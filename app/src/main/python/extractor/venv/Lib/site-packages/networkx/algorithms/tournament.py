...
def hamiltonian_path(G):
    ...
    hampath = hamiltonian_path(G.subgraph(set(G) - {v***REMOVED***))
...
def random_tournament(n, seed=None):
    ...
    uniformly random orientation. In other words, `\binom{n***REMOVED***{2***REMOVED***` flips
...
def tournament_matrix(G):
    ...
    .. math::
       ...
       T_{i j***REMOVED*** =
       \begin{cases***REMOVED***
       +1 & \text{if ***REMOVED*** (i, j) \in E \\
       -1 & \text{if ***REMOVED*** (j, i) \in E \\
       0 & \text{if ***REMOVED*** i == j.
       \end{cases***REMOVED***
