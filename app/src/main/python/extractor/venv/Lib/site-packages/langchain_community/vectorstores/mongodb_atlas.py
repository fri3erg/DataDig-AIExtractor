    ...
    def _select_relevance_score_fn(self) -> Callable[[float], float]:
        if self._relevance_score_fn == "euclidean":
            ...
            raise NotImplementedError(
                f"No relevance score function for ${self._relevance_score_fn***REMOVED***"
***REMOVED***
...
***REMOVED***
    ...
    def add_texts(
        ...
        **kwargs: Any,
        ...
        _metadatas: Union[List, Generator] = metadatas or ({***REMOVED*** for _ in texts)
        texts_batch = []
        metadatas_batch = []
        result_ids = []
    ...
    def _insert_texts(self, texts: List[str], metadatas: List[Dict[str, Any]]) -> List:
        ...
        to_insert = [
            {self._text_key: t, self._embedding_key: embedding, **m***REMOVED***
    ...
    def _similarity_search_with_score(
        ...
        ***REMOVED***
        ...
        query = {"$vectorSearch": params***REMOVED***

        pipeline = [
            query,
            {"$set": {"score": {"$meta": "vectorSearchScore"***REMOVED******REMOVED******REMOVED***,
        ]
