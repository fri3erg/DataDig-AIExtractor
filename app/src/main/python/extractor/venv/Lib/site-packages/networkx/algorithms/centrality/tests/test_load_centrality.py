...
class TestLoadCentrality:
    ...
    def setup_class(cls):
        ...
        cls.G = G
        cls.exact_weighted = {0: 4.0, 1: 0.0, 2: 8.0, 3: 6.0, 4: 8.0, 5: 0.0***REMOVED***
    ...
    def test_not_strongly_connected(self):
        ...
        result = {0: 5.0 / 12, 1: 1.0 / 4, 2: 1.0 / 12, 3: 1.0 / 4, 4: 0.000***REMOVED***
    ...
    def test_k5_load(self):
        ...
        d = {0: 0.000, 1: 0.000, 2: 0.000, 3: 0.000, 4: 0.000***REMOVED***
        for n in sorted(G):
            assert c[n] == pytest.approx(d[n], abs=1e-3)
    ...
    def test_p3_load(self):
        G = self.P3
        c = nx.load_centrality(G)
        d = {0: 0.000, 1: 1.000, 2: 0.000***REMOVED***
        for n in sorted(G):
            assert c[n] == pytest.approx(d[n], abs=1e-3)
    ...
    def test_unnormalized_p3_load(self):
        G = self.P3
        c = nx.load_centrality(G, normalized=False)
        d = {0: 0.000, 1: 2.000, 2: 0.000***REMOVED***
        for n in sorted(G):
            assert c[n] == pytest.approx(d[n], abs=1e-3)
    ...
    def test_load_betweenness_difference(self):
        ...
        # s\neq v***REMOVED***{\frac{\sigma_{st***REMOVED***(v)***REMOVED***{\sigma_{st***REMOVED******REMOVED******REMOVED***, therefore,
        ...
        d = {0: 1.750, 1: 1.750, 2: 6.500, 3: 6.500, 4: 1.750, 5: 1.750***REMOVED***
        for n in sorted(B):
            assert c[n] == pytest.approx(d[n], abs=1e-3)
    ...
    def test_c4_edge_load(self):
        ...
        d = {(0, 1): 6.000, (0, 3): 6.000, (1, 2): 6.000, (2, 3): 6.000***REMOVED***
        for n in G.edges():
            assert c[n] == pytest.approx(d[n], abs=1e-3)
    ...
    def test_p4_edge_load(self):
        G = self.P4
        c = nx.edge_load_centrality(G)
        d = {(0, 1): 6.000, (1, 2): 8.000, (2, 3): 6.000***REMOVED***
        for n in G.edges():
            assert c[n] == pytest.approx(d[n], abs=1e-3)
