...
class TestFirstValidIndex:
    ...
    @pytest.mark.parametrize(
        ...
        [
            ({"A": [1, 2, 3]***REMOVED***, [1, 1, 2], 1, 2),
            ({"A": [1, 2, 3]***REMOVED***, [1, 2, 2], 1, 2),
            ({"A": [1, 2, 3, 4]***REMOVED***, ["d", "d", "d", "d"], "d", "d"),
            ({"A": [1, np.nan, 3]***REMOVED***, [1, 1, 2], 1, 2),
            ({"A": [np.nan, np.nan, 3]***REMOVED***, [1, 1, 2], 2, 2),
            ({"A": [1, np.nan, 3]***REMOVED***, [1, 2, 2], 1, 2),
        ],
    )
    ...
    def test_first_last_valid(self, index):
        ...
        frame = DataFrame({"foo": mat***REMOVED***, index=index)
