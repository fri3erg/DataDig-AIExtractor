...
Create and score a series of chunk parsers, successively more complex.
    ...
    # Chunk everything:
    {<DT>  <NN>  <VBD>  <IN>  <DT>  <NN>  <DT>  <NN>  <VBD>  <.>***REMOVED***
    # Strip on verbs/prepositions:
    {<DT>  <NN>***REMOVED*** <VBD>  <IN> {<DT>  <NN>  <DT>  <NN>***REMOVED*** <VBD>  <.>
    # Split successive determiner/noun pairs:
    {<DT>  <NN>***REMOVED*** <VBD>  <IN> {<DT>  <NN>***REMOVED***{<DT>  <NN>***REMOVED*** <VBD>  <.>
    >>> print(chunked_text)
    (S
      (NP The/DT cat/NN)
      sat/VBD
...
underlying input.
    ...
    >>> cs.xform('<t3>', '{<t3>***REMOVED***')
    >>> print(cs)
     <t0>  <t1>  <t2> {<t3>***REMOVED*** <t4>  <t5>  <t6>  <t7>  <t8>  <t9>
...
called at the end of every call to `xform`.
    ...
    >>> # nested brackets:
    >>> cs.xform('<t3><t4><t5>', '{<t3>{<t4>***REMOVED***<t5>***REMOVED***')
    Traceback (most recent call last):
      . . .
    ValueError: Transformation generated invalid chunkstring:
      <t0><t1><t2>{<t3>{<t4>***REMOVED***<t5>***REMOVED***<t6><t7><t8><t9>
...
Test the different rule constructors & __repr__ methods:
    ...
    ...     print(rule)
    <RegexpChunkRule: '<a|b>(?=[^\\***REMOVED***]*(\\{|$))'->'{<a|b>***REMOVED***'>
    <RegexpChunkRule: '<a|b>(?=[^\\***REMOVED***]*(\\{|$))'->'{<a|b>***REMOVED***'>
    <ChunkRule: '<a|b>'>
    <StripRule: '<a|b>'>
    <UnChunkRule: '<a|b>'>
...
`tag_pattern2re_pattern()` complains if the tag pattern looks problematic:
    ...
    >>> tag_pattern2re_pattern('{***REMOVED***')
    Traceback (most recent call last):
      . . .
    ValueError: Bad tag pattern: '{***REMOVED***'
...
------------
    ...
    >>> parser = RegexpParser('''
    ... NP: {<DT>? <JJ>* <NN>****REMOVED*** # NP
    ... P: {<IN>***REMOVED***           # Preposition
    ... V: {<V.*>***REMOVED***          # Verb
    ... PP: {<P> <NP>***REMOVED***      # PP -> P NP
    ... VP: {<V> <NP|PP>****REMOVED***  # VP -> V (NP|PP)*
    ... ''')
    >>> print(repr(parser))
    ...
    # Input:
     <NP>  <VBD>  <IN>  <NP>  <NP>  <VBD>  <.>
    # Preposition:
     <NP>  <VBD> {<IN>***REMOVED*** <NP>  <NP>  <VBD>  <.>
    # Input:
     <NP>  <VBD>  <P>  <NP>  <NP>  <VBD>  <.>
    # Verb:
     <NP> {<VBD>***REMOVED*** <P>  <NP>  <NP> {<VBD>***REMOVED*** <.>
    # Input:
     <NP>  <V>  <P>  <NP>  <NP>  <V>  <.>
    # PP -> P NP:
     <NP>  <V> {<P>  <NP>***REMOVED*** <NP>  <V>  <.>
    # Input:
     <NP>  <V>  <PP>  <NP>  <V>  <.>
    # VP -> V (NP|PP)*:
     <NP> {<V>  <PP>  <NP>***REMOVED***{<V>***REMOVED*** <.>
    (S
      (NP The/DT cat/NN)
      (VP
        (V sat/VBD)
...
Test parsing of other rule types:
    ...
    >>> print(RegexpParser('''
    ... X:
    ...   ***REMOVED***<a><b>{     # strip rule
    ...   <a>***REMOVED***{<b>     # split rule
    ...   <a>{***REMOVED***<b>     # merge rule
    ...   <a>{<b>***REMOVED***<c>  # chunk rule w/ context
    ... '''))
...
Illegal patterns give an error message:
    ...
    >>> print(RegexpParser('X: {<foo>***REMOVED*** {<bar>***REMOVED***'))
    Traceback (most recent call last):
      . . .
    ValueError: Illegal chunk pattern: {<foo>***REMOVED*** {<bar>***REMOVED***
