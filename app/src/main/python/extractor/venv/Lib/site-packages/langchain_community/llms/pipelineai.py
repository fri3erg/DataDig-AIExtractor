...
class PipelineAI(LLM, BaseModel):
    ...
    def build_extra(cls, values: Dict[str, Any]) -> Dict[str, Any]:
        ...
        extra = values.get("pipeline_kwargs", {***REMOVED***)
        for field_name in list(values):
            if field_name not in all_required_field_names:
                if field_name in extra:
                    raise ValueError(f"Found {field_name***REMOVED*** supplied twice.")
                logger.warning(
                    f"""{field_name***REMOVED*** was transferred to pipeline_kwargs.
    ...
    ***REMOVED***
    ...
    def _identifying_params(self) -> Mapping[str, Any]:
        ...
        return {
            **{"pipeline_key": self.pipeline_key***REMOVED***,
            **{"pipeline_kwargs": self.pipeline_kwargs***REMOVED***,
        ***REMOVED***
...
***REMOVED***
        ...
        params = self.pipeline_kwargs or {***REMOVED***
