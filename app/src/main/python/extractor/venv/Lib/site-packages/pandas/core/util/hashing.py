...
***REMOVED***
        ...
        raise TypeError(f"Unexpected type for hashing {type(obj)***REMOVED***")
...
def hash_array(
    ...
    if not isinstance(vals, np.ndarray):
        ...
        raise TypeError(
            ...
            f"{type(vals).__name__***REMOVED***. Use hash_pandas_object instead."
        )
...
def _hash_ndarray(
    ...
    if dtype == bool:
        ...
        vals = vals.view(f"u{vals.dtype.itemsize***REMOVED***").astype("u8")
    else:
