...
class HTMLFormatter:
    ...
    def __init__(
        ...
        self.col_space = {***REMOVED***
        is_multi_index = isinstance(self.columns, MultiIndex)
        for column, value in self.fmt.col_space.items():
            col_space_value = f"{value***REMOVED***px" if isinstance(value, int) else value
    ...
    def render(self) -> list[str]:
        ...
        if self.should_show_dimensions:
            ...
            self.write(
                f"<p>{len(self.frame)***REMOVED*** rows {by***REMOVED*** {len(self.frame.columns)***REMOVED*** columns</p>"
***REMOVED***
    ...
    def write_th(
        ...
        if header and col_space is not None:
            tags = tags or ""
            tags += f'style="min-width: {col_space***REMOVED***;"'
    ...
    def _write_cell(
        ...
        if tags is not None:
            start_tag = f"<{kind***REMOVED*** {tags***REMOVED***>"
        else:
            start_tag = f"<{kind***REMOVED***>"
        ...
        if self.render_links and is_url(rs):
            rs_unescaped = pprint_thing(s, escape_chars={***REMOVED***).strip()
            start_tag += f'<a href="{rs_unescaped***REMOVED***" target="_blank">'
            end_a = "</a>"
        else:
            end_a = ""

        self.write(f"{start_tag***REMOVED***{rs***REMOVED***{end_a***REMOVED***</{kind***REMOVED***>", indent)
    ...
    def write_tr(
        ...
        if align is None:
            ...
            self.write(f'<tr style="text-align: {align***REMOVED***;">', indent)
        indent += indent_delta
        ...
        if self.classes is not None:
            ...
            if not isinstance(self.classes, (list, tuple)):
                raise TypeError(
                    ...
                    f"or tuple, not {type(self.classes)***REMOVED***"
    ***REMOVED***
        ...
        if self.table_id is None:
            ...
            id_section = f' id="{self.table_id***REMOVED***"'

        if self.border is None:
            border_attr = ""
        else:
            border_attr = f' border="{self.border***REMOVED***"'

        self.write(
            f'<table{border_attr***REMOVED*** class="{" ".join(_classes)***REMOVED***"{id_section***REMOVED***>',
            indent,
        )
    ...
    def _write_col_header(self, indent: int) -> None:
        ...
        if isinstance(self.columns, MultiIndex):
            template = 'colspan="{span:d***REMOVED***" halign="left"'
    ...
    def _get_formatted_values(self) -> dict[int, list[str]]:
        with option_context("display.max_colwidth", None):
            fmt_values = {i: self.fmt.format_col(i) for i in range(self.ncols)***REMOVED***
        return fmt_values
...
***REMOVED***
    ...
    def _write_hierarchical_rows(
        ...
        template = 'rowspan="{span***REMOVED***" valign="top"'
...
class NotebookFormatter(HTMLFormatter):
    ...
    def _get_formatted_values(self) -> dict[int, list[str]]:
        return {i: self.fmt.format_col(i) for i in range(self.ncols)***REMOVED***
    ...
    ***REMOVED***
        ...
        template = dedent(f"{template_first***REMOVED***\n{template_mid***REMOVED***\n{template_last***REMOVED***")
        self.write(template)
