...
class AccessLogger(AbstractAccessLogger):
    ...
    Usage:
        ...
        log_format = "%a %{User-Agent***REMOVED***i"
    ...
    Format:
        ...
        %{FOO***REMOVED***i  request.headers['FOO']
        %{FOO***REMOVED***o  response.headers['FOO']
        %{FOO***REMOVED***e  os.environ['FOO']
    ...
    ***REMOVED***
    ...
    LOG_FORMAT = '%a %t "%r" %s %b "%{Referer***REMOVED***i" "%{User-Agent***REMOVED***i"'
    FORMAT_RE = re.compile(r"%(\{([A-Za-z0-9\-_]+)\***REMOVED***([ioe])|[atPrsbOD]|Tf?)")
    CLEANUP_RE = re.compile(r"(%[^s])")
    _FORMAT_CACHE: Dict[str, Tuple[str, List[KeyMethod]]] = {***REMOVED***
    ...
    def _format_r(request: BaseRequest, response: StreamResponse, time: float) -> str:
        if request is None:
            return "-"
        return "{***REMOVED*** {***REMOVED*** HTTP/{***REMOVED***.{***REMOVED***".format(
            request.method,
            request.path_qs,
        ...
        try:
            ...
            for key, value in fmt_info:
                ...
                if key.__class__ is str:
                    ...
                    dct = extra.get(k1, {***REMOVED***)  # type: ignore[var-annotated,has-type]
