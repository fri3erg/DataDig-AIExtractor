...
class Type:
    ...
    def _init(self, name):
        ...
        if self.NAME == 'CHARACTER':
            ...
            self.dtype = np.dtype(f'S{self.elsize***REMOVED***')
        else:
            info = typeinfo[self.NAME]
    ...
    def __repr__(self):
        return (f"Type({self.NAME***REMOVED***)|type_num={self.type_num***REMOVED***,"
                f" dtype={self.dtype***REMOVED***,"
                f" type={self.type***REMOVED***, elsize={self.elsize***REMOVED***,"
                f" dtypechar={self.dtypechar***REMOVED***")
...
class Array:
    ...
    def __repr__(self):
        return (f'Array({self.type***REMOVED***, {self.dims***REMOVED***, {self.intent***REMOVED***,'
                f' {self.obj***REMOVED***)|arr={self.arr***REMOVED***')
