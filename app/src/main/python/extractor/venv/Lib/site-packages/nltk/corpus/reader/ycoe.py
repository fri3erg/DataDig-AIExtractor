...
class YCOECorpusReader(CorpusReader):
    ...
    def __init__(self, root, encoding="utf8"):
        ...
        documents = {f[:-4] for f in self._psd_reader.fileids()***REMOVED***
        if {f[:-4] for f in self._pos_reader.fileids()***REMOVED*** != documents:
    ...
    def documents(self, fileids=None):
        ...
        return sorted({f[:-4] for f in fileids***REMOVED***)
...
***REMOVED***
    ...
    def _getfileids(self, documents, subcorpus):
        ...
        return [f"{d***REMOVED***.{subcorpus***REMOVED***" for d in documents]
