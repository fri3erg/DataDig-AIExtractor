...
***REMOVED***
    ...
    def _validate_setitem_value(self, value):
        ...
        #  py38 builds.
        raise TypeError(f"Invalid value '{str(value)***REMOVED***' for dtype {self.dtype***REMOVED***")
...
***REMOVED***:
                raise ValueError(
                    f"cannot convert to '{dtype***REMOVED***'-dtype NumPy array "
...
***REMOVED***
    ...
    def _arith_method(self, other, op):
        ...
        if op_name in {"pow", "rpow"***REMOVED*** and isinstance(other, np.bool_):
        ...
        if other is libmissing.NA:
            ...
            if self.dtype.kind == "b":
                ...
                ***REMOVED***:
                    ...
                    raise NotImplementedError(
                        f"operator '{op_name***REMOVED***' not implemented for bool dtypes"
        ***REMOVED***
                if op_name in {"mod", "rmod"***REMOVED***:
                    dtype = "int8"
                else:
                    dtype = "bool"
    ...
    def _cmp_method(self, other, op) -> BooleanArray:
        ...
        if other is libmissing.NA:
            ...
            with warnings.catch_warnings():
                ...
                method = getattr(self._data, f"__{op.__name__***REMOVED***__")
                result = method(other)
...
***REMOVED***
    ...
    def _reduce(
        ...
        if name in {"any", "all", "min", "max", "sum", "prod", "mean", "var", "std"***REMOVED***:
            result = getattr(self, name)(skipna=skipna, **kwargs)
        else:
            # median, skew, kurt, sem
            data = self._data
            mask = self._mask
            op = getattr(nanops, f"nan{name***REMOVED***")
    ...
    def _wrap_na_result(self, *, name, axis, mask_size):
        ...
        if name in ["mean", "median", "var", "std", "skew", "kurt"]:
            ...
            np_dtype = {"b": int_dtyp, "i": int_dtyp, "u": uint_dtyp, "f": float_dtyp***REMOVED***[
                self.dtype.kind
            ]
