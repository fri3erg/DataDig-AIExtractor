...
TABLE_NAME = "{http://www.w3.org/1999/xhtml***REMOVED***table"
...
***REMOVED***
        ...
        framework_chunks: Dict[str, Document] = {***REMOVED***
    ...
    def _document_details_for_docset_id(self, docset_id: str) -> List[Dict]:
        ...
        url = f"{self.api***REMOVED***/docsets/{docset_id***REMOVED***/documents"
        all_documents = []

        while url:
            response = requests.get(
                url,
                headers={"Authorization": f"Bearer {self.access_token***REMOVED***"***REMOVED***,
***REMOVED***
            if response.ok:
                data = response.json()
                ...
                raise Exception(
                    f"Failed to download {url***REMOVED*** (status: {response.status_code***REMOVED***)"
    ***REMOVED***
    ...
    def _project_details_for_docset_id(self, docset_id: str) -> List[Dict]:
        ...
        url = f"{self.api***REMOVED***/projects?docset.id={docset_id***REMOVED***"
        all_projects = []
...
***REMOVED***
    ...
    ***REMOVED***
    ...
    def _metadata_for_project(self, project: Dict) -> Dict:
        ...
        url = f"{self.api***REMOVED***/projects/{project_id***REMOVED***/artifacts/latest"
        all_artifacts = []

        per_file_metadata: Dict = {***REMOVED***
        while url:
            response = requests.request(
                "GET",
                url,
    ...
    ***REMOVED***
        ...
        for artifact in all_artifacts:
            ...
            if artifact_name == "report-values.xml" and artifact_url and artifact_doc:
                ...
                response = requests.request(
                    "GET",
                    f"{artifact_url***REMOVED***/content",
                    headers={"Authorization": f"Bearer {self.access_token***REMOVED***"***REMOVED***,
                    data={***REMOVED***,
    ***REMOVED***
            ...
            ***REMOVED***.strip()
                    ...
                    raise Exception(
                        f"Failed to download {artifact_url***REMOVED***/content "
                        + "(status: {response.status_code***REMOVED***)"
        ***REMOVED***
    ...
    def _load_chunks_for_document(
        ...
        url = f"{self.api***REMOVED***/docsets/{docset_id***REMOVED***/documents/{document_id***REMOVED***/dgml"
...
***REMOVED***
    ...
    def load(self) -> List[Document]:
        ...
        if self.access_token and self.docset_id:
            ...
            combined_project_metadata: Dict[str, Dict] = {***REMOVED***
