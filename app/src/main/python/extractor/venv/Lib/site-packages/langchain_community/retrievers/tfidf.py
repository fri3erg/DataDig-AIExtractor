...
***REMOVED***
        ...
        tfidf_params = tfidf_params or {***REMOVED***
...
***REMOVED***
        ...
        joblib.dump(self.vectorizer, path / f"{file_name***REMOVED***.joblib")

        # Save docs and tfidf array as pickle.
        with open(path / f"{file_name***REMOVED***.pkl", "wb") as f:
...
***REMOVED***
        ...
        vectorizer = joblib.load(path / f"{file_name***REMOVED***.joblib")

        # Load docs and tfidf array as pickle.
        with open(path / f"{file_name***REMOVED***.pkl", "rb") as f:
