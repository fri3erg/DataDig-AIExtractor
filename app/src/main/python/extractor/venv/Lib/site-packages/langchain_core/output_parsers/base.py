...
class BaseOutputParser(
                ...
                def parse(self, text: str) -> bool:
                    ...
                    if cleaned_text not in (self.true_val.upper(), self.false_val.upper()):
                        raise OutputParserException(
                            ...
                            f"{self.true_val***REMOVED*** or {self.false_val***REMOVED*** (case-insensitive). "
                            f"Received {cleaned_text***REMOVED***."
            ***REMOVED***
    ...
    def OutputType(self) -> Type[T]:
        ...
        raise TypeError(
            f"Runnable {self.__class__.__name__***REMOVED*** doesn't have an inferable OutputType. "
...
***REMOVED***
    ...
    def _type(self) -> str:
        ...
        raise NotImplementedError(
            f"_type property is not implemented in class {self.__class__.__name__***REMOVED***."
