...
class ForefrontAI(LLM):
    ...
    def _identifying_params(self) -> Mapping[str, Any]:
        ...
        return {**{"endpoint_url": self.endpoint_url***REMOVED***, **self._default_params***REMOVED***
    ...
    def _call(
        ...
        **kwargs: Any,
        ...
        """
        auth_value = f"Bearer {self.forefrontai_api_key.get_secret_value()***REMOVED***"
        response = requests.post(
            ...
            ***REMOVED***,
            json={"text": prompt, **self._default_params, **kwargs***REMOVED***,
        )
