...
class TestBuildSchema:
    def test_build_table_schema(self, df_schema, using_infer_string):
        ...
        expected = {
            "fields": [
                {"name": "idx", "type": "integer"***REMOVED***,
                {"name": "A", "type": "integer"***REMOVED***,
                {"name": "B", "type": "string"***REMOVED***,
                {"name": "C", "type": "datetime"***REMOVED***,
                {"name": "D", "type": "duration"***REMOVED***,
            ],
            "primaryKey": ["idx"],
        ***REMOVED***
        if using_infer_string:
            expected["fields"][2] = {"name": "B", "type": "any", "extDtype": "string"***REMOVED***
    ...
    def test_series(self):
        ...
        expected = {
            "fields": [
                {"name": "index", "type": "integer"***REMOVED***,
                {"name": "foo", "type": "integer"***REMOVED***,
            ],
            "primaryKey": ["index"],
        ***REMOVED***
        assert result == expected
    ...
    def test_series_unnamed(self):
        ...
        expected = {
            "fields": [
                {"name": "index", "type": "integer"***REMOVED***,
                {"name": "values", "type": "integer"***REMOVED***,
            ],
            "primaryKey": ["index"],
        ***REMOVED***
        assert result == expected
    ...
    def test_multiindex(self, df_schema, using_infer_string):
        ...
        expected = {
            "fields": [
                {"name": "level_0", "type": "string"***REMOVED***,
                {"name": "level_1", "type": "integer"***REMOVED***,
                {"name": "A", "type": "integer"***REMOVED***,
                {"name": "B", "type": "string"***REMOVED***,
                {"name": "C", "type": "datetime"***REMOVED***,
                {"name": "D", "type": "duration"***REMOVED***,
        ...
        ***REMOVED***
        if using_infer_string:
            expected["fields"][0] = {
                ...
                "extDtype": "string",
            ***REMOVED***
            expected["fields"][3] = {"name": "B", "type": "any", "extDtype": "string"***REMOVED***
        assert result == expected
...
class TestTableOrient:
    def test_build_series(self):
        ...
        fields = [{"name": "id", "type": "integer"***REMOVED***, {"name": "a", "type": "integer"***REMOVED***]

        schema = {"fields": fields, "primaryKey": ["id"]***REMOVED***
    ...
    ***REMOVED***,
    ...
    def test_read_json_from_to_json_results(self):
        ...
        df = DataFrame(
            {
                "_id": {"row_0": 0***REMOVED***,
                "category": {"row_0": "Goods"***REMOVED***,
                "recommender_id": {"row_0": 3***REMOVED***,
                "recommender_name_jp": {"row_0": "浦田"***REMOVED***,
                "recommender_name_en": {"row_0": "Urata"***REMOVED***,
                "name_jp": {"row_0": "博多人形(松尾吉将まつお よしまさ)"***REMOVED***,
                "name_en": {"row_0": "Hakata Dolls Matsuo"***REMOVED***,
            ***REMOVED***
        )
    ...
    def test_to_json(self, df_table, using_infer_string):
        ...
        fields = [
            ...
            {"name": "D", "type": "duration"***REMOVED***,
            {
                "constraints": {"enum": ["a", "b", "c"]***REMOVED***,
                "name": "E",
                "ordered": False,
                "type": "any",
            ***REMOVED***,
            {
                ...
                "type": "any",
            ***REMOVED***,
            {"name": "G", "type": "number"***REMOVED***,
            {"name": "H", "type": "datetime", "tz": "US/Central"***REMOVED***,
        ]

        if using_infer_string:
            fields[2] = {"name": "B", "type": "any", "extDtype": "string"***REMOVED***

        schema = {"fields": fields, "primaryKey": ["idx"]***REMOVED***
        data = [
            OrderedDict(
                [
                    ("idx", 0),
...
***REMOVED***,
        ...
        expected = OrderedDict(
            [
                (
                    ...
                    {
                        "fields": [
                            {"name": "index", "type": "number"***REMOVED***,
                            {"name": "values", "type": "integer"***REMOVED***,
                        ],
                        "primaryKey": ["index"],
                    ***REMOVED***,
    ...
    ***REMOVED***,
    ...
    def test_to_json_period_index(self):
        ...
        fields = [
            {"freq": "QE-JAN", "name": "index", "type": "datetime"***REMOVED***,
            {"name": "values", "type": "integer"***REMOVED***,
        ]

        schema = {"fields": fields, "primaryKey": ["index"]***REMOVED***
        data = [
    ...
    ***REMOVED***,
    ...
    def test_convert_pandas_type_to_json_field_int(self, index_or_series):
        ...
        expected = {"name": "name", "type": "integer"***REMOVED***
        assert result == expected
    ...
    def test_convert_pandas_type_to_json_field_float(self, index_or_series):
        ...
        data = [1.0, 2.0, 3.0]
        result = convert_pandas_type_to_json_field(kind(data, name="name"))
        expected = {"name": "name", "type": "number"***REMOVED***
        assert result == expected

    @pytest.mark.parametrize(
        "dt_args,extra_exp", [({***REMOVED***, {***REMOVED***), ({"utc": True***REMOVED***, {"tz": "UTC"***REMOVED***)]
    )
    ...
    def test_convert_pandas_type_to_json_field_datetime(
        ...
        expected = {"name": "values", "type": "datetime"***REMOVED***
    ...
    def test_convert_pandas_type_to_json_period_range(self):
        ...
        expected = {"name": "values", "type": "datetime", "freq": "YE-DEC"***REMOVED***
        assert result == expected
    ...
    @pytest.mark.parametrize(
        "inp,exp",
        [
            ({"type": "integer"***REMOVED***, "int64"),
            ({"type": "number"***REMOVED***, "float64"),
            ({"type": "boolean"***REMOVED***, "bool"),
            ({"type": "duration"***REMOVED***, "timedelta64"),
            ({"type": "datetime"***REMOVED***, "datetime64[ns]"),
            ({"type": "datetime", "tz": "US/Hawaii"***REMOVED***, "datetime64[ns, US/Hawaii]"),
            ({"type": "any"***REMOVED***, "object"),
            (
                {
                    "type": "any",
                    "constraints": {"enum": ["a", "b", "c"]***REMOVED***,
...
***REMOVED***,
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            DataFrame({"A": [1]***REMOVED***, index=pd.Index([1], name="A")),
            DataFrame(
                {"A": [1]***REMOVED***,
...
class TestTableOrientReader:
    ...
    @pytest.mark.parametrize(
        "vals",
        [
            {"ints": [1, 2, 3, 4]***REMOVED***,
            {"objects": ["a", "b", "c", "d"]***REMOVED***,
            {"objects": ["1", "2", "3", "4"]***REMOVED***,
            {"date_ranges": pd.date_range("2016-01-01", freq="d", periods=4)***REMOVED***,
            {"categoricals": pd.Series(pd.Categorical(["a", "b", "c", "c"]))***REMOVED***,
            {
                "ordered_cats": pd.Series(
                    pd.Categorical(["a", "b", "c", "c"], ordered=True)
    ***REMOVED***
            ***REMOVED***,
            {"floats": [1.0, 2.0, 3.0, 4.0]***REMOVED***,
            {"floats": [1.1, 2.2, 3.3, 4.4]***REMOVED***,
            {"bools": [True, False, False, True]***REMOVED***,
            {
                "timezones": pd.date_range(
                    "2016-01-01", freq="d", periods=4, tz="US/Central"
    ***REMOVED***  # added in # GH 35973
            ***REMOVED***,
        ],
    )
    ...
    @pytest.mark.parametrize(
        "vals",
        [{"timedeltas": pd.timedelta_range("1h", periods=4, freq="min")***REMOVED***],
    )
    ...
    ***REMOVED***  # added in # GH 35973
    ...
    def test_read_json_table_period_orient(self, index_nm, vals, recwarn):
        df = DataFrame(
            vals,
            index=pd.Index(
                (pd.Period(f"2022Q{q***REMOVED***") for q in range(1, 5)), name=index_nm
***REMOVED***,
        )
        out = df.to_json(orient="table")
        result = pd.read_json(out, orient="table")
...
***REMOVED***,
    ...
    @pytest.mark.parametrize(
        ...
        [
            {"floats": [1.1, 2.2, 3.3, 4.4]***REMOVED***,
            {"dates": pd.date_range("2020-08-30", freq="d", periods=4)***REMOVED***,
            {
                "timezones": pd.date_range(
    ...
    def test_read_json_orient_table_old_schema_version(self):
        df_json = """
        {
            ...
            ***REMOVED***,
            "data":[
                {"index":0,"a":1***REMOVED***,
                {"index":1,"a":2.0***REMOVED***,
                {"index":2,"a":"s"***REMOVED***
            ]
        ***REMOVED***
        """
        expected = DataFrame({"a": [1, 2.0, "s"]***REMOVED***)
