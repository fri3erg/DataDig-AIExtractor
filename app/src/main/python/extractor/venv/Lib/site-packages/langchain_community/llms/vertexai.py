...
***REMOVED***
    ...
    def _try_init_vertexai(cls, values: Dict) -> None:
        ...
        params = {k: v for k, v in values.items() if k in allowed_params***REMOVED***
    ...
    def _prepare_params(
        ...
        **kwargs: Any,
        ...
        params_mapping = {"n": "candidate_count"***REMOVED***
        params = {params_mapping.get(k, k): v for k, v in kwargs.items()***REMOVED***
        params = {**self._default_params, "stop_sequences": stop_sequences, **params***REMOVED***
...
***REMOVED***
        ...
        client_options = ClientOptions(
            api_endpoint=f"{values['location']***REMOVED***-aiplatform.googleapis.com"
        )
            ...
            try:
                ...
                if isinstance(prediction, str):
                    error_desc = (
                        ...
                        f"{self.result_arg***REMOVED***). But got prediction of type "
                        f"{type(prediction)***REMOVED*** instead of dict. Most probably, you"
                        "need to set `result_arg=None` during VertexAIModelGarden "
                        "initialization."
        ***REMOVED***
                    raise ValueError(error_desc)
                else:
                    raise ValueError(f"{self.result_arg***REMOVED*** key not found in prediction!")
