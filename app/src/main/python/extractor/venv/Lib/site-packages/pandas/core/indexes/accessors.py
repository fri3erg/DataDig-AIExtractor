    ...
    ***REMOVED***
    ...
    def __init__(self, data: Series, orig) -> None:
        if not isinstance(data, ABCSeries):
            raise TypeError(
                f"cannot convert an object of type {type(data)***REMOVED*** to a datetimelike index"
***REMOVED***
...
@delegate_names(
    ...
    typ="property",
    accessor_mapping=lambda x: f"_dt_{x***REMOVED***",
...
***REMOVED***
    ...
    def _delegate_property_get(self, name: str):
        if not hasattr(self._parent.array, f"_dt_{name***REMOVED***"):
            raise NotImplementedError(
                f"dt.{name***REMOVED*** is not supported for {self._parent.dtype***REMOVED***"
***REMOVED***
        result = getattr(self._parent.array, f"_dt_{name***REMOVED***")
...
***REMOVED***
        ...
        result = getattr(self._parent.array, f"_dt_{name***REMOVED***")(*args, **kwargs)
    ...
    def to_pydatetime(self):
        # GH#20306
        warnings.warn(
            f"The behavior of {type(self).__name__***REMOVED***.to_pydatetime is deprecated, "
    ...
    def components(self) -> DataFrame:
        ...
        components_df = DataFrame(
            {
                col: getattr(self._parent.array, f"_dt_{col***REMOVED***")
                for col in [
                    "days",
                    "hours",
                    "minutes",
