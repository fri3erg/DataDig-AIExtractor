...
***REMOVED***
        ...
        ***REMOVED***
        ...
        if self._emitter is not None:
            self._emitter.emit(
                f'creating-resource-class.{cls_name***REMOVED***',
            ...
            if self.meta.data is None:
                if hasattr(self, 'load'):
                    ...
                    raise ResourceLoadException(
                        f'{self.__class__.__name__***REMOVED*** has no load method'
        ***REMOVED***
...
***REMOVED***
    ...
    def _create_reference(
        ...
        def get_reference(self):
            ...
            if needs_data and self.meta.data is None and hasattr(self, 'load'):
                self.load()
            return handler(self, {***REMOVED***, self.meta.data)
    ...
    def _create_class_partial(
        ...
        def create_resource(self, *args, **kwargs):
            ...
            json_def = service_context.resource_json_definitions.get(name, {***REMOVED***)
