...
***REMOVED***
        ...
        df = DataFrame({"s": s, "vals": [1, 2, 3, 4, 5, 6]***REMOVED***)
...
def test_categorical_conversion(tmp_path, setup_path):
    ...
    df = DataFrame({"obsids": obsids, "imgids": imgids, "data": data***REMOVED***)
...
@pytest.mark.parametrize(
    "where, df, expected",
    [
        ('col=="q"', DataFrame({"col": ["a", "b", "s"]***REMOVED***), DataFrame({"col": []***REMOVED***)),
        ('col=="a"', DataFrame({"col": ["a", "b", "s"]***REMOVED***), DataFrame({"col": ["a"]***REMOVED***)),
    ],
)
