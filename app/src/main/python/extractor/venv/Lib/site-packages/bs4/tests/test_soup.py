    ...
    def test_custom_builder_class(self):
        ...
        class Mock(object):
            def __init__(self, **kwargs):
                ...
                self.string_containers = {***REMOVED***
...
***REMOVED***
    ...
    def test_cdata_list_attributes(self):
        ...
        for switcheroo in ({'*': 'id'***REMOVED***, {'a': 'id'***REMOVED***):
            with warnings.catch_warnings(record=True) as w:
...
class TestOutput(SoupTest):
    ...
    def test_decode_xml_declaration(self, eventual_encoding, actual_encoding):
        ...
        soup.is_xml = True
        assert (f'<?xml version="1.0" encoding="{actual_encoding***REMOVED***"?>\n<tag></tag>'
...
class TestNewTag(SoupTest):
    ...
    def test_new_tag(self):
        soup = self.soup("")
        new_tag = soup.new_tag("foo", bar="baz", attrs={"name": "a name"***REMOVED***)
...
class TestEncodingConversion(SoupTest):
    ...
    def setup_method(self):
        self.unicode_data = '<html><head><meta charset="utf-8"/></head><body><foo>Sacr\N{LATIN SMALL LETTER E WITH ACUTE***REMOVED*** bleu!</foo></body></html>'
