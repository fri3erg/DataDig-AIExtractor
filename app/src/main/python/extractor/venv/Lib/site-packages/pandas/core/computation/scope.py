...
***REMOVED***
    ...
    ***REMOVED***
    ...
    def __repr__(self) -> str:
        ...
        return f"{type(self).__name__***REMOVED***(scope={scope_keys***REMOVED***, resolvers={res_keys***REMOVED***)"
    ...
    def _get_vars(self, stack, scopes: list[str]) -> None:
        ...
        for scope, (frame, _, _, _, _, _) in variables:
            try:
                d = getattr(frame, f"f_{scope***REMOVED***")
    ...
    def add_tmp(self, value) -> str:
        ...
        """
        name = f"{type(value).__name__***REMOVED***_{self.ntemps***REMOVED***_{_raw_hex_id(self)***REMOVED***"
