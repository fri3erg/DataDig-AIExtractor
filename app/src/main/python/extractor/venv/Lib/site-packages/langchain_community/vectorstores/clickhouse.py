...
class ClickhouseSettings(BaseSettings):
    ...
    index_query_params: Dict[str, str] = {***REMOVED***
...
CREATE TABLE IF NOT EXISTS {self.config.database***REMOVED***.{self.config.table***REMOVED***(
    {self.config.column_map['id']***REMOVED*** Nullable(String),
    {self.config.column_map['document']***REMOVED*** Nullable(String),
    {self.config.column_map['embedding']***REMOVED*** Array(Float32),
    {self.config.column_map['metadata']***REMOVED*** JSON,
    {self.config.column_map['uuid']***REMOVED*** UUID DEFAULT generateUUIDv4(),
    CONSTRAINT cons_vec_len CHECK length({self.config.column_map['embedding']***REMOVED***) = {dim***REMOVED***,
    INDEX vec_idx {self.config.column_map['embedding']***REMOVED*** TYPE \
{self.config.index_type***REMOVED***({index_params***REMOVED***) GRANULARITY 1000
    ...
    def _build_query_sql(
        ...
        if self.config.index_query_params:
            for k in self.config.index_query_params:
                settings_strs.append(f"SETTING {k***REMOVED***={self.config.index_query_params[k]***REMOVED***")
        q_str = f"""
            SELECT {self.config.column_map['document']***REMOVED***, 
                {self.config.column_map['metadata']***REMOVED***, dist
            FROM {self.config.database***REMOVED***.{self.config.table***REMOVED***
            {where_str***REMOVED***
            ORDER BY L2Distance({self.config.column_map['embedding']***REMOVED***, [{q_emb_str***REMOVED***]) 
                AS dist {self.dist_order***REMOVED***
            LIMIT {topk***REMOVED*** {' '.join(settings_strs)***REMOVED***
            """
        return q_str
