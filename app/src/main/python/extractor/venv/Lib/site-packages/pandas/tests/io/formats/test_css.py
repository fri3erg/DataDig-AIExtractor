...
def test_css_side_shorthands(shorthand, expansions):
    ...
    assert_resolves(
        f"{shorthand***REMOVED***: 1pt", {top: "1pt", right: "1pt", bottom: "1pt", left: "1pt"***REMOVED***
    )

    assert_resolves(
        f"{shorthand***REMOVED***: 1pt 4pt", {top: "1pt", right: "4pt", bottom: "1pt", left: "4pt"***REMOVED***
    )

    assert_resolves(
        f"{shorthand***REMOVED***: 1pt 4pt 2pt",
        {top: "1pt", right: "4pt", bottom: "2pt", left: "4pt"***REMOVED***,
    )

    assert_resolves(
        f"{shorthand***REMOVED***: 1pt 4pt 2pt 0pt",
        {top: "1pt", right: "4pt", bottom: "2pt", left: "0pt"***REMOVED***,
    )

    with tm.assert_produces_warning(CSSWarning):
        assert_resolves(f"{shorthand***REMOVED***: 1pt 1pt 1pt 1pt 1pt", {***REMOVED***)
...
def test_css_border_shorthand_sides(shorthand, sides):
    def create_border_dict(sides, color=None, style=None, width=None):
        ...
        for side in sides:
            if color:
                resolved[f"border-{side***REMOVED***-color"] = color
            if style:
                resolved[f"border-{side***REMOVED***-style"] = style
            if width:
                resolved[f"border-{side***REMOVED***-width"] = width
        return resolved

    assert_resolves(
        f"{shorthand***REMOVED***: 1pt red solid", create_border_dict(sides, "red", "solid", "1pt")
    )
...
@pytest.mark.parametrize(
    ...
    [
        ("xx-small", "6pt"),
        ("x-small", f"{7.5:f***REMOVED***pt"),
        ("small", f"{9.6:f***REMOVED***pt"),
        ("medium", "12pt"),
        ("large", f"{13.5:f***REMOVED***pt"),
        ("x-large", "18pt"),
        ("xx-large", "24pt"),
        ("8px", "6pt"),
        ("1.25pc", "15pt"),
...
def test_css_absolute_font_size(size, relative_to, resolved):
    if relative_to is None:
        ...
        inherited = {"font-size": relative_to***REMOVED***
    assert_resolves(f"font-size: {size***REMOVED***", {"font-size": resolved***REMOVED***, inherited=inherited)
...
@pytest.mark.parametrize(
    ...
    [
        ...
        ("smaller", None, "10pt"),
        ("smaller", "18pt", "15pt"),
        ("larger", None, f"{14.4:f***REMOVED***pt"),
        ("larger", "15pt", "18pt"),
    ],
)
