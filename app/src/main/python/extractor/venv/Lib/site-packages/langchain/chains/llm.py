...
class LLMChain(Chain):
    ...
    Example:
        .. code-block:: python
            ...
            prompt_template = "Tell me a {adjective***REMOVED*** joke"
...
***REMOVED***
            ...
            results = self.llm.bind(stop=stop, **self.llm_kwargs).batch(
                cast(List, prompts), {"callbacks": callbacks***REMOVED***
***REMOVED***
...
***REMOVED***
    ...
    def prep_prompts(
        ...
        for inputs in input_list:
            selected_inputs = {k: inputs[k] for k in self.prompt.input_variables***REMOVED***
    ...
    ***REMOVED***
    ...
    def apply(
        ...
        run_manager.on_chain_end({"outputs": outputs***REMOVED***)
        return outputs
    ...
    async def aapply(
        ...
        try:
            ...
            raise e
        outputs = self.create_outputs(response)
        await run_manager.on_chain_end({"outputs": outputs***REMOVED***)
        return outputs
    ...
    def create_outputs(self, llm_result: LLMResult) -> List[Dict[str, Any]]:
        ...
        if self.return_final_only:
            result = [{self.output_key: r[self.output_key]***REMOVED*** for r in result]
        return result
