...
DEFAULT_REFINE_PROMPT_TMPL = (
    "The original question is as follows: {question***REMOVED***\n"
    "We have provided an existing answer: {existing_answer***REMOVED***\n"
...
CHAT_REFINE_PROMPT = ChatPromptTemplate.from_messages(
    [("human", "{question***REMOVED***"), ("ai", "{existing_answer***REMOVED***"), ("human", refine_template)]
)
...
DEFAULT_TEXT_QA_PROMPT_TMPL = (
    ...
    "answer the question: {question***REMOVED***\n"
)
...
CHAT_QUESTION_PROMPT = ChatPromptTemplate.from_messages(
    [("system", chat_qa_prompt_template), ("human", "{question***REMOVED***")]
)
