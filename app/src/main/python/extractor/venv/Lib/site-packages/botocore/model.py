...
class StructureShape(Shape):
    ...
    def members(self):
        ...
        #    'members': {
        #        'MemberName': {'shape': 'shapeName'***REMOVED***,
        #        'MemberName2': {'shape': 'shapeName'***REMOVED***,
        #    ***REMOVED***
    ...
    def error_code(self):
        if not self.metadata.get('exception', False):
            return None
        error_metadata = self.metadata.get("error", {***REMOVED***)
...
class ServiceModel:
    ...
    def __init__(self, service_description, service_name=None):
        ...
        self.metadata = service_description.get('metadata', {***REMOVED***)
        self._shape_resolver = ShapeResolver(
            service_description.get('shapes', {***REMOVED***)
        )
        self._signature_version = NOT_SET
        self._service_name = service_name
        self._instance_cache = {***REMOVED***
    ...
    def shape_names(self):
        return list(self._service_description.get('shapes', {***REMOVED***))
...
***REMOVED***:
    ...
    def client_context_parameters(self):
        params = self._service_description.get('clientContextParams', {***REMOVED***)
        return [
    ...
    def _get_metadata_property(self, name):
        try:
            ...
            raise UndefinedModelAttributeError(
                f'"{name***REMOVED***" not defined in the metadata of the model: {self***REMOVED***'
***REMOVED***
    ...
    def __repr__(self):
        return f'{self.__class__.__name__***REMOVED***({self.service_name***REMOVED***)'
...
class OperationModel:
    def __init__(self, operation_model, service_model, name=None):
        ...
        self.http = operation_model.get('http', {***REMOVED***)
    ...
    def static_context_parameters(self):
        params = self._operation_model.get('staticContextParams', {***REMOVED***)
        return [
...
***REMOVED***
    ...
    def http_checksum(self):
        return self._operation_model.get('httpChecksum', {***REMOVED***)
    ...
    def __repr__(self):
        return f'{self.__class__.__name__***REMOVED***(name={self.name***REMOVED***)'
    ...
    def get_shape_by_name(self, shape_name, member_traits=None):
        ...
        try:
            ...
            raise InvalidShapeError(
                f"Shape is missing required key 'type': {shape_model***REMOVED***"
***REMOVED***
        if member_traits:
    ...
    def resolve_shape_ref(self, shape_ref):
        ...
        # {"shape": "StringType", "locationName": "Foobar"***REMOVED***
        if len(shape_ref) == 1 and 'shape' in shape_ref:
            ...
            try:
                ...
                raise InvalidShapeReferenceError(
                    f"Invalid model, missing shape reference: {shape_ref***REMOVED***"
    ***REMOVED***
...
class UnresolvableShapeMap:
    ...
    def get_shape_by_name(self, shape_name, member_traits=None):
        raise ValueError(
            f"Attempted to lookup shape '{shape_name***REMOVED***', but no shape map was provided."
        )

    def resolve_shape_ref(self, shape_ref):
        raise ValueError(
            f"Attempted to resolve shape '{shape_ref***REMOVED***', but no shape "
            f"map was provided."
        )
...
class DenormalizedStructureBuilder:
    ...
    def _build_model(self, model, shapes, shape_name):
        if model['type'] == 'structure':
            ...
            raise InvalidShapeError(f"Unknown shape type: {model['type']***REMOVED***")
    ...
    def _build_structure(self, model, shapes):
        ...
        for name, member_model in model.get('members', OrderedDict()).items():
            ...
            members[name] = {'shape': member_shape_name***REMOVED***
    ...
    def _build_list(self, model, shapes):
        ...
        shape = self._build_initial_shape(model)
        shape['member'] = {'shape': member_shape_name***REMOVED***
    ...
    def _build_map(self, model, shapes):
        ...
        shape = self._build_initial_shape(model)
        shape['key'] = {'shape': key_shape_name***REMOVED***
        shape['value'] = {'shape': value_shape_name***REMOVED***
...
class ShapeNameGenerator:
    ...
    def new_shape_name(self, type_name):
        ...
        return f'{type_name.capitalize()***REMOVED***Type{current_index***REMOVED***'
