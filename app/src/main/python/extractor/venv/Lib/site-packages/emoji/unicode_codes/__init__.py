...
_EMOJI_UNICODE = {lang: None for lang in LANGUAGES***REMOVED***  # Cache for the language dicts

_ALIASES_UNICODE = {***REMOVED***  # Cache for the aliases dict
...
def get_emoji_unicode_dict(lang):
    ...
    if _EMOJI_UNICODE[lang] is None:
        _EMOJI_UNICODE[lang] = {data[lang]: emj for emj, data in EMOJI_DATA.items()
                                if lang in data and data['status'] <= STATUS['fully_qualified']***REMOVED***
