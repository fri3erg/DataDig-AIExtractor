...
class BaseGraphTester:
    ...
    def test_contains(self):
        ...
        assert {1: 1***REMOVED*** not in G  # no exception for nonhashable
    ...
    def test_nodes(self):
        ...
        assert sorted(G.nodes(data=True)) == [(0, {***REMOVED***), (1, {***REMOVED***), (2, {***REMOVED***)]
    ...
    def test_has_node(self):
        ...
        assert not G.has_node({1: 1***REMOVED***)  # no exception for nonhashable
...
***REMOVED***
    ...
    def test_degree(self):
        ...
        assert dict(G.degree()) == {0: 2, 1: 2, 2: 2***REMOVED***
        assert G.degree(0) == 2
        with pytest.raises(nx.NetworkXError):
    ...
    def test_nbunch_iter(self):
        ...
        bunch = G.nbunch_iter([0, 1, 2, {***REMOVED***])
    ...
    def test_selfloop_degree(self):
        ...
        assert dict(G.degree()) == {1: 2***REMOVED***
        assert G.degree(1) == 2
...
class BaseAttrGraphTester(BaseGraphTester):
    ...
    def test_weighted_degree(self):
        ...
        assert dict(G.degree(weight="weight")) == {1: 2, 2: 5, 3: 3***REMOVED***
        assert G.degree(1, weight="weight") == 2
        assert nodes_equal((G.degree([1], weight="weight")), [(1, 2)])

        assert nodes_equal((d for n, d in G.degree(weight="other")), [3, 7, 4])
        assert dict(G.degree(weight="other")) == {1: 3, 2: 7, 3: 4***REMOVED***
    ...
    def test_str_unnamed(self):
        ...
        assert str(G) == f"{type(G).__name__***REMOVED*** with 3 nodes and 2 edges"

    def test_str_named(self):
        G = self.Graph(name="foo")
        G.add_edges_from([(1, 2), (2, 3)])
        assert str(G) == f"{type(G).__name__***REMOVED*** named 'foo' with 3 nodes and 2 edges"
    ...
    def test_node_attr(self):
        ...
        assert nodes_equal(G.nodes(data=True), [(0, {***REMOVED***), (1, {"foo": "bar"***REMOVED***), (2, {***REMOVED***)])
        G.nodes[1]["foo"] = "baz"
        assert nodes_equal(G.nodes(data=True), [(0, {***REMOVED***), (1, {"foo": "baz"***REMOVED***), (2, {***REMOVED***)])
    ...
    def test_node_attr2(self):
        ...
        assert nodes_equal(
            G.nodes(data=True), [(0, {***REMOVED***), (1, {***REMOVED***), (2, {***REMOVED***), (3, {"foo": "bar"***REMOVED***)]
        )

    def test_edge_lookup(self):
        G = self.Graph()
        G.add_edge(1, 2, foo="bar")
        assert edges_equal(G.edges[1, 2], {"foo": "bar"***REMOVED***)
    ...
    def test_edge_attr(self):
        ...
        assert edges_equal(G.edges(data=True), [(1, 2, {"foo": "bar"***REMOVED***)])
    ...
    def test_edge_attr2(self):
        ...
        assert edges_equal(
            G.edges(data=True), [(1, 2, {"foo": "foo"***REMOVED***), (3, 4, {"foo": "foo"***REMOVED***)]
        )
        assert edges_equal(G.edges(data="foo"), [(1, 2, "foo"), (3, 4, "foo")])

    def test_edge_attr3(self):
        G = self.Graph()
        G.add_edges_from([(1, 2, {"weight": 32***REMOVED***), (3, 4, {"weight": 64***REMOVED***)], foo="foo")
        assert edges_equal(
            G.edges(data=True),
            [
                (1, 2, {"foo": "foo", "weight": 32***REMOVED***),
                (3, 4, {"foo": "foo", "weight": 64***REMOVED***),
            ],
        )
        ...
        assert edges_equal(
            G.edges(data=True), [(1, 2, {"data": 7, "spam": "bar", "bar": "foo"***REMOVED***)]
        )
    ...
    def test_edge_attr4(self):
        ...
        assert edges_equal(
            G.edges(data=True), [(1, 2, {"data": 10, "spam": "bar", "bar": "foo"***REMOVED***)]
        )

        G.adj[1][2]["data"] = 20
        assert edges_equal(
            G.edges(data=True), [(1, 2, {"data": 20, "spam": "bar", "bar": "foo"***REMOVED***)]
        )
        G.edges[1, 2]["data"] = 21  # another spelling, "edge"
        assert edges_equal(
            G.edges(data=True), [(1, 2, {"data": 21, "spam": "bar", "bar": "foo"***REMOVED***)]
        )
    ...
    def test_subgraph(self):
        ...
        H = G.subgraph(0)
        assert H.adj == {0: {***REMOVED******REMOVED***
        H = G.subgraph([])
        assert H.adj == {***REMOVED***
        assert G.adj != {***REMOVED***
    ...
    def test_selfloops_attr(self):
        ...
        assert edges_equal(
            nx.selfloop_edges(G, data=True), [(0, 0, {***REMOVED***), (1, 1, {"weight": 2***REMOVED***)]
        )
        assert edges_equal(
...
class TestGraph(BaseAttrGraphTester):
    ...
    def setup_method(self):
        ...
        ed1, ed2, ed3 = ({***REMOVED***, {***REMOVED***, {***REMOVED***)
        self.k3adj = {0: {1: ed1, 2: ed2***REMOVED***, 1: {0: ed1, 2: ed3***REMOVED***, 2: {0: ed2, 1: ed3***REMOVED******REMOVED***
        self.k3edges = [(0, 1), (0, 2), (1, 2)]
        self.k3nodes = [0, 1, 2]
        self.K3 = self.Graph()
        self.K3._adj = self.k3adj
        self.K3._node = {***REMOVED***
        self.K3._node[0] = {***REMOVED***
        self.K3._node[1] = {***REMOVED***
        self.K3._node[2] = {***REMOVED***
    ...
    def test_data_input(self):
        G = self.Graph({1: [2], 2: [1]***REMOVED***, name="test")
        assert G.name == "test"
        assert sorted(G.adj.items()) == [(1, {2: {***REMOVED******REMOVED***), (2, {1: {***REMOVED******REMOVED***)]

    def test_adjacency(self):
        G = self.K3
        assert dict(G.adjacency()) == {
            0: {1: {***REMOVED***, 2: {***REMOVED******REMOVED***,
            1: {0: {***REMOVED***, 2: {***REMOVED******REMOVED***,
            2: {0: {***REMOVED***, 1: {***REMOVED******REMOVED***,
        ***REMOVED***

    def test_getitem(self):
        G = self.K3
        assert G.adj[0] == {1: {***REMOVED***, 2: {***REMOVED******REMOVED***
        assert G[0] == {1: {***REMOVED***, 2: {***REMOVED******REMOVED***
    ...
    def test_add_node(self):
        G = self.Graph()
        G.add_node(0)
        assert G.adj == {0: {***REMOVED******REMOVED***
        # test add attributes
        G.add_node(1, c="red")
        G.add_node(2, c="blue")
        G.add_node(3, c="red")
    ...
    def test_add_nodes_from(self):
        ...
        assert G.adj == {0: {***REMOVED***, 1: {***REMOVED***, 2: {***REMOVED******REMOVED***
        # test add attributes
        ...
        H.add_nodes_from([0, (1, {"c": "green"***REMOVED***), (3, {"c": "cyan"***REMOVED***)], c="red")
    ...
    def test_remove_node(self):
        G = self.K3.copy()
        G.remove_node(0)
        assert G.adj == {1: {2: {***REMOVED******REMOVED***, 2: {1: {***REMOVED******REMOVED******REMOVED***
        with pytest.raises(nx.NetworkXError):
            G.remove_node(-1)
    ...
    def test_remove_nodes_from(self):
        G = self.K3.copy()
        G.remove_nodes_from([0, 1])
        assert G.adj == {2: {***REMOVED******REMOVED***
        G.remove_nodes_from([-1])  # silent fail

    def test_add_edge(self):
        G = self.Graph()
        G.add_edge(0, 1)
        assert G.adj == {0: {1: {***REMOVED******REMOVED***, 1: {0: {***REMOVED******REMOVED******REMOVED***
        G = self.Graph()
        G.add_edge(*(0, 1))
        assert G.adj == {0: {1: {***REMOVED******REMOVED***, 1: {0: {***REMOVED******REMOVED******REMOVED***
        G = self.Graph()
    ...
    def test_add_edges_from(self):
        G = self.Graph()
        G.add_edges_from([(0, 1), (0, 2, {"weight": 3***REMOVED***)])
        assert G.adj == {
            0: {1: {***REMOVED***, 2: {"weight": 3***REMOVED******REMOVED***,
            1: {0: {***REMOVED******REMOVED***,
            2: {0: {"weight": 3***REMOVED******REMOVED***,
        ***REMOVED***
        G = self.Graph()
        G.add_edges_from([(0, 1), (0, 2, {"weight": 3***REMOVED***), (1, 2, {"data": 4***REMOVED***)], data=2)
        assert G.adj == {
            0: {1: {"data": 2***REMOVED***, 2: {"weight": 3, "data": 2***REMOVED******REMOVED***,
            1: {0: {"data": 2***REMOVED***, 2: {"data": 4***REMOVED******REMOVED***,
            2: {0: {"weight": 3, "data": 2***REMOVED***, 1: {"data": 4***REMOVED******REMOVED***,
        ***REMOVED***
    ...
    def test_remove_edge(self):
        G = self.K3.copy()
        G.remove_edge(0, 1)
        assert G.adj == {0: {2: {***REMOVED******REMOVED***, 1: {2: {***REMOVED******REMOVED***, 2: {0: {***REMOVED***, 1: {***REMOVED******REMOVED******REMOVED***
        with pytest.raises(nx.NetworkXError):
            G.remove_edge(-1, 0)
    ...
    def test_edges_data(self):
        G = self.K3
        all_edges = [(0, 1, {***REMOVED***), (0, 2, {***REMOVED***), (1, 2, {***REMOVED***)]
        assert edges_equal(G.edges(data=True), all_edges)
        assert edges_equal(G.edges(0, data=True), [(0, 1, {***REMOVED***), (0, 2, {***REMOVED***)])
    ...
    def test_get_edge_data(self):
        G = self.K3.copy()
        assert G.get_edge_data(0, 1) == {***REMOVED***
        assert G[0][1] == {***REMOVED***
    ...
    def test_update(self):
        ...
        G = self.K3.copy()
        G.update(nodes=[3, (4, {"size": 2***REMOVED***)], edges=[(4, 5), (6, 7, {"weight": 2***REMOVED***)])
        nlist = [
            (0, {***REMOVED***),
            (1, {***REMOVED***),
            (2, {***REMOVED***),
        ...
        G = self.K3.copy()
        G.update([(4, 5), (6, 7, {"weight": 2***REMOVED***)], [3, (4, {"size": 2***REMOVED***)])
        assert sorted(G.nodes.data()) == nlist
        assert sorted(G.edges.data()) == elist
        assert G.graph == {***REMOVED***
        ...
        H = self.Graph()
        H.update(nodes=[3, 4])
        assert H.nodes ^ {3, 4***REMOVED*** == set()
        assert H.size() == 0

        # update edges only
        H = self.Graph()
        H.update(edges=[(3, 4)])
        assert sorted(H.edges.data()) == [(3, 4, {***REMOVED***)]
        assert H.size() == 1
...
class TestEdgeSubgraph:
    ...
    def setup_method(self):
        ...
        for i in range(5):
            G.nodes[i]["name"] = f"node{i***REMOVED***"
