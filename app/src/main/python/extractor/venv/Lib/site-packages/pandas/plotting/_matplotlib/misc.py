...
def scatter_matrix(
    ...
    **kwds,
    ...
    hist_kwds = hist_kwds or {***REMOVED***
    density_kwds = density_kwds or {***REMOVED***
...
def radviz(
    ...
    **kwds,
    ...
    to_plot: dict[Hashable, list[list]] = {***REMOVED***
...
def parallel_coordinates(
    ...
    **kwds,
    ...
    if axvlines_kwds is None:
        axvlines_kwds = {"linewidth": 1, "color": "black"***REMOVED***
...
def lag_plot(series: Series, lag: int = 1, ax: Axes | None = None, **kwds) -> Axes:
    ...
    if ax is None:
        ax = plt.gca()
    ax.set_xlabel("y(t)")
    ax.set_ylabel(f"y(t + {lag***REMOVED***)")
