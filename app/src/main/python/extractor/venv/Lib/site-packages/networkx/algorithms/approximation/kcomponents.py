...
def k_components(G, min_density=0.95):
    ...
    # Exact solution for k = {1,2***REMOVED***
...
def _cliques_heuristic(G, H, k, min_density):
    ...
    for i, c_value in enumerate(sorted(set(h_cnumber.values()), reverse=True)):
        cands = {n for n, c in h_cnumber.items() if c == c_value***REMOVED***
        # Skip checking for overlap for the highest core value
        if i == 0:
            overlap = False
        else:
            overlap = set.intersection(
                *[{x for x in H[n] if x not in cands***REMOVED*** for n in cands]
***REMOVED***
...
class _AntiGraph(nx.Graph):
    ...
    def __getitem__(self, n):
        ...
        return {
            node: all_edge_dict for node in set(self._adj) - set(self._adj[n]) - {n***REMOVED***
        ***REMOVED***
    ...
    def neighbors(self, n):
        ...
        """
        try:
            return iter(set(self._adj) - set(self._adj[n]) - {n***REMOVED***)
    ...
    class AntiAtlasView(Mapping):
        ...
        def __getitem__(self, nbr):
            nbrs = set(self._graph._adj) - set(self._atlas) - {self._node***REMOVED***
            if nbr in nbrs:
    ...
    class AntiDegreeView(nx.reportviews.DegreeView):
        def __iter__(self):
            ...
            for n in self._nodes:
                nbrs = all_nodes - set(self._succ[n]) - {n***REMOVED***
                yield (n, len(nbrs))

        def __getitem__(self, n):
            nbrs = set(self._succ) - set(self._succ[n]) - {n***REMOVED***
    ...
    def adjacency(self):
        ...
        """
        for n in self._adj:
            yield (n, set(self._adj) - set(self._adj[n]) - {n***REMOVED***)
