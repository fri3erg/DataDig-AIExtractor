...
class RoundtripTest:
    def roundtrip(self, save_func, *args, **kwargs):
        ...
        """
        save_kwds = kwargs.get('save_kwds', {***REMOVED***)
        load_kwds = kwargs.get('load_kwds', {"allow_pickle": True***REMOVED***)
    ...
    def test_mmap(self):
        ...
        self.roundtrip(a, file_on_disk=True, load_kwds={'mmap_mode': 'r'***REMOVED***)
...
class TestSavezLoad(RoundtripTest):
    ...
    @pytest.mark.parametrize("count, expected_repr", [
        (1, "NpzFile {fname!r***REMOVED*** with keys: arr_0"),
        (5, "NpzFile {fname!r***REMOVED*** with keys: arr_0, arr_1, arr_2, arr_3, arr_4"),
        # _MAX_REPR_ARRAY_COUNT is 5, so files with more than 5 keys are
        # expected to end in '...'
        (6, "NpzFile {fname!r***REMOVED*** with keys: arr_0, arr_1, arr_2, arr_3, arr_4..."),
    ])
...
class LoadTxtBase:
    ...
    def test_converters_decode(self):
        ...
        x = self.loadfunc(c, dtype=np.str_,
                          converters={0: lambda x: x.decode('UTF-8')***REMOVED***)
    ...
    def test_converters_nodecode(self):
        ...
        with temppath() as path:
            ...
            x = self.loadfunc(path, dtype=np.str_,
                              converters={0: lambda x: x + 't'***REMOVED***,
                              encoding='UTF-8')
            a = np.array([utf8 + 't'])
            assert_array_equal(x, a)
...
class TestLoadTxt(LoadTxtBase):
    ...
    def test_missing(self):
        ...
        c.seek(0)
        x = np.loadtxt(c, dtype=int, delimiter=',',
                       converters={3: lambda s: int(s or - 999)***REMOVED***)
...
***REMOVED***
    ...
    def test_unused_converter(self):
        ...
        data = np.loadtxt(c, usecols=(1,),
                          converters={0: lambda s: int(s, 16)***REMOVED***)
        assert_array_equal(data, [21, 42])

        c.seek(0)
        data = np.loadtxt(c, usecols=(1,),
                          converters={1: lambda s: int(s, 16)***REMOVED***)
    ...
    def test_unpack_structured(self):
        txt = TextIO("M 21 72\nF 35 58")
        dt = {'names': ('a', 'b', 'c'), 'formats': ('|S1', '<i4', '<f4')***REMOVED***
    ...
    def test_max_rows_empty_lines(self, skip, data):
        with pytest.warns(UserWarning,
                    match=f"Input line 3.*max_rows={3-skip***REMOVED***"):
...
class TestFromTxt(LoadTxtBase):
    ...
    def test_header(self):
        ...
        control = {'gender': np.array([b'M', b'F']),
                   ...
                   'weight': np.array([75.0, 60.0])***REMOVED***
...
M   33  21.99
    ...
    def test_file_is_closed_on_error(self):
        ...
        with tempdir() as tmpdir:
            ...
            with open(fpath, "wb") as f:
                f.write('\N{GREEK PI SYMBOL***REMOVED***'.encode())
    ...
    def test_converters_with_usecols_and_names(self):
        ...
        with warnings.catch_warnings(record=True) as w:
            ...
            test = np.genfromtxt(data, usecols=('A', 'C', 'D'), names=True,
                                dtype=None,
                                converters={'C': lambda s: 2 * int(s)***REMOVED***)
            assert_(w[0].category is np.VisibleDeprecationWarning)
    ...
    def test_converters_cornercases(self):
        ...
        converter = {
            'date': lambda s: strptime(s, '%Y-%m-%d %H:%M:%SZ')***REMOVED***
    ...
    def test_converters_cornercases2(self):
        ...
        converter = {
            'date': lambda s: np.datetime64(strptime(s, '%Y-%m-%d %H:%M:%SZ'))***REMOVED***
        data = TextIO('2009-02-03 12:00:00Z, 72214.0')
        test = np.genfromtxt(data, delimiter=',', dtype=None,
                            names=['date', 'stid'], converters=converter)
        control = np.array((datetime(2009, 2, 3), 72214.),
    ...
    def test_tricky_converter_bug1666(self):
        ...
        test = np.genfromtxt(s, delimiter=',', converters={0: cnv***REMOVED***)
    ...
    def test_dtype_with_converters(self):
        ...
        test = np.genfromtxt(TextIO(dstr,),
                            delimiter=";", dtype=float, converters={0: bytes***REMOVED***)
        control = np.array([('2009', 23., 46)],
                           dtype=[('f0', '|S4'), ('f1', float), ('f2', float)])
        assert_equal(test, control)
        test = np.genfromtxt(TextIO(dstr,),
                            delimiter=";", dtype=float, converters={0: float***REMOVED***)
        control = np.array([2009., 23., 46],)
        assert_equal(test, control)
    ...
    def test_dtype_with_converters_and_usecols(self):
        ...
        conv = {0: int, 1: int, 2: int, 3: lambda r: dmap[r.decode()]***REMOVED***
    ...
    def test_userconverters_with_explicit_dtype(self):
        ...
        test = np.genfromtxt(data, delimiter=",", names=None, dtype=float,
                             usecols=(2, 3), converters={2: bytes***REMOVED***)
    ...
    def test_utf8_userconverters_with_explicit_dtype(self):
        ...
        with temppath() as path:
            ...
            test = np.genfromtxt(path, delimiter=",", names=None, dtype=float,
                                 usecols=(2, 3), converters={2: np.compat.unicode***REMOVED***,
                                 encoding='UTF-8')
    ...
    def test_user_missing_values(self):
        ...
        test = np.genfromtxt(TextIO(data),
                            missing_values={0: -9, 1: -99, 2: -999j***REMOVED***, usemask=True, **basekwargs)
        control = ma.array([(0, 0.0, 0j), (1, -999, 1j),
                            (-9, 2.2, -999j), (3, -99, 3j)],
    ...
    def test_user_filling_values(self):
        ...
        kwargs = dict(delimiter=",",
                      ...
                      filling_values={0: 0, 'b': 0, 2: -999***REMOVED***)
    ...
    def test_inconsistent_dtype(self):
        ...
        converters = {4: lambda x: "(%s)" % x.decode()***REMOVED***
    ...
    def test_recfromcsv(self):
        ...
        #gh-10394
        data = TextIO('color\n"red"\n"blue"')
        test = np.recfromcsv(data, converters={0: lambda x: x.strip(b'\"')***REMOVED***)
