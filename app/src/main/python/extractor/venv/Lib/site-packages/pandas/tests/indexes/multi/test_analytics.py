...
def test_groupby(idx):
    ...
    labels = idx.tolist()
    exp = {1: labels[:3], 2: labels[3:]***REMOVED***
    tm.assert_dict_equal(groups, exp)

    # GH5620
    groups = idx.groupby(idx)
    exp = {key: [key] for key in idx***REMOVED***
    tm.assert_dict_equal(groups, exp)
...
@pytest.mark.parametrize(
    "mapper",
    [
        lambda values, idx: {i: e for e, i in zip(values, idx)***REMOVED***,
...
def test_numpy_ufuncs(idx, func):
    ...
    msg = (
        ...
        f"has no callable {func.__name__***REMOVED*** method"
    )
...
def test_numpy_type_funcs(idx, func):
    msg = (
        f"ufunc '{func.__name__***REMOVED***' not supported for the input types, and the inputs "
