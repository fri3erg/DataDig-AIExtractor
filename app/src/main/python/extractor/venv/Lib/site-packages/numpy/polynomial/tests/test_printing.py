...
class TestFormat:
    ...
    def test_empty_formatstr(self):
        ...
        assert_equal(f"{p***REMOVED***", "1.0 + 2.0 x + 3.0 x**2")
...
def test_symbol(poly, tgt):
    ...
    assert_equal(f"{p:unicode***REMOVED***", tgt)
...
class TestLatexRepr:
    ...
    def test_simple_polynomial(self):
        ...
        assert_equal(self.as_latex(p),
            r'$x \mapsto 1.0 + 2.0\,x + 3.0\,x^{2***REMOVED***$')

        # translated input
        p = poly.Polynomial([1, 2, 3], domain=[-2, 0])
        assert_equal(self.as_latex(p),
            r'$x \mapsto 1.0 + 2.0\,\left(1.0 + x\right) + 3.0\,\left(1.0 + x\right)^{2***REMOVED***$')

        # scaled input
        p = poly.Polynomial([1, 2, 3], domain=[-0.5, 0.5])
        assert_equal(self.as_latex(p),
            r'$x \mapsto 1.0 + 2.0\,\left(2.0x\right) + 3.0\,\left(2.0x\right)^{2***REMOVED***$')

        # affine input
        p = poly.Polynomial([1, 2, 3], domain=[-1, 0])
        assert_equal(self.as_latex(p),
            r'$x \mapsto 1.0 + 2.0\,\left(1.0 + 2.0x\right) + 3.0\,\left(1.0 + 2.0x\right)^{2***REMOVED***$')

    def test_basis_func(self):
        p = poly.Chebyshev([1, 2, 3])
        assert_equal(self.as_latex(p),
            r'$x \mapsto 1.0\,{T***REMOVED***_{0***REMOVED***(x) + 2.0\,{T***REMOVED***_{1***REMOVED***(x) + 3.0\,{T***REMOVED***_{2***REMOVED***(x)$')
        # affine input - check no surplus parens are added
        p = poly.Chebyshev([1, 2, 3], domain=[-1, 0])
        assert_equal(self.as_latex(p),
            r'$x \mapsto 1.0\,{T***REMOVED***_{0***REMOVED***(1.0 + 2.0x) + 2.0\,{T***REMOVED***_{1***REMOVED***(1.0 + 2.0x) + 3.0\,{T***REMOVED***_{2***REMOVED***(1.0 + 2.0x)$')

    def test_multichar_basis_func(self):
        p = poly.HermiteE([1, 2, 3])
        assert_equal(self.as_latex(p),
            r'$x \mapsto 1.0\,{He***REMOVED***_{0***REMOVED***(x) + 2.0\,{He***REMOVED***_{1***REMOVED***(x) + 3.0\,{He***REMOVED***_{2***REMOVED***(x)$')

    def test_symbol_basic(self):
        # default input
        p = poly.Polynomial([1, 2, 3], symbol='z')
        assert_equal(self.as_latex(p),
            r'$z \mapsto 1.0 + 2.0\,z + 3.0\,z^{2***REMOVED***$')
...
***REMOVED***,
        ...
        assert_equal(
            ...
            (
                ...
                r'\left(1.0 + 2.0z\right)^{2***REMOVED***$'
***REMOVED***,
        )
...
class TestPrintOptions:
    ...
    def test_latex(self):
        ...
        assert_equal(p._repr_latex_(),
            r'$x \mapsto \text{0.5***REMOVED*** + \text{0.14285714***REMOVED***\,x + '
            r'\text{14285714.28571429***REMOVED***\,x^{2***REMOVED*** + '
            r'\text{(1.42857143e+08)***REMOVED***\,x^{3***REMOVED***$')
        
        with printoptions(precision=3):
            assert_equal(p._repr_latex_(),
                r'$x \mapsto \text{0.5***REMOVED*** + \text{0.143***REMOVED***\,x + '
                r'\text{14285714.286***REMOVED***\,x^{2***REMOVED*** + \text{(1.429e+08)***REMOVED***\,x^{3***REMOVED***$')
    ...
    def test_non_finite(self):
        ...
        assert p._repr_latex_() == r'$x \mapsto \text{nan***REMOVED*** + \text{inf***REMOVED***\,x$'
        with printoptions(nanstr='NAN', infstr='INF'):
            assert str(p) == 'NAN + INF x'
            assert p._repr_latex_() == \
                r'$x \mapsto \text{NAN***REMOVED*** + \text{INF***REMOVED***\,x$'
