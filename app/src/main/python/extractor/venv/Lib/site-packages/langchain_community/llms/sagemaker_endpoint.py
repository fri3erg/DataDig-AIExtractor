...
class LineIterator:
    ...
    b'{"outputs": [" a"]***REMOVED***\n'
    b'{"outputs": [" challenging"]***REMOVED***\n'
    b'{"outputs": [" problem"]***REMOVED***\n'
    ...
    ...
    {'PayloadPart': {'Bytes': b'{"outputs": '***REMOVED******REMOVED***
    {'PayloadPart': {'Bytes': b'[" problem"]***REMOVED***\n'***REMOVED******REMOVED***
        ...
        .. code-block:: python
            ...
            class ContentHandler(ContentHandlerBase):
                ...
                def transform_input(self, prompt: str, model_kwargs: Dict) -> bytes:
                    input_str = json.dumps({prompt: prompt, **model_kwargs***REMOVED***)
...
***REMOVED***
    ...
    def _identifying_params(self) -> Mapping[str, Any]:
        ...
        return {
            **{"endpoint_name": self.endpoint_name***REMOVED***,
    ...
    def _call(
        ...
        **kwargs: Any,
        ...
        """
        _model_kwargs = self.model_kwargs or {***REMOVED***
        _model_kwargs = {**_model_kwargs, **kwargs***REMOVED***
        _endpoint_kwargs = self.endpoint_kwargs or {***REMOVED***
    ...
    ***REMOVED***
                ...
                raise ValueError(f"Error raised by streaming inference endpoint: {e***REMOVED***")
        else:
            try:
