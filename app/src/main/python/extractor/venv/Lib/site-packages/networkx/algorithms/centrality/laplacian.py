...
def laplacian_centrality(
    ...
    .. math::
        ...
        C_L(u_i,G) = \frac{(\Delta E)_i***REMOVED***{E_L (G)***REMOVED*** = \frac{E_L (G)-E_L (G_i)***REMOVED***{E_L (G)***REMOVED***

        E_L (G) = \sum_{i=0***REMOVED***^n \lambda_i^2
    ...
    >>> sorted((v, f"{c:0.2f***REMOVED***") for v, c in laplacian_centrality(G).items())
    ...
    laplace_centralities_dict = {***REMOVED***
