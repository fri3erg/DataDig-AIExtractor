...
class SubArray(np.ndarray):
    ...
    def __new__(cls,arr,info={***REMOVED***):
    ...
    def __array_finalize__(self, obj):
        ...
        self.info = getattr(obj, 'info', {***REMOVED***).copy()
        return
...
class MSubArray(SubArray, MaskedArray):
    ...
    def __new__(cls, data, info={***REMOVED***, mask=nomask):
...
class ComplicatedSubArray(SubArray):
    ...
    def __str__(self):
        return f'myprefix {self.view(SubArray)***REMOVED*** mypostfix'
...
class WrappedArray(NDArrayOperatorsMixin):
    ...
    def __repr__(self):
        return f"{self.__class__.__name__***REMOVED***(\n{self._array***REMOVED***\n{self.attrs***REMOVED***\n)"
...
class TestSubclassing:
    ...
    def test_attributepropagation(self):
        ...
        assert_equal(z._data.info, {***REMOVED***)
        #
        z = (ym+1)
        assert_(isinstance(z, MaskedArray))
        ...
        #
        xsub = subarray(x, info={'name':'x'***REMOVED***)
    ...
    def test_subclasspreservation(self):
        ...
        xsub = MSubArray(x, mask=m, info={'xsub':xinfo***REMOVED***)
        #
    ...
    def test_subclass_repr(self):
        ...
        assert_startswith(repr(mxsub),
            f'masked_{SubArray.__name__***REMOVED***(data=[--, 1, --, 3, 4]')
