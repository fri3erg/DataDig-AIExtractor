...
def could_be_isomorphic(G1, G2):
    ...
    c1 = {n: sum(1 for c in clqs_1 if n in c) for n in G1***REMOVED***  # number of cliques
    ...
    c2 = {n: sum(1 for c in clqs_2 if n in c) for n in G2***REMOVED***  # number of cliques
