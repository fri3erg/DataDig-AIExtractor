...
class GroupByIndexingMixin:
    ...
    def _make_mask_from_positional_indexer(
        ...
        if is_list_like(arg):
            ...
            raise TypeError(
                f"Invalid index {type(arg)***REMOVED***. "
    ...
    def _make_mask_from_tuple(self, args: tuple) -> bool | np.ndarray:
        ...
        for arg in args:
            if is_integer(arg):
                ...
                raise ValueError(
                    f"Invalid argument {type(arg)***REMOVED***. Should be int or slice."
    ***REMOVED***
    ...
    def _make_mask_from_slice(self, arg: slice) -> bool | np.ndarray:
        ...
        if step is not None and step < 0:
            raise ValueError(f"Invalid step {step***REMOVED***. Must be non-negative")
