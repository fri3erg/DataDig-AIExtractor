...
"""
typedefs[
    'complex_long_double'] = 'typedef struct {long double r,i;***REMOVED*** complex_long_double;'
typedefs['complex_float'] = 'typedef struct {float r,i;***REMOVED*** complex_float;'
typedefs['complex_double'] = 'typedef struct {double r,i;***REMOVED*** complex_double;'
...
#define TRYPYARRAYTEMPLATE(ctype,typecode) \\
        ...
        if (!(arr=(PyArrayObject *)obj)) {fprintf(stderr,\"TRYPYARRAYTEMPLATE:\");PRINTPYOBJERR(obj);return 0;***REMOVED***\\
        if (PyArray_DESCR(arr)->type==typecode)  {*(ctype *)(PyArray_DATA(arr))=*v; return 1;***REMOVED***\\
...
#define TRYCOMPLEXPYARRAYTEMPLATE(ctype,typecode)\\
        ...
        if (!obj) return -2;\\
        if (!PyArray_Check(obj)) return -1;\\
        if (!(arr=(PyArrayObject *)obj)) {fprintf(stderr,\"TRYCOMPLEXPYARRAYTEMPLATE:\");PRINTPYOBJERR(obj);return 0;***REMOVED***\\
...
#         ***REMOVED***\\
#         if ((PyObject *)arr != obj) { Py_DECREF(arr); ***REMOVED***\\
#         return 1;\\
#     ***REMOVED***
# """
...
#define MEMCOPY(to,from,n)\\
    do { FAILNULL(to); FAILNULL(from); (void)memcpy(to,from,n); ***REMOVED*** while (0)
"""
...
#define STRINGFREE(str) do {if (!(str == NULL)) free(str);***REMOVED*** while (0)
"""
...
#define STRINGCOPY(to,from)\\
    do { FAILNULL(to); FAILNULL(from); (void)strcpy(to,from); ***REMOVED*** while (0)
"""
...
character_from_pyobj(character* v, PyObject *obj, const char *errmess) {
    if (PyBytes_Check(obj)) {
        ...
        *v = PyBytes_AS_STRING(obj)[0];
        return 1;
    ***REMOVED*** else if (PyUnicode_Check(obj)) {
        ...
        if (tmp != NULL) {
            *v = PyBytes_AS_STRING(tmp)[0];
            ...
            return 1;
        ***REMOVED***
    ***REMOVED*** else if (PyArray_Check(obj)) {
        PyArrayObject* arr = (PyArrayObject*)obj;
        if (F2PY_ARRAY_IS_CHARACTER_COMPATIBLE(arr)) {
            *v = PyArray_BYTES(arr)[0];
            return 1;
        ***REMOVED*** else if (F2PY_IS_UNICODE_ARRAY(arr)) {
            ...
            ***REMOVED***
        ***REMOVED***
    ***REMOVED*** else if (PySequence_Check(obj)) {
...
double_from_pyobj(double* v, PyObject *obj, const char *errmess)
{
    ...
    ***REMOVED***
    ...
    if (tmp) {
        if (double_from_pyobj(v,tmp,errmess)) {Py_DECREF(tmp); return 1;***REMOVED***
        Py_DECREF(tmp);
    ***REMOVED***
    {
        PyObject* err = PyErr_Occurred();
