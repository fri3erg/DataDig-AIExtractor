    ...
    ***REMOVED***
    ...
    def _parse_snippets(self, results: dict) -> List[str]:
        ...
        if results.get("answerBox"):
            answer_box = results.get("answerBox", {***REMOVED***)
        ...
        if results.get("knowledgeGraph"):
            kg = results.get("knowledgeGraph", {***REMOVED***)
            title = kg.get("title")
            entity_type = kg.get("type")
            if entity_type:
                snippets.append(f"{title***REMOVED***: {entity_type***REMOVED***.")
            description = kg.get("description")
            if description:
                snippets.append(description)
            for attribute, value in kg.get("attributes", {***REMOVED***).items():
                snippets.append(f"{title***REMOVED*** {attribute***REMOVED***: {value***REMOVED***.")

        for result in results[self.result_key_for_type[self.type]][: self.k]:
            if "snippet" in result:
                snippets.append(result["snippet"])
            for attribute, value in result.get("attributes", {***REMOVED***).items():
                snippets.append(f"{attribute***REMOVED***: {value***REMOVED***.")
    ...
    def _google_serper_api_results(
        ...
        ***REMOVED***
        params = {
            "q": search_term,
            **{key: value for key, value in kwargs.items() if value is not None***REMOVED***,
        ***REMOVED***
        response = requests.post(
            f"https://google.serper.dev/{search_type***REMOVED***", headers=headers, params=params
        )
    ...
    async def _async_google_serper_search_results(
        ...
        headers = {
            ...
            "Content-Type": "application/json",
        ***REMOVED***
        url = f"https://google.serper.dev/{search_type***REMOVED***"
        params = {
            "q": search_term,
            **{key: value for key, value in kwargs.items() if value is not None***REMOVED***,
        ***REMOVED***
