...
***REMOVED***
    ...
    def _validate_min_compression_size(self, min_size):
        ...
        if min_size is not None:
            error_msg_base = (
                f'Invalid value "{min_size***REMOVED***" for '
                'request_min_compression_size_bytes.'
***REMOVED***
            try:
                ...
                msg = (
                    f'{error_msg_base***REMOVED*** Value must be an integer. '
                    f'Received {type(min_size)***REMOVED*** instead.'
    ***REMOVED***
                raise botocore.exceptions.InvalidConfigError(error_msg=msg)
            if not min_allowed_min_size <= min_size <= max_allowed_min_size:
                msg = (
                    f'{error_msg_base***REMOVED*** Value must be between '
                    f'{min_allowed_min_size***REMOVED*** and {max_allowed_min_size***REMOVED***.'
    ***REMOVED***
                raise botocore.exceptions.InvalidConfigError(error_msg=msg)
    ...
    def _build_endpoint_resolver(
        ...
        # etc.
        s3_config_raw = self.compute_s3_config(client_config) or {***REMOVED***
        ...
        if client_config is not None:
            client_context = client_config.client_context_params or {***REMOVED***
        else:
            client_context = {***REMOVED***
...
***REMOVED***
        if (
            ...
            logger.warning(
                ...
                f'maximum length of {USERAGENT_APPID_MAXLEN***REMOVED*** characters.'
***REMOVED***
