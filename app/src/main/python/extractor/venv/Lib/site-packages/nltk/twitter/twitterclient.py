    ...
    def sample(self):
        ...
        while self.do_continue:
            ...
            try:
                ...
                if e is not None:
                    print(f"Error (stream will continue): {e***REMOVED***")
                continue
...
class Query(Twython):
    ...
    def expand_tweetids(self, ids_f, verbose=True):
        ...
        if verbose:
            print(f"Counted {len(ids)***REMOVED*** Tweet IDs in {ids_f***REMOVED***.")
...
***REMOVED***
    ...
    ***REMOVED***
                ...
                print(f"Waiting for 15 minutes -{e***REMOVED***")
                time.sleep(15 * 60)  # wait 15 minutes
                continue
            except TwythonError as e:
                print(f"Fatal error in Twython request -{e***REMOVED***")
...
class TweetViewer(TweetHandlerI):
    ...
    def on_finish(self):
        print(f"Written {self.counter***REMOVED*** Tweets")
...
class TweetWriter(TweetHandlerI):
    ...
    def timestamped_file(self):
        ...
        if self.gzip_compress:
            ...
            suffix = ""
        outfile = f"{fname***REMOVED***.{timestamp***REMOVED***.json{suffix***REMOVED***"
        return outfile
    ...
    def handle(self, data):
        ...
        if self.startingup:
            ...
            print(f"Writing to {self.fname***REMOVED***")
