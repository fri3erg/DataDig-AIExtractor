...
***REMOVED***,
    ...
    def test_sample_random_state(self, func_str, arg, frame_or_series):
        # GH#32503
        obj = DataFrame({"col1": range(10, 20), "col2": range(20, 30)***REMOVED***)
    ...
    def test_sample_upsampling_without_replacement(self, frame_or_series):
        ...
        obj = DataFrame({"A": list("abc")***REMOVED***)
        obj = tm.get_obj(obj, frame_or_series)
...
class TestSampleDataFrame:
    ...
    def test_sample(self):
        ...
        # Test axis argument
        df = DataFrame({"col1": range(10), "col2": ["a"] * 10***REMOVED***)
    ...
    def test_sample_axis1(self):
        ...
        df = DataFrame(
            {"col1": range(10, 20), "col2": range(20, 30), "colString": ["a"] * 10***REMOVED***
        )
    ...
    def test_sample_aligns_weights_with_frame(self):
        ...
        df = DataFrame({"col1": [5, 6, 7], "col2": ["a", "b", "c"]***REMOVED***, index=[9, 5, 3])
    ...
    def test_sample_does_not_modify_weights(self):
        ...
        df = DataFrame({"values": [1, 1, 1], "weights": [1, np.nan, np.nan]***REMOVED***)
