...
class TestAsIntegerRatio:
    ...
    def test_roundtrip(self, ftype, frac_vals, exp_vals):
        for frac, exp in zip(frac_vals, exp_vals):
            ...
            assert_equal(nf / df, f, "{***REMOVED***/{***REMOVED***".format(n, d))
...
class TestClassGetItem:
    ...
    def test_abc_complexfloating_subscript_tuple(self, arg_len: int) -> None:
        ...
        if arg_len in (1, 2):
            ...
            match = f"Too {'few' if arg_len == 0 else 'many'***REMOVED*** arguments"
...
class TestBitCount:
    ...
    def test_small(self, itype):
        for a in range(max(np.iinfo(itype).min, 0), 128):
            msg = f"Smoke test for {itype***REMOVED***({a***REMOVED***).bit_count()"
