...
class BaseParser:
    ...
    def update_kwargs(self, kwargs):
        kwargs = kwargs.copy()
        kwargs.update({"engine": self.engine, "low_memory": self.low_memory***REMOVED***)
...
def _get_all_parser_float_precision_combinations():
    ...
    for parser, parser_id in zip(_all_parsers, _all_parser_ids):
        ...
        for precision in parser.float_precision_choices:
            ...
            params.append(param)
            ids.append(f"{parser_id***REMOVED***-{precision***REMOVED***")

    return {"params": params, "ids": ids***REMOVED***
...
_encoding_fmts = [
    f"{prefix***REMOVED***{sep***REMOVED***{{0***REMOVED******REMOVED***" for sep in _encoding_seps for prefix in _encoding_prefixes
]
