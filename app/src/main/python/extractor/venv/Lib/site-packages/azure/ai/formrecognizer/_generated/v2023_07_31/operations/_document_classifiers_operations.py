...
def build_get_classifier_request(
    ...
    **kwargs: Any
    ...
    # Construct URL
    _url = kwargs.pop("template_url", "/documentClassifiers/{classifierId***REMOVED***")
    path_format_arguments = {
        "classifierId": _SERIALIZER.url("classifier_id", classifier_id, 'str', max_length=64, min_length=0, pattern=r'^[a-zA-Z0-9][a-zA-Z0-9._~-]{1,63***REMOVED***$'),
    ***REMOVED***
...
def build_classify_document_request_initial(
    ...
    **kwargs: Any
    ...
    # Construct URL
    _url = kwargs.pop("template_url", "/documentClassifiers/{classifierId***REMOVED***:analyze")
    path_format_arguments = {
        "classifierId": _SERIALIZER.url("classifier_id", classifier_id, 'str', max_length=64, min_length=0, pattern=r'^[a-zA-Z0-9][a-zA-Z0-9._~-]{1,63***REMOVED***$'),
    ***REMOVED***
...
def build_get_classify_result_request(
    ...
    **kwargs: Any
    ...
    # Construct URL
    _url = kwargs.pop("template_url", "/documentClassifiers/{classifierId***REMOVED***/analyzeResults/{resultId***REMOVED***")
    path_format_arguments = {
        "classifierId": _SERIALIZER.url("classifier_id", classifier_id, 'str', max_length=64, min_length=0, pattern=r'^[a-zA-Z0-9][a-zA-Z0-9._~-]{1,63***REMOVED***$'),
...
class DocumentClassifiersOperations:
    ...
    _build_classifier_initial.metadata = {'url': "/documentClassifiers:build"***REMOVED***  # type: ignore
...
***REMOVED***
    ...
    begin_build_classifier.metadata = {'url': "/documentClassifiers:build"***REMOVED***  # type: ignore
...
***REMOVED***
    ...
    list_classifiers.metadata = {'url': "/documentClassifiers"***REMOVED***  # type: ignore
    ...
    get_classifier.metadata = {'url': "/documentClassifiers/{classifierId***REMOVED***"***REMOVED***  # type: ignore
    ...
    delete_classifier.metadata = {'url': "/documentClassifiers/{classifierId***REMOVED***"***REMOVED***  # type: ignore
...
***REMOVED***
    ...
    _classify_document_initial.metadata = {'url': "/documentClassifiers/{classifierId***REMOVED***:analyze"***REMOVED***  # type: ignore
...
***REMOVED***
    ...
    begin_classify_document.metadata = {'url': "/documentClassifiers/{classifierId***REMOVED***:analyze"***REMOVED***  # type: ignore
    ...
    get_classify_result.metadata = {'url': "/documentClassifiers/{classifierId***REMOVED***/analyzeResults/{resultId***REMOVED***"***REMOVED***  # type: ignore
