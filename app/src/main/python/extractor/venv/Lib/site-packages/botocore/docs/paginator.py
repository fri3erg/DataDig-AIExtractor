    ...
    def document_paginators(self, section):
        ...
        for paginator_name in paginator_names:
            section.style.tocitem(
                f'{self._service_name***REMOVED***/paginator/{paginator_name***REMOVED***'
***REMOVED***
...
***REMOVED***
    ...
    def _add_paginator(self, section, paginator_name):
        ...
        breadcrumb_section.write(f' / Paginator / {paginator_name***REMOVED***')
        ...
        paginator_section.style.start_sphinx_py_class(
            class_name=(
                f'{self._client_class_name***REMOVED***.Paginator.{paginator_name***REMOVED***'
***REMOVED***
        )
        ...
        paginator_section.write(
            f"paginator = client.get_paginator('{xform_name(paginator_name)***REMOVED***')"
        )
...
***REMOVED***,
    ...
    paginate_description = (
        ...
        'from :py:meth:`{***REMOVED***.Client.{***REMOVED***`.'.format(
