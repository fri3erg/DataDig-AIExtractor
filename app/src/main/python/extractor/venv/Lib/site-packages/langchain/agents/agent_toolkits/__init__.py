...
def __getattr__(name: str) -> Any:
    ...
    if name in DEPRECATED_AGENTS:
        ...
        raise ImportError(
            f"{name***REMOVED*** has been moved to langchain experimental. "
            "See https://github.com/langchain-ai/langchain/discussions/11680"
            "for more information.\n"
            f"Please update your import statement from: `{old_path***REMOVED***` to `{new_path***REMOVED***`."
        )
    ...
    if not is_interactive_env():
        warnings.warn(
            ...
            f"`from langchain_community.agent_toolkits import {name***REMOVED***`.\n\n"
