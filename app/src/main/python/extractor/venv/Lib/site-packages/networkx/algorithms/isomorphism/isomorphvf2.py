...
class GraphMatcher:
    ...
    def __init__(self, G1, G2):
        ...
        self.G2_node_order = {n: i for i, n in enumerate(G2)***REMOVED***
    ...
    def candidate_pairs_iter(self):
        ...
        # P(s) = T1_inout x {min T2_inout***REMOVED***
        if T1_inout and T2_inout:
            ...
            # P(s) = (N_1 - M_1) x {min (N_2 - M_2)***REMOVED***
    ...
    def initialize(self):
        ...
        # See the paper for definitions of M_x and T_x^{y***REMOVED***

        # inout_1[n]  is non-zero if n is in M_1 or in T_1^{inout***REMOVED***
        # inout_2[m]  is non-zero if m is in M_2 or in T_2^{inout***REMOVED***
        #
        # The value stored is the depth of the SSR tree when the node became
        # part of the corresponding set.
        self.inout_1 = {***REMOVED***
        self.inout_2 = {***REMOVED***
...
***REMOVED***:
            ...
            for neighbor in self.G1[G1_node]:
                if neighbor in self.core_1:
                    if self.core_1[neighbor] not in self.G2[G2_node]:
                        ...
                        neighbor, G1_node
        ***REMOVED*** != self.G2.number_of_edges(self.core_1[neighbor], G2_node):
                        return False
        ...
        ***REMOVED*** < self.G2.number_of_edges(neighbor, G2_node):
                        return False
                else:
                    if self.G1.number_of_edges(
                        self.core_2[neighbor], G1_node
        ***REMOVED*** != self.G2.number_of_edges(neighbor, G2_node):
        ...
        if self.test != "mono":
            ...
            # R_terminout
            # The number of neighbors of n in T_1^{inout***REMOVED*** is equal to the
            # number of neighbors of m that are in T_2^{inout***REMOVED***, and vice versa.
            num1 = 0
            for neighbor in self.G1[G1_node]:
            ...
            # T_1^{inout***REMOVED*** is equal to the number of neighbors of m
            # that are neither in core_2 nor T_2^{inout***REMOVED***.
            num1 = 0
            for neighbor in self.G1[G1_node]:
...
class DiGraphMatcher(GraphMatcher):
    ...
    def candidate_pairs_iter(self):
        ...
        # P(s) = T1_out x {min T2_out***REMOVED***
    ...
    def initialize(self):
        ...
        # in_1[n]  is non-zero if n is in M_1 or in T_1^{in***REMOVED***
        # out_1[n] is non-zero if n is in M_1 or in T_1^{out***REMOVED***
        #
        # in_2[m]  is non-zero if m is in M_2 or in T_2^{in***REMOVED***
        # out_2[m] is non-zero if m is in M_2 or in T_2^{out***REMOVED***
        #
...
***REMOVED***:
            ...
            for predecessor in self.G1.pred[G1_node]:
                if predecessor in self.core_1:
                    if self.core_1[predecessor] not in self.G2.pred[G2_node]:
                        ...
                        predecessor, G1_node
        ***REMOVED*** != self.G2.number_of_edges(self.core_1[predecessor], G2_node):
                        return False
        ...
        ***REMOVED*** < self.G2.number_of_edges(predecessor, G2_node):
                        return False
                else:
                    if self.G1.number_of_edges(
                        self.core_2[predecessor], G1_node
            ...
            for successor in self.G1[G1_node]:
                if successor in self.core_1:
                    if self.core_1[successor] not in self.G2[G2_node]:
                        ...
                        G1_node, successor
        ***REMOVED*** != self.G2.number_of_edges(G2_node, self.core_1[successor]):
                        return False
        ...
        ***REMOVED*** < self.G2.number_of_edges(G2_node, successor):
                        return False
                else:
                    if self.G1.number_of_edges(
                        G1_node, self.core_2[successor]
        ***REMOVED*** != self.G2.number_of_edges(G2_node, successor):
        ...
        if self.test != "mono":
            ...
            # R_termin
            # The number of predecessors of n that are in T_1^{in***REMOVED*** is equal to the
            # number of predecessors of m that are in T_2^{in***REMOVED***.
            num1 = 0
            for predecessor in self.G1.pred[G1_node]:
            ...
            # The number of successors of n that are in T_1^{in***REMOVED*** is equal to the
            # number of successors of m that are in T_2^{in***REMOVED***.
            num1 = 0
            for successor in self.G1[G1_node]:
            ...
            # The number of predecessors of n that are in T_1^{out***REMOVED*** is equal to the
            # number of predecessors of m that are in T_2^{out***REMOVED***.
            num1 = 0
            for predecessor in self.G1.pred[G1_node]:
            ...
            # The number of successors of n that are in T_1^{out***REMOVED*** is equal to the
            # number of successors of m that are in T_2^{out***REMOVED***.
            num1 = 0
            for successor in self.G1[G1_node]:
            ...
            # T_1^{in***REMOVED*** nor T_1^{out***REMOVED*** is equal to the number of predecessors of m
            # that are neither in core_2 nor T_2^{in***REMOVED*** nor T_2^{out***REMOVED***.
            num1 = 0
            for predecessor in self.G1.pred[G1_node]:
            ...
            # T_1^{in***REMOVED*** nor T_1^{out***REMOVED*** is equal to the number of successors of m
            # that are neither in core_2 nor T_2^{in***REMOVED*** nor T_2^{out***REMOVED***.
            num1 = 0
            for successor in self.G1[G1_node]:
