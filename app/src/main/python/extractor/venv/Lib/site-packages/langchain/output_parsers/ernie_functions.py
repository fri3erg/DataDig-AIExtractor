...
***REMOVED***
        ...
        try:
            ...
            raise OutputParserException(f"Could not parse function call: {exc***REMOVED***")
...
class JsonOutputFunctionsParser(BaseCumulativeTransformOutputParser[Any]):
    ...
    def parse_result(self, result: List[Generation], *, partial: bool = False) -> Any:
        if len(result) != 1:
            raise OutputParserException(
                f"Expected exactly one result, but got {len(result)***REMOVED***"
***REMOVED***
        generation = result[0]
        if not isinstance(generation, ChatGeneration):
            raise OutputParserException(
...
***REMOVED***
        ...
        ***REMOVED***
            ...
            ***REMOVED***
                        ...
                        raise OutputParserException(
                            f"Could not parse function call data: {exc***REMOVED***"
            ***REMOVED***
                else:
                    try:
                        return {
