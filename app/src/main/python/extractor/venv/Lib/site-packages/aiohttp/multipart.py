...
def parse_content_disposition(
    ...
    def unescape(text: str, *, chars: str = "".join(map(re.escape, CHAR))) -> str:
        return re.sub(f"\\\\([{chars***REMOVED***])", "\\1", text)
    ...
    while parts:
        ...
        if not is_token(key):
            ...
            if is_quoted(value):
                ...
                _value = f"{value***REMOVED***;{parts[0]***REMOVED***"
                if is_quoted(_value):
                    parts.pop(0)
...
class BodyPartReader:
    ...
    async def read_chunk(self, size: int = chunk_size) -> bytes:
        ...
        if self._at_eof:
            ...
            assert (
                b"\r\n" == clrf
***REMOVED***, "reader did not read all the data or it is malformed"
        return chunk
    ...
    def _decode_content(self, data: bytes) -> bytes:
        ...
        if encoding == "identity":
            return data
        if encoding in {"deflate", "gzip"***REMOVED***:
            return ZLibDecompressor(
                encoding=encoding,
                suppress_deflate_header=True,
***REMOVED***.decompress_sync(data)

        raise RuntimeError(f"unknown content encoding: {encoding***REMOVED***")
    ...
    def _decode_content_transfer(self, data: bytes) -> bytes:
        ...
        if encoding == "base64":
            ...
            raise RuntimeError(
                "unknown content transfer encoding: {***REMOVED***" "".format(encoding)
***REMOVED***
    ...
    ***REMOVED***
    ...
    async def _read_boundary(self) -> None:
        ...
        if chunk == self._boundary:
            ...
            raise ValueError(f"Invalid boundary {chunk!r***REMOVED***, expected {self._boundary!r***REMOVED***")
...
class MultipartWriter(Payload):
    ...
    def __init__(self, subtype: str = "mixed", boundary: Optional[str] = None) -> None:
        ...
        ctype = f"multipart/{subtype***REMOVED***; boundary={self._boundary_value***REMOVED***"
    ...
    def append_payload(self, payload: Payload) -> Payload:
        ...
        if te_encoding not in ("", "base64", "quoted-printable", "binary"):
            raise RuntimeError(
                "unknown content transfer encoding: {***REMOVED***" "".format(te_encoding)
***REMOVED***
