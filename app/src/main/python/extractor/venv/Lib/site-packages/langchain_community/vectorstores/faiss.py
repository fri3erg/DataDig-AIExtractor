...
def _len_check_if_sized(x: Any, y: Any, x_name: str, y_name: str) -> None:
    if isinstance(x, Sized) and isinstance(y, Sized) and len(x) != len(y):
        raise ValueError(
            f"{x_name***REMOVED*** and {y_name***REMOVED*** expected to be equal length but "
            f"len({x_name***REMOVED***)={len(x)***REMOVED*** and len({y_name***REMOVED***)={len(y)***REMOVED***"
        )
    return
...
***REMOVED***
        ...
        if (
            ...
            warnings.warn(
                "Normalizing L2 is not applicable for metric type: {strategy***REMOVED***".format(
    ...
    def __add(
        ...
        if not isinstance(self.docstore, AddableMixin):
            raise ValueError(
                ...
                f"adding items, which {self.docstore***REMOVED*** does not"
***REMOVED***

        _len_check_if_sized(texts, metadatas, "texts", "metadatas")
        _metadatas = metadatas or ({***REMOVED*** for _ in texts)
        documents = [
        ...
        self.docstore.add({id_: doc for id_, doc in zip(ids, documents)***REMOVED***)
        starting_len = len(self.index_to_docstore_id)
        index_to_id = {starting_len + j: id_ for j, id_ in enumerate(ids)***REMOVED***
        ...
        **kwargs: Any,
        ...
        for j, i in enumerate(indices[0]):
            ...
            if not isinstance(doc, Document):
                raise ValueError(f"Could not find document for id {_id***REMOVED***, got {doc***REMOVED***")
    ...
    def delete(self, ids: Optional[List[str]] = None, **kwargs: Any) -> Optional[bool]:
        ...
        if missing_ids:
            raise ValueError(
                ...
                f"{missing_ids***REMOVED***"
***REMOVED***

        reversed_index = {id_: idx for idx, id_ in self.index_to_docstore_id.items()***REMOVED***
        ...
        self.index_to_docstore_id = {i: id_ for i, id_ in enumerate(remaining_ids)***REMOVED***
    ...
    def merge_from(self, target: FAISS) -> None:
        ...
        self.docstore.add({_id: doc for _, _id, doc in full_info***REMOVED***)
        index_to_id = {index: _id for index, _id, _ in full_info***REMOVED***
        self.index_to_docstore_id.update(index_to_id)
    ...
    def save_local(self, folder_path: str, index_name: str = "index") -> None:
        ...
        faiss = dependable_faiss_import()
        faiss.write_index(
            self.index, str(path / "{index_name***REMOVED***.faiss".format(index_name=index_name))
        )

        # save docstore and index_to_docstore_id
        with open(path / "{index_name***REMOVED***.pkl".format(index_name=index_name), "wb") as f:
    ...
    def load_local(
        ...
        **kwargs: Any,
        ...
        index = faiss.read_index(
            str(path / "{index_name***REMOVED***.faiss".format(index_name=index_name))
        )

        # load docstore and index_to_docstore_id
        with open(path / "{index_name***REMOVED***.pkl".format(index_name=index_name), "rb") as f:
