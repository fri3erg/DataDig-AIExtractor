...
def parse_and_check_json_markdown(text: str, expected_keys: List[str]) -> dict:
    ...
    try:
        ...
        raise OutputParserException(f"Got invalid JSON object. Error: {e***REMOVED***")
    for key in expected_keys:
        if key not in json_obj:
            raise OutputParserException(
                f"Got invalid return object. Expected key `{key***REMOVED***` "
                f"to be present, but got {json_obj***REMOVED***"
***REMOVED***
    return json_obj
    ...
    def parse_result(self, result: List[Generation], *, partial: bool = False) -> Any:
        ...
        if partial:
            ...
            try:
                ...
                raise OutputParserException(f"Invalid json output: {text***REMOVED***") from e
