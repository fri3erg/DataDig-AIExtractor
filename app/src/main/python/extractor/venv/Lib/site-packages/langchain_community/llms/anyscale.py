...
def create_llm_result(
    ...
    ***REMOVED***
    ...
    llm_output = {"token_usage": token_usage, "model_name": model_name***REMOVED***
...
***REMOVED***
    ...
    def _identifying_params(self) -> Mapping[str, Any]:
        ...
        return {
            **{"model_name": self.model_name***REMOVED***,
    ...
    def _invocation_params(self) -> Dict[str, Any]:
        ...
        ***REMOVED***
        return {**openai_creds, **{"model": self.model_name***REMOVED***, **super()._default_params***REMOVED***
    ...
    def _get_chat_messages(
        ...
        if len(prompts) > 1:
            raise ValueError(
                f"Anyscale currently only supports single prompt, got {prompts***REMOVED***"
***REMOVED***
        ...
        **kwargs: Any,
        ...
        for prompt in prompts:
            if self.streaming:
                ...
                choices.append(
                    {
                        "message": {"content": generation.text***REMOVED***,
    ...
    ***REMOVED***
    ...
    async def _agenerate(
        ...
        **kwargs: Any,
        ...
        _keys = {"completion_tokens", "prompt_tokens", "total_tokens"***REMOVED***
        for prompt in prompts:
            messages = self.prefix_messages + [{"role": "user", "content": prompt***REMOVED***]
            if self.streaming:
                generation: Optional[GenerationChunk] = None
