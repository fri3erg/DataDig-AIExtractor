...
def _find_workbook_part(package):
    ...
    defaults = {p.ContentType for p in package.Default***REMOVED***
...
class ExcelReader:
    ...
    def read_worksheets(self):
        comment_warning = """Cell '{0***REMOVED***':{1***REMOVED*** is part of a merged range but has a comment which will be removed because merged cells cannot contain any data."""
    ...
    def read(self):
        ...
        try:
            ...
            raise ValueError(
                f"Unable to read workbook: could not {action***REMOVED*** from {self.archive.filename***REMOVED***.\n"
