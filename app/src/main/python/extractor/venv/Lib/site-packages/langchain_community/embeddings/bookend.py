...
***REMOVED***
    ...
    def __init__(self, **kwargs: Any):
        ...
        self.auth_header = {"Authorization": "Basic {***REMOVED***".format(self.api_token)***REMOVED***
    ...
    def embed_documents(self, texts: List[str]) -> List[List[float]]:
        ...
        ***REMOVED***
        ...
        for text in texts:
            data = json.dumps(
                {"text": text, "question": None, "context": None, "instruction": None***REMOVED***
***REMOVED***
            r = requests.request(
                "POST",
