...
***REMOVED***
    ...
    headers: Dict[str, str] = {"Authorization": "Bearer "***REMOVED***

    def __init__(self, **kwargs: Any):
        """Initialize the Cloudflare Workers AI client."""
        super().__init__(**kwargs)

        self.headers = {"Authorization": f"Bearer {self.api_token***REMOVED***"***REMOVED***
    ...
    def embed_documents(self, texts: List[str]) -> List[List[float]]:
        ...
        for batch in batches:
            response = requests.post(
                f"{self.api_base_url***REMOVED***/{self.account_id***REMOVED***/ai/run/{self.model_name***REMOVED***",
                headers=self.headers,
                json={"text": batch***REMOVED***,
***REMOVED***
