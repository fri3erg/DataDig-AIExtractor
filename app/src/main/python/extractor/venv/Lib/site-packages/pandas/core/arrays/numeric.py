...
class NumericDtype(BaseMaskedDtype):
    ...
    def __repr__(self) -> str:
        return f"{self.name***REMOVED***Dtype()"
    ...
    def __from_arrow__(
        ...
        if not array.type.equals(pyarrow_type) and not pyarrow.types.is_null(
            ...
            if rt_dtype.kind not in "iuf":
                ...
                raise TypeError(
                    f"Expected array of {self***REMOVED*** type, got {array.type***REMOVED*** instead"
    ***REMOVED***
    ...
    def _standardize_dtype(cls, dtype: NumericDtype | str | np.dtype) -> NumericDtype:
        ...
        if not isinstance(dtype, NumericDtype):
            ...
            try:
                ...
                raise ValueError(f"invalid dtype specified {dtype***REMOVED***") from err
        return dtype
...
def _coerce_to_data_and_mask(
    ...
    if values.dtype == object or is_string_dtype(values.dtype):
        ...
        if inferred_type == "boolean" and dtype is None:
            ...
            raise TypeError(f"{values.dtype***REMOVED*** cannot be converted to {name***REMOVED***")
...
***REMOVED***
            raise TypeError(
                f"values should be {descr***REMOVED*** numpy array. Use "
