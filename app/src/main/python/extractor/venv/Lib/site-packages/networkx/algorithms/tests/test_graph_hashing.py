...
def test_reversed():
    ...
    nx.set_node_attributes(G, {n: str(n) for n in G.nodes()***REMOVED***, name="label")
...
def test_isomorphic():
    ...
    for i in range(1, r + 1):
        ...
        G2 = nx.relabel_nodes(G1, {u: -1 * u for u in G1.nodes()***REMOVED***)
...
def test_isomorphic_edge_attr():
    ...
    for i in range(1, r + 1):
        ...
        for a, b in G1.edges:
            G1[a][b]["edge_attr1"] = f"{a***REMOVED***-{b***REMOVED***-1"
            G1[a][b]["edge_attr2"] = f"{a***REMOVED***-{b***REMOVED***-2"
...
def test_missing_edge_attr():
    ...
    """
    G = nx.Graph()
    G.add_edges_from([(1, 2, {"edge_attr1": "a"***REMOVED***), (1, 3, {***REMOVED***)])
...
def test_isomorphic_node_attr():
    ...
    for i in range(1, r + 1):
        ...
        for u in G1.nodes():
            G1.nodes[u]["node_attr1"] = f"{u***REMOVED***-1"
            G1.nodes[u]["node_attr2"] = f"{u***REMOVED***-2"
...
def test_missing_node_attr():
    ...
    """
    G = nx.Graph()
    G.add_nodes_from([(1, {"node_attr1": "a"***REMOVED***), (2, {***REMOVED***)])
...
def test_empty_graph_subgraph_hash():
    ...
    assert subgraph_hashes1 == {***REMOVED***
    assert subgraph_hashes2 == {***REMOVED***
    assert subgraph_hashes3 == {***REMOVED***
    assert subgraph_hashes4 == {***REMOVED***
    assert subgraph_hashes5 == {***REMOVED***
...
def test_isomorphic_subgraph_hash():
    ...
    for i in range(1, r + 1):
        ...
        assert g1_subgraph_hashes == {-1 * k: v for k, v in g2_subgraph_hashes.items()***REMOVED***
...
def test_iteration_depth_edge_attr():
    ...
    for i in range(1, r + 1):
        ...
        for a, b in G.edges:
            G[a][b]["edge_attr1"] = f"{a***REMOVED***-{b***REMOVED***-1"
...
def test_iteration_depth_node_attr():
    ...
    for i in range(1, r + 1):
        ...
        for u in G.nodes():
            G.nodes[u]["node_attr1"] = f"{u***REMOVED***-1"
