...
class TestSeriesSubclassing:
    ...
    def test_to_frame(self):
        ...
        res = s.to_frame()
        exp = tm.SubclassedDataFrame({"xxx": [1, 2, 3, 4]***REMOVED***, index=list("abcd"))
    ...
    def test_subclass_unstack(self):
        ...
        res = s.unstack()
        exp = tm.SubclassedDataFrame({"x": [1, 3], "y": [2, 4]***REMOVED***, index=["a", "b"])
    ...
    def test_asof(self):
        ...
        s = tm.SubclassedSeries({"A": [np.nan, np.nan, np.nan]***REMOVED***, index=rng)
...
def test_constructor_from_dict():
    ...
    result = SubclassedSeries({"a": 1, "b": 2, "c": 3***REMOVED***)
