...
***REMOVED***,
    ...
    def test_insert(self, data):
        ...
        for closed in {"left", "right", "both", "neither"***REMOVED*** - {item.closed***REMOVED***:
            msg = f"'value.closed' is '{closed***REMOVED***', expected '{item.closed***REMOVED***'."
    ...
    def test_maybe_convert_i8_numeric(self, make_key, any_real_numpy_dtype):
        ...
        expected_dtype = {"i": np.int64, "u": np.uint64, "f": np.float64***REMOVED***[kind]
    ...
    def test_maybe_convert_i8_errors(self, breaks1, breaks2, make_key):
        ...
        msg = (
            f"Cannot index an IntervalIndex of subtype {breaks1.dtype***REMOVED*** with "
            f"values of dtype {breaks2.dtype***REMOVED***"
        )
        msg = re.escape(msg)
        with pytest.raises(ValueError, match=msg):
...
***REMOVED***
    ...
    def test_append(self, closed):
        ...
        for other_closed in {"left", "right", "both", "neither"***REMOVED*** - {closed***REMOVED***:
...
***REMOVED***
    ...
    def test_set_closed_errors(self, bad_closed):
        ...
        msg = f"invalid option for 'closed': {bad_closed***REMOVED***"
        with pytest.raises(ValueError, match=msg):
