...
class RunnableWithFallbacks(RunnableSerializable[Input, Output]):
    ...
    Example:
        ...
        .. code-block:: python
            ...
            chain_with_fallback = (
                PromptTemplate.from_template('Tell me a joke about {topic***REMOVED***')
                | model
                | StrOutputParser()
***REMOVED***.with_fallbacks([RunnableLambda(when_all_is_lost)])
    """
...
***REMOVED***
        ...
        run_managers = [
            cm.on_chain_start(
                dumpd(self),
                input if isinstance(input, dict) else {"input": input***REMOVED***,
