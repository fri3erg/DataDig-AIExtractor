...
def assoc(inst, **changes):
    ...
    for k, v in changes.items():
        ...
        if a is NOTHING:
            msg = f"{k***REMOVED*** is not an attrs attribute on {new.__class__***REMOVED***."
    ...
    *changes* applied.
    ...
    if args:
        try:
            ...
            msg = f"evolve() takes 1 positional argument, but {len(args)***REMOVED*** were given"
...
def resolve_types(
    ...
    if getattr(cls, "__attrs_types_resolved__", None) != cls:
        ...
        kwargs = {"globalns": globalns, "localns": localns***REMOVED***
