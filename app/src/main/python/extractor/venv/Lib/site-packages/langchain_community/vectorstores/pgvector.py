    ...
    class EmbeddingStore(BaseModel):
        ...
        collection_id = sqlalchemy.Column(
            ...
            sqlalchemy.ForeignKey(
                f"{CollectionStore.__tablename__***REMOVED***.uuid",
                ondelete="CASCADE",
***REMOVED***,
        )
...
***REMOVED***
    ...
    def __init__(
        ...
        *,
        ...
        self.engine_args = engine_args or {***REMOVED***
    ...
    ***REMOVED***
            ...
            raise Exception(f"Failed to create vector extension: {e***REMOVED***") from e
    ...
    ***REMOVED***
    ...
    def distance_strategy(self) -> Any:
        if self._distance_strategy == DistanceStrategy.EUCLIDEAN:
            ...
            raise ValueError(
                f"Got unexpected value for distance: {self._distance_strategy***REMOVED***. "
                f"Should be one of {', '.join([ds.value for ds in DistanceStrategy])***REMOVED***."
***REMOVED***
...
***REMOVED***
    ...
    def _create_filter_clause(self, key, value):
        ...
        value_case_insensitive = {k.lower(): v for k, v in value.items()***REMOVED***
