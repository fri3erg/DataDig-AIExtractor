...
***REMOVED*** from e
        ...
        ***REMOVED***[operation.operator]
        return rest.Filter(**{operator: args***REMOVED***)
...
***REMOVED***
        kwargs = {comparison.comparator.value: comparison.value***REMOVED***
