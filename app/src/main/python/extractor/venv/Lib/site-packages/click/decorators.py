        ...
        def new_func(*args: "P.args", **kwargs: "P.kwargs") -> "R":
            ...
            if obj is None:
                raise RuntimeError(
                    ...
                    f" object of type {object_type.__name__!r***REMOVED***"
                    " existing."
    ***REMOVED***
...
def pass_meta_key(
    ...
    if doc_description is None:
        doc_description = f"the {key!r***REMOVED*** key from :attr:`click.Context.meta`"

    decorator.__doc__ = (
        f"Decorator that passes {doc_description***REMOVED*** as the first argument"
    ...
    def callback(ctx: Context, param: Parameter, value: bool) -> None:
        ...
        if version is None and package_name is not None:
            ...
            try:
                ...
                raise RuntimeError(
                    f"{package_name!r***REMOVED*** is not installed. Try passing"
                    " 'package_name' instead."
    ***REMOVED*** from None

        if version is None:
            raise RuntimeError(
                f"Could not determine the version for {package_name!r***REMOVED*** automatically."
***REMOVED***

        echo(
            message % {"prog": prog_name, "package": package_name, "version": version***REMOVED***,
            color=ctx.color,
        )
        ctx.exit()
