...
class _GlobalConfig:
    ...
    def __init__(self):
        self.encoders: Dict[Union[type, Optional[type]], Callable] = {***REMOVED***
        self.decoders: Dict[Union[type, Optional[type]], Callable] = {***REMOVED***
        self.mm_fields: Dict[
    ...
    #     warnings.warn(f"Now using {value.__name__***REMOVED*** module to handle JSON. "
    #                   f"{self._disable_msg***REMOVED***")
...
def config(metadata: Optional[dict] = None, *,
    ...
    lib_metadata = metadata.setdefault('dataclasses_json', {***REMOVED***)
        ...
        if isinstance(undefined, str):
            if not hasattr(Undefined, undefined.upper()):
                ...
                raise UndefinedParameterError(
                    ...
                    f"must be one of {valid_actions***REMOVED***")
