...
class ChatHuggingFace(BaseChatModel):
    ...
    def _to_chatml_format(self, message: BaseMessage) -> dict:
        ...
        if isinstance(message, SystemMessage):
            ...
            raise ValueError(f"Unknown message type: {type(message)***REMOVED***")

        return {"role": role, "content": message.content***REMOVED***
...
***REMOVED***
    ...
    def _resolve_model_id(self) -> None:
        ...
        if isinstance(self.llm, HuggingFaceTextGenInference):
            ...
            raise ValueError(f"Unknown LLM type: {type(self.llm)***REMOVED***")
        ...
        if not self.model_id:
            raise ValueError(
                ...
                f"Could not find model id for inference server provided: {endpoint_url***REMOVED***"
