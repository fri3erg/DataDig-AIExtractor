...
class RouteDef(AbstractRouteDef):
    ...
    def __repr__(self) -> str:
        ...
        for name, value in sorted(self.kwargs.items()):
            info.append(f", {name***REMOVED***={value!r***REMOVED***")
        return "<RouteDef {method***REMOVED*** {path***REMOVED*** -> {handler.__name__!r***REMOVED***" "{info***REMOVED***>".format(
...
class StaticDef(AbstractRouteDef):
    ...
    def __repr__(self) -> str:
        ...
        for name, value in sorted(self.kwargs.items()):
            info.append(f", {name***REMOVED***={value!r***REMOVED***")
        return "<StaticDef {prefix***REMOVED*** -> {path***REMOVED***" "{info***REMOVED***>".format(
            prefix=self.prefix, path=self.path, info="".join(info)
        )

    def register(self, router: UrlDispatcher) -> List[AbstractRoute]:
        resource = router.add_static(self.prefix, self.path, **self.kwargs)
        routes = resource.get_info().get("routes", {***REMOVED***)
...
class RouteTableDef(Sequence[AbstractRouteDef]):
    ...
    def __repr__(self) -> str:
        return f"<RouteTableDef count={len(self._items)***REMOVED***>"
