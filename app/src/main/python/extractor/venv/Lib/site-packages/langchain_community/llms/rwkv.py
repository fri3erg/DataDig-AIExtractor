...
***REMOVED***
        try:
            ...
            model_kwargs = {k: v for k, v in values.items() if k in rwkv_keys***REMOVED***
...
***REMOVED***
    ...
    def _identifying_params(self) -> Mapping[str, Any]:
        ...
        return {
            ...
            **{k: v for k, v in self.__dict__.items() if k in RWKV._rwkv_param_names()***REMOVED***,
        ***REMOVED***
