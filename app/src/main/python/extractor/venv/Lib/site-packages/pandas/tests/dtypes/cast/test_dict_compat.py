...
def test_dict_compat():
    data_datetime64 = {np.datetime64("1990-03-15"): 1, np.datetime64("2015-03-15"): 2***REMOVED***
    data_unchanged = {1: 2, 3: 4, 5: 6***REMOVED***
    expected = {Timestamp("1990-3-15"): 1, Timestamp("2015-03-15"): 2***REMOVED***
