...
class TestGirvanNewman:
    ...
    def test_no_edges(self):
        ...
        validate_communities(communities[0], [{0***REMOVED***, {1***REMOVED***, {2***REMOVED***])
    ...
    def test_undirected(self):
        ...
        validate_communities(communities[0], [{0, 1***REMOVED***, {2, 3***REMOVED***])
        # After the next, we get the graph .-. . ., but there are two
        # symmetric possible versions.
        validate_possible_communities(
            communities[1], [{0***REMOVED***, {1***REMOVED***, {2, 3***REMOVED***], [{0, 1***REMOVED***, {2***REMOVED***, {3***REMOVED***]
        )
        # After the last removal, we always get the empty graph.
        validate_communities(communities[2], [{0***REMOVED***, {1***REMOVED***, {2***REMOVED***, {3***REMOVED***])
    ...
    def test_most_valuable_edge(self):
        ...
        assert len(communities) == 3
        validate_communities(communities[0], [{0***REMOVED***, {1, 2, 3***REMOVED***])
        validate_communities(communities[1], [{0***REMOVED***, {1***REMOVED***, {2, 3***REMOVED***])
        validate_communities(communities[2], [{0***REMOVED***, {1***REMOVED***, {2***REMOVED***, {3***REMOVED***])
