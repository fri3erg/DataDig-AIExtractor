...
language | string | Pass a ISO 639-1 value to display translated data for the fields that support it. minLength: 2, pattern: ([a-z]{2***REMOVED***)-([A-Z]{2***REMOVED***), default: en-US | optional
...
region | string | Specify a ISO 3166-1 code to filter release dates. Must be uppercase. pattern: ^[A-Z]{2***REMOVED***$ | optional
