...
***REMOVED***
            ...
            reduce_prompt = PromptTemplate.from_template(
                "Combine these summaries: {context***REMOVED***"
***REMOVED***
...
***REMOVED***
            ...
            # the final call.
            prompt = PromptTemplate.from_template(
                "Collapse this content: {context***REMOVED***"
***REMOVED***
            llm_chain = LLMChain(llm=llm, prompt=prompt)
    ...
    def get_output_schema(
        ...
        if self.return_intermediate_steps:
            return create_model(
                ...
                ***REMOVED***,  # type: ignore[call-overload]
***REMOVED***
    ...
    def collapse_document_chain(self) -> BaseCombineDocumentsChain:
        ...
        if isinstance(self.reduce_documents_chain, ReduceDocumentsChain):
            ...
            raise ValueError(
                ...
                f"{type(self.reduce_documents_chain)***REMOVED*** so it does not have "
                f"this attribute."
***REMOVED***
    ...
    def combine_docs(
        ...
        **kwargs: Any,
        ...
        map_results = self.llm_chain.apply(
            ...
            [{self.document_variable_name: d.page_content, **kwargs***REMOVED*** for d in docs],
            callbacks=callbacks,
        )
    ...
    async def acombine_docs(
        ...
        **kwargs: Any,
        ...
        map_results = await self.llm_chain.aapply(
            # FYI - this is parallelized and so it is fast.
            [{**{self.document_variable_name: d.page_content***REMOVED***, **kwargs***REMOVED*** for d in docs],
            callbacks=callbacks,
        )
        question_result_key = self.llm_chain.output_key
        result_docs = [
