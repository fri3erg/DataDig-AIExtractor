...
***REMOVED***
        if not isinstance(index, pinecone.Index):
            raise ValueError(
                f"client should be an instance of pinecone.Index, " f"got {type(index)***REMOVED***"
***REMOVED***
        self._index = index
        ...
        *,
        ...
        for res in results["matches"]:
            ...
            if self._text_key in metadata:
                ...
                logger.warning(
                    f"Found document with no `{self._text_key***REMOVED***` key. Skipping."
    ***REMOVED***
        return docs
...
***REMOVED***
            ...
            raise ValueError(
                f"Index '{index_name***REMOVED***' not found in your Pinecone project. "
                f"Did you mean one of the following indexes: {', '.join(index_names)***REMOVED***"
***REMOVED***
        return index
