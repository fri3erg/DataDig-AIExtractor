...
class _Config:
    ...
    conf_features : dict
        ...
        "extra_checks": str or list, optional
            ...
            ``#define {conf_c_prefix***REMOVED***_XXXX`` where ``XXXX`` is the case name in upper case.
...
***REMOVED***,
        ...
        if on_x86 and self.cc_is_msvc: return dict(
            SSE = dict(flags="/arch:SSE") if self.cc_on_x86 else {***REMOVED***,
            SSE2 = dict(flags="/arch:SSE2") if self.cc_on_x86 else {***REMOVED***,
            SSE3   = {***REMOVED***,
            SSSE3  = {***REMOVED***,
            SSE41  = {***REMOVED***,
...
***REMOVED***:
    ...
    def feature_get_til(self, names, keyisfalse):
        ...
        names = {t for n in names for t in til(n)***REMOVED***
...
***REMOVED***
        ...
        self.parse_target_groups = {***REMOVED***
...
***REMOVED***
        ...
        self.sources_status = getattr(self, "sources_status", {***REMOVED***)
...
***REMOVED***
    ...
    def generate_dispatch_header(self, header_path):
        ...
        if not os.path.exists(header_dir):
            self.dist_log(
                f"dispatch header dir {header_dir***REMOVED*** does not exist, creating it",
                stderr=True
***REMOVED***
    ...
    ***REMOVED*** % (self.conf_c_prefix, f)
            ...
            f.write(textwrap.dedent("""\
                ...
                */
                #define {pfx***REMOVED***WITH_CPU_BASELINE  "{baseline_str***REMOVED***"
                #define {pfx***REMOVED***WITH_CPU_DISPATCH  "{dispatch_str***REMOVED***"
                #define {pfx***REMOVED***WITH_CPU_BASELINE_N {baseline_len***REMOVED***
                #define {pfx***REMOVED***WITH_CPU_DISPATCH_N {dispatch_len***REMOVED***
                #define {pfx***REMOVED***WITH_CPU_EXPAND_(X) X
                #define {pfx***REMOVED***WITH_CPU_BASELINE_CALL(MACRO_TO_CALL, ...) \\
                {baseline_calls***REMOVED***
                #define {pfx***REMOVED***WITH_CPU_DISPATCH_CALL(MACRO_TO_CALL, ...) \\
                {dispatch_calls***REMOVED***
            """).format(
...
***REMOVED***)
            ...
            for name in dispatch_names:
                ...
                #ifdef {pfx***REMOVED***CPU_TARGET_{name***REMOVED***
                {pre***REMOVED***
                #endif /*{pfx***REMOVED***CPU_TARGET_{name***REMOVED****/
                """).format(
    ...
    ***REMOVED***)
            ...
            f.write(textwrap.dedent("""\
            /******* baseline features *******/
            {baseline_pre***REMOVED***
            /******* dispatch features *******/
            {dispatch_pre***REMOVED***
            """).format(
...
***REMOVED***)
    ...
    def _wrap_target(self, output_dir, dispatch_src, target, nochange=False):
        ...
        wrap_path = "{0***REMOVED***.{2***REMOVED***{1***REMOVED***".format(*os.path.splitext(wrap_path), ext_name.lower())
        ...
        with open(wrap_path, "w") as fd:
             ...
             * Please make changes to the code generator \
             (distutils/ccompiler_opt.py)
             */
            #define {pfx***REMOVED***CPU_TARGET_MODE
            #define {pfx***REMOVED***CPU_TARGET_CURRENT {target_name***REMOVED***
            {target_defs***REMOVED***
...
***REMOVED*** % self.conf_c_prefix_
        else:
            baseline_calls = ''

        with open(config_path, "w") as fd:
            fd.write(textwrap.dedent("""\
            // cache_hash:{cache_hash***REMOVED***
            /**
             * AUTOGENERATED DON'T EDIT
             * Please make changes to the code generator (distutils/ccompiler_opt.py)
             */
            #ifndef {pfx***REMOVED***CPU_DISPATCH_EXPAND_
                #define {pfx***REMOVED***CPU_DISPATCH_EXPAND_(X) X
            #endif
            #undef {pfx***REMOVED***CPU_DISPATCH_BASELINE_CALL
            #undef {pfx***REMOVED***CPU_DISPATCH_CALL
            #define {pfx***REMOVED***CPU_DISPATCH_BASELINE_CALL(CB, ...) \\
            {baseline_calls***REMOVED***
            #define {pfx***REMOVED***CPU_DISPATCH_CALL(CHK, CB, ...) \\
            {dispatch_calls***REMOVED***
            """).format(
