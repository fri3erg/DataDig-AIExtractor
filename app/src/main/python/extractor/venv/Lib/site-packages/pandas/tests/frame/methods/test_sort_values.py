...
class TestDataFrameSortValues:
    ...
    def test_sort_values_by_empty_list(self):
        ...
        expected = DataFrame({"a": [1, 4, 2, 5, 3, 6]***REMOVED***)
    ...
    def test_sort_values_multicolumn(self):
        ...
        frame = DataFrame(
            {"A": A, "B": B, "C": np.random.default_rng(2).standard_normal(100)***REMOVED***
        )
    ...
    def test_sort_values_nan(self):
        # GH#3917
        df = DataFrame(
            {"A": [1, 2, np.nan, 1, 6, 8, 4], "B": [9, np.nan, 5, 2, 5, 4, 5]***REMOVED***
        )

        # sort one column only
        expected = DataFrame(
            {"A": [np.nan, 1, 1, 2, 4, 6, 8], "B": [5, 9, 2, np.nan, 5, 5, 4]***REMOVED***,
            index=[2, 0, 3, 1, 6, 4, 5],
        )
        ...
        expected = DataFrame(
            {"A": [np.nan, 8, 6, 4, 2, 1, 1], "B": [5, 4, 5, 5, np.nan, 9, 2]***REMOVED***,
            index=[2, 5, 4, 6, 1, 0, 3],
        )
        ...
        expected = DataFrame(
            {"A": [1, 1, 2, 4, 6, 8, np.nan], "B": [2, 9, np.nan, 5, 5, 4, 5]***REMOVED***,
            index=[3, 0, 1, 6, 4, 5, 2],
        )
        ...
        expected = DataFrame(
            {"A": [np.nan, 1, 1, 2, 4, 6, 8], "B": [5, 2, 9, np.nan, 5, 5, 4]***REMOVED***,
            index=[2, 3, 0, 1, 6, 4, 5],
        )
        ...
        expected = DataFrame(
            {"A": [8, 6, 4, 2, 1, 1, np.nan], "B": [4, 5, 5, np.nan, 2, 9, 5]***REMOVED***,
            index=[5, 4, 6, 1, 3, 0, 2],
        )
    ...
    def test_sort_values_stable_categorial(self):
        # GH#16793
        df = DataFrame({"x": Categorical(np.repeat([1, 2, 3, 4], 5), ordered=True)***REMOVED***)
        expected = df.copy()
    ...
    def test_sort_values_nat_values_in_int_column(self):
        ...
        df = DataFrame(
            {"int": int_values, "float": float_values***REMOVED***, columns=["int", "float"]
        )

        df_reversed = DataFrame(
            {"int": int_values[::-1], "float": float_values[::-1]***REMOVED***,
            columns=["int", "float"],
            index=[1, 0],
        )
        ...
        # columns:
        df = DataFrame(
            {"datetime": [Timestamp("2016-01-01"), NaT], "float": float_values***REMOVED***,
            columns=["datetime", "float"],
        )

        df_reversed = DataFrame(
            {"datetime": [NaT, Timestamp("2016-01-01")], "float": float_values[::-1]***REMOVED***,
            columns=["datetime", "float"],
            index=[1, 0],
        )
    ...
    def test_sort_nat(self):
        ...
        df = DataFrame({"a": d1, "b": d2***REMOVED***, index=[0, 1, 2, 3])
        ...
        expected = DataFrame({"a": d3, "b": d4***REMOVED***, index=[1, 3, 0, 2])
    ...
    ***REMOVED***
    ...
    @pytest.mark.parametrize(
        ...
        [
            ({"A": [1, 2, 3]***REMOVED***, {"A": [3, 2, 1]***REMOVED***, True, [0, 1, 2]),
            ({"A": [1, 2, 3]***REMOVED***, {"A": [3, 2, 1]***REMOVED***, False, [2, 1, 0]),
            (
                {"A": [1, 2, 3], "B": [2, 3, 4]***REMOVED***,
                {"A": [3, 2, 1], "B": [4, 3, 2]***REMOVED***,
                True,
                [0, 1, 2],
***REMOVED***,
            (
...
***REMOVED***,
    ...
    def test_sort_values_ignore_index(
        ...
        kwargs = {"ignore_index": ignore_index, "inplace": inplace***REMOVED***
    ...
    ***REMOVED***,
    ...
    def test_sort_values_no_op_reset_index(self):
        # GH#52553
        df = DataFrame({"A": [10, 20], "B": [1, 5]***REMOVED***, index=[2, 3])
        result = df.sort_values(by="A", ignore_index=True)
        expected = DataFrame({"A": [10, 20], "B": [1, 5]***REMOVED***)
        tm.assert_frame_equal(result, expected)
...
class TestDataFrameSortKey:  # test key sorting (issue 27237)
    ...
    def test_sort_values_key_axes(self):
        df = DataFrame({0: ["Hello", "goodbye"], 1: [0, 1]***REMOVED***)
    ...
    def test_sort_values_key_dict_axis(self):
        df = DataFrame({0: ["Hello", 0], 1: ["goodbye", 1]***REMOVED***)
    ...
    def test_sort_values_key_casts_to_categorical(self, ordered):
        ...
        categories = ["c", "b", "a"]
        df = DataFrame({"x": [1, 1, 1], "y": ["a", "b", "c"]***REMOVED***)
    ...
    ***REMOVED***
        ...
        expected = DataFrame(
            {"x": [1, 1, 1], "y": ["c", "b", "a"]***REMOVED***, index=pd.Index([2, 1, 0])
        )
...
***REMOVED***
    ...
    def test_sort_values_validate_ascending_for_value_error(self):
        # GH41634
        df = DataFrame({"D": [23, 7, 21]***REMOVED***)
