...
max_min_funcs = {nx.maximum_flow, nx.minimum_cut***REMOVED***
flow_value_funcs = {nx.maximum_flow_value, nx.minimum_cut_value***REMOVED***
...
def validate_flows(G, s, t, flowDict, solnValue, capacity, flow_func):
    errmsg = f"Assertion failed in function: {flow_func.__name__***REMOVED***"
    assert set(G) == set(flowDict), errmsg
    for u in G:
        assert set(G[u]) == set(flowDict[u]), errmsg
    excess = {u: 0 for u in flowDict***REMOVED***
    for u in flowDict:
...
class TestMaxflowMinCutCommon:
    def test_graph1(self):
        ...
        solnFlows = {1: {2: 1.0***REMOVED***, 2: {1: 1.0***REMOVED******REMOVED***
    ...
    def test_graph2(self):
        ...
        H = {
            "x": {"a": 3, "b": 1***REMOVED***,
            "a": {"c": 3, "x": 3***REMOVED***,
            "b": {"c": 1, "d": 2, "x": 1***REMOVED***,
            "c": {"a": 3, "b": 1, "y": 2***REMOVED***,
            "d": {"b": 2, "e": 2***REMOVED***,
            "e": {"d": 2, "y": 2***REMOVED***,
            "y": {"c": 2, "e": 2***REMOVED***,
        ***REMOVED***
    ...
    def test_digraph1(self):
        ...
        H = {
            "a": {"b": 1000.0, "c": 1000.0***REMOVED***,
            "b": {"c": 0, "d": 1000.0***REMOVED***,
            "c": {"d": 1000.0***REMOVED***,
            "d": {***REMOVED***,
        ***REMOVED***
    ...
    def test_digraph3(self):
        ...
        H = {
            "s": {"v1": 12.0, "v2": 11.0***REMOVED***,
            "v2": {"v1": 0, "v4": 11.0***REMOVED***,
            "v1": {"v2": 0, "v3": 12.0***REMOVED***,
            "v3": {"v2": 0, "t": 19.0***REMOVED***,
            "v4": {"v3": 7.0, "t": 4.0***REMOVED***,
            "t": {***REMOVED***,
        ***REMOVED***
    ...
    def test_graph_infcap_edges(self):
        ...
        H = {
            "s": {"a": 85, "b": 12***REMOVED***,
            "a": {"c": 25, "s": 85, "t": 60***REMOVED***,
            "b": {"c": 12, "s": 12***REMOVED***,
            "c": {"a": 25, "b": 12, "t": 37***REMOVED***,
            "t": {"a": 60, "c": 37***REMOVED***,
        ***REMOVED***
    ...
    def test_disconnected(self):
        ...
        flowSoln = {0: {***REMOVED***, 2: {3: 0***REMOVED***, 3: {2: 0***REMOVED******REMOVED***
...
class TestMaxFlowMinCutInterface:
    ...
    def test_flow_func_not_callable(self):
        elements = ["this_should_be_callable", 10, {1, 2, 3***REMOVED***]
        G = nx.Graph()
        G.add_weighted_edges_from([(0, 1, 1), (1, 2, 1), (2, 3, 1)], weight="capacity")
    ...
    def test_flow_func_parameters(self):
        ...
        for interface_func in interface_funcs:
            for flow_func in flow_funcs:
                errmsg = (
                    f"Assertion failed in function: {flow_func.__name__***REMOVED*** "
                    f"in interface {interface_func.__name__***REMOVED***"
    ***REMOVED***
    ...
    def test_kwargs(self):
        ...
        fv = 1.0
        to_test = (
            (shortest_augmenting_path, {"two_phase": True***REMOVED***),
            (preflow_push, {"global_relabel_freq": 5***REMOVED***),
        )
        for interface_func in interface_funcs:
...
class TestCutoff:
    ...
    def test_complete_graph_cutoff(self):
        ...
        nx.set_edge_attributes(G, {(u, v): 1 for u, v in G.edges()***REMOVED***, "capacity")
        for flow_func in [
            shortest_augmenting_path,
            edmonds_karp,
            dinitz,
    ...
    ***REMOVED***
                assert cutoff == result, f"cutoff error in {flow_func.__name__***REMOVED***"
