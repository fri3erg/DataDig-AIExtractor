            ...
            ***REMOVED***
            ...
            if node is Ellipsis:
                ...
                if is_directed:
                    ...
                    handled_parents = {parent***REMOVED***
                else:
                    ...
                    # traverse
                    handled_parents = {*children, parent***REMOVED***
            ...
            ***REMOVED***
            ...
            if vertical_chains:
                if is_directed:
                    ...
                    num_children = len(set(children) - {parent***REMOVED***)
...
def _find_sources(graph):
    ...
    if graph.is_directed():
        ...
        supernode_to_nodes = {sn: [] for sn in scc_graph.nodes()***REMOVED***
...
def _parse_network_text(lines):
    ...
    try:
        ...
        ***REMOVED***:
            ...
            raise AssertionError(f"Unexpected first character: {first_char***REMOVED***")
