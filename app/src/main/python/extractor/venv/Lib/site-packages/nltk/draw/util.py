    ...
    ***REMOVED***
    ...
    def _add_child_widget(self, child):
        ...
        if child.__parent is not None:
            raise ValueError(f"{child***REMOVED*** already has a parent")
        child.__parent = self
...
class TextWidget(CanvasWidget):
    ...
    def __setitem__(self, attr, value):
        if attr in ("color", "font", "justify", "width"):
            if attr == "color":
                attr = "fill"
            self.canvas().itemconfig(self._tag, {attr: value***REMOVED***)
        else:
...
class AbstractContainerWidget(CanvasWidget):
    ...
    def __repr__(self):
        ...
        if name[-6:] == "Widget":
            name = name[:-6]
        return f"[{name***REMOVED***: {self._child!r***REMOVED***]"
...
class BoxWidget(AbstractContainerWidget):
    ...
    def __setitem__(self, attr, value):
        if attr == "margin":
            ...
            self.canvas().itemconfig(self._box, {attr: value***REMOVED***)
        else:
            CanvasWidget.__setitem__(self, attr, value)
...
class OvalWidget(AbstractContainerWidget):
    ...
    ***REMOVED***
            ...
            c.itemconfig(self._oval, {attr: value***REMOVED***)
            if self._oval2 is not None and attr != "fill":
                c.itemconfig(self._oval2, {attr: value***REMOVED***)
            if self._oval2 is not None and attr != "fill":
                self.canvas().itemconfig(self._oval2, {attr: value***REMOVED***)
        else:
            CanvasWidget.__setitem__(self, attr, value)
...
class CanvasFrame:
    ...
    def __init__(self, parent=None, **kw):
        ...
        scrollregion = "0 0 {***REMOVED*** {***REMOVED***".format(canvas["width"], canvas["height"])
        canvas["scrollregion"] = scrollregion
...
class ColorizedList:
    ...
    def add_callback(self, event, func):
        ...
        for e in events:
            self._callbacks.setdefault(e, {***REMOVED***)[func] = 1
