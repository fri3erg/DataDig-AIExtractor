...
class SlackChatLoader(BaseChatLoader):
    ...
    def __init__(
        ...
        if not self.zip_path.exists():
            raise FileNotFoundError(f"File {self.zip_path***REMOVED*** not found")
...
***REMOVED***
            ...
            if sender == previous_sender:
                ...
                results[-1].additional_kwargs["events"].append(
                    {"message_time": timestamp***REMOVED***
    ***REMOVED***
            else:
                results.append(
                    HumanMessage(
                        ...
                        additional_kwargs={
                            "sender": sender,
                            "events": [{"message_time": timestamp***REMOVED***],
                        ***REMOVED***,
        ***REMOVED***
    ***REMOVED***
    ...
    def _read_json(self, zip_file: zipfile.ZipFile, file_path: str) -> List[dict]:
        ...
        if not isinstance(data, list):
            raise ValueError(f"Expected list of dictionaries, got {type(data)***REMOVED***")
        return data
