...
***REMOVED***
    ...
    def messages(self) -> list[BaseMessage]:  # type: ignore[override]
        ...
        if isinstance(fetch_response, CacheListFetch.Hit):
            ...
            raise Exception(f"Unexpected response: {fetch_response***REMOVED***")
    ...
    def add_message(self, message: BaseMessage) -> None:
        ...
        if isinstance(push_response, CacheListPushBack.Success):
            ...
            raise Exception(f"Unexpected response: {push_response***REMOVED***")
    ...
    def clear(self) -> None:
        ...
        if isinstance(delete_response, CacheDelete.Success):
            ...
            raise Exception(f"Unexpected response: {delete_response***REMOVED***")
