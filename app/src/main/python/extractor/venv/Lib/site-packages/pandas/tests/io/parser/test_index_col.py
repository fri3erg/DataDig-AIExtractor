...
"""
    ...
    expected = DataFrame(
        {"a": [1, 5, 9], "b": [2, 6, 10], "c": [3, 7, 11], "d": [4, 8, 12]***REMOVED***,
...
@pytest.mark.parametrize(
    "index_col,kwargs",
    [
        (None, {"columns": ["x", "y", "z"]***REMOVED***),
        (False, {"columns": ["x", "y", "z"]***REMOVED***),
        (0, {"columns": ["y", "z"], "index": Index([], name="x")***REMOVED***),
        (1, {"columns": ["x", "z"], "index": Index([], name="y")***REMOVED***),
        ("x", {"columns": ["y", "z"], "index": Index([], name="x")***REMOVED***),
        ("y", {"columns": ["x", "z"], "index": Index([], name="y")***REMOVED***),
        (
            [0, 1],
            {
                "columns": ["z"],
...
def test_multi_index_naming(all_parsers, index_names, request):
    ...
    expected = DataFrame(
        {"col": [1, 2, 3, 4]***REMOVED***, index=MultiIndex.from_product([["a", "b"], ["c", "d"]])
    )
...
def test_specify_dtype_for_index_col(all_parsers, dtype, val, request):
    ...
    result = parser.read_csv(StringIO(data), index_col="a", dtype={"a": dtype***REMOVED***)
    expected = DataFrame({"b": [2]***REMOVED***, index=Index([val], name="a"))
    tm.assert_frame_equal(result, expected)
