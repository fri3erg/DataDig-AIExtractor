...
NASA_SEARCH_PROMPT = """
    ...
    ***REMOVED******REMOVED***
    ...
    Example Input: {{"year_start":  "2002", "year_end":  "2010", "page": 2***REMOVED******REMOVED***
    
    Task: get the image and video content of saturn photographed by John Appleseed
    Example Input: {{"q": "saturn", "photographer": "John Appleseed"***REMOVED******REMOVED***
    
    Task: search for Meteor Showers with description "Search Description" with media type image
    Example Input: {{"q": "Meteor Shower", "description": "Search Description", "media_type": "image"***REMOVED******REMOVED***
    
    Task: get the image and video content from year 2008 to 2010 from Kennedy Center
    Example Input: {{"year_start":  "2002", "year_end":  "2010", "location": "Kennedy Center***REMOVED******REMOVED***
    """
