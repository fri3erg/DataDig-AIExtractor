...
def convert_message_chunk_to_message(message_chunk: BaseMessageChunk) -> BaseMessage:
    if isinstance(message_chunk, HumanMessageChunk):
        ...
        raise TypeError(f"Got unknown type {message_chunk***REMOVED***")
...
class ChatTongyi(BaseChatModel):
    ...
    def lc_secrets(self) -> Dict[str, str]:
        return {"dashscope_api_key": "DASHSCOPE_API_KEY"***REMOVED***
...
***REMOVED***
            resp = await asyncio.get_running_loop().run_in_executor(
                None,
                functools.partial(
                    self.completion_with_retry, **{"run_manager": run_manager, **params***REMOVED***
    ***REMOVED***,
***REMOVED***
            generations.append(
                ChatGeneration(**self._chat_generation_from_qwen_resp(resp))
...
***REMOVED***
    ...
    def _invocation_params(
        ...
        params = {**self._default_params, **kwargs***REMOVED***
        if stop is not None:
            params["stop"] = stop
