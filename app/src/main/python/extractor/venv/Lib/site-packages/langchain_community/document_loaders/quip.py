    ...
    ***REMOVED***
    ...
    def get_thread_ids_by_folder_id(
        ...
        try:
            ...
            if e.code == 403:
                logging.warning(
                    f"depth {depth***REMOVED***, Skipped over restricted folder {folder_id***REMOVED***, {e***REMOVED***"
    ***REMOVED***
            else:
                logging.warning(
                    f"depth {depth***REMOVED***, Skipped over folder {folder_id***REMOVED*** "
                    f"due to unknown error {e.code***REMOVED***"
    ***REMOVED***
            return
        except HTTPError as e:
            logging.warning(
                f"depth {depth***REMOVED***, Skipped over folder {folder_id***REMOVED*** "
                f"due to HTTP error {e.code***REMOVED***"
***REMOVED***
            return

        title = folder["folder"].get("title", "Folder %s" % folder_id)

        logging.info(f"depth {depth***REMOVED***, Processing folder {title***REMOVED***")
    ...
    ***REMOVED***
    ...
    def process_thread(
        ...
        logger.info(
            f"processing thread {thread_id***REMOVED*** title {sanitized_title***REMOVED*** "
            f"link {link***REMOVED*** update_ts {update_ts***REMOVED***"
        )
        ...
        if "html" in thread:
            ...
            try:
                ...
                logger.error(f"Error parsing thread {title***REMOVED*** {thread_id***REMOVED***, skipping, {e***REMOVED***")
                return None
...
***REMOVED***
        ...
        for img in tree.iter("img"):
            ...
            try:
                ...
                logger.error(f"failed to convert image to text, {e***REMOVED***")
                raise e
        return text
