...
class LRPlanarity:
    ...
    def __init__(self, G):
        ...
        self.lowpt = {***REMOVED***  # height of lowest return point of an edge
        self.lowpt2 = {***REMOVED***  # height of second lowest return point
        self.nesting_depth = {***REMOVED***  # for nesting order
        ...
        self.S = []
        self.stack_bottom = {***REMOVED***
        self.lowpt_edge = {***REMOVED***

        self.left_ref = {***REMOVED***
        self.right_ref = {***REMOVED***
        ...
        * A node with a degree larger than 0 has a node attribute 'first_nbr'.
        ...
        for v in self:
            try:
                ...
                msg = f"Bad embedding. Missing orientation for a neighbor of {v***REMOVED***"
