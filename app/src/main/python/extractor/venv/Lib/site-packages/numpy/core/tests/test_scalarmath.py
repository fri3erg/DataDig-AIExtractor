...
def check_ufunc_scalar_equivalence(op, arr1, arr2):
    ...
    if arr1.dtype.kind == "c" or arr2.dtype.kind == "c":
        comp_ops = {operator.ge, operator.gt, operator.le, operator.lt***REMOVED***
...
class TestMultiply:
    def test_seq_repeat(self):
        ...
        deprecated_types = {'?'***REMOVED***
        forbidden_types = (
            set(np.typecodes["All"]) - accepted_types - deprecated_types)
        forbidden_types -= {'V'***REMOVED***  # can't default-construct void scalars
...
def test_subclass_deferral(sctype, __op__, __rop__, op, cmp):
    ...
    myf_op = type("myf_op", (sctype,), {__op__: op_func, __rop__: rop_func***REMOVED***)
...
def test_pyscalar_subclasses(subtype, __op__, __rop__, op, cmp):
    ...
    myt = type("myt", (subtype,),
               {__op__: op_func, __rop__: rop_func, "__array_ufunc__": None***REMOVED***)
    ...
    if op in {operator.mod, operator.floordiv***REMOVED*** and subtype == complex:
    ...
    myt = type("myt", (subtype,), {__rop__: rop_func***REMOVED***)
