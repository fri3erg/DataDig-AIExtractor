...
class StringFormatter:
    ...
    def to_string(self) -> str:
        ...
        if self.fmt.should_show_dimensions:
            text = f"{text***REMOVED***{self.fmt.dimensions_info***REMOVED***"
        return text
    ...
    def _empty_info_line(self) -> str:
        return (
            f"Empty {type(self.frame).__name__***REMOVED***\n"
            f"Columns: {pprint_thing(self.frame.columns)***REMOVED***\n"
            f"Index: {pprint_thing(self.frame.index)***REMOVED***"
        )
