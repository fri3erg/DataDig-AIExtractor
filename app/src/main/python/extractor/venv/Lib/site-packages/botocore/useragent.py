...
_USERAGENT_PLATFORM_NAME_MAPPINGS = {'darwin': 'macos'***REMOVED***
...
class UserAgentComponent(NamedTuple):
    ...
    def to_string(self):
        ...
        if self.value is None or self.value == '':
            return f'{clean_prefix***REMOVED***/{clean_name***REMOVED***'
        clean_value = sanitize_user_agent_string_component(
            self.value, allow_hash=True
        )
        return f'{clean_prefix***REMOVED***/{clean_name***REMOVED***#{clean_value***REMOVED***'
