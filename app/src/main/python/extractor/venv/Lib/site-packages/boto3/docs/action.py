...
WARNING_MESSAGES = {
    "Metric": {"put_data": PUT_DATA_WARNING_MESSAGE***REMOVED***,
***REMOVED***

IGNORE_PARAMS = {"Metric": {"put_data": ["Namespace"]***REMOVED******REMOVED***
...
***REMOVED***,
        ...
        resource_warnings = WARNING_MESSAGES.get(self._resource_name, {***REMOVED***)
        for action_name in sorted(resource_actions):
            ...
            breadcrumb_section.write(f' / Action / {action_name***REMOVED***')
...
def document_action(
    ...
    ignore_params = IGNORE_PARAMS.get(resource_name, {***REMOVED***).get(
        action_model.name,
    ...
    example_prefix = '{***REMOVED*** = {***REMOVED***.{***REMOVED***'.format(
        example_return_value, example_resource_name, action_model.name
    )
    full_action_name = (
        f"{section.context.get('qualifier', '')***REMOVED***{action_model.name***REMOVED***"
    )
...
def document_load_reload_action(
    ...
    """
    description = (
        'Calls :py:meth:`{***REMOVED***.Client.{***REMOVED***` to update the attributes of the '
        '{***REMOVED*** resource. Note that the load and reload methods are '
    ...
    if service_model.service_name == resource_name:
        example_resource_name = resource_name
    example_prefix = f'{example_resource_name***REMOVED***.{action_name***REMOVED***'
    full_action_name = f"{section.context.get('qualifier', '')***REMOVED***{action_name***REMOVED***"
    document_model_driven_method(
        section=section,
        method_name=full_action_name,
        operation_model=OperationModel({***REMOVED***, service_model),
        event_emitter=event_emitter,
