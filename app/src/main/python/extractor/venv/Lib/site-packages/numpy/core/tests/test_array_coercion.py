...
class TestStringDiscovery:
    ...
    def test_basic_stringlength(self, obj):
        length = len(str(obj))
        expected = np.dtype(f"S{length***REMOVED***")
...
class TestAsArray:
    ...
    def test_dtype_identity(self):
        ...
        unequal_type = np.dtype('i', metadata={'spam': True***REMOVED***)
        ...
        # instance.
        equivalent_requirement = np.dtype('i', metadata={'spam': True***REMOVED***)
...
def test_empty_string():
    ...
    assert res.dtype == f"S{np.dtype('O').itemsize***REMOVED***"
