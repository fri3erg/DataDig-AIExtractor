...
def document_custom_method(section, method_name, method):
    ...
    :param method: The handle to the method being documented
    """
    full_method_name = f"{section.context.get('qualifier', '')***REMOVED***{method_name***REMOVED***"
...
def document_model_driven_method(
    ...
    if service_uid is not None:
        ...
        link = f"{AWS_DOC_BASE***REMOVED***/{service_uid***REMOVED***/{operation_model.name***REMOVED***"
