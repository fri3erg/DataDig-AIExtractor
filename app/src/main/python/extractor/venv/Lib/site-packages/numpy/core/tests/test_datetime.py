...
class TestDateTime:
    ...
    def test_prohibit_negative_datetime(self, unit):
        with assert_raises(TypeError):
            np.array([1], dtype=f"M8[-1{unit***REMOVED***]")
    ...
    def test_timedelta_nat_format(self):
        # gh-17552
        assert_equal('NaT', '{0***REMOVED***'.format(np.timedelta64('nat')))
    ...
    def test_datetime_array_str(self):
        ...
        assert_equal(np.array2string(a, separator=', ',
                    formatter={'datetime': lambda x:
                            "'%s'" % np.datetime_as_string(x, timezone='UTC')***REMOVED***),
    ...
    def test_setstate(self):
        ...
        assert_raises(TypeError, dt.__setstate__, (4, '>', None, None, None, -1, -1, 0, ({***REMOVED***, 'xxx')))
        assert_(dt.__reduce__()[2] == np.dtype('>M8[us]').__reduce__()[2])
