...
frame_examples_sub = dedent(
    ...
    ...                   "float_col": float_values***REMOVED***)
    >>> df
...
INFO_DOCSTRING = dedent(
    """
    Print a concise summary of a {klass***REMOVED***.

    This method prints information about a {klass***REMOVED*** including
    the index dtype{type_sub***REMOVED***, non-null values and memory usage.
    {version_added_sub***REMOVED***\
    ...
    buf : writable buffer, defaults to sys.stdout
        ...
        the output.
    {max_cols_sub***REMOVED***
    memory_usage : bool, str, optional
        Specifies whether total memory usage of the {klass***REMOVED***
        ...
        details.
    {show_counts_sub***REMOVED***

    Returns
    -------
    None
        This method prints a summary of a {klass***REMOVED*** and returns None.

    See Also
    --------
    {see_also_sub***REMOVED***

    Examples
    --------
    {examples_sub***REMOVED***
    """
)
...
def _sizeof_fmt(num: float, size_qualifier: str) -> str:
    ...
    for x in ["bytes", "KB", "MB", "GB", "TB"]:
        if num < 1024.0:
            return f"{num:3.1f***REMOVED***{size_qualifier***REMOVED*** {x***REMOVED***"
        num /= 1024.0
    return f"{num:3.1f***REMOVED***{size_qualifier***REMOVED*** PB"
...
class _BaseInfo(ABC):
    ...
    def memory_usage_string(self) -> str:
        ...
        return f"{_sizeof_fmt(self.memory_usage_bytes, self.size_qualifier)***REMOVED***\n"
...
class _TableBuilderAbstract(ABC):
    ...
    def add_dtypes_line(self) -> None:
        ...
        collected_dtypes = [
            f"{key***REMOVED***({val:d***REMOVED***)" for key, val in sorted(self.dtype_counts.items())
        ]
        self._lines.append(f"dtypes: {', '.join(collected_dtypes)***REMOVED***")
...
class _DataFrameTableBuilder(_TableBuilderAbstract):
    ...
    def _fill_empty_info(self) -> None:
        ...
        self._lines.append(f"Empty {type(self.data).__name__***REMOVED***\n")
    ...
    def add_memory_usage_line(self) -> None:
        ...
        self._lines.append(f"memory usage: {self.memory_usage_string***REMOVED***")
...
***REMOVED***
    ...
    def _gen_non_null_counts(self) -> Iterator[str]:
        ...
        for count in self.non_null_counts:
            yield f"{count***REMOVED*** non-null"
...
class _DataFrameTableBuilderVerbose(_DataFrameTableBuilder, _TableBuilderVerboseMixin):
    ...
    def add_columns_summary_line(self) -> None:
        self._lines.append(f"Data columns (total {self.col_count***REMOVED*** columns):")
...
class _SeriesTableBuilderVerbose(_SeriesTableBuilder, _TableBuilderVerboseMixin):
    ...
    def add_series_name_line(self) -> None:
        self._lines.append(f"Series name: {self.data.name***REMOVED***")
