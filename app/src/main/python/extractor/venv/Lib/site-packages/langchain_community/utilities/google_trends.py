...
***REMOVED***
    ...
    def run(self, query: str) -> str:
        ...
        ***REMOVED***
        ...
        total_results2 = {***REMOVED***
        client = self.serp_search_engine(params)
        total_results2 = client.get_dict().get("related_queries", {***REMOVED***)
        rising = []
        top = []
        ...
        doc = [
            ...
            f"Date From: {start_date[0]***REMOVED*** {start_date[1]***REMOVED***, {start_date[-1]***REMOVED***\n"
            f"Date To: {end_date[0]***REMOVED*** {end_date[3]***REMOVED*** {end_date[-1]***REMOVED***\n"
            f"Min Value: {min_value***REMOVED***\n"
            f"Max Value: {max_value***REMOVED***\n"
            f"Average Value: {avg_value***REMOVED***\n"
            f"Percent Change: {str(percentage_change) + '%'***REMOVED***\n"
            f"Trend values: {', '.join([str(x) for x in values])***REMOVED***\n"
            f"Rising Related Queries: {', '.join(rising)***REMOVED***\n"
            f"Top Related Queries: {', '.join(top)***REMOVED***"
        ]
