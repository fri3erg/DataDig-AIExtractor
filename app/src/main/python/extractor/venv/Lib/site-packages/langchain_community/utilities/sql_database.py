...
def _format_index(index: sqlalchemy.engine.interfaces.ReflectedIndex) -> str:
    return (
        f'Name: {index["name"]***REMOVED***, Unique: {index["unique"]***REMOVED***,'
        f' Columns: {str(index["column_names"])***REMOVED***'
    )
...
class SQLDatabase:
    ...
    def __init__(
        ...
        if self._include_tables:
            ...
            if missing_tables:
                raise ValueError(
                    f"include_tables {missing_tables***REMOVED*** not found in database"
    ***REMOVED***
        ...
        if self._ignore_tables:
            ...
            if missing_tables:
                raise ValueError(
                    f"ignore_tables {missing_tables***REMOVED*** not found in database"
    ***REMOVED***
...
***REMOVED***
    ...
    def from_uri(
        ...
        _engine_args = engine_args or {***REMOVED***
...
***REMOVED***
    ...
    ***REMOVED***
        ...
        if warehouse_id:
            http_path = f"/sql/1.0/warehouses/{warehouse_id***REMOVED***"
        else:
            http_path = f"/sql/protocolv1/o/0/{cluster_id***REMOVED***"

        uri = (
            f"databricks://token:{api_token***REMOVED***@{host***REMOVED***?"
            f"http_path={http_path***REMOVED***&catalog={catalog***REMOVED***&schema={schema***REMOVED***"
        )
...
***REMOVED***
    ...
    def get_table_info(self, table_names: Optional[List[str]] = None) -> str:
        ...
        if table_names is not None:
            ...
            if missing_tables:
                raise ValueError(f"table_names {missing_tables***REMOVED*** not found in database")
        ...
        for table in meta_tables:
            ...
            table_info = f"{create_table.rstrip()***REMOVED***"
            has_extra_info = (
...
***REMOVED***
            ...
            if self._indexes_in_table_info:
                table_info += f"\n{self._get_table_indexes(table)***REMOVED***\n"
            if self._sample_rows_in_table_info:
                table_info += f"\n{self._get_sample_rows(table)***REMOVED***\n"
            if has_extra_info:
                table_info += "*/"
    ...
    ***REMOVED***
        ...
        return (
            f"{self._sample_rows_in_table_info***REMOVED*** rows from {table.name***REMOVED*** table:\n"
            f"{columns_str***REMOVED***\n"
            f"{sample_rows_str***REMOVED***"
        )
    ...
    def _execute(
        ...
        ***REMOVED***
                    ...
                    connection.exec_driver_sql(f"SET search_path TO {self._schema***REMOVED***")
                elif self.dialect == "oracle":
                    connection.exec_driver_sql(
                        f"ALTER SESSION SET CURRENT_SCHEMA = {self._schema***REMOVED***"
        ***REMOVED***
