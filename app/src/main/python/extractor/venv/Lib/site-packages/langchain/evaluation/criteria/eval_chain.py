...
def resolve_criteria(
    ...
    {'relevance': 'Is the submission referring to a real quote from the text?'***REMOVED***
    """  # noqa: E501
    if criteria is None:
        return {
...
class CriteriaEvalChain(StringEvaluator, LLMEvalChain, LLMChain):
    ...
    **kwargs : Any
    ...
    >>> criteria = {"my-custom-criterion": "Is the submission the most amazing ever?"***REMOVED***
    ...
    ***REMOVED***
    ...
    def _resolve_prompt(
        ...
        expected_input_vars = {"input", "output", "criteria"***REMOVED***
...
class LabeledCriteriaEvalChain(CriteriaEvalChain):
    ...
    def _resolve_prompt(
        ...
        expected_input_vars = {"input", "output", "criteria", "reference"***REMOVED***
