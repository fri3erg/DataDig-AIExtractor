...
class Runnable(Generic[Input, Output], ABC):
    ...
    * Async: Methods with "a" suffix are asynchronous. By default, they execute
    ...
    .. code-block:: python
        ...
        ***REMOVED***
        sequence.invoke(1) # {'mul_2': 4, 'mul_5': 10***REMOVED***
...
***REMOVED***
    ...
    Alternatively, you can pass existing or custom callbacks to any given chain:
        ...
        .. code-block:: python
            ...
            chain.invoke(
                ...,
                config={'callbacks': [ConsoleCallbackHandler()]***REMOVED***
***REMOVED***
    ...
    def InputType(self) -> Type[Input]:
        ...
        raise TypeError(
            f"Runnable {self.get_name()***REMOVED*** doesn't have an inferable InputType. "
    ...
    def OutputType(self) -> Type[Output]:
        ...
        raise TypeError(
            f"Runnable {self.get_name()***REMOVED*** doesn't have an inferable OutputType. "
...
***REMOVED***
        ...
        return create_model(  # type: ignore[call-overload]
            ...
            __config__=_SchemaConfig,
            **({"configurable": (configurable, None)***REMOVED*** if configurable else {***REMOVED***),
            **{
    ...
    async def astream_log(
        ...
        **kwargs: Optional[Any],
        ...
        if callbacks is None:
            ...
            raise ValueError(
                f"Unexpected type for callbacks: {callbacks***REMOVED***."
...
***REMOVED***
        ...
        ***REMOVED***:
                        patches.append({**op, "path": f"/final_output{op['path']***REMOVED***"***REMOVED***)
    ...
    def bind(self, **kwargs: Any) -> Runnable[Input, Output]:
        ...
        """
        return RunnableBinding(bound=self, kwargs=kwargs, config={***REMOVED***)
    ...
    def with_config(
        ...
        **kwargs: Any,
        ...
        return RunnableBinding(
            ...
            config=cast(
                RunnableConfig,
                {**(config or {***REMOVED***), **kwargs***REMOVED***,
***REMOVED***,  # type: ignore[misc]
            kwargs={***REMOVED***,
        )
    ...
    def configurable_fields(
        ...
        for key in kwargs:
            if key not in self.__fields__:
                raise ValueError(
                    f"Configuration key {key***REMOVED*** not found in {self***REMOVED***: "
                    "available keys are {self.__fields__.keys()***REMOVED***"
    ***REMOVED***
    ...
    Here's an example that uses streams JSON output generated by an LLM:
        ...
        .. code-block:: python
            ...
            prompt = PromptTemplate.from_template(
                'In JSON format, give me a list of {topic***REMOVED*** and their '
...
***REMOVED***
            ...
            async for chunk in chain.astream({'topic': 'colors'***REMOVED***):
                print('-')
    ...
    def __init__(
        ...
        *steps: RunnableLike,
        ...
        if len(steps_flat) < 2:
            raise ValueError(
                f"RunnableSequence must have at least 2 steps, got {len(steps_flat)***REMOVED***"
***REMOVED***
        super().__init__(
            first=steps_flat[0],
    ...
    def config_specs(self) -> List[ConfigurableFieldSpec]:
        ...
        deps_by_pos: Dict[int, Set[str]] = {***REMOVED***
        for pos, specs in specs_by_pos:
            deps_by_pos[pos] = next_deps
            next_deps = next_deps | {spec[0].id for spec in specs***REMOVED***
    ...
    def get_graph(self, config: Optional[RunnableConfig] = None) -> Graph:
        ...
        for step in self.steps:
            ...
            if not step_first_node:
                raise ValueError(f"Runnable {step***REMOVED*** has no first node")
        ...
        try:
            for i, step in enumerate(self.steps):
                input = step.invoke(
                    ...
                    patch_config(
                        config, callbacks=run_manager.get_child(f"seq:step:{i+1***REMOVED***")
        ***REMOVED***,
    ***REMOVED***
        # finish the root run
        except BaseException as e:
...
***REMOVED***
        ...
        try:
            if return_exceptions:
                ...
                failed_inputs_map: Dict[int, Exception] = {***REMOVED***
                for stepidx, step in enumerate(self.steps):
                    ...
                    inputs = step.batch(
                        ...
                        [
                            ...
                            patch_config(
                                config, callbacks=rm.get_child(f"seq:step:{stepidx+1***REMOVED***")
                ***REMOVED***
                ...
                for i, step in enumerate(self.steps):
                    inputs = step.batch(
                        ...
                        [
                            # each step a child run of the corresponding root run
                            patch_config(
                                config, callbacks=rm.get_child(f"seq:step:{i+1***REMOVED***")
                ***REMOVED***
    ...
    def _transform(
        ...
        for step in steps:
            final_pipeline = step.transform(
                ...
                patch_config(
                    config,
                    callbacks=run_manager.get_child(f"seq:step:{steps.index(step)+1***REMOVED***"),
    ***REMOVED***,
***REMOVED***
    ...
    def transform(
        ...
        **kwargs: Optional[Any],
        ...
        yield from self._transform_stream_with_config(
            input,
            self._transform,
            patch_config(config, run_name=(config or {***REMOVED***).get("run_name") or self.name),
            **kwargs,
        )
...
class RunnableParallel(RunnableSerializable[Input, Dict[str, Any]]):
    ...
    def __init__(
        ...
        **kwargs: Union[
        ...
        merged = {**__steps***REMOVED*** if __steps is not None else {***REMOVED***
        merged.update(kwargs)
        super().__init__(
            steps={key: coerce_to_runnable(r) for key, r in merged.items()***REMOVED***
        )
    ...
    def get_name(
        ...
        name = name or self.name or f"RunnableParallel<{','.join(self.steps.keys())***REMOVED***>"
...
***REMOVED***
    ...
    def get_output_schema(
        ...
        return create_model(  # type: ignore[call-overload]
            self.get_name("Output"),
            **{k: (v.OutputType, None) for k, v in self.steps.items()***REMOVED***,
            __config__=_SchemaConfig,
        )
        ...
        for step in self.steps.values():
            ...
            if not step_graph:
                ...
                if not step_last_node:
                    raise ValueError(f"Runnable {step***REMOVED*** has no last node")
    ...
    def __repr__(self) -> str:
        map_for_repr = ",\n  ".join(
            f"{k***REMOVED***: {indent_lines_after_first(repr(v), '  ' + k + ': ')***REMOVED***"
            ...
            with get_executor_for_config(config) as executor:
                futures = [
                    executor.submit(
                        ...
                        patch_config(
                            config,
                            callbacks=run_manager.get_child(f"map:key:{key***REMOVED***"),
            ***REMOVED***,
        ***REMOVED***
                    for key, step in steps.items()
                ]
                output = {key: future.result() for key, future in zip(steps, futures)***REMOVED***
        # finish the root run
        except BaseException as e:
            run_manager.on_chain_error(e)
            raise
            ...
            results = await asyncio.gather(
                *(
                    step.ainvoke(
                        ...
                        # mark each step as a child run
                        patch_config(
                            config, callbacks=run_manager.get_child(f"map:key:{key***REMOVED***")
            ***REMOVED***,
        ***REMOVED***
                    for key, step in steps.items()
    ***REMOVED***
***REMOVED***
            output = {key: value for key, value in zip(steps, results)***REMOVED***
        # finish the root run
        except BaseException as e:
            await run_manager.on_chain_error(e)
            raise
            ...
            named_generators = [
                (
                    ...
                    step.transform(
                        input_copies.pop(),
                        patch_config(
                            config, callbacks=run_manager.get_child(f"map:key:{name***REMOVED***")
            ***REMOVED***,
        ***REMOVED***,
    ***REMOVED***
            ...
            ***REMOVED***
            ...
            while futures:
                ...
                for future in completed_futures:
                    ...
                    try:
                        chunk = AddableDict({step_name: future.result()***REMOVED***)
                        yield chunk
...
***REMOVED***
            for task in completed_tasks:
                ...
                try:
                    chunk = AddableDict({step_name: task.result()***REMOVED***)
                    yield chunk
    ...
    def __init__(
        ...
        if inspect.isasyncgenfunction(transform):
            ...
            raise TypeError(
                ...
                f"Instead got an unsupported type: {type(transform)***REMOVED***"
***REMOVED***
...
***REMOVED***
    ...
    def __repr__(self) -> str:
        if hasattr(self, "_transform"):
            return f"RunnableGenerator({self._transform.__name__***REMOVED***)"
        elif hasattr(self, "_atransform"):
            return f"RunnableGenerator({self._atransform.__name__***REMOVED***)"
        else:
...
class RunnableLambda(Runnable[Input, Output]):
    ...
    ***REMOVED***
            ...
            raise TypeError(
                ...
                f"Instead got an unsupported type: {type(func)***REMOVED***"
***REMOVED***
...
***REMOVED***:
                ...
                return create_model(
                    self.get_name("Input"),
                    **{item[1:-1]: (Any, None) for item in items***REMOVED***,  # type: ignore
                    __config__=_SchemaConfig,
    ***REMOVED***
            else:
                return create_model(
    ...
    ***REMOVED***
        ...
        if dict_keys := get_function_first_arg_dict_keys(func):
            return create_model(
                self.get_name("Input"),
                **{key: (Any, None) for key in dict_keys***REMOVED***,  # type: ignore
                __config__=_SchemaConfig,
***REMOVED***
    ...
    ***REMOVED***:
            ...
            for dep in deps:
                ...
                if not dep_graph:
                    ...
                    if not dep_first_node:
                        raise ValueError(f"Runnable {dep***REMOVED*** has no first node")
                    dep_last_node = dep_graph.last_node()
                    if not dep_last_node:
                        raise ValueError(f"Runnable {dep***REMOVED*** has no last node")
    ...
    def __repr__(self) -> str:
        ...
        if hasattr(self, "func") and isinstance(self.func, itemgetter):
            return f"RunnableLambda({str(self.func)[len('operator.'):]***REMOVED***)"
        elif hasattr(self, "func"):
            return f"RunnableLambda({get_lambda_source(self.func) or '...'***REMOVED***)"
        elif hasattr(self, "afunc"):
            return f"RunnableLambda(afunc={get_lambda_source(self.afunc) or '...'***REMOVED***)"
        else:
        ...
        if isinstance(output, Runnable):
            ...
            if recursion_limit <= 0:
                raise RecursionError(
                    f"Recursion limit reached when invoking {self***REMOVED*** with input {input***REMOVED***."
    ***REMOVED***
        ...
        if isinstance(output, Runnable):
            ...
            if recursion_limit <= 0:
                raise RecursionError(
                    ...
                    f"{self***REMOVED*** with input {final***REMOVED***."
    ***REMOVED***
...
class RunnableEach(RunnableEachBase[Input, Output]):
    ...
    def get_name(
        ...
        name = name or self.name or f"RunnableEach<{self.bound.get_name()***REMOVED***>"
        return super().get_name(suffix, name=name)
        ...
        if configurable := config.get("configurable", None):
            ...
            for key in configurable:
                if key not in allowed_keys:
                    raise ValueError(
                        f"Configurable key '{key***REMOVED***' not found in runnable with"
                        f" config keys: {allowed_keys***REMOVED***"
        ***REMOVED***
        super().__init__(
            bound=bound,
    ...
    `bind`: Bind kwargs to pass to the underlying runnable when running it.
        ...
        .. code-block:: python
            ...
            runnable_binding = RunnableBinding(
                bound=model,
                kwargs={'stop': ['-']***REMOVED*** # <-- Note the additional kwargs
***REMOVED***
            runnable_binding.invoke('Say "Parrot-MAGIC"') # Should return `Parrot`
    """
    ...
    def bind(self, **kwargs: Any) -> Runnable[Input, Output]:
        ...
        return self.__class__(
            bound=self.bound,
            config=self.config,
            kwargs={**self.kwargs, **kwargs***REMOVED***,
    ...
    def with_config(
        ...
        **kwargs: Any,
        ...
        return self.__class__(
            bound=self.bound,
            kwargs=self.kwargs,
            config=cast(RunnableConfig, {**self.config, **(config or {***REMOVED***), **kwargs***REMOVED***),
            custom_input_type=self.custom_input_type,
            custom_output_type=self.custom_output_type,
        )
...
def coerce_to_runnable(thing: RunnableLike) -> Runnable[Input, Output]:
    ...
    if isinstance(thing, Runnable):
        ...
        raise TypeError(
            ...
            f"Instead got an unsupported type: {type(thing)***REMOVED***"
        )
...
def chain(
    ...
    .. code-block:: python
        ...
        @chain
        def my_func(fields):
            prompt = PromptTemplate("Hello, {name***REMOVED***!")
            llm = OpenAI()
