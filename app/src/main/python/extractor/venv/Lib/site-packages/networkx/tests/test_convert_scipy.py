...
class TestConvertScipy:
    ...
    def test_format_keyword_raise(self):
        with pytest.raises(nx.NetworkXError):
            WP4 = nx.Graph()
            WP4.add_edges_from(
                (n, n + 1, {"weight": 0.5, "other": 0.3***REMOVED***) for n in range(3)
***REMOVED***
            P4 = path_graph(4)
...
def test_from_scipy_sparse_array_formats(sparse_format):
    ...
    expected.add_edges_from(
        [
            ...
            (0, 2, {"weight": 2***REMOVED***),
            (1, 0, {"weight": 3***REMOVED***),
            (1, 2, {"weight": 1***REMOVED***),
            (2, 0, {"weight": 2***REMOVED***),
            (2, 1, {"weight": 1***REMOVED***),
        ]
    )
