...
class MapReduceChain(Chain):
    ...
    def from_params(
        ...
        **kwargs: Any,
        ...
        stuff_chain = StuffDocumentsChain(
            llm_chain=llm_chain,
            callbacks=callbacks,
            **(reduce_chain_kwargs if reduce_chain_kwargs else {***REMOVED***),
        )
        ...
        combine_documents_chain = MapReduceDocumentsChain(
            ...
            callbacks=callbacks,
            **(combine_chain_kwargs if combine_chain_kwargs else {***REMOVED***),
        )
        return cls(
    ...
    def _call(
        ...
        ***REMOVED***
        ...
        return {self.output_key: outputs***REMOVED***
