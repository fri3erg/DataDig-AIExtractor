...
class TreebankWordTokenizer(TokenizerI):
    ...
    # Pads parentheses
    PARENS_BRACKETS = (re.compile(r"[\]\[\(\)\{\***REMOVED***\<\>]"), r" \g<0> ")
...
***REMOVED***
    ...
    def span_tokenize(self, text: str) -> Iterator[Tuple[int, int]]:
        ...
        if ('"' in text) or ("''" in text):
            ...
            matched = [m.group() for m in re.finditer(r"``|'{2***REMOVED***|\"", text)]
...
class TreebankWordDetokenizer(TokenizerI):
    ...
    - There're additional regexes added in reversing the parentheses tokenization,
       such as the ``r'([\]\)\***REMOVED***\>])\s([:;,.])'``, which removes the additional right
    ...
    CONVERT_PARENTHESES = [
        ...
        (re.compile("-RSB-"), "]"),
        (re.compile("-LCB-"), "{"),
        (re.compile("-RCB-"), "***REMOVED***"),
    ]

    # Undo padding on parentheses.
    PARENS_BRACKETS = [
        (re.compile(r"([\[\(\{\<])\s"), r"\g<1>"),
        (re.compile(r"\s([\]\)\***REMOVED***\>])"), r"\g<1>"),
        (re.compile(r"([\]\)\***REMOVED***\>])\s([:;,.])"), r"\1\2"),
    ]
    ...
    PUNCTUATION = [
        ...
        (re.compile(r'([^\.])\s(\.)([\]\)***REMOVED***>"\']*)\s*$'), r"\1\2\3"),
