...
class ResourceModel:
    ...
    def load_rename_map(self, shape=None):
        ...
        * Attributes (shape members)
        ...
        for name in self._definition.get('actions', {***REMOVED***):
    ...
    ***REMOVED***
        ...
        for name in self._definition.get('hasMany', {***REMOVED***):
            self._load_name_with_category(names, name, 'collection')

        for name in self._definition.get('waiters', {***REMOVED***):
            self._load_name_with_category(
...
***REMOVED***
    ...
    def _load_name_with_category(self, names, name, category, snake_case=True):
        ...
        if name in names:
            logger.debug(f'Renaming {self.name***REMOVED*** {category***REMOVED*** {name***REMOVED***')
            ...
            if name in names:
                ...
                # renaming this value.
                raise ValueError(
                    'Problem renaming {***REMOVED*** {***REMOVED*** to {***REMOVED***!'.format(
...
***REMOVED***
    ...
    def actions(self):
        ...
        for name, item in self._definition.get('actions', {***REMOVED***).items():
    ...
    def batch_actions(self):
        ...
        for name, item in self._definition.get('batchActions', {***REMOVED***).items():
    ...
    def _get_has_definition(self):
        ...
        if self.name not in self._resource_defs:
            ...
            for name, resource_def in self._resource_defs.items():
                ...
                found = False
                has_items = self._definition.get('has', {***REMOVED***).items()
                for has_name, has_def in has_items:
                    if has_def.get('resource', {***REMOVED***).get('type') == name:
                ...
                if not found:
                    ...
                    #     'type': 'ResourceName',
                    #     'identifiers': [
                    #       {'target': 'Name1', 'source': 'input'***REMOVED***,
                    #       {'target': 'Name2', 'source': 'input'***REMOVED***,
                    #       ...
                    #     ]
                    #   ***REMOVED***
                    # ***REMOVED***
                    #
                    fake_has = {'resource': {'type': name, 'identifiers': []***REMOVED******REMOVED***

                    for identifier in resource_def.get('identifiers', []):
                        fake_has['resource']['identifiers'].append(
                            {'target': identifier['name'], 'source': 'input'***REMOVED***
            ***REMOVED***

                    definition[name] = fake_has
        else:
            definition = self._definition.get('has', {***REMOVED***)
    ...
    def collections(self):
        ...
        for name, item in self._definition.get('hasMany', {***REMOVED***).items():
    ...
    def waiters(self):
        ...
        for name, item in self._definition.get('waiters', {***REMOVED***).items():
