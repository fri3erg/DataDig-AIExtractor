...
***REMOVED***.tz_localize("US/Eastern"),
...
def assert_check_nselect_boundary(vals, dtype, method):
    # helper function for 'test_boundary_{dtype***REMOVED***' tests
...
class TestSeriesNLargestNSmallest:
    ...
    def test_nlargest_error(self, r):
        dt = r.dtype
        msg = f"Cannot use method 'n(largest|smallest)' with dtype {dt***REMOVED***"
        args = 2, len(r), 0, -1
