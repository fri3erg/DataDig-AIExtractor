...
class TestDAG:
    ...
    def test_topological_sort1(self):
        ...
        assert tuple(nx.topological_sort(DG)) in {(1, 2, 3), (1, 3, 2)***REMOVED***
    ...
    def test_ancestors(self):
        ...
        assert ancestors(G, 6) == {1, 2, 4, 5***REMOVED***
        assert ancestors(G, 3) == {1, 4***REMOVED***
    ...
    def test_descendants(self):
        ...
        G.add_edges_from([(1, 2), (1, 3), (4, 2), (4, 3), (4, 5), (2, 6), (5, 6)])
        assert descendants(G, 1) == {2, 3, 6***REMOVED***
        assert descendants(G, 4) == {2, 3, 5, 6***REMOVED***
    ...
    def test_transitive_closure(self):
        ...
        G = nx.DiGraph([(1, 2, {"a": 3***REMOVED***), (2, 3, {"b": 0***REMOVED***), (3, 4)])
        H = nx.transitive_closure(G)
        for u, v in G.edges():
            assert G.get_edge_data(u, v) == H.get_edge_data(u, v)

        k = 10
        G = nx.DiGraph((i, i + 1, {"f": "b", "weight": i***REMOVED***) for i in range(k))
        H = nx.transitive_closure(G)
        for u, v in G.edges():
            assert G.get_edge_data(u, v) == H.get_edge_data(u, v)
    ...
    def test_transitive_closure_dag(self):
        ...
        k = 10
        G = nx.DiGraph((i, i + 1, {"foo": "bar", "weight": i***REMOVED***) for i in range(k))
        H = transitive_closure(G)
        for u, v in G.edges():
            assert G.get_edge_data(u, v) == H.get_edge_data(u, v)
    ...
    def test_antichains(self):
        ...
        self._check_antichains(list(antichains(G)), solution)
        G = nx.DiGraph({0: [1, 2], 1: [4], 2: [3], 3: [4]***REMOVED***)
    ...
    def test_lexicographical_topological_sort2(self):
        ...
        class Test_Node:
            ...
            def __repr__(self):
                return f"Node({self.label***REMOVED***)"
...
def test_topological_generations():
    G = nx.DiGraph(
        {1: [2, 3], 2: [4, 5], 3: [7], 4: [], 5: [6, 7], 6: [], 7: []***REMOVED***
    ).reverse()
...
def test_ancestors_descendants_undirected():
    ...
    undirected graphs."""
    G = nx.path_graph(5)
    nx.ancestors(G, 2) == nx.descendants(G, 2) == {0, 1, 3, 4***REMOVED***
