...
def _get_default_params() -> dict:
    return {"language": "en", "format": "json"***REMOVED***
...
class SearxSearchWrapper(BaseModel):
    ...
    def validate_params(cls, values: Dict) -> Dict:
        ...
        values["params"] = {**default, **user_params***REMOVED***
        ...
        if not searx_host.startswith("http"):
            print(
                ...
                ! assuming secure https://{searx_host***REMOVED*** "
***REMOVED***
...
***REMOVED*** as response:
    ...
    def run(
        ...
        **kwargs: Any,
        ...
        _params = {
            "q": query,
        ***REMOVED***
        params = {**self.params, **_params, **kwargs***REMOVED***
    ...
    def results(
        ...
        ***REMOVED***
        ...
        if len(results) == 0:
            return [{"Result": "No good Search Result was found"***REMOVED***]
