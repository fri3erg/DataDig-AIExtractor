...
class TestStronglyConnected:
    ...
    def setup_class(cls):
        ...
        C = {frozenset([3, 4, 5, 7]), frozenset([1, 2, 8]), frozenset([6])***REMOVED***
        cls.gc.append((G, C))

        G = nx.DiGraph()
        G.add_edges_from([(1, 2), (1, 3), (1, 4), (4, 2), (3, 4), (2, 3)])
        C = {frozenset([2, 3, 4]), frozenset([1])***REMOVED***
        cls.gc.append((G, C))

        G = nx.DiGraph()
        G.add_edges_from([(1, 2), (2, 3), (3, 2), (2, 1)])
        C = {frozenset([1, 2, 3])***REMOVED***
        cls.gc.append((G, C))

        # Eppstein's tests
        G = nx.DiGraph({0: [1], 1: [2, 3], 2: [4, 5], 3: [4, 5], 4: [6], 5: [], 6: []***REMOVED***)
        C = {
            frozenset([0]),
            frozenset([1]),
            frozenset([2]),
        ...
        ***REMOVED***
        ...
        G = nx.DiGraph({0: [1], 1: [2, 3, 4], 2: [0, 3], 3: [4], 4: [3]***REMOVED***)
        C = {frozenset([0, 1, 2]), frozenset([3, 4])***REMOVED***
        cls.gc.append((G, C))

    def test_tarjan(self):
        scc = nx.strongly_connected_components
        for G, C in self.gc:
            assert {frozenset(g) for g in scc(G)***REMOVED*** == C
