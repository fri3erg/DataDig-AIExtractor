...
class Review:
    ...
    def __repr__(self):
        return 'Review(title="{***REMOVED***", review_lines={***REMOVED***)'.format(
...
class ReviewLine:
    ...
    def __repr__(self):
        return "ReviewLine(features={***REMOVED***, notes={***REMOVED***, sent={***REMOVED***)".format(
...
class ReviewsCorpusReader(CorpusReader):
    ...
    ***REMOVED***  # We create a new review
                break
