    ...
    for line in lines:
        ...
        if nodetype is not None:
            try:
                ...
                raise TypeError(
                    f"Failed to convert nodes {u***REMOVED***,{v***REMOVED*** to type {nodetype***REMOVED***."
    ***REMOVED*** from err
        ...
        if len(d) == 0 or data is False:
            ...
            try:  # try to evaluate as dictionary
                ...
                raise TypeError(
                    f"Failed to convert edge data ({d***REMOVED***) to dictionary."
    ***REMOVED*** from err
        else:
    ...
    ***REMOVED***
            ...
            for (edge_key, edge_type), edge_value in zip(data, d):
                try:
                    ...
                    raise TypeError(
                        f"Failed to convert {edge_key***REMOVED*** data {edge_value***REMOVED*** "
                        f"to type {edge_type***REMOVED***."
        ***REMOVED*** from err
