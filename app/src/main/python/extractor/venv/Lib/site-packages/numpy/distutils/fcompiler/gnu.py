...
class GnuFCompiler(FCompiler):
    ...
    ***REMOVED***
        ...
        if sys.platform == 'darwin':
            ...
            if not target:
                ...
                ***REMOVED***config
                ...
                if not target:
                    target = '10.9'
                    s = f'Env. variable MACOSX_DEPLOYMENT_TARGET set to {target***REMOVED***'
    ...
    def get_libgfortran_dir(self):
        ...
        if libgfortran_name:
            find_lib_arg = ['-print-file-name={0***REMOVED***'.format(libgfortran_name)]
            try:
