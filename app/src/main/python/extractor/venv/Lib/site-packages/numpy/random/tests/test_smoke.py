...
class RNG:
    ...
    def test_advance(self):
        ...
        if hasattr(self.rg.bit_generator, 'advance'):
            ...
            pytest.skip(f'Advance is not supported by {bitgen_name***REMOVED***')
    ...
    def test_jump(self):
        ...
        if hasattr(self.rg.bit_generator, 'jumped'):
            ...
            if bitgen_name not in ('SFC64',):
                raise AttributeError(f'no "jumped" in {bitgen_name***REMOVED***')
            pytest.skip(f'Jump is not supported by {bitgen_name***REMOVED***')
    ...
    def test_seed_array(self):
        if self.seed_vector_bits is None:
            ...
            pytest.skip(f'Vector seeding is not supported by {bitgen_name***REMOVED***')
