...
class NISTTokenizer(TokenizerI):
    ...
    pup_number = str("".join(set(perluniprops.chars("Number"))))  # i.e. \p{N***REMOVED***
    pup_punct = str("".join(set(perluniprops.chars("Punctuation"))))  # i.e. \p{P***REMOVED***
    pup_symbol = str("".join(set(perluniprops.chars("Symbol"))))  # i.e. \p{S***REMOVED***
    ...
    # Note: In the original perl implementation, \p{Z***REMOVED*** and \p{Zl***REMOVED*** were used to
    ...
    # Line_Separator = str(''.join(perluniprops.chars('Line_Separator'))) # i.e. \p{Zl***REMOVED***
    # Separator = str(''.join(perluniprops.chars('Separator'))) # i.e. \p{Z***REMOVED***
    ...
    PUNCT_1 = (
        re.compile(f"([{number_regex***REMOVED***])([{punct_regex***REMOVED***])"),
        "\\1 \\2 ",
    )
    PUNCT_2 = (
        re.compile(f"([{punct_regex***REMOVED***])([{number_regex***REMOVED***])"),
        " \\1 \\2",
    )
    # Tokenize symbols
    SYMBOLS = re.compile(f"([{symbol_regex***REMOVED***])"), " \\1 "
