...
class TextBlock(Strict):
    ...
    def __repr__(self):
        ...
        return f"{self.__class__.__name__***REMOVED*** text={self.text***REMOVED***, font={font***REMOVED***"
...
class CellRichText(list):
    ...
    def _check_element(cls, value):
        if hasattr(value, "__str__"):
            return
        raise TypeError(f"Illegal CellRichText element {value***REMOVED***")
    ...
    def __repr__(self):
        return "CellRichText([{***REMOVED***])".format(', '.join((repr(s) for s in self)))
