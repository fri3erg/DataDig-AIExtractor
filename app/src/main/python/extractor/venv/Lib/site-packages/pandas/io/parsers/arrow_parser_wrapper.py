        ...
        if on_bad_lines is not None:
            if callable(on_bad_lines):
                ...
                def handle_warning(invalid_row) -> str:
                    warnings.warn(
                        f"Expected {invalid_row.expected_columns***REMOVED*** columns, but found "
                        f"{invalid_row.actual_columns***REMOVED***: {invalid_row.text***REMOVED***",
                        ParserWarning,
        ...
        ***REMOVED***
        ...
        if self.header is None and "include_columns" in self.convert_options:
            self.convert_options["include_columns"] = [
                f"f{n***REMOVED***" for n in self.convert_options["include_columns"]
            ]
        ...
        if self.index_col is not None:
            ...
            for i, item in enumerate(self.index_col):
                ...
                # String case
                    ...
                    raise ValueError(f"Index {item***REMOVED*** invalid")
