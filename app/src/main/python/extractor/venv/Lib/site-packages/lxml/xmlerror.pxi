...
cdef class _BaseErrorLog:
    ...
    cdef _buildParseException(self, exctype, default_message):
        ...
        if line > 0:
            if column > 0:
                message = f"{message***REMOVED***, line {line***REMOVED***, column {column***REMOVED***"
            else:
                message = f"{message***REMOVED***, line {line***REMOVED***"
    ...
    cdef _buildExceptionMessage(self, default_message):
        ...
        if self._first_error.line > 0:
            if self._first_error.column > 0:
                message = f"{message***REMOVED***, line {self._first_error.line***REMOVED***, column {self._first_error.column***REMOVED***"
            else:
                message = f"{message***REMOVED***, line {self._first_error.line***REMOVED***"
        return message
