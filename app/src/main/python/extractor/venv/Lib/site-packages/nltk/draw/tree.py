...
class TreeSegmentWidget(CanvasWidget):
    ...
    def __setitem__(self, attr, value):
        ...
        if attr == "roof":
            ...
            canvas.itemconfig(self._polygon, {attr: value***REMOVED***)
            for l in self._lines:
                canvas.itemconfig(l, {attr: value***REMOVED***)
...
***REMOVED***
    ...
    def __repr__(self):
        return f"[TreeSeg {self._label***REMOVED***: {self._subtrees***REMOVED***]"
...
def tree_to_treesegment(
    ...
    """
    # Process attribs.
    tree_attribs = {***REMOVED***
    node_attribs = {***REMOVED***
    leaf_attribs = {***REMOVED***
    loc_attribs = {***REMOVED***
...
class TreeWidget(CanvasWidget):
    ...
    def __init__(
        ...
        # Attributes.
        self._nodeattribs = {***REMOVED***
        self._leafattribs = {***REMOVED***
        self._locattribs = {"color": "#008000"***REMOVED***
        ...
        # Build trees.
        self._keys = {***REMOVED***  # treeseg -> key
        self._expanded_trees = {***REMOVED***
        self._collapsed_trees = {***REMOVED***
        self._nodes = []
        self._leaves = []
        # self._locs = []
