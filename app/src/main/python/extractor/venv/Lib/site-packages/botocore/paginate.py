...
class PageIterator:
    ...
    def __init__(
        ...
        self._non_aggregate_part = {***REMOVED***
    ...
    def __iter__(self):
        ...
        next_token = {key: None for key in self._input_token***REMOVED***
...
class Paginator:
    ...
    def _extract_paging_params(self, kwargs):
        pagination_config = kwargs.pop('PaginationConfig', {***REMOVED***)
