...
def concurrency_safe_write(object_to_write, filename, write_func):
    ...
    temporary_filename = '{***REMOVED***.thread-{***REMOVED***-pid-{***REMOVED***'.format(
...
class StoreBackendMixin(object):
    ...
    def load_item(self, path, verbose=1, msg=None):
        ...
        if verbose > 1:
            if verbose < 10:
                print('{0***REMOVED***...'.format(msg))
            else:
                print('{0***REMOVED*** from {1***REMOVED***'.format(msg, full_path))
                ...
                with self._open_item(dest_filename, "wb") as f:
                    try:
                        ...
                        warnings.warn(
                            ...
                            f"exception. Exception: {e***REMOVED***.",
                            FutureWarning
            ***REMOVED***
            ...
            warnings.warn(
                ...
                f"creation of the directory. Exception: {e***REMOVED***.",
                CacheWarning
***REMOVED***
    ...
    def get_cached_func_info(self, path):
        ...
        return {'location': os.path.join(self.location, *path)***REMOVED***
    ...
    def enforce_store_limits(
        ...
        for item in items_to_delete:
            if self.verbose > 10:
                print('Deleting item {0***REMOVED***'.format(item))
            try:
...
class FileSystemStoreBackend(StoreBackendBase, StoreBackendMixin):
    ...
    def get_items(self):
        ...
        for dirpath, _, filenames in os.walk(self.location):
            is_cache_hash_dir = re.match('[a-f0-9]{32***REMOVED***',
