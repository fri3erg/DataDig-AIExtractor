...
def _check_engine(engine: str | None) -> str:
    ...
    if engine not in ENGINES:
        ...
        raise KeyError(
            f"Invalid engine '{engine***REMOVED***' passed, valid engines are {valid_engines***REMOVED***"
        )
...
def _check_parser(parser: str):
    ...
    if parser not in PARSERS:
        raise KeyError(
            f"Invalid parser '{parser***REMOVED***' passed, valid parsers are {PARSERS.keys()***REMOVED***"
        )
    ...
    if resolvers is not None:
        for resolver in resolvers:
            if not hasattr(resolver, "__getitem__"):
                ...
                raise TypeError(
                    f"Resolver of type '{name***REMOVED***' does not "
...
def eval(
    ...
    parser : {'pandas', 'python'***REMOVED***, default 'pandas'
        ...
        more details.
    engine : {'python', 'numexpr'***REMOVED***, default 'numexpr'
    ...
    Examples
    --------
    >>> df = pd.DataFrame({"animal": ["dog", "pig"], "age": [10, 20]***REMOVED***)
    >>> df
      animal  age
    0    dog   10
    1    pig   20
...
***REMOVED***
    ...
    ***REMOVED***
        ...
        if env.target is not None and assigner is not None:
            ...
            if not resolvers:
                resolvers = ({assigner: ret***REMOVED***,)
            else:
