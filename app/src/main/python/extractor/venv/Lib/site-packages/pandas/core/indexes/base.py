...
***REMOVED***
_index_shared_docs: dict[str, str] = {***REMOVED***
str_t = str
    ...
    def view(self, cls=None):
        ...
        ***REMOVED***
            ...
            if cls is not None:
                warnings.warn(
                    # GH#55709
                    f"Passing a type in {type(self).__name__***REMOVED***.view is deprecated "
...
***REMOVED***
    ...
    def _maybe_disallow_fill(self, allow_fill: bool, fill_value, indices) -> bool:
        ...
        ***REMOVED***
                ...
                raise ValueError(
                    f"Unable to fill values because {cls_name***REMOVED*** cannot contain NA"
    ***REMOVED***
        else:
            allow_fill = False
        return allow_fill
    ...
    def repeat(self, repeats, axis: None = None) -> Self:
        ...
        nv.validate_repeat((), {"axis": axis***REMOVED***)
    ...
    def __repr__(self) -> str_t:
        ...
        attrs_str = [f"{k***REMOVED***={v***REMOVED***" for k, v in attrs]
        prepr = ", ".join(attrs_str)

        return f"{klass_name***REMOVED***({data***REMOVED***{prepr***REMOVED***)"
    ...
    def _format_attrs(self) -> list[tuple[str_t, str_t | int | bool | None]]:
        ...
        if not self._is_multi:
            attrs.append(("dtype", f"'{self.dtype***REMOVED***'"))
    ...
    def format(
        ...
        warnings.warn(
            # GH#55413
            f"{type(self).__name__***REMOVED***.format is deprecated and will be removed "
...
***REMOVED***
    ...
    def _summary(self, name=None) -> str_t:
        ...
        if len(self) > 0:
            ...
            index_summary = f", {head***REMOVED*** to {tail***REMOVED***"
        else:
            index_summary = ""

        if name is None:
            name = type(self).__name__
        return f"{name***REMOVED***: {len(self)***REMOVED*** entries{index_summary***REMOVED***"
    ...
    def to_frame(
        ...
        result = DataFrame({name: self***REMOVED***, copy=not using_copy_on_write())
...
***REMOVED***
    ...
    def _validate_names(
        ...
        if len(new_names) != len(self.names):
            raise ValueError(
                f"Length of new names must be {len(self.names)***REMOVED***, got {len(new_names)***REMOVED***"
***REMOVED***

        # All items in 'new_names' need to be hashable
        validate_all_hashable(*new_names, error_name=f"{type(self).__name__***REMOVED***.name")
    ...
    def _set_names(self, values, *, level=None) -> None:
        ...
        if len(values) != 1:
            raise ValueError(f"Length of new names must be 1, got {len(values)***REMOVED***")

        # GH 20527
        # All items in 'name' need to be hashable:
        validate_all_hashable(*values, error_name=f"{type(self).__name__***REMOVED***.name")
    ...
    def set_names(self, names, *, level=None, inplace: bool = False) -> Self | None:
       ...
       ***REMOVED***
        ...
        >>> idx.set_names({'kind': 'snake'***REMOVED***)
        MultiIndex([('python', 2018),
                    ('python', 2019),
                    ( 'cobra', 2018),
                    ( 'cobra', 2019)],
        ...
        if isinstance(level, int):
            if level < 0 and level != -1:
                raise IndexError(
                    ...
                    f"{level***REMOVED*** is not a valid level number"
    ***REMOVED***
            if level > 0:
                raise IndexError(
                    f"Too many levels: Index has only 1 level, not {level + 1***REMOVED***"
    ***REMOVED***
        elif level != self.name:
            raise KeyError(
                f"Requested level ({level***REMOVED***) does not match index name ({self.name***REMOVED***)"
***REMOVED***
    ...
    def sortlevel(
        ...
        na_position : {'first' or 'last'***REMOVED***, default 'first'
...
***REMOVED***
    ...
    def _drop_level_numbers(self, levnums: list[int]):
        ...
        if len(levnums) >= self.nlevels:
            raise ValueError(
                f"Cannot remove {len(levnums)***REMOVED*** levels from an index with "
                f"{self.nlevels***REMOVED*** levels: at least one level must be left."
***REMOVED***
...
***REMOVED***
    ...
    def is_boolean(self) -> bool:
        ...
        """
        warnings.warn(
            f"{type(self).__name__***REMOVED***.is_boolean is deprecated. "
    ...
    def is_integer(self) -> bool:
        ...
        """
        warnings.warn(
            f"{type(self).__name__***REMOVED***.is_integer is deprecated. "
            "Use pandas.api.types.is_integer_dtype instead.",
            FutureWarning,
            stacklevel=find_stack_level(),
        )
    ...
    def is_floating(self) -> bool:
        ...
        """
        warnings.warn(
            f"{type(self).__name__***REMOVED***.is_floating is deprecated. "
            "Use pandas.api.types.is_float_dtype instead.",
            FutureWarning,
            stacklevel=find_stack_level(),
        )
    ...
    def is_numeric(self) -> bool:
        ...
        """
        warnings.warn(
            f"{type(self).__name__***REMOVED***.is_numeric is deprecated. "
    ...
    def is_object(self) -> bool:
        ...
        """
        warnings.warn(
            f"{type(self).__name__***REMOVED***.is_object is deprecated."
            "Use pandas.api.types.is_object_dtype instead",
            FutureWarning,
            stacklevel=find_stack_level(),
        )
    ...
    def is_categorical(self) -> bool:
        ...
        """
        warnings.warn(
            f"{type(self).__name__***REMOVED***.is_categorical is deprecated."
    ...
    def is_interval(self) -> bool:
        ...
        """
        warnings.warn(
            f"{type(self).__name__***REMOVED***.is_interval is deprecated."
    ...
    def holds_integer(self) -> bool:
        ...
        """
        warnings.warn(
            f"{type(self).__name__***REMOVED***.holds_integer is deprecated. "
            "Use pandas.api.types.infer_dtype instead.",
            FutureWarning,
            stacklevel=find_stack_level(),
        )
    ...
    def __reduce__(self):
        d = {"data": self._data, "name": self.name***REMOVED***
    ...
    def fillna(self, value=None, downcast=lib.no_default):
        ...
        if not is_scalar(value):
            raise TypeError(f"'value' must be a scalar, passed: {type(value).__name__***REMOVED***")
        if downcast is not lib.no_default:
            warnings.warn(
                f"The 'downcast' keyword in {type(self).__name__***REMOVED***.fillna is "
...
***REMOVED***
        ...
        if self.hasnans:
            ...
            raise NotImplementedError(
                f"{type(self).__name__***REMOVED***.fillna does not support 'downcast' "
    ...
    def _validate_sort_keyword(self, sort):
        if sort not in [None, False, True]:
            raise ValueError(
                ...
                f"None, True, or False; {sort***REMOVED*** was passed."
***REMOVED***
...
***REMOVED***:
    ...
    ***REMOVED***
    ...
    def symmetric_difference(self, other, result_name=None, sort=None):
        ...
        # {this***REMOVED*** minus {other***REMOVED***
        ...
        # {other***REMOVED*** minus {this***REMOVED***
...
***REMOVED***:
    ...
    def get_indexer(
        ...
        ----------
        target : Index
        method : {None, 'pad'/'ffill', 'backfill'/'bfill', 'nearest'***REMOVED***, optional
        ...
        ***REMOVED***
        ...
        if isinstance(self.dtype, (IntervalDtype, CategoricalDtype)):
            ...
            if method is not None:
                raise NotImplementedError(
                    f"method {method***REMOVED*** not yet implemented for {type(self).__name__***REMOVED***"
    ***REMOVED***
    ...
    ***REMOVED***
    ...
    def _convert_tolerance(self, tolerance, target: np.ndarray | Index) -> np.ndarray:
        ...
        if target.size != tolerance.size and tolerance.size > 1:
            ...
            if tolerance.ndim > 0:
                raise ValueError(
                    f"tolerance argument for {type(self).__name__***REMOVED*** with dtype "
                    f"{self.dtype***REMOVED*** must contain numeric elements if it is list type"
    ***REMOVED***

            raise ValueError(
                f"tolerance argument for {type(self).__name__***REMOVED*** with dtype {self.dtype***REMOVED*** "
                f"must be numeric if it is a scalar: {repr(tolerance)***REMOVED***"
***REMOVED***
        return tolerance
...
***REMOVED***:
    ...
    def _get_fill_indexer_searchsorted(
        ...
        if limit is not None:
            raise ValueError(
                f"limit argument for {repr(method)***REMOVED*** method only well-defined "
...
***REMOVED***
    ...
    ***REMOVED***
    ...
    def _raise_invalid_indexer(
        ...
        """
        msg = (
            f"cannot do {form***REMOVED*** indexing on {type(self).__name__***REMOVED*** with these "
            f"indexers [{key***REMOVED***] of type {type(key).__name__***REMOVED***"
        )
...
***REMOVED***
    ...
    def join(
        ...
        *,
        ...
        ----------
        other : Index
        how : {'left', 'right', 'inner', 'outer'***REMOVED***
...
***REMOVED***
        ...
        if isinstance(self, MultiIndex):
            ...
            flip: dict[JoinHow, JoinHow] = {"right": "left", "left": "right"***REMOVED***
...
***REMOVED***
    ...
    def _raise_scalar_data_error(cls, data):
        ...
        raise TypeError(
            f"{cls.__name__***REMOVED***(...) must be called with a collection of some "
            f"kind, {repr(data) if not isinstance(data, np.generic) else str(data)***REMOVED*** "
            "was passed"
        )
    ...
    def append(self, other: Index | Sequence[Index]) -> Index:
        ...
        names = {obj.name for obj in to_concat***REMOVED***
...
***REMOVED***
    ...
    def sort_values(
        ...
        na_position : {'first' or 'last'***REMOVED***, default 'last'
            Argument 'first' puts NaNs at the beginning, 'last' puts NaNs at
            the end.
...
***REMOVED***
    ...
    def shift(self, periods: int = 1, freq=None):
        ...
        raise NotImplementedError(
            ...
            f"TimedeltaIndex; Got type {type(self).__name__***REMOVED***"
        )
...
***REMOVED***:
    ...
    def _raise_if_missing(self, key, indexer, axis_name: str_t) -> None:
        ...
        if nmissing:
            if nmissing == len(indexer):
                raise KeyError(f"None of [{key***REMOVED***] are in the [{axis_name***REMOVED***]")

            not_found = list(ensure_index(key)[missing_mask.nonzero()[0]].unique())
            raise KeyError(f"{not_found***REMOVED*** not in index")
    ...
    def _get_indexer_non_comparable(
        ...
        if method is not None:
            ...
            raise TypeError(f"Cannot compare dtypes {self.dtype***REMOVED*** and {other_dtype***REMOVED***")
...
***REMOVED***:
    ...
    def groupby(self, values) -> PrettyDict[Hashable, np.ndarray]:
        ...
        -------
        dict
            {group name -> group labels***REMOVED***
        """
        ...
        # map to the label
        result = {k: self.take(v) for k, v in result.items()***REMOVED***
    ...
    def map(self, mapper, na_action: Literal["ignore"] | None = None):
        ...
        --------
        >>> idx = pd.Index([1, 2, 3])
        >>> idx.map({1: 'a', 2: 'b', 3: 'c'***REMOVED***)
        Index(['a', 'b', 'c'], dtype='object')

        Using `map` with a function:

        >>> idx = pd.Index([1, 2, 3])
        >>> idx.map('I am a {***REMOVED***'.format)
...
***REMOVED***
        ...
        if isinstance(slc, np.ndarray):
            ...
            if isinstance(slc, np.ndarray):
                raise KeyError(
                    f"Cannot get {side***REMOVED*** slice bound for non-unique "
                    f"label: {repr(original_label)***REMOVED***"
    ***REMOVED***
...
***REMOVED***
    ...
    def drop(
        ...
        if mask.any():
            if errors != "ignore":
                raise KeyError(f"{labels[mask].tolist()***REMOVED*** not found in axis")
...
***REMOVED***
    ...
    def _cmp_method(self, other, op):
        ...
        if self.is_(other):
            # fastpath
            if op in {operator.eq, operator.le, operator.ge***REMOVED***:
    ...
    def argmin(self, axis=None, skipna: bool = True, *args, **kwargs) -> int:
        ...
        if not self._is_multi and self.hasnans:
            ...
            if not skipna or mask.all():
                warnings.warn(
                    f"The behavior of {type(self).__name__***REMOVED***.argmax/argmin "
...
def _validate_join_method(method: str) -> None:
    if method not in ["left", "right", "inner", "outer"]:
        raise ValueError(f"do not recognize join method {method***REMOVED***")
...
def maybe_extract_name(name, obj, cls) -> Hashable:
    ...
    if not is_hashable(name):
        raise TypeError(f"{cls.__name__***REMOVED***.name must be a hashable type")
...
def get_unanimous_names(*indexes: Index) -> tuple[Hashable, ...]:
    ...
    name_sets = [{*ns***REMOVED*** for ns in zip_longest(*name_tups)]
    ...
    if sort is not False:
        try:
            ...
            if sort is True:
                raise
            warnings.warn(
                f"{err***REMOVED***, sort order is undefined for incomparable objects.",
                RuntimeWarning,
                stacklevel=find_stack_level(),
***REMOVED***
    return result
...
***REMOVED***
        ...
        if values.dtype != _dtype_obj and not quoting and itemsize:
            ...
            if values.dtype.itemsize / np.dtype("U1").itemsize < itemsize:
                ...
                values = values.astype(f"<U{itemsize***REMOVED***")
        else:
            values = np.array(values, dtype="object")
