...
class StanfordTokenizer(TokenizerI):
    ...
    >>> StanfordTokenizer(options={"americanize": True***REMOVED***).tokenize(s) # doctest: +SKIP
...
***REMOVED***,
        ...
        self._options_cmd = ",".join(f"{key***REMOVED***={val***REMOVED***" for key, val in options.items())
