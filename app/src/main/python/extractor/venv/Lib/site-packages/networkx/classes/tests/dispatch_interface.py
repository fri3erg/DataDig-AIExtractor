...
def convert(graph):
    ...
    raise TypeError(f"Unsupported type of graph: {type(graph)***REMOVED***")
    ...
    def convert_from_nx(
        ...
        ***REMOVED***:
        ...
        if isinstance(graph, NodeView):
            ...
            raise TypeError(
                f"Bad type for graph argument {graph_name***REMOVED*** in {name***REMOVED***: {type(graph)***REMOVED***"
***REMOVED***
        elif graph.__class__ in {Graph, LoopbackGraph***REMOVED***:
            G = LoopbackGraph()
        elif graph.__class__ in {DiGraph, LoopbackDiGraph***REMOVED***:
            G = LoopbackDiGraph()
        elif graph.__class__ in {MultiGraph, LoopbackMultiGraph***REMOVED***:
            G = LoopbackMultiGraph()
        elif graph.__class__ in {MultiDiGraph, LoopbackMultiDiGraph***REMOVED***:
            G = LoopbackMultiDiGraph()
        elif graph.__class__ in {PlanarEmbedding, LoopbackPlanarEmbedding***REMOVED***:
