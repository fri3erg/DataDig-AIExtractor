...
def api_version_validation(**kwargs):
    params_added_on = kwargs.pop("params_added_on", {***REMOVED***)
    ...
    def decorator(func):
        ...
        def wrapper(*args, **kwargs):
            ...
            if method_added_on > client_api_version:
                raise ValueError(
                    f"'{func.__name__***REMOVED***' is not available in API version "
                    f"{client_api_version***REMOVED***. Pass service API version {method_added_on***REMOVED*** or newer to your client."
    ***REMOVED***
            ...
            ***REMOVED***
            if unsupported:
                raise ValueError(
                    "".join(
                        [
                            f"'{param***REMOVED***' is not available in API version {client_api_version***REMOVED***. "
                            f"Use service API version {version***REMOVED*** or newer.\n"
