...
critique_example = PromptTemplate(
    template="""Human: {input_prompt***REMOVED***

Model: {output_from_model***REMOVED***

Critique Request: {critique_request***REMOVED***

Critique: {critique***REMOVED***""",
    input_variables=[
        "input_prompt",
        "output_from_model",
        "critique_request",
...
CRITIQUE_PROMPT = FewShotPromptTemplate(
    ...
    examples=[
        {k: v for k, v in e.items() if k != "revision_request"***REMOVED*** for e in examples
    ],
    ...
    suffix="""Human: {input_prompt***REMOVED***
Model: {output_from_model***REMOVED***
...
Revision Request: {revision_request***REMOVED***
