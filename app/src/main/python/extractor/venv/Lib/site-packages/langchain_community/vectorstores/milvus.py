...
***REMOVED***
        ...
        self.default_search_params = {
            "IVF_FLAT": {"metric_type": "L2", "params": {"nprobe": 10***REMOVED******REMOVED***,
            "IVF_SQ8": {"metric_type": "L2", "params": {"nprobe": 10***REMOVED******REMOVED***,
            "IVF_PQ": {"metric_type": "L2", "params": {"nprobe": 10***REMOVED******REMOVED***,
            "HNSW": {"metric_type": "L2", "params": {"ef": 10***REMOVED******REMOVED***,
            "RHNSW_FLAT": {"metric_type": "L2", "params": {"ef": 10***REMOVED******REMOVED***,
            "RHNSW_SQ": {"metric_type": "L2", "params": {"ef": 10***REMOVED******REMOVED***,
            "RHNSW_PQ": {"metric_type": "L2", "params": {"ef": 10***REMOVED******REMOVED***,
            "IVF_HNSW": {"metric_type": "L2", "params": {"nprobe": 10, "ef": 10***REMOVED******REMOVED***,
            "ANNOY": {"metric_type": "L2", "params": {"search_k": 10***REMOVED******REMOVED***,
            "AUTOINDEX": {"metric_type": "L2", "params": {***REMOVED******REMOVED***,
        ***REMOVED***
        ...
        if self._metadata_field is not None:
            ...
            if metadatas:
                ...
                ***REMOVED***,
                            key,
            ***REMOVED***
                        raise ValueError(f"Unrecognized datatype for {key***REMOVED***.")
            ...
            try:
                ...
                if self.index_params is None:
                    self.index_params = {
                        "metric_type": "L2",
                        "index_type": "HNSW",
                        "params": {"M": 8, "efConstruction": 64***REMOVED***,
                    ***REMOVED***
    ...
    def add_texts(
        ...
        **kwargs: Any,
        ...
        if not isinstance(self.col, Collection):
            kwargs = {"embeddings": embeddings, "metadatas": metadatas***REMOVED***
    ...
    ***REMOVED***
    ...
    def similarity_search_with_score_by_vector(
        ...
        **kwargs: Any,
        ...
        ret = []
        for result in res[0]:
            data = {x: result.entity.get(x) for x in output_fields***REMOVED***
    ...
    def max_marginal_relevance_search_by_vector(
        ...
        **kwargs: Any,
        ...
        vectors = self.col.query(
            expr=f"{self._primary_field***REMOVED*** in {ids***REMOVED***",
            output_fields=[self._primary_field, self._vector_field],
            timeout=timeout,
        )
        # Reorganize the results from query to match search order.
        vectors = {x[self._primary_field]: x[self._vector_field] for x in vectors***REMOVED***
