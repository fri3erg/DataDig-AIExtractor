...
+++++++++++
    ...
    >>> print(tlp.parse(r'P', {'P': 't'***REMOVED***).type)
    t
    ...
    <e,<e,?>>
    >>> tlp.parse(r'\x y.P(x,y)', {'P': '<e,<e,t>>'***REMOVED***).type
    <e,<e,t>>
...
typecheck()
    ...
    >>> e = tlp.parse(r'man(x)')
    >>> print(dict((k,str(v)) for k,v in e.typecheck().items()) == {'x': 'e', 'man': '<e,?>'***REMOVED***)
    True
    >>> sig = {'man': '<e, t>'***REMOVED***
    >>> e = tlp.parse(r'man(x)', sig)
    >>> print(e.function.type)
    <e,t>
    >>> print(dict((k,str(v)) for k,v in e.typecheck().items()) == {'x': 'e', 'man': '<e,t>'***REMOVED***)
    True
    >>> print(e.function.type)
    <e,t>
    >>> print(dict((k,str(v)) for k,v in e.typecheck(sig).items()) == {'x': 'e', 'man': '<e,t>'***REMOVED***)
    True
