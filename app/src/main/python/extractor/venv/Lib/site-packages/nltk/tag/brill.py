...
class BrillTagger(TaggerI):
    ...
    def print_template_statistics(self, test_stats=None, printunused=True):
        ...
        assert len(trainscores) == len(
            tids
        ), "corrupt statistics: " "{***REMOVED*** train scores for {***REMOVED*** rules".format(
            trainscores, tids
        )
        ...
        def print_train_stats():
            print(
                "TEMPLATE STATISTICS (TRAIN)  {***REMOVED*** templates, {***REMOVED*** rules)".format(
                    len(template_counts), len(tids)
    ***REMOVED***
***REMOVED***
            print(
                "TRAIN ({tokencount:7d***REMOVED*** tokens) initial {initialerrors:5d***REMOVED*** {initialacc:.4f***REMOVED*** "
                "final: {finalerrors:5d***REMOVED*** {finalacc:.4f***REMOVED***".format(**train_stats)
***REMOVED***
...
***REMOVED***
            for (tid, trainscore) in train_tplscores:
                s = "{***REMOVED*** | {:5d***REMOVED***   {:5.3f***REMOVED*** |{:4d***REMOVED***   {:.3f***REMOVED*** | {***REMOVED***".format(
                    tid,
                    trainscore,
    ...
    ***REMOVED***
        ...
        def print_testtrain_stats():
            ...
            print(
                "TEMPLATE STATISTICS (TEST AND TRAIN) ({***REMOVED*** templates, {***REMOVED*** rules)".format(
                    len(template_counts), len(tids)
    ***REMOVED***
***REMOVED***
            print(
                "TEST  ({tokencount:7d***REMOVED*** tokens) initial {initialerrors:5d***REMOVED*** {initialacc:.4f***REMOVED*** "
                "final: {finalerrors:5d***REMOVED*** {finalacc:.4f***REMOVED*** ".format(**test_stats)
***REMOVED***
            print(
                "TRAIN ({tokencount:7d***REMOVED*** tokens) initial {initialerrors:5d***REMOVED*** {initialacc:.4f***REMOVED*** "
                "final: {finalerrors:5d***REMOVED*** {finalacc:.4f***REMOVED*** ".format(**train_stats)
...
***REMOVED***
            for (tid, testscore) in test_tplscores:
                s = "{:s***REMOVED*** |{:5d***REMOVED***  {:6.3f***REMOVED*** |  {:4d***REMOVED***   {:.3f***REMOVED*** |{:4d***REMOVED***   {:.3f***REMOVED*** | {:s***REMOVED***".format(
                    tid,
                    testscore,
    ...
    ***REMOVED***
        ...
        def print_unused_templates():
            usedtpls = {int(tid) for tid in tids***REMOVED***
            unused = [
                (tid, tpl)
                for (tid, tpl) in enumerate(Template.ALLTEMPLATES)
                if tid not in usedtpls
            ]
            print(f"UNUSED TEMPLATES ({len(unused)***REMOVED***)")

            for (tid, tpl) in unused:
                print(f"{tid:03d***REMOVED*** {str(tpl):s***REMOVED***")
