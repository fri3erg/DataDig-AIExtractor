...
class WrongConstantError(PydanticValueError):
    ...
    def __str__(self) -> str:
        ...
        return f'unexpected value; permitted: {permitted***REMOVED***'
...
class UrlExtraError(UrlError):
    code = 'url.extra'
    msg_template = 'URL invalid, extra characters found after valid URL: {extra!r***REMOVED***'
...
class EnumMemberError(PydanticTypeError):
    ...
    def __str__(self) -> str:
        ...
        return f'value is not a valid enumeration member; permitted: {permitted***REMOVED***'
...
class PathNotExistsError(_PathValueError):
    ...
    msg_template = 'file or directory at path "{path***REMOVED***" does not exist'


class PathNotAFileError(_PathValueError):
    code = 'path.not_a_file'
    msg_template = 'path "{path***REMOVED***" does not point to a file'


class PathNotADirectoryError(_PathValueError):
    code = 'path.not_a_directory'
    msg_template = 'path "{path***REMOVED***" does not point to a directory'


class PyObjectError(PydanticTypeError):
    msg_template = 'ensure this value contains valid import path or valid callable: {error_message***REMOVED***'
...
class TupleLengthError(PydanticValueError):
    code = 'tuple.length'
    msg_template = 'wrong tuple length {actual_length***REMOVED***, expected {expected_length***REMOVED***'
...
class ListMinLengthError(PydanticValueError):
    code = 'list.min_items'
    msg_template = 'ensure this value has at least {limit_value***REMOVED*** items'
...
class ListMaxLengthError(PydanticValueError):
    code = 'list.max_items'
    msg_template = 'ensure this value has at most {limit_value***REMOVED*** items'
...
class AnyStrMinLengthError(PydanticValueError):
    ...
    msg_template = 'ensure this value has at least {limit_value***REMOVED*** characters'
...
class AnyStrMaxLengthError(PydanticValueError):
    ...
    msg_template = 'ensure this value has at most {limit_value***REMOVED*** characters'
...
class StrRegexError(PydanticValueError):
    code = 'str.regex'
    msg_template = 'string does not match regex "{pattern***REMOVED***"'
...
class NumberNotGtError(_NumberBoundError):
    code = 'number.not_gt'
    msg_template = 'ensure this value is greater than {limit_value***REMOVED***'


class NumberNotGeError(_NumberBoundError):
    code = 'number.not_ge'
    msg_template = 'ensure this value is greater than or equal to {limit_value***REMOVED***'


class NumberNotLtError(_NumberBoundError):
    code = 'number.not_lt'
    msg_template = 'ensure this value is less than {limit_value***REMOVED***'


class NumberNotLeError(_NumberBoundError):
    code = 'number.not_le'
    msg_template = 'ensure this value is less than or equal to {limit_value***REMOVED***'
...
class NumberNotMultipleError(PydanticValueError):
    ...
    msg_template = 'ensure this value is a multiple of {multiple_of***REMOVED***'
...
class DecimalMaxDigitsError(PydanticValueError):
    ...
    msg_template = 'ensure that there are no more than {max_digits***REMOVED*** digits in total'
...
class DecimalMaxPlacesError(PydanticValueError):
    ...
    msg_template = 'ensure that there are no more than {decimal_places***REMOVED*** decimal places'
...
class DecimalWholeDigitsError(PydanticValueError):
    ...
    msg_template = 'ensure that there are no more than {whole_digits***REMOVED*** digits before the decimal point'
...
class UUIDVersionError(PydanticValueError):
    code = 'uuid.version'
    msg_template = 'uuid version {required_version***REMOVED*** expected'
...
class ArbitraryTypeError(PydanticTypeError):
    code = 'arbitrary_type'
    msg_template = 'instance of {expected_arbitrary_type***REMOVED*** expected'
...
class SubclassError(PydanticTypeError):
    code = 'subclass'
    msg_template = 'subclass of {expected_class***REMOVED*** expected'
...
class DataclassTypeError(PydanticTypeError):
    code = 'dataclass'
    msg_template = 'instance of {class_name***REMOVED***, tuple or dict expected'


class CallableError(PydanticTypeError):
    msg_template = '{value***REMOVED*** is not callable'


class EnumError(PydanticTypeError):
    code = 'enum_instance'
    msg_template = '{value***REMOVED*** is not a valid Enum instance'


class IntEnumError(PydanticTypeError):
    code = 'int_enum_instance'
    msg_template = '{value***REMOVED*** is not a valid IntEnum instance'
...
class ColorError(PydanticValueError):
    msg_template = 'value is not a valid color: {reason***REMOVED***'
...
class InvalidLengthForBrand(PydanticValueError):
    ...
    msg_template = 'Length for a {brand***REMOVED*** card must be {required_length***REMOVED***'
...
class InvalidByteSizeUnit(PydanticValueError):
    msg_template = 'could not interpret byte unit: {unit***REMOVED***'


class MissingDiscriminator(PydanticValueError):
    code = 'discriminated_union.missing_discriminator'
    msg_template = 'Discriminator {discriminator_key!r***REMOVED*** is missing in value'


class InvalidDiscriminator(PydanticValueError):
    code = 'discriminated_union.invalid_discriminator'
    msg_template = (
        'No match for discriminator {discriminator_key!r***REMOVED*** and value {discriminator_value!r***REMOVED*** '
        '(allowed values: {allowed_values***REMOVED***)'
    )
