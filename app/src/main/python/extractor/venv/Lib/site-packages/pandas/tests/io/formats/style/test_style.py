...
def mi_styler_comp(mi_styler):
    ...
    mi_styler.css = {**mi_styler.css, "row": "ROW", "col": "COL"***REMOVED***
    mi_styler.uuid_len = 5
    mi_styler.uuid = "abcde"
    mi_styler.set_caption("capt")
    mi_styler.set_table_styles([{"selector": "a", "props": "a:v;"***REMOVED***])
...
@pytest.fixture
def df():
    df = DataFrame({"A": [0, 1], "B": np.random.default_rng(2).standard_normal(2)***REMOVED***)
    return df
...
@pytest.mark.parametrize(
    ...
    [
        (
            True,
            [
                {"is_visible": True, "attributes": 'colspan="2"', "value": "c0"***REMOVED***,
                {"is_visible": False, "attributes": "", "value": "c0"***REMOVED***,
            ],
        ),
        (
            False,
            [
                {"is_visible": True, "attributes": "", "value": "c0"***REMOVED***,
                {"is_visible": True, "attributes": "", "value": "c0"***REMOVED***,
            ],
        ),
    ],
...
def test_mi_styler_sparsify_columns(mi_styler, sparse_columns, exp_cols):
    exp_l1_c0 = {"is_visible": True, "attributes": "", "display_value": "c1_a"***REMOVED***
    exp_l1_c1 = {"is_visible": True, "attributes": "", "display_value": "c1_b"***REMOVED***
...
@pytest.mark.parametrize(
    ...
    [
        (
            True,
            [
                {"is_visible": True, "attributes": 'rowspan="2"', "value": "i0"***REMOVED***,
                {"is_visible": False, "attributes": "", "value": "i0"***REMOVED***,
            ],
        ),
        (
            False,
            [
                {"is_visible": True, "attributes": "", "value": "i0"***REMOVED***,
                {"is_visible": True, "attributes": "", "value": "i0"***REMOVED***,
            ],
        ),
    ],
...
def test_mi_styler_sparsify_index(mi_styler, sparse_index, exp_rows):
    exp_l1_r0 = {"is_visible": True, "attributes": "", "display_value": "i1_a"***REMOVED***
    exp_l1_r1 = {"is_visible": True, "attributes": "", "display_value": "i1_b"***REMOVED***
...
def test_render_trimming_mi():
    ...
    assert {"attributes": 'rowspan="2"'***REMOVED***.items() <= ctx["body"][0][0].items()
    assert {"class": "data row0 col_trim"***REMOVED***.items() <= ctx["body"][0][4].items()
    assert {"class": "data row_trim col_trim"***REMOVED***.items() <= ctx["body"][2][4].items()
...
def test_hide_raises(mi_styler):
    ...
    with pytest.raises(ValueError, match=msg):
        mi_styler.hide(axis="index", level={"bad": 1, "type": 2***REMOVED***)
...
def test_apply_map_header(method, axis):
    # GH 41893
    df = DataFrame({"A": [0, 0], "B": [1, 1]***REMOVED***, index=["C", "D"])
    func = {
    ...
    ***REMOVED***
    ...
    result = getattr(df.style, f"{method***REMOVED***_index")(func[method], axis=axis)
    assert len(result._todo) == 1
    assert len(getattr(result, f"ctx_{axis***REMOVED***")) == 0
    ...
    expected = {
        (0, 0): [("attr", "val")],
    ***REMOVED***
    assert getattr(result, f"ctx_{axis***REMOVED***") == expected
...
def test_apply_map_header_mi(mi_styler, method, axis):
    ...
    ***REMOVED***
    result = getattr(mi_styler, f"{method***REMOVED***_index")(func[method], axis=axis)._compute()
    expected = {(1, 1): [("attr", "val")]***REMOVED***
    assert getattr(result, f"ctx_{axis***REMOVED***") == expected
...
class TestStyler:
    ...
    def test_update_ctx(self, styler):
        styler._update_ctx(DataFrame({"A": ["color: red", "color: blue"]***REMOVED***))
        expected = {(0, 0): [("color", "red")], (1, 0): [("color", "blue")]***REMOVED***
        assert styler.ctx == expected

    def test_update_ctx_flatten_multi_and_trailing_semi(self, styler):
        attrs = DataFrame({"A": ["color: red; foo: bar", "color:blue ; foo: baz;"]***REMOVED***)
    ...
    def test_numeric_columns(self):
        ...
        df = DataFrame({0: [1, 2, 3]***REMOVED***)
        df.style._translate(True, True)

    def test_apply_axis(self):
        df = DataFrame({"A": [0, 0], "B": [1, 1]***REMOVED***)
        f = lambda x: [f"val: {x.max()***REMOVED***" for v in x]
    ...
    def test_apply_subset(self, slice_, axis, df):
        def h(x, color="bar"):
            return Series(f"color: {color***REMOVED***", index=x.index, name=x.name)
    ...
    def test_subset_for_boolean_cols(self, stylefunc):
        ...
        styled._compute()
        assert set(styled.ctx) == {(0, 0), (0, 1), (1, 0), (1, 1)***REMOVED***

    def test_empty(self):
        df = DataFrame({"A": [1, 0]***REMOVED***)
        s = df.style
        s.ctx = {(0, 0): [("color", "red")], (1, 0): [("", "")]***REMOVED***

        result = s._translate(True, True)["cellstyle"]
        expected = [
            {"props": [("color", "red")], "selectors": ["row0_col0"]***REMOVED***,
            {"props": [("", "")], "selectors": ["row1_col0"]***REMOVED***,
        ]
        assert result == expected
    ...
    def test_duplicate(self):
        df = DataFrame({"A": [1, 0]***REMOVED***)
        s = df.style
        s.ctx = {(0, 0): [("color", "red")], (1, 0): [("color", "red")]***REMOVED***

        result = s._translate(True, True)["cellstyle"]
        expected = [
            {"props": [("color", "red")], "selectors": ["row0_col0", "row1_col0"]***REMOVED***
        ]
        assert result == expected
    ...
    def test_unique_id(self):
        ...
        df = DataFrame({"a": [1, 3, 5, 6], "b": [2, 4, 12, 21]***REMOVED***)
    ...
    def test_table_styles(self, df):
        style = [{"selector": "th", "props": [("foo", "bar")]***REMOVED***]  # default format
        styler = Styler(df, table_styles=style)
        result = " ".join(styler.to_html().split())
        assert "th { foo: bar; ***REMOVED***" in result
        ...
        # GH 39563
        style = [{"selector": "th", "props": "foo:bar;"***REMOVED***]  # css string format
    ...
    def test_table_styles_multiple(self, df):
        ctx = df.style.set_table_styles(
            [
                {"selector": "th,td", "props": "color:red;"***REMOVED***,
                {"selector": "tr", "props": "color:green;"***REMOVED***,
            ]
        )._translate(True, True)["table_styles"]
        assert ctx == [
            {"selector": "th", "props": [("color", "red")]***REMOVED***,
            {"selector": "td", "props": [("color", "red")]***REMOVED***,
            {"selector": "tr", "props": [("color", "green")]***REMOVED***,
        ]
    ...
    def test_table_styles_dict_multiple_selectors(self, df):
        ...
        result = df.style.set_table_styles(
            {
                "B": [
                    {"selector": "th,td", "props": [("border-left", "2px solid black")]***REMOVED***
                ]
            ***REMOVED***
        )._translate(True, True)["table_styles"]

        expected = [
            {"selector": "th.col1", "props": [("border-left", "2px solid black")]***REMOVED***,
            {"selector": "td.col1", "props": [("border-left", "2px solid black")]***REMOVED***,
        ]
...
***REMOVED***
    ...
    def test_export(self, df, styler):
        ...
        g = lambda x, z: f"color: {z***REMOVED***" if x > 0 else f"color: {z***REMOVED***"
        style1 = styler
    ...
    def test_bad_apply_shape(self):
        ...
        msg = "created invalid {***REMOVED*** labels"
    ...
    def test_apply_bad_labels(self, axis):
        def f(x):
            return DataFrame(**{axis: ["bad", "labels"]***REMOVED***)

        df = DataFrame([[1, 2], [3, 4]])
        msg = f"created invalid {axis***REMOVED*** labels."
        with pytest.raises(ValueError, match=msg):
            df.style._apply(f, axis=None)
...
***REMOVED***,
        ...
        for level in [0, 1]:
            ...
            expected = [
                ...
                ***REMOVED***,
                {
                    "class": f"index_name level{level***REMOVED***",
                    "display_value": f"colnam_{level***REMOVED***",
                    "is_visible": True,
                ***REMOVED***,
            ]
            for i, expected_dict in enumerate(expected):
...
***REMOVED***,
    ...
    def test_pipe(self, df):
        def set_caption_from_template(styler, a, b):
            return styler.set_caption(f"Dataframe with a = {a***REMOVED*** and b = {b***REMOVED***")
...
***REMOVED***,
    ...
    def test_chaining_table_styles(self):
        ...
        styler = df.style.set_table_styles(
            [{"selector": "", "props": [("background-color", "yellow")]***REMOVED***]
        ).set_table_styles(
            [{"selector": ".col0", "props": [("background-color", "blue")]***REMOVED***],
            overwrite=False,
        )
    ...
    def test_column_and_row_styling(self):
        ...
        s = s.set_table_styles({"A": [{"selector": "", "props": [("color", "blue")]***REMOVED***]***REMOVED***)
        assert "#T_ .col0 {\n  color: blue;\n***REMOVED***" in s.to_html()
        s = s.set_table_styles(
            {0: [{"selector": "", "props": [("color", "blue")]***REMOVED***]***REMOVED***, axis=1
        )
        assert "#T_ .row0 {\n  color: blue;\n***REMOVED***" in s.to_html()
    ...
    def test_list_slice(self, box):
        ...
        df = DataFrame({"A": [1, 2], "B": [3, 4]***REMOVED***, index=["A", "B"])
    ...
    def test_non_reducing_slice_on_multiindex(self):
        ...
        ***REMOVED***
        ...
        expected = DataFrame({("b", "d"): [4, 1]***REMOVED***)
...
def test_row_trimming_hide_index_mi():
    ...
    assert {"value": 0, "attributes": 'rowspan="2"', "is_visible": True***REMOVED***.items() <= ctx[
        "body"
    ][0][0].items()
    assert {"value": 0, "attributes": "", "is_visible": False***REMOVED***.items() <= ctx["body"][
        1
    ][0].items()
    assert {"value": "...", "is_visible": True***REMOVED***.items() <= ctx["body"][2][0].items()
...
def test_output_buffer(mi_styler, format):
    # gh 47053
    with tm.ensure_clean(f"delete_me.{format***REMOVED***") as f:
        getattr(mi_styler, f"to_{format***REMOVED***")(f)
