...
# Unicode codepoint properties with the \p{***REMOVED*** syntax.
...
***REMOVED***
    ...
    def remove_punctuation(self, text):
        ...
        return re.sub(r"[^\P{P***REMOVED***\']+", "", text)
...
def demo():
    ...
    ***REMOVED***
    ...
    for cur_lang in langs:
        ...
        print(f"Language detection: {guess***REMOVED*** ({friendly[guess]***REMOVED***)")
        print("#" * 140)
