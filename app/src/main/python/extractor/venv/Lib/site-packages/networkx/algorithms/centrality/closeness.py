...
def closeness_centrality(G, u=None, distance=None, wf_improved=True):
    ...
    .. math::
        ...
        C(u) = \frac{n - 1***REMOVED***{\sum_{v=1***REMOVED***^{n-1***REMOVED*** d(v, u)***REMOVED***,
    ...
    .. math::
        ...
        C_{WF***REMOVED***(u) = \frac{n-1***REMOVED***{N-1***REMOVED*** \frac{n - 1***REMOVED***{\sum_{v=1***REMOVED***^{n-1***REMOVED*** d(v, u)***REMOVED***,
    ...
    {0: 1.0, 1: 1.0, 2: 0.75, 3: 0.75***REMOVED***
