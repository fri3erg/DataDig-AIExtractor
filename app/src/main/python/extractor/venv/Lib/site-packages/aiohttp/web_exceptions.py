...
***REMOVED***
        ...
        if self.body is None and not self.empty_body:
            self.text = f"{self.status***REMOVED***: {self.reason***REMOVED***"
...
class HTTPRequestEntityTooLarge(HTTPClientError):
    ...
    def __init__(self, max_size: float, actual_size: float, **kwargs: Any) -> None:
        kwargs.setdefault(
            "text",
            "Maximum request body size {***REMOVED*** exceeded, "
            "actual body size {***REMOVED***".format(max_size, actual_size),
        )
...
class HTTPUnavailableForLegalReasons(HTTPClientError):
    ...
    def __init__(
        ...
        *,
        ...
        if link:
            self._link = URL(link)
            self.headers["Link"] = f'<{str(self._link)***REMOVED***>; rel="blocked-by"'
