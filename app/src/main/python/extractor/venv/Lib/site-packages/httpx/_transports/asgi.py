        ...
        ***REMOVED***
        ...
        async def receive() -> typing.Dict[str, typing.Any]:
            ...
            if request_complete:
                ...
                return {"type": "http.disconnect"***REMOVED***

            try:
                body = await request_body_chunks.__anext__()
            except StopAsyncIteration:
                request_complete = True
                return {"type": "http.request", "body": b"", "more_body": False***REMOVED***
            return {"type": "http.request", "body": body, "more_body": True***REMOVED***
