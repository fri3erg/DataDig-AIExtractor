...
class TestDateRanges:
    ...
    def test_range_bug(self, unit):
        ...
        expected = DatetimeIndex(
            [start + i * offset for i in range(5)], dtype=f"M8[{unit***REMOVED***]", freq=offset
        )
        tm.assert_index_equal(result, expected)
    ...
    def test_frequencies_H_T_S_L_U_N_deprecated(self, freq, freq_depr):
        ...
        msg = (
            f"'{freq_depr_msg***REMOVED***' is deprecated and will be removed in a future version, "
        )
        f"please use '{freq_msg***REMOVED***' instead"
    ...
    def test_frequencies_A_deprecated_Y_renamed(self, freq, freq_depr):
        ...
        freq_msg = re.split("[0-9]*", freq, maxsplit=1)[1]
        freq_depr_msg = re.split("[0-9]*", freq_depr, maxsplit=1)[1]
        msg = f"'{freq_depr_msg***REMOVED***' is deprecated and will be removed "
        f"in a future version, please use '{freq_msg***REMOVED***' instead."
...
class TestCustomDateRange:
    ...
    def test_cdaterange(self, unit):
        ...
        expected = DatetimeIndex(
            ["2013-05-01", "2013-05-02", "2013-05-03"], dtype=f"M8[{unit***REMOVED***]", freq="C"
        )
        tm.assert_index_equal(result, expected)
...
***REMOVED***
    ...
    def test_all_custom_freq(self, freq):
        ...
        bad_freq = freq + "FOO"
        msg = f"invalid custom frequency string: {bad_freq***REMOVED***"
        with pytest.raises(ValueError, match=msg):
...
class TestDateRangeNonTickFreq:
    ...
    def test_date_range_businesshour(self, unit):
        ...
        idx = DatetimeIndex(
            ["2014-07-04 16:00", "2014-07-07 09:00"], dtype=f"M8[{unit***REMOVED***]", freq="bh"
        )
    ...
    def test_date_range_business_hour_short(self, unit):
        ...
        expected4 = DatetimeIndex(["2014-07-01 10:00"], dtype=f"M8[{unit***REMOVED***]", freq="bh")
    ...
    def test_date_range_negative_freq_year_end(self, unit):
        ...
        exp = DatetimeIndex(
            ["2011-12-31", "2009-12-31", "2007-12-31"], dtype=f"M8[{unit***REMOVED***]", freq="-2YE"
        )
        tm.assert_index_equal(rng, exp)
        assert rng.freq == "-2YE"
    ...
    def test_date_range_semi_month_begin(self, unit):
        ...
        exp = DatetimeIndex(dates, dtype=f"M8[{unit***REMOVED***]", freq="SMS")
    ...
    def test_date_range_semi_month_end(self, unit):
        ...
        exp = DatetimeIndex(dates, dtype=f"M8[{unit***REMOVED***]", freq="SME")
        tm.assert_index_equal(result, exp)
    ...
    def test_date_range_week_of_month(self, unit):
        ...
        expected = DatetimeIndex(["2011-01-03"], dtype=f"M8[{unit***REMOVED***]", freq="WOM-1MON")
        tm.assert_index_equal(result, expected)

        result2 = date_range(start="20110101", periods=2, freq="WOM-1MON", unit=unit)
        expected2 = DatetimeIndex(
            ["2011-01-03", "2011-02-07"], dtype=f"M8[{unit***REMOVED***]", freq="WOM-1MON"
        )
        tm.assert_index_equal(result2, expected2)
    ...
    def test_date_range_negative_freq_month_end(self, unit):
        ...
        exp = DatetimeIndex(
            ["2011-01-31", "2010-11-30", "2010-09-30"], dtype=f"M8[{unit***REMOVED***]", freq="-2ME"
        )
        tm.assert_index_equal(rng, exp)
        assert rng.freq == "-2ME"
    ...
    def test_date_range_fy5253(self, unit):
        ...
        expected = DatetimeIndex(
            ["2013-01-31", "2014-01-30"], dtype=f"M8[{unit***REMOVED***]", freq=freq
        )
