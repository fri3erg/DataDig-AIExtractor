        ...
        if "client" in values:
            ...
            if not isinstance(client, Metal):
                raise ValueError(
                    ...
                    f"Instead, got {type(client)***REMOVED***"
    ***REMOVED***

        values["params"] = values.get("params", {***REMOVED***)
    ...
    def _get_relevant_documents(
        ...
        results = self.client.search({"text": query***REMOVED***, **self.params)
        final_results = []
        for r in results["data"]:
            metadata = {k: v for k, v in r.items() if k != "text"***REMOVED***
