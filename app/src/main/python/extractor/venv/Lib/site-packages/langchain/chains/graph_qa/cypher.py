...
def construct_schema(
    ...
    filtered_schema: Dict[str, Any] = {
        "node_props": {
            k: v
            for k, v in structured_schema.get("node_props", {***REMOVED***).items()
            if filter_func(k)
        ***REMOVED***,
        "rel_props": {
            k: v
            for k, v in structured_schema.get("rel_props", {***REMOVED***).items()
            if filter_func(k)
        ***REMOVED***,
        "relationships": [
            r
    ...
    ***REMOVED***
    ...
    for label, properties in filtered_schema["node_props"].items():
        props_str = ", ".join(
            [f"{prop['property']***REMOVED***: {prop['type']***REMOVED***" for prop in properties]
        )
        formatted_node_props.append(f"{label***REMOVED*** {{{props_str***REMOVED******REMOVED******REMOVED***")
    ...
    for rel_type, properties in filtered_schema["rel_props"].items():
        ...
        formatted_rel_props.append(f"{rel_type***REMOVED*** {{{props_str***REMOVED******REMOVED******REMOVED***")

    # Format relationships
    formatted_rels = [
        f"(:{el['start']***REMOVED***)-[:{el['type']***REMOVED***]->(:{el['end']***REMOVED***)"
...
***REMOVED***
        use_qa_llm_kwargs = qa_llm_kwargs if qa_llm_kwargs is not None else {***REMOVED***
        use_cypher_llm_kwargs = (
            cypher_llm_kwargs if cypher_llm_kwargs is not None else {***REMOVED***
        )
...
***REMOVED***
    ...
    def _call(
        ...
        generated_cypher = self.cypher_generation_chain.run(
            {"question": question, "schema": self.graph_schema***REMOVED***, callbacks=callbacks
        )
        ...
        intermediate_steps.append({"query": generated_cypher***REMOVED***)
...
***REMOVED***
            ...
            intermediate_steps.append({"context": context***REMOVED***)

            result = self.qa_chain(
                {"question": question, "context": context***REMOVED***,
                callbacks=callbacks,
***REMOVED***
            final_result = result[self.qa_chain.output_key]

        chain_result: Dict[str, Any] = {self.output_key: final_result***REMOVED***
