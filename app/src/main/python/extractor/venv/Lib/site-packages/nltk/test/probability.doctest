...
-------------------
    ...
    [(1, FreqDist({'b': 6, 'c': 3, 'a': 1***REMOVED***)), (2, FreqDist({'x': 7, 'y': 5, 'z': 2***REMOVED***)), (3, FreqDist({'m': 1***REMOVED***))]

    >>> r = cfd1 - cfd2
    >>> [(i,r[i]) for i in r.conditions()]
    [(1, FreqDist({'b': 2, 'a': 1***REMOVED***)), (2, FreqDist({'x': 1***REMOVED***))]

    >>> r = cfd1 | cfd2
    >>> [(i,r[i]) for i in r.conditions()]
    [(1, FreqDist({'b': 4, 'c': 3, 'a': 1***REMOVED***)), (2, FreqDist({'x': 4, 'y': 3, 'z': 2***REMOVED***)), (3, FreqDist({'m': 1***REMOVED***))]

    >>> r = cfd1 & cfd2
    >>> [(i,r[i]) for i in r.conditions()]
    [(1, FreqDist({'b': 2***REMOVED***)), (2, FreqDist({'x': 3, 'y': 2***REMOVED***))]
...
they don't get smoothed
    ...
    >>> fd = FreqDist({'a':1, 'b':1, 'c': 2, 'd': 3, 'e': 4, 'f': 4, 'g': 4, 'h': 5, 'i': 5, 'j': 6, 'k': 6, 'l': 6, 'm': 7, 'n': 7, 'o': 8, 'p': 9, 'q': 10***REMOVED***)
...
``ConditionalFreqDist`` can be pickled:
    ...
    True
    >>> dpd = DictionaryConditionalProbDist({'x': pd***REMOVED***)
