    ...
    Example:
        .. code-block:: python
            ...
            prompt_template = (
                ...
                "you are. Context: {content***REMOVED***"
***REMOVED***
    ...
    def get_output_schema(
        ...
        ***REMOVED***
        ...
        if self.metadata_keys:
            schema.update({key: (Any, None) for key in self.metadata_keys***REMOVED***)
    ...
    def validate_llm_output(cls, values: Dict) -> Dict:
        ...
        if not isinstance(output_parser, RegexParser):
            raise ValueError(
                ...
                f" got {output_parser***REMOVED***"
***REMOVED***
        output_keys = output_parser.output_keys
        if values["rank_key"] not in output_keys:
            raise ValueError(
                f"Got {values['rank_key']***REMOVED*** as key to rank on, but did not find "
                f"it in the llm_chain output keys ({output_keys***REMOVED***)"
***REMOVED***
        if values["answer_key"] not in output_keys:
            raise ValueError(
                f"Got {values['answer_key']***REMOVED*** as key to return, but did not find "
                f"it in the llm_chain output keys ({output_keys***REMOVED***)"
***REMOVED***
        return values
