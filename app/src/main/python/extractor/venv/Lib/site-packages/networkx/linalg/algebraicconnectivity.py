...
class _LUSolver:
    ...
    def __init__(self, A):
        ...
        self._LU = sp.sparse.linalg.splu(
            ...
            options={"Equil": True, "SymmetricMode": True***REMOVED***,
        )
...
def _tracemin_fiedler(L, X, normalized, tol, method):
    ...
    if method == "tracemin_pcg":
        ...
        raise nx.NetworkXError(f"Unknown linear system solver: {method***REMOVED***")
...
def _get_fiedler_func(method):
    ...
    ***REMOVED***
        ...
        raise nx.NetworkXError(f"unknown method {method!r***REMOVED***.")
