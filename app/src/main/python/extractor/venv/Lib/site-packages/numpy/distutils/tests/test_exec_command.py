...
class TestExecCommand:
    ...
    def check_nt(self, **kws):
        ...
        s, o = exec_command.exec_command(
         '"%s" -c "***REMOVED***;sys.stderr.write(sys.platform)"' % self.pyexe)
        assert_(s == 0)
        assert_(o == 'win32')
    ...
    def check_posix(self, **kws):
        ...
        s, o = exec_command.exec_command(
             '"%s" -c "***REMOVED***,os;sys.stderr.write(os.name)"' %
             self.pyexe, **kws)
        assert_(s == 0)
        assert_(o == 'posix')
    ...
    def check_basic(self, *kws):
        ...
        s, o = exec_command.exec_command(
             '"%s" -c "***REMOVED***;sys.stderr.write(\'0\');'
        ...
        s, o = exec_command.exec_command(
                 '"%s" -c "***REMOVED***;sys.exit(15)"' % self.pyexe, **kws)
        assert_(s == 15)
        assert_(o == '')
