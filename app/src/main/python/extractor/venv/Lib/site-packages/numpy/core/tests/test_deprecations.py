...
class _DeprecationTestCase:
    ...
    def assert_not_deprecated(self, function, args=(), kwargs={***REMOVED***):
...
class TestFromStringAndFileInvalidData(_DeprecationTestCase):
    ...
    def test_deprecate_unparsable_string(self, invalid_str):
        x = np.array([1.51, 2, 3.51, 4], dtype=float)
        x_str = "1.51,2,3.51,4{***REMOVED***".format(invalid_str)
...
class Test_GetSet_NumericOps(_DeprecationTestCase):
    ...
    def test_get_numeric_ops(self):
        ...
        # other tests.
        self.assert_deprecated(np.set_numeric_ops, kwargs={***REMOVED***)
...
class BuiltInRoundComplexDType(_DeprecationTestCase):
    ...
    def test_deprecated(self):
        for scalar_type in self.deprecated_types:
            ...
            self.assert_deprecated(round, args=(scalar,), kwargs={'ndigits': 0***REMOVED***)
    ...
    def test_not_deprecated(self):
        for scalar_type in self.not_deprecated_types:
            ...
            self.assert_not_deprecated(round, args=(scalar,), kwargs={'ndigits': 0***REMOVED***)
...
def test_future_scalar_attributes(name):
    ...
    with pytest.warns(FutureWarning,
            match=f"In the future .*{name***REMOVED***"):
...
class TestRemovedGlobals:
    ...
    def test_attributeerror_includes_info(self, name):
        msg = f".*\n`np.{name***REMOVED***` was a deprecated alias for the builtin"
