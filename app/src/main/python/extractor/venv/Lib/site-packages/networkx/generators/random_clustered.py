...
def random_clustered_graph(joint_degree_sequence, create_using=None, seed=None):
    ...
    $[(d_{1,i***REMOVED***, d_{1,t***REMOVED***), \dotsc, (d_{n,i***REMOVED***, d_{n,t***REMOVED***)]$. According to this list,
    vertex $u$ is a member of $d_{u,t***REMOVED***$ triangles and has $d_{u, i***REMOVED***$ other
    edges. The number $d_{u,t***REMOVED***$ is the *triangle degree* of $u$ and the number
    $d_{u,i***REMOVED***$ is the *independent edge degree*.
