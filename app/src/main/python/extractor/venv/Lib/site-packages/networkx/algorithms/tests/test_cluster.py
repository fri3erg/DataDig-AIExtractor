...
class TestTriangles:
    ...
    def test_cubical(self):
        ...
        assert nx.triangles(G, 1) == 0
        assert nx.triangles(G, [1, 2]) == {1: 0, 2: 0***REMOVED***
...
class TestDirectedClustering:
    def test_clustering(self):
        ...
        assert nx.clustering(G) == {***REMOVED***
    ...
    def test_k5(self):
        ...
        assert nx.clustering(G, [1, 4]) == {1: 1, 4: 11 / 12***REMOVED***
        G.remove_edge(2, 1)
        assert list(nx.clustering(G).values()) == [
            5 / 6,
            1,
        ...
        assert nx.clustering(G, [1, 4]) == {1: 1, 4: 0.83333333333333337***REMOVED***
...
class TestDirectedWeightedClustering:
    ...
    def test_k5(self):
        ...
        assert nx.clustering(G, [1, 4], weight="weight") == {1: 1, 4: 11 / 12***REMOVED***
        G.remove_edge(2, 1)
        assert list(nx.clustering(G, weight="weight").values()) == [
            5 / 6,
            1,
...
class TestWeightedClustering:
    ...
    def test_cubical(self):
        ...
        assert nx.clustering(G, [1, 2], weight="weight") == {1: 0, 2: 0***REMOVED***
...
class TestClustering:
    ...
    def test_cubical(self):
        ...
        assert nx.clustering(G, 1) == 0
        assert nx.clustering(G, [1, 2]) == {1: 0, 2: 0***REMOVED***
...
class TestSquareClustering:
    def test_clustering(self):
        ...
        assert nx.square_clustering(G) == {***REMOVED***
    ...
    def test_cubical(self):
        ...
        assert nx.square_clustering(G, [1, 2]) == {1: 1 / 3, 2: 1 / 3***REMOVED***
...
class TestGeneralizedDegree:
    def test_generalized_degree(self):
        G = nx.Graph()
        assert nx.generalized_degree(G) == {***REMOVED***

    def test_path(self):
        G = nx.path_graph(5)
        assert nx.generalized_degree(G, 0) == {0: 1***REMOVED***
        assert nx.generalized_degree(G, 1) == {0: 2***REMOVED***

    def test_cubical(self):
        G = nx.cubical_graph()
        assert nx.generalized_degree(G, 0) == {0: 3***REMOVED***

    def test_k5(self):
        G = nx.complete_graph(5)
        assert nx.generalized_degree(G, 0) == {3: 4***REMOVED***
        G.remove_edge(0, 1)
        assert nx.generalized_degree(G, 0) == {2: 3***REMOVED***
        assert nx.generalized_degree(G, [1, 2]) == {1: {2: 3***REMOVED***, 2: {2: 2, 3: 2***REMOVED******REMOVED***
