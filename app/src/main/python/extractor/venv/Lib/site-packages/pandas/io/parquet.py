...
def _get_path_or_handle(
    ...
    ***REMOVED***
            ...
            raise ValueError(
                ...
                f"not a {type(fs).__name__***REMOVED***"
***REMOVED***
    if is_fsspec_url(path_or_handle) and fs is None:
        ...
        if fs is None:
            ...
            fs, path_or_handle = fsspec.core.url_to_fs(
                path_or_handle, **(storage_options or {***REMOVED***)
***REMOVED***
...
class PyArrowImpl(BaseImpl):
    ...
    def write(
        ...
        **kwargs,
        ...
        from_pandas_kwargs: dict[str, Any] = {"schema": kwargs.pop("schema", None)***REMOVED***
        ...
        if df.attrs:
            df_metadata = {"PANDAS_ATTRS": json.dumps(df.attrs)***REMOVED***
            existing_metadata = table.schema.metadata
            merged_metadata = {**existing_metadata, **df_metadata***REMOVED***
...
***REMOVED***
        ...
        if is_fsspec_url(path):
            ...
            kwargs["open_with"] = lambda path, _: fsspec.open(
                path, "wb", **(storage_options or {***REMOVED***)
***REMOVED***.open()
...
***REMOVED***
    ...
    def read(
        ...
        **kwargs,
        ...
        parquet_kwargs: dict[str, Any] = {***REMOVED***
...
***REMOVED***
        ...
        if is_fsspec_url(path):
            ...
            parquet_kwargs["fs"] = fsspec.open(path, "rb", **(storage_options or {***REMOVED***)).fs
...
def to_parquet(
    ...
    **kwargs,
    ...
    compression : {{'snappy', 'gzip', 'brotli', 'lz4', 'zstd', None***REMOVED******REMOVED***,
...
def read_parquet(
    ...
    **kwargs
    ...
    ...     {{"foo": range(5), "bar": range(5, 10)***REMOVED******REMOVED***
    ...    )
    >>> original_df
       foo  bar
    0    0    5
