...
***REMOVED***
    ...
    def __init__(
        ...
        **kwargs: Optional[dict],
        ...
        self.index_params = kwargs.get("index_params") or {***REMOVED***
...
***REMOVED***
    ...
    def _create_index_if_not_exists(self, dims_length: Optional[int] = None) -> None:
        ...
        if self.client.indices.exists(index=self.index_name):
            logger.info(f"Index {self.index_name***REMOVED*** already exists. Skipping creation.")
    ...
    ***REMOVED***
            ...
            logger.debug(
                f"Creating index {self.index_name***REMOVED*** with mappings {indexMapping***REMOVED***"
***REMOVED***

            self.client.indices.create(
                index=self.index_name,
                body={
                    "settings": {"index": {"knn": True***REMOVED******REMOVED***,
                    "mappings": {"properties": indexMapping***REMOVED***,
                ***REMOVED***,
***REMOVED***
...
***REMOVED***
    ...
    ***REMOVED***
    ...
    def _query_body(
        ...
        search_params: Dict = {***REMOVED***,
    ) -> Dict:
        query_vector_body = {"vector": query_vector, "k": search_params.get("k", 2)***REMOVED***
        ...
        return {
            ...
            "query": {"knn": {self.vector_query_field: query_vector_body***REMOVED******REMOVED***,
        ***REMOVED***
    ...
    def _search(
        ...
        logger.debug(f"response={response***REMOVED***")
...
***REMOVED***
    ...
    def similarity_search_with_score(
        ...
        Returns:
            List of Documents most similar to the query and score for each
        """
        search_params = kwargs.get("search_params") or {***REMOVED***
