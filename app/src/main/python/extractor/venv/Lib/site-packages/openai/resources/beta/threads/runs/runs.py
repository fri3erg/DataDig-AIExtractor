...
class Runs(SyncAPIResource):
    ...
    def create(
        ...
        *,
        ...
        """
        if not thread_id:
            raise ValueError(f"Expected a non-empty value for `thread_id` but received {thread_id!r***REMOVED***")
        extra_headers = {"OpenAI-Beta": "assistants=v1", **(extra_headers or {***REMOVED***)***REMOVED***
        return self._post(
            f"/threads/{thread_id***REMOVED***/runs",
    ...
    def retrieve(
        ...
        *,
        ...
        if not thread_id:
            raise ValueError(f"Expected a non-empty value for `thread_id` but received {thread_id!r***REMOVED***")
        if not run_id:
            raise ValueError(f"Expected a non-empty value for `run_id` but received {run_id!r***REMOVED***")
        extra_headers = {"OpenAI-Beta": "assistants=v1", **(extra_headers or {***REMOVED***)***REMOVED***
        return self._get(
            f"/threads/{thread_id***REMOVED***/runs/{run_id***REMOVED***",
            options=make_request_options(
                extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout
***REMOVED***,
            cast_to=Run,
    ...
    def update(
        ...
        *,
        ...
        return self._post(
            f"/threads/{thread_id***REMOVED***/runs/{run_id***REMOVED***",
            body=maybe_transform({"metadata": metadata***REMOVED***, run_update_params.RunUpdateParams),
            options=make_request_options(
                extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout
***REMOVED***,
            cast_to=Run,
...
***REMOVED***,
    ...
    def cancel(
        ...
        *,
        ...
        extra_headers = {"OpenAI-Beta": "assistants=v1", **(extra_headers or {***REMOVED***)***REMOVED***
        return self._post(
            f"/threads/{thread_id***REMOVED***/runs/{run_id***REMOVED***/cancel",
            options=make_request_options(
                extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout
***REMOVED***,
            cast_to=Run,
    ...
    def submit_tool_outputs(
        ...
        *,
        ...
        extra_headers = {"OpenAI-Beta": "assistants=v1", **(extra_headers or {***REMOVED***)***REMOVED***
        return self._post(
            f"/threads/{thread_id***REMOVED***/runs/{run_id***REMOVED***/submit_tool_outputs",
            body=maybe_transform(
                {"tool_outputs": tool_outputs***REMOVED***, run_submit_tool_outputs_params.RunSubmitToolOutputsParams
***REMOVED***,
            options=make_request_options(
                extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout
***REMOVED***,
