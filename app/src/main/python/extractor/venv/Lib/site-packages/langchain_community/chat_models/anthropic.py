...
def _convert_one_message_to_text(
    ...
    if isinstance(message, ChatMessage):
        message_text = f"\n\n{message.role.capitalize()***REMOVED***: {content***REMOVED***"
    elif isinstance(message, HumanMessage):
        message_text = f"{human_prompt***REMOVED*** {content***REMOVED***"
    elif isinstance(message, AIMessage):
        message_text = f"{ai_prompt***REMOVED*** {content***REMOVED***"
...
class ChatAnthropic(BaseChatModel, _AnthropicCommon):
    ...
    def lc_secrets(self) -> Dict[str, str]:
        return {"anthropic_api_key": "ANTHROPIC_API_KEY"***REMOVED***
    ...
    def _stream(
        ...
        **kwargs: Any,
        ...
        params: Dict[str, Any] = {"prompt": prompt, **self._default_params, **kwargs***REMOVED***
        if stop:
