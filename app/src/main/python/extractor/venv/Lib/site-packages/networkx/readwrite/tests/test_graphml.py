...
"""
        ...
        cls.attribute_graph.graph["node_default"] = {"color": "yellow"***REMOVED***
    ...
    def test_preserve_multi_edge_data(self):
        ...
        G.add_edges_from(
            [
                ...
                (1, 2, {"key": "data_key1"***REMOVED***),
                (1, 2, {"id": "data_id2"***REMOVED***),
                (1, 2, {"key": "data_key3", "id": "data_id3"***REMOVED***),
                # edges with both data and keys:
                (1, 2, 103, {"key": "data_key4"***REMOVED***),
                (1, 2, 104, {"id": "data_id5"***REMOVED***),
                (1, 2, 105, {"key": "data_key6", "id": "data_id7"***REMOVED***),
            ]
        )
        fh = io.BytesIO()
        ...
        Gadj = {
            str(node): {
                str(nbr): {str(ekey): dd for ekey, dd in key_dict.items()***REMOVED***
  ...
  <graph edgedefault="directed">
    <node id="n1">
      <data key="d6">4284</data>
        ...
        fh = io.BytesIO(s.encode("UTF-8"))
        G = nx.read_graphml(fh)
        expected = [("n1", {"cudfversion": 4284***REMOVED***)]
...
class TestWriteGraphML(BaseGraphML):
    ...
    def test_default_attribute(self):
        ...
        G.graph["node_default"] = {"color": "yellow"***REMOVED***
        G.graph["edge_default"] = {"weight": 7***REMOVED***
        fh = io.BytesIO()
        self.writer(G, fh)
        fh.seek(0)
        H = nx.read_graphml(fh, node_type=int)
    ...
    def test_write_generate_edge_id_from_attribute(self):
        ...
        edge_attributes = {e: str(e) for e in G.edges***REMOVED***
        ...
        edge_ids = [
            ...
            for edge in tree.getroot().findall(
                ".//{http://graphml.graphdrawing.org/xmlns***REMOVED***edge"
***REMOVED***
        ]
...
***REMOVED***
    ...
    def test_numpy_float64(self):
        np = pytest.importorskip("numpy")
        wt = np.float64(3.4)
        G = nx.Graph([(1, 2, {"weight": wt***REMOVED***)])
        fd, fname = tempfile.mkstemp()
        self.writer(G, fname)
    ...
    def test_unicode_escape(self):
        ...
        a = {"a": '{"a": "123"***REMOVED***'***REMOVED***  # an object with many chars to escape
        sa = json.dumps(a)
        G = nx.Graph()
        G.graph["test"] = sa
        fh = io.BytesIO()
