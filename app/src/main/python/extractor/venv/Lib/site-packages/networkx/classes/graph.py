...
class Graph:
    ...
    **Attributes:**
    ...
    [(1, {'time': '5pm'***REMOVED***), (3, {'time': '2pm'***REMOVED***)]
    ...
    >>> G.add_edges_from([(1, 2, {"color": "blue"***REMOVED***), (2, 3, {"weight": 8***REMOVED***)])
    >>> G[1][2]["weight"] = 4.7
    ...
    **Subclassing Example**
    ...
    ...     all_edge_dict = {"weight": 1***REMOVED***
    ...
    ...
    def __str__(self):
        ...
        return "".join(
            [
                type(self).__name__,
                f" named {self.name!r***REMOVED***" if self.name else "",
                f" with {self.number_of_nodes()***REMOVED*** nodes and {self.number_of_edges()***REMOVED*** edges",
            ]
        )
    ...
    def add_nodes_from(self, nodes_for_adding, **attr):
        ...
        >>> G.add_nodes_from([(1, dict(size=11)), (2, {"color": "blue"***REMOVED***)])
        >>> G.nodes[1]["size"]
        11
        >>> H = nx.Graph()
    ...
    def remove_node(self, n):
        ...
        try:
            ...
            raise NetworkXError(f"The node {n***REMOVED*** is not in the graph.") from err
        for u in nbrs:
    ...
    def nodes(self):
        ...
        >>> G.nodes[0]["foo"] = "bar"
        >>> list(G.nodes(data=True))
        [(0, {'foo': 'bar'***REMOVED***), (1, {'time': '5pm'***REMOVED***), (2, {***REMOVED***)]
        >>> list(G.nodes.data())
        [(0, {'foo': 'bar'***REMOVED***), (1, {'time': '5pm'***REMOVED***), (2, {***REMOVED***)]
    ...
    def add_edge(self, u_of_edge, v_of_edge, **attr):
        ...
        >>> G.add_edge(1, 2)
        >>> G[1][2].update({0: 5***REMOVED***)
        >>> G.edges[1, 2].update({0: 5***REMOVED***)
        """
    ...
    def add_edges_from(self, ebunch_to_add, **attr):
        ...
        for e in ebunch_to_add:
            ...
            if ne == 3:
                ...
                u, v = e
                dd = {***REMOVED***  # doesn't need edge_attr_dict_factory
            else:
                raise NetworkXError(f"Edge tuple {e***REMOVED*** must be a 2-tuple or 3-tuple.")
            if u not in self._node:
                if u is None:
                    raise ValueError("None cannot be a node")
                self._adj[u] = self.adjlist_inner_dict_factory()
    ...
    def add_weighted_edges_from(self, ebunch_to_add, weight="weight", **attr):
        ...
        """
        self.add_edges_from(((u, v, {weight: d***REMOVED***) for u, v, d in ebunch_to_add), **attr)
    ...
    def remove_edge(self, u, v):
        ...
        >>> e = (2, 3, {"weight": 7***REMOVED***)  # an edge with attribute data
        ...
        try:
            ...
            raise NetworkXError(f"The edge {u***REMOVED***-{v***REMOVED*** is not in the graph") from err
    ...
    def update(self, edges=None, nodes=None):
        ...
        >>> adj = {1: {2, 3***REMOVED***, 2: {1, 3***REMOVED***, 3: {1, 2***REMOVED******REMOVED***
        >>> e = [(u, v) for u, nbrs in adj.items() for v in nbrs]
        >>> G.update(edges=e, nodes=adj)

        >>> DG = nx.DiGraph()
        >>> # dict-of-dict-of-attribute
        >>> adj = {1: {2: 1.3, 3: 0.7***REMOVED***, 2: {1: 1.4***REMOVED***, 3: {1: 0.7***REMOVED******REMOVED***
        >>> e = [
        ...     (u, v, {"weight": d***REMOVED***)
        ...
        >>> adj = {1: {2: {"weight": 1.3***REMOVED***, 3: {"color": 0.7, "weight": 1.2***REMOVED******REMOVED******REMOVED***
        >>> e = [
        ...     (u, v, {"weight": d***REMOVED***)
        ...     for u, nbrs in adj.items()
        ...     for v, d in nbrs.items()
        ...
        >>> pred = {1: {2, 3***REMOVED***, 2: {3***REMOVED***, 3: {3***REMOVED******REMOVED***
        >>> e = [(v, u) for u, nbrs in pred.items() for v in nbrs]

        >>> # MultiGraph dict-of-dict-of-dict-of-attribute
        >>> MDG = nx.MultiDiGraph()
        >>> adj = {
        ...     1: {2: {0: {"weight": 1.3***REMOVED***, 1: {"weight": 1.2***REMOVED******REMOVED******REMOVED***,
        ...     3: {2: {0: {"weight": 0.7***REMOVED******REMOVED******REMOVED***,
        ... ***REMOVED***
        >>> e = [
        ...     (u, v, ekey, d)
        ...     for u, nbrs in adj.items()
    ...
    def neighbors(self, n):
        ...
        >>> G["a"]
        AtlasView({'b': {'weight': 7***REMOVED******REMOVED***)
        >>> G = nx.path_graph(4)
        >>> [n for n in G[0]]
        [1]
        """
    ...
    def edges(self):
        ...
        >>> [e for e in G.edges]
        [(0, 1), (1, 2), (2, 3)]
        >>> G.edges.data()  # default data is {***REMOVED*** (empty dict)
        EdgeDataView([(0, 1, {***REMOVED***), (1, 2, {***REMOVED***), (2, 3, {'weight': 5***REMOVED***)])
    ...
    def get_edge_data(self, u, v, default=None):
        ...
        >>> G = nx.path_graph(4)  # or DiGraph, MultiGraph, MultiDiGraph, etc
        >>> G.get_edge_data(0, 1)  # default edge data is {***REMOVED***
        {***REMOVED***
        >>> e = (0, 1)
    ...
    def adjacency(self):
        ...
        [(0, {1: {***REMOVED******REMOVED***), (1, {0: {***REMOVED***, 2: {***REMOVED******REMOVED***), (2, {1: {***REMOVED***, 3: {***REMOVED******REMOVED***), (3, {2: {***REMOVED******REMOVED***)]
        ...
        if nbunch is None:  # include all nodes via iterator
            ...
            ***REMOVED***
                    ...
                    if "hashable" in message:
                        exc = NetworkXError(
                            f"Node {n***REMOVED*** in sequence nbunch is not a valid node."
            ***REMOVED***
                    raise exc
