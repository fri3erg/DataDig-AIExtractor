...
***REMOVED***
        try:
            (inference_params := {***REMOVED***) if inference_params is None else inference_params
...
***REMOVED***
            ...
            logger.error(f"Predict failed, exception: {e***REMOVED***")
...
***REMOVED***
        ...
        try:
            for i in range(0, len(prompts), batch_size):
                ...
                (
                    inference_params := {***REMOVED***
    ***REMOVED*** if inference_params is None else inference_params
