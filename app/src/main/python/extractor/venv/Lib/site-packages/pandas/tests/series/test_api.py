...
class TestSeriesMisc:
    ...
    def test_tab_completion_with_categorical(self):
        ...
        results = sorted({r for r in s.cat.__dir__() if not r.startswith("_")***REMOVED***)
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            Index([True, False]),
            Index([f"a{i***REMOVED***" for i in range(101)]),
    ...
    def test_attrs(self):
        ...
        assert s.attrs == {***REMOVED***
        s.attrs["version"] = 1
        result = s + 1
        assert result.attrs == {"version": 1***REMOVED***
    ...
    def test_datetime_series_no_datelike_attrs(self, op, datetime_series):
        # GH#7206
        msg = f"'Series' object has no attribute '{op***REMOVED***'"
        with pytest.raises(AttributeError, match=msg):
            getattr(datetime_series, op)

    def test_series_datetimelike_attribute_access(self):
        # attribute access should still work!
        ser = Series({"year": 2000, "month": 1, "day": 10***REMOVED***)
...
***REMOVED***
            ...
            msg = f"Series.{kernel***REMOVED*** does not allow numeric_only=True with non-numeric"
            with pytest.raises(TypeError, match=msg):
                method(*args, numeric_only=True)
        else:
