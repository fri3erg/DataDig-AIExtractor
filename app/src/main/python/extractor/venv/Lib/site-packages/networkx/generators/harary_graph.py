...
def hnm_harary_graph(n, m, create_using=None):
    ...
    The Harary graph $H_{n,m***REMOVED***$ is the graph that maximizes node connectivity
    ...
    -------
    NetworkX graph
        The Harary graph $H_{n,m***REMOVED***$.
...
def hkn_harary_graph(k, n, create_using=None):
    ...
    The Harary graph $H_{k,n***REMOVED***$ is the graph that minimizes the number of
    ...
    -------
    NetworkX graph
        The Harary graph $H_{k,n***REMOVED***$.
