...
def _decode_header_lines(
    ...
    for line in _obsolete_line_fold(lines):
        matches = validate(header_field_re, line, "illegal header line: {!r***REMOVED***", line)
...
def maybe_read_from_IDLE_client(buf: ReceiveBuffer) -> Optional[Request]:
    ...
    matches = validate(
        request_line_re, lines[0], "illegal request line: {!r***REMOVED***", lines[0]
    )
    return Request(
...
def maybe_read_from_SEND_RESPONSE_server(
    ...
    matches = validate(status_line_re, lines[0], "illegal status line: {!r***REMOVED***", lines[0])
    http_version = (
...
class ContentLengthReader:
    ...
    def read_eof(self) -> NoReturn:
        raise RemoteProtocolError(
            ...
            "(received {***REMOVED*** bytes, expected {***REMOVED***)".format(
    ...
    def __call__(self, buf: ReceiveBuffer) -> Union[Data, EndOfMessage, None]:
        ...
        if self._bytes_in_chunk == 0:
            ...
            matches = validate(
                chunk_header_re,
                chunk_header,
                "illegal chunk header: {!r***REMOVED***",
                chunk_header,
***REMOVED***
