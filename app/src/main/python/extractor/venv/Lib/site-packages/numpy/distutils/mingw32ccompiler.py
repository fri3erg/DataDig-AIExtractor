...
def find_python_dll():
    ...
    if implementation == 'cpython':
        dllname = f'python{major_version***REMOVED***{minor_version***REMOVED***.dll'
    elif implementation == 'pypy':
        dllname = f'libpypy{major_version***REMOVED***.{minor_version***REMOVED***-c.dll'
    else:
        dllname = f'Unknown platform {implementation***REMOVED***' 
...
def find_dll(dll_name):
    ...
    arch = {'AMD64' : 'amd64',
            'Intel' : 'x86'***REMOVED***[get_build_architecture()]
