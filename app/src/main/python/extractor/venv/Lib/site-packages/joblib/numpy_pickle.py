    ...
    * writing the array bytes to a file.
    ...
    def read_mmap(self, unpickler):
        ...
        if (numpy_array_alignment_bytes is None and
            ...
            message = (
                f'The memmapped array {marray***REMOVED*** loaded from the file '
                f'{unpickler.file_handle.name***REMOVED*** is not byte aligned. '
    ...
    * optional compression with a special care on avoiding memory copies.
    ...
    def _create_array_wrapper(self, array):
        ...
        try:
            ...
            kwargs = {'numpy_array_alignment_bytes': None***REMOVED***
...
def dump(value, filename, compress=0, protocol=None, cache_size=None):
    ...
    if compress is True:
        ...
        if len(compress) != 2:
            raise ValueError(
                ...
                '(compress method, compress level), you passed {***REMOVED***'
                .format(compress))
    ...
    if (compress_level is not None and
        ...
        raise ValueError(
            'Non valid compress level given: "{***REMOVED***". Possible values are '
            '{***REMOVED***.'.format(compress_level, list(range(10))))

    if compress_method not in _COMPRESSORS:
        # Raising an error if an unsupported compression method is given.
        raise ValueError(
            'Non valid compression method given: "{***REMOVED***". Possible values are '
            '{***REMOVED***.'.format(compress_method, _COMPRESSORS))
    ...
    if cache_size is not None:
        ...
        warnings.warn("Please do not set 'cache_size' in joblib.dump, "
                      ...
                      "You used 'cache_size={***REMOVED***'".format(cache_size),
