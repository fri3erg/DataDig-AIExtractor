...
def _add_docstring(obj, doc, warn_on_python):
    if warn_on_python and not _needs_add_docstring(obj):
        warnings.warn(
            "add_newdoc was used on a pure-python object {***REMOVED***. "
...
def add_newdoc(place, obj, doc, warn_on_python=True):
    ...
    obj : str
        ...
        function name
    doc : {str, Tuple[str, str], List[Tuple[str, str]]***REMOVED***
    ...
    """
    new = getattr(__import__(place, globals(), {***REMOVED***, [obj]), obj)
