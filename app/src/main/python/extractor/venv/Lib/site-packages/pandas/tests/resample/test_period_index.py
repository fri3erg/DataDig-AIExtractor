...
class TestPeriodIndex:
    ...
    @pytest.mark.parametrize("kwargs", [{"on": "date"***REMOVED***, {"level": "d"***REMOVED***])
    ...
    def test_annual_upsample_cases(
        ...
        ts = simple_period_range_series("1/1/1990", "12/31/1991", freq=f"Y-{month***REMOVED***")
    ...
    def test_not_subperiod(self, simple_period_range_series, rule, expected_error_msg):
        ...
        msg = (
            ...
            f"{expected_error_msg***REMOVED***, as they are not sub or super periods"
        )
    ...
    def test_resample_to_quarterly(self, simple_period_range_series, month):
        ts = simple_period_range_series("1990", "1992", freq=f"Y-{month***REMOVED***")
        quar_ts = ts.resample(f"Q-{month***REMOVED***").ffill()
    ...
    def test_resample_tz_localized3(self):
        ...
        result = (
            ts.resample("YE")
            .agg({"first": "sum", "second": "mean"***REMOVED***)
...
***REMOVED***
    ...
    def test_resample_lowercase_frequency_deprecated(
        ...
        depr_msg = f"'{freq_depr[1:]***REMOVED***' is deprecated and will be removed in a "
        f"future version. Please use '{freq[1:]***REMOVED***' instead."
        depr_msg_res = f"'{freq_depr_res[1:]***REMOVED***' is deprecated and will be removed in a "
        f"future version. Please use '{freq_res[1:]***REMOVED***' instead."
    ...
    def test_asfreq_invalid_period_freq(self, offset, series_and_frame):
        # GH#9586
        msg = f"Invalid offset: '{offset.base***REMOVED***' for converting time series "
...
def test_resample_frequency_ME_QE_YE_error_message(series_and_frame, freq, freq_depr):
    # GH#9586
    msg = f"for Period, please use '{freq[1:]***REMOVED***' instead of '{freq_depr[1:]***REMOVED***'"
...
def test_resample_frequency_invalid_freq(series_and_frame, freq_depr):
    # GH#9586
    msg = f"Invalid frequency: {freq_depr[1:]***REMOVED***"
