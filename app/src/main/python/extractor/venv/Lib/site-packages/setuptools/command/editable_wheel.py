...
class _EditableMode(Enum):
    ...
    def convert(cls, mode: Optional[str]) -> "_EditableMode":
        ...
        if _mode not in _EditableMode.__members__:
            raise errors.OptionError(f"Invalid editable mode: {mode!r***REMOVED***. Try: 'strict'.")
...
class editable_wheel(Command):
    ...
    def finalize_options(self):
        ...
        self.package_dir = dist.package_dir or {***REMOVED***
    ...
    def _configure_build(
        ...
        data = str(Path(unpacked_wheel, f"{name***REMOVED***.data", "data"))
        headers = str(Path(unpacked_wheel, f"{name***REMOVED***.data", "headers"))
        scripts = str(Path(unpacked_wheel, f"{name***REMOVED***.data", "scripts"))
    ...
    def _collect_build_outputs(self) -> Tuple[List[str], Dict[str, str]]:
        ...
        for cmd_name in build.get_sub_commands():
            ...
            if hasattr(cmd, "get_output_mapping"):
                mapping.update(cmd.get_output_mapping() or {***REMOVED***)
    ...
    def _safely_run(self, cmd_name: str):
        try:
            ...
            msg = f"""{traceback.format_exc()***REMOVED***\n
            If you are seeing this warning it is very likely that a setuptools
            plugin or customization overrides the `{cmd_name***REMOVED***` command, without
            taking into consideration how editable installs run build steps
            starting from v64.0.0.

            Plugin authors and developers relying on custom build steps are encouraged
            to update their `{cmd_name***REMOVED***` implementation considering the information in
    ...
    def _create_wheel_file(self, bdist_wheel):
        ...
        archive_name = f"{dist_name***REMOVED***-{build_tag***REMOVED***-{tag***REMOVED***.whl"
    ...
    def _run_install(self, category: str):
        has_category = getattr(self.distribution, f"has_{category***REMOVED***", None)
        if has_category and has_category():
            _logger.info(f"Installing {category***REMOVED*** as non editable")
            self.run_command(f"install_{category***REMOVED***")
    ...
    def _select_strategy(
        ...
        build_name = f"__editable__.{name***REMOVED***-{tag***REMOVED***"
        ...
        if set(self.package_dir) == {""***REMOVED*** and has_simple_layout or is_compat_mode:
...
class _StaticPth:
    ...
    def __call__(self, wheel: "WheelFile", files: List[str], mapping: Dict[str, str]):
        ...
        contents = bytes(f"{entries***REMOVED***\n", "utf-8")
        wheel.writestr(f"__editable__.{self.name***REMOVED***.pth", contents)

    def __enter__(self):
        msg = f"""
        Editable install will be performed using .pth file to extend `sys.path` with:
        {list(map(os.fspath, self.path_entries))!r***REMOVED***
        """
...
class _TopLevelFinder:
    ...
    def __call__(self, wheel: "WheelFile", files: List[str], mapping: Dict[str, str]):
        ...
        package_dir = self.dist.package_dir or {***REMOVED***
        ...
        name = f"__editable__.{self.name***REMOVED***.finder"
        finder = _make_identifier(name)
        content = bytes(_finder_template(name, roots, namespaces_), "utf-8")
        wheel.writestr(f"{finder***REMOVED***.py", content)

        content = bytes(f"import {finder***REMOVED***; {finder***REMOVED***.install()", "utf-8")
        wheel.writestr(f"__editable__.{self.name***REMOVED***.pth", content)
...
def _simple_layout(
    ...
    >>> _simple_layout(['a'], {"": "src"***REMOVED***, "/tmp/myproj")
    True
    >>> _simple_layout(['a', 'a.b'], {"": "src"***REMOVED***, "/tmp/myproj")
    True
    >>> _simple_layout(['a', 'a.b'], {***REMOVED***, "/tmp/myproj")
    True
    >>> _simple_layout(['a', 'a.a1', 'a.a1.a2', 'b'], {"": "src"***REMOVED***, "/tmp/myproj")
    True
    >>> _simple_layout(['a', 'a.a1', 'a.a1.a2', 'b'], {"a": "a", "b": "b"***REMOVED***, ".")
    True
    >>> _simple_layout(['a', 'a.a1', 'a.a1.a2', 'b'], {"a": "_a", "b": "_b"***REMOVED***, ".")
    False
    >>> _simple_layout(['a', 'a.a1', 'a.a1.a2', 'b'], {"a": "_a"***REMOVED***, "/tmp/myproj")
    False
    >>> _simple_layout(['a', 'a.a1', 'a.a1.a2', 'b'], {"a.a1.a2": "_a2"***REMOVED***, ".")
    False
    >>> _simple_layout(['a', 'a.b'], {"": "src", "a.b": "_ab"***REMOVED***, "/tmp/myproj")
    False
    >>> # Special cases, no packages yet:
    >>> _simple_layout([], {"": "src"***REMOVED***, "/tmp/myproj")
    True
    >>> _simple_layout([], {"a": "_a", "": "src"***REMOVED***, "/tmp/myproj")
    False
    """
    layout = {
    ...
    ***REMOVED***
    if not layout:
        return set(package_dir) in ({***REMOVED***, {""***REMOVED***)
...
MAPPING = {mapping!r***REMOVED***
NAMESPACES = {namespaces!r***REMOVED***
PATH_PLACEHOLDER = {name!r***REMOVED*** + ".__path_hook__"
...
class _EditableFinder:  # MetaPathFinder
    ...
    def find_spec(cls, fullname, path=None, target=None):
        for pkg, pkg_path in reversed(list(MAPPING.items())):
            if fullname == pkg or fullname.startswith(f"{{pkg***REMOVED******REMOVED***."):
