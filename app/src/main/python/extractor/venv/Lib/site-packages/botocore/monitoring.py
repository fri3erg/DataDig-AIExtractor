...
class BaseMonitorEvent:
    ...
    def __repr__(self):
        return f'{self.__class__.__name__***REMOVED***({self.__dict__!r***REMOVED***)'
    ...
    ***REMOVED***
    ...
    def _validate_client_id(self, csm_client_id):
        if len(csm_client_id) > self._MAX_CLIENT_ID_LENGTH:
            raise ValueError(
                f'The value provided for csm_client_id: {csm_client_id***REMOVED*** exceeds '
                f'the maximum length of {self._MAX_CLIENT_ID_LENGTH***REMOVED*** characters'
***REMOVED***
