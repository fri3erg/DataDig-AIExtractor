...
def _load_generations_from_json(generations_json: str) -> RETURN_VAL_TYPE:
    ...
    try:
        ...
        raise ValueError(
            f"Could not decode json to list of generations: {generations_json***REMOVED***"
        )
...
def _loads_generations(generations_str: str) -> Union[RETURN_VAL_TYPE, None]:
    ...
    try:
        ...
        logger.warning(
            f"Legacy 'Generation' cached blob encountered: '{generations_str***REMOVED***'"
        )
        return generations
    except (json.JSONDecodeError, TypeError):
        logger.warning(
            f"Malformed/unparsable cached blob encountered: '{generations_str***REMOVED***'"
        )
        return None
...
class InMemoryCache(BaseCache):
    ...
    def __init__(self) -> None:
        ...
        self._cache: Dict[Tuple[str, str], RETURN_VAL_TYPE] = {***REMOVED***
...
class SQLiteCache(SQLAlchemyCache):
    ...
    def __init__(self, database_path: str = ".langchain.db"):
        ...
        engine = create_engine(f"sqlite:///{database_path***REMOVED***")
...
class RedisSemanticCache(BaseCache):
    ...
    DEFAULT_SCHEMA = {
        ...
        "extra": [{"name": "return_val"***REMOVED***, {"name": "llm_string"***REMOVED***],
    ***REMOVED***
...
***REMOVED***)
        ...
        """
        self._cache_dict: Dict[str, RedisVectorstore] = {***REMOVED***
    ...
    def _index_name(self, llm_string: str) -> str:
        ...
        return f"cache:{hashed_index***REMOVED***"
        ...
        for gen in return_val:
            if not isinstance(gen, Generation):
                raise ValueError(
                    ...
                    f"normal LLM generations, got {type(gen)***REMOVED***"
    ***REMOVED***
        llm_cache = self._get_llm_cache(llm_string)
            ...
            def init_gptcache(cache_obj: gptcache.Cache, llm str):
                cache_obj.init(
                    ...
                    data_manager=manager_factory(
                        manager="map",
                        data_dir=f"map_cache_{llm***REMOVED***"
        ***REMOVED***,
    ***REMOVED***
...
***REMOVED***
        ...
        self.gptcache_dict: Dict[str, Any] = {***REMOVED***
...
def _ensure_cache_exists(cache_client: momento.CacheClient, cache_name: str) -> None:
    ...
    if isinstance(create_cache_response, CreateCache.Success) or isinstance(
        ...
        raise Exception(f"Unexpected response cache creation: {create_cache_response***REMOVED***")


def _validate_ttl(ttl: Optional[timedelta]) -> None:
    if ttl is not None and ttl <= timedelta(seconds=0):
        raise ValueError(f"ttl must be positive but was {ttl***REMOVED***.")
...
***REMOVED***
    ...
    ***REMOVED***
        ...
        if isinstance(set_response, CacheSet.Success):
            ...
            raise Exception(f"Unexpected response: {set_response***REMOVED***")
...
***REMOVED***
    ...
    def delete_through_llm(
        ...
        llm_string = get_prompts(
            {**llm.dict(), **{"stop": stop***REMOVED******REMOVED***,
            [],
        )[1]
...
***REMOVED***
        ...
        self.table = MetadataVectorCassandraTable(
            ...
            ttl_seconds=self.ttl_seconds,
            metadata_indexing=("allow", {"_llm_string_hash"***REMOVED***),
            skip_provisioning=skip_provisioning,
        )
    ...
    def update(self, prompt: str, llm_string: str, return_val: RETURN_VAL_TYPE) -> None:
        ...
        ***REMOVED***
        row_id = f"{_hash(prompt)***REMOVED***-{llm_string_hash***REMOVED***"
        #
        self.table.put(
            body_blob=body,
    ...
    def lookup_with_id(
        ...
        hits = list(
            self.table.metric_ann_search(
                ...
                metadata={"_llm_string_hash": _hash(llm_string)***REMOVED***,
                n=1,
...
***REMOVED***
    ...
    def _make_id(prompt: str, llm_string: str) -> str:
        return f"{_hash(prompt)***REMOVED***#{_hash(llm_string)***REMOVED***"
