...
***REMOVED***
        ...
        nodes = {***REMOVED***
        ids = {a: n for n, a in enumerate(positions)***REMOVED***
        highlighted_nodes = {
            n for a, n in ids.items() if not highlight or tree[a] in highlight
        ***REMOVED***
        levels = {n: [] for n in range(maxdepth - 1)***REMOVED***
        terminals = []
        for a in positions:
            node = tree[a]
...
***REMOVED***
    ...
    def text(
        ...
        labels = {***REMOVED***
        wrapre = re.compile(
            "(.{%d,%d***REMOVED***\\b\\W*|.{%d***REMOVED***)" % (maxwidth - 4, maxwidth, maxwidth)
        )
            ...
            ***REMOVED***
                ...
                if html:
                    ...
                    if n in self.highlight:
                        text = [f"<font color={color***REMOVED***>{a***REMOVED***</font>" for a in text]
...
def test():
    ...
    def print_tree(n, tree, sentence=None, ansi=True, **xargs):
        print()
        print('{***REMOVED***: "{***REMOVED***"'.format(n, " ".join(sentence or tree.leaves())))
        print(tree)
        print()
