...
class Reference(Strict):
    ...
    def __str__(self):
        fmt = u"{0***REMOVED***!${1***REMOVED***${2***REMOVED***:${3***REMOVED***${4***REMOVED***"
        if (self.min_col == self.max_col
            and self.min_row == self.max_row):
            fmt = u"{0***REMOVED***!${1***REMOVED***${2***REMOVED***"
    ...
    def pop(self):
        ...
        """
        cell = "{0***REMOVED***{1***REMOVED***".format(get_column_letter(self.min_col), self.min_row)
        if self.min_row == self.max_row:
            self.min_col += 1
        else:
            self.min_row += 1
