    ...
    def retrieve(
        ...
        *,
        ...
        if not fine_tuning_job_id:
            raise ValueError(f"Expected a non-empty value for `fine_tuning_job_id` but received {fine_tuning_job_id!r***REMOVED***")
        return self._get(
            f"/fine_tuning/jobs/{fine_tuning_job_id***REMOVED***",
            options=make_request_options(
                extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout
***REMOVED***,
            cast_to=FineTuningJob,
    ...
    def cancel(
        ...
        *,
        ...
        if not fine_tuning_job_id:
            raise ValueError(f"Expected a non-empty value for `fine_tuning_job_id` but received {fine_tuning_job_id!r***REMOVED***")
        return self._post(
            f"/fine_tuning/jobs/{fine_tuning_job_id***REMOVED***/cancel",
            options=make_request_options(
                extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout
***REMOVED***,
            cast_to=FineTuningJob,
    ...
    def list_events(
        ...
        *,
        ...
        if not fine_tuning_job_id:
            raise ValueError(f"Expected a non-empty value for `fine_tuning_job_id` but received {fine_tuning_job_id!r***REMOVED***")
        return self._get_api_list(
            f"/fine_tuning/jobs/{fine_tuning_job_id***REMOVED***/events",
