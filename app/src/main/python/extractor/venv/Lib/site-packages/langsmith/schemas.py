...
class Example(ExampleBase):
    ...
    def url(self) -> Optional[str]:
        ...
        if self._host_url:
            path = f"/datasets/{self.dataset_id***REMOVED***/e/{self.id***REMOVED***"
            if self._tenant_id:
                return f"{self._host_url***REMOVED***/o/{str(self._tenant_id)***REMOVED***{path***REMOVED***"
            return f"{self._host_url***REMOVED***{path***REMOVED***"
        return None
    ...
    def url(self) -> Optional[str]:
        ...
        if self._host_url:
            if self._public_path:
                return f"{self._host_url***REMOVED***{self._public_path***REMOVED***"
            if self._tenant_id:
                return f"{self._host_url***REMOVED***/o/{str(self._tenant_id)***REMOVED***/datasets/{self.id***REMOVED***"
            return f"{self._host_url***REMOVED***/datasets/{self.id***REMOVED***"
        return None
...
class Run(RunBase):
    ...
    This is a string composed of {time***REMOVED***{run-uuid***REMOVED***.* so that a trace can be
    ...
    def url(self) -> Optional[str]:
        ...
        if self._host_url and self.app_path:
            return f"{self._host_url***REMOVED***{self.app_path***REMOVED***"
        return None
...
class TracerSession(BaseModel):
    ...
    def url(self) -> Optional[str]:
        """URL of this run within the app."""
        if self._host_url:
            return f"{self._host_url***REMOVED***/o/{self.tenant_id***REMOVED***/projects/p/{self.id***REMOVED***"
        return None
