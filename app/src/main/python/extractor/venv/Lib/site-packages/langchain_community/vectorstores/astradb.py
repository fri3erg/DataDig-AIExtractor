        ...
        if filter_dict is None:
            ...
            for k, v in filter_dict.items():
                if k and k[0] == "$":
                    ...
                    metadata_filter[f"metadata.{k***REMOVED***"] = v
...
***REMOVED***
    ...
    def delete_by_document_id(self, document_id: str) -> bool:
        ...
        return ((deletion_response or {***REMOVED***).get("status") or {***REMOVED***).get(
            "deletedCount", 0
        ) == 1
        ...
        **kwargs: Any,
        ...
        if kwargs:
            warnings.warn(
                ...
                f"unsupported arguments ({', '.join(sorted(kwargs.keys()))***REMOVED***), "
...
***REMOVED***
        ...
        if metadatas is None:
            metadatas = [{***REMOVED*** for _ in _texts]
        #
...
***REMOVED***
        ...
        def _handle_batch(document_batch: List[DocDict]) -> List[str]:
            im_result = self.collection.insert_many(
                ...
                options={"ordered": False***REMOVED***,
                partial_failures_allowed=True,
***REMOVED***
            if "status" not in im_result:
                raise ValueError(
                    f"API Exception while running bulk insertion: {str(im_result)***REMOVED***"
    ***REMOVED***
...
***REMOVED***
            if num_errors != len(missed_inserted_ids) or unexpected_errors:
                raise ValueError(
                    f"API Exception while running bulk insertion: {str(errors)***REMOVED***"
    ***REMOVED***
            ...
            def _handle_missing_document(missing_document: DocDict) -> str:
                replacement_result = self.collection.find_one_and_replace(
                    filter={"_id": missing_document["_id"]***REMOVED***,
    ...
    def similarity_search_with_score_id_by_vector(
        ...
        hits = list(
            self.collection.paginated_find(
                ...
                sort={"$vector": embedding***REMOVED***,
                options={"limit": k, "includeSimilarity": True***REMOVED***,
                projection={
                    "_id": 1,
                    "content": 1,
                    "metadata": 1,
        ...
        **kwargs: Any,
        ...
        prefetch_hits = list(
            self.collection.paginated_find(
                filter=metadata_parameter,
                sort={"$vector": embedding***REMOVED***,
                options={"limit": fetch_k, "includeSimilarity": True***REMOVED***,
                projection={
                    "_id": 1,
                    "content": 1,
                    "metadata": 1,
        ...
        if kwargs:
            ...
            if unknown_kwargs:
                warnings.warn(
                    ...
                    f"unsupported arguments ({', '.join(sorted(unknown_kwargs))***REMOVED***), "
                    "which will be ignored."
    ***REMOVED***
