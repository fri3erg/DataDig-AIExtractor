    ...
    def __init__(self, **kwargs: Any):
        ...
        try:
            ...
            raise ImportError(
                ...
                f"Please run `pip install mlflow{self._mlflow_extras***REMOVED***` to install "
...
***REMOVED*** from e
    ...
    def _validate_uri(self) -> None:
        ...
        if urlparse(self.target_uri).scheme not in allowed:
            raise ValueError(
                f"Invalid target URI: {self.target_uri***REMOVED***. "
                f"The scheme must be one of {allowed***REMOVED***."
***REMOVED***
...
***REMOVED***
            ...
            raise ValueError(f"Got unknown message type: {message***REMOVED***")
...
***REMOVED***
    ...
    def _create_chat_result(response: Mapping[str, Any]) -> ChatResult:
        ...
        for choice in response["choices"]:
            ...
            usage = choice.get("usage", {***REMOVED***)
            gen = ChatGeneration(
                message=message,
...
***REMOVED***
        ...
        usage = response.get("usage", {***REMOVED***)
