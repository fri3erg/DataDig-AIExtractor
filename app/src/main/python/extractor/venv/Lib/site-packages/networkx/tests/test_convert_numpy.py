...
class TestConvertNumpyArray:
    ...
    def test_nodelist(self):
        ...
        with pytest.raises(
            nx.NetworkXError,
            match=f"Nodes {nodelist - P3.nodes***REMOVED*** in nodelist is not in G",
        ):
            nx.to_numpy_array(P3, nodelist=nodelist)

    def test_weight_keyword(self):
        WP4 = nx.Graph()
        WP4.add_edges_from((n, n + 1, {"weight": 0.5, "other": 0.3***REMOVED***) for n in range(3))
        P4 = path_graph(4)
    ...
    def test_from_numpy_array_type(self):
        ...
        with pytest.raises(
            nx.NetworkXError, match=f"Input array must be 2D, not {A.ndim***REMOVED***"
        ):
            g = nx.from_numpy_array(A)
    ...
    @pytest.mark.parametrize(
        ...
        (
            ...
            np.dtype(
                [("weight", "f8"), ("color", "i1")]
***REMOVED***,  # Structured dtype with named fields
        ),
    )
...
@pytest.mark.parametrize(
    ...
    [
        ...
        (0, 1, {"weight": 10***REMOVED***),  # One edge attr
        (0, 1, {"weight": 5, "flow": -4***REMOVED***),  # Multiple but not all edge attrs
        (0, 1, {"weight": 2.0, "cost": 10, "flow": -45***REMOVED***),  # All attrs
    ],
)
