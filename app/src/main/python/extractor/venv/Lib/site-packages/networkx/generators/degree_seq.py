...
def directed_configuration_model(
    ...
    name = "directed configuration_model {***REMOVED*** nodes {***REMOVED*** edges"
    return G
...
def expected_degree_graph(w, seed=None, selfloops=True):
    ...
    Given a sequence of expected degrees $W=(w_0,w_1,\ldots,w_{n-1***REMOVED***)$
    of length $n$ this algorithm assigns an edge between node $u$ and
    node $v$ with probability

    .. math::

       p_{uv***REMOVED*** = \frac{w_u w_v***REMOVED***{\sum_k w_k***REMOVED*** .
    ...
    The complexity of this algorithm is $\mathcal{O***REMOVED***(n+m)$ where $n$ is the
    ...
    .. math::
       ...
       E[deg(u)] = \sum_{v \ne u***REMOVED*** p_{uv***REMOVED***
                = w_u \left( 1 - \frac{w_u***REMOVED***{\sum_k w_k***REMOVED*** \right) .
    ...
    .. math::
       ...
       E[deg(u)] =  \sum_{v \ne u***REMOVED*** p_{uv***REMOVED***  + 2 p_{uu***REMOVED***
                = w_u \left( 1 + \frac{w_u***REMOVED***{\sum_k w_k***REMOVED*** \right) .
    ...
    mapping = {c: u for c, (u, v) in enumerate(order)***REMOVED***
...
def random_degree_sequence_graph(sequence, seed=None, tries=10):
    ...
    If the maximum degree $d_m$ in the sequence is $O(m^{1/4***REMOVED***)$ then the
    ...
    for try_n in range(tries):
        try:
            ...
            pass
    raise nx.NetworkXError(f"failed to generate graph in {tries***REMOVED*** tries")
