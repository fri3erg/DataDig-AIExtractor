...
***REMOVED***
    ...
    def _image_analysis(self, image_path: str) -> Dict:
        ...
        if image_src_type == "local":
            ...
            raise ValueError(f"Invalid image path: {image_path***REMOVED***")
        ...
        if result.reason == sdk.ImageAnalysisResultReason.ANALYZED:
            ...
            raise RuntimeError(
                ...
                f"Reason: {error_details.reason***REMOVED***\n"
                f"Details: {error_details.message***REMOVED***"
***REMOVED***
...
***REMOVED***
    ...
    def _run(
        ...
        try:
            ...
            raise RuntimeError(f"Error while running AzureCogsImageAnalysisTool: {e***REMOVED***")
