...
for _prefix in _need_suffix:
    for _m in MONTHS:
        key = f"{_prefix***REMOVED***-{_m***REMOVED***"
        OFFSET_TO_PERIOD_FREQSTR[key] = OFFSET_TO_PERIOD_FREQSTR[_prefix]

for _prefix in ["Y", "Q"]:
    for _m in MONTHS:
        _alias = f"{_prefix***REMOVED***-{_m***REMOVED***"
        OFFSET_TO_PERIOD_FREQSTR[_alias] = _alias

for _d in DAYS:
    OFFSET_TO_PERIOD_FREQSTR[f"W-{_d***REMOVED***"] = f"W-{_d***REMOVED***"
    ...
    if isinstance(index, ABCSeries):
        ...
        if not (
            ...
            raise TypeError(
                ...
                f"on a Series of {index.dtype***REMOVED***"
***REMOVED***
        index = values
    ...
    if not hasattr(index, "dtype"):
        ...
        raise TypeError(
            f"cannot infer freq from a non-convertible index of dtype {index.dtype***REMOVED***"
        )
    ...
    ***REMOVED***
    ...
    def _infer_daily_rule(self) -> str | None:
        ...
        if annual_rule:
            ...
            alias = f"{annual_rule***REMOVED***-{month***REMOVED***"
            return _maybe_add_count(alias, nyears)

        quarterly_rule = self._get_quarterly_rule()
        if quarterly_rule:
            nquarters = self.mdiffs[0] / 3
            mod_dict = {0: 12, 2: 11, 1: 10***REMOVED***
            month = MONTH_ALIASES[mod_dict[self.rep_stamp.month % 3]]
            alias = f"{quarterly_rule***REMOVED***-{month***REMOVED***"
    ...
    def _get_annual_rule(self) -> str | None:
        ...
        if pos_check is None:
            ...
            return {"cs": "YS", "bs": "BYS", "ce": "YE", "be": "BYE"***REMOVED***.get(pos_check)
    ...
    def _get_quarterly_rule(self) -> str | None:
        ...
        if pos_check is None:
            ...
            return {"cs": "QS", "bs": "BQS", "ce": "QE", "be": "BQE"***REMOVED***.get(pos_check)
    ...
    def _get_monthly_rule(self) -> str | None:
        ...
        if pos_check is None:
            ...
            return {"cs": "MS", "bs": "BMS", "ce": "ME", "be": "BME"***REMOVED***.get(pos_check)
...
***REMOVED***
    ...
    def _get_wom_rule(self) -> str | None:
        ...
        return f"WOM-{week***REMOVED***{wd***REMOVED***"
...
def _maybe_add_count(base: str, count: float) -> str:
    if count != 1:
        ...
        count = int(count)
        return f"{count***REMOVED***{base***REMOVED***"
    else:
        return base
...
***REMOVED***
        return source in {"D", "C", "B", "M", "h", "min", "s", "ms", "us", "ns"***REMOVED***
    elif _is_quarterly(target):
        return source in {"D", "C", "B", "M", "h", "min", "s", "ms", "us", "ns"***REMOVED***
    elif _is_monthly(target):
        return source in {"D", "C", "B", "h", "min", "s", "ms", "us", "ns"***REMOVED***
    elif _is_weekly(target):
        return source in {target, "D", "C", "B", "h", "min", "s", "ms", "us", "ns"***REMOVED***
    elif target == "B":
        return source in {"B", "h", "min", "s", "ms", "us", "ns"***REMOVED***
    elif target == "C":
        return source in {"C", "h", "min", "s", "ms", "us", "ns"***REMOVED***
    elif target == "D":
        return source in {"D", "h", "min", "s", "ms", "us", "ns"***REMOVED***
    elif target == "h":
        return source in {"h", "min", "s", "ms", "us", "ns"***REMOVED***
    elif target == "min":
        return source in {"min", "s", "ms", "us", "ns"***REMOVED***
    elif target == "s":
        return source in {"s", "ms", "us", "ns"***REMOVED***
    elif target == "ms":
        return source in {"ms", "us", "ns"***REMOVED***
    elif target == "us":
        return source in {"us", "ns"***REMOVED***
    elif target == "ns":
        return source in {"ns"***REMOVED***
    else:
        return False
...
def is_superperiod(source, target) -> bool:
    ...
    if _is_annual(source):
        ...
        return target in {"D", "C", "B", "M", "h", "min", "s", "ms", "us", "ns"***REMOVED***
    elif _is_quarterly(source):
        return target in {"D", "C", "B", "M", "h", "min", "s", "ms", "us", "ns"***REMOVED***
    elif _is_monthly(source):
        return target in {"D", "C", "B", "h", "min", "s", "ms", "us", "ns"***REMOVED***
    elif _is_weekly(source):
        return target in {source, "D", "C", "B", "h", "min", "s", "ms", "us", "ns"***REMOVED***
    elif source == "B":
        return target in {"D", "C", "B", "h", "min", "s", "ms", "us", "ns"***REMOVED***
    elif source == "C":
        return target in {"D", "C", "B", "h", "min", "s", "ms", "us", "ns"***REMOVED***
        ...
        return target in {"h", "min", "s", "ms", "us", "ns"***REMOVED***
    elif source == "min":
        return target in {"min", "s", "ms", "us", "ns"***REMOVED***
    elif source == "s":
        return target in {"s", "ms", "us", "ns"***REMOVED***
    elif source == "ms":
        return target in {"ms", "us", "ns"***REMOVED***
    elif source == "us":
        return target in {"us", "ns"***REMOVED***
    elif source == "ns":
        return target in {"ns"***REMOVED***
    else:
        return False
...
def _maybe_coerce_freq(code) -> str:
    ...
    if code in {"h", "min", "s", "ms", "us", "ns"***REMOVED***:
        return code
    else:
        return code.upper()
