...
class UnixSite(BaseSite):
    ...
    def name(self) -> str:
        scheme = "https" if self._ssl_context else "http"
        return f"{scheme***REMOVED***://unix:{self._path***REMOVED***:"
    ...
    def __init__(
        ...
        *,
        ...
        if hasattr(socket, "AF_UNIX") and sock.family == socket.AF_UNIX:
            name = f"{scheme***REMOVED***://unix:{sock.getsockname()***REMOVED***:"
        else:
...
class BaseRunner(ABC):
    ...
    def _reg_site(self, site: BaseSite) -> None:
        if site in self._sites:
            raise RuntimeError(f"Site {site***REMOVED*** is already registered in runner {self***REMOVED***")
        self._sites.append(site)

    def _check_site(self, site: BaseSite) -> None:
        if site not in self._sites:
            raise RuntimeError(f"Site {site***REMOVED*** is not registered in runner {self***REMOVED***")
    ...
    def __init__(
        ...
        if not isinstance(app, Application):
            raise TypeError(
                ...
                "instance, got {!r***REMOVED***".format(app)
***REMOVED***
        self._app = app
