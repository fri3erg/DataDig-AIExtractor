...
class ScoreStringEvalChain(StringEvaluator, LLMEvalChain, LLMChain):
    ...
    def evaluation_name(self) -> str:
        ...
        """
        return f"score_string:{self.criterion_name***REMOVED***"
...
***REMOVED***
        ...
        expected_input_vars = {"prediction", "input", "criteria"***REMOVED***
...
***REMOVED***
        ...
        criteria_str = "\n".join(
            f"{k***REMOVED***: {v***REMOVED***" if v else k for k, v in criteria_.items()
        ).strip()
        criteria_str = (
            CRITERIA_INSTRUCTIONS + f"{criteria_str***REMOVED***\n"
            if criteria_str
...
***REMOVED***
        criteria_ = resolve_criteria(criteria)
        criteria_str = "\n".join(f"{k***REMOVED***: {v***REMOVED***" for k, v in criteria_.items()).strip()
        criteria_str = (
            CRITERIA_INSTRUCTIONS + f"{criteria_str***REMOVED***\n"
            if criteria_str
            else DEFAULT_CRITERIA
