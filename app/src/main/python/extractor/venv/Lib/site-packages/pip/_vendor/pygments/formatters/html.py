...
class HtmlFormatter(Formatter):
    ...
    .. sourcecode:: css
        ...
        td .code .kw { font-weight: bold; color: #00FF00 ***REMOVED***
        td .code .cm { color: #999999 ***REMOVED***
        ...
    ...
    .. sourcecode:: css
        ...
        div.syntax pre .kw,
        pre.syntax .kw { font-weight: bold; color: #00FF00 ***REMOVED***
        div.syntax pre .cm,
        pre.syntax .cm { color: #999999 ***REMOVED***
        ...
    ...
    **Subclassing the HTML formatter**
    ...
    def __init__(self, **options):
        ...
        self.span_element_openers = {***REMOVED***
    ...
    def _create_stylesheet(self):
        t2c = self.ttype2class = {Token: ''***REMOVED***
        c2s = self.class2style = {***REMOVED***
    ...
    def get_token_style_defs(self, arg=None):
        ...
        lines = [
            '%s { %s ***REMOVED*** /* %s */' % (prefix(cls), style, repr(ttype)[6:])
    ...
    def get_background_style_defs(self, arg=None):
        ...
        if arg and not self.nobackground and bg_color is not None:
            ...
            lines.insert(
                0, '%s{ background: %s;%s ***REMOVED***' % (
                    prefix(''), bg_color, text_style
    ***REMOVED***
***REMOVED***
        if hl_color is not None:
            lines.insert(
                0, '%s { background-color: %s ***REMOVED***' % (prefix('hll'), hl_color)
***REMOVED***
    ...
    def get_linenos_style_defs(self):
        lines = [
            'pre { %s ***REMOVED***' % self._pre_style,
            'td.linenos .normal { %s ***REMOVED***' % self._linenos_style,
            'span.linenos { %s ***REMOVED***' % self._linenos_style,
            'td.linenos .special { %s ***REMOVED***' % self._linenos_special_style,
            'span.linenos.special { %s ***REMOVED***' % self._linenos_special_style,
        ]
                ...
                if not os.path.exists(cssfilename) or not self.noclobber_cssfile:
                    with open(cssfilename, "w", encoding="utf-8") as cf:
                        cf.write(CSSFILE_TEMPLATE %
                                 {'styledefs': self.get_style_defs('body')***REMOVED***)
    ...
    def _wrap_tablelinenos(self, inner):
        ...
        yield 0, (f'<table class="{self.cssclass***REMOVED***table">' + filename_tr +
