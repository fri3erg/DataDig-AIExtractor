...
class TreeEdge(EdgeI):
    ...
    def __str__(self):
        str = f"[{self._span[0]***REMOVED***:{self._span[1]***REMOVED***] "
        str += "%-2r ->" % (self._lhs,)
...
class LeafEdge(EdgeI):
    ...
    def __str__(self):
        return f"[{self._index***REMOVED***:{self._index + 1***REMOVED***] {repr(self._leaf)***REMOVED***"
...
class Chart:
    ...
    def _add_index(self, restr_keys):
        ...
        # Create the index.
        index = self._indexes[restr_keys] = {***REMOVED***
    ...
    def trees(self, edge, tree_class=Tree, complete=False):
        ...
        """
        return iter(self._trees(edge, complete, memo={***REMOVED***, tree_class=tree_class))
    ...
    def child_pointer_lists(self, edge):
        ...
        return self._edge_to_cpls.get(edge, {***REMOVED***).keys()
