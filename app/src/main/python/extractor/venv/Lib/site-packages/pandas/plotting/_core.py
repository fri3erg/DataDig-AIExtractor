...
def hist_frame(
    ...
    **kwargs
    ...
    .. plot::
        ...
        ...         'width': [0.7, 0.2, 0.15, 0.2, 1.1]***REMOVED***
...
return_type : {'axes', 'dict', 'both'***REMOVED*** or None, default 'axes'
...
_bar_or_line_doc = """
        ...
        color : str, array-like, or dict, optional
            ...
            - A dict of the form {column name : color***REMOVED***, so that each column will be
                colored accordingly. For example, if your columns are called `a` and
                `b`, then passing {'a': 'green', 'b': 'red'***REMOVED*** will color %(kind)ss for
...
class PlotAccessor(PandasObject):
    ...
    grid : bool, default None (matlab style default)
        Axis grid lines.
    legend : bool or {'reverse'***REMOVED***
    ...
    **kwargs
    ...
    _kind_aliases = {"density": "kde"***REMOVED***
    ...
    def _get_call_args(backend_name: str, data: Series | DataFrame, args, kwargs):
        ...
        if isinstance(data, ABCSeries):
            ...
            raise TypeError(
                f"Called plot accessor for type {type(data).__name__***REMOVED***, "
...
***REMOVED***
        ...
        if args and isinstance(data, ABCSeries):
            ...
            keyword_args = ", ".join(
                [f"{name***REMOVED***={repr(value)***REMOVED***" for (name, _), value in zip(arg_def, args)]
***REMOVED***
            msg = (
                "`Series.plot()` should not be called with positional "
                "arguments, only keyword arguments. The order of "
                "positional arguments will change in the future. "
                f"Use `Series.plot({keyword_args***REMOVED***)` instead of "
                f"`Series.plot({positional_args***REMOVED***)`."
***REMOVED***
            raise TypeError(msg)

        pos_args = {name: value for (name, _), value in zip(arg_def, args)***REMOVED***
    ...
    def __call__(self, *args, **kwargs):
        ...
        if kind not in self._all_kinds:
            raise ValueError(
                f"{kind***REMOVED*** is not a valid plot kind "
                f"Valid plot kinds: {self._all_kinds***REMOVED***"
***REMOVED***
        ...
        if kind in self._dataframe_kinds:
            if isinstance(data, ABCDataFrame):
                ...
                raise ValueError(f"plot kind {kind***REMOVED*** can only be used for data frames")
        elif kind in self._series_kinds:
            if isinstance(data, ABCDataFrame):
                if y is None and kwargs.get("subplots") is False:
                    raise ValueError(
                        f"{kind***REMOVED*** requires either y column or 'subplots=True'"
        ***REMOVED***
                if y is not None:
    ...
    @Appender(
        ...
        .. plot::
            ...
            ...    ***REMOVED***, index=[1990, 1997, 2003, 2009, 2014])
            >>> lines = df.plot.line()
        ...
        .. plot::
           ...
           >>> axes = df.plot.line(
           ...     subplots=True, color={"pig": "pink", "horse": "#742802"***REMOVED***
           ... )
    ...
    @Appender(
        ...
        .. plot::
            ...
            >>> df = pd.DataFrame({'lab':['A', 'B', 'C'], 'val':[10, 30, 20]***REMOVED***)
        ...
        .. plot::
            ...
            ...                    'lifespan': lifespan***REMOVED***, index=index)
        ...
        .. plot::
            ...
            >>> axes = df.plot.bar(
            ...     rot=0, subplots=True, color={"speed": "red", "lifespan": "green"***REMOVED***
            ... )
            >>> axes[1].legend(loc=2)  # doctest: +SKIP
    ...
    @Appender(
        ...
        .. plot::
            ...
            >>> ax = df.plot.barh(color={"speed": "red", "lifespan": "green"***REMOVED***)
    ...
    def box(self, by: IndexLabel | None = None, **kwargs) -> PlotAccessor:
        ...
        **kwargs
        ...
        .. plot::
            ...
            >>> df = pd.DataFrame({"gender": list("MMMMMMMMFFFFFF"), "age": age_list***REMOVED***)
    ...
    def area(
        ...
        **kwargs
        ...
        .. plot::
            ...
            ... ***REMOVED***, index=pd.date_range(start='2018/01/01', end='2018/07/01',
            ...                        freq='ME'))
            >>> ax = df.plot.area()
    ...
    def pie(self, **kwargs) -> PlotAccessor:
        ...
        **kwargs
        ...
        .. plot::
            ...
            ...                    'radius': [2439.7, 6051.8, 6378.1]***REMOVED***,
...
_backends: dict[str, types.ModuleType] = {***REMOVED***
...
***REMOVED*** from None
    ...
    raise ValueError(
        f"Could not find plotting backend '{backend***REMOVED***'. Ensure that you've "
        f"installed the package providing the '{backend***REMOVED***' entrypoint, or that "
