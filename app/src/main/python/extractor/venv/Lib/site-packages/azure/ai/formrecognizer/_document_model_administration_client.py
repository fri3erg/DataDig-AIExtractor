...
***REMOVED***
    ...
    ***REMOVED***
            ...
            model_kwargs.update({"azure_blob_file_list_source": azure_blob_file_list_source***REMOVED***)
...
***REMOVED***,
    ...
    def begin_build_document_classifier(
        ...
        **kwargs: Any
        ...
        _doc_types = {doc: details._to_generated() for doc, details in doc_types.items()***REMOVED***
