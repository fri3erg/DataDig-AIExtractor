...
def _cat_compare_op(op):
    opname = f"__{op.__name__***REMOVED***__"
    ...
    ***REMOVED***
        ...
        if hashable:
            if other in self.categories:
                ...
                if opname not in {"__eq__", "__ge__", "__gt__"***REMOVED***:
            ...
            if opname not in ["__eq__", "__ne__"]:
                raise TypeError(
                    f"Cannot compare a Categorical for op {opname***REMOVED*** with "
                    f"type {type(other)***REMOVED***.\nIf you want to compare values, "
...
***REMOVED***
        ...
        ***REMOVED***
                ...
                ValueError,
***REMOVED***:
                msg = f"Cannot cast {self.categories.dtype***REMOVED*** dtype to {dtype***REMOVED***"
...
***REMOVED***
    ...
    def rename_categories(self, new_categories) -> Self:
        ...
        >>> c.rename_categories({'a': 'A', 'c': 'C'***REMOVED***)
        ['A', 'A', 'b']
        Categories (2, object): ['A', 'b']
...
***REMOVED***
    ...
    def add_categories(self, new_categories) -> Self:
        ...
        if len(already_included) != 0:
            raise ValueError(
                f"new categories must not include old categories: {already_included***REMOVED***"
***REMOVED***
...
***REMOVED***
    ...
    def remove_categories(self, removals) -> Self:
        ...
        if len(not_included) != 0:
            ...
            raise ValueError(f"removals must all be in old categories: {not_included***REMOVED***")
    ...
    def map(
        ...
        na_action : {None, 'ignore'***REMOVED***, default 'ignore'
        ...
        ['A', 'B', 'C']
        Categories (3, object): ['A', 'B', 'C']
        >>> cat.map({'a': 'first', 'b': 'second', 'c': 'third'***REMOVED***, na_action=None)
        ['first', 'second', 'third']
        ...
        ['a', 'b', 'c']
        Categories (3, object): ['a' < 'b' < 'c']
        >>> cat.map({'a': 3, 'b': 2, 'c': 1***REMOVED***, na_action=None)
        [3, 2, 1]
        Categories (3, int64): [3 < 2 < 1]

        If the mapping is not one-to-one an :class:`~pandas.Index` is returned:

        >>> cat.map({'a': 'first', 'b': 'second', 'c': 'first'***REMOVED***, na_action=None)
        Index(['first', 'second', 'first'], dtype='object')

        If a `dict` is used, all unmapped categories are mapped to `NaN` and
        the result is an :class:`~pandas.Index`:

        >>> cat.map({'a': 'first', 'b': 'second'***REMOVED***, na_action=None)
    ...
    def _validate_scalar(self, fill_value):
        ...
        if is_valid_na_for_dtype(fill_value, self.categories.dtype):
            ...
            raise TypeError(
                ...
                f"category ({fill_value***REMOVED***), set the categories first"
***REMOVED*** from None
        return fill_value
...
***REMOVED***
        ...
        raise TypeError(
            f"Object with dtype {self.dtype***REMOVED*** cannot perform "
            f"the numpy op {ufunc.__name__***REMOVED***"
        )
...
***REMOVED***
    ...
    def check_for_ordered(self, op) -> None:
        ...
        if not self.ordered:
            raise TypeError(
                f"Categorical is not ordered for operation {op***REMOVED***\n"
...
***REMOVED***
    ...
    def argsort(
        ...
        ascending : bool, default True
            ...
            or descending sort.
        kind : {'quicksort', 'mergesort', 'heapsort', 'stable'***REMOVED***, optional
            Sorting algorithm.
        **kwargs:
    ...
    def sort_values(
        ...
        *,
        ...
        na_position : {'first', 'last'***REMOVED*** (optional, default='last')
        ...
        if na_position not in ["last", "first"]:
            raise ValueError(f"invalid na_position: {repr(na_position)***REMOVED***")
...
***REMOVED***
    ...
    def _get_repr_footer(self) -> str:
        ...
        levheader = f"Categories ({len(self.categories)***REMOVED***, {dtype***REMOVED***): "
        ...
        return f"{levheader***REMOVED***[{levstring.replace(' < ... < ', ' ... ')***REMOVED***]"
    ...
    def __repr__(self) -> str:
        ...
        if length > max_len:
            ...
            body = f"{head[:-1]***REMOVED***, ..., {tail[1:]***REMOVED***"
            length_info = f"Length: {len(self)***REMOVED***"
            result = f"{body***REMOVED***\n{length_info***REMOVED***\n{footer***REMOVED***"
        elif length > 0:
            ...
            body = "[]"
            result = f"{body***REMOVED***, {footer***REMOVED***"
...
***REMOVED***
    ...
    def _reverse_indexer(self) -> dict[Hashable, npt.NDArray[np.intp]]:
        ...
        *This is an internal function*
        ...
        >>> c._reverse_indexer()
        {'a': array([0, 1, 4]), 'b': array([2]), 'c': array([3])***REMOVED***
    ...
    def _concat_same_type(cls, to_concat: Sequence[Self], axis: AxisInt = 0) -> Self:
        ...
        if axis >= first.ndim:
            raise ValueError(
                f"axis {axis***REMOVED*** is out of bounds for array of dimension {first.ndim***REMOVED***"
***REMOVED***
    ...
    def _groupby_op(
        ...
        **kwargs,
        ...
        if how in ["sum", "prod", "cumsum", "cumprod", "skew"]:
            raise TypeError(f"{dtype***REMOVED*** type does not support {how***REMOVED*** operations")
        if how in ["min", "max", "rank", "idxmin", "idxmax"] and not dtype.ordered:
            # raise TypeError instead of NotImplementedError to ensure we
            #  don't go down a group-by-group path, since in the empty-groups
            #  case that would fail to raise
            raise TypeError(f"Cannot perform {how***REMOVED*** with non-ordered Categorical")
        if how not in [
            "rank",
            "any",
            "all",
            ...
            if kind == "transform":
                raise TypeError(f"{dtype***REMOVED*** type does not support {how***REMOVED*** operations")
            raise TypeError(f"{dtype***REMOVED*** dtype does not support aggregation '{how***REMOVED***'")
