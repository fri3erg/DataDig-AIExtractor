...
class Worksheet(_WorkbookChild):
    ...
    _rel_type = "worksheet"
    _path = "/xl/worksheets/sheet{0***REMOVED***.xml"
    ...
    def _get_cell(self, row, column):
        ...
        if not 0 < row < 1048577:
            raise ValueError(f"Row numbers must be between 1 and 1048576. Row number supplied was {row***REMOVED***")
    ...
    def __getitem__(self, key):
        ...
        if isinstance(key, slice):
            if not all([key.start, key.stop]):
                raise IndexError("{0***REMOVED*** is not a valid coordinate or range".format(key))
            key = "{0***REMOVED***:{1***REMOVED***".format(key.start, key.stop)
    ...
    def calculate_dimension(self):
        ...
        return f"{get_column_letter(min_col)***REMOVED***{min_row***REMOVED***:{get_column_letter(max_col)***REMOVED***{max_row***REMOVED***"
    ...
    def add_table(self, table):
        ...
        if self.parent._duplicate_name(table.name):
            raise ValueError("Table with name {0***REMOVED*** already exists".format(table.name))
    ...
    def unmerge_cells(self, range_string=None, start_row=None, start_column=None, end_row=None, end_column=None):
        ...
        if cr.coord not in self.merged_cells:
            raise ValueError("Cell range {0***REMOVED*** is not merged".format(cr.coord))
    ...
    def append(self, iterable):
        ...
        * **or** append({'A' : 'This is A1', 'C' : 'This is C1'***REMOVED***)
        * **or** append({1 : 'This is A1', 3 : 'This is C1'***REMOVED***)
    ...
    def _invalid_row(self, iterable):
        raise TypeError('Value must be a list, tuple, range or generator, or a dict. Supplied value is {0***REMOVED***'.format(
            type(iterable))
            ***REMOVED***
