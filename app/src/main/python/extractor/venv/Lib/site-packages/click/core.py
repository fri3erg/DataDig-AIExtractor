...
def _check_multicommand(
    ...
    raise RuntimeError(
        f"{hint***REMOVED***. Command {base_command.name!r***REMOVED*** is set to chain and"
        f" {cmd_name!r***REMOVED*** was added as a subcommand but it in itself is a"
        f" multi command. ({cmd_name!r***REMOVED*** is a {type(cmd).__name__***REMOVED***"
        f" within a chained {type(base_command).__name__***REMOVED*** named"
        f" {base_command.name!r***REMOVED***)."
    )
...
class Context:
    ...
    def __init__(
        ...
        self.params: t.Dict[str, t.Any] = {***REMOVED***
        ...
        self.obj: t.Any = obj
        self._meta: t.Dict[str, t.Any] = getattr(parent, "meta", {***REMOVED***)
...
***REMOVED***:
                auto_envvar_prefix = (
                    f"{parent.auto_envvar_prefix***REMOVED***_{self.info_name.upper()***REMOVED***"
    ***REMOVED***
        else:
        ...
        self._depth = 0
        self._parameter_source: t.Dict[str, ParameterSource] = {***REMOVED***
    ...
    def meta(self) -> t.Dict[str, t.Any]:
        ...
        Example usage::
            ...
            LANG_KEY = f'{__name__***REMOVED***.lang'
    ...
    def command_path(self) -> str:
        ...
        if self.parent is not None:
            ...
            rv = f"{' '.join(parent_command_path)***REMOVED*** {rv***REMOVED***"
        return rv.lstrip()
...
class BaseCommand:
    ...
    def to_info_dict(self, ctx: Context) -> t.Dict[str, t.Any]:
        ...
        .. versionadded:: 8.0
        """
        return {"name": self.name***REMOVED***

    def __repr__(self) -> str:
        return f"<{self.__class__.__name__***REMOVED*** {self.name***REMOVED***>"
    ...
    ***REMOVED***
    ...
    def _main_shell_completion(
        ...
        if complete_var is None:
            ...
            complete_var = f"_{complete_name***REMOVED***_COMPLETE".upper()
...
class Command(BaseCommand):
    ...
    def get_short_help_str(self, limit: int = 45) -> str:
        ...
        if self.deprecated:
            text = _("(Deprecated) {text***REMOVED***").format(text=text)
    ...
    def parse_args(self, ctx: Context, args: t.List[str]) -> t.List[str]:
        ...
        if args and not ctx.allow_extra_args and not ctx.resilient_parsing:
            ctx.fail(
                ngettext(
                    "Got unexpected extra argument ({args***REMOVED***)",
                    "Got unexpected extra arguments ({args***REMOVED***)",
                    len(args),
...
***REMOVED***
    ...
    def invoke(self, ctx: Context) -> t.Any:
        ...
        if self.deprecated:
            message = _(
                "DeprecationWarning: The command {name!r***REMOVED*** is deprecated."
***REMOVED***.format(name=self.name)
    ...
    ***REMOVED***
    ...
    def resolve_command(
        ...
        if cmd is None and not ctx.resilient_parsing:
            ...
            ctx.fail(_("No such command {name!r***REMOVED***.").format(name=original_cmd_name))
    ...
    def __init__(
        ...
        **attrs: t.Any,
        ...
        if commands is None:
            ...
            commands = {c.name: c for c in commands if c.name is not None***REMOVED***
...
***REMOVED***, "Use 'command(**kwargs)(callable)' to provide arguments."
            (func,) = args
            args = ()
    ...
    def group(
        ...
        if args and callable(args[0]):
            assert (
                len(args) == 1 and not kwargs
***REMOVED***, "Use 'group(**kwargs)(callable)' to provide arguments."
            (func,) = args
            args = ()
...
class Parameter:
    ...
    def __init__(
        ...
        if __debug__:
            if self.type.is_composite and nargs != self.type.arity:
                raise ValueError(
                    f"'nargs' must be {self.type.arity***REMOVED*** (or None) for"
                    f" type {self.type!r***REMOVED***, but it was {nargs***REMOVED***."
    ***REMOVED***
            ...
            ***REMOVED*** from None
                ...
                ***REMOVED***
                    ...
                    if nargs > 1 and len(check_default) != nargs:
                        ...
                        raise ValueError(
                            f"'default' {subject***REMOVED*** must match nargs={nargs***REMOVED***."
            ***REMOVED***
    ...
    ***REMOVED*** from None
        ...
        if self.nargs == 1 or self.type.is_composite:
            ...
            def convert(value: t.Any) -> t.Any:  # t.Tuple[t.Any, ...]
                ...
                if len(value) != self.nargs:
                    raise BadParameter(
                        ngettext(
                            "Takes {nargs***REMOVED*** values but 1 was given.",
                            "Takes {nargs***REMOVED*** values but {len***REMOVED*** were given.",
                            len(value),
    ...
    def get_error_hint(self, ctx: Context) -> str:
        ...
        return " / ".join(f"'{x***REMOVED***'" for x in hint_list)
    ...
    def _parse_decls(
        ...
        for decl in decls:
            if decl.isidentifier():
                if name is not None:
                    raise TypeError(f"Name '{name***REMOVED***' defined twice")
                name = decl
            else:
                ...
                if split_char in decl:
                    ...
                    if first == second:
                        raise ValueError(
                            f"Boolean option {decl!r***REMOVED*** cannot use the"
        ...
        if not opts and not secondary_opts:
            raise TypeError(
                f"No options defined but a name was passed ({name***REMOVED***)."
                " Did you mean to declare an argument instead? Did"
                f" you mean to pass '--{name***REMOVED***'?"
***REMOVED***
    ...
    def add_to_parser(self, parser: OptionParser, ctx: Context) -> None:
        ...
        if self.is_flag:
            action = f"{action***REMOVED***_const"
...
***REMOVED***
    ...
    def get_help_record(self, ctx: Context) -> t.Optional[t.Tuple[str, str]]:
        ...
        def _write_opts(opts: t.Sequence[str]) -> str:
            ...
            if not self.is_flag and not self.count:
                rv += f" {self.make_metavar()***REMOVED***"
    ...
    ***REMOVED***:
                    envvar = f"{ctx.auto_envvar_prefix***REMOVED***_{self.name.upper()***REMOVED***"
    ...
    ***REMOVED***
                extra.append(_("env var: {var***REMOVED***").format(var=var_str))
        ...
        if show_default_is_str or (show_default and (default_value is not None)):
            if show_default_is_str:
                default_string = f"({self.show_default***REMOVED***)"
    ...
    ***REMOVED***[1]
            ...
            if default_string:
                extra.append(_("default: {default***REMOVED***").format(default=default_string))
        ...
        if extra:
            ...
            help = f"{help***REMOVED***  [{extra_str***REMOVED***]" if help else f"[{extra_str***REMOVED***]"
    ...
    def consume_value(
        ...
        # prompting is enabled.
            ...
            source in {None, ParameterSource.DEFAULT***REMOVED***
...
***REMOVED***
    ...
    def get_error_hint(self, ctx: Context) -> str:
        return f"'{self.make_metavar()***REMOVED***'"
