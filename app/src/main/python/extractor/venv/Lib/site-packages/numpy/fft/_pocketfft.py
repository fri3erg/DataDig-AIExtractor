...
def _get_forward_norm(n, norm):
    if n < 1:
        raise ValueError(f"Invalid number of FFT data points ({n***REMOVED***) specified.")
    ...
    if norm is None or norm == "backward":
        ...
        return n
    raise ValueError(f'Invalid norm value {norm***REMOVED***; should be "backward",'
                     '"ortho" or "forward".')
...
_SWAP_DIRECTION_MAP = {"backward": "forward", None: "forward",
                       "ortho": "ortho", "forward": "backward"***REMOVED***
...
def fft(a, n=None, axis=-1, norm=None):
    ...
    axis : int, optional
        ...
        used.
    norm : {"backward", "ortho", "forward"***REMOVED***, optional
        .. versionadded:: 1.10.0
