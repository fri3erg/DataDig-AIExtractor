...
pear:tomato
"""
    exp = DataFrame({"fruit": ["apple", "pear"], "vegetable": ["broccoli", "tomato"]***REMOVED***)
...
@pytest.mark.parametrize(
    ...
    [
        ({"sep": ","***REMOVED***, None),  # sep is default --> sep_override=True
        ({"sep": "."***REMOVED***, ParserWarning),  # sep isn't default --> sep_override=False
        ({"delimiter": ":"***REMOVED***, None),  # No conflict
        ({"delimiter": None***REMOVED***, None),  # Default arguments --> sep_override=True
        ({"delimiter": ","***REMOVED***, ParserWarning),  # Conflict
        ({"delimiter": "."***REMOVED***, ParserWarning),  # Conflict
    ],
    ids=[
        "sep-override-true",
