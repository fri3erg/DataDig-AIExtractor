...
class _XMLFrameParser:
    ...
    dtype : dict
        ...
        'b': np.int32, 'c': 'Int64'***REMOVED******REMOVED***
    ...
    def _parse_nodes(self, elems: list[Any]) -> list[dict[str, str | None]]:
        ...
        if self.elems_only:
            ...
            ***REMOVED***,
                ...
                dicts = [
                    {ch.tag: ch.text if ch.text else None for ch in el.findall("*")***REMOVED***
                    for el in elems
                ]

        elif self.attrs_only:
            dicts = [
                {k: v if v else None for k, v in el.attrib.items()***REMOVED*** for el in elems
            ]
            ...
            dicts = [
                {
                    **el.attrib,
                    **({el.tag: el.text***REMOVED*** if el.text and not el.text.isspace() else {***REMOVED***),
                    **{
                        nm: ch.text if ch.text else None
                        for nm, ch in zip(self.names, el.findall("*"))
                    ***REMOVED***,
        ...
        dicts = [
            {k.split("***REMOVED***")[1] if "***REMOVED***" in k else k: v for k, v in d.items()***REMOVED*** for d in dicts
        ]

        keys = list(dict.fromkeys([k for d in dicts for k in d.keys()]))
        dicts = [{k: d[k] if k in d.keys() else None for k in keys***REMOVED*** for d in dicts]
    ...
    def _iterparse_nodes(self, iterparse: Callable) -> list[dict[str, str | None]]:
        ...
        if not isinstance(self.iterparse, dict):
            raise TypeError(
                f"{type(self.iterparse).__name__***REMOVED*** is not a valid type for iterparse"
***REMOVED***

        row_node = next(iter(self.iterparse.keys())) if self.iterparse else ""
        if not is_list_like(self.iterparse[row_node]):
            raise TypeError(
                f"{type(self.iterparse[row_node])***REMOVED*** is not a valid type "
...
***REMOVED***
        ...
        for event, elem in iterparse(self.path_or_buffer, events=("start", "end")):
            curr_elem = elem.tag.split("***REMOVED***")[1] if "***REMOVED***" in elem.tag else elem.tag
...
***REMOVED***
    ...
    def _validate_path(self) -> list[Any]:
        ...
        try:
            ...
            attrs = {k: v for el in elems for k, v in el.attrib.items()***REMOVED***
            ...
            if elems is not None:
                if self.elems_only and children == []:
                    raise ValueError(msg)
                if self.attrs_only and attrs == {***REMOVED***:
                    raise ValueError(msg)
                if children == [] and attrs == {***REMOVED***:
                    raise ValueError(msg)
...
***REMOVED***
    ...
    def _validate_names(self) -> None:
        ...
        ***REMOVED***
                ...
                raise TypeError(
                    f"{type(self.names).__name__***REMOVED*** is not a valid type for names"
    ***REMOVED***
    ...
    *,
    ...
    namespaces : dict, optional
        ...
        underlying nodes and/or attributes. For example, ::
            ...
            namespaces = {{"doc": "https://example.com"***REMOVED******REMOVED***
    ...
    iterparse : dict, optional
        ...
        For example, ::
            ...
            iterparse = {{"row_element": ["child_elem", "attr", "grandchild_elem"]***REMOVED******REMOVED***
