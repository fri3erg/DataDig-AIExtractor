...
def _load_agent_from_tools(
    ...
    if config_type not in AGENT_TO_CLASS:
        raise ValueError(f"Loading {config_type***REMOVED*** agent not supported")

    agent_cls = AGENT_TO_CLASS[config_type]
    combined_config = {**config, **kwargs***REMOVED***
...
def load_agent(
    ...
    Returns:
        An agent executor.
    """
    valid_suffixes = {"json", "yaml"***REMOVED***
...
def _load_agent_from_file(
    ...
    if file_path.suffix[1:] == "json":
        ...
        raise ValueError(f"Unsupported file type, must be one of {valid_suffixes***REMOVED***.")
