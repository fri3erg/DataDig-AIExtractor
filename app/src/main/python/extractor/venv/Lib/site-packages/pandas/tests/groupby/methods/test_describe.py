...
def test_frame_describe_multikey(tsframe):
    ...
    with tm.assert_produces_warning(FutureWarning, match=msg):
        groupedT = tsframe.groupby({"A": 0, "B": 0, "C": 1, "D": 1***REMOVED***, axis=1)
...
def test_frame_describe_tupleindex():
    ...
    df2 = df1.rename(columns={"k": "key"***REMOVED***)
...
def test_frame_describe_unstacked_format():
    ...
    ***REMOVED***
    df = DataFrame({"PRICE": prices, "VOLUME": volumes***REMOVED***)
...
@pytest.mark.parametrize(
    "kwargs",
    [
        {"percentiles": [0.10, 0.20, 0.30], "include": "all", "exclude": None***REMOVED***,
        {"percentiles": [0.10, 0.20, 0.30], "include": None, "exclude": ["int"]***REMOVED***,
        {"percentiles": [0.10, 0.20, 0.30], "include": ["int"], "exclude": None***REMOVED***,
    ],
)
