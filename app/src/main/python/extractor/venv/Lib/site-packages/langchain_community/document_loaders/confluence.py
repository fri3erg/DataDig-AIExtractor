...
***REMOVED***
    ...
    :param oauth2: _description_, defaults to {***REMOVED***
    ...
    def __init__(
        ...
        confluence_kwargs = confluence_kwargs or {***REMOVED***
        ...
        if errors:
            raise ValueError(f"Error(s) while validating input: {errors***REMOVED***")
        try:
...
***REMOVED***
        ...
        if sum(non_null_creds) > 1:
            ...
            errors.append(
                f"Cannot provide a value for more than one of: {all_names***REMOVED***. Received "
                f"values for: {provided***REMOVED***"
***REMOVED***
...
***REMOVED***
    ...
    ***REMOVED***(self.confluence.get_page_by_id)
                page = get_page(
                    page_id=page_id, expand=f"{content_format.value***REMOVED***,version"
    ***REMOVED***
    ...
    ***REMOVED***
    ...
    def _search_content_by_cql(
        ...
        params: Dict[str, Any] = {"cql": cql***REMOVED***
    ...
    ***REMOVED***
        ...
        if keep_markdown_format:
            ...
            if keep_newlines:
                text = BeautifulSoup(
                    content.replace("</p>", "\n</p>").replace("<br />", "\n"), "lxml"
    ***REMOVED***.get_text(" ") + "".join(attachment_texts)
            else:
                text = BeautifulSoup(content, "lxml").get_text(
                    " ", strip=True
    ***REMOVED*** + "".join(attachment_texts)
...
***REMOVED***
    ...
    ***REMOVED***:
                ...
                if e.response.status_code == 404:
                    print(f"Attachment not found at {absolute_url***REMOVED***")
                    continue
                else:
                    raise
...
***REMOVED***
        ...
        if file_extension.startswith(
            ...
            for sheet in workbook.sheets():
                text += f"{sheet.name***REMOVED***:\n"
                for row in range(sheet.nrows):
                    for col in range(sheet.ncols):
                        text += f"{sheet.cell_value(row, col)***REMOVED***\t"
                    text += "\n"
                text += "\n"
