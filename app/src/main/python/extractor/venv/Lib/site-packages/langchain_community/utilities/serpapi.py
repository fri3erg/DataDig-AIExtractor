...
***REMOVED***
    ...
    def get_params(self, query: str) -> Dict[str, str]:
        ...
        _params = {
            ...
            "q": query,
        ***REMOVED***
        params = {**self.params, **_params***REMOVED***
        return params
    ...
    def _process_response(res: dict) -> str:
        ...
        if "error" in res.keys():
            raise ValueError(f"Got error from SerpAPI: {res['error']***REMOVED***")
    ...
    ***REMOVED***:
                    snippets.append(f"{title***REMOVED*** {key***REMOVED***: {value***REMOVED***.")
