...
class _OllamaCommon(BaseLanguageModel):
    ...
    def _identifying_params(self) -> Mapping[str, Any]:
        ...
        return {**{"model": self.model, "format": self.format***REMOVED***, **self._default_params***REMOVED***
    ...
    def _create_generate_stream(
        ...
        **kwargs: Any,
        ...
        payload = {"prompt": prompt, "images": images***REMOVED***
        yield from self._create_stream(
            payload=payload,
            stop=stop,
            api_url=f"{self.base_url***REMOVED***/api/generate/",
            **kwargs,
        )
    ...
    def _create_stream(
        ...
        **kwargs: Any,
        ...
        if payload.get("messages"):
            request_payload = {"messages": payload.get("messages", []), **params***REMOVED***
        else:
            request_payload = {
        ...
        if response.status_code != 200:
            if response.status_code == 404:
                raise OllamaEndpointNotFoundError(
                    ...
                    f"and you should pull the model with `ollama pull {self.model***REMOVED***`."
    ***REMOVED***
            else:
                optional_detail = response.json().get("error")
                raise ValueError(
                    f"Ollama call failed with status code {response.status_code***REMOVED***."
                    f" Details: {optional_detail***REMOVED***"
    ***REMOVED***
...
***REMOVED*** as response:
            ...
            ***REMOVED***
                        ...
                        raise ValueError(
                            f"Ollama call failed with status code {response.status***REMOVED***."
                            f" Details: {optional_detail***REMOVED***"
            ***REMOVED***
