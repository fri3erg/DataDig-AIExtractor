...
class TestDataFramePlots:
    ...
    @pytest.mark.parametrize(
        "kwargs, warn",
        [
            [{"return_type": "dict"***REMOVED***, None],
            [{"column": ["one", "two"]***REMOVED***, None],
            [{"column": ["one", "two"], "by": "indic"***REMOVED***, UserWarning],
            [{"column": ["one"], "by": ["indic", "indic2"]***REMOVED***, None],
            [{"by": "indic"***REMOVED***, UserWarning],
            [{"by": ["indic", "indic2"]***REMOVED***, UserWarning],
            [{"notch": 1***REMOVED***, None],
            [{"by": "indic", "notch": 1***REMOVED***, UserWarning],
        ],
    )
...
***REMOVED***
    ...
    def test_boxplot_return_type_legacy(self):
        ...
        msg = "return_type must be {'axes', 'dict', 'both'***REMOVED***"
    ...
    @pytest.mark.parametrize(
        ...
        [
            (
                {"boxes": "r", "whiskers": "b", "medians": "g", "caps": "c"***REMOVED***,
                {"boxes": "r", "whiskers": "b", "medians": "g", "caps": "c"***REMOVED***,
***REMOVED***,
            ({"boxes": "r"***REMOVED***, {"boxes": "r"***REMOVED***),
            ("r", {"boxes": "r", "whiskers": "r", "medians": "r", "caps": "r"***REMOVED***),
        ],
    )
...
***REMOVED***,
    ...
    @pytest.mark.parametrize(
        "dict_colors, msg",
        [({"boxes": "r", "invalid_key": "r"***REMOVED***, "invalid key 'invalid_key'")],
    )
    ...
    def test_specified_props_kwd(self, props, expected):
        # GH 30346
        df = DataFrame({k: np.random.default_rng(2).random(10) for k in "ABC"***REMOVED***)
...
***REMOVED***
    ...
    def test_grouped_plot_fignums(self):
        ...
        df = DataFrame({"height": height, "weight": weight, "gender": gender***REMOVED***)
...
***REMOVED***
    ...
    def test_fontsize(self):
        df = DataFrame({"a": [1, 2, 3, 4, 5, 6], "b": [0, 0, 0, 1, 1, 1]***REMOVED***)
        _check_ticks_props(
