...
def test_validate() -> None:
    ...
    assert groups == {"group1": b"0", "group2": b"1"***REMOVED***
...
def test_validate_formatting() -> None:
    ...
    with pytest.raises(LocalProtocolError) as excinfo:
        validate(my_re, b"", "oops {***REMOVED***")
    assert "oops {***REMOVED***" in str(excinfo.value)

    with pytest.raises(LocalProtocolError) as excinfo:
        validate(my_re, b"", "oops {***REMOVED*** xx", 10)
