...
class _EmbeddingDistanceChainMixin(Chain):
    ...
    ***REMOVED***
    ...
    def _prepare_output(self, result: dict) -> dict:
        parsed = {"score": result["score"]***REMOVED***
    ...
    def _get_metric(self, metric: EmbeddingDistance) -> Any:
        ...
        ***REMOVED***
        if metric in metrics:
            ...
            raise ValueError(f"Invalid metric: {metric***REMOVED***")
...
class EmbeddingDistanceEvalChain(_EmbeddingDistanceChainMixin, StringEvaluator):
    ...
    def evaluation_name(self) -> str:
        return f"embedding_{self.distance_metric.value***REMOVED***_distance"
...
class PairwiseEmbeddingDistanceEvalChain(
    ...
    @property
    def evaluation_name(self) -> str:
        return f"pairwise_embedding_{self.distance_metric.value***REMOVED***_distance"
