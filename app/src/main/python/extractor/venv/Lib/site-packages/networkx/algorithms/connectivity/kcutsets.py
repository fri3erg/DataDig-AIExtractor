...
def all_node_cuts(G, k=None, flow_func=None):
    ...
    kwargs = {"capacity": "capacity", "residual": R***REMOVED***
    ...
    X = {n for n, d in sorted(G.degree(), key=itemgetter(1), reverse=True)[:k]***REMOVED***
    ...
    for x in X:
        ...
        for v in non_adjacent:
            ...
            R = flow_func(H, f"{mapping[x]***REMOVED***B", f"{mapping[v]***REMOVED***A", **kwargs)
            ...
            if flow_value == k:
                ...
                VE1 = incident_nodes = {n for edge in E1 for n in edge***REMOVED***
                ...
                VE1 = {cmap[n] for n in VE1***REMOVED***
                ...
                for antichain in nx.antichains(L):
                    ...
                    if f"{mapping[x]***REMOVED***B" not in S or f"{mapping[v]***REMOVED***A" in S:
                        continue
                    ...
                    if any(H_nodes[u]["id"] != H_nodes[w]["id"] for u, w in cutset):
                        continue
                    node_cut = {H_nodes[u]["id"] for u, _ in cutset***REMOVED***
                ...
                # in residual graphs.
                H.add_edge(f"{mapping[x]***REMOVED***B", f"{mapping[v]***REMOVED***A", capacity=1)
                H.add_edge(f"{mapping[v]***REMOVED***B", f"{mapping[x]***REMOVED***A", capacity=1)
                # Add edges to the residual network.
                R.add_edge(f"{mapping[x]***REMOVED***B", f"{mapping[v]***REMOVED***A", capacity=1)
                R.add_edge(f"{mapping[v]***REMOVED***A", f"{mapping[x]***REMOVED***B", capacity=0)
                R.add_edge(f"{mapping[v]***REMOVED***B", f"{mapping[x]***REMOVED***A", capacity=1)
                R.add_edge(f"{mapping[x]***REMOVED***A", f"{mapping[v]***REMOVED***B", capacity=0)
