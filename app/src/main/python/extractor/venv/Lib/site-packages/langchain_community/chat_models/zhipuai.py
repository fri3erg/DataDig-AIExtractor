...
class ChatZhipuAI(BaseChatModel):
    ...
    {"enable": "true", "search_query": "history "***REMOVED***
    """
    ...
    def _identifying_params(self) -> Dict[str, Any]:
        return {"model_name": self.model***REMOVED***
    ...
    def lc_secrets(self) -> Dict[str, str]:
        return {"zhipuai_api_key": "ZHIPUAI_API_KEY"***REMOVED***
    ...
    def _generate(
        ...
        **kwargs: Any,
        ...
        for message in messages:
            ...
            prompt.append({"role": role, "content": message.content***REMOVED***)
        ...
        **kwargs: Any,
        ...
        for r in response.events():
            if r.event == "add":
                ...
                raise ValueError(f"Error from ZhipuAI API response: {r.data***REMOVED***")
