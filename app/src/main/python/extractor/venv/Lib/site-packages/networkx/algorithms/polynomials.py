...
def tutte_polynomial(G):
    ...
    .. math::
        ...
        T_G(x, y) = \sum_{A \in E***REMOVED*** (x-1)^{c(A) - c(E)***REMOVED*** (y-1)^{c(A) + |A| - n(G)***REMOVED***
    ...
    $E \setminus T \cup {e***REMOVED***$. An edge `e` is internally active with respect to
    ...
    Let `P_e` be the unique path in $T \cup {e***REMOVED***$ whose source and target vertex
    ...
    .. math::
        ...
        T_G(x, y) = \sum_{T \text{ a spanning tree of ***REMOVED*** G***REMOVED*** x^{i(T)***REMOVED*** y^{e(T)***REMOVED***
    ...
    .. math::
        T_G(x, y) = \begin{cases***REMOVED***
    	   x^{k(G)***REMOVED*** y^{l(G)***REMOVED***, & \text{if all edges are cut-edges or self-loops***REMOVED*** \\
           T_{G-e***REMOVED***(x, y) + T_{G/e***REMOVED***(x, y), & \text{otherwise, for an arbitrary edge $e$ not a cut-edge or loop***REMOVED***
        \end{cases***REMOVED***
...
def chromatic_polynomial(G):
    ...
    .. math::
        ...
        X_G(x) = \sum_{S \subseteq E***REMOVED*** (-1)^{|S|***REMOVED*** x^{c(G(S))***REMOVED***
    ...
    `(0, k_0), (1, k_1), \dots, (n(G), k_{n(G)***REMOVED***)` [2]_.
    ...
    .. math::
        X_G(x) = \begin{cases***REMOVED***
    	   x^{n(G)***REMOVED***, & \text{if $e(G)=0$***REMOVED*** \\
           X_{G-e***REMOVED***(x) - X_{G/e***REMOVED***(x), & \text{otherwise, for an arbitrary edge $e$***REMOVED***
        \end{cases***REMOVED***
