...
_ALLOWED_DTYPES = {
    "evaluate": {"int64", "int32", "float64", "float32", "bool"***REMOVED***,
    "where": {"int64", "float64", "bool"***REMOVED***,
***REMOVED***
...
def _evaluate_numexpr(op, op_str, a, b):
    ...
    if _can_use_numexpr(op, op_str, a, b, "evaluate"):
        ...
        try:
            result = ne.evaluate(
                f"a_value {op_str***REMOVED*** b_value",
                local_dict={"a_value": a_value, "b_value": b_value***REMOVED***,
                casting="safe",
***REMOVED***
        except TypeError:
...
def _where_numexpr(cond, a, b):
    ...
    if _can_use_numexpr(None, "where", a, b, "where"):
        result = ne.evaluate(
            ...
            local_dict={"cond_value": cond, "a_value": a, "b_value": b***REMOVED***,
            casting="safe",
        )
...
def _bool_arith_fallback(op_str, a, b) -> bool:
    ...
    if _has_bool_dtype(a) and _has_bool_dtype(b):
        if op_str in _BOOL_OP_UNSUPPORTED:
            warnings.warn(
                f"evaluating in Python space because the {repr(op_str)***REMOVED*** "
                "operator is not supported by numexpr for the bool dtype, "
                f"use {repr(_BOOL_OP_UNSUPPORTED[op_str])***REMOVED*** instead.",
