...
class Nonterminal:
    ...
    def __div__(self, rhs):
        ...
        :rtype: Nonterminal
        """
        return Nonterminal(f"{self._symbol***REMOVED***/{rhs._symbol***REMOVED***")
...
class DependencyProduction(Production):
    ...
    def __str__(self):
        ...
        :rtype: str
        """
        result = f"'{self._lhs***REMOVED***' ->"
        for elt in self._rhs:
            result += f" '{elt***REMOVED***'"
        return result
...
***REMOVED***
        ...
        self._categories = {prod.lhs() for prod in productions***REMOVED***
    ...
    def _calculate_indexes(self):
        self._lhs_index = {***REMOVED***
        self._rhs_index = {***REMOVED***
        self._empty_index = {***REMOVED***
        self._lexical_index = {***REMOVED***
    ...
    def _calculate_leftcorners(self):
        ...
        self._immediate_leftcorner_categories = {cat: {cat***REMOVED*** for cat in self._categories***REMOVED***
        self._immediate_leftcorner_words = {cat: set() for cat in self._categories***REMOVED***
        ...
        self._leftcorner_words = {***REMOVED***
...
***REMOVED***
    ...
    def leftcorners(self, cat):
        ...
        """
        return self._leftcorners.get(cat, {cat***REMOVED***)
...
***REMOVED***
    ...
    def leftcorner_parents(self, cat):
        ...
        :rtype: set(Nonterminal)
        """
        return self._leftcorner_parents.get(cat, {cat***REMOVED***)
    ...
    def check_coverage(self, tokens):
        ...
        if missing:
            missing = ", ".join(f"{w!r***REMOVED***" for w in missing)
            raise ValueError(
...
***REMOVED***
        ...
        for rule in self.productions():
            if rule.is_lexical() and len(rule.rhs()) > 1:
                raise ValueError(
                    f"Cannot handled mixed rule {rule.lhs()***REMOVED*** => {rule.rhs()***REMOVED***"
    ***REMOVED***
...
class ProbabilisticDependencyGrammar:
    ...
    def __str__(self):
        ...
        for tag_word in self._tags:
            str += f"\n {tag_word***REMOVED***:\t({self._tags[tag_word]***REMOVED***)"
        return str
...
def read_grammar(input, nonterm_parser, probabilistic=False, encoding=None):
    ...
    for linenum, line in enumerate(lines):
        ...
        try:
            ...
            raise ValueError(f"Unable to parse line {linenum + 1***REMOVED***: {line***REMOVED***\n{e***REMOVED***") from e
