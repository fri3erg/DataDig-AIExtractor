...
class Comparison:
    ...
    def __repr__(self):
        return (
            'Comparison(text="{***REMOVED***", comp_type={***REMOVED***, entity_1="{***REMOVED***", entity_2="{***REMOVED***", '
            'feature="{***REMOVED***", keyword="{***REMOVED***")'
        ).format(
            self.text,
            self.comp_type,
            self.entity_1,
...
class ComparativeSentencesCorpusReader(CorpusReader):
    ...
    def keywords(self, fileids=None):
        ...
        keywords_set = {keyword.lower() for keyword in all_keywords if keyword***REMOVED***
        return keywords_set
