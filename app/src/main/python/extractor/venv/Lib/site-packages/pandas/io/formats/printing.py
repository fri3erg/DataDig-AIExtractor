...
def _pprint_seq(
    ...
    if isinstance(seq, set):
        fmt = "{{{body***REMOVED******REMOVED******REMOVED***"
    else:
        fmt = "[{body***REMOVED***]" if hasattr(seq, "__setitem__") else "({body***REMOVED***)"
...
def _pprint_dict(
    ...
    rather than calling this directly.
    """
    fmt = "{{{things***REMOVED******REMOVED******REMOVED***"
    pairs = []

    pfmt = "{key***REMOVED***: {val***REMOVED***"
...
def pprint_thing(
    ...
    if hasattr(thing, "__next__"):
        ...
        result = f"'{as_escaped_string(thing)***REMOVED***'"
    else:
...
def format_object_summary(
    ...
    if n == 0:
        summary = f"[]{close***REMOVED***"
    elif n == 1 and not line_break_each_value:
        first = formatter(obj[0])
        summary = f"[{first***REMOVED***]{close***REMOVED***"
    elif n == 2 and not line_break_each_value:
        first = formatter(obj[0])
        last = formatter(obj[-1])
        summary = f"[{first***REMOVED***, {last***REMOVED***]{close***REMOVED***"
    else:
        if max_seq_items == 1:
...
class _EastAsianTextAdjustment(_TextAdjustment):
    def __init__(self) -> None:
        ...
        self._EAW_MAP = {"Na": 1, "N": 1, "W": 2, "F": 2, "H": 1***REMOVED***
