...
class CSVLoader(BaseLoader):
    ...
    def __init__(
        ...
        self.csv_args = csv_args or {***REMOVED***
    ...
    def load(self) -> List[Document]:
        ...
        try:
            ...
            ***REMOVED*** as csvfile:
                ...
                raise RuntimeError(f"Error loading {self.file_path***REMOVED***") from e
    ...
    ***REMOVED***
                ...
                raise ValueError(
                    f"Source column '{self.source_column***REMOVED***' not found in CSV file."
    ***REMOVED***
            content = "\n".join(
                f"{k.strip()***REMOVED***: {v.strip() if v is not None else v***REMOVED***"
                for k, v in row.items()
                if k not in self.metadata_columns
***REMOVED***
            metadata = {"source": source, "row": i***REMOVED***
            for col in self.metadata_columns:
                try:
                    metadata[col] = row[col]
                except KeyError:
                    raise ValueError(f"Metadata column '{col***REMOVED***' not found in CSV file.")
