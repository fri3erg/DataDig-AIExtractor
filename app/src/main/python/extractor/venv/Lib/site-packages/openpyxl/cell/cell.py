...
_TYPES = {int:'n', float:'n', str:'s', bool:'b'***REMOVED***
...
def get_time_format(t):
    ...
    for base in t.mro()[1:]:
        ...
        if value:
            ...
            return value
    raise ValueError("Could not get time format for {0!r***REMOVED***".format(value))
...
class Cell(StyleableObject):
    ...
    def coordinate(self):
        ...
        return f"{col***REMOVED***{self.row***REMOVED***"
    ...
    def __repr__(self):
        return "<Cell {0!r***REMOVED***.{1***REMOVED***>".format(self.parent.title, self.coordinate)
    ...
    def check_string(self, value):
        ...
        if next(ILLEGAL_CHARACTERS_RE.finditer(value), None):
            raise IllegalCharacterError(f"{value***REMOVED*** cannot be used in worksheets.")
        return value
    ...
    def _bind_value(self, value):
        ...
        if dt is None and value is not None:
            raise ValueError("Cannot convert {0!r***REMOVED*** to Excel".format(value))
...
class MergedCell(StyleableObject):
    ...
    def __repr__(self):
        return "<MergedCell {0!r***REMOVED***.{1***REMOVED***>".format(self.parent.title, self.coordinate)
