...
def LCF_graph(n, shift_list, repeats, create_using=None):
    ...
    The utility graph $K_{3,3***REMOVED***$
...
def bull_graph(create_using=None):
    ...
    G = nx.from_dict_of_lists(
        {0: [1, 2], 1: [0, 2, 3], 2: [0, 1, 4], 3: [1], 4: [2]***REMOVED***,
...
def diamond_graph(create_using=None):
    ...
    """
    G = nx.from_dict_of_lists(
        {0: [1, 2], 1: [0, 2, 3], 2: [0, 1, 3], 3: [1, 2]***REMOVED***, create_using=create_using
    )
...
def house_graph(create_using=None):
    ...
    """
    G = nx.from_dict_of_lists(
        {0: [1, 2], 1: [0, 3], 2: [0, 3, 4], 3: [1, 2, 4], 4: [2, 3]***REMOVED***,
        create_using=create_using,
    )
    G.name = "House Graph"
    return G
...
def octahedral_graph(create_using=None):
    ...
    """
    G = nx.from_dict_of_lists(
        {0: [1, 2, 3, 4], 1: [2, 3, 5], 2: [4, 5], 3: [4, 5], 4: [5]***REMOVED***,
        create_using=create_using,
    )
