...
class CookieJar(AbstractCookieJar):
    ...
    DATE_HMS_TIME_RE = re.compile(r"(\d{1,2***REMOVED***):(\d{1,2***REMOVED***):(\d{1,2***REMOVED***)")

    DATE_DAY_OF_MONTH_RE = re.compile(r"(\d{1,2***REMOVED***)")
    ...
    DATE_YEAR_RE = re.compile(r"(\d{2,4***REMOVED***)")
    ...
    def __init__(
        ...
        *,
        ...
        self._expirations: Dict[Tuple[str, str, str], float] = {***REMOVED***
