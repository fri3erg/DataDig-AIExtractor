...
# able to share
_shared_docs = {**_shared_docs***REMOVED***
_shared_doc_kwargs = {
    "axes": "keywords for axes",
    "klass": "Series/DataFrame",
    "axes_single_arg": "{0 or 'index'***REMOVED*** for Series, {0 or 'index', 1 or 'columns'***REMOVED*** for DataFrame",  # noqa: E501
    "inplace": """
...
class NDFrame(PandasObject, indexing.IndexingMixin):
    ...
    def __init__(self, data: Manager) -> None:
        ...
        object.__setattr__(self, "_item_cache", {***REMOVED***)
        object.__setattr__(self, "_attrs", {***REMOVED***)
...
***REMOVED***:
    ...
    def attrs(self) -> dict[Hashable, Any]:
        ...
        >>> ser = pd.Series([1, 2, 3])
        >>> ser.attrs = {"A": [10, 20, 30]***REMOVED***
        >>> ser.attrs
        {'A': [10, 20, 30]***REMOVED***

        For DataFrame:

        >>> df = pd.DataFrame({'A': [1, 2], 'B': [3, 4]***REMOVED***)
        >>> df.attrs = {"A": [10, 20, 30]***REMOVED***
        >>> df.attrs
        {'A': [10, 20, 30]***REMOVED***
        """
        return self._attrs
        ...
        if dtype is not None:
            ...
            if dtype.kind == "V":
                raise NotImplementedError(
                    ...
                    f"in the {cls.__name__***REMOVED*** constructor"
    ***REMOVED***
    ...
    def _data(self):
        ...
        # GH#33333
        warnings.warn(
            f"{type(self).__name__***REMOVED***._data is deprecated and will be removed in "
    ...
    _AXIS_TO_AXIS_NUMBER: dict[Axis, AxisInt] = {0: 0, "index": 0, "rows": 0***REMOVED***
    ...
    def _construct_axes_dict(self, axes: Sequence[Axis] | None = None, **kwargs):
        ...
        d = {a: self._get_axis(a) for a in (axes or self._AXIS_ORDERS)***REMOVED***
    ...
    def _get_axis_number(cls, axis: Axis) -> AxisInt:
        try:
            ...
            raise ValueError(f"No axis named {axis***REMOVED*** for object type {cls.__name__***REMOVED***")
    ...
    def _get_axis(self, axis: Axis) -> Index:
        ...
        assert axis_number in {0, 1***REMOVED***
    ...
    def _get_axis_resolvers(self, axis: str) -> dict[str, Series | MultiIndex]:
        ...
        for i, name in enumerate(axis_index.names):
            if name is not None:
                ...
                # multiiindex
                key = f"{prefix***REMOVED***level_{i***REMOVED***"
                level = i
    ...
    def _get_index_resolvers(self) -> dict[Hashable, Series | MultiIndex]:
        ...
        d: dict[str, Series | MultiIndex] = {***REMOVED***
        for axis_name in self._AXIS_ORDERS:
            d.update(self._get_axis_resolvers(axis_name))

        return {clean_column_name(k): v for k, v in d.items() if not isinstance(k, int)***REMOVED***
    ...
    def _get_cleaned_column_resolvers(self) -> dict[Hashable, Series]:
        ...
        if isinstance(self, ABCSeries):
            return {clean_column_name(self.name): self***REMOVED***

        return {
            clean_column_name(k): Series(
                v, copy=False, index=self.index, name=k
***REMOVED***.__finalize__(self)
    ...
    def ndim(self) -> int:
        ...
        Examples
        --------
        >>> s = pd.Series({'a': 1, 'b': 2, 'c': 3***REMOVED***)
        >>> s.ndim
        1

        >>> df = pd.DataFrame({'col1': [1, 2], 'col2': [3, 4]***REMOVED***)
        >>> df.ndim
        2
        """
    ...
    def swapaxes(self, axis1: Axis, axis2: Axis, copy: bool_t | None = None) -> Self:
        ...
        warnings.warn(
            # GH#51946
            f"'{type(self).__name__***REMOVED***.swapaxes' is deprecated and "
            "will be removed in a future version. "
            f"Please use '{type(self).__name__***REMOVED***.transpose' instead.",
            FutureWarning,
            stacklevel=find_stack_level(),
        )
...
***REMOVED***
    ...
    def droplevel(self, level: IndexLabel, axis: Axis = 0) -> Self:
        """
        Return {klass***REMOVED*** with requested index / column level(s) removed.
        ...
        axis : {{0 or 'index', 1 or 'columns'***REMOVED******REMOVED***, default 0
        ...
        -------
        {klass***REMOVED***
            {klass***REMOVED*** with requested index / column level(s) removed.
    ...
    def squeeze(self, axis: Axis | None = None):
        ...
        Parameters
        ----------
        axis : {0 or 'index', 1 or 'columns', None***REMOVED***, default None
        ...
        for axis_no, replacements in enumerate((index, columns)):
            ...
            if not callable(replacements):
                ...
                if errors == "raise" and len(indexer[indexer == -1]):
                    ...
                    raise KeyError(f"{missing_labels***REMOVED*** not found in axis")
    ...
    def rename_axis(
        ...
        *,
        ...
        index, columns : scalar, list-like, dict-like or function, optional
            ...
            and/or ``columns``.
        axis : {0 or 'index', 1 or 'columns'***REMOVED***, default 0
        ...
        * ``(mapper, axis={'index', 'columns'***REMOVED***, ...)``
        ...
        **MultiIndex**
        ...
        >>> df.rename_axis(index={'type': 'class'***REMOVED***)
        limbs          num_legs  num_arms
        class  name
        mammal dog            4         0
               cat            4         0
        ...
        mammal dog            4         0
               ...
               monkey         2         2
        """
        axes = {"index": index, "columns": columns***REMOVED***
...
***REMOVED***
    ...
    ***REMOVED***
    ...
    def _set_axis_name(
        ...
        Examples
        --------
        >>> df = pd.DataFrame({"num_legs": [4, 4, 2]***REMOVED***,
        ...                   ["dog", "cat", "monkey"])
        >>> df
                num_legs
        dog            4
    ...
    def equals(self, other: object) -> bool_t:
        ...
        Examples
        --------
        >>> df = pd.DataFrame({1: [10], 2: [20]***REMOVED***)
        >>> df
            1   2
        0  10  20
        ...
        >>> exactly_equal = pd.DataFrame({1: [10], 2: [20]***REMOVED***)
        >>> exactly_equal
            1   2
        0  10  20
        ...
        >>> different_column_type = pd.DataFrame({1.0: [10], 2.0: [20]***REMOVED***)
        ...
        >>> different_data_type = pd.DataFrame({1: [10.0], 2: [20.0]***REMOVED***)
        >>> different_data_type
              1     2
        0  10.0  20.0
    ...
    def __nonzero__(self) -> NoReturn:
        raise ValueError(
            f"The truth value of a {type(self).__name__***REMOVED*** is ambiguous. "
    ...
    def bool(self) -> bool_t:
        ...
        >>> pd.DataFrame({'col': [True]***REMOVED***).bool()  # doctest: +SKIP
        True
        >>> pd.DataFrame({'col': [False]***REMOVED***).bool()  # doctest: +SKIP
        False
        ...
        warnings.warn(
            f"{type(self).__name__***REMOVED***.bool is now deprecated and will be removed "
...
***REMOVED***
            ...
            msg = (
                f"'{key***REMOVED***' is both {level_article***REMOVED*** {level_type***REMOVED*** level and "
                f"{label_article***REMOVED*** {label_type***REMOVED*** label, which is ambiguous."
***REMOVED***
    ...
    ***REMOVED***
            ...
            raise ValueError(
                f"The {label_axis_name***REMOVED*** label '{key***REMOVED***' is not unique.{multi_message***REMOVED***"
***REMOVED***
    ...
    def _drop_labels_or_levels(self, keys, axis: AxisInt = 0):
        ...
        if invalid_keys:
            raise ValueError(
                ...
                f"levels for axis {axis***REMOVED***: {invalid_keys***REMOVED***"
***REMOVED***
    ...
    def __iter__(self) -> Iterator:
        ...
        Examples
        --------
        >>> df = pd.DataFrame({'A': [1, 2, 3], 'B': [4, 5, 6]***REMOVED***)
        >>> for x in df:
        ...     print(x)
        A
        B
    ...
    def keys(self) -> Index:
        ...
        Examples
        --------
        >>> d = pd.DataFrame(data={'A': [1, 2, 3], 'B': [0, 4, 8]***REMOVED***,
        ...                  index=['a', 'b', 'c'])
        >>> d
           A  B
        a  1  0
    ...
    def empty(self) -> bool_t:
        ...
        >>> df_empty = pd.DataFrame({'A' : []***REMOVED***)
        >>> df_empty
        Empty DataFrame
        Columns: [A]
        Index: []
        ...
        >>> df = pd.DataFrame({'A' : [np.nan]***REMOVED***)
        >>> df
            A
        0 NaN
        >>> df.empty
...
***REMOVED***:
    ...
    def __getstate__(self) -> dict[str, Any]:
        meta = {k: getattr(self, k, None) for k in self._metadata***REMOVED***
        return {
            "_mgr": self._mgr,
            "_typ": self._typ,
            "_metadata": self._metadata,
            "attrs": self.attrs,
            "_flags": {k: self.flags[k] for k in self.flags._keys***REMOVED***,
            **meta,
        ***REMOVED***
    ...
    def __setstate__(self, state) -> None:
        if isinstance(state, BlockManager):
            ...
            typ = state.get("_typ")
            if typ is not None:
                attrs = state.get("_attrs", {***REMOVED***)
                if attrs is None:  # should not happen, but better be on the safe side
                    attrs = {***REMOVED***
                object.__setattr__(self, "_attrs", attrs)
                flags = state.get("_flags", {"allows_duplicate_labels": True***REMOVED***)
        ...
        self._item_cache: dict[Hashable, Series] = {***REMOVED***
    ...
    def __repr__(self) -> str:
        ...
        prepr = f"[{','.join(map(pprint_thing, self))***REMOVED***]"
        return f"{type(self).__name__***REMOVED***({prepr***REMOVED***)"
    ...
    def to_excel(
        ...
        """
        Write {klass***REMOVED*** to an Excel sheet.

        To write a single {klass***REMOVED*** to an Excel .xlsx file it is only necessary to
        ...
        freeze_panes : tuple of int (length 2), optional
            ...
            is to be frozen.
        {storage_options***REMOVED***

            .. versionadded:: {storage_options_versionadded***REMOVED***
    ...
    def to_json(
        ...
        orient : str
            ...
            * Series:
                ...
                - default is 'index'
                - allowed values are: {{'split', 'records', 'index', 'table'***REMOVED******REMOVED***.

            * DataFrame:

                - default is 'columns'
                - allowed values are: {{'split', 'records', 'index', 'columns',
                  'values', 'table'***REMOVED******REMOVED***.

            * The format of the JSON string:

                - 'split' : dict like {{'index' -> [index], 'columns' -> [columns],
                  'data' -> [values]***REMOVED******REMOVED***
                - 'records' : list like [{{column -> value***REMOVED******REMOVED***, ... , {{column -> value***REMOVED******REMOVED***]
                - 'index' : dict like {{index -> {{column -> value***REMOVED******REMOVED******REMOVED******REMOVED***
                - 'columns' : dict like {{column -> {{index -> value***REMOVED******REMOVED******REMOVED******REMOVED***
                - 'values' : just the values array
                - 'table' : dict like {{'schema': {{schema***REMOVED******REMOVED***, 'data': {{data***REMOVED******REMOVED******REMOVED******REMOVED***

                Describing the data, where data component is like ``orient='records'``.

        date_format : {{None, 'epoch', 'iso'***REMOVED******REMOVED***
    ...
    def to_hdf(
        ...
        complevel : {0-9***REMOVED***, default None
            Specifies a compression level for data.
            A value of 0 or None disables compression.
        complib : {'zlib', 'lzo', 'bzip2', 'blosc'***REMOVED***, default 'zlib'
            Specifies the compression library to be used.
            These additional compressors for Blosc are supported
            (default if no compressor specified: 'blosc:blosclz'):
            {'blosc:blosclz', 'blosc:lz4', 'blosc:lz4hc', 'blosc:snappy',
            'blosc:zlib', 'blosc:zstd'***REMOVED***.
            Specifying a compression library which is not available issues
            a ValueError.
        append : bool, default False
            For Table formats, append the input data to the existing.
        format : {'fixed', 'table', None***REMOVED***, default 'fixed'
            Possible values:
    ...
    def to_sql(
        ...
        schema : str, optional
            ...
            default schema.
        if_exists : {'fail', 'replace', 'append'***REMOVED***, default 'fail'
        ...
        method : {None, 'multi', callable***REMOVED***, optional
        ...
        >>> df = pd.DataFrame({'name' : ['User 1', 'User 2', 'User 3']***REMOVED***)
        >>> df
             name
        0  User 1
        1  User 2
        ...
        ...     df1 = pd.DataFrame({'name' : ['User 4', 'User 5']***REMOVED***)
        ...
        >>> df2 = pd.DataFrame({'name' : ['User 6', 'User 7']***REMOVED***)
        ...
        >>> df = pd.DataFrame({"A": [1, None, 2]***REMOVED***)
        >>> df
             A
        0  1.0
        1  NaN
    ...
    def to_pickle(
        ...
        Examples
        --------
        >>> original_df = pd.DataFrame({{"foo": range(5), "bar": range(5, 10)***REMOVED******REMOVED***)  # doctest: +SKIP
    ...
    def to_latex(
        ...
        Requires ``\usepackage{{booktabs***REMOVED******REMOVED***``.  The output can be copy/pasted
        into a main LaTeX document or read from an external file
        with ``\input{{table.tex***REMOVED******REMOVED***``.
        ...
        na_rep : str, default 'NaN'
            Missing data representation.
        formatters : list of functions or dict of {{str: function***REMOVED******REMOVED***, optional
            Formatter functions to apply to columns' elements by position or
            name. The result of each function must be a unicode string.
            List must be of length equal to the number of columns.
        float_format : one-parameter function or str, optional, default None
            Formatter for floating point numbers. For example
            ``float_format="%.2f"`` and ``float_format="{{:0.2f***REMOVED******REMOVED***".format`` will
        ...
        longtable : bool, optional
            ...
            adding a \usepackage{{longtable***REMOVED******REMOVED*** to your LaTeX preamble.
        ...
        multirow : bool, default True
            ...
            \usepackage{{multirow***REMOVED******REMOVED*** to your LaTeX preamble. Will print
        ...
        caption : str or tuple, optional
            ...
            which results in ``\caption[short_caption]{{full_caption***REMOVED******REMOVED***``;
            if a single string is passed, no short caption will be set.
        label : str, optional
            The LaTeX label to be placed inside ``\label{{***REMOVED******REMOVED***`` in the output.
            This is used with ``\ref{{***REMOVED******REMOVED***`` in the main ``.tex`` file.

        position : str, optional
            The LaTeX positional argument for tables, to be placed after
            ``\begin{{***REMOVED******REMOVED***`` in the output.
        ...
        ...                   formatters={"name": str.upper***REMOVED***,
        ...                   float_format="{:.1f***REMOVED***".format,
        ... ))  # doctest: +SKIP
        \begin{tabular***REMOVED***{lrr***REMOVED***
        \toprule
        name & age & height \\
        \midrule
        RAPHAEL & 26 & 181.2 \\
        ...
        if isinstance(header, (list, tuple)) and len(header) != length:
            raise ValueError(f"Writing {length***REMOVED*** cols but got {len(header)***REMOVED*** aliases")
        ...
        base_format_ = {
            ...
            "decimal": decimal,
        ***REMOVED***
        index_format_: dict[str, Any] = {"axis": 0, **base_format_***REMOVED***
        column_format_: dict[str, Any] = {"axis": 1, **base_format_***REMOVED***
        ...
        if isinstance(formatters, list):
            ...
            ***REMOVED***
            ...
            if index_formatter is not None:
                index_format_.update({"formatter": index_formatter***REMOVED***)
            if column_formatter is not None:
                column_format_.update({"formatter": column_formatter***REMOVED***)

            formatters_ = formatters
            float_columns = self.select_dtypes(include="float").columns
            for col in float_columns:
                if col not in formatters.keys():
                    formatters_.update({col: float_format_***REMOVED***)
...
***REMOVED***
        if header is False:
            hide_.append({"axis": "columns"***REMOVED***)
        elif isinstance(header, (list, tuple)):
            relabel_index_.append({"labels": header, "axis": "columns"***REMOVED***)
            format_index_ = [index_format_]  # column_format is overwritten

        if index is False:
            hide_.append({"axis": "index"***REMOVED***)
        if index_names is False:
            hide_.append({"names": True, "axis": "index"***REMOVED***)
        ...
        render_kwargs_ = {
            ...
            if multicolumn
            else f"naive-{multicolumn_format***REMOVED***",
        ...
        ***REMOVED***
        ...
        return self._to_latex_via_styler(
            ...
            format={"formatter": formatters_, **base_format_***REMOVED***,
    ...
    def _to_latex_via_styler(
        ...
        *,
        ...
        render_kwargs = {***REMOVED*** if render_kwargs is None else render_kwargs
    ...
    def to_csv(
        ...
        mode : {{'w', 'x', 'a'***REMOVED******REMOVED***, default 'w'
        ...
        ...                    'mask': ['red', 'purple'],
        ...                    'weapon': ['sai', 'bo staff']***REMOVED******REMOVED***)
    ...
    def take(self, indices, axis: Axis = 0, **kwargs) -> Self:
        ...
        axis : {0 or 'index', 1 or 'columns', None***REMOVED***, default 0
...
***REMOVED***:
            ...
            raise TypeError(
                f"{type(self).__name__***REMOVED***.take requires a sequence of integers, "
                "not slice."
***REMOVED***
        else:
            warnings.warn(
                # GH#51539
                f"Passing a slice to {type(self).__name__***REMOVED***.take is deprecated "
...
***REMOVED***
    ...
    def xs(
        ...
        ...      'locomotion': ['walks', 'walks', 'flies', 'walks']***REMOVED***
...
***REMOVED***
    ...
    def reindex_like(
        ...
        other : Object of the same data type
            ...
            of this object.
        method : {None, 'backfill'/'bfill', 'pad'/'ffill', 'nearest'***REMOVED***
    ...
    def drop(
        ...
        *,
        ...
        if labels is not None:
            ...
            axes = {axis_name: labels***REMOVED***
        elif index is not None or columns is not None:
            axes = {"index": index***REMOVED***
            if self.ndim == 2:
...
***REMOVED***
    ...
    def _drop_axis(
        ...
        level : int or level name, default None
            For MultiIndex
        errors : {'ignore', 'raise'***REMOVED***, default 'raise'
        ...
        # Case for non-unique axis
            ...
            if level is not None:
                ...
                if errors == "raise" and mask.all():
                    raise KeyError(f"{labels***REMOVED*** not found in axis")
            elif (
...
***REMOVED***:
    ...
    def add_prefix(self, prefix: str, axis: Axis | None = None) -> Self:
        ...
        >>> df = pd.DataFrame({'A': [1, 2, 3, 4], 'B': [3, 4, 5, 6]***REMOVED***)
        >>> df
           A  B
        0  1  3
        1  2  4
        ...
        3       4       6
        """
        f = lambda x: f"{prefix***REMOVED***{x***REMOVED***"

        axis_name = self._info_axis_name
        if axis is not None:
            axis_name = self._get_axis_name(axis)

        mapper = {axis_name: f***REMOVED***
    ...
    def add_suffix(self, suffix: str, axis: Axis | None = None) -> Self:
        ...
        3       4       6
        """
        f = lambda x: f"{x***REMOVED***{suffix***REMOVED***"
    ...
    def sort_values(
        ...
        *,
        ...
        kind : {'quicksort', 'mergesort', 'heapsort', 'stable'***REMOVED***, default 'quicksort'
             Choice of sorting algorithm. See also :func:`numpy.sort` for more
             information. `mergesort` and `stable` are the only stable algorithms. For
             DataFrames, this option is only applied when sorting on a single
             column or label.
        na_position : {'first', 'last'***REMOVED***, default 'last'
    ...
    def reindex(
        ...
        *,
        ...
        """
        Conform {klass***REMOVED*** to new index with optional filling logic.
        ...
        Parameters
        ----------
        {optional_reindex***REMOVED***
        method : {{None, 'backfill'/'bfill', 'pad'/'ffill', 'nearest'***REMOVED******REMOVED***
            Method to use for filling holes in reindexed DataFrame.
            Please note: this is only applicable to DataFrames/Series with a
            monotonically increasing/decreasing index.
        ...
        Returns
        -------
        {klass***REMOVED*** with changed index.
        ...
        * ``(labels, axis={{'index', 'columns'***REMOVED******REMOVED***, ...)``
        ...
        ...                   'response_time': [0.04, 0.02, 0.07, 0.08, 1.0]***REMOVED******REMOVED***,
        ...                   index=index)
        >>> df
        ...
        >>> df2 = pd.DataFrame({{"prices": [100, 101, np.nan, 100, 89, 88]***REMOVED******REMOVED***,
        ...                    index=date_index)
        >>> df2
                    prices
        2010-01-01   100.0
...
***REMOVED***
            ...
            obj = obj._reindex_with_indexers(
                {axis: [new_index, indexer]***REMOVED***,
...
***REMOVED***
        ...
        if items is not None:
            ...
            # error: Keywords must be strings
            return self.reindex(**{name: items***REMOVED***)  # type: ignore[misc]
        elif like:
    ...
    def head(self, n: int = 5) -> Self:
        ...
        ...                    'monkey', 'parrot', 'shark', 'whale', 'zebra']***REMOVED***)
        >>> df
              animal
        0  alligator
        1        bee
    ...
    def sample(
        ...
        ...                    'num_wings': [2, 0, 0, 0],
        ...                    'num_specimen_seen': [10, 2, 1, 8]***REMOVED***,
    ...
    def pipe(
        ...
        **kwargs,
        ...
        ----------
        func : function
            Function to apply to the {klass***REMOVED***.
            ``args``, and ``kwargs`` are passed into ``func``.
            Alternatively a ``(callable, data_keyword)`` tuple where
            ``data_keyword`` is a string indicating the keyword of
            ``callable`` that expects the {klass***REMOVED***.
...
***REMOVED***
    ...
    def astype(
        ...
        dtype : str, data type, Series or Mapping of column name -> data type
            ...
            mapping, e.g. {col: dtype, ...***REMOVED***, where col is a column label and dtype is
        ...
        copy : bool, default True
            ...
            .. note::
                ...
                You can already get the future behavior and improvements through
                enabling copy on write ``pd.options.mode.copy_on_write = True``
        errors : {'raise', 'ignore'***REMOVED***, default 'raise'
        ...
        >>> df.astype({'col1': 'int32'***REMOVED***).dtypes
        col1    int32
        col2    int64
        dtype: object
            ...
            for col_name in dtype_ser.index:
                if col_name not in self:
                    raise KeyError(
                        ...
                        f"'{col_name***REMOVED***' not found in columns."
        ***REMOVED***
            ...
            for i, (col_name, col) in enumerate(self.items()):
                ...
                if isna(cdt):
                    ...
                    try:
                        ...
                        ex.args = (
                            f"{ex***REMOVED***: Error while type casting for column '{col_name***REMOVED***'",
            ***REMOVED***
                        raise
...
***REMOVED***:
    ...
    def infer_objects(self, copy: bool_t | None = None) -> Self:
        ...
        Examples
        --------
        >>> df = pd.DataFrame({"A": ["a", 1, 2, 3]***REMOVED***)
        >>> df = df.iloc[1:]
        >>> df
           A
        1  1
    ...
    def convert_dtypes(
        ...
        dtype_backend : {'numpy_nullable', 'pyarrow'***REMOVED***, default 'numpy_nullable'
    ...
    def _deprecate_downcast(self, downcast, method_name: str):
        ...
        if downcast is not lib.no_default:
            warnings.warn(
                f"The 'downcast' keyword in {method_name***REMOVED*** is deprecated and "
    ...
    def fillna(
        ...
        *,
        ...
        value : scalar, dict, Series, or DataFrame
            ...
            be a list.
        method : {{'backfill', 'bfill', 'ffill', None***REMOVED******REMOVED***, default None
        ...
        >>> values = {{"A": 0, "B": 1, "C": 2, "D": 3***REMOVED******REMOVED***
...
***REMOVED***:
        ...
        ***REMOVED***
        ...
        if method is not None:
            warnings.warn(
                f"{type(self).__name__***REMOVED***.fillna with 'method' is deprecated and "
...
***REMOVED***
    ...
    ***REMOVED***
        ...
        ***REMOVED***
                ...
                raise ValueError(f"invalid fill value with a {type(value)***REMOVED***")
    ...
    def ffill(
        ...
        *,
        ...
        limit : int, default None
            ...
            maximum number of entries along the entire axis where NaNs will be
            filled. Must be greater than 0 if not None.
        limit_area : {{`None`, 'inside', 'outside'***REMOVED******REMOVED***, default None
...
***REMOVED***:
    ...
    def pad(
        ...
        *,
        ...
        .. deprecated:: 2.0
            ...
            {klass***REMOVED***.pad is deprecated. Use {klass***REMOVED***.ffill instead.
    ...
    def bfill(
        ...
        *,
        ...
        >>> df = pd.DataFrame({{'A': [1, None, None, 4], 'B': [None, 5, None, 7]***REMOVED******REMOVED***)
        >>> df
              A     B
        0   1.0	  NaN
        1   NaN	  5.0
    ...
    def backfill(
        ...
        *,
        ...
        .. deprecated:: 2.0
            ...
            {klass***REMOVED***.backfill is deprecated. Use {klass***REMOVED***.bfill instead.
    ...
    def replace(
        ...
        *,
        ...
        if method is not lib.no_default:
            warnings.warn(
                # GH#33302
                f"The 'method' keyword in {type(self).__name__***REMOVED***.replace is "
...
***REMOVED***
            ...
            warnings.warn(
                # GH#33302
                f"The 'limit' keyword in {type(self).__name__***REMOVED***.replace is "
                "deprecated and will be removed in a future version.",
                FutureWarning,
                stacklevel=find_stack_level(),
***REMOVED***
        if (
            ...
            warnings.warn(
                # GH#33302
                f"{type(self).__name__***REMOVED***.replace without 'value' and with "
...
***REMOVED***
        ...
        if not (
            ...
            raise TypeError(
                ...
                f"{repr(type(to_replace).__name__)***REMOVED***"
***REMOVED***
...
***REMOVED***
            ...
            if is_dict_like(to_replace):
                if is_dict_like(value):  # {'A' : NA***REMOVED*** -> {'A' : 0***REMOVED***
            ...
            ***REMOVED***
                ...
                if len(to_replace) != len(value):
                    raise ValueError(
                        ...
                        f"Expecting {len(to_replace)***REMOVED*** got {len(value)***REMOVED*** "
        ***REMOVED***
    ...
    ***REMOVED***:
                    raise TypeError(
                        ...
                        f"you passed a {repr(type(regex).__name__)***REMOVED***"
        ***REMOVED***
                return self.replace(
    ...
    ***REMOVED***
                ...
                if is_dict_like(value):  # NA -> {'A' : 0, 'B' : -1***REMOVED***
                    # Operate column-wise
                    if self.ndim == 1:
                        raise ValueError(
                            ...
                            "non-None to_replace"
            ***REMOVED***
                    mapping = {col: (to_replace, val) for col, val in value.items()***REMOVED***
                    return self._replace_columnwise(mapping, inplace, regex)
            ...
            ***REMOVED***
                    ...
                    raise TypeError(
                        f'Invalid "to_replace" type: {repr(type(to_replace).__name__)***REMOVED***'
        ***REMOVED***
    ...
    def interpolate(
        ...
        **kwargs,
        ...
        axis : {{0 or 'index', 1 or 'columns', None***REMOVED******REMOVED***, default None
        ...
        limit_direction : {{'forward', 'backward', 'both'***REMOVED******REMOVED***, Optional
        ...
        if downcast is not lib.no_default:
            # GH#40988
            warnings.warn(
                f"The 'downcast' keyword in {type(self).__name__***REMOVED***.interpolate "
...
***REMOVED***:
        ...
        ***REMOVED***
        ...
        if method.lower() in fillna_methods:
            # GH#53581
            warnings.warn(
                f"{type(self).__name__***REMOVED***.interpolate with method={method***REMOVED*** is "
...
***REMOVED***
            ...
            if np.any(obj.dtypes == object):
                ...
                if not (obj.ndim == 2 and np.all(obj.dtypes == object)):
                    ...
                    warnings.warn(
                        f"{type(self).__name__***REMOVED***.interpolate with object dtype is "
        ...
        ***REMOVED***
        ...
        if method in fillna_methods and "fill_value" in kwargs:
            raise ValueError(
                ...
                f"{type(self).__name__***REMOVED***.interpolate with method from "
                f"{fillna_methods***REMOVED***"
***REMOVED***
...
***REMOVED***
    ...
    def asof(self, where, subset=None):
        ...
        ...                    'b': [None, None, None, None, 500]***REMOVED***,
    ...
    ***REMOVED***
    ...
    def isna(self) -> Self:
        ...
        -------
        {klass***REMOVED***
            Mask of bool values for each element in {klass***REMOVED*** that
            indicates whether an element is an NA value.

        See Also
        --------
        {klass***REMOVED***.isnull : Alias of isna.
        {klass***REMOVED***.notna : Boolean inverse of isna.
        {klass***REMOVED***.dropna : Omit axes labels with missing values.
        isna : Top-level isna.
    ...
    def notna(self) -> Self:
        ...
        See Also
        --------
        {klass***REMOVED***.notnull : Alias of notna.
        {klass***REMOVED***.isna : Boolean inverse of notna.
        {klass***REMOVED***.dropna : Omit axes labels with missing values.
...
***REMOVED***  # type: ignore[assignment]
    ...
    def clip(
        ...
        *args, **kwargs
        ...
        Examples
        --------
        >>> data = {'col_0': [9, -3, 0, -1, 5], 'col_1': [-2, -7, 6, 8, -5]***REMOVED***
...
***REMOVED***
    ...
    def asfreq(
        ...
        If the index of this {klass***REMOVED*** is a :class:`~pandas.PeriodIndex`, the new index
        ...
        method : {{'backfill'/'bfill', 'pad'/'ffill'***REMOVED******REMOVED***, default None
        ...
        how : {{'start', 'end'***REMOVED******REMOVED***, default end
        ...
        -------
        {klass***REMOVED***
            {klass***REMOVED*** object reindexed to the specified frequency.
        ...
        >>> df = pd.DataFrame({{'s': series***REMOVED******REMOVED***)
        >>> df
                               s
    ...
    def at_time(self, time, asof: bool_t = False, axis: Axis | None = None) -> Self:
        ...
        >>> ts = pd.DataFrame({'A': [1, 2, 3, 4]***REMOVED***, index=i)
        >>> ts
                             A
    ...
    def between_time(
        ...
        inclusive : {"both", "neither", "left", "right"***REMOVED***, default "both"
    ...
    def resample(
        ...
        closed : {{'right', 'left'***REMOVED******REMOVED***, default None
            Which side of bin interval is closed. The default is 'left'
            for all frequency offsets except for 'ME', 'YE', 'QE', 'BME',
            'BA', 'BQE', and 'W' which all have a default of 'right'.
        label : {{'right', 'left'***REMOVED******REMOVED***, default None
            Which bin edge label to label bucket with. The default is 'left'
            for all frequency offsets except for 'ME', 'YE', 'QE', 'BME',
            'BA', 'BQE', and 'W' which all have a default of 'right'.
        convention : {{'start', 'end', 's', 'e'***REMOVED******REMOVED***, default 'start'
            For `PeriodIndex` only, controls whether to use the start or
            end of `rule`.

            .. deprecated:: 2.2.0
                Convert PeriodIndex to DatetimeIndex before resampling instead.
        kind : {{'timestamp', 'period'***REMOVED******REMOVED***, optional, default None
        ...
        groupby : Group {klass***REMOVED*** by mapping, function, label, or list of labels.
        asfreq : Reindex a {klass***REMOVED*** with the given frequency without grouping.
        ...
        ...      'volume': [50, 60, 40, 100, 50, 100, 40, 50]***REMOVED******REMOVED***
        >>> df = pd.DataFrame(d)
    ...
    ***REMOVED***
                ...
                warnings.warn(
                    f"The 'axis' keyword in {type(self).__name__***REMOVED***.resample is "
                    "deprecated and will be removed in a future version.",
                    FutureWarning,
                    stacklevel=find_stack_level(),
    ***REMOVED***
        ...
        if kind is not lib.no_default:
            # GH#55895
            warnings.warn(
                f"The 'kind' keyword in {type(self).__name__***REMOVED***.resample is "
                "deprecated and will be removed in a future version. "
...
***REMOVED***
        ...
        if convention is not lib.no_default:
            warnings.warn(
                f"The 'convention' keyword in {type(self).__name__***REMOVED***.resample is "
                "deprecated and will be removed in a future version. "
...
***REMOVED***
    ...
    def rank(
        ...
        axis : {0 or 'index', 1 or 'columns'***REMOVED***, default 0
            ...
            For `Series` this parameter is unused and defaults to 0.
        method : {'average', 'min', 'max', 'first', 'dense'***REMOVED***, default 'average'
        ...
        na_option : {'keep', 'top', 'bottom'***REMOVED***, default 'keep'
        ...
        ...                                    'spider', 'snake'],
        ...                         'Number_legs': [4, 2, 4, 8, np.nan]***REMOVED***)
        >>> df
            Animal  Number_legs
        0      cat          4.0
        1  penguin          2.0
        ...
        * pct_rank: when setting ``pct = True``, the ranking is expressed as
        ...
        if na_option not in {"keep", "top", "bottom"***REMOVED***:
    ...
    ***REMOVED***
    ...
    def compare(
        ...
        if type(self) is not type(other):
            ...
            raise TypeError(
                f"can only compare '{cls_self***REMOVED***' (not '{cls_other***REMOVED***') with '{cls_self***REMOVED***'"
***REMOVED***
        ...
        if not isinstance(result_names, tuple):
            raise TypeError(
                f"Passing 'result_names' as a {type(result_names)***REMOVED*** is not "
...
***REMOVED***
    ...
    def align(
        ...
        join : {{'outer', 'inner', 'left', 'right'***REMOVED******REMOVED***, default 'outer'
        ...
        fill_value : scalar, default np.nan
            Value to use for missing values. Defaults to NaN, but can be any
            "compatible" value.
        method : {{'backfill', 'bfill', 'pad', 'ffill', None***REMOVED******REMOVED***, default None
            Method to use for filling holes in reindexed Series:
        ...
        fill_axis : {axes_single_arg***REMOVED***, default 0
            Filling axis, method and limit.

            .. deprecated:: 2.1

        broadcast_axis : {axes_single_arg***REMOVED***, default None
        ...
        Returns
        -------
        tuple of ({klass***REMOVED***, type of other)
            Aligned objects.
        ...
        if (
            ...
            warnings.warn(
                ...
                f"{type(self).__name__***REMOVED***.align are deprecated and will be removed "
...
***REMOVED***
        ...
        if broadcast_axis is not lib.no_default:
            ...
            msg = (
                f"The 'broadcast_axis' keyword in {type(self).__name__***REMOVED***.align is "
                "deprecated and will be removed in a future version."
***REMOVED***
            if broadcast_axis is not None:
                if self.ndim == 1 and other.ndim == 2:
                    msg += (
                        " Use left = DataFrame({col: left for col in right.columns***REMOVED***, "
                        "index=right.index) before calling `left.align(right)` instead."
        ***REMOVED***
                elif self.ndim == 2 and other.ndim == 1:
                    msg += (
                        " Use right = DataFrame({col: right for col in left.columns***REMOVED***, "
        ...
        ***REMOVED***
        ...
        if broadcast_axis == 1 and self.ndim != other.ndim:
            if isinstance(self, ABCSeries):
                ...
                df = cons(
                    {c: self for c in other.columns***REMOVED***, **other._construct_axes_dict()
    ***REMOVED***
    ...
    ***REMOVED***[:2]
                ...
                df = cons(
                    {c: other for c in self.columns***REMOVED***, **self._construct_axes_dict()
    ***REMOVED***
...
***REMOVED***
            ...
            raise TypeError(f"unsupported type: {type(other)***REMOVED***")
...
***REMOVED***
        ...
        if is_series:
            reindexers = {0: [join_index, ilidx]***REMOVED***
        else:
            reindexers = {0: [join_index, ilidx], 1: [join_columns, clidx]***REMOVED***
        ...
        right = other._reindex_with_indexers(
            {0: [join_index, iridx], 1: [join_columns, cridx]***REMOVED***,
            copy=copy,
            fill_value=fill_value,
            allow_dups=True,
        )
        ...
        if isinstance(cond, NDFrame):
            ...
            if cond.ndim == 1 and self.ndim == 2:
                cond = cond._constructor_expanddim(
                    {i: cond for i in range(len(self.columns))***REMOVED***,
                    copy=False,
    ***REMOVED***
...
***REMOVED***
        ...
        msg = "Boolean array expected for the condition, not {dtype***REMOVED***"
...
***REMOVED***
    ...
    def where(
        ...
        *,
        ...
        """
        Replace values where the condition is {cond_rev***REMOVED***.

        Parameters
        ----------
        cond : bool {klass***REMOVED***, array-like, or callable
            Where `cond` is {cond***REMOVED***, keep the original value. Where
            {cond_rev***REMOVED***, replace with corresponding value from `other`.
            If `cond` is callable, it is computed on the {klass***REMOVED*** and
            should return boolean {klass***REMOVED*** or array. The callable must
            not change input {klass***REMOVED*** (though pandas doesn't check it).
        other : scalar, {klass***REMOVED***, or callable
            Entries where `cond` is {cond_rev***REMOVED*** are replaced with
            corresponding value from `other`.
            If other is callable, it is computed on the {klass***REMOVED*** and
            should return scalar or {klass***REMOVED***. The callable must not
            change input {klass***REMOVED*** (though pandas doesn't check it).
        ...
        See Also
        --------
        :func:`DataFrame.{name_other***REMOVED***` : Return an object of same shape as
            self.

        Notes
        -----
        The {name***REMOVED*** method is an application of the if-then idiom. For each
        element in the calling DataFrame, if ``cond`` is ``{cond***REMOVED***`` the
        element is used; otherwise the corresponding element from the DataFrame
        ``other`` is used. If the axis of ``other`` does not align with axis of
        ``cond`` {klass***REMOVED***, the misaligned index positions will be filled with
        {cond_rev***REMOVED***.
        ...
        For further details and examples see the ``{name***REMOVED***`` documentation in
...
***REMOVED***:
    ...
    def shift(
        ...
        ...                    "Col2": [13, 23, 18, 33, 48],
        ...                    "Col3": [17, 27, 22, 37, 52]***REMOVED******REMOVED***,
...
***REMOVED***.__finalize__(self, method="shift")
    ...
    def _shift_with_freq(self, periods: int, axis: int, freq) -> Self:
        ...
        if isinstance(index, PeriodIndex):
            ...
            if freq != orig_freq:
                ...
                raise ValueError(
                    f"Given freq {freq_to_period_freqstr(freq.n, freq.name)***REMOVED*** "
                    f"does not match PeriodIndex freq "
                    f"{freq_to_period_freqstr(orig_freq.n, orig_freq.name)***REMOVED***"
    ***REMOVED***
    ...
    def truncate(
        ...
        axis : {0 or 'index', 1 or 'columns'***REMOVED***, optional
        ...
        >>> df = pd.DataFrame(index=dates, data={'A': 1***REMOVED***)
        >>> df.tail()
                             A
        ...
        if before is not None and after is not None and before > after:
            raise ValueError(f"Truncate: {after***REMOVED*** must be after {before***REMOVED***")
        ...
        def _tz_convert(ax, tz):
            if not hasattr(ax, "tz_convert"):
                if len(ax) > 0:
                    ...
                    raise TypeError(
                        f"{ax_name***REMOVED*** is not a valid DatetimeIndex or PeriodIndex"
        ***REMOVED***
        ...
        if isinstance(ax, MultiIndex):
            ...
            if level not in (None, 0, ax.name):
                raise ValueError(f"The level {level***REMOVED*** is not valid")
...
***REMOVED***
    ...
    def pct_change(
        ...
        **kwargs,
        ...
        fill_method : {'backfill', 'bfill', 'pad', 'ffill', None***REMOVED***, default 'pad'
        ...
        **DataFrame**
        ...
        ...     'IT': [804.74, 810.01, 860.13]***REMOVED***,
        ...
        if fill_method not in (lib.no_default, None) or limit is not lib.no_default:
            warnings.warn(
                ...
                f"{type(self).__name__***REMOVED***.pct_change are deprecated and will be removed "
                ...
                for _, col in cols:
                    ...
                    if mask.any():
                        warnings.warn(
                            ...
                            f"{type(self).__name__***REMOVED***.pct_change is deprecated and will "
    ...
    def _stat_function_ddof(
        ...
        **kwargs,
        ...
        if axis is None:
            if self.ndim > 1:
                warnings.warn(
                    f"The behavior of {type(self).__name__***REMOVED***.{name***REMOVED*** with axis=None "
    ...
    ***REMOVED***
    ...
    def rolling(
        ...
        if axis is not lib.no_default:
            ...
            if axis == 1:
                warnings.warn(
                    f"Support for axis=1 in {type(self).__name__***REMOVED***.{name***REMOVED*** is "
                    "deprecated and will be removed in a future version. "
                    f"Use obj.T.{name***REMOVED***(...) instead",
                    FutureWarning,
                    stacklevel=find_stack_level(),
    ***REMOVED***
            else:
                warnings.warn(
                    f"The 'axis' keyword in {type(self).__name__***REMOVED***.{name***REMOVED*** is "
                    "deprecated and will be removed in a future version. "
...
***REMOVED***
    ...
    def first_valid_index(self) -> Hashable | None:
        """
        Return index for {position***REMOVED*** non-NA value or None, if no non-NA value is found.
        ...
        >>> df = pd.DataFrame({{'A': [None, None, 2], 'B': [None, 3, 4]***REMOVED******REMOVED***)
        >>> df
             A      B
        0  NaN    NaN
        1  NaN    3.0
        ...
        >>> df = pd.DataFrame({{'A': [None, None, None], 'B': [None, None, None]***REMOVED******REMOVED***)
        >>> df
             A      B
        0  None   None
        1  None   None
...
axis : {axis_descr***REMOVED***
    ...
    .. warning::
        ...
        The behavior of DataFrame.{name***REMOVED*** with ``axis=None`` is deprecated,
...
Returns
-------
{name1***REMOVED*** or {name2***REMOVED*** (if level specified) \
{notes***REMOVED***\
{examples***REMOVED***
"""
...
...                    'age': [21, 25, 62, 43],
...                    'height': [1.61, 1.87, 1.49, 2.01]***REMOVED***
...       ***REMOVED***.set_index('person_id')
>>> df
           age  height
person_id
0           21    1.61
...
Parameters
----------
axis : {{0 or 'index', 1 or 'columns', None***REMOVED******REMOVED***, default 0
...
skipna : bool, default True
    ...
    True, then the result will be {empty_value***REMOVED***, as for an empty row/column.
...
Returns
-------
{name1***REMOVED*** or {name2***REMOVED***
    If level is specified, then, {name2***REMOVED*** is returned; otherwise, {name1***REMOVED***
    is returned.
...
>>> df = pd.DataFrame({'col1': [True, True], 'col2': [True, False]***REMOVED***)
>>> df
   col1   col2
0  True   True
1  True  False
...
_cnum_doc = """
Return cumulative {desc***REMOVED*** over a DataFrame or Series axis.
...
-------
{name1***REMOVED*** or {name2***REMOVED***
    Return cumulative {desc***REMOVED*** of {name1***REMOVED*** or {name2***REMOVED***.

See Also
--------
core.window.expanding.Expanding.{accum_func_name***REMOVED*** : Similar functionality
    but ignores ``NaN`` values.
{name2***REMOVED***.{accum_func_name***REMOVED*** : Return the {desc***REMOVED*** over
    {name2***REMOVED*** axis.
{name2***REMOVED***.cummax : Return cumulative maximum over {name2***REMOVED*** axis.
{name2***REMOVED***.cummin : Return cumulative minimum over {name2***REMOVED*** axis.
{name2***REMOVED***.cumsum : Return cumulative sum over {name2***REMOVED*** axis.
{name2***REMOVED***.cumprod : Return cumulative product over {name2***REMOVED*** axis.
...
>>> df = pd.DataFrame({"A": [1, 2], "B": [0, 2], "C": [0, 0]***REMOVED***)
>>> df
   A  B  C
0  1  0  0
1  2  2  0
...
>>> df = pd.DataFrame({"A": [True, False], "B": [1, 2]***REMOVED***)
>>> df
       A  B
0   True  1
1  False  2
...
>>> df = pd.DataFrame({"A": [True, False], "B": [1, 0]***REMOVED***)
>>> df
       A  B
0   True  1
1  False  0
...
def make_doc(name: str, ndim: int) -> str:
    ...
    if ndim == 1:
        name1 = "scalar"
        name2 = "Series"
        axis_descr = "{index (0)***REMOVED***"
    else:
        name1 = "Series"
        name2 = "DataFrame"
        axis_descr = "{index (0), columns (1)***REMOVED***"
    ...
    if name == "any":
        ...
        kwargs = {"empty_value": "False"***REMOVED***
    elif name == "all":
        base_doc = _bool_doc
        desc = _all_desc
        see_also = _all_see_also
        examples = _all_examples
        kwargs = {"empty_value": "True"***REMOVED***
    elif name == "min":
        base_doc = _num_doc
        desc = (
        ...
        kwargs = {"min_count": _min_count_stub***REMOVED***
        ...
        examples = """
            ...
            >>> df = pd.DataFrame({'a': [1, 2], 'b': [2, 3]***REMOVED***, index=['tiger', 'zebra'])
            >>> df
                   a   b
            tiger  1   2
            zebra  2   3
            ...
            >>> df = pd.DataFrame({'a': [1, 2], 'b': ['T', 'Z']***REMOVED***,
            ...                   index=['tiger', 'zebra'])
        ...
        see_also = ""
        kwargs = {"notes": _std_notes***REMOVED***
        ...
        examples = """
            ...
            >>> df = pd.DataFrame({'a': [1, 2, 3], 'b': [2, 3, 4], 'c': [1, 3, 5]***REMOVED***,
            ...
            >>> df = pd.DataFrame({'a': [1, 2, 3], 'b': ['T', 'Z', 'X']***REMOVED***,
            ...                   index=['tiger', 'zebra', 'cow'])
        ...
        examples = """
            ...
            >>> df = pd.DataFrame({'a': [1, 2, 2, 3], 'b': [3, 4, 4, 4]***REMOVED***,
            ...
            >>> df = pd.DataFrame({'a': [1, 2], 'b': [3, 4], 'c': [3, 4], 'd': [1, 2]***REMOVED***,
            ...                   index=['cat', 'dog'])
            >>> df.kurt(axis=1)
            cat   -6.0
            dog   -6.0
        ...
        kwargs = {"accum_func_name": "sum"***REMOVED***
        ...
        kwargs = {"accum_func_name": "prod"***REMOVED***
        ...
        kwargs = {"accum_func_name": "min"***REMOVED***
        ...
        kwargs = {"accum_func_name": "max"***REMOVED***
