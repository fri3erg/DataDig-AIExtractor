    ...
    def load_comments(self, soup_info: Any) -> List[Document]:
        ...
        return [
            Document(
                ...
                metadata={"source": self.web_path, "title": title***REMOVED***,
***REMOVED***
    ...
    def load_results(self, soup: Any) -> List[Document]:
        ...
        for lineItem in items:
            ...
            link = lineItem.find("span", {"class": "titleline"***REMOVED***).find("a").get("href")
            title = lineItem.find("span", {"class": "titleline"***REMOVED***).text.strip()
            metadata = {
