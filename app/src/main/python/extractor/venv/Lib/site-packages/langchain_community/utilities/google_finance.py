...
***REMOVED***
    ...
    def run(self, query: str) -> str:
        ...
        ***REMOVED***
        ...
        markets = total_results.get("markets", {***REMOVED***)
        res = "\nQuery: " + query + "\n"
        ...
        if "futures_chain" in total_results:
            ...
            res += (
                f"stock: {stock***REMOVED***\n"
                + f"price: {price***REMOVED***\n"
                + f"percentage: {percentage***REMOVED***\n"
                + f"movement: {movement***REMOVED***\n"
***REMOVED***
