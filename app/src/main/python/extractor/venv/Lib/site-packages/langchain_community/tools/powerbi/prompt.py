...
The following tables exist: {tables***REMOVED***
...
USER_INPUT = """
Question: {tool_input***REMOVED***
DAX: 
"""

SINGLE_QUESTION_TO_QUERY = f"{QUESTION_TO_QUERY_BASE***REMOVED***{USER_INPUT***REMOVED***"
...
RETRY_RESPONSE = (
    "{tool_input***REMOVED*** DAX: {query***REMOVED*** Error: {error***REMOVED***. Please supply a new DAX query."
)
BAD_REQUEST_RESPONSE = "Error on this question, the error was {error***REMOVED***, you can try to rephrase the question."
