...
class MessagesPlaceholder(BaseMessagePromptTemplate):
    ...
    def format_messages(self, **kwargs: Any) -> List[BaseMessage]:
        ...
        if not isinstance(value, list):
            raise ValueError(
                f"variable {self.variable_name***REMOVED*** should be a list of base messages, "
                f"got {value***REMOVED***"
***REMOVED***
        for v in value:
        ...
        **kwargs: Any,
        ...
        Args:
            ...
            partial_variables: A dictionary of variables that can be used to partially
                              ...
                              `"{variable1***REMOVED*** {variable2***REMOVED***"`, and `partial_variables` is
                              `{"variable1": "foo"***REMOVED***`, then the final prompt will be
                              `"foo {variable2***REMOVED***"`.
...
class BaseChatPromptTemplate(BasePromptTemplate, ABC):
    ...
    def lc_attributes(self) -> Dict:
        ...
        constructor.
        """
        return {"input_variables": self.input_variables***REMOVED***
    ...
    Examples:
        ...
        .. code-block:: python
            ...
            template = ChatPromptTemplate.from_messages([
                ("system", "You are a helpful AI bot. Your name is {name***REMOVED***."),
                ("human", "Hello, how are you doing?"),
                ("ai", "I'm doing well, thanks!"),
                ("human", "{user_input***REMOVED***"),
            ])
...
***REMOVED***
    ...
    def __add__(self, other: Any) -> ChatPromptTemplate:
        ...
        if isinstance(other, ChatPromptTemplate):
            ...
            raise NotImplementedError(f"Unsupported operand type for +: {type(other)***REMOVED***")
    ...
    def validate_input_variables(cls, values: dict) -> dict:
        ...
        input_vars = set()
        input_types: Dict[str, Any] = values.get("input_types", {***REMOVED***)
        ...
        if "input_variables" in values and values.get("validate_template"):
            if input_vars != set(values["input_variables"]):
                raise ValueError(
                    ...
                    f"Expected: {input_vars***REMOVED***. "
                    f"Got: {values['input_variables']***REMOVED***"
    ***REMOVED***
        else:
    ...
    def from_messages(
        ...
        Args:
            messages: sequence of message representations.
                  ...
                  (message type, template); e.g., ("human", "{user_input***REMOVED***"),
                  (4) 2-tuple of (message class, template), (4) a string which is
                  shorthand for ("human", template); e.g., "{user_input***REMOVED***"
...
***REMOVED***:
                ...
                raise ValueError(f"Unexpected input: {message_template***REMOVED***")
        return result
    ...
    def partial(self, **kwargs: Union[str, Callable[[], str]]) -> ChatPromptTemplate:
        ...
        Example:
            ...
            .. code-block:: python
                ...
                template = ChatPromptTemplate.from_messages(
                    [
                        ("system", "You are an AI assistant named {name***REMOVED***."),
                        ("human", "Hi I'm {user***REMOVED***"),
                        ("ai", "Hi there, {user***REMOVED***, I'm {name***REMOVED***."),
                        ("human", "{input***REMOVED***"),
                    ]
    ***REMOVED***
        ...
        prompt_dict["partial_variables"] = {**self.partial_variables, **kwargs***REMOVED***
...
def _create_template_from_message_type(
    ...
    if message_type in ("human", "user"):
        ...
        raise ValueError(
            f"Unexpected message type: {message_type***REMOVED***. Use one of 'human',"
...
def _convert_to_message(
    ...
    - BaseMessagePromptTemplate
    - BaseMessage
    - 2-tuple of (role string, template); e.g., ("human", "{user_input***REMOVED***")
    - 2-tuple of (message class, template)
    - string: shorthand for ("human", template); e.g., "{user_input***REMOVED***"
    ...
    if isinstance(message, (BaseMessagePromptTemplate, BaseChatPromptTemplate)):
        ...
        if len(message) != 2:
            raise ValueError(f"Expected 2-tuple of (role, template), got {message***REMOVED***")
        ...
        raise NotImplementedError(f"Unsupported message type: {type(message)***REMOVED***")
