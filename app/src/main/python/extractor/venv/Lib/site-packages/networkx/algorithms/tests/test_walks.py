...
def test_directed():
    ...
    expected = {0: {0: 1, 1: 0, 2: 0***REMOVED***, 1: {0: 0, 1: 1, 2: 0***REMOVED***, 2: {0: 0, 1: 0, 2: 1***REMOVED******REMOVED***
...
def test_undirected():
    G = nx.cycle_graph(3)
    num_walks = nx.number_of_walks(G, 3)
    expected = {0: {0: 2, 1: 3, 2: 3***REMOVED***, 1: {0: 3, 1: 2, 2: 3***REMOVED***, 2: {0: 3, 1: 3, 2: 2***REMOVED******REMOVED***
    assert num_walks == expected
