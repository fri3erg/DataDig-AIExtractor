...
_shared_doc_kwargs = {
    "axes": "index, columns",
    "klass": "DataFrame",
    "axes_single_arg": "{0 or 'index', 1 or 'columns'***REMOVED***",
    "axis": """axis : {0 or 'index', 1 or 'columns'***REMOVED***, default 0
...
how : {'left', 'right', 'outer', 'inner', 'cross'***REMOVED***, default 'inner'
...
...                     'value': [1, 2, 3, 5]***REMOVED***)
>>> df2 = pd.DataFrame({'rkey': ['foo', 'bar', 'baz', 'foo'],
...                     'value': [5, 6, 7, 8]***REMOVED***)
>>> df1
    lkey value
0   foo      1
1   bar      2
...
>>> df1 = pd.DataFrame({'a': ['foo', 'bar'], 'b': [1, 2]***REMOVED***)
>>> df2 = pd.DataFrame({'a': ['foo', 'baz'], 'c': [3, 4]***REMOVED***)
>>> df1
      a  b
0   foo  1
1   bar  2
...
>>> df1 = pd.DataFrame({'left': ['foo', 'bar']***REMOVED***)
>>> df2 = pd.DataFrame({'right': [7, 8]***REMOVED***)
>>> df1
    left
0   foo
1   bar
...
class DataFrame(NDFrame, OpsMixin):
    ...
    >>> d = {'col1': [0, 1, 2, 3], 'col2': pd.Series([2, 3], index=[2, 3])***REMOVED***
    ...
    _internal_names_set = {"columns", "index"***REMOVED*** | NDFrame._internal_names_set
    _typ = "dataframe"
    _HANDLED_TYPES = (Series, Index, ExtensionArray, np.ndarray)
    _accessors: set[str] = {"sparse"***REMOVED***
    ...
    def __init__(
        ...
        if isinstance(data, (BlockManager, ArrayManager)):
            if not allow_mgr:
                # GH#52419
                warnings.warn(
                    f"Passing a {type(data).__name__***REMOVED*** to {type(self).__name__***REMOVED*** "
...
***REMOVED***:
        ...
        if isinstance(data, (BlockManager, ArrayManager)):
            mgr = self._init_mgr(
                data, axes={"index": index, "columns": columns***REMOVED***, dtype=dtype, copy=copy
***REMOVED***
            ...
            if isinstance(data, mrecords.MaskedRecords):
                raise TypeError(
                    ...
                    "{name: data[name] for name in data.dtype.names***REMOVED*** "
                    "instead"
    ***REMOVED***
...
***REMOVED***
    ...
    ***REMOVED***
                ...
                mgr = dict_to_mgr(
                    ...
                    # attribute "name"
                    {data.name: data***REMOVED***,  # type: ignore[union-attr]
                    index,
                    columns,
                    dtype=dtype,
                    typ=manager,
    ...
    ***REMOVED***
    ...
    def __dataframe__(
        ...
        Examples
        --------
        >>> df_not_necessarily_pandas = pd.DataFrame({'A': [1, 2], 'B': [3, 4]***REMOVED***)
    ...
    def _is_homogeneous_type(self) -> bool:
        ...
        Examples
        --------
        >>> DataFrame({"A": [1, 2], "B": [3, 4]***REMOVED***)._is_homogeneous_type
        True
        >>> DataFrame({"A": [1, 2], "B": [3.0, 4.0]***REMOVED***)._is_homogeneous_type
        False
        ...
        ...    "B": np.array([1, 2], dtype=np.int64)***REMOVED***)._is_homogeneous_type
        False
        """
        # The "<" part of "<=" here is for empty DataFrame cases
        return len({arr.dtype for arr in self._mgr.arrays***REMOVED***) <= 1
...
***REMOVED***
    ...
    def to_string(
        ...
        Examples
        --------
        >>> d = {'col1': [1, 2, 3], 'col2': [4, 5, 6]***REMOVED***
        >>> df = pd.DataFrame(d)
        >>> print(df.to_string())
           col1  col2
        0     1     4
...
***REMOVED***
    ...
    def style(self) -> Styler:
        ...
        Examples
        --------
        >>> df = pd.DataFrame({'A': [1, 2, 3]***REMOVED***)
    ...
    _shared_docs[
        ...
        ...                   'population': [1864, 22000, 80000]***REMOVED***,
        ...
        ...     print(f'content: {content***REMOVED***', sep='\n')
        ...
        label: species
        content:
        panda         bear
    ...
    def itertuples(
        ...
        Examples
        --------
        >>> df = pd.DataFrame({'num_legs': [4, 2], 'num_wings': [0, 2]***REMOVED***,
        ...                   index=['dog', 'hawk'])
        >>> df
              num_legs  num_wings
        dog          4          0
    ...
    def dot(self, other: AnyArrayLike | DataFrame) -> DataFrame | Series:
        ...
        if isinstance(other, (Series, DataFrame)):
            ...
            if lvals.shape[1] != rvals.shape[0]:
                raise ValueError(
                    f"Dot product shape mismatch, {lvals.shape***REMOVED*** vs {rvals.shape***REMOVED***"
    ***REMOVED***
...
***REMOVED***
    ...
    def __rmatmul__(self, other) -> DataFrame:
        ...
        try:
            ...
            msg = f"shapes {np.shape(other)***REMOVED*** and {self.shape***REMOVED*** not aligned"
    ...
    def from_dict(
        ...
        ----------
        data : dict
            Of the form {field : array-like***REMOVED*** or {field : dict***REMOVED***.
        orient : {'columns', 'index', 'tight'***REMOVED***, default 'columns'
        ...
        >>> data = {'col_1': [3, 2, 1, 0], 'col_2': ['a', 'b', 'c', 'd']***REMOVED***
        ...
        >>> data = {'row_1': [3, 2, 1, 0], 'row_2': ['a', 'b', 'c', 'd']***REMOVED***
        ...
        if orient == "index":
            ...
            if columns is not None:
                raise ValueError(f"cannot use columns parameter with orient='{orient***REMOVED***'")
        else:  # pragma: no cover
            raise ValueError(
                f"Expected 'index', 'columns' or 'tight' for orient parameter. "
                f"Got '{orient***REMOVED***' instead"
***REMOVED***
    ...
    def to_numpy(
        ...
        Examples
        --------
        >>> pd.DataFrame({"A": [1, 2], "B": [3, 4]***REMOVED***).to_numpy()
        array([[1, 3],
               [2, 4]])
        ...
        >>> df = pd.DataFrame({"A": [1, 2], "B": [3.0, 4.5]***REMOVED***)
        >>> df.to_numpy()
        array([[1. , 3. ],
               [2. , 4.5]])
    ...
    def to_dict(
        ...
        Parameters
        ----------
        orient : str {'dict', 'list', 'series', 'split', 'tight', 'records', 'index'***REMOVED***
            Determines the type of the values of the dictionary.

            - 'dict' (default) : dict like {column -> {index -> value***REMOVED******REMOVED***
            - 'list' : dict like {column -> [values]***REMOVED***
            - 'series' : dict like {column -> Series(values)***REMOVED***
            - 'split' : dict like
              {'index' -> [index], 'columns' -> [columns], 'data' -> [values]***REMOVED***
            - 'tight' : dict like
              {'index' -> [index], 'columns' -> [columns], 'data' -> [values],
              'index_names' -> [index.names], 'column_names' -> [column.names]***REMOVED***
            - 'records' : list like
              [{column -> value***REMOVED***, ... , {column -> value***REMOVED***]
            - 'index' : dict like {index -> {column -> value***REMOVED******REMOVED***
        ...
        row2     2  0.75
        >>> df.to_dict()
        {'col1': {'row1': 1, 'row2': 2***REMOVED***, 'col2': {'row1': 0.5, 'row2': 0.75***REMOVED******REMOVED***
        ...
        'col2': row1    0.50
                row2    0.75
        Name: col2, dtype: float64***REMOVED***

        >>> df.to_dict('split')
        {'index': ['row1', 'row2'], 'columns': ['col1', 'col2'],
         'data': [[1, 0.5], [2, 0.75]]***REMOVED***

        >>> df.to_dict('records')
        [{'col1': 1, 'col2': 0.5***REMOVED***, {'col1': 2, 'col2': 0.75***REMOVED***]

        >>> df.to_dict('index')
        {'row1': {'col1': 1, 'col2': 0.5***REMOVED***, 'row2': {'col1': 2, 'col2': 0.75***REMOVED******REMOVED***

        >>> df.to_dict('tight')
        {'index': ['row1', 'row2'], 'columns': ['col1', 'col2'],
         'data': [[1, 0.5], [2, 0.75]], 'index_names': [None], 'column_names': [None]***REMOVED***
        ...
        [defaultdict(<class 'list'>, {'col1': 1, 'col2': 0.5***REMOVED***),
         defaultdict(<class 'list'>, {'col1': 2, 'col2': 0.75***REMOVED***)]
        """
    ...
    def to_gbq(
        ...
        table_schema : list of dicts, optional
            ...
            'STRING'***REMOVED***,...]``. If schema is not provided, it will be
    ...
    def from_records(
        ...
        >>> data = [{'col_1': 3, 'col_2': 'a'***REMOVED***,
        ...         {'col_1': 2, 'col_2': 'b'***REMOVED***,
        ...         {'col_1': 1, 'col_2': 'c'***REMOVED***,
        ...         {'col_1': 0, 'col_2': 'd'***REMOVED***]
        >>> pd.DataFrame.from_records(data)
           col_1 col_2
        0      3     a
        1      2     b
...
***REMOVED***
    ...
    ***REMOVED***
    ...
    def to_records(
        ...
        Examples
        --------
        >>> df = pd.DataFrame({'A': [1, 2], 'B': [0.5, 0.75]***REMOVED***,
        ...                   index=['a', 'b'])
        >>> df
           A     B
        a  1  0.50
        ...
        >>> df.to_records(column_dtypes={"A": "int32"***REMOVED***)
        rec.array([('a', 1, 0.5 ), ('b', 2, 0.75)],
                  dtype=[('I', 'O'), ('A', '<i4'), ('B', '<f8')])
        ...
        >>> index_dtypes = f"<S{df.index.str.len().max()***REMOVED***"
        ...
        for i, v in enumerate(arrays):
            ...
            if dtype_mapping is None:
                ...
                msg = f"Invalid dtype {dtype_mapping***REMOVED*** specified for {element***REMOVED*** {name***REMOVED***"
                raise ValueError(msg)

        return np.rec.fromarrays(arrays, dtype={"names": names, "formats": formats***REMOVED***)
    ...
    def to_stata(
        ...
        *,
        ...
        version : {{114, 117, 118, 119, None***REMOVED******REMOVED***, default 114
        ...
        ...                               'parrot'],
        ...                    'speed': [350, 18, 361, 15]***REMOVED******REMOVED***)
...
***REMOVED***
    ...
    @doc(
        ...
        --------
        >>> df = pd.DataFrame(
        ...     data={"animal_1": ["elk", "pig"], "animal_2": ["dog", "quetzal"]***REMOVED***
        ... )
    ...
    def to_parquet(
        ...
        **kwargs,
        ...
        engine : {{'auto', 'pyarrow', 'fastparquet'***REMOVED******REMOVED***, default 'auto'
        ...
        **kwargs
        ...
        Examples
        --------
        >>> df = pd.DataFrame(data={{'col1': [1, 2], 'col2': [3, 4]***REMOVED******REMOVED***)
    ...
    def to_orc(
        ...
        *,
        ...
        engine : {'pyarrow'***REMOVED***, default 'pyarrow'
            ORC library to use.
        index : bool, optional
            If ``True``, include the dataframe's index(es) in the file output.
            If ``False``, they will not be written to the file.
        ...
        * Currently timezones in datetime columns are not preserved when a
        ...
        Examples
        --------
        >>> df = pd.DataFrame(data={'col1': [1, 2], 'col2': [4, 3]***REMOVED***)
    ...
    def to_html(
        ...
        notebook : {True, False***REMOVED***, default False
    ...
    def to_xml(
        ...
        namespaces : dict, optional
            ...
            example, ::
                ...
                namespaces = {{"": "https://example.com"***REMOVED******REMOVED***
        ...
        pretty_print : bool, default True
            ...
            line breaks.
        parser : {{'lxml','etree'***REMOVED******REMOVED***, default 'lxml'
        ...
        ...                    'degrees': [360, 360, 180],
        ...                    'sides': [4, np.nan, 3]***REMOVED******REMOVED***)
        ...
        >>> df.to_xml(namespaces={{"doc": "https://example.com"***REMOVED******REMOVED***,
...
***REMOVED***
    ...
    def transpose(self, *args, copy: bool = False) -> DataFrame:
        ...
        **Non-square DataFrame with mixed dtypes**
        ...
        dtype: object
        """
        nv.validate_transpose(args, {***REMOVED***)
        # construct the args
...
***REMOVED***
            ...
            raise ValueError(
                f"Item wrong length {len(key)***REMOVED*** instead of {len(self.index)***REMOVED***."
***REMOVED***
    ...
    def isetitem(self, loc, value) -> None:
        ...
        if isinstance(value, DataFrame):
            ...
            if len(loc) != len(value.columns):
                raise ValueError(
                    f"Got {len(loc)***REMOVED*** positions but value has {len(value.columns)***REMOVED*** "
                    f"columns."
    ***REMOVED***
...
***REMOVED***:
        ...
        if len(value.columns) > 1:
            raise ValueError(
                ...
                f"column {key***REMOVED***"
***REMOVED***
        elif len(value.columns) == 0:
            raise ValueError(
                f"Cannot set a DataFrame without columns to the column {key***REMOVED***"
***REMOVED***
    ...
    def _set_value(
        ...
        try:
            ...
            raise InvalidIndexError(
                f"You can only assign a scalar value not a {type(value)***REMOVED***"
***REMOVED*** from ii_err
    ...
    def query(self, expr: str, *, inplace: bool = False, **kwargs) -> DataFrame | None:
        ...
        *Backtick quoted variables*
        ...
        if not isinstance(expr, str):
            msg = f"expr must be a string to be evaluated, {type(expr)***REMOVED*** given"
            raise ValueError(msg)
    ...
    def eval(self, expr: str, *, inplace: bool = False, **kwargs) -> Any | None:
        ...
        **kwargs
        ...
        Examples
        --------
        >>> df = pd.DataFrame({'A': range(1, 6), 'B': range(10, 0, -2)***REMOVED***)
        >>> df
           A   B
        0  1  10
        1  2   8
    ...
    def select_dtypes(self, include=None, exclude=None) -> Self:
        ...
        * To select Pandas datetimetz dtypes, use ``'datetimetz'``
        ...
        if not include.isdisjoint(exclude):
            raise ValueError(f"include and exclude overlap on {(include & exclude)***REMOVED***")
...
***REMOVED***
        if not allow_duplicates and column in self.columns:
            ...
            raise ValueError(f"cannot insert {column***REMOVED***, already exists")
        ...
        if isinstance(value, DataFrame) and len(value.columns) > 1:
            raise ValueError(
                ...
                f"{len(value.columns)***REMOVED*** columns instead."
***REMOVED***
        elif isinstance(value, DataFrame):
            value = value.iloc[:, 0]
    ...
    def assign(self, **kwargs) -> DataFrame:
        ...
        Parameters
        ----------
        **kwargs : dict of {str: callable or Series***REMOVED***
        ...
        Examples
        --------
        >>> df = pd.DataFrame({'temp_c': [17.0, 25.0]***REMOVED***,
...
***REMOVED***
    ...
    @property
    def _series(self):
        return {item: self._ixs(idx, axis=1) for idx, item in enumerate(self.columns)***REMOVED***
...
***REMOVED***
            ...
            return self._reindex_with_indexers(
                {0: [new_index, row_indexer], 1: [new_columns, col_indexer]***REMOVED***,
                copy=copy,
...
***REMOVED***
    ...
    def rename(
        ...
        *,
        ...
        level : int or level name, default None
            ...
            level.
        errors : {'ignore', 'raise'***REMOVED***, default 'ignore'
        ...
        * ``(mapper, axis={'index', 'columns'***REMOVED***, ...)``
        ...
        >>> df = pd.DataFrame({"A": [1, 2, 3], "B": [4, 5, 6]***REMOVED***)
        >>> df.rename(columns={"A": "a", "B": "c"***REMOVED***)
           a  c
        0  1  4
        1  2  5
        2  3  6
        ...
        >>> df.rename(index={0: "x", 1: "y", 2: "z"***REMOVED***)
           A  B
        x  1  4
        y  2  5
        z  3  6
        ...
        >>> df.rename(columns={"A": "a", "B": "b", "C": "c"***REMOVED***, errors="raise")
        Traceback (most recent call last):
        ...
        >>> df.rename({1: 2, 2: 4***REMOVED***, axis='index')
           A  B
        0  1  4
        2  2  5
        4  3  6
    ...
    def _replace_columnwise(
        ...
        ----------
        mapping : dict
            of the form {col: (target, value)***REMOVED***
        inplace : bool
    ...
    ***REMOVED***
            ...
            for period in periods:
                if not is_integer(period):
                    raise TypeError(
                        f"Periods must be integer, but {period***REMOVED*** is {type(period)***REMOVED***."
        ***REMOVED***
                period = cast(int, period)
                shifted_dataframes.append(
                    super()
                    .shift(periods=period, freq=freq, axis=axis, fill_value=fill_value)
                    .add_suffix(f"{suffix***REMOVED***_{period***REMOVED***" if suffix else f"_{period***REMOVED***")
    ***REMOVED***
        ...
        for col in keys:
            if isinstance(col, (Index, Series, np.ndarray, list, abc.Iterator)):
                ...
                try:
                    ...
                    raise TypeError(
                        f"{err_msg***REMOVED***. Received column of type {type(col)***REMOVED***"
        ***REMOVED*** from err
                else:
                    if not found:
                        missing.append(col)
        ...
        if missing:
            raise KeyError(f"None of {missing***REMOVED*** are in the columns")
    ...
    ***REMOVED***
        ...
        for col in keys:
            ...
            if len(arrays[-1]) != len(self):
                ...
                raise ValueError(
                    f"Length mismatch: Expected {len(self)***REMOVED*** rows, "
                    f"received array of length {len(arrays[-1])***REMOVED***"
    ***REMOVED***
        ...
        if verify_integrity and not index.is_unique:
            ...
            raise ValueError(f"Index has duplicate keys: {duplicates***REMOVED***")
                    ...
                    if col_fill is None:
                        if len(col_name) not in (1, self.columns.nlevels):
                            raise ValueError(
                                ...
                                f"with incomplete column name {name***REMOVED***"
                ***REMOVED***
                        col_fill = col_name[0]
    ...
    ***REMOVED***
    ...
    def dropna(
        ...
        *,
        ...
        how : {'any', 'all'***REMOVED***, default 'any'
...
***REMOVED***
        ...
        if thresh is not lib.no_default:
            ...
            raise ValueError(f"invalid how option: {how***REMOVED***")
    ...
    def drop_duplicates(
        ...
        *,
        ...
        keep : {'first', 'last', ``False``***REMOVED***, default 'first'
    ...
    def sort_values(
        ...
        *,
        ...
        if is_sequence(ascending) and (
            ...
            raise ValueError(
                f"Length of ascending ({len(ascending)***REMOVED***)"  # type: ignore[arg-type]
                f" != length of by ({len(by)***REMOVED***)"
***REMOVED***
        if len(by) > 1:
...
***REMOVED***
    ...
    def sort_index(
        ...
        *,
        ...
        >>> df = pd.DataFrame({"a": [1, 2, 3, 4]***REMOVED***, index=['A', 'b', 'C', 'd'])
    ...
    def value_counts(
        ...
        ...                    'middle_name': ['Smith', pd.NA, pd.NA, 'Louise']***REMOVED***)
        >>> df
...
***REMOVED***
    ...
    def nlargest(
        ...
        keep : {'first', 'last', 'all'***REMOVED***, default 'first'
    ...
    def _arith_method_with_reindex(self, right: DataFrame, op) -> DataFrame:
        ...
        if result.columns.has_duplicates:
            ...
            result = result._reindex_with_indexers(
                {1: [join_columns, indexer]***REMOVED***, allow_dups=True
***REMOVED***
        else:
    ...
    def _align_for_op(
        ...
        def to_series(right):
            msg = (
                ...
                "length must be {req_len***REMOVED***: given {given_len***REMOVED***"
***REMOVED***
        ...
        ***REMOVED***
                    ...
                    raise ValueError(
                        ...
                        f"must be {left.shape***REMOVED***: given {right.shape***REMOVED***"
        ***REMOVED***

            elif right.ndim > 2:
                raise ValueError(
                    "Unable to coerce to Series/DataFrame, "
                    f"dimension must be <= 2: {right.shape***REMOVED***"
    ***REMOVED***
            ...
            if any(is_array_like(el) for el in right):
                raise ValueError(
                    f"Unable to coerce list of {type(right[0])***REMOVED*** to Series/DataFrame"
    ***REMOVED***
            # GH#17901
            right = to_series(right)
...
***REMOVED***
    ...
    def _flex_arith_method(
        ...
        if isinstance(other, Series) and fill_value is not None:
            ...
            raise NotImplementedError(f"fill_value {fill_value***REMOVED*** not supported.")
    ...
    def combine(
        ...
        >>> df1 = pd.DataFrame({'A': [0, 0], 'B': [4, 4]***REMOVED***)
        >>> df2 = pd.DataFrame({'A': [1, 1], 'B': [3, 3]***REMOVED***)
        ...
        >>> df1 = pd.DataFrame({'A': [5, 0], 'B': [2, 4]***REMOVED***)
        >>> df2 = pd.DataFrame({'A': [1, 1], 'B': [3, 3]***REMOVED***)
        ...
        >>> df1 = pd.DataFrame({'A': [0, 0], 'B': [None, 4]***REMOVED***)
        >>> df2 = pd.DataFrame({'A': [1, 1], 'B': [3, 3]***REMOVED***)
        ...
        >>> df1 = pd.DataFrame({'A': [0, 0], 'B': [None, 4]***REMOVED***)
        >>> df2 = pd.DataFrame({'A': [1, 1], 'B': [None, 3]***REMOVED***)
        >>> df1.combine(df2, take_smaller, fill_value=-5)
            A    B
        0  0 -5.0
        1  0  3.0
        ...
        >>> df1 = pd.DataFrame({'A': [0, 0], 'B': [4, 4]***REMOVED***)
        >>> df2 = pd.DataFrame({'B': [3, 3], 'C': [-10, 1], ***REMOVED***, index=[1, 2])
        >>> df1.combine(df2, take_smaller)
             A    B     C
        0  NaN  NaN   NaN
        1  NaN  3.0 -10.0
        ...
        >>> df2 = pd.DataFrame({'B': [3, 3], 'C': [1, 1], ***REMOVED***, index=[1, 2])
    ...
    ***REMOVED***
    ...
    def combine_first(self, other: DataFrame) -> DataFrame:
        ...
        Examples
        --------
        >>> df1 = pd.DataFrame({'A': [None, 0], 'B': [None, 4]***REMOVED***)
        >>> df2 = pd.DataFrame({'A': [1, 1], 'B': [3, 3]***REMOVED***)
        ...
        >>> df1 = pd.DataFrame({'A': [None, 0], 'B': [4, None]***REMOVED***)
        >>> df2 = pd.DataFrame({'B': [3, 3], 'C': [1, 1]***REMOVED***, index=[1, 2])
        >>> df1.combine_first(df2)
             A    B    C
        0  NaN  4.0  NaN
...
***REMOVED***
    ...
    def update(
        ...
        join : {'left'***REMOVED***, default 'left'
        ...
        errors : {'raise', 'ignore'***REMOVED***, default 'ignore'
        ...
        ...                    'B': ['x', 'y', 'z']***REMOVED***)
        >>> new_df = pd.DataFrame({'B': ['d', 'e', 'f', 'g', 'h', 'i']***REMOVED***)
        >>> df.update(new_df)
        >>> df
           A  B
        0  a  d
        ...
        >>> df = pd.DataFrame({'A': ['a', 'b', 'c'],
        ...                    'B': ['x', 'y', 'z']***REMOVED***)
        >>> new_df = pd.DataFrame({'B': ['d', 'f']***REMOVED***, index=[0, 2])
        >>> df.update(new_df)
        >>> df
           A  B
        0  a  d
        ...
        >>> df = pd.DataFrame({'A': [1, 2, 3],
        ...                    'B': [400., 500., 600.]***REMOVED***)
        >>> new_df = pd.DataFrame({'B': [4, np.nan, 6]***REMOVED***)
        >>> df.update(new_df)
        >>> df
           A      B
        0  1    4.0
    ...
    ***REMOVED***
    ...
    @Appender(
        ...
        ...                               'Parrot', 'Parrot'],
        ...                    'Max Speed': [380., 370., 24., 26.]***REMOVED***)
        >>> df
           Animal  Max Speed
        0  Falcon      380.0
        1  Falcon      370.0
        ...
        **Hierarchical Indexes**
        ...
        >>> df = pd.DataFrame({'Max Speed': [390., 350., 30., 20.]***REMOVED***,
        ...                   index=index)
        >>> df
                        Max Speed
        Animal Type
    ...
    ***REMOVED***
    ...
    def explode(
        ...
        if not self.columns.is_unique:
            ...
            raise ValueError(
                f"DataFrame columns must be unique. Duplicate columns: {duplicate_cols***REMOVED***"
***REMOVED***
        ...
        if len(columns) == 1:
            ...
            result = DataFrame({c: df[c].explode() for c in columns***REMOVED***)
    ...
    @Appender(_shared_docs["melt"] % {"caller": "df.melt(", "other": "melt"***REMOVED***)
    def melt(
        self,
        id_vars=None,
        value_vars=None,
    ...
    @doc(
        Series.diff,
        klass="DataFrame",
        extra_params="axis : {0 or 'index', 1 or 'columns'***REMOVED***, default 0\n    "
        ...
        >>> df = pd.DataFrame({'a': [1, 0]***REMOVED***, dtype=np.uint8)
        >>> df.diff()
               a
        0    NaN
        1  255.0"""
    ...
    >>> df.agg({'A' : ['sum', 'min'], 'B' : ['min', 'max']***REMOVED***)
            A    B
    sum  12.0  NaN
    min   1.0  2.0
    max   NaN  8.0
    ...
    def apply(
        ...
        **kwargs,
        ...
        result_type : {'expand', 'reduce', 'broadcast', None***REMOVED***, default None
        ...
        engine : {'python', 'numba'***REMOVED***, default 'python'
    ...
    def map(
        ...
        na_action : {None, 'ignore'***REMOVED***, default None
        ...
        **kwargs
        ...
        1  11.262736  20.857489
        """
        if na_action not in {"ignore", None***REMOVED***:
            raise ValueError(
                f"na_action must be 'ignore' or None. Got {repr(na_action)***REMOVED***"
***REMOVED***
...
***REMOVED***
    ...
    def join(
        ...
        how : {'left', 'right', 'outer', 'inner', 'cross'***REMOVED***, default 'left'
        ...
        if isinstance(other, Series):
            ...
            other = DataFrame({other.name: other***REMOVED***)
    ...
    ***REMOVED***
    ...
    def round(
        ...
        **kwargs
        ...
        >>> df.round({'dogs': 1, 'cats': 0***REMOVED***)
            dogs  cats
        0   0.2   0.0
        1   0.0   1.0
        2   0.7   0.0
...
***REMOVED***.__finalize__(self, method="round")
        else:
    ...
    def corr(
        ...
        Parameters
        ----------
        method : {'pearson', 'kendall', 'spearman'***REMOVED*** or callable
...
***REMOVED***
            ...
            raise ValueError(
                f"Invalid method {method***REMOVED*** was passed, "
...
***REMOVED***
    ...
    ***REMOVED***
    ...
    def count(self, axis: Axis = 0, numeric_only: bool = False):
        ...
        ...                    "Single": [False, True, True, True, False]***REMOVED***)
        >>> df
           Person   Age  Single
        0    John  24.0   False
        1    Myla   NaN    True
    ...
    def _reduce(
        ...
        **kwds,
        ...
        dtype_has_keepdims: dict[ExtensionDtype, bool] = {***REMOVED***
    ...
    ***REMOVED***:
                ...
                if has_keepdims:
                    ...
                    warnings.warn(
                        f"{type(values)***REMOVED***._reduce will require a `keepdims` parameter "
                        "in the future",
                        FutureWarning,
                        stacklevel=find_stack_level(),
        ***REMOVED***
    ...
    ***REMOVED***.iloc[:0]
            ...
            if df.shape[1] and name != "kurt":
                ...
                if isinstance(dtype, ExtensionDtype):
                    ...
                    # with axis=0.
                    name = {"argmax": "idxmax", "argmin": "idxmin"***REMOVED***.get(name, name)
                    df = df.astype(dtype, copy=False)
                    arr = concat_compat(list(df._iter_column_arrays()))
                    ...
                    with rewrite_warning(
                        target_message=(
                            f"The behavior of SeriesGroupBy.{name***REMOVED*** with all-NA values"
            ***REMOVED***,
                        target_category=FutureWarning,
                        new_message=(
                            f"The behavior of {type(self).__name__***REMOVED***.{name***REMOVED*** with all-NA "
    ...
    def nunique(self, axis: Axis = 0, dropna: bool = True) -> Series:
        ...
        Examples
        --------
        >>> df = pd.DataFrame({'A': [4, 5, 6], 'B': [4, 1, 1]***REMOVED***)
        >>> df.nunique()
        A    3
        B    2
        dtype: int64
    ...
    def idxmin(
        ...
        if (indices == -1).any():
            warnings.warn(
                f"The behavior of {type(self).__name__***REMOVED***.idxmin with all-NA "
...
***REMOVED***
    ...
    def idxmax(
        ...
        if (indices == -1).any():
            warnings.warn(
                f"The behavior of {type(self).__name__***REMOVED***.idxmax with all-NA "
                "values, or any-NA and skipna=False, is deprecated. In a future "
                "version this will raise ValueError",
                FutureWarning,
                stacklevel=find_stack_level(),
***REMOVED***
    ...
    def _get_agg_axis(self, axis_num: int) -> Index:
        ...
        if axis_num == 0:
            ...
            raise ValueError(f"Axis must be 0 or 1 (got {repr(axis_num)***REMOVED***)")
    ...
    def quantile(
        ...
        interpolation : {'linear', 'lower', 'higher', 'midpoint', 'nearest'***REMOVED***
            ...
            * midpoint: (`i` + `j`) / 2.
        method : {'single', 'table'***REMOVED***, default 'single'
...
***REMOVED***
        ...
        valid_method = {"single", "table"***REMOVED***
        if method not in valid_method:
            raise ValueError(
                f"Invalid method: {method***REMOVED***. Method must be in {valid_method***REMOVED***."
***REMOVED***
        if method == "single":
            res = data._mgr.quantile(qs=q, interpolation=interpolation)
        elif method == "table":
            valid_interpolation = {"nearest", "lower", "higher"***REMOVED***
            if interpolation not in valid_interpolation:
                raise ValueError(
                    f"Invalid interpolation: {interpolation***REMOVED***. "
                    f"Interpolation must be in {valid_interpolation***REMOVED***"
    ***REMOVED***
    ...
    def to_timestamp(
        ...
        if not isinstance(old_ax, PeriodIndex):
            raise TypeError(f"unsupported Type {type(old_ax).__name__***REMOVED***")
    ...
    def isin(self, values: Series | DataFrame | Sequence | Mapping) -> DataFrame:
        ...
        Examples
        --------
        >>> df = pd.DataFrame({'num_legs': [2, 4], 'num_wings': [2, 0]***REMOVED***,
        ...                   index=['falcon', 'dog'])
        >>> df
                num_legs  num_wings
        falcon         2          2
        ...
        >>> other = pd.DataFrame({'num_legs': [8, 3], 'num_wings': [0, 2]***REMOVED***,
        ...                      index=['spider', 'falcon'])
        >>> df.isin(other)
                num_legs  num_wings
        falcon     False       True
...
***REMOVED***
            ...
            if not is_list_like(values):
                raise TypeError(
                    ...
                    f"you passed a '{type(values).__name__***REMOVED***'"
    ***REMOVED***
...
***REMOVED***
    ...
    ***REMOVED***
    ...
    index = properties.AxisProperty(
        ...
        ...                    'Age': [25, 30, 35],
        ...                    'Location': ['Seattle', 'New York', 'Kona']***REMOVED***,
        ...                   index=([10, 20, 30]))
        >>> df.index
