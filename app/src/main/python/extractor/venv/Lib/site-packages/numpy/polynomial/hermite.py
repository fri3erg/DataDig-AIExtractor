...
def hermmulx(c):
    ...
    .. math::
        ...
        xP_i(x) = (P_{i + 1***REMOVED***(x)/2 + i*P_{i - 1***REMOVED***(x))
...
def hermval2d(x, y, c):
    ...
    .. math:: p(x,y) = \\sum_{i,j***REMOVED*** c_{i,j***REMOVED*** * H_i(x) * H_j(y)
...
def hermval3d(x, y, z, c):
    ...
    .. math:: p(x,y,z) = \\sum_{i,j,k***REMOVED*** c_{i,j,k***REMOVED*** * H_i(x) * H_j(y) * H_k(z)
...
def hermgrid3d(x, y, z, c):
    ...
    .. math:: p(a,b,c) = \\sum_{i,j,k***REMOVED*** c_{i,j,k***REMOVED*** * H_i(a) * H_j(b) * H_k(c)
...
def hermgauss(deg):
    ...
    .. math:: w_k = c / (H'_n(x_k) * H_{n-1***REMOVED***(x_k))
