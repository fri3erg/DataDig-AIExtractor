...
def relabel_nodes(G, mapping, copy=True):
    ...
    >>> mapping = {0: "a", 1: "b"***REMOVED***  # 0->'a' and 1->'b'
    ...
    >>> print(H[0])
    {4: {0: {'value': 'a'***REMOVED***, 1: {'value': 'b'***REMOVED***, 2: {'value': 'c'***REMOVED******REMOVED******REMOVED***
    ...
    m = {n: mapping(n) for n in G***REMOVED*** if callable(mapping) else mapping
...
def convert_node_labels_to_integers(
    ...
    if ordering == "default":
        ...
        raise nx.NetworkXError(f"Unknown node ordering: {ordering***REMOVED***")
    H = relabel_nodes(G, mapping)
    # create node attribute with the old label
    if label_attribute is not None:
        nx.set_node_attributes(H, {v: k for k, v in mapping.items()***REMOVED***, label_attribute)
    return H
