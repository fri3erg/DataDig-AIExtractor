...
a prepared statement is prepared::
    ...
    engine = create_async_engine(
        ...
        poolclass=NullPool,
        connect_args={
            'prepared_statement_name_func': lambda:  f'__asyncpg_{uuid4()***REMOVED***__',
        ***REMOVED***,
    )
...
client using this setting passed to :func:`_asyncio.create_async_engine`::
    ...
    engine = create_async_engine(
        ...
        connect_args={"server_settings": {"jit": "off"***REMOVED******REMOVED***,
    )
        ...
        def to_range(value):
            if value is not None:
                ...
                value = ranges.Range(
                    value.lower,
                    value.upper,
                    bounds=f"{'[' if empty or value.lower_inc else '('***REMOVED***"  # type: ignore  # noqa: E501
                    f"{']' if not empty and value.upper_inc else ')'***REMOVED***",
                    empty=empty,
    ***REMOVED***
            return value
            ...
            def to_range(rvalue):
                if rvalue is not None:
                    ...
                    rvalue = ranges.Range(
                        rvalue.lower,
                        rvalue.upper,
                        bounds=f"{'[' if empty or rvalue.lower_inc else '('***REMOVED***"  # type: ignore  # noqa: E501
                        f"{']' if not empty and rvalue.upper_inc else ')'***REMOVED***",
                        empty=empty,
        ***REMOVED***
                return rvalue
...
***REMOVED***
    ...
    def _handle_exception(self, error):
        ...
        ***REMOVED*** = getattr(error, "sqlstate", None)
