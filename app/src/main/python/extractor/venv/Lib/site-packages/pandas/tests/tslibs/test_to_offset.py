...
def test_to_offset_invalid(freqstr):
    ...
    msg = re.escape(f"Invalid frequency: {freqstr***REMOVED***")
...
@pytest.mark.parametrize(
    "kwargs,expected",
    [
        ({"days": 1, "seconds": 1***REMOVED***, offsets.Second(86401)),
        ({"days": -1, "seconds": 1***REMOVED***, offsets.Second(-86399)),
        ({"hours": 1, "minutes": 10***REMOVED***, offsets.Minute(70)),
        ({"hours": 1, "minutes": -10***REMOVED***, offsets.Minute(50)),
        ({"weeks": 1***REMOVED***, offsets.Day(7)),
        ({"hours": 1***REMOVED***, offsets.Hour(1)),
        ({"hours": 1***REMOVED***, to_offset("60min")),
        ({"microseconds": 1***REMOVED***, offsets.Micro(1)),
        ({"microseconds": 0***REMOVED***, offsets.Nano(0)),
    ],
)
...
def test_to_offset_lowercase_frequency_deprecated(freq_depr):
    ...
    f"future version, please use '{freq_depr.upper()[1:]***REMOVED***' instead."
...
def test_to_offset_uppercase_frequency_deprecated(freq_depr):
    # GH#54939
    depr_msg = f"'{freq_depr[1:]***REMOVED***' is deprecated and will be removed in a "
    f"future version, please use '{freq_depr.lower()[1:]***REMOVED***' instead."
