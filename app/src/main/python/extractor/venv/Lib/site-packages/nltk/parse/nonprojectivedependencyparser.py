...
class ProbabilisticNonprojectiveParser:
    ...
    ***REMOVED***:
    ...
    def parse(self, tokens, tags):
        ...
        """
        self.inner_nodes = {***REMOVED***

        # Initialize g_graph
        g_graph = DependencyGraph()
        for index, token in enumerate(tokens):
            g_graph.nodes[index + 1].update(
                {"word": token, "tag": tags[index], "rel": "NTOP", "address": index + 1***REMOVED***
***REMOVED***
        ...
        while unvisited_vertices:
            ...
            for new_vertex in [current_vertex, best_in_edge]:
                b_graph.nodes[new_vertex].update(
                    {"word": "TEMP", "rel": "NTOP", "address": new_vertex***REMOVED***
    ***REMOVED***
            ...
            if cycle_path:
                ...
                new_node = {"word": "NONE", "rel": "NTOP", "address": nr_vertices + 1***REMOVED***
...
***REMOVED***:
                ...
                node.update({"word": token, "address": address***REMOVED***)
