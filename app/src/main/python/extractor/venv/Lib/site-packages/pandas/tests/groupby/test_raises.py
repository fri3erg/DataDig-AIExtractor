...
def test_groupby_raises_string(
    ...
    ***REMOVED***[groupby_func]

    if groupby_func == "fillna":
        kind = "Series" if groupby_series else "DataFrame"
        warn_msg = f"{kind***REMOVED***GroupBy.fillna is deprecated"
    else:
        warn_msg = ""
...
***REMOVED***,
    ...
    ***REMOVED***[groupby_func]
    ...
    if groupby_func in ["any", "all"]:
        warn_msg = f"'{groupby_func***REMOVED***' with datetime64 dtypes is deprecated"
