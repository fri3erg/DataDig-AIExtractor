...
class TestPublicPrivate:
    ...
    def test_access_type(self, tmp_path):
        ...
        assert len(mod) == 1
        tt = mod[0]['vars']
        assert set(tt['a']['attrspec']) == {'private', 'bind(c)'***REMOVED***
        assert set(tt['b_']['attrspec']) == {'public', 'bind(c)'***REMOVED***
        assert set(tt['c']['attrspec']) == {'public'***REMOVED***
...
class TestDimSpec(util.F2PyTest):
    ...
    code_template = textwrap.dedent("""
      function get_arr_size_{count***REMOVED***(a, n) result (length)
        integer, intent(in) :: n
        integer, dimension({dimspec***REMOVED***), intent(out) :: a
        integer length
        length = size(a)
      end function

      subroutine get_inv_arr_size_{count***REMOVED***(a, n)
        integer :: n
        ! the value of n is computed in f2py wrapper
        !f2py intent(out) n
        integer, dimension({dimspec***REMOVED***), intent(in) :: a
      end subroutine
    """)
    ...
    def test_array_size(self, dimspec):
        ...
        get_arr_size = getattr(self.module, f"get_arr_size_{count***REMOVED***")
    ...
    def test_inv_array_size(self, dimspec):
        ...
        count = self.all_dimspecs.index(dimspec)
        get_arr_size = getattr(self.module, f"get_arr_size_{count***REMOVED***")
        get_inv_arr_size = getattr(self.module, f"get_inv_arr_size_{count***REMOVED***")
...
class TestEval(util.F2PyTest):
    def test_eval_scalar(self):
        ...
        assert eval_scalar('123', {***REMOVED***) == '123'
        assert eval_scalar('12 + 3', {***REMOVED***) == '15'
...
class TestFortranReader(util.F2PyTest):
    ...
    def test_input_encoding(self, tmp_path, encoding):
        # gh-635
        f_path = tmp_path / f"input_with_{encoding***REMOVED***_encoding.f90"
...
class TestFortranGroupCounters(util.F2PyTest):
    def test_end_if_comment(self):
        ...
        try:
            ...
            assert False, f"'crackfortran.crackfortran' raised an exception {exc***REMOVED***"
