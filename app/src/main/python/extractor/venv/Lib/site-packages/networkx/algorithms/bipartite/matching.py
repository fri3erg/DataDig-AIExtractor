...
def hopcroft_karp_matching(G, top_nodes=None):
    ...
    References
    ----------
    .. [1] John E. Hopcroft and Richard M. Karp. "An n^{5 / 2***REMOVED*** Algorithm for
    ...
    leftmatches = {v: None for v in left***REMOVED***
    rightmatches = {v: None for v in right***REMOVED***
    distances = {***REMOVED***
    ...
    leftmatches = {k: v for k, v in leftmatches.items() if v is not None***REMOVED***
    rightmatches = {k: v for k, v in rightmatches.items() if v is not None***REMOVED***

    # At this point, the left matches and the right matches are inverses of one
    # another. In other words,
    #
    #     leftmatches == {v, k for k, v in rightmatches.items()***REMOVED***
    #
...
def eppstein_matching(G, top_nodes=None):
    ...
    while True:
        ...
        preds = {***REMOVED***
        unmatched = []
        pred = {u: unmatched for u in G***REMOVED***
        for v in matching:
            del pred[matching[v]]
        layer = list(pred)
...
def _connected_by_alternating_paths(G, matching, targets):
    ...
    edge_sets = {frozenset((u, v)) for u, v in matching.items()***REMOVED***
    matched_edges = {tuple(edge) for edge in edge_sets***REMOVED***
    unmatched_edges = {
...
def minimum_weight_full_matching(G, top_nodes=None, weight="weight"):
    ...
    :math:`w : E \to \mathbb{R***REMOVED***`. This function then produces a matching
    ...
    matching, :math:`\sum_{e \in M***REMOVED*** w(e)`, or raises an error if no such
    matching exists.
