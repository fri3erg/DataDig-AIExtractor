...
class APIChain(Chain):
    ...
    * Use a None if you want to allow all domains by default -- this is not
    ...
    def validate_api_request_prompt(cls, values: Dict) -> Dict:
        ...
        expected_vars = {"question", "api_docs"***REMOVED***
        if set(input_vars) != expected_vars:
            raise ValueError(
                f"Input variables should be {expected_vars***REMOVED***, got {input_vars***REMOVED***"
***REMOVED***
        return values
...
***REMOVED***
    ...
    def validate_api_answer_prompt(cls, values: Dict) -> Dict:
        ...
        expected_vars = {"question", "api_docs", "api_url", "api_response"***REMOVED***
        if set(input_vars) != expected_vars:
            raise ValueError(
                f"Input variables should be {expected_vars***REMOVED***, got {input_vars***REMOVED***"
***REMOVED***
    ...
    def _call(
        ...
        if self.limit_to_domains and not _check_in_allowed_domain(
            ...
            raise ValueError(
                f"{api_url***REMOVED*** is not in the allowed domains: {self.limit_to_domains***REMOVED***"
***REMOVED***
