...
class OpenAIMetadataTagger(BaseDocumentTransformer, BaseModel):
    ...
    Example:
        .. code-block:: python
                ...
                schema = {
                    "properties": {
                        "movie_title": { "type": "string" ***REMOVED***,
                        "critic": { "type": "string" ***REMOVED***,
                        "tone": {
                            "type": "string",
                ...
                ***REMOVED***
                ...
                original_documents = [
                    ...
                    Document(page_content="Review of The Godfather\nBy Anonymous\n\nThis movie was super boring. 1 out of 5 stars.", metadata={"reliable": False***REMOVED***),
                ]
    ...
    def transform_documents(
        ...
        for document in documents:
            ...
            new_document = Document(
                ...
                metadata={**extracted_metadata, **document.metadata***REMOVED***,
***REMOVED***
...
def create_metadata_tagger(
    ...
    *,
    ...
    _tagging_chain_kwargs = tagging_chain_kwargs or {***REMOVED***
