...
def _results_to_docs_and_scores(results: Any) -> List[Tuple[Document, float]]:
    return [
        ...
        (Document(page_content=result[0], metadata=result[1] or {***REMOVED***), result[2])
        for result in zip(
            results["documents"][0],
            results["metadatas"][0],
            results["distances"][0],
    ...
    def add_images(
        ...
        **kwargs: Any,
        ...
        if metadatas:
            ...
            if length_diff:
                metadatas = metadatas + [{***REMOVED***] * length_diff
            empty_ids = []
            non_empty_ids = []
    ...
    def _select_relevance_score_fn(self) -> Callable[[float], float]:
        ...
        if distance == "cosine":
            ...
            raise ValueError(
                ...
                f" for distance metric of type: {distance***REMOVED***."
    ...
    def get(
        ...
        Args:
            ...
            where_document: A WhereDocument type dict used to filter by the documents.
                            E.g. `{$contains: "hello"***REMOVED***`. Optional.
