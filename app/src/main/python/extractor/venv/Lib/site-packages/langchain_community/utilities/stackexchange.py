...
***REMOVED***
    ...
    def run(self, query: str) -> str:
        ...
        output = self.client.fetch(
            "search/excerpts", **{query_key: query***REMOVED***, **self.fetch_params
        )
        if len(output["items"]) < 1:
            return f"No relevant results found for '{query***REMOVED***' on Stack Overflow."
        questions = [
        ...
        for question in questions:
            res_text = f"Question: {question['title']***REMOVED***\n{question['excerpt']***REMOVED***"
            relevant_answers = [
                answer
