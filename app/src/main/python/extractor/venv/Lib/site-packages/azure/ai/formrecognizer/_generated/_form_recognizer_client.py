...
class FormRecognizerClient(FormRecognizerClientOperationsMixin, MultiApiClientMixin, _SDKClient):
    ...
    def __init__(
        ...
        **kwargs  # type: Any
        ...
        if api_version == '2022-08-31' or api_version == '2023-07-31':
            base_url = '{endpoint***REMOVED***/formrecognizer'
        elif api_version == '2.0':
            base_url = '{endpoint***REMOVED***/formrecognizer/v2.0'
        elif api_version == '2.1':
            base_url = '{endpoint***REMOVED***/formrecognizer/v2.1'
        else:
            raise ValueError("API version {***REMOVED*** is not available".format(api_version))
    ...
    def _models_dict(cls, api_version):
        return {k: v for k, v in cls.models(api_version).__dict__.items() if isinstance(v, type)***REMOVED***
    ...
    def document_classifiers(self):
        ...
        if api_version == '2023-07-31':
            ...
            raise ValueError("API version {***REMOVED*** does not have operation group 'document_classifiers'".format(api_version))
    ...
    def document_models(self):
        ...
        if api_version == '2023-07-31':
            ...
            raise ValueError("API version {***REMOVED*** does not have operation group 'document_models'".format(api_version))
        return OperationClass(self._client, self._config, Serializer(self._models_dict(api_version)), Deserializer(self._models_dict(api_version)))
    ...
    def miscellaneous(self):
        ...
        if api_version == '2023-07-31':
            ...
            raise ValueError("API version {***REMOVED*** does not have operation group 'miscellaneous'".format(api_version))
        return OperationClass(self._client, self._config, Serializer(self._models_dict(api_version)), Deserializer(self._models_dict(api_version)))
