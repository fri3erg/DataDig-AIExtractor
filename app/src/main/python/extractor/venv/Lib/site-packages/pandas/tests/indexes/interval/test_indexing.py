...
class TestGetLoc:
    ...
    def test_get_loc_interval(self, closed, side):
        ...
        for bound in [[0, 1], [1, 2], [2, 3], [3, 4], [0, 2], [2.5, 3], [-1, 4]]:
            ...
            msg = re.escape(f"Interval({bound[0]***REMOVED***, {bound[1]***REMOVED***, closed='{side***REMOVED***')")
            if closed == side:
                if bound == [0, 1]:
    ...
    def test_get_loc_scalar(self, closed, scalar):
        # correct = {side: {query: answer***REMOVED******REMOVED***.
        # If query is not in the dict, that query should raise a KeyError
        correct = {
            "right": {0.5: 0, 1: 0, 2.5: 1, 3: 1***REMOVED***,
            "left": {0: 0, 0.5: 0, 2: 1, 2.5: 1***REMOVED***,
            "both": {0: 0, 0.5: 0, 1: 0, 2: 1, 2.5: 1, 3: 1***REMOVED***,
            "neither": {0.5: 0, 2.5: 1***REMOVED***,
        ***REMOVED***
    ...
    def test_get_loc_length_one_interval(self, left, right, closed, other_closed):
        ...
        if interval == index[0]:
            ...
            with pytest.raises(
                KeyError,
                match=re.escape(f"Interval({left***REMOVED***, {right***REMOVED***, closed='{other_closed***REMOVED***')"),
***REMOVED***:
