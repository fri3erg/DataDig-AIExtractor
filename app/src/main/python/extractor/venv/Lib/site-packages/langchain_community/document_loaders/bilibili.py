...
***REMOVED***
        ...
        if bvid is not None:
            ...
            if aid is not None:
                try:
                    ...
                    raise ValueError(f"{url***REMOVED*** is not bilibili url.")
            else:
                raise ValueError(f"{url***REMOVED*** is not bilibili url.")

        video_info = sync(v.get_info())
        video_info.update({"url": url***REMOVED***)
        ...
        if sub_list:
            ...
            raw_transcript_with_meta_info = (
                f"Video Title: {video_info['title']***REMOVED***,"
                f"description: {video_info['desc']***REMOVED***\n\n"
                f"Transcript: {raw_transcript***REMOVED***"
***REMOVED***
            ...
            warnings.warn(
                f"""
                No subtitles found for video: {url***REMOVED***.
