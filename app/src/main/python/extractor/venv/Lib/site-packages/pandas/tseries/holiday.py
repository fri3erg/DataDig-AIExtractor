...
class Holiday:
    ...
    def __repr__(self) -> str:
        ...
        if self.year is not None:
            info += f"year={self.year***REMOVED***, "
        info += f"month={self.month***REMOVED***, day={self.day***REMOVED***, "

        if self.offset is not None:
            info += f"offset={self.offset***REMOVED***"

        if self.observance is not None:
            info += f"observance={self.observance***REMOVED***"

        repr = f"Holiday: {self.name***REMOVED*** ({info***REMOVED***)"
        return repr
...
class AbstractHolidayCalendar(metaclass=HolidayCalendarMetaClass):
    ...
    def holidays(self, start=None, end=None, return_name: bool = False):
        ...
        if self.rules is None:
            raise Exception(
                f"Holiday Calendar {self.name***REMOVED*** does not have any rules specified"
***REMOVED***
    ...
    ***REMOVED***  # type: ignore[assignment]
    ...
    def merge_class(base, other):
        ...
        if not isinstance(other, list):
            other = [other]
        other_holidays = {holiday.name: holiday for holiday in other***REMOVED***
        ...
        if not isinstance(base, list):
            base = [base]
        base_holidays = {holiday.name: holiday for holiday in base***REMOVED***
...
def HolidayCalendarFactory(name: str, base, other, base_class=AbstractHolidayCalendar):
    ...
    calendar_class = type(name, (base_class,), {"rules": rules, "name": name***REMOVED***)
    return calendar_class
