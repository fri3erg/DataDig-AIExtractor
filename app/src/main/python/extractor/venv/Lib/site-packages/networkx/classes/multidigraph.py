...
class MultiDiGraph(MultiGraph, DiGraph):
    ...
    **Edges:**
    ...
    >>> G[4]
    AdjacencyView({5: {0: {***REMOVED***, 1: {'route': 282***REMOVED***, 2: {'route': 37***REMOVED******REMOVED******REMOVED***)
    ...
    ***REMOVED***
    ...
    def edges(self):
        ...
        >>> [e for e in G.edges()]
        [(0, 1), (1, 2), (1, 2), (2, 3)]
        >>> list(G.edges(data=True))  # default data is {***REMOVED*** (empty dict)
        [(0, 1, {***REMOVED***), (1, 2, {***REMOVED***), (1, 2, {***REMOVED***), (2, 3, {'weight': 5***REMOVED***)]
        >>> list(G.edges(data="weight", default=1))
        [(0, 1, 1), (1, 2, 1), (1, 2, 1), (2, 3, 5)]
        >>> list(G.edges(keys=True))  # default keys are integers
        [(0, 1, 0), (1, 2, 0), (1, 2, 1), (2, 3, 0)]
        >>> list(G.edges(data=True, keys=True))
        [(0, 1, 0, {***REMOVED***), (1, 2, 0, {***REMOVED***), (1, 2, 1, {***REMOVED***), (2, 3, 0, {'weight': 5***REMOVED***)]
