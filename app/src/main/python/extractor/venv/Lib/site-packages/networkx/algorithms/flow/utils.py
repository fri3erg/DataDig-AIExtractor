...
@nx._dispatch(edge_attrs={"capacity": float("inf")***REMOVED***)
...
@nx._dispatch(
    graphs="R",
    preserve_edge_attrs={"R": {"capacity": float("inf")***REMOVED******REMOVED***,
...
@nx._dispatch(graphs={"G": 0, "R": 1***REMOVED***, preserve_edge_attrs={"R": {"flow": None***REMOVED******REMOVED***)
def build_flow_dict(G, R):
    """Build a flow dictionary from a residual network."""
    flow_dict = {***REMOVED***
    for u in G:
        flow_dict[u] = {v: 0 for v in G[u]***REMOVED***
        flow_dict[u].update(
