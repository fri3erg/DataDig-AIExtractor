...
class TestTimestampRendering:
    ...
    def test_pprint(self):
        # GH#12622
        nested_obj = {"foo": 1, "bar": [{"w": {"a": Timestamp("2011-01-01")***REMOVED******REMOVED***] * 10***REMOVED***
        result = pprint.pformat(nested_obj, width=50)
        expected = r"""{'bar': [{'w': {'a': Timestamp('2011-01-01 00:00:00')***REMOVED******REMOVED***,
         {'w': {'a': Timestamp('2011-01-01 00:00:00')***REMOVED******REMOVED***,
         {'w': {'a': Timestamp('2011-01-01 00:00:00')***REMOVED******REMOVED***,
         {'w': {'a': Timestamp('2011-01-01 00:00:00')***REMOVED******REMOVED***,
         {'w': {'a': Timestamp('2011-01-01 00:00:00')***REMOVED******REMOVED***,
         {'w': {'a': Timestamp('2011-01-01 00:00:00')***REMOVED******REMOVED***,
