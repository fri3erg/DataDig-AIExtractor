    ...
    def __init__(
        ...
        **kwargs: Any,
        ...
        if kwargs:
            ...
            raise ValueError(
                f"Unexpected keyword arguments {remaining***REMOVED***. "
                + "Any extension attributes must be passed explicitly using extensions."
***REMOVED***

    def __repr__(self) -> str:
        return "CloudEvent(source={***REMOVED***, type={***REMOVED***, specversion={***REMOVED***, id={***REMOVED***, time={***REMOVED***)".format(
    ...
    def from_dict(cls, event: Dict[str, Any]) -> CloudEvent[DataType]:
        ...
        extensions = {k: v for k, v in event.items() if k not in reserved_attr***REMOVED***
        if extensions:
