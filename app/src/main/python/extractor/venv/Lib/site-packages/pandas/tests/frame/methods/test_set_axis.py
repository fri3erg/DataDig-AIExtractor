...
***REMOVED***
    ...
    def test_set_axis_setattr_index_wrong_length(self, obj):
        # wrong length
        msg = (
            f"Length mismatch: Expected axis has {len(obj)***REMOVED*** elements, "
            f"new values have {len(obj)-1***REMOVED*** elements"
        )
...
class TestDataFrameSetAxis(SharedSetAxisTests):
    ...
    def obj(self):
        df = DataFrame(
            {"A": [1.1, 2.2, 3.3], "B": [5.0, 6.1, 7.2], "C": [4.4, 5.5, 6.6]***REMOVED***,
