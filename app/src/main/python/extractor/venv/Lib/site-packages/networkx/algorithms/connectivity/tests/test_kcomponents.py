...
def test_set_consolidation_rosettacode():
    ...
    def list_of_sets_equal(result, solution):
        assert {frozenset(s) for s in result***REMOVED*** == {frozenset(s) for s in solution***REMOVED***

    question = [{"A", "B"***REMOVED***, {"C", "D"***REMOVED***]
    solution = [{"A", "B"***REMOVED***, {"C", "D"***REMOVED***]
    list_of_sets_equal(_consolidate(question, 1), solution)
    question = [{"A", "B"***REMOVED***, {"B", "C"***REMOVED***]
    solution = [{"A", "B", "C"***REMOVED***]
    list_of_sets_equal(_consolidate(question, 1), solution)
    question = [{"A", "B"***REMOVED***, {"C", "D"***REMOVED***, {"D", "B"***REMOVED***]
    solution = [{"A", "C", "B", "D"***REMOVED***]
    list_of_sets_equal(_consolidate(question, 1), solution)
    question = [{"H", "I", "K"***REMOVED***, {"A", "B"***REMOVED***, {"C", "D"***REMOVED***, {"D", "B"***REMOVED***, {"F", "G", "H"***REMOVED***]
    solution = [{"A", "C", "B", "D"***REMOVED***, {"G", "F", "I", "H", "K"***REMOVED***]
    list_of_sets_equal(_consolidate(question, 1), solution)
    question = [
        {"A", "H"***REMOVED***,
        {"H", "I", "K"***REMOVED***,
    ...
    solution = [{"A", "C", "B", "D", "G", "F", "I", "H", "K"***REMOVED***]
    list_of_sets_equal(_consolidate(question, 1), solution)
    question = [
        {"H", "I", "K"***REMOVED***,
        {"A", "B"***REMOVED***,
