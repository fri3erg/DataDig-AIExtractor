...
def correlate(a, v, mode='valid'):
    ...
    .. math:: c_k = \sum_n a_{n+k***REMOVED*** \cdot \overline{v***REMOVED***_n
    ...
    .. math:: c'_k = \sum_n a_{n***REMOVED*** \cdot \overline{v_{n+k***REMOVED******REMOVED***

    which is related to :math:`c_k` by :math:`c'_k = c_{-k***REMOVED***`.
    ...
    (:math:`\overline{c_{-k***REMOVED******REMOVED***`) when the two input sequences a and v change
    places:
...
def convolve(a, v, mode='full'):
    ...
    .. math:: (a * v)_n = \\sum_{m = -\\infty***REMOVED***^{\\infty***REMOVED*** a_m v_{n - m***REMOVED***
...
def outer(a, b, out=None):
    ...
    the outer product [1]_ is::
      ...
      [[a_0*b_0  a_0*b_1 ... a_0*b_{N-1***REMOVED*** ]
       [a_1*b_0    .
       [ ...          .
       [a_{M-1***REMOVED****b_0            a_{M-1***REMOVED****b_{N-1***REMOVED*** ]]
...
def roll(a, shift, axis=None):
    ...
    if axis is None:
        ...
        shifts = {ax: 0 for ax in range(a.ndim)***REMOVED***
...
def normalize_axis_tuple(axis, ndim, argname=None, allow_duplicate=False):
    ...
    if not allow_duplicate and len(set(axis)) != len(axis):
        if argname:
            raise ValueError('repeated axis in `{***REMOVED***` argument'.format(argname))
        else:
