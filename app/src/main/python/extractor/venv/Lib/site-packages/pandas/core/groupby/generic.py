...
class NamedAgg(NamedTuple):
    ...
    Examples
    --------
    >>> df = pd.DataFrame({"key": [1, 1, 2], "a": [-1, 0, 1], 1: [10, 11, 12]***REMOVED***)
...
class SeriesGroupBy(GroupBy[Series]):
    ...
    def _get_data_to_aggregate(
        ...
        if numeric_only and not is_numeric_dtype(ser.dtype):
            ...
            raise TypeError(
                f"Cannot use {kwd_name***REMOVED***=True with "
                f"{type(self).__name__***REMOVED***.{name***REMOVED*** and non-numeric dtypes."
***REMOVED***
        return single
    ...
    ***REMOVED***
            ...
            try:
                ...
                warnings.warn(
                    ...
                    f"{type(self).__name__***REMOVED***.agg is deprecated, and cases that "
    ...
    ***REMOVED***
        ...
        results: dict[base.OutputKey, DataFrame | Series] = {***REMOVED***
...
***REMOVED***
        ...
        indexed_output = {key.position: val for key, val in results.items()***REMOVED***
...
***REMOVED***
            ...
            raise TypeError(f"{how***REMOVED*** is not supported for {obj.dtype***REMOVED*** dtype") from err
...
***REMOVED***
    ...
    def fillna(
        ...
        method : {{'bfill', 'ffill', None***REMOVED******REMOVED***, default None
            Method to use for filling holes. ``'ffill'`` will propagate
            the last valid observation forward within a group.
            ``'bfill'`` will use next valid observation to fill the gap.
        axis : {0 or 'index', 1 or 'columns'***REMOVED***
        ...
        """
        warnings.warn(
            f"{type(self).__name__***REMOVED***.fillna is deprecated and "
            "will be removed in a future version. Use obj.ffill() or obj.bfill() "
            "for forward or backward filling instead. If you want to fill with a "
            f"single value, use {type(self.obj).__name__***REMOVED***.fillna instead",
            FutureWarning,
            stacklevel=find_stack_level(),
        )
...
***REMOVED***
        ...
        def alt(obj):
            ...
            raise TypeError(f"'skew' is not supported for dtype={obj.dtype***REMOVED***")
...
class DataFrameGroupBy(GroupBy[DataFrame]):
    ...
    >>> data = {"A": [1, 1, 2, 2],
    ...         "B": [1, 2, 3, 4],
    ...         "C": [0.362838, 0.227877, 1.267767, -0.562860]***REMOVED***
    ...
    >>> df.groupby('A').agg({'B': ['min', 'max'], 'C': 'sum'***REMOVED***)
        B             C
      min max       sum
    A
    1   1   2  0.590715
    ...
    ***REMOVED***
            ...
            if self._grouper.nkeys > 1:
                ...
                gba = GroupByApply(self, [func], args=(), kwargs={***REMOVED***)
                try:
                    result = gba.agg()
    ...
    def _python_agg_general(self, func, *args, **kwargs):
        ...
        output: dict[int, ArrayLike] = {***REMOVED***
    ...
    def _aggregate_frame(self, func, *args, **kwargs) -> DataFrame:
        ...
        result: dict[Hashable, NDFrame | np.ndarray] = {***REMOVED***
...
***REMOVED***
        ...
        if self.axis == 0:
            ...
            if columns.name is None:
                ...
                names = {v.name for v in values***REMOVED***
                if len(names) == 1:
    ...
    def filter(self, func, dropna: bool = True, *args, **kwargs):
        ...
        for name, group in gen:
            ...
            if is_bool(res) or (is_scalar(res) and isna(res)):
                ...
                raise TypeError(
                    f"filter function returned a {type(res).__name__***REMOVED***, "
...
***REMOVED***
    ...
    def idxmax(
        ...
        ...                    'co2_emissions': [37.2, 19.66, 1712]***REMOVED***,
...
***REMOVED***
    ...
    def dtypes(self) -> Series:
        # GH#51045
        warnings.warn(
            f"{type(self).__name__***REMOVED***.dtypes is deprecated and will be removed in "
