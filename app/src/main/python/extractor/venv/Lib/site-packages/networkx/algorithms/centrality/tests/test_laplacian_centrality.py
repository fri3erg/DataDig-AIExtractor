...
def test_laplacian_centrality_single_node():
    """See gh-6571"""
    G = nx.empty_graph(1)
    assert nx.laplacian_centrality(G, normalized=False) == {0: 0***REMOVED***
...
def test_laplacian_centrality_unconnected_nodes():
    ...
    """
    G = nx.empty_graph(3)
    assert nx.laplacian_centrality(G, normalized=False) == {0: 0, 1: 0, 2: 0***REMOVED***
...
def test_laplacian_centrality_P3():
    ...
    exact = {0: 0.6, 1: 1.0, 2: 0.6***REMOVED***
    for n, dc in d.items():
        assert exact[n] == pytest.approx(dc, abs=1e-7)
...
def test_laplacian_centrality_K5():
    ...
    exact = {0: 0.52, 1: 0.52, 2: 0.52, 3: 0.52, 4: 0.52***REMOVED***
    for n, dc in d.items():
        assert exact[n] == pytest.approx(dc, abs=1e-7)
