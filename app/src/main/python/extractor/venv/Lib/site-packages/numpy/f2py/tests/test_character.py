...
class TestCharacterString(util.F2PyTest):
    ...
    for length in length_list:
        ...
        subroutine {fprefix***REMOVED***_input_{fsuffix***REMOVED***(c, o, n)
          character*{clength***REMOVED***, intent(in) :: c
          integer n
          !f2py integer, depend(c), intent(hide) :: n = slen(c)
          integer*1, dimension(n) :: o
          !f2py intent(out) o
          o = transfer(c, o)
        end subroutine {fprefix***REMOVED***_input_{fsuffix***REMOVED***

        subroutine {fprefix***REMOVED***_output_{fsuffix***REMOVED***(c, o, n)
          character*{clength***REMOVED***, intent(out) :: c
          integer n
          integer*1, dimension(n), intent(in) :: o
          !f2py integer, depend(o), intent(hide) :: n = len(o)
          c = transfer(o, c)
        end subroutine {fprefix***REMOVED***_output_{fsuffix***REMOVED***

        subroutine {fprefix***REMOVED***_array_input_{fsuffix***REMOVED***(c, o, m, n)
          integer m, i, n
          character*{clength***REMOVED***, intent(in), dimension(m) :: c
        ...
        end subroutine {fprefix***REMOVED***_array_input_{fsuffix***REMOVED***

        subroutine {fprefix***REMOVED***_array_output_{fsuffix***REMOVED***(c, o, m, n)
          character*{clength***REMOVED***, intent(out), dimension(m) :: c
          integer n
        ...
        end subroutine {fprefix***REMOVED***_array_output_{fsuffix***REMOVED***

        subroutine {fprefix***REMOVED***_2d_array_input_{fsuffix***REMOVED***(c, o, m1, m2, n)
          integer m1, m2, i, j, n
          character*{clength***REMOVED***, intent(in), dimension(m1, m2) :: c
        ...
        end subroutine {fprefix***REMOVED***_2d_array_input_{fsuffix***REMOVED***
        """)

    @pytest.mark.parametrize("length", length_list)
    def test_input(self, length):
        fsuffix = {'(*)': 'star'***REMOVED***.get(length, length)
        f = getattr(self.module, self.fprefix + '_input_' + fsuffix)

        a = {'1': 'a', '3': 'abc', 'star': 'abcde' * 3***REMOVED***[length]
    ...
    def test_array_input(self, length):
        ...
        a = np.array([{'1': 'a', '3': 'abc', 'star': 'abcde' * 3***REMOVED***[length],
                      {'1': 'A', '3': 'ABC', 'star': 'ABCDE' * 3***REMOVED***[length],
                      ], dtype='S')
    ...
    def test_array_output(self, length):
        ...
        expected = np.array(
            [{'1': 'a', '3': 'abc', 'star': 'abcde' * 3***REMOVED***[length],
             {'1': 'A', '3': 'ABC', 'star': 'ABCDE' * 3***REMOVED***[length]], dtype='S')
    ...
    def test_2d_array_input(self, length):
        ...
        a = np.array([[{'1': 'a', '3': 'abc', 'star': 'abcde' * 3***REMOVED***[length],
                       {'1': 'A', '3': 'ABC', 'star': 'ABCDE' * 3***REMOVED***[length]],
                      [{'1': 'f', '3': 'fgh', 'star': 'fghij' * 3***REMOVED***[length],
                       {'1': 'F', '3': 'FGH', 'star': 'FGHIJ' * 3***REMOVED***[length]]],
                     dtype='S')
...
class TestCharacter(util.F2PyTest):
    ...
    code = textwrap.dedent(f"""
       subroutine {fprefix***REMOVED***_input(c, o)
          character, intent(in) :: c
          integer*1 o
          !f2py intent(out) o
          o = transfer(c, o)
       end subroutine {fprefix***REMOVED***_input

       subroutine {fprefix***REMOVED***_output(c, o)
          character :: c
          integer*1, intent(in) :: o
          !f2py intent(out) c
          c = transfer(o, c)
       end subroutine {fprefix***REMOVED***_output

       subroutine {fprefix***REMOVED***_input_output(c, o)
          character, intent(in) :: c
          character o
          !f2py intent(out) o
          o = c
       end subroutine {fprefix***REMOVED***_input_output

       subroutine {fprefix***REMOVED***_inout(c, n)
          character :: c, n
          !f2py intent(in) n
          !f2py intent(inout) c
          c = n
       end subroutine {fprefix***REMOVED***_inout

       function {fprefix***REMOVED***_return(o) result (c)
          character :: c
          character, intent(in) :: o
          c = transfer(o, c)
       end function {fprefix***REMOVED***_return

       subroutine {fprefix***REMOVED***_array_input(c, o)
       ...
       end subroutine {fprefix***REMOVED***_array_input

       subroutine {fprefix***REMOVED***_2d_array_input(c, o)
       ...
       end subroutine {fprefix***REMOVED***_2d_array_input

       subroutine {fprefix***REMOVED***_array_output(c, o)
          character :: c(3)
       ...
       end subroutine {fprefix***REMOVED***_array_output

       subroutine {fprefix***REMOVED***_array_inout(c, n)
          character :: c(3), n(3)
          !f2py intent(in) n(3)
       ...
       end subroutine {fprefix***REMOVED***_array_inout

       subroutine {fprefix***REMOVED***_2d_array_inout(c, n)
       ...
       end subroutine {fprefix***REMOVED***_2d_array_inout

       function {fprefix***REMOVED***_array_return(o) result (c)
          character, dimension(3) :: c
          character, intent(in) :: o(3)
          do i=1,3
            c(i) = o(i)
          end do
       end function {fprefix***REMOVED***_array_return

       function {fprefix***REMOVED***_optional(o) result (c)
          character, intent(in) :: o
          !f2py character o = "a"
          character :: c
          c = o
       end function {fprefix***REMOVED***_optional
    """)
    ...
    def test_input_varia(self):
        ...
        try:
            ...
            raise SystemError(f'{f.__name__***REMOVED*** should have failed on empty list')
        ...
        try:
            ...
            raise SystemError(f'{f.__name__***REMOVED*** should have failed on int value')
    ...
    def test_array_input_varia(self):
        ...
        try:
            ...
            raise SystemError(
                f'{f.__name__***REMOVED*** should have failed on wrong input')
    ...
    def test_inout_varia(self):
        ...
        try:
            ...
            raise SystemError(f'{f.__name__***REMOVED*** should have failed on str value')
...
class TestMiscCharacter(util.F2PyTest):
    ...
    code = textwrap.dedent(f"""
       subroutine {fprefix***REMOVED***_gh18684(x, y, m)
       ...
       end subroutine {fprefix***REMOVED***_gh18684

       subroutine {fprefix***REMOVED***_gh6308(x, i)
         integer i
         !f2py check(i>=0 && i<12) i
         character*5 name, x
         common name(12)
         name(i + 1) = x
       end subroutine {fprefix***REMOVED***_gh6308

       subroutine {fprefix***REMOVED***_gh4519(x)
         ...
         !   print*, "x(",i,")=", x(i)
         !end do
       end subroutine {fprefix***REMOVED***_gh4519

       pure function {fprefix***REMOVED***_gh3425(x) result (y)
         character(len=*), intent(in) :: x
       ...
       end function {fprefix***REMOVED***_gh3425

       subroutine {fprefix***REMOVED***_character_bc_new(x, y, z)
         ...
         z(1) = 'c'
       end subroutine {fprefix***REMOVED***_character_bc_new

       subroutine {fprefix***REMOVED***_character_bc_old(x, y, z)
         character, intent(in) :: x
         character, intent(out) :: y
         ...
         z(1) = 'c'
       end subroutine {fprefix***REMOVED***_character_bc_old
    """)
