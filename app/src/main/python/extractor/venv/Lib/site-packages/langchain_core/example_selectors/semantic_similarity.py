...
class SemanticSimilarityExampleSelector(BaseExampleSelector, BaseModel):
    ...
    def add_example(self, example: Dict[str, str]) -> str:
        ...
        if self.input_keys:
            string_example = " ".join(
                sorted_values({key: example[key] for key in self.input_keys***REMOVED***)
***REMOVED***
        else:
    ...
    def select_examples(self, input_variables: Dict[str, str]) -> List[dict]:
        ...
        if self.input_keys:
            input_variables = {key: input_variables[key] for key in self.input_keys***REMOVED***
        vectorstore_kwargs = self.vectorstore_kwargs or {***REMOVED***
        ...
        if self.example_keys:
            examples = [{k: eg[k] for k in self.example_keys***REMOVED*** for eg in examples]
        return examples
    ...
    def from_examples(
        ...
        **vectorstore_cls_kwargs: Any,
        ...
        if input_keys:
            string_examples = [
                " ".join(sorted_values({k: eg[k] for k in input_keys***REMOVED***))
                for eg in examples
            ]
        else:
