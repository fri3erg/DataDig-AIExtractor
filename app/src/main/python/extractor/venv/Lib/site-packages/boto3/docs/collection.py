...
***REMOVED***,
        ...
        for collection in collections:
            ...
            breadcrumb_section.write(f' / Collection / {collection.name***REMOVED***')
            collection_doc.add_title_section(collection.name)
            collection_section = collection_doc.add_new_section(
                collection.name,
                context={'qualifier': f'{self.class_name***REMOVED***.'***REMOVED***,
***REMOVED***
            ...
            collections_dir_path = os.path.join(
                ...
                f'{self._service_name***REMOVED***',
                f'{self._resource_sub_path***REMOVED***',
***REMOVED***
...
def document_collection_object(
    ...
    if include_signature:
        full_collection_name = (
            f"{section.context.get('qualifier', '')***REMOVED***{collection_model.name***REMOVED***"
        )
        section.style.start_sphinx_py_attr(full_collection_name)
    section.include_doc_string(
        f'A collection of {collection_model.resource.type***REMOVED*** resources.'
    )
    section.include_doc_string(
        f'A {collection_model.resource.type***REMOVED*** Collection will include all '
...
def document_batch_action(
    ...
    example_prefix = '{***REMOVED*** = {***REMOVED***.{***REMOVED***.{***REMOVED***'.format(
...
def document_collection_method(
    ...
    custom_action_info_dict = {
        'all': {
            'method_description': (
                f'Creates an iterable of all {collection_model.resource.type***REMOVED*** '
                f'resources in the collection.'
***REMOVED***,
            'example_prefix': '{***REMOVED***_iterator = {***REMOVED***.{***REMOVED***.all'.format(
        ...
        ***REMOVED***,
        'filter': {
            'method_description': (
                ...
                f'method. A {collection_model.resource.type***REMOVED*** collection will '
                ...
                f'on all resources.'
***REMOVED***,
            'example_prefix': '{***REMOVED***_iterator = {***REMOVED***.{***REMOVED***.filter'.format(
                xform_name(collection_model.resource.type),
                example_resource_name,
                collection_model.name,
***REMOVED***,
        ...
        ***REMOVED***,
        'limit': {
            'method_description': (
                ...
                f'{collection_model.resource.type***REMOVED*** resources in the collection.'
***REMOVED***,
            'example_prefix': '{***REMOVED***_iterator = {***REMOVED***.{***REMOVED***.limit'.format(
                xform_name(collection_model.resource.type),
                example_resource_name,
                collection_model.name,
***REMOVED***,
...
***REMOVED***,
            'example_prefix': '{***REMOVED***_iterator = {***REMOVED***.{***REMOVED***.page_size'.format(
                xform_name(collection_model.resource.type),
                example_resource_name,
                collection_model.name,
***REMOVED***,
