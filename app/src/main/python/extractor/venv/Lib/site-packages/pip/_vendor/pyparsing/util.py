...
class __config_flags:
    ...
    def _set(cls, dname, value):
        if dname in cls._fixed_names:
            warnings.warn(
                f"{cls.__name__***REMOVED***.{dname***REMOVED*** {cls._type_desc***REMOVED*** is {str(getattr(cls, dname)).upper()***REMOVED***"
...
***REMOVED***
        ...
        if dname in cls._all_names:
            ...
            raise ValueError(f"no such {cls._type_desc***REMOVED*** {dname!r***REMOVED***")
...
***REMOVED***.pop()
            if first == last:
                ...
                ret.append(
                    f"{escape_re_range_char(first)***REMOVED***{sep***REMOVED***{escape_re_range_char(last)***REMOVED***"
    ***REMOVED***
    else:
...
def _make_synonym_function(compat_name: str, fn: C) -> C:
    ...
    if "self" == list(inspect.signature(fn).parameters)[0]:
        ...
        def _inner(self, *args, **kwargs):
            # warnings.warn(
            #     f"Deprecated - use {fn.__name__***REMOVED***", DeprecationWarning, stacklevel=3
            # )
    ...
    _inner.__doc__ = f"""Deprecated - use :class:`{fn.__name__***REMOVED***`"""
