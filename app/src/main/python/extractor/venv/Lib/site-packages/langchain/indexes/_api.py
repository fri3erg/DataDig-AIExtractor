...
class _HashedDocument(Document):
    ...
    def calculate_hashes(cls, values: Dict[str, Any]) -> Dict[str, Any]:
        ...
        metadata = values.get("metadata", {***REMOVED***)
        ...
        for key in forbidden_keys:
            if key in metadata:
                raise ValueError(
                    f"Metadata cannot contain key {key***REMOVED*** as it "
    ...
    ***REMOVED***
        ...
        try:
            ...
            raise ValueError(
                f"Failed to hash metadata: {e***REMOVED***. "
...
def _get_source_id_assigner(
    ...
    if source_id_key is None:
        ...
        raise ValueError(
            ...
            f"Got {source_id_key***REMOVED*** of type {type(source_id_key)***REMOVED***."
        )
...
def index(
    ...
    *,
    ...
    """
    if cleanup not in {"incremental", "full", None***REMOVED***:
        raise ValueError(
            f"cleanup should be one of 'incremental', 'full' or None. "
            f"Got {cleanup***REMOVED***."
        )
    ...
    for method in methods:
        if not hasattr(vector_store, method):
            raise ValueError(
                f"Vectorstore {vector_store***REMOVED*** does not have required method {method***REMOVED***"
***REMOVED***
            ...
            for source_id, hashed_doc in zip(source_ids, hashed_docs):
                if source_id is None:
                    raise ValueError(
                        ...
                        f"content: {hashed_doc.page_content[:100]***REMOVED*** was not assigned "
                        f"as source id."
        ***REMOVED***
