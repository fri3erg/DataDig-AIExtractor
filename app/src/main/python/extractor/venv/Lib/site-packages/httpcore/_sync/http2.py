...
class HTTP2Connection(ConnectionInterface):
    ...
    def handle_request(self, request: Request) -> Response:
        if not self.can_handle_request(request.url.origin):
            ...
            raise RuntimeError(
                f"Attempted to send request to {request.url.origin***REMOVED*** on connection "
                f"to {self._origin***REMOVED***"
***REMOVED***
        ...
        with self._init_lock:
            if not self._sent_connection_init:
                try:
                    kwargs = {"request": request***REMOVED***
    ...
    ***REMOVED***
        ...
        try:
            kwargs = {"request": request, "stream_id": stream_id***REMOVED***
...
***REMOVED***
            ...
            with ShieldCancellation():
                kwargs = {"stream_id": stream_id***REMOVED***
...
***REMOVED***
    ...
    def _read_incoming_data(
        ...
        timeouts = request.extensions.get("timeout", {***REMOVED***)
...
***REMOVED***
    ...
    def info(self) -> str:
        ...
        return (
            f"{origin!r***REMOVED***, HTTP/2, {self._state.name***REMOVED***, "
            f"Request Count: {self._request_count***REMOVED***"
        )
    ...
    def __repr__(self) -> str:
        ...
        origin = str(self._origin)
        return (
            f"<{class_name***REMOVED*** [{origin!r***REMOVED***, {self._state.name***REMOVED***, "
            f"Request Count: {self._request_count***REMOVED***]>"
        )
...
class HTTP2ConnectionByteStream:
    ...
    def __iter__(self) -> typing.Iterator[bytes]:
        kwargs = {"request": self._request, "stream_id": self._stream_id***REMOVED***
        try:
    ...
    ***REMOVED***:
    ...
    def close(self) -> None:
        if not self._closed:
            self._closed = True
            kwargs = {"stream_id": self._stream_id***REMOVED***
