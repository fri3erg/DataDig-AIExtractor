...
***REMOVED***
            dep_output_path = Path(
                self.temp_dir.name, hash_string(f"dep-{text***REMOVED***") + ".html"
***REMOVED***
...
***REMOVED***
            ent_output_path = Path(
                self.temp_dir.name, hash_string(f"ent-{text***REMOVED***") + ".html"
***REMOVED***
...
***REMOVED***
    ...
    def _create_session_analysis_df(self) -> Any:
        ...
        llm_input_prompts_df = ClearMLCallbackHandler._build_llm_df(
            ...
            rename_map={"step": "prompt_step"***REMOVED***,
        )
        ...
        llm_outputs_df = ClearMLCallbackHandler._build_llm_df(
            ...
            {"step": "output_step", "text": "output"***REMOVED***,
        )
