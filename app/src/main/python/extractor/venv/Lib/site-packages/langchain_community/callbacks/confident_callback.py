            ...
            for i, generation in enumerate(response.generations):
                ...
                if isinstance(metric, AnswerRelevancy):
                    result = metric.measure(
                        ...
                        query=query,
        ***REMOVED***
                    print(f"Answer Relevancy: {result***REMOVED***")
                elif isinstance(metric, UnBiasedMetric):
                    score = metric.measure(output)
                    print(f"Bias Score: {score***REMOVED***")
                elif isinstance(metric, NonToxicMetric):
                    score = metric.measure(output)
                    print(f"Toxic Score: {score***REMOVED***")
                else:
                    raise ValueError(
                        f"""Metric {metric.__name__***REMOVED*** is not supported by deepeval 
                        callbacks."""
        ***REMOVED***
