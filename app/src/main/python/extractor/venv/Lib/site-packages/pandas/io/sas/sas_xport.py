...
{_base_params_doc***REMOVED***
{_format_params_doc***REMOVED***
{_params2_doc***REMOVED***
{_iterator_doc***REMOVED***
...
def _handle_truncated_float_vec(vec, nbytes):
    ...
    if nbytes != 8:
        ...
        dtype = np.dtype(f"S{nbytes***REMOVED***,S{8 - nbytes***REMOVED***")
...
class XportReader(ReaderBase, abc.Iterator):
    ...
    ***REMOVED***
        ...
        # read field names
        types = {1: "numeric", 2: "char"***REMOVED***
...
***REMOVED***
            ...
            if field["ntype"] == "numeric" and ((fl < 2) or (fl > 8)):
                msg = f"Floating field width {fl***REMOVED*** is not between 2 and 8."
                raise TypeError(msg)
