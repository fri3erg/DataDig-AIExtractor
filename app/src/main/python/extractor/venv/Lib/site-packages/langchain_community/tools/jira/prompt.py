...
JIRA_ISSUE_CREATE_PROMPT = """
    ...
    {{"summary": "test issue", "description": "test description", "issuetype": {{"name": "Task"***REMOVED******REMOVED***, "priority": {{"name": "Low"***REMOVED******REMOVED******REMOVED******REMOVED***
    """
...
JIRA_CATCH_ALL_PROMPT = """
    ...
    pass in the following dictionary: {{"function": "get_all_users_from_group", "args": ["group"], "kwargs": {{"limit":100***REMOVED******REMOVED*** ***REMOVED******REMOVED***
    or to find out how many projects are in the Jira instance, you would pass in the following string:
    {{"function": "projects"***REMOVED******REMOVED***
...
title","body":"This is the body. You can use <strong>HTML tags</strong>!"***REMOVED******REMOVED*** """
