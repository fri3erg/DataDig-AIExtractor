...
def test_scalar_format():
    ...
    tests = [('{0***REMOVED***', True, np.bool_),
            ('{0***REMOVED***', False, np.bool_),
            ('{0:d***REMOVED***', 130, np.uint8),
            ('{0:d***REMOVED***', 50000, np.uint16),
            ('{0:d***REMOVED***', 3000000000, np.uint32),
            ('{0:d***REMOVED***', 15000000000000000000, np.uint64),
            ('{0:d***REMOVED***', -120, np.int8),
            ('{0:d***REMOVED***', -30000, np.int16),
            ('{0:d***REMOVED***', -2000000000, np.int32),
            ('{0:d***REMOVED***', -7000000000000000000, np.int64),
            ('{0:g***REMOVED***', 1.5, np.float16),
            ('{0:g***REMOVED***', 1.5, np.float32),
            ('{0:g***REMOVED***', 1.5, np.float64),
            ('{0:g***REMOVED***', 1.5, np.longdouble),
            ('{0:g***REMOVED***', 1.5+0.5j, np.complex64),
            ('{0:g***REMOVED***', 1.5+0.5j, np.complex128),
            ('{0:g***REMOVED***', 1.5+0.5j, np.clongdouble)]
