    ...
    ***REMOVED***
    ...
    def tokenize(self, expression):
        ...
        while self._current is not None:
            if self._current in self.SIMPLE_TOKENS:
                yield {'type': self.SIMPLE_TOKENS[self._current],
                       'value': self._current,
                       'start': self._position, 'end': self._position + 1***REMOVED***
                self._next()
                ...
                yield {'type': 'unquoted_identifier', 'value': buff,
                       'start': start, 'end': start + len(buff)***REMOVED***
                ...
                if next_char == ']':
                    ...
                    yield {'type': 'flatten', 'value': '[]',
                           'start': start, 'end': start + 2***REMOVED***
                elif next_char == '?':
                    self._next()
                    ...
                    yield {'type': 'lbracket', 'value': '[',
                           'start': start, 'end': start + 1***REMOVED***
            elif self._current == "'":
                ...
                if self._next() == '=':
                    yield {'type': 'eq', 'value': '==',
                        'start': self._position - 1, 'end': self._position***REMOVED***
                    self._next()
                else:
        ...
        yield {'type': 'eof', 'value': '',
               'start': self._length, 'end': self._length***REMOVED***
    ...
    def _consume_literal(self):
        ...
        return {'type': 'literal', 'value': parsed_json,
                'start': start, 'end': token_len***REMOVED***
