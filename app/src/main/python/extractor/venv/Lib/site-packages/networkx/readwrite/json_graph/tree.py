...
def tree_data(G, root, ident="id", children="children"):
    ...
    def add_children(n, G):
        ...
        children_ = []
        for child in nbrs:
            d = {**G.nodes[child], ident: child***REMOVED***
    ...
    return {**G.nodes[root], ident: root, children: add_children(root, G)***REMOVED***
...
def tree_graph(data, ident="id", children="children"):
    ...
    nodedata = {str(k): v for k, v in data.items() if k != ident and k != children***REMOVED***
