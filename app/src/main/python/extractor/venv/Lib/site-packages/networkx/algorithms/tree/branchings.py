...
# @article{
#    year={1986***REMOVED***,
#    issn={0209-9683***REMOVED***,
#    journal={Combinatorica***REMOVED***,
#    volume={6***REMOVED***,
#    number={2***REMOVED***,
#    doi={10.1007/BF02579168***REMOVED***,
#    title={Efficient algorithms for finding minimum spanning trees in
#        undirected and directed graphs***REMOVED***,
#    url={https://doi.org/10.1007/BF02579168***REMOVED***,
#    publisher={Springer-Verlag***REMOVED***,
#    keywords={68 B 15; 68 C 05***REMOVED***,
#    author={Gabow, Harold N. and Galil, Zvi and Spencer, Thomas and Tarjan,
#        Robert E.***REMOVED***,
#    pages={109-122***REMOVED***,
...
@nx._dispatch(edge_attrs={"attr": "default"***REMOVED***)
...
class MultiDiGraph_EdgeKey(nx.MultiDiGraph):
    ...
    def add_edge(self, u_for_edge, v_for_edge, key_for_edge, **attr):
        ...
        if key in self.edge_index:
            ...
            if (u != uu) or (v != vv):
                raise Exception(f"Key {key!r***REMOVED*** is already in use.")
    ...
    def remove_edge_with_key(self, key):
        try:
            ...
            raise KeyError(f"Invalid edge key {key!r***REMOVED***") from err
        else:
            del self.edge_index[key]
...
class Edmonds:
    ...
    def __init__(self, G, seed=None):
        ...
        self.template = random_string(seed=seed) + "_{0***REMOVED***"
    ...
    def _init(self, attr, default, kind, style, preserve_attrs, seed, partition):
        ...
        - Check that the kind argument is in {min, max***REMOVED*** or raise a NetworkXException.
        ...
        for key, (u, v, data) in enumerate(self.G_original.edges(data=True)):
            d = {attr: trans(data.get(attr, default))***REMOVED***
    ...
    def find_optimum(
        ...
        default : float
            ...
            the attribute `attr`.
        kind : {'min', 'max'***REMOVED***
            The type of optimum to search for, either 'min' or 'max'.
        style : {'branching', 'arborescence'***REMOVED***
        ...
        while True:
            ...
            # print(f"Max edge is {edge!r***REMOVED***")
            if edge is None:
                ...
                # print(f"Edge is acceptable: {acceptable***REMOVED***")
                if acceptable:
                    dd = {attr: weight***REMOVED***
        ...
        def is_root(G, u, edgekeys):
            ...
            if u not in G:
                # print(G.nodes(), u)
                raise Exception(f"{u!r***REMOVED*** not in G")
            for v in G.pred[u]:
        ...
        for edgekey in edges:
            ...
            dd = {self.attr: self.trans(d[self.attr])***REMOVED***
...
@nx._dispatch(
    edge_attrs={"attr": "default", "partition": 0***REMOVED***,
...
def maximum_branching(
    ...
    while True:
        ...
        if desired_edge is not None and desired_edge_weight > 0:
            ...
            circuit = uf[u] == uf[v]
            dd = {attr: desired_edge_weight***REMOVED***
...
@nx._dispatch(
    edge_attrs={"attr": "default", "partition": None***REMOVED***,
    preserve_edge_attrs="preserve_attrs",
)
...
docstring_branching = """
Returns a {kind***REMOVED*** {style***REMOVED*** from G.
...
------
NetworkXException
    If the graph does not contain a {kind***REMOVED*** {style***REMOVED***.
