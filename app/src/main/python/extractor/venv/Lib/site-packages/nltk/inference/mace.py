...
def decode_result(found):
    ...
    :type found: bool
    """
    return {True: "Countermodel found", False: "No countermodel found", None: "None"***REMOVED***[
        found
    ]
...
def test_model_found(arguments):
    ...
    for (goal, assumptions) in arguments:
        ...
        for a in alist:
            print("   %s" % a)
        print(f"|- {g***REMOVED***: {decode_result(found)***REMOVED***\n")
...
def test_build_model(arguments):
    ...
    for a in alist:
        print("   %s" % a)
    print(f"|- {g***REMOVED***: {decode_result(m.build_model())***REMOVED***\n")
    spacer()
...
def test_transform_output(argument_pair):
    ...
    for a in alist:
        print("   %s" % a)
    print(f"|- {g***REMOVED***: {m.build_model()***REMOVED***\n")
