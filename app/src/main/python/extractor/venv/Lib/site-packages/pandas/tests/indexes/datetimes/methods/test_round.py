...
***REMOVED***,
    ...
    def test_round_int64(self, start, index_freq, periods, round_freq):
        ...
        assert (mod == 0).all(), f"floor not a {round_freq***REMOVED*** multiple"
        ...
        mod = result.asi8 % unit
        assert (mod == 0).all(), f"ceil not a {round_freq***REMOVED*** multiple"
        ...
        mod = result.asi8 % unit
        assert (mod == 0).all(), f"round not a {round_freq***REMOVED*** multiple"
        assert (diff <= unit // 2).all(), "round error"
        if unit % 2 == 0:
            assert (
                result.asi8[diff == unit // 2] % 2 == 0
***REMOVED***.all(), "round half to even error"
