...
def _get_search_client(
    ...
    try:
        ...
        if fields is not None:
            ...
            fields_types = {f.name: f.type for f in fields***REMOVED***
            mandatory_fields = {df.name: df.type for df in default_fields***REMOVED***
            ...
            ***REMOVED***
            if len(missing_fields) > 0:
                ...
                def fmt_err(x: str) -> str:
                    return (
                        f"{x***REMOVED*** current type: '{fields_types.get(x, 'MISSING')***REMOVED***'. "
                        f"It has to be '{mandatory_fields.get(x)***REMOVED***' or you can point "
                        f"to a different '{mandatory_fields.get(x)***REMOVED***' field name by "
                        f"using the env variable 'AZURESEARCH_FIELDS_{x.upper()***REMOVED***'"
        ***REMOVED***

                error = "\n".join([fmt_err(x) for x in missing_fields])
                raise ValueError(
                    f"You need to specify at least the following fields "
                    f"{missing_fields***REMOVED*** or provide alternative field names in the env "
                    f"variables.\n\n{error***REMOVED***"
    ***REMOVED***
        else:
    ...
    ***REMOVED***.tolist(),
    ...
    def similarity_search(
        ...
        if search_type == "similarity":
            ...
            raise ValueError(f"search_type of {search_type***REMOVED*** not allowed.")
        return docs
        ...
        docs = [
            (
                Document(
                    ...
                    metadata={
                        **(
                            {FIELDS_ID: result.pop(FIELDS_ID)***REMOVED***
...
***REMOVED***
    ...
    ***REMOVED***
        ...
        semantic_answers_dict: Dict = {***REMOVED***
        ...
        docs = [
            ...
            ***REMOVED***,
                        **{
                            "captions": {
                                "text": result.get("@search.captions", [{***REMOVED***])[0].text,
                                "highlights": result.get("@search.captions", [{***REMOVED***])[
                                    0
                                ].highlights,
                            ***REMOVED***
