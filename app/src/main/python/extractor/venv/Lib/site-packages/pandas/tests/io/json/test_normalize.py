            ...
            "states": [
                {
                    "name": "California",
                    "cities": [
                        {"name": "San Francisco", "pop": 12345***REMOVED***,
                        {"name": "Los Angeles", "pop": 12346***REMOVED***,
                    ],
                ***REMOVED***,
                {
                    "name": "Ohio",
                    "cities": [
                        {"name": "Columbus", "pop": 1234***REMOVED***,
                        {"name": "Cleveland", "pop": 1236***REMOVED***,
                    ],
                ***REMOVED***,
            ],
        ***REMOVED***,
        {
            "country": "Germany",
            "states": [
                {"name": "Bayern", "cities": [{"name": "Munich", "pop": 12347***REMOVED***]***REMOVED***,
                {
                    "name": "Nordrhein-Westfalen",
                    "cities": [
                        {"name": "Duesseldorf", "pop": 1238***REMOVED***,
                        {"name": "Koeln", "pop": 1239***REMOVED***,
                    ],
                ***REMOVED***,
            ],
        ***REMOVED***,
...
def state_data():
    return [
        {
            "counties": [
                {"name": "Dade", "population": 12345***REMOVED***,
                {"name": "Broward", "population": 40000***REMOVED***,
                {"name": "Palm Beach", "population": 60000***REMOVED***,
            ],
            "info": {"governor": "Rick Scott"***REMOVED***,
            "shortname": "FL",
            "state": "Florida",
        ***REMOVED***,
        {
            "counties": [
                {"name": "Summit", "population": 1234***REMOVED***,
                {"name": "Cuyahoga", "population": 1337***REMOVED***,
            ],
            "info": {"governor": "John Kasich"***REMOVED***,
            "shortname": "OH",
            "state": "Ohio",
        ***REMOVED***,
    ]
...
def author_missing_data():
    return [
        {"info": None***REMOVED***,
        {
            "info": {"created_at": "11/08/1993", "last_updated": "26/05/2012"***REMOVED***,
            "author_name": {"first": "Jane", "last_name": "Doe"***REMOVED***,
        ***REMOVED***,
    ]
    ...
    return [
        {
            ...
            "previous_residences": {"cities": [{"city_name": "Foo York City"***REMOVED***]***REMOVED***,
        ***REMOVED***,
        {
            "addresses": [
                {
            ...
            "previous_residences": {"cities": [{"city_name": "Barmingham"***REMOVED***]***REMOVED***,
        ***REMOVED***,
    ]
...
def max_level_test_input_data():
    ...
    return [
        {
            "CreatedBy": {"Name": "User001"***REMOVED***,
            "Lookup": {
                "TextField": "Some text",
                "UserField": {"Id": "ID001", "Name": "Name001"***REMOVED***,
            ***REMOVED***,
            "Image": {"a": "b"***REMOVED***,
        ***REMOVED***
    ]
...
class TestJSONNormalize:
    ...
    def test_fields_list_type_normalize(self):
        parse_metadata_fields_list_type = [
            {"values": [1, 2, 3], "metadata": {"listdata": [1, 2]***REMOVED******REMOVED***
        ]
        ...
        expected = DataFrame(
            {0: [1, 2, 3], "metadata.listdata": [[1, 2], [1, 2], [1, 2]]***REMOVED***
        )
        tm.assert_frame_equal(result, expected)
    ...
    @pytest.mark.parametrize(
        ...
        [
            ([{"a": 0***REMOVED***, {"a": 1***REMOVED***], None, None),
            ({"a": [{"a": 0***REMOVED***, {"a": 1***REMOVED***]***REMOVED***, "a", None),
            ('{"a": [{"a": 0***REMOVED***, {"a": 1***REMOVED***]***REMOVED***', None, NotImplementedError),
    ...
    def test_simple_normalize_with_separator(self, deep_nested):
        # GH 14883
        result = json_normalize({"A": {"A": 1, "B": 2***REMOVED******REMOVED***)
        expected = DataFrame([[1, 2]], columns=["A.A", "A.B"])
        tm.assert_frame_equal(result.reindex_like(expected), expected)

        result = json_normalize({"A": {"A": 1, "B": 2***REMOVED******REMOVED***, sep="_")
        expected = DataFrame([[1, 2]], columns=["A_A", "A_B"])
        tm.assert_frame_equal(result.reindex_like(expected), expected)

        result = json_normalize({"A": {"A": 1, "B": 2***REMOVED******REMOVED***, sep="\u03c3")
    ...
    def test_normalize_with_multichar_separator(self):
        # GH #43831
        data = {"a": [1, 2], "b": {"b_1": 2, "b_2": (3, 4)***REMOVED******REMOVED***
    ...
    def test_value_array_record_prefix(self):
        # GH 21536
        result = json_normalize({"A": [1, 2]***REMOVED***, "A", record_prefix="Prefix.")
        ...
        data = [
            {
                ...
                "bar": "there",
                "data": [
                    {"foo": "something", "bar": "else"***REMOVED***,
                    {"foo": "something2", "bar": "else2"***REMOVED***,
                ],
            ***REMOVED***
        ]
    ...
    def test_non_ascii_key(self):
        testjson = (
            b'[{"\xc3\x9cnic\xc3\xb8de":0,"sub":{"A":1, "B":2***REMOVED******REMOVED***,'
            b'{"\xc3\x9cnic\xc3\xb8de":1,"sub":{"A":3, "B":4***REMOVED******REMOVED***]'
        ).decode("utf8")
...
***REMOVED***,
    ...
    def test_nested_flattening_consistent(self):
        # see gh-21537
        df1 = json_normalize([{"A": {"B": 1***REMOVED******REMOVED***])
        df2 = json_normalize({"dummy": [{"A": {"B": 1***REMOVED******REMOVED***]***REMOVED***, "dummy")
    ...
    def test_nonetype_record_path(self, nulls_fixture):
        ...
        result = json_normalize(
            [
                {"state": "Texas", "info": nulls_fixture***REMOVED***,
                {"state": "Florida", "info": [{"i": 2***REMOVED***]***REMOVED***,
            ],
            record_path=["info"],
        )
        expected = DataFrame({"i": 2***REMOVED***, index=[0])
        tm.assert_equal(result, expected)

    @pytest.mark.parametrize("value", ["false", "true", "{***REMOVED***", "1", '"text"'])
    def test_non_list_record_path_errors(self, value):
        # see gh-30148, GH 26284
        parsed_value = json.loads(value)
        test_input = {"state": "Texas", "info": parsed_value***REMOVED***
        test_path = "info"
        msg = (
            f"{test_input***REMOVED*** has non list value {parsed_value***REMOVED*** for path {test_path***REMOVED***. "
    ...
    def test_meta_non_iterable(self):
        # GH 31507
        data = """[{"id": 99, "data": [{"one": 1, "two": 2***REMOVED***]***REMOVED***]"""

        result = json_normalize(json.loads(data), record_path=["data"], meta=["id"])
        expected = DataFrame(
            {"one": [1], "two": [2], "id": np.array([99], dtype=object)***REMOVED***
        )
        tm.assert_frame_equal(result, expected)
    ...
    def test_top_column_with_leading_underscore(self):
        # 49861
        data = {"_id": {"a1": 10, "l2": {"l3": 0***REMOVED******REMOVED***, "gg": 4***REMOVED***
...
class TestNestedToRecord:
    def test_flat_stays_flat(self):
        recs = [{"flat1": 1, "flat2": 2***REMOVED***, {"flat3": 3, "flat2": 4***REMOVED***]
        result = nested_to_record(recs)
        expected = recs
        assert result == expected

    def test_one_level_deep_flattens(self):
        data = {"flat1": 1, "dict1": {"c": 1, "d": 2***REMOVED******REMOVED***

        result = nested_to_record(data)
        expected = {"dict1.c": 1, "dict1.d": 2, "flat1": 1***REMOVED***
    ...
    def test_nested_flattens(self):
        data = {
            "flat1": 1,
            "dict1": {"c": 1, "d": 2***REMOVED***,
            "nested": {"e": {"c": 1, "d": 2***REMOVED***, "d": 2***REMOVED***,
        ***REMOVED***
...
***REMOVED***
    ...
    def test_missing_nested_meta(self):
        ...
        data = {"meta": "foo", "nested_meta": None, "value": [{"rec": 1***REMOVED***, {"rec": 2***REMOVED***]***REMOVED***
        result = json_normalize(
            data,
            record_path="value",
        ...
        expected = DataFrame(ex_data, columns=columns).astype(
            {"nested_meta.leaf": object***REMOVED***
        )
        tm.assert_frame_equal(result, expected)
...
***REMOVED***
    ...
    def test_donot_drop_nonevalues(self):
        # GH21356
        data = [
            {"info": None, "author_name": {"first": "Smith", "last_name": "Appleseed"***REMOVED******REMOVED***,
            {
                "info": {"created_at": "11/08/1993", "last_updated": "26/05/2012"***REMOVED***,
                "author_name": {"first": "Jane", "last_name": "Doe"***REMOVED***,
            ***REMOVED***,
                ...
                [
                    {
                        "CreatedBy.Name": "User001",
                        "Lookup.TextField": "Some text",
                        "Lookup.UserField": {"Id": "ID001", "Name": "Name001"***REMOVED***,
                        "Image.a": "b",
                    ***REMOVED***
                ],
***REMOVED***,
        ...
        input_data = [
            {
                "CreatedBy": {
                    "user": {
                        "name": {"firstname": "Leo", "LastName": "Thomson"***REMOVED***,
                        "family_tree": {
                            "father": {
                                "name": "Father001",
                                "father": {
    ...
    def test_series_non_zero_index(self):
        # GH 19020
        data = {
            0: {"id": 1, "name": "Foo", "elements": {"a": 1***REMOVED******REMOVED***,
            1: {"id": 2, "name": "Bar", "elements": {"b": 2***REMOVED******REMOVED***,
            2: {"id": 3, "name": "Baz", "elements": {"c": 3***REMOVED******REMOVED***,
        ***REMOVED***
        s = Series(data)
        s.index = [1, 2, 3]
