...
class ShapeDocumenter:
    ...
    def __init__(
        ...
        if context is None:
            self._context = {'special_shape_types': {***REMOVED******REMOVED***
    ...
    def traverse_and_document_shape(
        ...
        if getattr(shape, 'serialization', {***REMOVED***).get('eventstream'):
        ...
        if shape.name in history:
            ...
            getattr(
                self,
                f"document_shape_type_{param_type***REMOVED***",
...
***REMOVED***
            if is_top_level_param:
                self._event_emitter.emit(
                    f"docs.{self.EVENT_NAME***REMOVED***.{self._service_name***REMOVED***.{self._operation_name***REMOVED***.{name***REMOVED***",
                    section=section,
    ***REMOVED***
            at_overlying_method_section = len(history) == 1
            if at_overlying_method_section:
                self._event_emitter.emit(
                    f"docs.{self.EVENT_NAME***REMOVED***.{self._service_name***REMOVED***.{self._operation_name***REMOVED***.complete-section",
                    section=section,
    ***REMOVED***
            history.pop()
    ...
    def _get_special_py_default(self, shape):
        special_defaults = {
            'document_type': '{...***REMOVED***|[...]|123|123.4|\'string\'|True|None',
            'jsonvalue_header': '{...***REMOVED***|[...]|123|123.4|\'string\'|True|None',
