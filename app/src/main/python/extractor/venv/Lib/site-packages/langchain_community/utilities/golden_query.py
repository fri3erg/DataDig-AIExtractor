...
class GoldenQueryAPIWrapper(BaseModel):
    ...
    def run(self, query: str) -> str:
        ...
        headers = {"apikey": self.golden_api_key or ""***REMOVED***

        response = requests.post(
            f"{GOLDEN_BASE_URL***REMOVED***/api/v2/public/queries/",
            json={"prompt": query***REMOVED***,
            headers=headers,
        ...
        response = requests.get(
            (
                f"{GOLDEN_BASE_URL***REMOVED***/api/v2/public/queries/{query_id***REMOVED***/results/"
                "?pageSize=10"
***REMOVED***,
            headers=headers,
            timeout=GOLDEN_TIMEOUT,
