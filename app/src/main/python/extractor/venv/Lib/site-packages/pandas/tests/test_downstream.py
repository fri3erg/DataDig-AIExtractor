...
def test_statsmodels():
    ...
    df = DataFrame(
        {"Lottery": range(5), "Literacy": range(5), "Pop1831": range(100, 105)***REMOVED***
    )
...
def test_seaborn():
    ...
    tips = DataFrame(
        {"day": pd.date_range("2023", freq="D", periods=5), "total_bill": range(5)***REMOVED***
    )
...
def test_missing_required_dependency():
    ...
    msg = (
        rf"Command '\['{pyexe***REMOVED***', '-sSE', '-c', 'import pandas'\]' "
...
def test_frame_setitem_dask_array_into_new_col():
    ...
    try:
        ...
        result = df.loc[[1], :]
        expected = DataFrame({"a": ["b"], "b": [100], "c": [2]***REMOVED***, index=[1])
...
def test_dataframe_consortium() -> None:
    ...
    df_pd = DataFrame({"a": [1, 2, 3], "b": [4, 5, 6]***REMOVED***)
