...
class PowerBIDataset(BaseModel):
    ...
    def request_url(self) -> str:
        """Get the request url."""
        if self.group_id:
            return f"{BASE_URL***REMOVED***/groups/{self.group_id***REMOVED***/datasets/{self.dataset_id***REMOVED***/executeQueries"  # noqa: E501 # pylint: disable=C0301
        return f"{BASE_URL***REMOVED***/datasets/{self.dataset_id***REMOVED***/executeQueries"  # noqa: E501 # pylint: disable=C0301
    ...
    ***REMOVED*** from exc
    ...
    def get_schemas(self) -> str:
        ...
        if self.schemas:
            return ", ".join([f"{key***REMOVED***: {value***REMOVED***" for key, value in self.schemas.items()])
...
***REMOVED***:
    ...
    def _get_schema(self, table: str) -> None:
        ...
        try:
            result = self.run(
                f"EVALUATE TOPN({self.sample_rows_in_table_info***REMOVED***, {table***REMOVED***)"
***REMOVED***
...
***REMOVED***
    ...
    def _create_json_content(self, command: str) -> dict[str, Any]:
        ...
        return {
            "queries": [{"query": rf"{command***REMOVED***"***REMOVED***],
            "impersonatedUserName": self.impersonated_user_name,
            "serializerSettings": {"includeNulls": True***REMOVED***,
        ***REMOVED***
...
def json_to_md(
    ...
    for header in headers:
        ...
        if table_name:
            header.replace(f"{table_name***REMOVED***.", "")
        output_md += f"| {header***REMOVED*** "
    output_md += "|\n"
    for row in json_contents:
        for value in row.values():
            output_md += f"| {value***REMOVED*** "
        output_md += "|\n"
    return output_md
