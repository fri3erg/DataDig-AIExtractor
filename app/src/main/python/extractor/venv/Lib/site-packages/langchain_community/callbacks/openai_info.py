...
def get_openai_token_cost_for_model(
    ...
    if model_name not in MODEL_COST_PER_1K_TOKENS:
        raise ValueError(
            f"Unknown model: {model_name***REMOVED***. Please provide a valid OpenAI model name."
...
class OpenAICallbackHandler(BaseCallbackHandler):
    ...
    def __repr__(self) -> str:
        return (
            f"Tokens Used: {self.total_tokens***REMOVED***\n"
            f"\tPrompt Tokens: {self.prompt_tokens***REMOVED***\n"
            f"\tCompletion Tokens: {self.completion_tokens***REMOVED***\n"
            f"Successful Requests: {self.successful_requests***REMOVED***\n"
            f"Total Cost (USD): ${self.total_cost***REMOVED***"
        )
