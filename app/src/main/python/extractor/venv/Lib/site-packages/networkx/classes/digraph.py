    ...
    **Subclassing Example**
    ...
    def remove_node(self, n):
        ...
        try:
            ...
            raise NetworkXError(f"The node {n***REMOVED*** is not in the digraph.") from err
        for u in nbrs:
    ...
    def remove_edge(self, u, v):
        ...
        try:
            ...
            raise NetworkXError(f"The edge {u***REMOVED***-{v***REMOVED*** not in graph.") from err
    ...
    def edges(self):
        ...
        OutEdgeDataView([(0, 1, {***REMOVED***), (1, 2, {***REMOVED***), (2, 3, {'weight': 5***REMOVED***)])
