...
Python dictionary as data::
 ...
 1 2 {'weight':7, 'color':'green'***REMOVED***
...
def generate_edgelist(G, delimiter=" ", data=True):
    ...
    ...     print(line)
    0 1 {***REMOVED***
    2 1 {'weight': 3***REMOVED***
    2 3 {'capacity': 12***REMOVED***
...
def parse_edgelist(
    ...
    [(1, {'bipartite': 0***REMOVED***), (2, {'bipartite': 0***REMOVED***), (3, {'bipartite': 0***REMOVED***), (4, {'bipartite': 1***REMOVED***)]
    >>> sorted(G.edges())
    [(1, 2), (2, 3), (3, 4)]

    Edgelist with data in Python dictionary representation:

    >>> lines = ["1 2 {'weight':3***REMOVED***", "2 3 {'weight':27***REMOVED***", "3 4 {'weight':3.0***REMOVED***"]
    >>> G = bipartite.parse_edgelist(lines, nodetype=int)
    >>> sorted(G.nodes())
    [1, 2, 3, 4]
    >>> sorted(G.edges(data=True))
    [(1, 2, {'weight': 3***REMOVED***), (2, 3, {'weight': 27***REMOVED***), (3, 4, {'weight': 3.0***REMOVED***)]
    ...
    [1, 2, 3, 4]
    >>> sorted(G.edges(data=True))
    [(1, 2, {'weight': 3.0***REMOVED***), (2, 3, {'weight': 27.0***REMOVED***), (3, 4, {'weight': 3.0***REMOVED***)]
    ...
    for line in lines:
        ...
        if nodetype is not None:
            try:
                ...
                raise TypeError(
                    f"Failed to convert nodes {u***REMOVED***,{v***REMOVED*** " f"to type {nodetype***REMOVED***."
    ***REMOVED*** from err
        ...
        if len(d) == 0 or data is False:
            ...
            try:  # try to evaluate as dictionary
                ...
                raise TypeError(
                    f"Failed to convert edge data ({d***REMOVED***)" f"to dictionary."
    ***REMOVED*** from err
        else:
            # convert edge data to dictionary with specified keys and type
            if len(d) != len(data):
                raise IndexError(
                    f"Edge data {d***REMOVED*** and data_keys {data***REMOVED*** are not the same length"
    ***REMOVED***
            edgedata = {***REMOVED***
            for (edge_key, edge_type), edge_value in zip(data, d):
                try:
                    ...
                    raise TypeError(
                        f"Failed to convert {edge_key***REMOVED*** data "
                        f"{edge_value***REMOVED*** to type {edge_type***REMOVED***."
        ***REMOVED*** from err
                edgedata.update({edge_key: edge_value***REMOVED***)
