...
def _get_default_document_prompt() -> PromptTemplate:
    return PromptTemplate(input_variables=["page_content"], template="{page_content***REMOVED***")
...
***REMOVED***
            ...
            prompt = PromptTemplate.from_template(
                "Summarize this content: {context***REMOVED***"
***REMOVED***
            ...
            prompt_refine = PromptTemplate.from_template(
                "Here's your first summary: {prev_response***REMOVED***. "
                "Now add to it based on the following context: {context***REMOVED***"
***REMOVED***
...
***REMOVED***
    ...
    ***REMOVED***
            ...
            if values["document_variable_name"] not in llm_chain_variables:
                raise ValueError(
                    f"document_variable_name {values['document_variable_name']***REMOVED*** was "
                    f"not found in llm_chain input_variables: {llm_chain_variables***REMOVED***"
    ***REMOVED***
        return values
    ...
    def combine_docs(
        ...
        for doc in docs[1:]:
            ...
            inputs = {**base_inputs, **kwargs***REMOVED***
    ...
    def _construct_result(self, refine_steps: List[str], res: str) -> Tuple[str, dict]:
        if self.return_intermediate_steps:
            extra_return_dict = {"intermediate_steps": refine_steps***REMOVED***
        else:
            extra_return_dict = {***REMOVED***
    ...
    def _construct_initial_inputs(
        ...
        base_info = {"page_content": docs[0].page_content***REMOVED***
        base_info.update(docs[0].metadata)
        document_info = {k: base_info[k] for k in self.document_prompt.input_variables***REMOVED***
        base_inputs: dict = {
