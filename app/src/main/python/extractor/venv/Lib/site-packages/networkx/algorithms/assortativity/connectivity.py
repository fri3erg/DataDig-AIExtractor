...
def average_degree_connectivity(
    ...
    `w_{ij***REMOVED***` is the weight of the edge that links `i` and `j`,
    ...
    if G.is_directed():
        ...
        direction = {"out": G.out_degree, "in": G.in_degree, "in+out": G.degree***REMOVED***
        neighbor_funcs = {
            "out": G.successors,
            "in": G.predecessors,
            "in+out": G.neighbors,
...
***REMOVED***
    ...
    # normalize
    return {k: avg if dnorm[k] == 0 else avg / dnorm[k] for k, avg in dsum.items()***REMOVED***
