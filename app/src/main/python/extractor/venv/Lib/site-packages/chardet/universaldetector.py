...
class UniversalDetector:
    ...
    ***REMOVED***
    ...
    def reset(self) -> None:
        ...
        """
        self.result = {"encoding": None, "confidence": 0.0, "language": None***REMOVED***
        self.done = False
        self._got_data = False
        self._has_win_bytes = False
        self._input_state = InputState.PURE_ASCII
        ...
        if not self._got_data:
            ...
            if byte_str.startswith(codecs.BOM_UTF8):
                ...
                ***REMOVED***
                ...
                self.result = {"encoding": "UTF-32", "confidence": 1.0, "language": ""***REMOVED***
                ...
                ***REMOVED***
                ...
                self.result = {"encoding": "UTF-16", "confidence": 1.0, "language": ""***REMOVED***
...
***REMOVED***:
    ...
    def close(self) -> ResultDict:
        ...
        # Default to ASCII if it is all we've seen so far
            ...
            self.result = {"encoding": "ascii", "confidence": 1.0, "language": ""***REMOVED***
