...
class Endpoint:
    ...
    def __repr__(self):
        return f'{self._endpoint_prefix***REMOVED***({self.host***REMOVED***)'
...
***REMOVED***
            ...
            event_name = 'request-created.{service_id***REMOVED***.{op_name***REMOVED***'.format(
...
***REMOVED***
    ...
    ***REMOVED***
    ...
    def _update_retries_context(self, context, attempt, success_response=None):
        retries_context = context.setdefault('retries', {***REMOVED***)
...
***REMOVED***
        service_id = operation_model.service_model.service_id.hyphenize()
        self._event_emitter.emit(
            f"response-received.{service_id***REMOVED***.{operation_model.name***REMOVED***",
            **kwargs_to_emit,
        )
...
***REMOVED***
            service_id = operation_model.service_model.service_id.hyphenize()
            event_name = f"before-send.{service_id***REMOVED***.{operation_model.name***REMOVED***"
...
***REMOVED***
    ...
    def _add_modeled_error_fields(
        ...
        error_code = parsed_response.get("Error", {***REMOVED***).get("Code")
    ...
    def _needs_retry(
        ...
        service_id = operation_model.service_model.service_id.hyphenize()
        event_name = f"needs-retry.{service_id***REMOVED***.{operation_model.name***REMOVED***"
