    ...
    def plan(
        ...
        **kwargs: Any,
        ...
        for action, observation in intermediate_steps:
            log += (
                f"<tool>{action.tool***REMOVED***</tool><tool_input>{action.tool_input***REMOVED***"
                f"</tool_input><observation>{observation***REMOVED***</observation>"
***REMOVED***
        tools = ""
        for tool in self.tools:
            tools += f"{tool.name***REMOVED***: {tool.description***REMOVED***\n"
        inputs = {
...
***REMOVED***
    ...
    """
    missing_vars = {"tools", "agent_scratchpad"***REMOVED***.difference(prompt.input_variables)
    if missing_vars:
