    ...
    ***REMOVED***
    ...
    def __getattr__(name):
        if name in submodules:
            return importlib.import_module(f"{module_name***REMOVED***.{name***REMOVED***")
        elif name in attr_to_modules:
            submod = importlib.import_module(f"{module_name***REMOVED***.{attr_to_modules[name]***REMOVED***")
            return getattr(submod, name)
        else:
            raise AttributeError(f"No {module_name***REMOVED*** attribute {name***REMOVED***")
    ...
    def __getattr__(self, x):
        if x in ("__class__", "__file__", "__frame_data"):
            ...
            raise ModuleNotFoundError(
                f"No module named '{fd['spec']***REMOVED***'\n\n"
                "This error is lazily reported, having originally occurred in\n"
                f'  File {fd["filename"]***REMOVED***, line {fd["lineno"]***REMOVED***, in {fd["function"]***REMOVED***\n\n'
                f'----> {"".join(fd["code_context"] or "").strip()***REMOVED***'
***REMOVED***
