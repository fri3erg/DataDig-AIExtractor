...
***REMOVED***
            ...
            raise ValueError(f"Invalid document path: {document_path***REMOVED***")
    ...
    ***REMOVED***
    ...
    def _run(
        ...
        try:
            ...
            raise RuntimeError(f"Error while running AzureCogsFormRecognizerTool: {e***REMOVED***")
