...
***REMOVED*** from ex
        ...
        list_dict = {list_item.id: list_item.name for list_item in board.list_lists()***REMOVED***
    ...
    def _get_board(self) -> Board:
        ...
        if not board:
            raise ValueError(f"Board `{self.board_name***REMOVED***` not found.")
        return board
    ...
    def _card_to_doc(self, card: Card, list_dict: dict) -> Document:
        ...
        if self.include_checklist:
            ...
            for checklist in card.checklists:
                if checklist.items:
                    items = [
                        f"{item['name']***REMOVED***:{item['state']***REMOVED***" for item in checklist.items
                    ]
                    text_content += f"\n{checklist.name***REMOVED***\n" + "\n".join(items)
