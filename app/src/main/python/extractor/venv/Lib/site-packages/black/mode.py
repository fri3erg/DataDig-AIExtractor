...
VERSION_TO_FEATURES: Dict[TargetVersion, Set[Feature]] = {
    TargetVersion.PY33: {Feature.ASYNC_IDENTIFIERS***REMOVED***,
    TargetVersion.PY34: {Feature.ASYNC_IDENTIFIERS***REMOVED***,
    TargetVersion.PY35: {Feature.TRAILING_COMMA_IN_CALL, Feature.ASYNC_IDENTIFIERS***REMOVED***,
    TargetVersion.PY36: {
        Feature.F_STRINGS,
