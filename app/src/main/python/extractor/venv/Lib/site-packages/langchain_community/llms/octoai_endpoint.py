        ...
        try:
            ...
            if "model" in _model_kwargs:
                ...
                parameter_payload["messages"].append(
                    {"role": "user", "content": prompt***REMOVED***
    ***REMOVED***
                ...
                parameter_payload = {"inputs": prompt, "parameters": _model_kwargs***REMOVED***
            ...
            raise ValueError(f"Error raised by the inference endpoint: {e***REMOVED***") from e
