...
_CREATE_DRAFT_ANSWER_TEMPLATE = """{question***REMOVED***\n\n"""
...
_REVISED_ANSWER_TEMPLATE = """{checked_assertions***REMOVED***

Question: In light of the above assertions and checks, how would you answer the question '{question***REMOVED***'?
