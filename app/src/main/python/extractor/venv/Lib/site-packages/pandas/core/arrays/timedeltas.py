...
class TimedeltaArray(dtl.TimelikeOps):
    ...
    def _from_sequence_not_strict(
        ...
        *,
        ...
        result._maybe_pin_freq(freq, {***REMOVED***)
        return result
...
***REMOVED***
        ...
        td64values = index.view(f"m8[{unit***REMOVED***]")
    ...
    ***REMOVED***
                ...
                raise ValueError(
                    f"Cannot convert from {self.dtype***REMOVED*** to {dtype***REMOVED***. "
    ...
    ***REMOVED***
    ...
    def sum(
        ...
        *,
        ...
        nv.validate_sum(
            (), {"dtype": dtype, "out": out, "keepdims": keepdims, "initial": initial***REMOVED***
        )
    ...
    def std(
        ...
        *,
        ...
        nv.validate_stat_ddof_func(
            (), {"dtype": dtype, "out": out, "keepdims": keepdims***REMOVED***, fname="std"
        )
    ...
    def _add_offset(self, other):
        ...
        raise TypeError(
            f"cannot add the type {type(other).__name__***REMOVED*** to a {type(self).__name__***REMOVED***"
        )
    ...
    def _scalar_divlike_op(self, other, op):
        ...
        if isinstance(other, self._recognized_scalars):
            ...
            if op in [roperator.rtruediv, roperator.rfloordiv]:
                raise TypeError(
                    f"Cannot divide {type(other).__name__***REMOVED*** by {type(self).__name__***REMOVED***"
    ***REMOVED***
...
def sequence_to_td64ns(
    ...
    errors : {"raise", "coerce", "ignore"***REMOVED***, default "raise"
    ...
    if data.dtype == object or is_string_dtype(data.dtype):
        ...
        raise TypeError(f"dtype {data.dtype***REMOVED*** cannot be converted to timedelta64[ns]")
...
def _ints_to_td64ns(data, unit: str = "ns"):
    ...
    if unit != "ns":
        dtype_str = f"timedelta64[{unit***REMOVED***]"
...
def _validate_td64_dtype(dtype) -> DtypeObj:
    ...
    if not lib.is_np_dtype(dtype, "m"):
        raise ValueError(f"dtype '{dtype***REMOVED***' is invalid, should be np.timedelta64 dtype")
