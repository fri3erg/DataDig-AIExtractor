...
class EdenaiTool(BaseTool):
    ...
    def _call_eden_ai(self, query_params: Dict[str, Any]) -> str:
        ...
        ***REMOVED***
        ...
        url = f"https://api.edenai.run/v2/{self.feature***REMOVED***/{self.subfeature***REMOVED***"
        ...
        ***REMOVED***
        ...
        try:
            ...
            raise RuntimeError(f"An error occurred while running tool: {e***REMOVED***")
    ...
    def _parse_json_multilevel(
        ...
        for section, subsections in extracted_data.items():
            ...
            if isinstance(subsections, str):
                ...
                formatted_list.append(f"{indentation***REMOVED***{section***REMOVED*** : {subsections***REMOVED***")

            elif isinstance(subsections, list):
                formatted_list.append(f"{indentation***REMOVED***{section***REMOVED*** : ")
    ...
    def _list_handling(
        ...
        for list_item in subsection_list:
            if isinstance(list_item, dict):
                ...
                formatted_list.append(f"{'  ' * level***REMOVED***{list_item***REMOVED***")
