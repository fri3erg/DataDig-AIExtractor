...
class TestGeneric:
    @pytest.mark.parametrize(
        ...
        [
            str.lower,
            {x: x.lower() for x in list("ABCD")***REMOVED***,
            Series({x: x.lower() for x in list("ABCD")***REMOVED***),
        ],
    )
    def test_rename(self, frame_or_series, func):
        ...
        for axis in frame_or_series._AXIS_ORDERS:
            kwargs = {axis: idx***REMOVED***
            obj = construct(frame_or_series, 4, **kwargs)

            # rename a single axis
            result = obj.rename(**{axis: func***REMOVED***)
            expected = obj.copy()
    ...
    def test_nonzero(self, frame_or_series):
        ...
        msg = f"The truth value of a {frame_or_series.__name__***REMOVED*** is ambiguous"
    ...
    def test_frame_or_series_compound_dtypes(self, frame_or_series):
        ...
        msg = (
            ...
            f"in the {frame_or_series.__name__***REMOVED*** constructor"
        )
...
class TestNDFrame:
    ...
    def test_bool_dep(self) -> None:
        ...
        with tm.assert_produces_warning(FutureWarning, match=msg_warn):
            DataFrame({"col": [False]***REMOVED***).bool()
