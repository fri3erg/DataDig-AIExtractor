...
class QdrantSparseVectorRetriever(BaseRetriever):
    ...
    search_options: Dict[str, Any] = {***REMOVED***
        ...
        try:
            ...
            if sparse_vector_name not in sparse_vectors_config:
                raise QdrantException(
                    ...
                    f"contain sparse vector named {sparse_vector_name***REMOVED***."
                    f"Did you mean one of {', '.join(sparse_vectors_config.keys())***REMOVED***?"
    ***REMOVED***
        except (UnexpectedResponse, RpcError, ValueError):
            raise QdrantException(
                f"Qdrant collection {collection_name***REMOVED*** does not exist."
***REMOVED***
        return values
