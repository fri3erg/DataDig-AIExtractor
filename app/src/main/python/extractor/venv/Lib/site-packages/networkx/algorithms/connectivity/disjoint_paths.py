...
@nx._dispatch(
    graphs={"G": 0, "auxiliary?": 5, "residual?": 6***REMOVED***,
    preserve_edge_attrs={
...
def edge_disjoint_paths(
    ...
    >>> result = {n: {***REMOVED*** for n in G***REMOVED***
    ...
    ***REMOVED***
    ...
    flow_dict = {n: {***REMOVED*** for edge in cutset for n in edge***REMOVED***
    for u, v in cutset:
        flow_dict[u][v] = 1
...
def node_disjoint_paths(
    ...
    # Maximum possible edge disjoint paths
    possible = min(H.out_degree(f"{mapping[s]***REMOVED***B"), H.in_degree(f"{mapping[t]***REMOVED***A"))
    if not possible:
        raise NetworkXNoPath
    ...
    ***REMOVED***
    ...
    paths_edges = edge_disjoint_paths(H, f"{mapping[s]***REMOVED***B", f"{mapping[t]***REMOVED***A", **kwargs)
