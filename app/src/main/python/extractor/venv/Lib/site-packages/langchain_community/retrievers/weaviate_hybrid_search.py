...
***REMOVED***
        if not isinstance(values["client"], weaviate.Client):
            ...
            raise ValueError(
                f"client should be an instance of weaviate.Client, got {type(client)***REMOVED***"
***REMOVED***
        ...
        if values.get("create_schema_if_missing", True):
            class_obj = {
                ...
                "properties": [{"name": values["text_key"], "dataType": ["text"]***REMOVED***],
    ...
    def add_documents(self, docs: List[Document], **kwargs: Any) -> List[str]:
        ...
        with self.client.batch as batch:
            ...
            for i, doc in enumerate(docs):
                metadata = doc.metadata or {***REMOVED***
                data_properties = {self.text_key: doc.page_content, **metadata***REMOVED***
    ...
    def _get_relevant_documents(
        ...
        *,
        ...
        hybrid_search_kwargs: Used to pass additional arguments
         to the .with_hybrid() method.
            ...
            1)  Search specific properties only -
                ...
                Example - hybrid_search_kwargs={"properties": ["question", "answer"]***REMOVED***
            ...
            2) Weight boosted searched properties -
                ...
                Example - hybrid_search_kwargs={"properties": ["question^2", "answer"]***REMOVED***
            ...
            3) Search with a custom vector - Define a different vector
                ...
                Example - hybrid_search_kwargs={"vector": [0.1, 0.2, 0.3, ...]***REMOVED***
            ...
            4) Use Fusion ranking method
                ...
                hybrid_search_kwargs={"fusion": fusion_type=HybridFusion.RELATIVE_SCORE***REMOVED***
        ...
        if "errors" in result:
            raise ValueError(f"Error during query: {result['errors']***REMOVED***")
