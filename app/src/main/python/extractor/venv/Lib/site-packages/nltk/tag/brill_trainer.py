...
class BrillTaggerTrainer:
    ...
    def train(self, train_sents, max_rules=200, min_score=2, min_acc=None):
        ...
        *min_acc*.
        ...
        if self._trace > 0:
            print(
                "TBL train (fast) (seqs: {sequencecount***REMOVED***; tokens: {tokencount***REMOVED***; "
                "tpls: {templatecount***REMOVED***; min score: {min_score***REMOVED***; min acc: {min_acc***REMOVED***)".format(
                    **trainstats
    ***REMOVED***
***REMOVED***
        ...
        if self._trace:
            print(f"    Found {len(self._rule_scores)***REMOVED*** useful rules.")
        ...
        # The user can cancel training manually:
            ...
            print(f"Training stopped manually -- {len(rules)***REMOVED*** rules found")
...
------------------+-------------------------------------------------------
    ...
    def _trace_rule(self, rule):
        ...
        if self._trace > 2:
            print(
                "{:4d***REMOVED***{:4d***REMOVED***{:4d***REMOVED***{:4d***REMOVED***  |".format(
...
***REMOVED***
    ...
    def _trace_apply(self, num_updates):
        prefix = " " * 18 + "|"
        print(prefix)
        print(prefix, f"Applying rule to {num_updates***REMOVED*** positions.")

    def _trace_update_rules(self, num_obsolete, num_new, num_unseen):
        prefix = " " * 18 + "|"
        print(prefix, "Updated rule tables:")
        print(prefix, (f"  - {num_obsolete***REMOVED*** rule applications removed"))
        print(
            prefix,
            (f"  - {num_new***REMOVED*** rule applications added ({num_unseen***REMOVED*** novel)"),
        )
        print(prefix)
