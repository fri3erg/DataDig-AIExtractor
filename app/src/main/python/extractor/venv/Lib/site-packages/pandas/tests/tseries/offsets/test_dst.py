...
class TestDST:
    ...
    timezone_utc_offsets = {
        "US/Eastern": {"utc_offset_daylight": -4, "utc_offset_standard": -5***REMOVED***,
        "dateutil/US/Pacific": {"utc_offset_daylight": -7, "utc_offset_standard": -8***REMOVED***,
    ***REMOVED***
    ...
    def _test_offset(self, offset_name, offset_n, tstart, expected_utc_offset):
        offset = DateOffset(**{offset_name: offset_n***REMOVED***)
...
***REMOVED***
    ...
    def _make_timestamp(self, string, hrs_offset, tz):
        if hrs_offset >= 0:
            offset_string = f"{hrs_offset:02d***REMOVED***00"
        else:
            offset_string = f"-{(hrs_offset * -1):02***REMOVED***00"
...
def test_nontick_offset_with_ambiguous_time_error(original_dt, target_dt, offset, tz):
    ...
    msg = f"Cannot infer dst time from {target_dt***REMOVED***, try using the 'ambiguous' argument"
