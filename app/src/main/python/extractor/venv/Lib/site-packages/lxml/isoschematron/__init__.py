...
# some helpers
_schematron_root = '{%s***REMOVED***schema' % SCHEMATRON_NS
_xml_schema_root = '{%s***REMOVED***schema' % XML_SCHEMA_NS
...
svrl_validation_errors = _etree.XPath(
    '//svrl:failed-assert', namespaces={'svrl': SVRL_NS***REMOVED***)
...
class Schematron(_etree._Validator):
    ...
    ASSERTS_AND_REPORTS = _etree.XPath(
        ...
        namespaces={'svrl': SVRL_NS***REMOVED***)
    ...
    def __init__(self, etree=None, file=None, include=True, expand=True,
                 include_params={***REMOVED***, expand_params={***REMOVED***, compile_params={***REMOVED***,
        ...
        compile_kwargs = {'phase': phase***REMOVED***
