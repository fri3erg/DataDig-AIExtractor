...
***REMOVED***
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            file_path = f"{temp_dir***REMOVED***/{self.bucket***REMOVED***/{self.key***REMOVED***"
            os.makedirs(os.path.dirname(file_path), exist_ok=True)
            # Download the file to a destination
            logger.debug(f"get object key {self.key***REMOVED*** to file {file_path***REMOVED***")
            ...
            try:
                ...
                logger.error(f"load document error = {ex***REMOVED***")
