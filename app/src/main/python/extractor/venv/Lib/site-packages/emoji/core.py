...
def emojize(
    ...
    Replace emoji names in a string with Unicode codes.
        ...
        Python is fun 👍
        >>> print(emoji.emojize("Python is fun {thumbs_up***REMOVED***", delimiters = ("{", "***REMOVED***")))
        Python is fun 👍
...
def emoji_list(string):
    ...
    Returns the location and emoji in list of dict format.
        ...
        [{'match_start': 15, 'match_end': 16, 'emoji': '😁'***REMOVED***]
    """
    ...
    return [{
        ...
        'emoji': m.value.emoji,
    ***REMOVED*** for m in tokenize(string, keep_zwj=False) if isinstance(m.value, EmojiMatch)]


def distinct_emoji_list(string):
    """Returns distinct list of emojis from the string."""
    distinct_list = list(
        {e['emoji'] for e in emoji_list(string)***REMOVED***
    )
