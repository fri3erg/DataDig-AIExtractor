...
def _get_builtin_translator(vectorstore: VectorStore) -> Visitor:
    ...
    ***REMOVED***
    if isinstance(vectorstore, Qdrant):
        ...
        raise ValueError(
            f"Self query retriever with Vector Store type {vectorstore.__class__***REMOVED***"
            f" not supported."
        )
...
***REMOVED***
    ...
    def _prepare_query(
        ...
        if self.use_original_query:
            new_query = query
        search_kwargs = {**self.search_kwargs, **new_kwargs***REMOVED***
    ...
    def _get_relevant_documents(
        ...
        structured_query = self.query_constructor.invoke(
            {"query": query***REMOVED***, config={"callbacks": run_manager.get_child()***REMOVED***
        )
        if self.verbose:
            logger.info(f"Generated Query: {structured_query***REMOVED***")
    ...
    def from_llm(
        ...
        **kwargs: Any,
        ...
        chain_kwargs = chain_kwargs or {***REMOVED***
