        ...
        return {
            side: {
                "style": self._border_style(
                    props.get(f"border-{side***REMOVED***-style"),
                    props.get(f"border-{side***REMOVED***-width"),
                    self.color_to_excel(props.get(f"border-{side***REMOVED***-color")),
    ***REMOVED***,
                "color": self.color_to_excel(props.get(f"border-{side***REMOVED***-color")),
            ***REMOVED***
    ...
    def _border_style(self, style: str | None, width: str | None, color: str | None):
        ...
        if style == "dashed":
            ...
            warnings.warn(
                f"Unhandled border style format: {repr(style)***REMOVED***",
                CSSWarning,
...
***REMOVED***
    ...
    def build_fill(self, props: Mapping[str, str]):
        ...
        if fill_color not in (None, "transparent", "none"):
            return {"fgColor": self.color_to_excel(fill_color), "patternType": "solid"***REMOVED***

    def build_number_format(self, props: Mapping[str, str]) -> dict[str, str | None]:
        fc = props.get("number-format")
        fc = fc.replace("§", ";") if isinstance(fc, str) else fc
        return {"format_code": fc***REMOVED***
...
***REMOVED***(?=,|\s*$)
    ...
    def color_to_excel(self, val: str | None) -> str | None:
        ...
        try:
            ...
            warnings.warn(
                f"Unhandled color format: {repr(val)***REMOVED***",
                CSSWarning,
                stacklevel=find_stack_level(),
***REMOVED***
        return None
    ...
    def _is_shorthand_color(self, color_string: str) -> bool:
        ...
        if len(code) == 3:
            ...
            raise ValueError(f"Unexpected color {color_string***REMOVED***")
    ...
    ***REMOVED***
    ...
    def write(
        ...
        if num_rows > self.max_rows or num_cols > self.max_cols:
            raise ValueError(
                f"This sheet is too large! Your sheet size is: {num_rows***REMOVED***, {num_cols***REMOVED*** "
                f"Max sheet size is: {self.max_rows***REMOVED***, {self.max_cols***REMOVED***"
***REMOVED***
