...
class SpreadsheetDrawing(Serialisable):
    ...
    _path = PartName="/xl/drawings/drawing{0***REMOVED***.xml"
    _id = None
        ...
        for idx, obj in enumerate(self.charts + self.images, 1):
            ...
            if isinstance(obj, ChartBase):
                ...
                if not child:
                    ...
                    child.blipFill.blip.embed = "rId{0***REMOVED***".format(idx)
    ...
    def _chart_frame(self, idx):
        chart_rel = ChartRelation(f"rId{idx***REMOVED***")
        frame = GraphicFrame()
        nv = frame.nvGraphicFramePr.cNvPr
        nv.id = idx
        nv.name = "Chart {0***REMOVED***".format(idx)
    ...
    def _picture_frame(self, idx):
        ...
        pic.nvPicPr.cNvPr.name = "Image {0***REMOVED***".format(idx)

        pic.blipFill.blip = Blip()
        pic.blipFill.blip.embed = "rId{0***REMOVED***".format(idx)
