    ...
    def __init__(
            ...
            ***REMOVED***
            ...
            for key, value in kwargs.items():
                if key not in allowed:
                    message = f"{key!r***REMOVED*** is an invalid keyword argument for URL()"
                    raise TypeError(message)
                if value is not None and not isinstance(value, allowed[key]):
                    expected = allowed[key].__name__
                    seen = type(value).__name__
                    message = f"Argument {key!r***REMOVED*** must be {expected***REMOVED*** but got {seen***REMOVED***"
                    raise TypeError(message)
        ...
        if isinstance(url, str):
            ...
            raise TypeError(
                ...
                f" got {type(url)***REMOVED***: {url!r***REMOVED***"
***REMOVED***
    ...
    def __repr__(self) -> str:
        ...
        if ":" in userinfo:
            ...
            userinfo = f'{userinfo.split(":")[0]***REMOVED***:[secure]'

        authority = "".join(
            [
                f"{userinfo***REMOVED***@" if userinfo else "",
                f"[{host***REMOVED***]" if ":" in host else host,
                f":{port***REMOVED***" if port is not None else "",
            ]
        )
        url = "".join(
            [
                f"{self.scheme***REMOVED***:" if scheme else "",
                f"//{authority***REMOVED***" if authority else "",
                path,
                f"?{query***REMOVED***" if query is not None else "",
                f"#{fragment***REMOVED***" if fragment is not None else "",
            ]
        )

        return f"{self.__class__.__name__***REMOVED***({url!r***REMOVED***)"
...
class QueryParams(typing.Mapping[str, str]):
    ...
    def __init__(
        ...
        if value is None or isinstance(value, (str, bytes)):
            ...
            self._dict = {k: list(v) for k, v in value._dict.items()***REMOVED***
        else:
            dict_value: typing.Dict[typing.Any, typing.List[typing.Any]] = {***REMOVED***
            if isinstance(value, (list, tuple)):
                # Convert list inputs like:
                #     [("a", "123"), ("a", "456"), ("b", "789")]
                # To a dict representation, like:
                #     {"a": ["123", "456"], "b": ["789"]***REMOVED***
                for item in value:
                    dict_value.setdefault(item[0], []).append(item[1])
            else:
                # Convert dict inputs like:
                #    {"a": "123", "b": ["456", "789"]***REMOVED***
    ...
    def values(self) -> typing.ValuesView[str]:
        ...
        """
        return {k: v[0] for k, v in self._dict.items()***REMOVED***.values()
    ...
    def items(self) -> typing.ItemsView[str, str]:
        ...
        """
        return {k: v[0] for k, v in self._dict.items()***REMOVED***.items()
    ...
    def merge(self, params: typing.Optional[QueryParamTypes] = None) -> "QueryParams":
        ...
        q = httpx.QueryParams("a=123")
        q = q.merge({"b": "456"***REMOVED***)
        assert q == httpx.QueryParams("a=123&b=456")

        q = httpx.QueryParams("a=123")
        q = q.merge({"a": "456", "b": "789"***REMOVED***)
        assert q == httpx.QueryParams("a=456&b=789")
        """
        q = QueryParams(params)
        q._dict = {**self._dict, **q._dict***REMOVED***
        return q
    ...
    def __repr__(self) -> str:
        ...
        return f"{class_name***REMOVED***({query_string!r***REMOVED***)"
