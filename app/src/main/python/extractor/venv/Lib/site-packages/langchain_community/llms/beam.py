    ...
    ***REMOVED***
    ...
    def app_creation(self) -> None:
        ...
        app = beam.App(
            ...
            gpu="{gpu***REMOVED***",
            python_version="{python_version***REMOVED***",
            python_packages={python_packages***REMOVED***,
        )

        app.Trigger.RestAPI(
            inputs={{"prompt": beam.Types.String(), "max_length": beam.Types.String()***REMOVED******REMOVED***,
            outputs={{"text": beam.Types.String()***REMOVED******REMOVED***,
...
***REMOVED***
    ...
    def run_creation(self) -> None:
        ...
        def beam_langchain(**inputs):
            ...
            print(output)
            return {{"text": output***REMOVED******REMOVED***
...
***REMOVED***
        ...
        if process.returncode == 0:
            ...
            raise ValueError(
                ...
                Deployment output: {output***REMOVED***"""
***REMOVED***
        else:
            raise ValueError(f"Deployment failed. Error: {process.stderr***REMOVED***")
    ...
    def _call(
        ...
        **kwargs: Any,
        ...
        payload = {"prompt": prompt, "max_length": self.max_length***REMOVED***
