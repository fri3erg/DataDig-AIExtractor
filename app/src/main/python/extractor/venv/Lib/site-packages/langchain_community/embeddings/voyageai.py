...
def _check_response(response: dict) -> dict:
    if "data" not in response:
        raise RuntimeError(f"Voyage API Error. Message: {json.dumps(response)***REMOVED***")
    return response
...
class VoyageEmbeddings(BaseModel, Embeddings):
    ...
    def _invocation_params(
        ...
        params = {
            ...
            "headers": {"Authorization": f"Bearer {api_key***REMOVED***"***REMOVED***,
            "json": {"model": self.model, "input": input, "input_type": input_type***REMOVED***,
    ...
    ***REMOVED*** from e
        ...
        if input_type and input_type not in ["query", "document"]:
            raise ValueError(
                f"input_type {input_type***REMOVED*** is invalid. Options: None, 'query', "
                "'document'."
***REMOVED***
