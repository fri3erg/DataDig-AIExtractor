...
def test_arrow_array():
    ...
    expected = pa.array([{"left": i, "right": i + 1***REMOVED*** for i in range(1, 5)])
...
def test_arrow_array_missing():
    ...
    vals = [
        {"left": 0.0, "right": 1.0***REMOVED***,
        {"left": None, "right": None***REMOVED***,
        {"left": 2.0, "right": 3.0***REMOVED***,
    ]
...
def test_from_arrow_from_raw_struct_array():
    ...
    arr = pa.array([{"left": 0, "right": 1***REMOVED***, {"left": 1, "right": 2***REMOVED***])
