...
def raise_error(response, errors, message):
    error_message = "({***REMOVED***) {***REMOVED***{***REMOVED***".format(errors[0]["code"], errors[0]["message"], message)
        ...
        if response.status_code == 200:
            ...
            if status.lower() == "invalid":
                ...
                if train_result:
                    ...
                    if errors:
                        message = "\nInvalid model created with ID={***REMOVED***".format(body["modelInfo"]["modelId"])
