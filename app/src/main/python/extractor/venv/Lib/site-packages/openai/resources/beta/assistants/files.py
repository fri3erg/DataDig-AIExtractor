...
class Files(SyncAPIResource):
    ...
    def create(
        ...
        *,
        ...
        """
        if not assistant_id:
            raise ValueError(f"Expected a non-empty value for `assistant_id` but received {assistant_id!r***REMOVED***")
        extra_headers = {"OpenAI-Beta": "assistants=v1", **(extra_headers or {***REMOVED***)***REMOVED***
        return self._post(
            f"/assistants/{assistant_id***REMOVED***/files",
            body=maybe_transform({"file_id": file_id***REMOVED***, file_create_params.FileCreateParams),
...
***REMOVED***,
    ...
    def retrieve(
        ...
        *,
        ...
        extra_headers = {"OpenAI-Beta": "assistants=v1", **(extra_headers or {***REMOVED***)***REMOVED***
        return self._get(
            f"/assistants/{assistant_id***REMOVED***/files/{file_id***REMOVED***",
            options=make_request_options(
                extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout
***REMOVED***,
            cast_to=AssistantFile,
