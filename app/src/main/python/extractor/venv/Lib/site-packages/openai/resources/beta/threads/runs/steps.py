...
class Steps(SyncAPIResource):
    ...
    def retrieve(
        ...
        *,
        ...
        if not step_id:
            raise ValueError(f"Expected a non-empty value for `step_id` but received {step_id!r***REMOVED***")
        extra_headers = {"OpenAI-Beta": "assistants=v1", **(extra_headers or {***REMOVED***)***REMOVED***
        return self._get(
            f"/threads/{thread_id***REMOVED***/runs/{run_id***REMOVED***/steps/{step_id***REMOVED***",
    ...
    def list(
        ...
        *,
        ...
        return self._get_api_list(
            f"/threads/{thread_id***REMOVED***/runs/{run_id***REMOVED***/steps",
