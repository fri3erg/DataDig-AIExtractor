        ...
        if run_manager:
            if isinstance(run_manager, AsyncCallbackManagerForLLMRun):
                ...
                try:
                    ...
                    _log_error_once(f"Error in on_retry: {e***REMOVED***")
            else:
...
***REMOVED***
    ...
    def _convert_input(self, input: LanguageModelInput) -> PromptValue:
        if isinstance(input, PromptValue):
            ...
            raise ValueError(
                f"Invalid input type {type(input)***REMOVED***. "
...
***REMOVED***
    ...
    ***REMOVED***
            ...
            config = [{**c, "max_concurrency": None***REMOVED*** for c in config]  # type: ignore[misc]
            return [
                output
        ...
        **kwargs: Any,
        ...
        if not isinstance(prompts, list):
            raise ValueError(
                ...
                f" argument of type {type(prompts)***REMOVED***."
***REMOVED***
...
***REMOVED***
            ...
            metadata_list = cast(
                List[Optional[Dict[str, Any]]], metadata or ([{***REMOVED***] * len(prompts))
***REMOVED***
        ...
        **kwargs: Any,
        ...
        if not isinstance(prompt, str):
            raise ValueError(
                ...
                f"{type(prompt)***REMOVED***. If you want to run the LLM on multiple prompts, use "
                "`generate` instead."
***REMOVED***
        return (
            self.generate(
...
***REMOVED***
    ...
    def __str__(self) -> str:
        ...
        cls_name = f"\033[1m{self.__class__.__name__***REMOVED***\033[0m"
        return f"{cls_name***REMOVED***\nParams: {self._identifying_params***REMOVED***"
