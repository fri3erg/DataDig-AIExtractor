...
def _getNsTag(tag):
    if tag[0] == '{':
        return tuple(tag[1:].split('***REMOVED***', 1))
    else:
        return None, tag
...
class ElementTreeContentHandler(ContentHandler):
    ...
    def __init__(self, makeelement=None):
        ...
        self._ns_mapping = { None : [None] ***REMOVED***
        self._new_mappings = {***REMOVED***
    ...
    def _buildTag(self, ns_name_tuple):
        ...
        if ns_uri:
            el_tag = "{%s***REMOVED***%s" % ns_name_tuple
        elif self._default_ns:
            el_tag = "{%s***REMOVED***%s" % (self._default_ns, local_name)
        else:
            el_tag = local_name
        return el_tag
    ...
    def startElementNS(self, ns_name, qname, attributes=None):
        ...
        if attributes:
            ...
            for name_tuple, value in iter_attributes:
                if name_tuple[0]:
                    attr_name = "{%s***REMOVED***%s" % name_tuple
                else:
    ...
    def startElement(self, name, attributes=None):
        if attributes:
            attributes = {(None, k): v for k, v in attributes.items()***REMOVED***
...
class ElementTreeProducer:
    ...
    def __init__(self, element_or_tree, content_handler):
        ...
        self._empty_attributes = attr_class({***REMOVED***, {***REMOVED***)
    ...
    def saxify(self):
        ...
        if hasattr(element, 'getprevious'):
            ...
            for sibling in siblings[::-1]:
                self._recursive_saxify(sibling, {***REMOVED***)

        self._recursive_saxify(element, {***REMOVED***)
