...
class TestIBMModel(unittest.TestCase):
    ...
    def test_best_model2_alignment(self):
        ...
        translation_table = {
            "i": {"j'": 0.9, "aime": 0.05, "bien": 0.02, "jambon": 0.03, None: 0***REMOVED***,
            "love": {"j'": 0.05, "aime": 0.9, "bien": 0.01, "jambon": 0.01, None: 0.03***REMOVED***,
            "ham": {"j'": 0, "aime": 0.01, "bien": 0, "jambon": 0.99, None: 0***REMOVED***,
        ***REMOVED***
    ...
    def test_best_model2_alignment_handles_fertile_words(self):
        ...
        translation_table = {
            "i": {"j'": 0.9, "aime": 0.05, "bien": 0.02, "jambon": 0.03, None: 0***REMOVED***,
            "really": {"j'": 0, "aime": 0, "bien": 0.9, "jambon": 0.01, None: 0.09***REMOVED***,
            ",": {"j'": 0, "aime": 0, "bien": 0.3, "jambon": 0, None: 0.7***REMOVED***,
            "love": {"j'": 0.05, "aime": 0.9, "bien": 0.01, "jambon": 0.01, None: 0.03***REMOVED***,
            "ham": {"j'": 0, "aime": 0.01, "bien": 0, "jambon": 0.99, None: 0***REMOVED***,
        ***REMOVED***
        alignment_table = defaultdict(
