...
class ParquetSerializer(BaseSerializer):
    ...
    def load(self) -> Any:
        ...
        df = table.to_pandas()
        return {col: series.tolist() for col, series in df.items()***REMOVED***
...
***REMOVED***
    ...
    def add_texts(
        ...
        **kwargs: Any,
        ...
        self._metadatas.extend(metadatas or ([{***REMOVED***] * len(_texts)))
        ...
        return [
            (
                Document(
                    ...
                    metadata={"id": self._ids[idx], **self._metadatas[idx]***REMOVED***,
    ***REMOVED***,
                dist,
***REMOVED***
