...
def forbid_nonstring_types(
    ...
    For calling `.str.{method***REMOVED***` on a Series or Index, it is necessary to first
    ...
    allowed_types = {"string", "empty", "bytes", "mixed", "mixed-integer"***REMOVED*** - set(
        forbidden
    )
    ...
    def _forbid_nonstring_types(func: F) -> F:
        ...
        def wrapper(self, *args, **kwargs):
            if self._inferred_dtype not in allowed_types:
                msg = (
                    f"Cannot use .str.{func_name***REMOVED*** with values of "
                    f"inferred dtype '{self._inferred_dtype***REMOVED***'."
    ***REMOVED***
                raise TypeError(msg)
...
def _map_and_wrap(name: str | None, docstring: str | None):
    ...
    def wrapper(self):
        result = getattr(self._data.array, f"_str_{name***REMOVED***")()
...
***REMOVED***
    ...
    def __iter__(self) -> Iterator:
        raise TypeError(f"'{type(self).__name__***REMOVED***' object is not iterable")
    ...
    ***REMOVED***:
    ...
    def cat(
        ...
        join : {'left', 'right', 'outer', 'inner'***REMOVED***, default 'left'
...
***REMOVED***
   ...
   ***REMOVED***
    ...
    def get(self, i):
        ...
        >>> s = pd.Series([{"name": "Hello", "value": "World"***REMOVED***,
        ...               {"name": "Goodbye", "value": "Planet"***REMOVED***])
        >>> s.str.get('name')
        0      Hello
        1    Goodbye
        dtype: object
...
***REMOVED***
    ...
    def pad(
        ...
        side : {'left', 'right', 'both'***REMOVED***, default 'left'
        ...
        if not isinstance(fillchar, str):
            msg = f"fillchar must be a character, not {type(fillchar).__name__***REMOVED***"
            raise TypeError(msg)
        ...
        if not is_integer(width):
            msg = f"width must be of integer type, not {type(width).__name__***REMOVED***"
            raise TypeError(msg)
    ...
    @Appender(_shared_docs["str_pad"] % {"side": "left and right", "method": "center"***REMOVED***)
    @forbid_nonstring_types(["bytes"])
    def center(self, width: int, fillchar: str = " "):
        return self.pad(width, side="both", fillchar=fillchar)

    @Appender(_shared_docs["str_pad"] % {"side": "right", "method": "ljust"***REMOVED***)
    @forbid_nonstring_types(["bytes"])
    def ljust(self, width: int, fillchar: str = " "):
        return self.pad(width, side="right", fillchar=fillchar)

    @Appender(_shared_docs["str_pad"] % {"side": "left", "method": "rjust"***REMOVED***)
    @forbid_nonstring_types(["bytes"])
    ...
    @Appender(
        _shared_docs["str_strip"]
        % {"side": "left side", "method": "lstrip", "position": "leading"***REMOVED***
    )
    @forbid_nonstring_types(["bytes"])
    ...
    @Appender(
        _shared_docs["str_strip"]
        % {"side": "right side", "method": "rstrip", "position": "trailing"***REMOVED***
    )
    @forbid_nonstring_types(["bytes"])
    ...
    @Appender(
        _shared_docs["str_removefix"] % {"side": "prefix", "other_side": "suffix"***REMOVED***
    )
    @forbid_nonstring_types(["bytes"])
    ...
    @Appender(
        _shared_docs["str_removefix"] % {"side": "suffix", "other_side": "prefix"***REMOVED***
    )
    @forbid_nonstring_types(["bytes"])
    ...
    def translate(self, table):
        ...
        >>> mytable = str.maketrans({'ñ': 'n', 'ç': 'c'***REMOVED***)
    ...
    def startswith(
        ...
        if not isinstance(pat, (str, tuple)):
            msg = f"expected a string or tuple, not {type(pat).__name__***REMOVED***"
            raise TypeError(msg)
    ...
    ***REMOVED***
    ...
    def find(self, sub, start: int = 0, end=None):
        if not isinstance(sub, str):
            msg = f"expected a string object, not {type(sub).__name__***REMOVED***"
            raise TypeError(msg)
    ...
    def normalize(self, form):
        ...
        Parameters
        ----------
        form : {'NFC', 'NFKC', 'NFD', 'NFKD'***REMOVED***
            Unicode form.
    ...
    _doc_args: dict[str, dict[str, str]] = {***REMOVED***
    _doc_args["lower"] = {"type": "lowercase", "method": "lower", "version": ""***REMOVED***
    _doc_args["upper"] = {"type": "uppercase", "method": "upper", "version": ""***REMOVED***
    _doc_args["title"] = {"type": "titlecase", "method": "title", "version": ""***REMOVED***
    ...
    **Checks for Character Case**
    ...
    dtype: bool
    """
    _doc_args["isalnum"] = {"type": "alphanumeric", "method": "isalnum"***REMOVED***
    _doc_args["isalpha"] = {"type": "alphabetic", "method": "isalpha"***REMOVED***
    _doc_args["isdigit"] = {"type": "digits", "method": "isdigit"***REMOVED***
    _doc_args["isspace"] = {"type": "whitespace", "method": "isspace"***REMOVED***
    _doc_args["islower"] = {"type": "lowercase", "method": "islower"***REMOVED***
    _doc_args["isupper"] = {"type": "uppercase", "method": "isupper"***REMOVED***
    _doc_args["istitle"] = {"type": "titlecase", "method": "istitle"***REMOVED***
    _doc_args["isnumeric"] = {"type": "numeric", "method": "isnumeric"***REMOVED***
    _doc_args["isdecimal"] = {"type": "decimal", "method": "isdecimal"***REMOVED***
...
def _get_group_names(regex: re.Pattern) -> list[Hashable]:
    ...
    """
    names = {v: k for k, v in regex.groupindex.items()***REMOVED***
