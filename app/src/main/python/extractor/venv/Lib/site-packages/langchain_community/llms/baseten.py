    ...
    def _call(
        ...
        **kwargs: Any,
        ...
        if self.deployment == "production":
            model_url = f"https://model-{model_id***REMOVED***.api.baseten.co/production/predict"
        elif self.deployment == "development":
            model_url = f"https://model-{model_id***REMOVED***.api.baseten.co/development/predict"
        else:  # try specific deployment ID
            model_url = f"https://model-{model_id***REMOVED***.api.baseten.co/deployment/{self.deployment***REMOVED***/predict"
        response = requests.post(
            model_url,
            headers={"Authorization": f"Api-Key {baseten_api_key***REMOVED***"***REMOVED***,
            json={"prompt": prompt, **kwargs***REMOVED***,
        )
