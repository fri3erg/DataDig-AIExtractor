...
class Xinference(LLM):
    ...
    .. code-block:: python
        ...
        llm = Xinference(
            ...
            model_uid = {model_uid***REMOVED*** # replace model_uid with the model UID return from launching the model
        )

        llm(
            prompt="Q: where can we visit in the capital of France? A:",
            generate_config={"max_tokens": 1024, "stream": True***REMOVED***,
        )
...
***REMOVED*** from e
        ...
        model_kwargs = model_kwargs or {***REMOVED***
    ...
    def _identifying_params(self) -> Mapping[str, Any]:
        ...
        return {
            **{"server_url": self.server_url***REMOVED***,
            **{"model_uid": self.model_uid***REMOVED***,
    ...
    def _call(
        ...
        **kwargs: Any,
        ...
        generate_config: "LlamaCppGenerateConfig" = kwargs.get("generate_config", {***REMOVED***)

        generate_config = {**self.model_kwargs, **generate_config***REMOVED***
