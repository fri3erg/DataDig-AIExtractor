...
def global_parameters(b, c):
    ...
    intersection array  [b_0,b_1,.....b_{d-1***REMOVED***;c_1,c_2,.....c_d]
...
def intersection_array(G):
    ...
    [b_0,b_1,.....b_{d-1***REMOVED***;c_1,c_2,.....c_d]
    ...
    bint = {***REMOVED***  # 'b' intersection array
    cint = {***REMOVED***  # 'c' intersection array
    for u in G:
        for v in G:
            try:
                i = path_length[u][v]
