...
class ObsidianLoader(BaseLoader):
    ...
    TEMPLATE_VARIABLE_REGEX = re.compile(r"{{(.*?)***REMOVED******REMOVED***", re.DOTALL)
    ...
    def _replace_template_var(
        ...
        placeholder = f"__TEMPLATE_VAR_{len(placeholders)***REMOVED***__"
    ...
    def _restore_template_vars(self, obj: Any, placeholders: Dict[str, str]) -> Any:
        ...
        if isinstance(obj, str):
            for placeholder, value in placeholders.items():
                obj = obj.replace(placeholder, f"{{{{{value***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***")
    ...
    def _parse_front_matter(self, content: str) -> dict:
        ...
        placeholders: Dict[str, str] = {***REMOVED***
    ...
    def _to_langchain_compatible_metadata(self, metadata: dict) -> dict:
        ...
        for key, value in metadata.items():
            if type(value) in {str, int, float***REMOVED***:
                result[key] = value
            else:
    ...
    def _parse_document_tags(self, content: str) -> set:
        ...
        return {tag for tag in match***REMOVED***
