    ...
    ***REMOVED***
    ...
    def check_accumulate(self, ser: pd.Series, op_name: str, skipna: bool):
        ...
        if ser.dtype.name.startswith("U"):
            expected_dtype = f"UInt{length***REMOVED***"
        elif ser.dtype.name.startswith("I"):
            expected_dtype = f"Int{length***REMOVED***"
        ...
        if expected_dtype == "Float32" and op_name == "cumprod" and skipna:
            # TODO: xfail?
            pytest.skip(
                f"Float32 precision lead to large differences with op {op_name***REMOVED*** "
                f"and skipna={skipna***REMOVED***"
***REMOVED***
...
***REMOVED***
            ...
            raise NotImplementedError(f"{op_name***REMOVED*** not supported")
