...
@pytest.fixture
def left():
    return DataFrame({"key": ["a", "c", "e"], "lvalue": [1, 2.0, 3]***REMOVED***)


@pytest.fixture
def right():
    return DataFrame({"key": ["b", "c", "d", "f"], "rvalue": [1, 2, 3.0, 4]***REMOVED***)
...
class TestMergeOrdered:
    ...
    def test_doc_example(self):
        ...
        right = DataFrame({"key": ["b", "c", "d"], "rvalue": [1, 2, 3]***REMOVED***)
    ...
    @pytest.mark.parametrize(
        ...
        [
            (
                DataFrame({"G": ["g", "g"], "H": ["h", "h"], "T": [1, 3]***REMOVED***),
                DataFrame({"T": [2], "E": [1]***REMOVED***),
                ["T"],
                ["G", "H"],
                None,
                DataFrame(
...
***REMOVED***,
    ...
    def test_left_by_length_equals_to_right_shape0(self):
        ...
        expected = DataFrame(
            {"G": ["g"] * 3, "H": ["h"] * 3, "E": [1, 2, 3], "T": [np.nan, 1.0, np.nan]***REMOVED***
        )
    ...
    def test_elements_not_in_by_but_in_df(self):
        ...
        left = DataFrame([["g", "h", 1], ["g", "h", 3]], columns=list("GHE"))
        right = DataFrame([[2, 1]], columns=list("ET"))
        msg = r"\{'h'\***REMOVED*** not found in left columns"
