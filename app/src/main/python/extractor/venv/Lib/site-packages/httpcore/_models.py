...
def enforce_bytes(value: Union[bytes, str], *, name: str) -> bytes:
    ...
    if isinstance(value, str):
        try:
            ...
            raise TypeError(f"{name***REMOVED*** strings may not include unicode characters.")
    elif isinstance(value, bytes):
        return value

    seen_type = type(value).__name__
    raise TypeError(f"{name***REMOVED*** must be bytes or str, but got {seen_type***REMOVED***.")
...
def enforce_url(value: Union["URL", bytes, str], *, name: str) -> "URL":
    ...
    seen_type = type(value).__name__
    raise TypeError(f"{name***REMOVED*** must be a URL, bytes, or str, but got {seen_type***REMOVED***.")
...
***REMOVED***
    ...
    seen_type = type(value).__name__
    raise TypeError(
        f"{name***REMOVED*** must be a mapping or sequence of two-tuples, but got {seen_type***REMOVED***."
    )
...
class ByteStream:
    ...
    def __repr__(self) -> str:
        return f"<{self.__class__.__name__***REMOVED*** [{len(self._content)***REMOVED*** bytes]>"
...
class Origin:
    ...
    def __str__(self) -> str:
        ...
        port = str(self.port)
        return f"{scheme***REMOVED***://{host***REMOVED***:{port***REMOVED***"
...
***REMOVED***
    ...
    def __repr__(self) -> str:
        return (
            f"{self.__class__.__name__***REMOVED***(scheme={self.scheme!r***REMOVED***, "
            f"host={self.host!r***REMOVED***, port={self.port!r***REMOVED***, target={self.target!r***REMOVED***)"
        )
...
class Request:
    ...
    def __repr__(self) -> str:
        return f"<{self.__class__.__name__***REMOVED*** [{self.method!r***REMOVED***]>"
...
class Response:
    ...
    ***REMOVED***
    ...
    def __repr__(self) -> str:
        return f"<{self.__class__.__name__***REMOVED*** [{self.status***REMOVED***]>"
