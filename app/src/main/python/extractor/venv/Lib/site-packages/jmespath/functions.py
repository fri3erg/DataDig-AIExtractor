...
class Functions(metaclass=FunctionRegistry):
    ...
    ***REMOVED***
    ...
    @signature({'types': ['number']***REMOVED***)
    def _func_abs(self, arg):
        return abs(arg)

    @signature({'types': ['array-number']***REMOVED***)
    ...
    @signature({'types': [], 'variadic': True***REMOVED***)
    def _func_not_null(self, *arguments):
        for argument in arguments:
            if argument is not None:
                return argument

    @signature({'types': []***REMOVED***)
    ...
    @signature({'types': ['array', 'string']***REMOVED***, {'types': []***REMOVED***)
    def _func_contains(self, subject, search):
        return search in subject

    @signature({'types': ['string', 'array', 'object']***REMOVED***)
    def _func_length(self, arg):
        return len(arg)

    @signature({'types': ['string']***REMOVED***, {'types': ['string']***REMOVED***)
    ...
    @signature({'types': ['array', 'string']***REMOVED***)
    ...
    @signature({"types": ['string']***REMOVED***, {"types": ['array-string']***REMOVED***)
    def _func_join(self, separator, array):
        return separator.join(array)

    @signature({'types': ['expref']***REMOVED***, {'types': ['array']***REMOVED***)
    ...
    @signature({"types": ['array-number', 'array-string']***REMOVED***)
    ...
    @signature({"types": ["object"], "variadic": True***REMOVED***)
    ...
    @signature({"types": ['array-string', 'array-number']***REMOVED***)
    ...
    @signature({"types": ['object']***REMOVED***)
    ...
    @signature({'types': ['array']***REMOVED***, {'types': ['expref']***REMOVED***)
