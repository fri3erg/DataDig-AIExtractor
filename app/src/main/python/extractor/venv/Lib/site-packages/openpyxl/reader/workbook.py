...
***REMOVED***
    ...
    def find_sheets(self):
        ...
        for sheet in self.sheets:
            if not sheet.id:
                msg = f"File contains an invalid specification for {0***REMOVED***. This will be removed".format(sheet.name)
                warn(msg)
                continue
    ...
    def assign_names(self):
        ...
        for idx, names in self.defined_names.by_sheet().items():
            ...
            try:
                ...
                warn(f"Defined names for sheet index {idx***REMOVED*** cannot be located")
                continue
            ...
            for name, defn in names.items():
                ...
                if reserved is None:
                    ...
                    try:
                        ...
                        warn(f"Print area cannot be set to Defined name: {defn.value***REMOVED***.")
                        continue
