...
freqs = (
    [f"QE-{month***REMOVED***" for month in MONTHS]
    + [f"{annual***REMOVED***-{month***REMOVED***" for annual in ["YE", "BYE"] for month in MONTHS]
    + ["ME", "BME", "BMS"]
    + [f"WOM-{count***REMOVED***{day***REMOVED***" for count in range(1, 5) for day in DAYS]
    + [f"W-{day***REMOVED***" for day in DAYS]
)
...
def test_infer_freq_delta(base_delta_code_pair, count):
    ...
    exp_freq = f"{count:d***REMOVED***{code***REMOVED***" if count > 1 else code
