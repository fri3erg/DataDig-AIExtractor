...
Question: ${{Question with math problem.***REMOVED******REMOVED***
```text
${{single line mathematical expression that solves the problem***REMOVED******REMOVED***
```
...numexpr.evaluate(text)...
```output
${{Output of running the code***REMOVED******REMOVED***
```
