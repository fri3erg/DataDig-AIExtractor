...
class RedisFilterField:
    ...
    OPERATORS: Dict[RedisFilterOperator, str] = {***REMOVED***
    ...
    def _set_value(
        ...
        if operator not in self.OPERATORS:
            raise ValueError(
                f"Operator {operator***REMOVED*** not supported by {self.__class__.__name__***REMOVED***. "
                + f"Supported operators are {self.OPERATORS.values()***REMOVED***."
***REMOVED***

        if not isinstance(val, val_type):
            raise TypeError(
                f"Right side argument passed to operator {self.OPERATORS[operator]***REMOVED*** "
                f"with left side "
                f"argument {self.__class__.__name__***REMOVED*** must be of type {val_type***REMOVED***, "
                f"received value {val***REMOVED***"
***REMOVED***
        self._value = val
...
class RedisTag(RedisFilterField):
    ...
    ***REMOVED***
    OPERATOR_MAP: Dict[RedisFilterOperator, str] = {
        RedisFilterOperator.EQ: "@%s:{%s***REMOVED***",
        RedisFilterOperator.NE: "(-@%s:{%s***REMOVED***)",
        RedisFilterOperator.IN: "@%s:{%s***REMOVED***",
    ***REMOVED***
...
class RedisFilterExpression:
    ...
    Examples:
        ...
        >>> print(str(filter))
        (@brand:{nike***REMOVED*** @price:[-inf (100)])
    ...
    def format_expression(
        ...
        if _right == "*" != _left:
            return _left
        return f"({_left***REMOVED***{operator_str***REMOVED***{_right***REMOVED***)"
