...
class _RapidFuzzChainMixin(Chain):
    ...
    def _prepare_output(self, result: Dict[str, Any]) -> Dict[str, Any]:
        ...
        """
        result = {"score": result["score"]***REMOVED***
    ...
    def _get_metric(distance: str, normalize_score: bool = False) -> Callable:
        ...
        ***REMOVED***
        if distance not in module_map:
            raise ValueError(
                f"Invalid distance metric: {distance***REMOVED***"
                f"\nMust be one of: {list(StringDistance)***REMOVED***"
***REMOVED***
...
class StringDistanceEvalChain(StringEvaluator, _RapidFuzzChainMixin):
    ...
    def evaluation_name(self) -> str:
        ...
        """
        return f"{self.distance.value***REMOVED***_distance"
    ...
    def _call(
        ...
        """
        return {"score": self.compute_metric(inputs["reference"], inputs["prediction"])***REMOVED***
    ...
    def _evaluate_strings(
        ...
        **kwargs: Any,
        ...
        """
        result = self(
            inputs={"prediction": prediction, "reference": reference***REMOVED***,
            callbacks=callbacks,
            tags=tags,
            metadata=metadata,
...
class PairwiseStringDistanceEvalChain(PairwiseStringEvaluator, _RapidFuzzChainMixin):
    ...
    def evaluation_name(self) -> str:
        ...
        Returns:
            str: The evaluation name.
        """
        return f"pairwise_{self.distance.value***REMOVED***_distance"
    ...
    def _evaluate_string_pairs(
        ...
        **kwargs: Any,
        ...
        """
        result = self(
            inputs={"prediction": prediction, "prediction_b": prediction_b***REMOVED***,
            callbacks=callbacks,
            tags=tags,
            metadata=metadata,
            include_run_info=include_run_info,
