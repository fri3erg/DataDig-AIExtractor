    ...
    def roleset(self, roleset_id):
        ...
        for roleset in etree.findall("predicate/roleset"):
            if roleset.attrib["id"] == roleset_id:
                return roleset
        raise ValueError(f"Roleset {roleset_id***REMOVED*** not found in {framefile***REMOVED***")
...
class NombankInstance:
    ...
    def roleset(self):
        ...
        return f"{r***REMOVED***.{self.sensenumber***REMOVED***"

    def __repr__(self):
        return "<NombankInstance: {***REMOVED***, sent {***REMOVED***, word {***REMOVED***>".format(
            self.fileid,
            self.sentnum,
            self.wordnum,
        )
    ...
    def __str__(self):
        s = "{***REMOVED*** {***REMOVED*** {***REMOVED*** {***REMOVED*** {***REMOVED***".format(
            self.fileid,
            self.sentnum,
            self.wordnum,
            self.baseform,
        ...
        for (argloc, argid) in sorted(items):
            s += f" {argloc***REMOVED***-{argid***REMOVED***"
        return s
...
***REMOVED***
    ...
    def __str__(self):
        return f"{self.wordnum***REMOVED***:{self.height***REMOVED***"
