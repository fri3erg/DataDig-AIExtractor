...
@parametrize('func,args,filtered_args',
             [(f, [[], (1, )], {'x': 1, 'y': 0***REMOVED***),
              (f, [['x'], (1, )], {'y': 0***REMOVED***),
              (f, [['y'], (0, )], {'x': 0***REMOVED***),
              (f, [['y'], (0, ), {'y': 1***REMOVED***], {'x': 0***REMOVED***),
              (f, [['x', 'y'], (0, )], {***REMOVED***),
              (f, [[], (0,), {'y': 1***REMOVED***], {'x': 0, 'y': 1***REMOVED***),
              (f, [['y'], (), {'x': 2, 'y': 1***REMOVED***], {'x': 2***REMOVED***),
              (g, [[], (), {'x': 1***REMOVED***], {'x': 1***REMOVED***),
              (i, [[], (2, )], {'x': 2***REMOVED***)])
...
def test_filter_args_method():
    obj = Klass()
    assert filter_args(obj.f, [], (1, )) == {'x': 1, 'self': obj***REMOVED***


@parametrize('func,args,filtered_args',
             [(h, [[], (1, )],
               {'x': 1, 'y': 0, '*': [], '**': {***REMOVED******REMOVED***),
              (h, [[], (1, 2, 3, 4)],
               {'x': 1, 'y': 2, '*': [3, 4], '**': {***REMOVED******REMOVED***),
              (h, [[], (1, 25), {'ee': 2***REMOVED***],
               {'x': 1, 'y': 25, '*': [], '**': {'ee': 2***REMOVED******REMOVED***),
              (h, [['*'], (1, 2, 25), {'ee': 2***REMOVED***],
               {'x': 1, 'y': 2, '**': {'ee': 2***REMOVED******REMOVED***)])
def test_filter_varargs(func, args, filtered_args):
    assert filter_args(func, *args) == filtered_args


test_filter_kwargs_extra_params = [
    (m1, [[], (1,), {'y': 2***REMOVED***], {'x': 1, 'y': 2***REMOVED***),
    (m2, [[], (1,), {'y': 2***REMOVED***], {'x': 1, 'y': 2, 'z': 3***REMOVED***)
]


@parametrize('func,args,filtered_args',
             [(k, [[], (1, 2), {'ee': 2***REMOVED***],
               {'*': [1, 2], '**': {'ee': 2***REMOVED******REMOVED***),
              (k, [[], (3, 4)],
               {'*': [3, 4], '**': {***REMOVED******REMOVED***)] +
             test_filter_kwargs_extra_params)
...
def test_filter_args_2():
    assert (filter_args(j, [], (1, 2), {'ee': 2***REMOVED***) ==
            {'x': 1, 'y': 2, '**': {'ee': 2***REMOVED******REMOVED***)

    ff = functools.partial(f, 1)
    # filter_args has to special-case partial
    assert filter_args(ff, [], (1, )) == {'*': [1], '**': {***REMOVED******REMOVED***
    assert filter_args(ff, ['y'], (1, )) == {'*': [1], '**': {***REMOVED******REMOVED***
...
def test_filter_args_edge_cases():
    ...
    assert (filter_args(func_with_signature, ['b'], (1, 2)) == {'a': 1***REMOVED***)
...
@parametrize('func,args,kwargs,sgn_expected',
             [(g, [list(range(5))], {***REMOVED***, 'g([0, 1, 2, 3, 4])'),
              (k, [1, 2, (3, 4)], {'y': True***REMOVED***, 'k(1, 2, (3, 4), y=True)')])
...
def test_format_signature_long_arguments():
    ...
    kwargs = {str(i): arg for i, arg in enumerate(args)***REMOVED***
