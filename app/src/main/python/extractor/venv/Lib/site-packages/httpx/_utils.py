...
_HTML5_FORM_ENCODING_REPLACEMENTS = {'"': "%22", "\\": "\\\\"***REMOVED***
_HTML5_FORM_ENCODING_REPLACEMENTS.update(
    {chr(c): "%{:02X***REMOVED***".format(c) for c in range(0x1F + 1) if c != 0x1B***REMOVED***
)
...
def format_form_param(name: str, value: str) -> bytes:
    ...
    return f'{name***REMOVED***="{value***REMOVED***"'.encode()
...
def parse_header_links(value: str) -> typing.List[typing.Dict[str, str]]:
    ...
    would return
        [
            {"url": "http:/.../front.jpeg", "type": "image/jpeg"***REMOVED***,
            {"url": "http://.../back.jpeg"***REMOVED***,
        ]
...
SENSITIVE_HEADERS = {"authorization", "proxy-authorization"***REMOVED***
...
def port_or_default(url: "URL") -> typing.Optional[int]:
    if url.port is not None:
        return url.port
    return {"http": 80, "https": 443***REMOVED***.get(url.scheme)
...
def get_environment_proxies() -> typing.Dict[str, typing.Optional[str]]:
    ...
    mounts: typing.Dict[str, typing.Optional[str]] = {***REMOVED***

    for scheme in ("http", "https", "all"):
        if proxy_info.get(scheme):
            hostname = proxy_info[scheme]
            mounts[f"{scheme***REMOVED***://"] = (
                hostname if "://" in hostname else f"http://{hostname***REMOVED***"
***REMOVED***
    ...
    for hostname in no_proxy_hosts:
        ...
        if hostname == "*":
            ...
            if "://" in hostname:
                ...
                mounts[f"all://{hostname***REMOVED***"] = None
    ...
    def __init__(self, pattern: str) -> None:
        ...
        if pattern and ":" not in pattern:
            raise ValueError(
                ...
                f'Instead of "{pattern***REMOVED***", use "{pattern***REMOVED***://"'
***REMOVED***
        ...
        if not url.host or url.host == "*":
            ...
            self.host_regex = re.compile(f"^.+\\.{domain***REMOVED***$")
        elif url.host.startswith("*"):
