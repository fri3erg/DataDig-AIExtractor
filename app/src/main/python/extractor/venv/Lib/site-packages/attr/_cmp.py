...
_operation_names = {"eq": "==", "lt": "<", "le": "<=", "gt": ">", "ge": ">="***REMOVED***
...
def cmp_using(
    ...
    one of ``{lt, le, gt, ge***REMOVED***`` and ``eq``  are provided.
    ...
    ***REMOVED***
    ...
    type_ = types.new_class(
        class_name, (object,), {***REMOVED***, lambda ns: ns.update(body)
    )
...
def _make_operator(name, func):
    ...
    method.__name__ = f"__{name***REMOVED***__"
    method.__doc__ = (
        f"Return a {_operation_names[name]***REMOVED*** b.  Computed by attrs."
    )
