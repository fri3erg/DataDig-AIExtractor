...
class BoxPlot(LinePlot):
    ...
    def __init__(self, data, return_type: str = "axes", **kwargs) -> None:
        if return_type not in self._valid_return_types:
            raise ValueError("return_type must be {None, 'axes', 'dict', 'both'***REMOVED***")
        ...
        if isinstance(color, dict):
            ...
            for key in color:
                if key not in valid_keys:
                    raise ValueError(
                        f"color dict contains invalid key '{key***REMOVED***'. "
                        f"The key must be either {valid_keys***REMOVED***"
        ***REMOVED***
        return color
...
def _grouped_plot_by_column(
    ...
    **kwargs,
    ...
    fig.suptitle(f"Boxplot grouped by {byline***REMOVED***")
...
def boxplot(
    ...
    **kwds,
    ...
    if return_type not in BoxPlot._valid_return_types:
        raise ValueError("return_type must be {'axes', 'dict', 'both'***REMOVED***")
    ...
    if by is not None:
        ...
        if ax is None:
            rc = {"figure.figsize": figsize***REMOVED*** if figsize is not None else {***REMOVED***
