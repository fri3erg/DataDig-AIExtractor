...
def test_format_non_unique(df):
    ...
    # test dict
    html = df.style.format({"d": "{:.1f***REMOVED***"***REMOVED***).to_html()
...
def test_table_styles_dict_non_unique_index(styler):
    styles = styler.set_table_styles(
        {"j": [{"selector": "td", "props": "a: v;"***REMOVED***]***REMOVED***, axis=1
    ).table_styles
    assert styles == [
        {"selector": "td.row1", "props": [("a", "v")]***REMOVED***,
        {"selector": "td.row2", "props": [("a", "v")]***REMOVED***,
    ]


def test_table_styles_dict_non_unique_columns(styler):
    styles = styler.set_table_styles(
        {"d": [{"selector": "td", "props": "a: v;"***REMOVED***]***REMOVED***, axis=0
    ).table_styles
    assert styles == [
        {"selector": "td.col1", "props": [("a", "v")]***REMOVED***,
        {"selector": "td.col2", "props": [("a", "v")]***REMOVED***,
    ]
