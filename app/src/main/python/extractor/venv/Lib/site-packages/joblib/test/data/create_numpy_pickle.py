...
def write_test_pickle(to_pickle, args):
    ...
    py_version = '{0[0]***REMOVED***{0[1]***REMOVED***'.format(sys.version_info)
    ...
    if compress:
        if method == 'zlib':
            ...
            extension = '.pkl.{***REMOVED***'.format(method)
        if args.cache_size:
            kwargs['cache_size'] = 0
            body += '_cache_size'
    else:
    ...
    pickle_filename = 'joblib_{***REMOVED***{***REMOVED***_pickle_py{***REMOVED***_np{***REMOVED***{***REMOVED***'.format(
    ...
    try:
        ...
        print("Error: cannot generate file '{***REMOVED***' with arguments '{***REMOVED***'. "
              "Error was: {***REMOVED***".format(pickle_filename, kwargs, e))
    else:
        print("File '{***REMOVED***' generated successfully.".format(pickle_filename))
