    ...
    ***REMOVED***
    ...
    def client_options(self) -> "ClientOptions":
        ...
        return ClientOptions(
            api_endpoint=f"{self.location_id***REMOVED***-discoveryengine.googleapis.com"
...
***REMOVED***
            ...
            documents.append(
                Document(
                    page_content=json.dumps(document_dict.get("struct_data", {***REMOVED***)),
                    metadata={"id": document_dict["id"], "name": document_dict["name"]***REMOVED***,
    ***REMOVED***
***REMOVED***
...
***REMOVED***
            ...
            doc_metadata = document_dict.get("struct_data", {***REMOVED***)
            ...
            for chunk in derived_struct_data[chunk_type]:
                ...
                if chunk_type == "extractive_answers":
                    doc_metadata["source"] += f":{chunk.get('pageNumber', '')***REMOVED***"
...
***REMOVED***
    ...
    ***REMOVED***
        ...
        if not documents:
            print(f"No {chunk_type***REMOVED*** could be found.")
            if chunk_type == "extractive_answers":
                print(
...
***REMOVED***
            ...
            raise NotImplementedError(
                ...
                + f" Got {self.engine_data_type***REMOVED***"
***REMOVED***
