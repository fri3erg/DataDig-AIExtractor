...
class QAEvalChain(LLMChain, StringEvaluator, LLMEvalChain):
    ...
    def from_llm(
        ...
        **kwargs: Any,
        ...
        expected_input_vars = {"query", "answer", "result"***REMOVED***
        if expected_input_vars != set(prompt.input_variables):
            raise ValueError(
                f"Input variables should be {expected_input_vars***REMOVED***, "
                f"but got {prompt.input_variables***REMOVED***"
***REMOVED***
    ...
    async def _aevaluate_strings(
        ...
        **kwargs: Any,
        ...
        result = await self.acall(
            inputs={"query": input, "answer": reference, "result": prediction***REMOVED***,
            callbacks=callbacks,
            include_run_info=include_run_info,
        )
        return self._prepare_output(result)
...
class ContextQAEvalChain(LLMChain, StringEvaluator, LLMEvalChain):
    ...
    def _validate_input_vars(cls, prompt: PromptTemplate) -> None:
        expected_input_vars = {"query", "context", "result"***REMOVED***
        if expected_input_vars != set(prompt.input_variables):
            raise ValueError(
                f"Input variables should be {expected_input_vars***REMOVED***, "
                f"but got {prompt.input_variables***REMOVED***"
***REMOVED***
    ...
    async def _aevaluate_strings(
        ...
        **kwargs: Any,
        ...
        result = await self.acall(
            inputs={"query": input, "context": reference, "result": prediction***REMOVED***,
            callbacks=callbacks,
            include_run_info=include_run_info,
        )
        return self._prepare_output(result)
