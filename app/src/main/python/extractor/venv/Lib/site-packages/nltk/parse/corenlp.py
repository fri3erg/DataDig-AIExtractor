...
***REMOVED***
        ...
        self.url = f"http://localhost:{port***REMOVED***"
...
***REMOVED***
        ...
        if returncode is not None:
            ...
            raise CoreNLPServerError(
                ...
                "The error was: {***REMOVED***".format(stderrdata.decode("ascii")),
***REMOVED***
...
class GenericCoreNLPParser(ParserI, TokenizerI, TaggerI):
    ...
    def raw_parse(self, sentence, properties=None, *args, **kwargs):
        ...
        :rtype: iter(Tree)
        """
        default_properties = {"tokenize.whitespace": "false"***REMOVED***
        default_properties.update(properties or {***REMOVED***)
...
***REMOVED***
    ...
    def api_call(self, data, properties=None, timeout=60):
        default_properties = {
            "outputFormat": "json",
            "annotators": "tokenize,pos,lemma,ssplit,{parser_annotator***REMOVED***".format(
...
***REMOVED***,
        ***REMOVED***
        ...
        response = self.session.post(
            self.url,
            params={"properties": json.dumps(default_properties)***REMOVED***,
            data=data.encode(self.encoding),
            headers={"Content-Type": f"text/plain; charset={self.encoding***REMOVED***"***REMOVED***,
            timeout=timeout,
        )
    ...
    def tokenize(self, text, properties=None):
        ...
        ...             properties={'tokenize.options': 'americanize=true'***REMOVED***,
        ...     )
        ... )
        ['The', 'colour', 'of', 'the', 'wall', 'is', 'blue', '.']
        >>> server.stop()
        ...
        """
        default_properties = {"annotators": "tokenize,ssplit"***REMOVED***
