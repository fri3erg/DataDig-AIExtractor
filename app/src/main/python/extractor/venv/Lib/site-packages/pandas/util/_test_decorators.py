...
def skip_if_installed(package: str) -> pytest.MarkDecorator:
    ...
    return pytest.mark.skipif(
        ...
        reason=f"Skipping because {package***REMOVED*** is installed.",
    )
...
def skip_if_no(package: str, min_version: str | None = None) -> pytest.MarkDecorator:
    ...
    pytest.MarkDecorator
        ...
        parametrization mark.
    """
    msg = f"Could not import '{package***REMOVED***'"
    if min_version:
        msg += f" satisfying a min_version of {min_version***REMOVED***"
    return pytest.mark.skipif(
        not bool(
...
skip_if_not_us_locale = pytest.mark.skipif(
    ...
    reason=f"Set local {locale.getlocale()[0]***REMOVED*** is not en_US",
)
...
def parametrize_fixture_doc(*args) -> Callable[[F], F]:
    ...
    initial fixture docstring by replacing placeholders {0***REMOVED***, {1***REMOVED*** etc
