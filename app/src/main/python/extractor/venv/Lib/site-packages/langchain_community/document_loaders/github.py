        ...
        if v:
            try:
                ...
                raise ValueError(
                    ...
                    f"YYYY-MM-DDTHH:MM:SSZ format. Received: {v***REMOVED***"
    ***REMOVED***
        return v
    ...
    def query_params(self) -> str:
        ...
        ***REMOVED***
        query_params_list = [
            f"{k***REMOVED***={v***REMOVED***" for k, v in query_params_dict.items() if v is not None
        ]
    ...
    def url(self) -> str:
        ...
        return f"{self.github_api_url***REMOVED***/repos/{self.repo***REMOVED***/issues?{self.query_params***REMOVED***"
