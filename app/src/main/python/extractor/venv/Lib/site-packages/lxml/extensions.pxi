...
cdef class _BaseContext:
    ...
    def __init__(self, namespaces, extensions, error_log, enable_regexp,
        ...
        cdef list ns
        self._utf_refs = {***REMOVED***
        self._global_namespaces = []
        self._function_cache = {***REMOVED***
        ...
        if extensions is not None:
            ...
            # format: [ {(ns, name):function***REMOVED*** ] -> {(ns_utf, name_utf):function***REMOVED***
            new_extensions = {***REMOVED***
    ...
    def eval_context(self):
        if self._eval_context_dict is None:
            self._eval_context_dict = {***REMOVED***
                ...
                if isinstance(value, _Element):
                    ...
                    if context is None or doc is None:
                        raise XPathResultError, \
                              f"Non-Element values not supported at this point - got {value!r***REMOVED***"
                    ...
                    if isinstance(value, bytes):
                        ...
                        raise XPathResultError, \
                              f"This is not a supported node-set result: {value!r***REMOVED***"
        except:
            xpath.xmlXPathFreeNodeSet(resultSet)
            raise
    else:
        raise XPathResultError, f"Unknown return type: {python._fqtypename(obj).decode('utf8')***REMOVED***"
...
cdef object _unwrapXPathObject(xpath.xmlXPathObject* xpathObj,
    ...
    if xpathObj.type == xpath.XPATH_UNDEFINED:
        ...
        raise XPathResultError, f"Unknown xpath result {xpathObj.type***REMOVED***"
...
cdef _unpackNodeSetEntry(list results, xmlNode* c_node, _Document doc,
    ...
    if _isElement(c_node):
        ...
        raise NotImplementedError, \
            f"Not yet implemented result node type: {c_node.type***REMOVED***"
    ...
    try:
        ...
        if function is not None:
            ...
            context._exc._store_exception(XPathFunctionError(
                f"XPath function '{_namespacedNameFromNsName(rctxt.functionURI, rctxt.function)***REMOVED***' not found"))
    except:
