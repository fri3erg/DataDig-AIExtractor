...
***REMOVED***,
        ...
        for waiter in waiters:
            ...
            breadcrumb_section.write(f' / Waiter / {waiter.name***REMOVED***')
...
def document_resource_waiter(
    ...
    description = (
        'Waits until this {***REMOVED*** is {***REMOVED***. This method calls '
        ':py:meth:`{***REMOVED***.Waiter.{***REMOVED***.wait` which polls '
        ':py:meth:`{***REMOVED***.Client.{***REMOVED***` every {***REMOVED*** seconds until '
        'a successful state is reached. An error is returned '
        'after {***REMOVED*** failed checks.'.format(
            resource_name,
    ...
    example_prefix = '{***REMOVED***.{***REMOVED***'.format(
        xform_name(resource_name), resource_waiter_model.name
    )
    full_waiter_name = (
        f"{section.context.get('qualifier', '')***REMOVED***{resource_waiter_model.name***REMOVED***"
    )
