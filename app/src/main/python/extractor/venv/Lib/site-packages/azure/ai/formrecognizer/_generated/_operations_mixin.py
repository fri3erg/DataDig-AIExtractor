    ...
    def authorize_copy_document_model(
        ...
        **kwargs  # type: Any
        ...
        if api_version == '2022-08-31':
            from .v2022_08_31.operations import FormRecognizerClientOperationsMixin as OperationClass
        else:
            raise ValueError("API version {***REMOVED*** does not have operation 'authorize_copy_document_model'".format(api_version))
    ...
    def begin_analyze_business_card_async(  # pylint: disable=inconsistent-return-statements
        ...
        **kwargs  # type: Any
        ...
        if api_version == '2.1':
            ...
            raise ValueError("API version {***REMOVED*** does not have operation 'begin_analyze_business_card_async'".format(api_version))
        mixin_instance = OperationClass()
        mixin_instance._client = self._client
        mixin_instance._config = self._config
        mixin_instance._serialize = Serializer(self._models_dict(api_version))
    ...
    def begin_analyze_document(  # pylint: disable=inconsistent-return-statements
        ...
        **kwargs  # type: Any
        ...
        if api_version == '2022-08-31':
            ...
            raise ValueError("API version {***REMOVED*** does not have operation 'begin_analyze_document'".format(api_version))
        mixin_instance = OperationClass()
        mixin_instance._client = self._client
        mixin_instance._config = self._config
        mixin_instance._serialize = Serializer(self._models_dict(api_version))
    ...
    def begin_analyze_id_document_async(  # pylint: disable=inconsistent-return-statements
        ...
        **kwargs  # type: Any
        ...
        if api_version == '2.1':
            ...
            raise ValueError("API version {***REMOVED*** does not have operation 'begin_analyze_id_document_async'".format(api_version))
        mixin_instance = OperationClass()
        mixin_instance._client = self._client
        mixin_instance._config = self._config
        mixin_instance._serialize = Serializer(self._models_dict(api_version))
    ...
    def begin_analyze_invoice_async(  # pylint: disable=inconsistent-return-statements
        ...
        **kwargs  # type: Any
        ...
        if api_version == '2.1':
            ...
            raise ValueError("API version {***REMOVED*** does not have operation 'begin_analyze_invoice_async'".format(api_version))
        mixin_instance = OperationClass()
        mixin_instance._client = self._client
        mixin_instance._config = self._config
        mixin_instance._serialize = Serializer(self._models_dict(api_version))
    ...
    def begin_analyze_layout_async(  # pylint: disable=inconsistent-return-statements
        ...
        **kwargs  # type: Any
        ...
        if api_version == '2.0':
            ...
            raise ValueError("API version {***REMOVED*** does not have operation 'begin_analyze_layout_async'".format(api_version))
        mixin_instance = OperationClass()
        mixin_instance._client = self._client
        mixin_instance._config = self._config
        mixin_instance._serialize = Serializer(self._models_dict(api_version))
    ...
    def begin_analyze_receipt_async(  # pylint: disable=inconsistent-return-statements
        ...
        **kwargs  # type: Any
        ...
        if api_version == '2.0':
            ...
            raise ValueError("API version {***REMOVED*** does not have operation 'begin_analyze_receipt_async'".format(api_version))
        mixin_instance = OperationClass()
        mixin_instance._client = self._client
        mixin_instance._config = self._config
        mixin_instance._serialize = Serializer(self._models_dict(api_version))
    ...
    def begin_analyze_with_custom_model(  # pylint: disable=inconsistent-return-statements
        ...
        **kwargs  # type: Any
        ...
        if api_version == '2.0':
            ...
            raise ValueError("API version {***REMOVED*** does not have operation 'begin_analyze_with_custom_model'".format(api_version))
        mixin_instance = OperationClass()
        mixin_instance._client = self._client
        mixin_instance._config = self._config
        mixin_instance._serialize = Serializer(self._models_dict(api_version))
    ...
    def begin_build_document_model(  # pylint: disable=inconsistent-return-statements
        ...
        **kwargs  # type: Any
        ...
        if api_version == '2022-08-31':
            ...
            raise ValueError("API version {***REMOVED*** does not have operation 'begin_build_document_model'".format(api_version))
        mixin_instance = OperationClass()
        mixin_instance._client = self._client
        mixin_instance._config = self._config
        mixin_instance._serialize = Serializer(self._models_dict(api_version))
    ...
    def begin_compose_custom_models_async(  # pylint: disable=inconsistent-return-statements
        ...
        **kwargs  # type: Any
        ...
        if api_version == '2.1':
            ...
            raise ValueError("API version {***REMOVED*** does not have operation 'begin_compose_custom_models_async'".format(api_version))
        mixin_instance = OperationClass()
        mixin_instance._client = self._client
        mixin_instance._config = self._config
        mixin_instance._serialize = Serializer(self._models_dict(api_version))
    ...
    def begin_compose_document_model(  # pylint: disable=inconsistent-return-statements
        ...
        **kwargs  # type: Any
        ...
        if api_version == '2022-08-31':
            ...
            raise ValueError("API version {***REMOVED*** does not have operation 'begin_compose_document_model'".format(api_version))
        mixin_instance = OperationClass()
        mixin_instance._client = self._client
        mixin_instance._config = self._config
        mixin_instance._serialize = Serializer(self._models_dict(api_version))
    ...
    def begin_copy_custom_model(  # pylint: disable=inconsistent-return-statements
        ...
        **kwargs  # type: Any
        ...
        if api_version == '2.0':
            ...
            raise ValueError("API version {***REMOVED*** does not have operation 'begin_copy_custom_model'".format(api_version))
        mixin_instance = OperationClass()
        mixin_instance._client = self._client
        mixin_instance._config = self._config
        mixin_instance._serialize = Serializer(self._models_dict(api_version))
    ...
    def begin_copy_document_model_to(  # pylint: disable=inconsistent-return-statements
        ...
        **kwargs  # type: Any
        ...
        if api_version == '2022-08-31':
            ...
            raise ValueError("API version {***REMOVED*** does not have operation 'begin_copy_document_model_to'".format(api_version))
        mixin_instance = OperationClass()
        mixin_instance._client = self._client
        mixin_instance._config = self._config
        mixin_instance._serialize = Serializer(self._models_dict(api_version))
    ...
    def begin_train_custom_model_async(  # pylint: disable=inconsistent-return-statements
        ...
        **kwargs  # type: Any
        ...
        if api_version == '2.1':
            ...
            raise ValueError("API version {***REMOVED*** does not have operation 'begin_train_custom_model_async'".format(api_version))
        mixin_instance = OperationClass()
        mixin_instance._client = self._client
        mixin_instance._config = self._config
        mixin_instance._serialize = Serializer(self._models_dict(api_version))
    ...
    def delete_custom_model(  # pylint: disable=inconsistent-return-statements
        ...
        **kwargs  # type: Any
        ...
        if api_version == '2.0':
            ...
            raise ValueError("API version {***REMOVED*** does not have operation 'delete_custom_model'".format(api_version))
        mixin_instance = OperationClass()
        mixin_instance._client = self._client
        mixin_instance._config = self._config
        mixin_instance._serialize = Serializer(self._models_dict(api_version))
    ...
    def delete_document_model(  # pylint: disable=inconsistent-return-statements
        ...
        **kwargs  # type: Any
        ...
        if api_version == '2022-08-31':
            ...
            raise ValueError("API version {***REMOVED*** does not have operation 'delete_document_model'".format(api_version))
        mixin_instance = OperationClass()
        mixin_instance._client = self._client
        mixin_instance._config = self._config
        mixin_instance._serialize = Serializer(self._models_dict(api_version))
    ...
    def generate_model_copy_authorization(
        ...
        **kwargs  # type: Any
        ...
        if api_version == '2.0':
            ...
            raise ValueError("API version {***REMOVED*** does not have operation 'generate_model_copy_authorization'".format(api_version))
        mixin_instance = OperationClass()
        mixin_instance._client = self._client
        mixin_instance._config = self._config
        mixin_instance._serialize = Serializer(self._models_dict(api_version))
    ...
    def get_analyze_business_card_result(
        ...
        **kwargs  # type: Any
        ...
        if api_version == '2.1':
            ...
            raise ValueError("API version {***REMOVED*** does not have operation 'get_analyze_business_card_result'".format(api_version))
        mixin_instance = OperationClass()
        mixin_instance._client = self._client
        mixin_instance._config = self._config
        mixin_instance._serialize = Serializer(self._models_dict(api_version))
    ...
    def get_analyze_document_result(
        ...
        **kwargs  # type: Any
        ...
        if api_version == '2022-08-31':
            ...
            raise ValueError("API version {***REMOVED*** does not have operation 'get_analyze_document_result'".format(api_version))
        mixin_instance = OperationClass()
        mixin_instance._client = self._client
        mixin_instance._config = self._config
        mixin_instance._serialize = Serializer(self._models_dict(api_version))
    ...
    def get_analyze_form_result(
        ...
        **kwargs  # type: Any
        ...
        if api_version == '2.0':
            ...
            raise ValueError("API version {***REMOVED*** does not have operation 'get_analyze_form_result'".format(api_version))
        mixin_instance = OperationClass()
        mixin_instance._client = self._client
        mixin_instance._config = self._config
        mixin_instance._serialize = Serializer(self._models_dict(api_version))
    ...
    def get_analyze_id_document_result(
        ...
        **kwargs  # type: Any
        ...
        if api_version == '2.1':
            ...
            raise ValueError("API version {***REMOVED*** does not have operation 'get_analyze_id_document_result'".format(api_version))
        mixin_instance = OperationClass()
        mixin_instance._client = self._client
        mixin_instance._config = self._config
        mixin_instance._serialize = Serializer(self._models_dict(api_version))
    ...
    def get_analyze_invoice_result(
        ...
        **kwargs  # type: Any
        ...
        if api_version == '2.1':
            ...
            raise ValueError("API version {***REMOVED*** does not have operation 'get_analyze_invoice_result'".format(api_version))
        mixin_instance = OperationClass()
        mixin_instance._client = self._client
        mixin_instance._config = self._config
        mixin_instance._serialize = Serializer(self._models_dict(api_version))
    ...
    def get_analyze_layout_result(
        ...
        **kwargs  # type: Any
        ...
        if api_version == '2.0':
            ...
            raise ValueError("API version {***REMOVED*** does not have operation 'get_analyze_layout_result'".format(api_version))
        mixin_instance = OperationClass()
        mixin_instance._client = self._client
        mixin_instance._config = self._config
        mixin_instance._serialize = Serializer(self._models_dict(api_version))
    ...
    def get_analyze_receipt_result(
        ...
        **kwargs  # type: Any
        ...
        if api_version == '2.0':
            ...
            raise ValueError("API version {***REMOVED*** does not have operation 'get_analyze_receipt_result'".format(api_version))
        mixin_instance = OperationClass()
        mixin_instance._client = self._client
        mixin_instance._config = self._config
        mixin_instance._serialize = Serializer(self._models_dict(api_version))
    ...
    def get_custom_model(
        ...
        **kwargs  # type: Any
        ...
        if api_version == '2.0':
            ...
            raise ValueError("API version {***REMOVED*** does not have operation 'get_custom_model'".format(api_version))
        mixin_instance = OperationClass()
        mixin_instance._client = self._client
        mixin_instance._config = self._config
        mixin_instance._serialize = Serializer(self._models_dict(api_version))
    ...
    def get_custom_model_copy_result(
        ...
        **kwargs  # type: Any
        ...
        if api_version == '2.0':
            ...
            raise ValueError("API version {***REMOVED*** does not have operation 'get_custom_model_copy_result'".format(api_version))
        mixin_instance = OperationClass()
        mixin_instance._client = self._client
        mixin_instance._config = self._config
        mixin_instance._serialize = Serializer(self._models_dict(api_version))
    ...
    def get_custom_models(
        ...
        **kwargs  # type: Any
        ...
        if api_version == '2.0':
            ...
            raise ValueError("API version {***REMOVED*** does not have operation 'get_custom_models'".format(api_version))
        mixin_instance = OperationClass()
        mixin_instance._client = self._client
        mixin_instance._config = self._config
        mixin_instance._serialize = Serializer(self._models_dict(api_version))
    ...
    def get_document_model(
        ...
        **kwargs  # type: Any
        ...
        if api_version == '2022-08-31':
            ...
            raise ValueError("API version {***REMOVED*** does not have operation 'get_document_model'".format(api_version))
        mixin_instance = OperationClass()
        mixin_instance._client = self._client
        mixin_instance._config = self._config
        mixin_instance._serialize = Serializer(self._models_dict(api_version))
    ...
    def get_document_models(
        ...
        **kwargs  # type: Any
        ...
        if api_version == '2022-08-31':
            ...
            raise ValueError("API version {***REMOVED*** does not have operation 'get_document_models'".format(api_version))
        mixin_instance = OperationClass()
        mixin_instance._client = self._client
        mixin_instance._config = self._config
        mixin_instance._serialize = Serializer(self._models_dict(api_version))
    ...
    def get_operation(
        ...
        **kwargs  # type: Any
        ...
        if api_version == '2022-08-31':
            ...
            raise ValueError("API version {***REMOVED*** does not have operation 'get_operation'".format(api_version))
        mixin_instance = OperationClass()
        mixin_instance._client = self._client
        mixin_instance._config = self._config
        mixin_instance._serialize = Serializer(self._models_dict(api_version))
    ...
    def get_operations(
        ...
        **kwargs  # type: Any
        ...
        if api_version == '2022-08-31':
            ...
            raise ValueError("API version {***REMOVED*** does not have operation 'get_operations'".format(api_version))
        mixin_instance = OperationClass()
        mixin_instance._client = self._client
        mixin_instance._config = self._config
        mixin_instance._serialize = Serializer(self._models_dict(api_version))
    ...
    def get_resource_details(
        ...
        **kwargs  # type: Any
        ...
        if api_version == '2022-08-31':
            ...
            raise ValueError("API version {***REMOVED*** does not have operation 'get_resource_details'".format(api_version))
        mixin_instance = OperationClass()
        mixin_instance._client = self._client
        mixin_instance._config = self._config
        mixin_instance._serialize = Serializer(self._models_dict(api_version))
    ...
    def list_custom_models(
        ...
        **kwargs  # type: Any
        ...
        if api_version == '2.0':
            ...
            raise ValueError("API version {***REMOVED*** does not have operation 'list_custom_models'".format(api_version))
        mixin_instance = OperationClass()
        mixin_instance._client = self._client
        mixin_instance._config = self._config
        mixin_instance._serialize = Serializer(self._models_dict(api_version))
    ...
    def train_custom_model_async(  # pylint: disable=inconsistent-return-statements
        ...
        **kwargs  # type: Any
        ...
        if api_version == '2.0':
            ...
            raise ValueError("API version {***REMOVED*** does not have operation 'train_custom_model_async'".format(api_version))
        mixin_instance = OperationClass()
        mixin_instance._client = self._client
        mixin_instance._config = self._config
        mixin_instance._serialize = Serializer(self._models_dict(api_version))
