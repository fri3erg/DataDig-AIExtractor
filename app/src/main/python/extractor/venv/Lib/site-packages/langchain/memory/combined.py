...
class CombinedMemory(BaseMemory):
    ...
    def check_repeated_memory_variable(
        ...
        for val in value:
            ...
            if overlap:
                raise ValueError(
                    f"The same variables {overlap***REMOVED*** are found in multiple"
    ...
    ***REMOVED***
    ...
    def load_memory_variables(self, inputs: Dict[str, Any]) -> Dict[str, str]:
        ...
        memory_data: Dict[str, Any] = {***REMOVED***
        ...
        for memory in self.memories:
            ...
            for key, value in data.items():
                if key in memory_data:
                    raise ValueError(
                        f"The variable {key***REMOVED*** is repeated in the CombinedMemory."
        ***REMOVED***
