...
def skolemize(expression, univ_scope=None, used_variables=None):
    ...
    if isinstance(expression, AllExpression):
        term = skolemize(
            expression.term,
            univ_scope | {expression.variable***REMOVED***,
            used_variables | {expression.variable***REMOVED***,
        )
        return term.replace(
            expression.variable,
        ...
        if isinstance(negated, AllExpression):
            term = skolemize(
                -negated.term, univ_scope, used_variables | {negated.variable***REMOVED***
***REMOVED***
            if univ_scope:
...
***REMOVED***
            ...
            term = skolemize(
                -negated.term,
                univ_scope | {negated.variable***REMOVED***,
                used_variables | {negated.variable***REMOVED***,
***REMOVED***
            return term.replace(
                negated.variable,
                VariableExpression(unique_variable(ignore=used_variables)),
***REMOVED***
        ...
        term = skolemize(
            expression.term, univ_scope, used_variables | {expression.variable***REMOVED***
        )
        if univ_scope:
