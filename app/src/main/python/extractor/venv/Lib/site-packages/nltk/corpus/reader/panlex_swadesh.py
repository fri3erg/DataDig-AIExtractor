...
class PanlexSwadeshCorpusReader(WordListCorpusReader):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self._languages = {lang.panlex_uid: lang for lang in self.get_languages()***REMOVED***
    ...
    def get_languages(self):
        for line in self.raw(f"langs{self.swadesh_size***REMOVED***.txt").split("\n"):
    ...
    def words_by_lang(self, lang_code):
        ...
        """
        fileid = f"swadesh{self.swadesh_size***REMOVED***/{lang_code***REMOVED***.txt"
    ...
    def words_by_iso639(self, iso63_code):
        ...
        """
        fileids = [
            f"swadesh{self.swadesh_size***REMOVED***/{lang_code***REMOVED***.txt"
