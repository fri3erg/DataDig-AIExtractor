...
_index_doc_kwargs.update({"target_klass": "PeriodIndex or list of Periods"***REMOVED***)
_shared_doc_kwargs = {
    "klass": "PeriodArray",
***REMOVED***
    ...
    def __new__(
        ...
        ***REMOVED***
        ...
        if not set(fields).issubset(valid_field_set):
            ...
            raise TypeError(f"__new__() got an unexpected keyword argument {argument***REMOVED***")
        elif len(fields):
            # GH#55960
            warnings.warn(
...
***REMOVED***
    ...
    def from_fields(
        ...
        *,
        ...
        fields = {
            ...
            "second": second,
        ***REMOVED***
        fields = {key: value for key, value in fields.items() if value is not None***REMOVED***
    ...
    def get_loc(self, key):
        ...
        if is_valid_na_for_dtype(key, self.dtype):
            ...
            try:
                ...
                raise KeyError(f"Cannot interpret '{key***REMOVED***' as period") from err
    ...
    def shift(self, periods: int = 1, freq=None) -> Self:
        if freq is not None:
            raise TypeError(
                f"`freq` argument is not supported for {type(self).__name__***REMOVED***.shift"
***REMOVED***
        return self + periods
