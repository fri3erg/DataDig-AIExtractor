    ...
    def test_slice_non_numeric(self, index, idx, frame_or_series, indexer_sli):
        ...
        if indexer_sli is tm.iloc:
            msg = (
                ...
                rf"on {type(index).__name__***REMOVED*** with these indexers \[(3|4)\.0\] of "
                "type float"
***REMOVED***
        else:
            msg = (
                "cannot do slice indexing "
                rf"on {type(index).__name__***REMOVED*** with these indexers "
                r"\[(3|4)(\.0)?\] "
                r"of type (float|int)"
***REMOVED***
    ...
    def test_slice_integer(self):
        ...
        for index, oob in [
            ...
            msg = (
                "cannot do slice indexing "
                rf"on {type(index).__name__***REMOVED*** with these indexers \[-6\.0\] of "
                "type float"
***REMOVED***
            with pytest.raises(TypeError, match=msg):
                s[slice(-6.0, 6.0)]
            ...
            for idx, res1 in [
                ...
                msg = (
                    "cannot do slice indexing "
                    rf"on {type(index).__name__***REMOVED*** with these indexers \[(2|3)\.5\] of "
                    "type float"
    ***REMOVED***
                with pytest.raises(TypeError, match=msg):
                    s[idx]
    ...
    def test_integer_positional_indexing(self, idx):
        ...
        msg = (
            ...
            rf"on {klass.__name__***REMOVED*** with these indexers \[(2|4)\.0\] of "
            "type float"
        )
        with pytest.raises(TypeError, match=msg):
            s[idx]
    ...
    def test_slice_integer_frame_getitem(self, index):
        ...
        for idx in [slice(0.0, 1), slice(0, 1.0), slice(0.0, 1.0)]:
            ...
            msg = (
                "cannot do slice indexing "
                rf"on {type(index).__name__***REMOVED*** with these indexers \[(0|1)\.0\] of "
                "type float"
***REMOVED***
            with pytest.raises(TypeError, match=msg):
                s[idx]
        ...
        msg = (
            "cannot do slice indexing "
            rf"on {type(index).__name__***REMOVED*** with these indexers \[-10\.0\] of "
            "type float"
        )
        with pytest.raises(TypeError, match=msg):
            s[slice(-10.0, 10.0)]
        ...
        for idx, res in [
            ...
            msg = (
                "cannot do slice indexing "
                rf"on {type(index).__name__***REMOVED*** with these indexers \[0\.5\] of "
                "type float"
***REMOVED***
            with pytest.raises(TypeError, match=msg):
                s[idx]
