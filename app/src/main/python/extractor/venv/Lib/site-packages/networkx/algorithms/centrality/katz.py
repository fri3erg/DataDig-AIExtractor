...
def katz_centrality(
    ...
    .. math::
        ...
        x_i = \alpha \sum_{j***REMOVED*** A_{ij***REMOVED*** x_j + \beta,
    ...
    .. math::
        ...
        \alpha < \frac{1***REMOVED***{\lambda_{\max***REMOVED******REMOVED***.
    ...
    ...     print(f"{n***REMOVED*** {c:.2f***REMOVED***")
    0 0.37
    1 0.60
    2 0.60
    3 0.37
    ...
    You can use ``max(nx.adjacency_spectrum(G))`` to get $\lambda_{\max***REMOVED***$ the largest
    eigenvalue of the adjacency matrix.
    The iteration will stop after ``max_iter`` iterations or an error tolerance of
    ``number_of_nodes(G) * tol`` has been reached.

    When $\alpha = 1/\lambda_{\max***REMOVED***$ and $\beta=0$, Katz centrality is the same
