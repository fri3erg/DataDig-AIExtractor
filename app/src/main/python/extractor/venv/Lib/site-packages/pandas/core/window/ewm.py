...
class ExponentialMovingWindow(BaseWindow):
    ...
    adjust : bool, default True
        ...
        .. math::
            y_t = \frac{x_t + (1 - \alpha)x_{t-1***REMOVED*** + (1 - \alpha)^2 x_{t-2***REMOVED*** + ... + (1 -
            \alpha)^t x_0***REMOVED***{1 + (1 - \alpha) + (1 - \alpha)^2 + ... + (1 - \alpha)^t***REMOVED***
        ...
        .. math::
            \begin{split***REMOVED***
                y_0 &= x_0\\
                y_t &= (1 - \alpha) y_{t-1***REMOVED*** + \alpha x_t,
            \end{split***REMOVED***
    ...
    def std(self, bias: bool = False, numeric_only: bool = False):
        if (
            ...
            raise NotImplementedError(
                f"{type(self).__name__***REMOVED***.std does not implement numeric_only"
***REMOVED***
...
***REMOVED***
    ...
    def mean(self, *args, update=None, update_times=None, **kwargs):
        ...
        Examples
        --------
        >>> df = pd.DataFrame({"a": range(5), "b": range(5, 10)***REMOVED***)
