        ...
        try:
            ...
            if action_match is not None:
                ...
                if response["action"] == "Final Answer":
                    return AgentFinish({"output": response["action_input"]***REMOVED***, text)
                else:
                    return AgentAction(
                        response["action"], response.get("action_input", {***REMOVED***), text
        ***REMOVED***
            else:
                return AgentFinish({"output": text***REMOVED***, text)
        except Exception as e:
            raise OutputParserException(f"Could not parse LLM output: {text***REMOVED***") from e
