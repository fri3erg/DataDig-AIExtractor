...
class TestBipartiteBasic:
    ...
    def test_bipartite_color(self):
        G = nx.path_graph(4)
        c = bipartite.color(G)
        assert c == {0: 1, 1: 0, 2: 1, 3: 0***REMOVED***
    ...
    def test_bipartite_sets(self):
        ...
        assert X == {0, 2***REMOVED***
        assert Y == {1, 3***REMOVED***
    ...
    def test_bipartite_density(self):
        ...
        assert bipartite.density(nx.Graph(), {***REMOVED***) == 0.0
    ...
    def test_bipartite_degrees(self):
        ...
        assert dict(u) == {1: 2, 3: 2***REMOVED***
        assert dict(d) == {0: 1, 2: 2, 4: 1***REMOVED***
    ...
    def test_bipartite_weighted_degrees(self):
        ...
        assert dict(u) == {1: 1.1, 3: 2***REMOVED***
        assert dict(d) == {0: 0.1, 2: 2, 4: 1***REMOVED***
        u, d = bipartite.degrees(G, Y, weight="other")
        assert dict(u) == {1: 1.2, 3: 2***REMOVED***
        assert dict(d) == {0: 0.2, 2: 2, 4: 1***REMOVED***
