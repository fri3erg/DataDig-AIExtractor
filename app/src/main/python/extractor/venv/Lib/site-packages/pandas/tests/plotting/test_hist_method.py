...
class TestSeriesPlots:
    @pytest.mark.parametrize("kwargs", [{***REMOVED***, {"grid": False***REMOVED***, {"figsize": (8, 10)***REMOVED***])
    def test_hist_legacy_kwargs(self, ts, kwargs):
        _check_plot_works(ts.hist, **kwargs)

    @pytest.mark.parametrize("kwargs", [{***REMOVED***, {"bins": 5***REMOVED***])
...
***REMOVED***
    ...
    @pytest.mark.slow
    @pytest.mark.parametrize(
        "kwargs", [{"sharex": True, "sharey": True***REMOVED***, {"figsize": (8, 10)***REMOVED***, {"bins": 5***REMOVED***]
    )
...
***REMOVED***
    ...
    ***REMOVED***,
    ...
    @pytest.mark.parametrize(
        "layout_test",
        (
            {"layout": None, "expected_size": (2, 2)***REMOVED***,  # default is 2x2
            {"layout": (2, 2), "expected_size": (2, 2)***REMOVED***,
            {"layout": (4, 1), "expected_size": (4, 1)***REMOVED***,
            {"layout": (1, 4), "expected_size": (1, 4)***REMOVED***,
            {"layout": (3, 3), "expected_size": (3, 3)***REMOVED***,
            {"layout": (-1, 4), "expected_size": (1, 4)***REMOVED***,
            {"layout": (4, -1), "expected_size": (4, 1)***REMOVED***,
            {"layout": (-1, 2), "expected_size": (2, 2)***REMOVED***,
            {"layout": (2, -1), "expected_size": (2, 2)***REMOVED***,
        ),
    )
...
***REMOVED***
    ...
    def test_grouped_hist_legacy2(self):
        ...
        df_int = DataFrame({"height": height, "weight": weight, "gender": gender_int***REMOVED***)
...
***REMOVED***
    ...
    @pytest.mark.slow
    @pytest.mark.parametrize("kwargs", [{***REMOVED***, {"column": "height", "layout": (2, 2)***REMOVED***])
    ...
    @pytest.mark.parametrize(
        ...
        [
            [{"by": "gender", "layout": (3, 5)***REMOVED***, 2, (3, 5)],
            [{"column": ["height", "weight", "category"]***REMOVED***, 3, (2, 2)],
        ],
    )
