...
***REMOVED*** from ex
    ...
    def _load_documents_from_folder(self, folder_path: str) -> List[Document]:
        ...
        try:
            ...
            raise ValueError(
                f"Could not list files in the folder: {folder_path***REMOVED***. "
...
***REMOVED*** from ex
    ...
    def _load_file_from_path(self, file_path: str) -> Optional[Document]:
        ...
        try:
            ...
            raise ValueError(
                f"Could not load file: {file_path***REMOVED***. Please verify the file path"
                "and try again."
***REMOVED*** from ex
        ...
        try:
            ...
            if file_extension == ".pdf":
                print(f"File {file_path***REMOVED*** type detected as .pdf")
                ...
                try:
                    ...
                    print(f"Error while trying to parse PDF {file_path***REMOVED***: {pdf_ex***REMOVED***")
                    return None
            else:
                print(
                    f"File {file_path***REMOVED*** could not be decoded as pdf or text. Skipping."
    ***REMOVED***

            return None

        metadata = {
            "source": f"dropbox://{file_path***REMOVED***",
