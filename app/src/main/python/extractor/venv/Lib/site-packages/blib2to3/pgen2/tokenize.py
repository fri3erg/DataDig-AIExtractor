...
def _combinations(*l: str) -> Set[str]:
    return {x + y for x in l for y in l + ("",) if x.casefold() != y.casefold()***REMOVED***
...
endprogs: Final = {
    ...
    "'''": single3prog,
    '"""': double3prog,
    **{f"{prefix***REMOVED***'''": single3prog for prefix in _strprefixes***REMOVED***,
    **{f'{prefix***REMOVED***"""': double3prog for prefix in _strprefixes***REMOVED***,
***REMOVED***

triple_quoted: Final = (
    {"'''", '"""'***REMOVED***
    | {f"{prefix***REMOVED***'''" for prefix in _strprefixes***REMOVED***
    | {f'{prefix***REMOVED***"""' for prefix in _strprefixes***REMOVED***
)
single_quoted: Final = (
    {"'", '"'***REMOVED***
...
def generate_tokens(
    ...
    ***REMOVED***:
            ...
            ***REMOVED***, f"endprog not found for {token***REMOVED***"
