...
MATCH_ALL_QUERY = {"match_all": {***REMOVED******REMOVED***  # type: Dict
...
def _validate_embeddings_and_bulk_size(embeddings_length: int, bulk_size: int) -> None:
    ...
    if bulk_size < embeddings_length:
        raise RuntimeError(
            f"The embeddings count, {embeddings_length***REMOVED*** is more than the "
            f"[bulk_size], {bulk_size***REMOVED***. Increase the value of [bulk_size]."
        )
...
def _default_scripting_text_mapping(
    ...
    return {
        "mappings": {
            "properties": {
                vector_field: {"type": "knn_vector", "dimension": dim***REMOVED***,
            ***REMOVED***
        ***REMOVED***
    ***REMOVED***
...
def _default_text_mapping(
    ...
    return {
        "settings": {"index": {"knn": True, "knn.algo_param.ef_search": ef_search***REMOVED******REMOVED***,
        "mappings": {
            "properties": {
                vector_field: {
                    "type": "knn_vector",
                    ...
                    "method": {
                        ...
                        "engine": engine,
                        "parameters": {"ef_construction": ef_construction, "m": m***REMOVED***,
                    ***REMOVED***,
                ***REMOVED***
            ***REMOVED***
        ***REMOVED***,
...
def _default_approximate_search_query(
    ...
    return {
        "size": k,
        "query": {"knn": {vector_field: {"vector": query_vector, "k": k***REMOVED******REMOVED******REMOVED***,
    ***REMOVED***
    ...
    return {
        ...
        "query": {
            "bool": {
                ...
                subquery_clause: [
                    {"knn": {vector_field: {"vector": query_vector, "k": k***REMOVED******REMOVED******REMOVED***
                ],
            ***REMOVED***
        ***REMOVED***,
    ***REMOVED***
...
***REMOVED***
    ...
    def similarity_search(
        ...
        Optional Args for Script Scoring Search:
            ...
            nearest neighbors; default: {"match_all": {***REMOVED******REMOVED***
...
***REMOVED***
    ...
    def _raw_similarity_search_with_score(
        ...
        vector_field = kwargs.get("vector_field", "vector_field")
        index_name = kwargs.get("index_name", self.index_name)
        filter = kwargs.get("filter", {***REMOVED***)
...
***REMOVED***
        ...
        if search_type == "approximate_search":
            boolean_filter = kwargs.get("boolean_filter", {***REMOVED***)
            subquery_clause = kwargs.get("subquery_clause", "must")
            efficient_filter = kwargs.get("efficient_filter", {***REMOVED***)
            # `lucene_filter` is deprecated, added for Backwards Compatibility
            lucene_filter = kwargs.get("lucene_filter", {***REMOVED***)

            if boolean_filter != {***REMOVED*** and efficient_filter != {***REMOVED***:
                raise ValueError(
                    "Both `boolean_filter` and `efficient_filter` are provided which "
                    "is invalid"
    ***REMOVED***

            if lucene_filter != {***REMOVED*** and efficient_filter != {***REMOVED***:
                raise ValueError(
                    "Both `lucene_filter` and `efficient_filter` are provided which "
                    "is invalid. `lucene_filter` is deprecated"
    ***REMOVED***

            if lucene_filter != {***REMOVED*** and boolean_filter != {***REMOVED***:
                raise ValueError(
    ...
    ***REMOVED***
            ...
            if (
                efficient_filter == {***REMOVED***
                and boolean_filter == {***REMOVED***
                and lucene_filter == {***REMOVED***
                and filter != {***REMOVED***
***REMOVED***:
