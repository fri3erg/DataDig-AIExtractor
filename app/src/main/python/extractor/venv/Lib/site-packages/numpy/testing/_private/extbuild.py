...
def build_and_import_extension(
    ...
    try:
        ...
        raise RuntimeError(f"could not compile in {build_dir***REMOVED***:") from e
...
def _make_methods(functions, modname):
    ...
    for funcname, flags, code in functions:
        ...
        methods_table.append(
            "{\"%s\", (PyCFunction)%s, %s***REMOVED***," % (funcname, cfuncname, flags))
        func_code = """
        static PyObject* {cfuncname***REMOVED***{signature***REMOVED***
        {{
        {code***REMOVED***
        ***REMOVED******REMOVED***
...
def build(cfile, outputfilename, compile_extra, link_extra,
    ...
    with open(cfile.parent / "meson.build", "wt") as fid:
        ...
        fid.write(textwrap.dedent(f"""\
            project('foo', 'c')
            shared_module('{so_name***REMOVED***', '{cfile.parts[-1]***REMOVED***',
                c_args: {includes***REMOVED*** + {compile_extra***REMOVED***,
                link_args: {link_dirs***REMOVED*** + {link_extra***REMOVED***,
                link_with: {libraries***REMOVED***,
                name_prefix: '',
                name_suffix: 'dummy',
***REMOVED***
        """))
