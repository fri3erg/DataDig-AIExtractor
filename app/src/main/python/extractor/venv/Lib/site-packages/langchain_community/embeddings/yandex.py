    ...
    def validate_environment(cls, values: Dict) -> Dict:
        ...
        if values["iam_token"]:
            values["_grpc_metadata"] = [
                ("authorization", f"Bearer {values['iam_token']***REMOVED***")
            ]
            if values["folder_id"]:
                values["_grpc_metadata"].append(("x-folder-id", values["folder_id"]))
        else:
            values["_grpc_metadata"] = (
                ("authorization", f"Api-Key {values['api_key']***REMOVED***"),
***REMOVED***
        ...
        if not values["model_uri"]:
            values[
                "model_uri"
            ] = f"emb://{values['folder_id']***REMOVED***/{values['model_name']***REMOVED***/{values['model_version']***REMOVED***"
        return values
