...
def _get_sys_info() -> dict[str, JSONSerializable]:
    ...
    return {
        ...
        "LOCALE": {"language-code": language_code, "encoding": encoding***REMOVED***,
    ***REMOVED***
...
def _get_dependency_info() -> dict[str, JSONSerializable]:
    ...
    result: dict[str, JSONSerializable] = {***REMOVED***
    for modname in deps:
...
def show_versions(as_json: str | bool = False) -> None:
    ...
    if as_json:
        j = {"system": sys_info, "dependencies": deps***REMOVED***
        ...
        sys_info["LOCALE"] = f"{language_code***REMOVED***.{encoding***REMOVED***"

        maxlen = max(len(x) for x in deps)
        print("\nINSTALLED VERSIONS")
        print("------------------")
        for k, v in sys_info.items():
            print(f"{k:<{maxlen***REMOVED******REMOVED***: {v***REMOVED***")
        print("")
