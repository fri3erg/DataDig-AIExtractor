...
***REMOVED***
        ...
        df1 = {
            "a": {"a": True, "b": False, "c": False, "d": True, "e": True***REMOVED***,
            "b": {"a": False, "b": True, "c": False, "d": False, "e": False***REMOVED***,
            "c": {"a": False, "b": False, "c": True, "d": False, "e": False***REMOVED***,
            "d": {"a": True, "b": False, "c": False, "d": True, "e": True***REMOVED***,
            "e": {"a": True, "b": False, "c": False, "d": True, "e": True***REMOVED***,
        ***REMOVED***

        df2 = {
            "a": {"a": True, "b": False, "c": True, "d": False, "e": False***REMOVED***,
            "b": {"a": False, "b": True, "c": False, "d": False, "e": False***REMOVED***,
            "c": {"a": True, "b": False, "c": True, "d": False, "e": False***REMOVED***,
            "d": {"a": False, "b": False, "c": False, "d": True, "e": False***REMOVED***,
            "e": {"a": False, "b": False, "c": False, "d": False, "e": True***REMOVED***,
        ***REMOVED***
    ...
    def test_logical_with_nas(self):
        d = DataFrame({"a": [np.nan, False], "b": [True, True]***REMOVED***)
