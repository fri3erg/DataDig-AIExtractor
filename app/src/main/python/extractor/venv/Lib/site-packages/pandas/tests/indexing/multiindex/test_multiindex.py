...
class TestMultiIndexBasic:
    ...
    def test_nested_tuples_duplicates(self):
        ...
        df = DataFrame({"c1": [1, 2, 3], "c2": [np.nan, np.nan, np.nan]***REMOVED***, index=mi)

        expected = DataFrame({"c1": df["c1"], "c2": [1.0, 1.0, np.nan]***REMOVED***, index=mi)
...
***REMOVED***,
    ...
    def test_rename_multiindex_with_duplicates(self):
        ...
        df = df.rename(index={"A": "Apple"***REMOVED***, level=0)
