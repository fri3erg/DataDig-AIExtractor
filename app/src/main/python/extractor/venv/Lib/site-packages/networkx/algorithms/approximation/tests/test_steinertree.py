...
class TestSteinerTree:
    ...
    def test_metric_closure(self):
        ...
        mc = [
            (1, 2, {"distance": 10, "path": [1, 2]***REMOVED***),
            (1, 3, {"distance": 20, "path": [1, 2, 3]***REMOVED***),
            (1, 4, {"distance": 22, "path": [1, 2, 7, 5, 4]***REMOVED***),
            (1, 5, {"distance": 12, "path": [1, 2, 7, 5]***REMOVED***),
            (1, 6, {"distance": 22, "path": [1, 2, 7, 5, 6]***REMOVED***),
            (1, 7, {"distance": 11, "path": [1, 2, 7]***REMOVED***),
            (2, 3, {"distance": 10, "path": [2, 3]***REMOVED***),
            (2, 4, {"distance": 12, "path": [2, 7, 5, 4]***REMOVED***),
            (2, 5, {"distance": 2, "path": [2, 7, 5]***REMOVED***),
            (2, 6, {"distance": 12, "path": [2, 7, 5, 6]***REMOVED***),
            (2, 7, {"distance": 1, "path": [2, 7]***REMOVED***),
            (3, 4, {"distance": 10, "path": [3, 4]***REMOVED***),
            (3, 5, {"distance": 12, "path": [3, 2, 7, 5]***REMOVED***),
            (3, 6, {"distance": 22, "path": [3, 2, 7, 5, 6]***REMOVED***),
            (3, 7, {"distance": 11, "path": [3, 2, 7]***REMOVED***),
            (4, 5, {"distance": 10, "path": [4, 5]***REMOVED***),
            (4, 6, {"distance": 20, "path": [4, 5, 6]***REMOVED***),
            (4, 7, {"distance": 11, "path": [4, 5, 7]***REMOVED***),
            (5, 6, {"distance": 10, "path": [5, 6]***REMOVED***),
            (5, 7, {"distance": 1, "path": [5, 7]***REMOVED***),
            (6, 7, {"distance": 11, "path": [6, 5, 7]***REMOVED***),
        ]
    ...
    def test_steiner_tree(self):
        valid_steiner_trees = [
            [
                [
                    (1, 2, {"weight": 10***REMOVED***),
                    (2, 3, {"weight": 10***REMOVED***),
                    (2, 7, {"weight": 1***REMOVED***),
                    (3, 4, {"weight": 10***REMOVED***),
                    (5, 7, {"weight": 1***REMOVED***),
                ],
                [
                    (1, 2, {"weight": 10***REMOVED***),
                    (2, 7, {"weight": 1***REMOVED***),
                    (3, 4, {"weight": 10***REMOVED***),
                    (4, 5, {"weight": 10***REMOVED***),
                    (5, 7, {"weight": 1***REMOVED***),
                ],
                [
                    (1, 2, {"weight": 10***REMOVED***),
            ...
            [
                [
                    (0, 5, {"weight": 6***REMOVED***),
                    (1, 2, {"weight": 2***REMOVED***),
                    (1, 5, {"weight": 3***REMOVED***),
                    (3, 5, {"weight": 5***REMOVED***),
                ],
                [
                    (0, 5, {"weight": 6***REMOVED***),
                    (4, 2, {"weight": 4***REMOVED***),
                    (4, 5, {"weight": 1***REMOVED***),
                    (3, 5, {"weight": 5***REMOVED***),
                ],
            ],
            [
                [
                    (1, 10, {"weight": 2***REMOVED***),
                    (3, 10, {"weight": 2***REMOVED***),
                    (3, 11, {"weight": 1***REMOVED***),
                    (5, 12, {"weight": 1***REMOVED***),
                    (6, 13, {"weight": 1***REMOVED***),
                    (8, 9, {"weight": 2***REMOVED***),
                    (9, 14, {"weight": 1***REMOVED***),
                    (10, 14, {"weight": 1***REMOVED***),
                    (11, 12, {"weight": 1***REMOVED***),
                    (12, 15, {"weight": 1***REMOVED***),
                    (13, 15, {"weight": 1***REMOVED***),
                ]
            ],
        ]
...
***REMOVED***:
    ...
    ***REMOVED***
    ...
    def test_multigraph_steiner_tree(self):
        ...
        G.add_edges_from(
            [
                (1, 2, 0, {"weight": 1***REMOVED***),
                (2, 3, 0, {"weight": 999***REMOVED***),
                (2, 3, 1, {"weight": 1***REMOVED***),
                (3, 4, 0, {"weight": 1***REMOVED***),
                (3, 5, 0, {"weight": 1***REMOVED***),
            ]
        )
        terminal_nodes = [2, 4, 5]
        expected_edges = [
            (2, 3, 1, {"weight": 1***REMOVED***),  # edge with key 1 has lower weight
            (3, 4, 0, {"weight": 1***REMOVED***),
            (3, 5, 0, {"weight": 1***REMOVED***),
        ]
        for method in self.methods:
