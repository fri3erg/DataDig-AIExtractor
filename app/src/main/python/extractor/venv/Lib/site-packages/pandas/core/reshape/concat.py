...
def concat(
    ...
    *,
    ...
    axis : {0/'index', 1/'columns'***REMOVED***, default 0
        The axis to concatenate along.
    join : {'inner', 'outer'***REMOVED***, default 'outer'
    ...
    >>> df7 = pd.DataFrame({'a': 1, 'b': 2***REMOVED***, index=[0])
    >>> df7
        a   b
    0   1   2
    >>> new_row = pd.Series({'a': 3, 'b': 4***REMOVED***)
    >>> new_row
    a    3
    b    4
    dtype: int64
    ...
    def __init__(
        ...
        if isinstance(objs, (ABCSeries, ABCDataFrame, str)):
            raise TypeError(
                ...
                f'objects, you passed an object of type "{type(objs).__name__***REMOVED***"'
***REMOVED***
...
***REMOVED***
        ...
        if not is_bool(sort):
            raise ValueError(
                f"The 'sort' keyword only accepts boolean values; {sort***REMOVED*** was passed."
***REMOVED***
    ...
    def _get_ndims(self, objs: list[Series | DataFrame]) -> set[int]:
        ...
        for obj in objs:
            if not isinstance(obj, (ABCSeries, ABCDataFrame)):
                msg = (
                    f"cannot concatenate object of type '{type(obj)***REMOVED***'; "
...
***REMOVED***:
    ...
    ***REMOVED***
                ...
                obj = sample._constructor({name: obj***REMOVED***, copy=False)
                ...
                for i, x in enumerate(self.objs):
                    if x.ndim != 1:
                        raise TypeError(
                            ...
                            f"object of type '{type(x).__name__***REMOVED***'"
            ***REMOVED***
    ...
    def _maybe_check_integrity(self, concat_index: Index):
        if self.verify_integrity:
            if not concat_index.is_unique:
                ...
                raise ValueError(f"Indexes have overlapping values: {overlap***REMOVED***")
...
def _make_concat_multiindex(indexes, keys, levels=None, names=None) -> MultiIndex:
    ...
    for level in levels:
        if not level.is_unique:
            raise ValueError(f"Level values not unique: {level.tolist()***REMOVED***")
    ...
    if not all_indexes_same(indexes) or not all(level.is_unique for level in levels):
        ...
        for hlevel, level in zip(zipped, levels):
            ...
            if isinstance(hlevel, Index) and hlevel.equals(level):
                ...
                for key, index in zip(hlevel, indexes):
                    ...
                    if not mask.any():
                        raise ValueError(f"Key {key***REMOVED*** not in level {level***REMOVED***")
        ...
        if len(names) == len(levels):
            ...
            if not len({idx.nlevels for idx in indexes***REMOVED***) == 1:
    ...
    ***REMOVED***
    ...
    for hlevel, level in zip(zipped, levels):
        ...
        if mask.any():
            raise ValueError(
                f"Values not found in passed level: {hlevel_index[mask]!s***REMOVED***"
***REMOVED***
