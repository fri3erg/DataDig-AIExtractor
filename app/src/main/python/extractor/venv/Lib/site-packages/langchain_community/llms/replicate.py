...
class Replicate(LLM):
    ...
    be passed in with the format model_kwargs={model_param: value, ...***REMOVED***
    ...
    ***REMOVED***,
                model_kwargs={"image_dimensions": "512x512"***REMOVED***
***REMOVED***
    """
    ...
    def lc_secrets(self) -> Dict[str, str]:
        return {"replicate_api_token": "REPLICATE_API_TOKEN"***REMOVED***
    ...
    def build_extra(cls, values: Dict[str, Any]) -> Dict[str, Any]:
        ...
        input = values.pop("input", {***REMOVED***)
        if input:
            logger.warning(
                "Init param `input` is deprecated, please use `model_kwargs` instead."
***REMOVED***
        extra = {**values.pop("model_kwargs", {***REMOVED***), **input***REMOVED***
