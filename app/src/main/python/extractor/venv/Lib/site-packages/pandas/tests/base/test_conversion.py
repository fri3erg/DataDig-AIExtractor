...
@pytest.mark.parametrize(
    "data",
    [
        {"a": [1, 2, 3], "b": [1, 2, None]***REMOVED***,
        {"a": np.array([1, 2, 3]), "b": np.array([1, 2, np.nan])***REMOVED***,
        {"a": pd.array([1, 2, 3]), "b": pd.array([1, 2, None])***REMOVED***,
    ],
)
...
@pytest.mark.parametrize(
    ...
    [
        (
            {"a": pd.array([1, 2, None])***REMOVED***,
            np.array([[1.0], [2.0], [np.nan]], dtype=float),
        ),
        (
            {"a": [1, 2, 3], "b": [1, 2, 3]***REMOVED***,
