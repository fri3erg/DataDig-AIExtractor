...
class OpsMixin:
    ...
    def __add__(self, other):
        ...
        Examples
        --------
        >>> df = pd.DataFrame({'height': [1.5, 2.6], 'weight': [500, 800]***REMOVED***,
        ...                   index=['elk', 'moose'])
        >>> df
               height  weight
        elk       1.5     500
        ...
        >>> df[['height', 'weight']] + {'height': 0.5, 'weight': 1.5***REMOVED***
               height  weight
        elk       2.0   501.5
        moose     3.1   801.5
        ...
        >>> other = pd.DataFrame({'height': [0.2, 0.4, 0.6]***REMOVED***,
...
def array_ufunc(self, ufunc: np.ufunc, method: str, *inputs: Any, **kwargs: Any):
    ...
    if len(alignable) > 1:
        ...
        # it to handle *args.
        set_types = set(types)
        if len(set_types) > 1 and {DataFrame, Series***REMOVED***.issubset(set_types):
            # We currently don't handle ufunc(DataFrame, Series)
            # well. Previously this raised an internal ValueError. We might
            # support it someday, so raise a NotImplementedError.
            raise NotImplementedError(
                f"Cannot apply ufunc {ufunc***REMOVED*** to mixed DataFrame and Series inputs."
***REMOVED***
        axes = self.axes
    ...
    if self.ndim == 1:
        ...
        reconstruct_kwargs = {"name": name***REMOVED***
    else:
        reconstruct_kwargs = {***REMOVED***
