...
class Connection:
    ...
    def __repr__(self) -> str:
        return f"Connection<{self._key***REMOVED***>"

    def __del__(self, _warnings: Any = warnings) -> None:
        if self._protocol is not None:
            kwargs = {"source": self***REMOVED***
            _warnings.warn(f"Unclosed connection {self!r***REMOVED***", ResourceWarning, **kwargs)
            if self._loop.is_closed():
                return

            self._connector._release(self._key, self._protocol, should_close=True)

            context = {"client_connection": self, "message": "Unclosed connection"***REMOVED***
...
class BaseConnector:
    ...
    ***REMOVED***
        ...
        self._conns: Dict[ConnectionKey, List[Tuple[ResponseHandler, float]]] = {***REMOVED***
        self._limit = limit
        ...
        # {host_key: FIFO list of waiters***REMOVED***
    ...
    def __del__(self, _warnings: Any = warnings) -> None:
        ...
        kwargs = {"source": self***REMOVED***
        _warnings.warn(f"Unclosed connector {self!r***REMOVED***", ResourceWarning, **kwargs)
        context = {
            "connector": self,
            "connections": conns,
...
class _DNSCacheTable:
    def __init__(self, ttl: Optional[float] = None) -> None:
        self._addrs_rr: Dict[Tuple[str, int], Tuple[Iterator[Dict[str, Any]], int]] = {***REMOVED***
        self._timestamps: Dict[Tuple[str, int], float] = {***REMOVED***
        self._ttl = ttl
...
class TCPConnector(BaseConnector):
    ...
    def __init__(
        ...
        *,
        ...
        self._throttle_dns_events: Dict[Tuple[str, int], EventResultOrError] = {***REMOVED***
        self._family = family
    ...
    def _make_ssl_context(verified: bool) -> SSLContext:
        if verified:
            ...
            try:
                ...
                warnings.warn(
                    "{!s***REMOVED***: The Python interpreter is compiled "
...
***REMOVED***:
        ...
        ***REMOVED***
            ...
            raise ClientConnectionError(
                ...
                f"{req.host!s***REMOVED***:{req.port:d***REMOVED*** through an underlying connection "
                f"to an HTTPS proxy {req.proxy!s***REMOVED*** ssl:{req.ssl or 'default'***REMOVED*** "
                f"[{type_err!s***REMOVED***]"
***REMOVED*** from type_err
        else:
            ...
            tls_proto.connection_made(
                tls_transport
***REMOVED***  # Kick the state machine of the new TLS protocol
