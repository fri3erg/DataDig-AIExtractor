...
class PromptLayerCallbackHandler(BaseCallbackHandler):
    ...
    def __init__(
        ...
        self.runs: Dict[UUID, Dict[str, Any]] = {***REMOVED***
    ...
    def on_chat_model_start(
        ...
        **kwargs: Any,
        ...
        self.runs[run_id] = {
            ...
            "invocation_params": kwargs.get("invocation_params", {***REMOVED***),
    ...
    def on_llm_end(
        ...
        **kwargs: Any,
        ...
        run_info = self.runs.get(run_id, {***REMOVED***)
        if not run_info:
            return
        ...
        for i in range(len(response.generations)):
            ...
            ***REMOVED***
            model_params = run_info.get("invocation_params", {***REMOVED***)
