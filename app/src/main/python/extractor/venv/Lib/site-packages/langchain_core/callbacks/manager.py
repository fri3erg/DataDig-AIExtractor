    ...
    *,
    ...
    Example:
        .. code-block:: python
            ...
            llm_input = "Foo"
            with trace_as_chain_group("group_name", inputs={"input": llm_input***REMOVED***) as manager:
                # Use the callback manager for the chain group
                res = llm.predict(llm_input, callbacks=manager)
                manager.on_chain_end({"output": res***REMOVED***)
    """  # noqa: E501
    ...
    run_manager = cm.on_chain_start({"name": group_name***REMOVED***, inputs or {***REMOVED***, run_id=run_id)
    ...
    try:
        ...
        if not group_cm.ended:
            run_manager.on_chain_end({***REMOVED***)
    ...
    *,
    ...
    Example:
        .. code-block:: python
            ...
            llm_input = "Foo"
            async with atrace_as_chain_group("group_name", inputs={"input": llm_input***REMOVED***) as manager:
                # Use the async callback manager for the chain group
                res = await llm.apredict(llm_input, callbacks=manager)
                await manager.on_chain_end({"output": res***REMOVED***)
    """  # noqa: E501
    from langchain_core.tracers.context import _get_trace_callbacks
    ...
    run_manager = await cm.on_chain_start(
        {"name": group_name***REMOVED***, inputs or {***REMOVED***, run_id=run_id
    )
    child_cm = run_manager.get_child()
    ...
    try:
        ...
        if not group_cm.ended:
            await run_manager.on_chain_end({***REMOVED***)
...
def handle_event(
    ...
    ***REMOVED***:
        ...
        ***REMOVED***
                    ...
                    logger.warning(
                        f"NotImplementedError in {handler_name***REMOVED***.{event_name***REMOVED***"
                        f" callback: {repr(e)***REMOVED***"
        ***REMOVED***
            except Exception as e:
                logger.warning(
                    f"Error in {handler.__class__.__name__***REMOVED***.{event_name***REMOVED*** callback:"
                    f" {repr(e)***REMOVED***"
    ***REMOVED***
...
***REMOVED***
            ...
            logger.warning(
                f"NotImplementedError in {handler.__class__.__name__***REMOVED***.{event_name***REMOVED***"
                f" callback: {repr(e)***REMOVED***"
***REMOVED***
    except Exception as e:
        logger.warning(
...
class BaseRunManager(RunManagerMixin):
    ...
    def __init__(
        ...
        *,
        ...
        self.inheritable_metadata = inheritable_metadata or {***REMOVED***
...
***REMOVED***
    ...
    if inheritable_metadata or local_metadata:
        callback_manager.add_metadata(inheritable_metadata or {***REMOVED***)
        callback_manager.add_metadata(local_metadata or {***REMOVED***, False)
