...
def _build_metadata(soup: Any, url: str) -> dict:
    ...
    metadata = {"source": url***REMOVED***
    if title := soup.find("title"):
        metadata["title"] = title.get_text()
    if description := soup.find("meta", attrs={"name": "description"***REMOVED***):
...
***REMOVED***
        if web_paths:
            ...
            raise TypeError(
                f"web_path must be str or Sequence[str] got ({type(web_path)***REMOVED***) or"
                f" web_paths must be Sequence[str] got ({type(web_paths)***REMOVED***)"
***REMOVED***
        self.requests_per_second = requests_per_second
        self.default_parser = default_parser
        self.requests_kwargs = requests_kwargs or {***REMOVED***
        self.raise_for_status = raise_for_status
        self.bs_get_text_kwargs = bs_get_text_kwargs or {***REMOVED***
        self.bs_kwargs = bs_kwargs or {***REMOVED***
        if session:
    ...
    async def _fetch(
        ...
        ***REMOVED*** as response:
                    ...
                    if i == retries - 1:
                        ...
                        logger.warning(
                            f"Error fetching {url***REMOVED*** with attempt "
                            f"{i + 1***REMOVED***/{retries***REMOVED***: {e***REMOVED***. Retrying..."
            ***REMOVED***
        ...
        async with semaphore:
            try:
                ...
                if self.continue_on_failure:
                    logger.warning(
                        f"Error fetching {url***REMOVED***, skipping due to"
                        f" continue_on_failure=True"
        ***REMOVED***
                    return ""
                logger.exception(
                    f"Error fetching {url***REMOVED*** and aborting, use continue_on_failure=True "
...
***REMOVED***
    ...
    def _scrape(
        ...
        return BeautifulSoup(html_doc.text, parser, **(bs_kwargs or {***REMOVED***))
