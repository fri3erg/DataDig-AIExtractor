...
def encode_content(
    ...
    if isinstance(content, (bytes, str)):
        ...
        headers = {"Content-Length": str(content_length)***REMOVED*** if body else {***REMOVED***
        ...
        if content_length_or_none is None:
            headers = {"Transfer-Encoding": "chunked"***REMOVED***
        else:
            headers = {"Content-Length": str(content_length_or_none)***REMOVED***
    ...
    raise TypeError(f"Unexpected type for 'content', {type(content)!r***REMOVED***")
...
def encode_urlencoded_data(
    ...
    headers = {"Content-Length": content_length, "Content-Type": content_type***REMOVED***
    return headers, ByteStream(body)
...
def encode_request(
    ...
    if content is not None:
        ...
        return encode_multipart_data(data or {***REMOVED***, files, boundary)
    elif data:
        return encode_urlencoded_data(data)
    elif json is not None:
        return encode_json(json)

    return {***REMOVED***, ByteStream(b"")
