...
class VaderConstants:
    ...
    ***REMOVED***
    ...
    REGEX_REMOVE_PUNCTUATION = re.compile(f"[{re.escape(string.punctuation)***REMOVED***]")
...
class SentiText:
    ...
    def _words_plus_punc(self):
        ...
        ***REMOVED***
        ...
        # remove singletons
        words_only = {w for w in words_only if len(w) > 1***REMOVED***
        # the product gives ('cat', ',') and (',', 'cat')
        punc_before = {"".join(p): p[1] for p in product(self.PUNC_LIST, words_only)***REMOVED***
        punc_after = {"".join(p): p[0] for p in product(words_only, self.PUNC_LIST)***REMOVED***
...
***REMOVED*** or item.lower() in self.constants.BOOSTER_DICT:
    ...
    ***REMOVED***:
        ...
        ***REMOVED***
                    if start_i == 2:
                        ...
                        #  "on the ball": 2,"under the weather": -2***REMOVED***
...
***REMOVED***:
    ...
    def _but_check(self, words_and_emoticons, sentiments):
        ...
        but = {"but"***REMOVED*** & set(words_and_emoticons)
        if but:
    ...
    def _idioms_check(self, valence, words_and_emoticons, i):
        onezero = f"{words_and_emoticons[i - 1]***REMOVED*** {words_and_emoticons[i]***REMOVED***"

        twoonezero = "{***REMOVED*** {***REMOVED*** {***REMOVED***".format(
            words_and_emoticons[i - 2],
            words_and_emoticons[i - 1],
            words_and_emoticons[i],
        )

        twoone = f"{words_and_emoticons[i - 2]***REMOVED*** {words_and_emoticons[i - 1]***REMOVED***"

        threetwoone = "{***REMOVED*** {***REMOVED*** {***REMOVED***".format(
            words_and_emoticons[i - 3],
            words_and_emoticons[i - 2],
            words_and_emoticons[i - 1],
        )

        threetwo = "{***REMOVED*** {***REMOVED***".format(
        ...
        if len(words_and_emoticons) - 1 > i:
            zeroone = f"{words_and_emoticons[i]***REMOVED*** {words_and_emoticons[i + 1]***REMOVED***"
            if zeroone in self.constants.SPECIAL_CASE_IDIOMS:
                valence = self.constants.SPECIAL_CASE_IDIOMS[zeroone]
        if len(words_and_emoticons) - 1 > i + 1:
            zeroonetwo = "{***REMOVED*** {***REMOVED*** {***REMOVED***".format(
                words_and_emoticons[i],
                words_and_emoticons[i + 1],
                words_and_emoticons[i + 2],
***REMOVED***
...
***REMOVED***:
    ...
    ***REMOVED***  # compensates for neutral words that are counted as 1
            if sentiment_score < 0:
                neg_sum += (
                    float(sentiment_score) - 1
    ***REMOVED***  # when used with math.fabs(), compensates for neutrals
            if sentiment_score == 0:
                neu_count += 1
