...
#  define PyEval_RestoreThread(state)  if (state); else {***REMOVED***
#  undef PyGILState_Ensure
#  define PyGILState_Ensure() (PyGILState_UNLOCKED)
#  undef PyGILState_Release
#  define PyGILState_Release(state)  if (state); else {***REMOVED***
#  undef  Py_UNBLOCK_THREADS
#  define Py_UNBLOCK_THREADS  _save = NULL;
#  undef  Py_BLOCK_THREADS
#  define Py_BLOCK_THREADS  if (_save); else {***REMOVED***
#endif
...
long _ftol2( double dblSource ) { return _ftol( dblSource ); ***REMOVED***
#endif
