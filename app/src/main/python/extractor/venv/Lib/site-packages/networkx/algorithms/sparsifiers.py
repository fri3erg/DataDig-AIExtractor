...
def spanner(G, stretch, weight=None, seed=None):
    ...
    # cluster center
    clustering = {v: v for v in G.nodes***REMOVED***
...
def _lightest_edge_dicts(residual_graph, clustering, node):
    ...
    """
    lightest_edge_neighbor = {***REMOVED***
    lightest_edge_weight = {***REMOVED***
...
def _add_edge_to_spanner(H, residual_graph, u, v, weight):
    """Add the edge {u, v***REMOVED*** to the spanner H and take weight from
    the residual graph.
