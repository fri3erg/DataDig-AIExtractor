...
class TestTimedeltas:
    ...
    def test_timedelta_units_H_T_S_L_U_N_deprecated(self, depr_unit, unit):
        # GH#52536
        depr_msg = (
            f"'{depr_unit***REMOVED***' is deprecated and will be removed in a future version."
        )
    ...
    def test_timedelta_range_H_T_deprecated(self, freq, msg_freq):
        # GH#52536
        msg = f"'{msg_freq***REMOVED***' is deprecated and will be removed in a future version."
...
***REMOVED***,
    ...
    def test_timedelta_range_deprecated_freq(
        ...
        # GH#52536
        msg = (
            f"'{freq_depr[-1]***REMOVED***' is deprecated and will be removed in a future version."
        )
