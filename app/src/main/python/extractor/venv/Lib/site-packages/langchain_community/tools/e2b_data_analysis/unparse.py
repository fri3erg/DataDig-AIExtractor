...
class Unparser:
    ...
    def _fstring_Constant(self, t, write):
        ...
        value = t.value.replace("{", "{{").replace("***REMOVED***", "***REMOVED******REMOVED***")
        write(value)
    ...
    def _Dict(self, t):
        ...
        def write_item(item):
            k, v = item
            if k is None:
                # for dictionary unpacking operator in dicts {**{'y': 2***REMOVED******REMOVED***
    ...
    unop = {"Invert": "~", "Not": "not", "UAdd": "+", "USub": "-"***REMOVED***
    ...
    ***REMOVED***
    ...
    boolops = {ast.And: "and", ast.Or: "or"***REMOVED***
