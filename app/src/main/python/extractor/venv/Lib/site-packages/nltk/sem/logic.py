...
class LogicParser:
    ...
    def parse(self, data, signature=None):
        ...
        try:
            ...
            msg = "{***REMOVED***\n{***REMOVED***\n{***REMOVED***^".format(e, data, " " * mapping[e.index - 1])
...
def read_logic(s, logic_parser=None, encoding=None):
    """
    Convert a file of First Order Formulas into a list of {Expression***REMOVED***s.
...
def unique_variable(pattern=None, ignore=None):
    ...
    v = Variable(f"{prefix***REMOVED***{_counter.get()***REMOVED***")
...
class ComplexType(Type):
    ...
    def __str__(self):
        if self == ANY_TYPE:
            ...
            return f"<{self.first***REMOVED***,{self.second***REMOVED***>"

    def str(self):
        if self == ANY_TYPE:
            return ANY_TYPE.str()
        else:
            return f"({self.first.str()***REMOVED*** -> {self.second.str()***REMOVED***)"
...
class Expression(SubstituteBindingsI):
    ...
    def typecheck(self, signature=None):
        ...
        return {key: sig[key][0].type for key in sig***REMOVED***
...
***REMOVED*** from e
    ...
    def predicates(self):
        ...
        if isinstance(self.function, ConstantExpression):
            function_preds = {self.function.variable***REMOVED***
        else:
...
***REMOVED***
    ...
    def free(self):
        """:see: Expression.free()"""
        return self.term.free() - {self.variable***REMOVED***
...
def demoException(s):
    try:
        ...
        print(f"{e.__class__.__name__***REMOVED***: {e***REMOVED***")


def printtype(ex):
    print(f"{ex.str()***REMOVED*** : {ex.type***REMOVED***")
