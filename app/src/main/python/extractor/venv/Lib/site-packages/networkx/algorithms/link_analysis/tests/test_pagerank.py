...
***REMOVED***
        ...
        cls.dangling_edges = {1: 2, 2: 3, 3: 0, 4: 0, 5: 0, 6: 0***REMOVED***
...
***REMOVED***
    ...
    def test_pagerank(self, alg):
        ...
        nstart = {n: random.random() for n in G***REMOVED***
    ...
    def test_personalization(self, alg):
        ...
        personalize = {0: 1, 1: 1, 2: 4, 3: 4***REMOVED***
        answer = {
    ...
    def test_empty(self):
        G = nx.Graph()
        assert nx.pagerank(G) == {***REMOVED***
        assert _pagerank_python(G) == {***REMOVED***
        assert _pagerank_numpy(G) == {***REMOVED***
...
class TestPageRankScipy(TestPageRank):
    def test_scipy_pagerank(self):
        ...
        for n in G:
            assert p[n] == pytest.approx(G.pagerank[n], abs=1e-4)
        personalize = {n: random.random() for n in G***REMOVED***
    ...
    def test_empty_scipy(self):
        G = nx.Graph()
        assert _pagerank_scipy(G) == {***REMOVED***
