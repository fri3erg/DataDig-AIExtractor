...
class TestGreenlet(TestCase):
    ...
    def test_switch_kwargs_to_parent(self):
        def run(x):
            ...
            return x, x ** 2
        g = RawGreenlet(run)
        self.assertEqual({'x': 3***REMOVED***, g.switch(3))
        self.assertEqual(((2,), {'x': 3***REMOVED***), g.switch())
    ...
    def test_instance_dict(self):
        ...
        def setdict(g, value):
            g.__dict__ = value
        g = RawGreenlet(f)
        self.assertEqual(g.__dict__, {***REMOVED***)
        g.switch()
        self.assertEqual(g.test, 42)
        self.assertEqual(g.__dict__, {'test': 42***REMOVED***)
...
***REMOVED***
    ...
    def test_abstract_subclasses(self):
        AbstractSubclass = ABCMeta(
            'AbstractSubclass',
            (RawGreenlet,),
            {'run': abstractmethod(lambda self: None)***REMOVED***)
...
class TestMainGreenlet(TestCase):
    ...
    def test_main_greenlet_type_can_be_subclassed(self):
        ...
        subclass = type('subclass', (main_type,), {***REMOVED***)
