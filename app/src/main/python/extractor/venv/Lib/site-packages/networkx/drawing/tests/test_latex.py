...
def test_tikz_attributes():
    ...
    expected_tex = r"""\begin{figure***REMOVED***
  \begin{tikzpicture***REMOVED***[scale=3]
      \draw
        (0, 0) node[blue] (0){0***REMOVED***
        (1, 1) node[line width=3,draw] (1){1***REMOVED***
        (2, 2) node[circle,draw,blue!50] (2){2***REMOVED***
        (3, 3) node (3){Stop***REMOVED***;
      \begin{scope***REMOVED***[->]
        \draw (0) to node[near end] {1st Step***REMOVED*** (1);
        \draw[loop,] (0) to node[midway] {Loop***REMOVED*** (0);
        \draw[>->,bend right,line width=3,green!90] (1) to node[pos=0.5] {2nd***REMOVED*** (2);
        \draw[bend left,green] (2) to node[near start] {3rd Step***REMOVED*** (3);
      \end{scope***REMOVED***
...
def test_basic_multiple_graphs():
    ...
    # print(latex_code)
    assert "begin{document***REMOVED***" in latex_code
    assert "begin{figure***REMOVED***" in latex_code
    assert latex_code.count("begin{subfigure***REMOVED***") == 4
    assert latex_code.count("tikzpicture") == 8
    assert latex_code.count("[-]") == 4


def test_basic_tikz():
    expected_tex = r"""\documentclass{report***REMOVED***
\usepackage{tikz***REMOVED***
\usepackage{subcaption***REMOVED***

\begin{document***REMOVED***
\begin{figure***REMOVED***
  \begin{subfigure***REMOVED***{0.5\textwidth***REMOVED***
  \begin{tikzpicture***REMOVED***[scale=2]
      \draw[gray!90]
        (0.749, 0.702) node[red!90] (0){0***REMOVED***
        (1.0, -0.014) node[red!90] (1){1***REMOVED***
        (-0.777, -0.705) node (2){2***REMOVED***
        (-0.984, 0.042) node (3){3***REMOVED***
        (-0.028, 0.375) node[cyan!90] (4){4***REMOVED***
        (-0.412, 0.888) node (5){5***REMOVED***
        (0.448, -0.856) node (6){6***REMOVED***
        (0.003, -0.431) node[cyan!90] (7){7***REMOVED***;
      \begin{scope***REMOVED***[->,gray!90]
        \draw (0) to (4);
        \draw (0) to (5);
        \draw (0) to (6);
        \draw (0) to (7);
      ...
      \end{scope***REMOVED***
    \end{tikzpicture***REMOVED***
    \caption{My tikz number 1 of 2***REMOVED***\label{tikz_1_2***REMOVED***
  \end{subfigure***REMOVED***
  \begin{subfigure***REMOVED***{0.5\textwidth***REMOVED***
  \begin{tikzpicture***REMOVED***[scale=2]
      \draw[gray!90]
        (0.749, 0.702) node[green!90] (0){0***REMOVED***
        (1.0, -0.014) node[green!90] (1){1***REMOVED***
        (-0.777, -0.705) node (2){2***REMOVED***
        (-0.984, 0.042) node (3){3***REMOVED***
        (-0.028, 0.375) node[purple!90] (4){4***REMOVED***
        (-0.412, 0.888) node (5){5***REMOVED***
        (0.448, -0.856) node (6){6***REMOVED***
        (0.003, -0.431) node[purple!90] (7){7***REMOVED***;
      \begin{scope***REMOVED***[->,gray!90]
        \draw (0) to (4);
        \draw (0) to (5);
        \draw (0) to (6);
      ...
      \end{scope***REMOVED***
    \end{tikzpicture***REMOVED***
    \caption{My tikz number 2 of 2***REMOVED***\label{tikz_2_2***REMOVED***
  \end{subfigure***REMOVED***
  \caption{A graph generated with python and latex.***REMOVED***
\end{figure***REMOVED***
\end{document***REMOVED***"""
    ...
    ***REMOVED***
    ...
    rc_node_color = {0: "red!90", 1: "red!90", 4: "cyan!90", 7: "cyan!90"***REMOVED***
    gp_node_color = {0: "green!90", 1: "green!90", 4: "purple!90", 7: "purple!90"***REMOVED***
...
def test_exception_multiple_graphs(to_latex=nx.to_latex):
    G = nx.path_graph(3)
    pos_bad = {0: (1, 2), 1: (0, 1)***REMOVED***
    pos_OK = {0: (1, 2), 1: (0, 1), 2: (2, 1)***REMOVED***
    fourG = [G, G, G, G]
