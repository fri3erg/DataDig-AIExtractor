...
class FreeText(MarkupAnnotation):
    ...
    def __init__(
        ...
        **kwargs: Any,
        ...
        font_str = "font: "
        if bold is True:
            font_str = f"{font_str***REMOVED***bold "
        if italic is True:
            font_str = f"{font_str***REMOVED***italic "
        font_str = f"{font_str***REMOVED***{font***REMOVED*** {font_size***REMOVED***"
        font_str = f"{font_str***REMOVED***;text-align:left;color:#{font_color***REMOVED***"

        default_appearance_string = ""
        if border_color:
            for st in hex_to_rgb(border_color):
                default_appearance_string = f"{default_appearance_string***REMOVED***{st***REMOVED*** "
            default_appearance_string = f"{default_appearance_string***REMOVED***rg"
...
***REMOVED***
        if is_external and is_internal:
            raise ValueError(
                ...
                f"url={url***REMOVED***, target_page_index={target_page_index***REMOVED***"
***REMOVED***
