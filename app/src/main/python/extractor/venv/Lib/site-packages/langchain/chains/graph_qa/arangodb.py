...
class ArangoGraphQAChain(Chain):
    ...
    ***REMOVED***
                raise ValueError(f"Response is Invalid: {aql_generation_output***REMOVED***")

            aql_query = matches[0]
            #####################

            _run_manager.on_text(
                f"AQL Query ({aql_generation_attempt***REMOVED***):", verbose=self.verbose
***REMOVED***
            _run_manager.on_text(
...
***REMOVED***
    ...
    ***REMOVED***
        ...
        # Return results #
        result = {self.output_key: result[self.qa_chain.output_key]***REMOVED***
