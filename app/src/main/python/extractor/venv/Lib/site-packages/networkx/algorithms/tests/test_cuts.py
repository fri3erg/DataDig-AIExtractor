...
class TestCutSize:
    ...
    def test_multigraph(self):
        ...
        assert nx.cut_size(G, {"a"***REMOVED***, {"b"***REMOVED***) == 2
...
class TestVolume:
    ...
    def test_graph(self):
        G = nx.cycle_graph(4)
        assert nx.volume(G, {0, 1***REMOVED***) == 4

    def test_digraph(self):
        G = nx.DiGraph([(0, 1), (1, 2), (2, 3), (3, 0)])
        assert nx.volume(G, {0, 1***REMOVED***) == 2

    def test_multigraph(self):
        edges = list(nx.cycle_graph(4).edges())
        G = nx.MultiGraph(edges * 2)
        assert nx.volume(G, {0, 1***REMOVED***) == 8
    ...
    def test_barbell(self):
        G = nx.barbell_graph(3, 0)
        assert nx.volume(G, {0, 1, 2***REMOVED***) == 7
        assert nx.volume(G, {3, 4, 5***REMOVED***) == 7
...
class TestNormalizedCutSize:
    ...
    def test_graph(self):
        ...
        # The cut looks like this: o-{-o--o-***REMOVED***-o
        expected = 2 * ((1 / 4) + (1 / 2))
