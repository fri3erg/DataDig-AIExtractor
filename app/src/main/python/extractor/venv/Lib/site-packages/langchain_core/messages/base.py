...
class BaseMessageChunk(BaseMessage):
    ...
    def _merge_kwargs_dict(
        ...
        Example:
        If left = {"function_call": {"arguments": None***REMOVED******REMOVED*** and
        ...
        for k, v in right.items():
            if k not in merged:
                ...
                raise TypeError(
                    f'additional_kwargs["{k***REMOVED***"] already exists in this message,'
    ...
    ***REMOVED***
                ...
                raise TypeError(
                    f"Additional kwargs key {k***REMOVED*** already exists in this message."
    ***REMOVED***
        return merged
...
***REMOVED***
            ...
            raise TypeError(
                ...
                f'" and "{other.__class__.__name__***REMOVED***"'
***REMOVED***
...
def message_to_dict(message: BaseMessage) -> dict:
    ...
    Returns:
        Message as a dict.
    """
    return {"type": message.type, "data": message.dict()***REMOVED***
