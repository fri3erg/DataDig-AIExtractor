...
def get_cache_file(mode: Mode) -> Path:
    return CACHE_DIR / f"cache.{mode.get_cache_key()***REMOVED***.pickle"
...
class Cache:
    ...
    def read(cls, mode: Mode) -> Self:
        ...
        try:
            ...
            err(f"Unable to read cache file {cache_file***REMOVED*** due to {e***REMOVED***")
        ...
        with cache_file.open("rb") as fobj:
            try:
                ...
                file_data = {k: FileData(*v) for k, v in data.items()***REMOVED***
    ...
    def write(self, sources: Iterable[Path]) -> None:
        ...
        self.file_data.update(
            **{str(src.resolve()): Cache.get_file_data(src) for src in sources***REMOVED***
        )
        try:
