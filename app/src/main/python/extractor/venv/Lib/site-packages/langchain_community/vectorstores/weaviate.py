        ...
        **kwargs: Any,
        ...
        with self._client.batch as batch:
            for i, text in enumerate(texts):
                data_properties = {self._text_key: text***REMOVED***
    ...
    ***REMOVED***
    ...
    def similarity_search_by_text(
        ...
        Returns:
            List of Documents most similar to the query.
        """
        content: Dict[str, Any] = {"concepts": [query]***REMOVED***
    ...
    def similarity_search_by_vector(
        ...
        vector = {"vector": embedding***REMOVED***
        query_obj = self._client.query.get(self._index_name, self._query_attrs)
        if kwargs.get("where_filter"):
            query_obj = query_obj.with_where(kwargs.get("where_filter"))
        if kwargs.get("tenant"):
...
***REMOVED***
        ...
        if not self._by_text:
            vector = {"vector": embedded_query***REMOVED***
            result = (
...
***REMOVED*** from e
        ...
        index_name = index_name or f"LangChain_{uuid4().hex***REMOVED***"
