...
class TimitCorpusReader(CorpusReader):
    ...
    def __init__(self, root, encoding="utf8"):
        ...
        self._root = root
        self.speakers = sorted({u.split("/")[0] for u in self._utterances***REMOVED***)
    ...
    def fileids(self, filetype=None):
        ...
        if filetype is None:
            ...
            return [f"{u***REMOVED***.{filetype***REMOVED***" for u in self._utterances]
    ...
    def utterance(self, spkrid, sentid):
        return f"{spkrid***REMOVED***/{sentid***REMOVED***"
    ...
    def spkrinfo(self, speaker):
        ...
        if self._speakerinfo is None:
            self._speakerinfo = {***REMOVED***
            with self.open("spkrinfo.txt") as fp:
                for line in fp:
                    if not line.strip() or line[0] == ";":
                        continue
                    rec = line.strip().split(None, 9)
                    key = f"dr{rec[2]***REMOVED***-{rec[1].lower()***REMOVED***{rec[0].lower()***REMOVED***"
...
***REMOVED***
    ...
    ***REMOVED***:
    ...
    def _utterance_fileids(self, utterances, extension):
        ...
        if isinstance(utterances, str):
            utterances = [utterances]
        return [f"{u***REMOVED***{extension***REMOVED***" for u in utterances]
...
class SpeakerInfo:
    ...
    def __repr__(self):
        ...
        args = [f"{attr***REMOVED***={getattr(self, attr)!r***REMOVED***" for attr in attribs.split()]
