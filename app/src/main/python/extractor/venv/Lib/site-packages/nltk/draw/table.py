...
class MultiListbox(Frame):
    ...
    def __init__(self, master, columns, column_weights=None, cnf={***REMOVED***, **kw):
        """
...
***REMOVED***
    ...
    def configure(self, cnf={***REMOVED***, **kw):
        """
        ...
        for (key, val) in list(cnf.items()):
            if key.startswith("label_") or key.startswith("label-"):
                for label in self._labels:
                    label.configure({key[6:]: val***REMOVED***)
            elif key.startswith("listbox_") or key.startswith("listbox-"):
                for listbox in self._listboxes:
                    listbox.configure({key[8:]: val***REMOVED***)
            else:
                Frame.configure(self, {key: val***REMOVED***)

    def __setitem__(self, key, val):
        """
        Configure this widget.  This is equivalent to
        ``self.configure({key,val``)***REMOVED***.  See ``configure()``.
        """
        self.configure({key: val***REMOVED***)

    def rowconfigure(self, row_index, cnf={***REMOVED***, **kw):
        """
    ...
    def columnconfigure(self, col_index, cnf={***REMOVED***, **kw):
        """
...
***REMOVED***:
                for i in range(lb.size()):
                    lb.itemconfigure(i, {key: val***REMOVED***)
            else:
                lb.configure({key: val***REMOVED***)
...
class Table:
    ...
    def __init__(
        ...
        **kw
        ...
        self._column_name_to_index = {c: i for (i, c) in enumerate(column_names)***REMOVED***
