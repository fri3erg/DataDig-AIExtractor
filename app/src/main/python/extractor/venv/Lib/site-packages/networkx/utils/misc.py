...
>>> import networkx
>>> networkx.utils.make_list_of_ints({1, 2, 3***REMOVED***)
[1, 2, 3]
>>> networkx.utils.arbitrary_element({5, 1, 7***REMOVED***)  # doctest: +SKIP
1
"""
...
def make_list_of_ints(sequence):
    ...
    if not isinstance(sequence, list):
        result = []
        for i in sequence:
            errmsg = f"sequence is not all integers: {i***REMOVED***"
            try:
                ii = int(i)
            except ValueError:
...
def arbitrary_element(iterable):
    ...
    1
    >>> nx.utils.arbitrary_element({1, 2, 3***REMOVED***)  # set
    1
    >>> d = {k: v for k, v in zip([1, 2, 3], [3, 2, 1])***REMOVED***
...
def groups(many_to_one):
    ...
    >>> many_to_one = {"a": 1, "b": 1, "c": 2, "d": 3, "e": 3***REMOVED***
    >>> groups(many_to_one)  # doctest: +SKIP
    {1: {'a', 'b'***REMOVED***, 2: {'c'***REMOVED***, 3: {'e', 'd'***REMOVED******REMOVED***
    """
...
def create_random_state(random_state=None):
    ...
    if isinstance(random_state, np.random.Generator):
        return random_state
    msg = (
        f"{random_state***REMOVED*** cannot be used to create a numpy.random.RandomState or\n"
...
def create_py_random_state(random_state=None):
    ...
    msg = f"{random_state***REMOVED*** cannot be used to generate a random.Random instance"
    raise ValueError(msg)
