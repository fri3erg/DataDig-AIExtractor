    ...
    ***REMOVED***
    ...
    def process_template_line(self, line):  # noqa: C901
        ...
        ***REMOVED***
            ...
            self.debug_print("recursive-include {***REMOVED*** {***REMOVED***".format(dir, ' '.join(patterns)))
            for pattern in patterns:
        ...
        ***REMOVED***
            ...
            self.debug_print("recursive-exclude {***REMOVED*** {***REMOVED***".format(dir, ' '.join(patterns)))
            for pattern in patterns:
...
def translate_pattern(pattern, anchor=1, prefix=None, is_regex=0):
    ...
    if prefix is not None:
        ...
        pattern_re = r'{***REMOVED***\A{***REMOVED***{***REMOVED***.*{***REMOVED***{***REMOVED***'.format(start, prefix_re, sep, pattern_re, end)
    else:  # no prefix -- respect anchor flag
        if anchor:
            pattern_re = r'{***REMOVED***\A{***REMOVED***'.format(start, pattern_re[len(start) :])
