...
***REMOVED***
    ...
    def _add_client_intro(self, section, client_methods):
        ...
        section.write(
            f"A low-level client representing {official_service_name***REMOVED***"
        )
        ...
        for method_name in sorted(client_methods):
            section.style.tocitem(f'{self._service_name***REMOVED***/client/{method_name***REMOVED***')

    def _add_class_signature(self, section):
        section.style.start_sphinx_py_class(
            class_name=f'{self._client_class_name***REMOVED***.Client'
        )
    ...
    def _add_client_creation_example(self, section):
        ...
        section.style.new_line()
        section.write(
            'client = session.create_client(\'{service***REMOVED***\')'.format(
...
***REMOVED***
    ...
    def _add_client_method(self, section, method_name, method):
        ...
        breadcrumb_section.style.ref(
            self._client_class_name, f'../../{self._service_name***REMOVED***'
        )
        breadcrumb_section.write(f' / Client / {method_name***REMOVED***')
        section.add_title_section(method_name)
        method_section = section.add_new_section(
            method_name,
            context={'qualifier': f'{self._client_class_name***REMOVED***.Client.'***REMOVED***,
        )
...
***REMOVED***
    ...
    def _add_method_exceptions_list(self, section, operation_model):
        ...
        for error in operation_model.error_shapes:
            class_name = (
                f'{self._client_class_name***REMOVED***.Client.exceptions.{error.name***REMOVED***'
***REMOVED***
    ...
    def _add_model_driven_method(self, section, method_name):
        ...
        full_method_name = (
            f"{section.context.get('qualifier', '')***REMOVED***{method_name***REMOVED***"
        )
        document_model_driven_method(
            section,
            full_method_name,
...
class ClientExceptionsDocumenter:
    ...
    ***REMOVED***,
    ...
    def _exception_class_name(self, shape):
        return f'{self._client_class_name***REMOVED***.Client.exceptions.{shape.name***REMOVED***'
    ...
    def _add_exceptions_list(self, section):
        ...
        for shape in error_shapes:
            section.style.tocitem(
                f'{self._service_name***REMOVED***/client/exceptions/{shape.name***REMOVED***'
***REMOVED***
...
***REMOVED***
    ...
    def _add_exception_class(self, section, shape):
        ...
        breadcrumb_section.write(f' / Client / exceptions / {shape.name***REMOVED***')
...
class ClientContextParamsDocumenter:
    ...
    ***REMOVED***
    ...
    def _add_context_params_list(self, section):
        section.style.new_line()
        sn = f'``{self._service_name***REMOVED***``'
        section.writeln(f'The available {sn***REMOVED*** client context params are:')
        for param in self._context_params:
            section.style.new_line()
            name = f'``{xform_name(param.name)***REMOVED***``'
            section.write(f'* {name***REMOVED*** ({param.type***REMOVED***) - {param.documentation***REMOVED***')
