...
RE_POSSIBLE_ENCODING_INDICATION = re_compile(
    r"(?:(?:encoding)|(?:charset)|(?:coding))(?:[\:= ]{1,10***REMOVED***)(?:[\"\']?)([a-zA-Z0-9\-_]+)(?:[\"\']?)",
    IGNORECASE,
)
...
IANA_SUPPORTED: List[str] = sorted(
    filter(
        ...
        and x not in {"rot_13", "tactis", "mbcs"***REMOVED***,
...
KO_NAMES: Set[str] = {"johab", "cp949", "euc_kr"***REMOVED***
ZH_NAMES: Set[str] = {"big5", "cp950", "big5hkscs", "hz"***REMOVED***
