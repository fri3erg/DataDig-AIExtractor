...
class TestCliques:
    def setup_method(self):
        ...
        H = nx.relabel_nodes(H, {i: i + 1 for i in range(6)***REMOVED***)
    ...
    def test_selfloops(self):
        ...
        answer = [{2, 6, 1, 3***REMOVED***, {2, 6, 4***REMOVED***, {5, 4, 7***REMOVED***, {8, 9***REMOVED***, {10, 11***REMOVED***]
    ...
    def test_number_of_cliques(self):
        ...
        assert nx.number_of_cliques(G, [1, 2]) == {1: 1, 2: 2***REMOVED***
        ...
        ***REMOVED***
        assert nx.number_of_cliques(G, nodes=list(G)) == {
            ...
            11: 1,
        ***REMOVED***
        assert nx.number_of_cliques(G, nodes=[2, 3, 4]) == {2: 2, 3: 1, 4: 2***REMOVED***
    ...
    def test_node_clique_number(self):
        ...
        assert nx.node_clique_number(G, [1, 2]) == {1: 4, 2: 4***REMOVED***
        assert nx.node_clique_number(G, 1) == 4
        ...
        ***REMOVED***
        assert nx.node_clique_number(G, cliques=self.cl) == {
            ...
            11: 2,
        ***REMOVED***
        assert nx.node_clique_number(G, [1, 2], cliques=self.cl) == {1: 4, 2: 4***REMOVED***
    ...
    def test_make_clique_bipartite(self):
        ...
        H1 = nx.relabel_nodes(H1, {-v: v for v in range(1, 6)***REMOVED***)
    ...
    def test_make_max_clique_graph(self):
        ...
        # 0.
        H1 = nx.relabel_nodes(H1, {-v: v - 1 for v in range(1, 6)***REMOVED***)
