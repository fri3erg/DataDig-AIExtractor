...
class SlackDirectoryLoader(BaseLoader):
    ...
    def _get_channel_id_map(zip_path: Path) -> Dict[str, str]:
        ...
        with zipfile.ZipFile(zip_path, "r") as zip_file:
            try:
                ...
                return {channel["name"]: channel["id"] for channel in channels***REMOVED***
            except KeyError:
                return {***REMOVED***
    ...
    def _get_message_source(self, channel_name: str, user: str, timestamp: str) -> str:
        ...
        if self.workspace_url:
            ...
            return (
                f"{self.workspace_url***REMOVED***/archives/{channel_id***REMOVED***"
                + f"/p{timestamp.replace('.', '')***REMOVED***"
***REMOVED***
        else:
            return f"{channel_name***REMOVED*** - {user***REMOVED*** - {timestamp***REMOVED***"
