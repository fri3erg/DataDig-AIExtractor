...
PROMPT_FOR_GENERATION_FORMAT = """{intro***REMOVED***
{instruction_key***REMOVED***
{instruction***REMOVED***
{response_key***REMOVED***
""".format(
    intro=INTRO_BLURB,
    instruction_key=INSTRUCTION_KEY,
    instruction="{instruction***REMOVED***",
...
***REMOVED***
    ...
    def _call(
        ...
        **kwargs: Any,
        ...
        payload = {"inputs": [prompt]***REMOVED***
        payload.update(_model_kwargs)
        payload.update(kwargs)

        # HTTP headers for authorization
        headers = {
            "Authorization": f"{self.mosaicml_api_token***REMOVED***",
    ...
    ***REMOVED***
            ...
            if isinstance(parsed_response, dict):
                ...
                for key in output_keys:
                    ...
                    raise ValueError(
                        f"No valid key ({', '.join(output_keys)***REMOVED***) in response:"
                        f" {parsed_response***REMOVED***"
        ***REMOVED***
                ...
                raise ValueError(f"Unexpected response type: {parsed_response***REMOVED***")
            ...
            raise ValueError(
                f"Error raised by inference API: {e***REMOVED***.\nResponse: {response.text***REMOVED***"
***REMOVED***
