    ...
    def _build_request(
        ...
        if options.url in _deployments_endpoints and is_mapping(options.json_data):
            ...
            if model is not None and not "/deployments" in str(self.base_url):
                options.url = f"/deployments/{model***REMOVED***{options.url***REMOVED***"
    ...
    def __init__(
        ...
        *,
        ...
        Args:
            ...
            azure_deployment: A model deployment, if given sets the base client URL to include `/deployments/{azure_deployment***REMOVED***`.
...
***REMOVED***
        ...
        if default_query is None:
            default_query = {"api-version": api_version***REMOVED***
        else:
            default_query = {**default_query, "api-version": api_version***REMOVED***
    ...
    ***REMOVED***
            ...
            if azure_deployment is not None:
                base_url = f"{azure_endpoint***REMOVED***/openai/deployments/{azure_deployment***REMOVED***"
            else:
                base_url = f"{azure_endpoint***REMOVED***/openai"
        else:
    ...
    def copy(
        ...
        *,
        ...
        _extra_kwargs: Mapping[str, Any] = {***REMOVED***,
    ) -> Self:
        """
    ...
    def _get_azure_ad_token(self) -> str | None:
        ...
        if provider is not None:
            ...
            if not token or not isinstance(token, str):  # pyright: ignore[reportUnnecessaryIsInstance]
                raise ValueError(
                    f"Expected `azure_ad_token_provider` argument to return a string but it returned {token***REMOVED***",
    ***REMOVED***
            return token
    ...
    def _prepare_options(self, options: FinalRequestOptions) -> None:
        headers: dict[str, str | Omit] = {**options.headers***REMOVED*** if is_given(options.headers) else {***REMOVED***
        options.headers = headers

        azure_ad_token = self._get_azure_ad_token()
        if azure_ad_token is not None:
            if headers.get("Authorization") is None:
                headers["Authorization"] = f"Bearer {azure_ad_token***REMOVED***"
