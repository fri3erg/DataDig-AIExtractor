...
***REMOVED***
    ...
    def _load_collection(self) -> DocumentCollection:
        ...
        try:
            ...
            logger.info(
                f"Collection {self.collection_name***REMOVED*** not found. Creating new collection."
***REMOVED***
...
***REMOVED***:
                raise ValueError(
                    ...
                    f" {self._collection.embedding_dimensions***REMOVED***, Embedding dimensions:"
                    f" {len(embeddings[0])***REMOVED***"
    ***REMOVED***
        else:
            pass
