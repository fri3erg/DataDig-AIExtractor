    ...
    def _call(
        ...
        **kwargs: Any,
        ...
        try:
            ...
            raise ValueError(f"Error raised by the service: {error***REMOVED***")

    def _call_eas(self, prompt: str = "", params: Dict = {***REMOVED***) -> Any:
        """Generate text from the eas service."""
        headers = {
            "Content-Type": "application/json",
            "Authorization": f"{self.eas_service_token***REMOVED***",
        ***REMOVED***
        if self.version == "1.0":
            body = {
                "input_ids": f"{prompt***REMOVED***",
            ***REMOVED***
        else:
            body = {
                "prompt": f"{prompt***REMOVED***",
            ***REMOVED***
        ...
        if response.status_code != 200:
            raise Exception(
                ...
                f" and message {response.text***REMOVED***"
***REMOVED***
    ...
    def _stream(
        ...
        ***REMOVED***
        ...
        if self.version == "1.0":
            pload = {"input_ids": prompt, **invocation_params***REMOVED***
...
***REMOVED***
            ...
            pload = {"prompt": prompt, "use_stream_chat": "True", **invocation_params***REMOVED***
