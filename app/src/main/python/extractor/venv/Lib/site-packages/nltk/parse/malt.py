...
def find_maltparser(parser_dirname):
    ...
    _jars = {os.path.split(jar)[1] for jar in _malt_jars***REMOVED***
    malt_dependencies = {"log4j.jar", "libsvm.jar", "liblinear-1.8.jar"***REMOVED***
