...
***REMOVED***
    ...
    @property
    def raw(self) -> str:
        return f"{type(self).__name__***REMOVED***(name={repr(self.name)***REMOVED***, type={self.type***REMOVED***)"
...
_bool_op_map = {"not": "~", "and": "&", "or": "|"***REMOVED***
...
class Op:
    ...
    def __repr__(self) -> str:
        ...
        parened = (f"({pprint_thing(opr)***REMOVED***)" for opr in self.operands)
        return pprint_thing(f" {self.op***REMOVED*** ".join(parened))
...
class BinOp(Op):
    ...
    def __init__(self, op: str, lhs, rhs) -> None:
        ...
        try:
            ...
            raise ValueError(
                f"Invalid binary operator {repr(op)***REMOVED***, valid operators are {keys***REMOVED***"
***REMOVED*** from err
...
class Div(BinOp):
    ...
    def __init__(self, lhs, rhs) -> None:
        ...
        if not isnumeric(lhs.return_type) or not isnumeric(rhs.return_type):
            raise TypeError(
                f"unsupported operand type(s) for {self.op***REMOVED***: "
                f"'{lhs.return_type***REMOVED***' and '{rhs.return_type***REMOVED***'"
***REMOVED***
...
class UnaryOp(Op):
    ...
    def __init__(self, op: Literal["+", "-", "~", "not"], operand) -> None:
        ...
        try:
            ...
            raise ValueError(
                f"Invalid unary operator {repr(op)***REMOVED***, "
                f"valid operators are {UNARY_OPS_SYMS***REMOVED***"
***REMOVED*** from err
    ...
    def __repr__(self) -> str:
        return pprint_thing(f"{self.op***REMOVED***({self.operand***REMOVED***)")
...
class MathCall(Op):
    ...
    def __repr__(self) -> str:
        ...
        return pprint_thing(f"{self.op***REMOVED***({','.join(operands)***REMOVED***)")


class FuncNode:
    def __init__(self, name: str) -> None:
        if name not in MATHOPS:
            raise ValueError(f'"{name***REMOVED***" is not a supported function')
        self.name = name
