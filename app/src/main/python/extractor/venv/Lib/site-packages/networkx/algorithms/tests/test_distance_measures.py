...
class TestDistance:
    ...
    def test_periphery(self):
        assert set(nx.periphery(self.G)) == {1, 4, 13, 16***REMOVED***

    def test_center(self):
        assert set(nx.center(self.G)) == {6, 7, 10, 11***REMOVED***
