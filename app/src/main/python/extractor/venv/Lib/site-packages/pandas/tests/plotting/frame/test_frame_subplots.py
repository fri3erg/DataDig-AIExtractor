...
***REMOVED***
    ...
    def test_subplots_sharex_axes_existing_axes(self):
        # GH 9158
        d = {"A": [1.0, 2.0, 3.0, 4.0], "B": [4.0, 3.0, 2.0, 1.0], "C": [5, 1, 3, 4]***REMOVED***
    ...
    def test_bar_log_no_subplots(self):
        ...
        # no subplots
        df = DataFrame({"A": [3] * 5, "B": list(range(1, 6))***REMOVED***, index=range(5))
    ...
    @pytest.mark.parametrize(
        ...
        [
            # stacked center
            {"kind": "bar", "stacked": True***REMOVED***,
            {"kind": "bar", "stacked": True, "width": 0.9***REMOVED***,
            {"kind": "barh", "stacked": True***REMOVED***,
            {"kind": "barh", "stacked": True, "width": 0.9***REMOVED***,
            # center
            {"kind": "bar", "stacked": False***REMOVED***,
            {"kind": "bar", "stacked": False, "width": 0.9***REMOVED***,
            {"kind": "barh", "stacked": False***REMOVED***,
            {"kind": "barh", "stacked": False, "width": 0.9***REMOVED***,
            # subplots center
            {"kind": "bar", "subplots": True***REMOVED***,
            {"kind": "bar", "subplots": True, "width": 0.9***REMOVED***,
            {"kind": "barh", "subplots": True***REMOVED***,
            {"kind": "barh", "subplots": True, "width": 0.9***REMOVED***,
            # align edge
            {"kind": "bar", "stacked": True, "align": "edge"***REMOVED***,
            {"kind": "bar", "stacked": True, "width": 0.9, "align": "edge"***REMOVED***,
            {"kind": "barh", "stacked": True, "align": "edge"***REMOVED***,
            {"kind": "barh", "stacked": True, "width": 0.9, "align": "edge"***REMOVED***,
            {"kind": "bar", "stacked": False, "align": "edge"***REMOVED***,
            {"kind": "bar", "stacked": False, "width": 0.9, "align": "edge"***REMOVED***,
            {"kind": "barh", "stacked": False, "align": "edge"***REMOVED***,
            {"kind": "barh", "stacked": False, "width": 0.9, "align": "edge"***REMOVED***,
            {"kind": "bar", "subplots": True, "align": "edge"***REMOVED***,
            {"kind": "bar", "subplots": True, "width": 0.9, "align": "edge"***REMOVED***,
            {"kind": "barh", "subplots": True, "align": "edge"***REMOVED***,
            {"kind": "barh", "subplots": True, "width": 0.9, "align": "edge"***REMOVED***,
        ],
    )
    def test_bar_align_multiple_columns(self, kwargs):
        # GH2157
        df = DataFrame({"A": [3] * 5, "B": list(range(5))***REMOVED***, index=range(5))
    ...
    @pytest.mark.parametrize(
        "kind, kwargs",
        [
            ["bar", {"stacked": True***REMOVED***],
            ["barh", {"stacked": False***REMOVED***],
            ["barh", {"stacked": True***REMOVED***],
            ["bar", {"subplots": True***REMOVED***],
            ["barh", {"subplots": True***REMOVED***],
        ],
    )
