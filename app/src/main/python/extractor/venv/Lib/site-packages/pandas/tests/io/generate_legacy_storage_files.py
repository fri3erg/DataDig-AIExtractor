...
def create_pickle_data():
    ...
    ***REMOVED***
    ...
    scalars = {"timestamp": Timestamp("20130101"), "period": Period("2012", "M")***REMOVED***
...
***REMOVED***,
    ...
    ***REMOVED***
    ...
    frame = {
        "float": DataFrame({"A": series["float"], "B": series["float"] + 1***REMOVED***),
        "int": DataFrame({"A": series["int"], "B": series["int"] + 1***REMOVED***),
        "mixed": DataFrame({k: data[k] for k in ["A", "B", "C", "D"]***REMOVED***),
        "mi": DataFrame(
            {"A": np.arange(5).astype(np.float64), "B": np.arange(5).astype(np.int64)***REMOVED***,
            index=MultiIndex.from_tuples(
                tuple(
                    zip(
                        *[
...
***REMOVED***,
        ...
        "cat_onecol": DataFrame({"A": Categorical(["foo", "bar"])***REMOVED***),
    ...
    ***REMOVED***
    ...
    return {
        ...
        "scalars": scalars,
        "mi": mi,
        "sp_series": {"float": _create_sp_series(), "ts": _create_sp_tsseries()***REMOVED***,
        "sp_frame": {"float": _create_sp_frame()***REMOVED***,
        "cat": cat,
        "timestamp": timestamp,
        "offsets": off,
    ***REMOVED***
...
def write_legacy_pickles(output_dir):
    ...
    print(f"  pandas version: {version***REMOVED***")
    print(f"  output dir    : {output_dir***REMOVED***")
    print("  storage format: pickle")

    pth = f"{platform_name()***REMOVED***.pickle"

    with open(os.path.join(output_dir, pth), "wb") as fh:
        pickle.dump(create_pickle_data(), fh, pickle.DEFAULT_PROTOCOL)

    print(f"created pickle file: {pth***REMOVED***")
...
def write_legacy_file():
    ...
    if storage_type == "pickle":
        ...
        sys.exit("storage_type must be one of {'pickle'***REMOVED***")
