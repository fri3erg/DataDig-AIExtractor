...
class RegexMatchStringEvaluator(StringEvaluator):
    ...
    >>> evaluator.evaluate_strings(
            ...
            reference="^mindy.*cto$",
        )  # This will return {'score': 1.0***REMOVED*** due to the IGNORECASE flag

    >>> evaluator = RegexMatchStringEvaluator()
    >>> evaluator.evaluate_strings(
            prediction="Mindy is the CTO",
            reference="^Mike.*CEO$",
        )  # This will return {'score': 0.0***REMOVED***

    >>> evaluator.evaluate_strings(
            prediction="Mindy is the CTO",
            reference="^Mike.*CEO$|^Mindy.*CTO$",
        )  # This will return {'score': 1.0***REMOVED*** as the prediction matches the second pattern in the union
    """  # noqa: E501
    ...
    def _evaluate_strings(  # type: ignore[arg-type,override]
        ...
        **kwargs: Any,
        ...
        return {"score": int(bool(match))***REMOVED***
