...
def _chat_stream_response_to_chat_generation_chunk(
    ...
    return ChatGenerationChunk(
        message=AIMessageChunk(
            content=parsed_response.get("message", {***REMOVED***).get("content", "")
        ),
        generation_info=generation_info,
    )
    ...
    def _format_message_as_text(self, message: BaseMessage) -> str:
        if isinstance(message, ChatMessage):
            ...
            if message.content[0].get("type") == "text":
                message_text = f"[INST] {message.content[0]['text']***REMOVED*** [/INST]"
    ...
    def _create_chat_stream(
        ...
        ***REMOVED***
        yield from self._create_stream(
            payload=payload, stop=stop, api_url=f"{self.base_url***REMOVED***/api/chat/", **kwargs
        )
