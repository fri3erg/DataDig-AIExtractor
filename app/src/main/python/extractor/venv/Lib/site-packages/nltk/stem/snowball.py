...
class SnowballStemmer(StemmerI):
    ...
    def __init__(self, language, ignore_stopwords=False):
        if language not in self.languages:
            raise ValueError(f"The language '{language***REMOVED***' is not supported.")
...
class _LanguageSpecificStemmer(StemmerI):
    ...
    def __init__(self, ignore_stopwords=False):
        ...
        if ignore_stopwords:
            try:
                ...
                raise ValueError(
                    "{!r***REMOVED*** has no list of stopwords. Please set"
    ...
    ***REMOVED*** from e
    ...
    def __repr__(self):
        ...
        """
        return f"<{type(self).__name__***REMOVED***>"
...
***REMOVED***
        ...
        stemmed = re.sub(r"(.{,70***REMOVED***)\s", r"\1\n", stemmed + " ").rstrip()
        excerpt = " ".join(excerpt)
        excerpt = re.sub(r"(.{,70***REMOVED***)\s", r"\1\n", excerpt + " ").rstrip()
