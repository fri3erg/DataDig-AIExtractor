...
def effective_size(G, nodes=None, weight=None):
    ...
    .. math::
       ...
       e(u) = \sum_{v \in N(u) \setminus \{u\***REMOVED******REMOVED***
       \left(1 - \sum_{w \in N(v)***REMOVED*** p_{uw***REMOVED*** m_{vw***REMOVED***\right)

    where $N(u)$ is the set of neighbors of $u$ and $p_{uw***REMOVED***$ is the
    normalized mutual weight of the (directed or undirected) edges
    joining $u$ and $v$, for each vertex $u$ and $v$ [1]_. And $m_{vw***REMOVED***$
    ...
    .. math::
       ...
       e(u) = n - \frac{2t***REMOVED***{n***REMOVED***
    ...
    >>> efficiency = {n: v / G.degree(n) for n, v in esize.items()***REMOVED***
...
def constraint(G, nodes=None, weight=None):
    ...
    .. math::
       ...
       c(v) = \sum_{w \in N(v) \setminus \{v\***REMOVED******REMOVED*** \ell(v, w)
...
def local_constraint(G, u, v, weight=None):
    ...
    .. math::
       ...
       \ell(u, v) = \left(p_{uv***REMOVED*** + \sum_{w \in N(v)***REMOVED*** p_{uw***REMOVED*** p_{wv***REMOVED***\right)^2,

    where $N(v)$ is the set of neighbors of $v$ and $p_{uv***REMOVED***$ is the
    normalized mutual weight of the (directed or undirected) edges
