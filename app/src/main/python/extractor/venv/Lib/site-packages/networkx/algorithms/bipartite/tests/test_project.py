...
class TestBipartiteProject:
    ...
    def test_digraph_weighted_projection(self):
        ...
        assert nx.get_edge_attributes(P, "weight") == {(1, 3): 1.0***REMOVED***
        assert len(P) == 2
...
class TestBipartiteWeightedProjection:
    ...
    def test_generic_weighted_projected_graph_simple(self):
        ...
        assert edges_equal(
            ...
            [(0, 2, {"weight": 1***REMOVED***), (2, 4, {"weight": 1***REMOVED***)],
        )
        ...
        assert nodes_equal(list(G), [0, 2, 4])
        assert edges_equal(
            list(G.edges(data=True)), [(0, 2, {"weight": 1***REMOVED***), (2, 4, {"weight": 1***REMOVED***)]
        )
    ...
    def test_generic_weighted_projected_graph_custom(self):
        ...
        assert edges_equal(list(G.edges(data=True)), [(0, 1, {"weight": 1.0***REMOVED***)])
        G = bipartite.generic_weighted_projected_graph(
            B, [0, 1], weight_function=my_weight
        )
        assert edges_equal(list(G.edges(data=True)), [(0, 1, {"weight": 10***REMOVED***)])
        G = bipartite.generic_weighted_projected_graph(B, [0, 1])
        assert edges_equal(list(G.edges(data=True)), [(0, 1, {"weight": 2***REMOVED***)])
