...
class TestFromrecords:
    ...
    def test_recarray_from_repr(self):
        ...
        recordarr_r = eval("numpy." + repr(recordarr), {'numpy': np***REMOVED***)
        recarr_r = eval("numpy." + repr(recarr), {'numpy': np***REMOVED***)
        recordview_r = eval("numpy." + repr(recordview), {'numpy': np***REMOVED***)
    ...
    def test_recarray_returntypes(self):
        qux_fields = {'C': (np.dtype('S5'), 0), 'D': (np.dtype('S5'), 6)***REMOVED***
