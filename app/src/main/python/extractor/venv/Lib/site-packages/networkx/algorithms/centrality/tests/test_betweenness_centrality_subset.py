...
class TestSubsetBetweennessCentrality:
    ...
    def test_P5_directed(self):
        ...
        b_answer = {0: 0, 1: 1, 2: 1, 3: 0, 4: 0, 5: 0***REMOVED***
    ...
    def test_P5(self):
        ...
        G = nx.Graph()
        nx.add_path(G, range(5))
        b_answer = {0: 0, 1: 0.5, 2: 0.5, 3: 0, 4: 0, 5: 0***REMOVED***
        b = nx.betweenness_centrality_subset(G, sources=[0], targets=[3], weight=None)
        for n in sorted(G):
            assert b[n] == pytest.approx(b_answer[n], abs=1e-7)
    ...
    def test_P5_multiple_target(self):
        ...
        G = nx.Graph()
        nx.add_path(G, range(5))
        b_answer = {0: 0, 1: 1, 2: 1, 3: 0.5, 4: 0, 5: 0***REMOVED***
        b = nx.betweenness_centrality_subset(
    ...
    def test_box(self):
        ...
        b_answer = {0: 0, 1: 0.25, 2: 0.25, 3: 0***REMOVED***
        b = nx.betweenness_centrality_subset(G, sources=[0], targets=[3], weight=None)
        for n in sorted(G):
            assert b[n] == pytest.approx(b_answer[n], abs=1e-7)
    ...
    def test_box_and_path(self):
        ...
        b_answer = {0: 0, 1: 0.5, 2: 0.5, 3: 0.5, 4: 0, 5: 0***REMOVED***
        b = nx.betweenness_centrality_subset(
            G, sources=[0], targets=[3, 4], weight=None
        )
        for n in sorted(G):
    ...
    def test_box_and_path2(self):
        ...
        b_answer = {0: 0, 1: 1.0, 2: 0.5, 20: 0.5, 3: 0.5, 4: 0***REMOVED***
        b = nx.betweenness_centrality_subset(
            G, sources=[0], targets=[3, 4], weight=None
        )
        for n in sorted(G):
    ...
    def test_normalized_P5_directed(self):
        ...
        G = nx.DiGraph()
        nx.add_path(G, range(5))
        b_answer = {0: 0, 1: 1.0 / 12.0, 2: 1.0 / 12.0, 3: 0, 4: 0, 5: 0***REMOVED***
        b = nx.betweenness_centrality_subset(
    ...
    def test_weighted_graph(self):
        ...
        b_answer = {0: 0.0, 1: 0.0, 2: 0.5, 3: 0.5, 4: 0.5, 5: 0.0***REMOVED***
        b = nx.betweenness_centrality_subset(
