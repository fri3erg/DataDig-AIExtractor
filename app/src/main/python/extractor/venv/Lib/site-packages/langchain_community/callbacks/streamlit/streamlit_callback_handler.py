...
class LLMThoughtLabeler:
    ...
    def get_initial_label(self) -> str:
        ...
        """
        return f"{THINKING_EMOJI***REMOVED*** **Thinking...**"
    ...
    def get_tool_label(self, tool: ToolRecord, is_complete: bool) -> str:
        ...
        if len(tool.input_str) > idx:
            input = input + "..."
        input = input.replace("\n", " ")
        label = f"{emoji***REMOVED*** **{name***REMOVED***:** {input***REMOVED***"
        return label
    ...
    def get_history_label(self) -> str:
        ...
        """
        return f"{HISTORY_EMOJI***REMOVED*** **History**"
    ...
    def get_final_agent_thought_label(self) -> str:
        ...
        a tool.
        """
        return f"{CHECKMARK_EMOJI***REMOVED*** **Complete!**"
...
class LLMThought:
    ...
    def on_tool_end(
        ...
        **kwargs: Any,
        ...
        self._container.markdown(f"**{output***REMOVED*****")
...
***REMOVED***, "_last_tool should never be null when _state == RUNNING_TOOL"
