...
class TestSlicing:
    ...
    def test_monotone_DTI_indexing_bug(self):
        ...
        df["date"] = date_index
        expected = DataFrame({0: list(range(5)), "date": date_index***REMOVED***)
        ...
        df = DataFrame({"A": [1, 2, 3]***REMOVED***, index=dti[::-1])

        expected = DataFrame({"A": 1***REMOVED***, index=dti[-1:][::-1])
    ...
    def test_partial_slicing_dataframe(self):
        ...
        for rnum, resolution in enumerate(resolutions[2:], 2):
            ...
            values = [1, 2, 3]
            df = DataFrame({"a": values***REMOVED***, index, dtype=np.int64)
...
***REMOVED***,
    ...
    def test_slice_reduce_to_series(self):
        # GH 27516
        df = DataFrame(
            {"A": range(24)***REMOVED***, index=date_range("2000", periods=24, freq="ME")
        )
        expected = Series(
