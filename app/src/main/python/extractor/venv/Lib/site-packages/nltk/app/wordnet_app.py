...
def _collect_one_synset(word, synset, synset_relations):
    ...
    s = f"<li>{make_lookup_link(ref, synset_label)***REMOVED*** ({descr***REMOVED***) "
...
class RestrictedUnpickler(pickle.Unpickler):
    ...
    def find_class(self, module, name):
        ...
        raise pickle.UnpicklingError(f"global '{module***REMOVED***.{name***REMOVED***' is forbidden")
...
def make_lookup_link(ref, label):
    return f'<a href="lookup_{ref.encode()***REMOVED***">{label***REMOVED***</a>'
