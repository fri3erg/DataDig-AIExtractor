...
class ArrowCTypes:
    ...
    #   - microseconds -> 'u'
    #   - nanoseconds -> 'n'
    TIMESTAMP = "ts{resolution***REMOVED***:{tz***REMOVED***"
    TIME = "tt{resolution***REMOVED***"
...
def dtype_to_arrow_c_fmt(dtype: DtypeObj) -> str:
    ...
    if isinstance(dtype, CategoricalDtype):
        ...
        if pa.types.is_decimal(pa_type):
            return f"d:{pa_type.precision***REMOVED***,{pa_type.scale***REMOVED***"
        elif pa.types.is_timestamp(pa_type) and pa_type.tz is not None:
            return f"ts{pa_type.unit[0]***REMOVED***:{pa_type.tz***REMOVED***"
    ...
    raise NotImplementedError(
        f"Conversion of {dtype***REMOVED*** to Arrow C format string is not implemented."
    )
