...
allTypes = {***REMOVED***            # Collect the types we will add to the module


# separate the actual type info from the abstract base classes
_abstract_types = {***REMOVED***
_concrete_typeinfo = {***REMOVED***
...
_concrete_types = {v.type for k, v in _concrete_typeinfo.items()***REMOVED***
...
sctypes = {'int': [],
           ...
           'float':[],
           'complex':[],
           'others':[bool, object, bytes, unicode, void]***REMOVED***
