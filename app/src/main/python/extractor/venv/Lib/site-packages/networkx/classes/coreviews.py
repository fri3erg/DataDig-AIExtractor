...
class AtlasView(Mapping):
    ...
    def __getstate__(self):
        return {"_atlas": self._atlas***REMOVED***
    ...
    def copy(self):
        return {n: self[n].copy() for n in self._atlas***REMOVED***

    def __str__(self):
        return str(self._atlas)  # {nbr: self[nbr] for nbr in self***REMOVED***)

    def __repr__(self):
        return f"{self.__class__.__name__***REMOVED***({self._atlas!r***REMOVED***)"
...
class UnionAtlas(Mapping):
    ...
    def __getstate__(self):
        return {"_succ": self._succ, "_pred": self._pred***REMOVED***
    ...
    def copy(self):
        result = {nbr: dd.copy() for nbr, dd in self._succ.items()***REMOVED***
    ...
    def __str__(self):
        return str({nbr: self[nbr] for nbr in self***REMOVED***)

    def __repr__(self):
        return f"{self.__class__.__name__***REMOVED***({self._succ!r***REMOVED***, {self._pred!r***REMOVED***)"
...
class UnionAdjacency(Mapping):
    ...
    succ : a dict-of-dict-of-dict {node: nbrdict***REMOVED***
    pred : a dict-of-dict-of-dict {node: nbrdict***REMOVED***
    ...
    def copy(self):
        return {n: self[n].copy() for n in self._succ***REMOVED***
...
class UnionMultiInner(UnionAtlas):
    ...
    def __getitem__(self, node):
        ...
        if in_succ:
            ...
            return UnionAtlas(self._succ[node], {***REMOVED***)
        return UnionAtlas({***REMOVED***, self._pred[node])

    def copy(self):
        nodes = set(self._succ.keys()) | set(self._pred.keys())
        return {n: self[n].copy() for n in nodes***REMOVED***
...
class FilterAtlas(Mapping):  # nodedict, nbrdict, keydict
    ...
    def __getitem__(self, key):
        if key in self._atlas and self.NODE_OK(key):
            return self._atlas[key]
        raise KeyError(f"Key {key***REMOVED*** not found")

    def __str__(self):
        return str({nbr: self[nbr] for nbr in self***REMOVED***)

    def __repr__(self):
        return f"{self.__class__.__name__***REMOVED***({self._atlas!r***REMOVED***, {self.NODE_OK!r***REMOVED***)"
...
class FilterAdjacency(Mapping):  # edgedict
    ...
    def __getitem__(self, node):
        ...
        raise KeyError(f"Key {node***REMOVED*** not found")
    ...
    def __repr__(self):
        ...
        return f"{name***REMOVED***({self._atlas!r***REMOVED***, {self.NODE_OK!r***REMOVED***, {self.EDGE_OK!r***REMOVED***)"
...
class FilterMultiInner(FilterAdjacency):  # muliedge_seconddict
    ...
    def __getitem__(self, nbr):
        ...
        raise KeyError(f"Key {nbr***REMOVED*** not found")
