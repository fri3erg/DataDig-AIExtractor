...
class AddressValue(msrest.serialization.Model):
    ...
    _attribute_map = {
        'house_number': {'key': 'houseNumber', 'type': 'str'***REMOVED***,
        'po_box': {'key': 'poBox', 'type': 'str'***REMOVED***,
        'road': {'key': 'road', 'type': 'str'***REMOVED***,
        'city': {'key': 'city', 'type': 'str'***REMOVED***,
        'state': {'key': 'state', 'type': 'str'***REMOVED***,
        'postal_code': {'key': 'postalCode', 'type': 'str'***REMOVED***,
        'country_region': {'key': 'countryRegion', 'type': 'str'***REMOVED***,
        'street_address': {'key': 'streetAddress', 'type': 'str'***REMOVED***,
        'unit': {'key': 'unit', 'type': 'str'***REMOVED***,
        'city_district': {'key': 'cityDistrict', 'type': 'str'***REMOVED***,
        'state_district': {'key': 'stateDistrict', 'type': 'str'***REMOVED***,
        'suburb': {'key': 'suburb', 'type': 'str'***REMOVED***,
        'house': {'key': 'house', 'type': 'str'***REMOVED***,
        'level': {'key': 'level', 'type': 'str'***REMOVED***,
    ***REMOVED***
...
class AnalyzeDocumentRequest(msrest.serialization.Model):
    ...
    _attribute_map = {
        'url_source': {'key': 'urlSource', 'type': 'str'***REMOVED***,
        'base64_source': {'key': 'base64Source', 'type': 'bytearray'***REMOVED***,
    ***REMOVED***
...
class AnalyzeResult(msrest.serialization.Model):
    ...
    _validation = {
        'api_version': {'required': True***REMOVED***,
        'model_id': {'required': True, 'pattern': r'^[a-zA-Z0-9][a-zA-Z0-9._~-]{1,63***REMOVED***$'***REMOVED***,
        'string_index_type': {'required': True***REMOVED***,
        'content': {'required': True***REMOVED***,
        'pages': {'required': True***REMOVED***,
    ***REMOVED***

    _attribute_map = {
        'api_version': {'key': 'apiVersion', 'type': 'str'***REMOVED***,
        'model_id': {'key': 'modelId', 'type': 'str'***REMOVED***,
        'string_index_type': {'key': 'stringIndexType', 'type': 'str'***REMOVED***,
        'content': {'key': 'content', 'type': 'str'***REMOVED***,
        'pages': {'key': 'pages', 'type': '[DocumentPage]'***REMOVED***,
        'paragraphs': {'key': 'paragraphs', 'type': '[DocumentParagraph]'***REMOVED***,
        'tables': {'key': 'tables', 'type': '[DocumentTable]'***REMOVED***,
        'key_value_pairs': {'key': 'keyValuePairs', 'type': '[DocumentKeyValuePair]'***REMOVED***,
        'styles': {'key': 'styles', 'type': '[DocumentStyle]'***REMOVED***,
        'languages': {'key': 'languages', 'type': '[DocumentLanguage]'***REMOVED***,
        'documents': {'key': 'documents', 'type': '[Document]'***REMOVED***,
    ***REMOVED***
...
class AnalyzeResultOperation(msrest.serialization.Model):
    ...
    _validation = {
        'status': {'required': True***REMOVED***,
        'created_date_time': {'required': True***REMOVED***,
        'last_updated_date_time': {'required': True***REMOVED***,
    ***REMOVED***

    _attribute_map = {
        'status': {'key': 'status', 'type': 'str'***REMOVED***,
        'created_date_time': {'key': 'createdDateTime', 'type': 'iso-8601'***REMOVED***,
        'last_updated_date_time': {'key': 'lastUpdatedDateTime', 'type': 'iso-8601'***REMOVED***,
        'error': {'key': 'error', 'type': 'Error'***REMOVED***,
        'analyze_result': {'key': 'analyzeResult', 'type': 'AnalyzeResult'***REMOVED***,
    ***REMOVED***
...
class AuthorizeCopyRequest(msrest.serialization.Model):
    ...
    _validation = {
        'model_id': {'required': True, 'pattern': r'^[a-zA-Z0-9][a-zA-Z0-9._~-]{1,63***REMOVED***$'***REMOVED***,
        'description': {'max_length': 4096, 'min_length': 0***REMOVED***,
    ***REMOVED***

    _attribute_map = {
        'model_id': {'key': 'modelId', 'type': 'str'***REMOVED***,
        'description': {'key': 'description', 'type': 'str'***REMOVED***,
        'tags': {'key': 'tags', 'type': '{str***REMOVED***'***REMOVED***,
    ***REMOVED***
...
class AzureBlobContentSource(msrest.serialization.Model):
    ...
    _validation = {
        'container_url': {'required': True***REMOVED***,
    ***REMOVED***

    _attribute_map = {
        'container_url': {'key': 'containerUrl', 'type': 'str'***REMOVED***,
        'prefix': {'key': 'prefix', 'type': 'str'***REMOVED***,
    ***REMOVED***
...
class AzureBlobFileListContentSource(msrest.serialization.Model):
    ...
    _validation = {
        'container_url': {'required': True***REMOVED***,
        'file_list': {'required': True***REMOVED***,
    ***REMOVED***

    _attribute_map = {
        'container_url': {'key': 'containerUrl', 'type': 'str'***REMOVED***,
        'file_list': {'key': 'fileList', 'type': 'str'***REMOVED***,
    ***REMOVED***
...
class BoundingRegion(msrest.serialization.Model):
    ...
    _validation = {
        'page_number': {'required': True, 'minimum': 1***REMOVED***,
        'polygon': {'required': True***REMOVED***,
    ***REMOVED***

    _attribute_map = {
        'page_number': {'key': 'pageNumber', 'type': 'int'***REMOVED***,
        'polygon': {'key': 'polygon', 'type': '[float]'***REMOVED***,
    ***REMOVED***
...
class BuildDocumentClassifierRequest(msrest.serialization.Model):
    ...
    _validation = {
        'classifier_id': {'required': True, 'pattern': r'^[a-zA-Z0-9][a-zA-Z0-9._~-]{1,63***REMOVED***$'***REMOVED***,
        'description': {'max_length': 4096, 'min_length': 0***REMOVED***,
        'doc_types': {'required': True***REMOVED***,
    ***REMOVED***

    _attribute_map = {
        'classifier_id': {'key': 'classifierId', 'type': 'str'***REMOVED***,
        'description': {'key': 'description', 'type': 'str'***REMOVED***,
        'doc_types': {'key': 'docTypes', 'type': '{ClassifierDocumentTypeDetails***REMOVED***'***REMOVED***,
    ***REMOVED***
...
class BuildDocumentModelRequest(msrest.serialization.Model):
    ...
    _validation = {
        'model_id': {'required': True, 'pattern': r'^[a-zA-Z0-9][a-zA-Z0-9._~-]{1,63***REMOVED***$'***REMOVED***,
        'description': {'max_length': 4096, 'min_length': 0***REMOVED***,
        'build_mode': {'required': True***REMOVED***,
    ***REMOVED***

    _attribute_map = {
        'model_id': {'key': 'modelId', 'type': 'str'***REMOVED***,
        'description': {'key': 'description', 'type': 'str'***REMOVED***,
        'build_mode': {'key': 'buildMode', 'type': 'str'***REMOVED***,
        'azure_blob_source': {'key': 'azureBlobSource', 'type': 'AzureBlobContentSource'***REMOVED***,
        'azure_blob_file_list_source': {'key': 'azureBlobFileListSource', 'type': 'AzureBlobFileListContentSource'***REMOVED***,
        'tags': {'key': 'tags', 'type': '{str***REMOVED***'***REMOVED***,
    ***REMOVED***
...
class ComposeDocumentModelRequest(msrest.serialization.Model):
    ...
    _validation = {
        'model_id': {'required': True, 'pattern': r'^[a-zA-Z0-9][a-zA-Z0-9._~-]{1,63***REMOVED***$'***REMOVED***,
        'description': {'max_length': 4096, 'min_length': 0***REMOVED***,
        'component_models': {'required': True***REMOVED***,
    ***REMOVED***

    _attribute_map = {
        'model_id': {'key': 'modelId', 'type': 'str'***REMOVED***,
        'description': {'key': 'description', 'type': 'str'***REMOVED***,
        'component_models': {'key': 'componentModels', 'type': '[ComponentDocumentModelDetails]'***REMOVED***,
        'tags': {'key': 'tags', 'type': '{str***REMOVED***'***REMOVED***,
    ***REMOVED***
...
class CopyAuthorization(msrest.serialization.Model):
    ...
    _validation = {
        'target_resource_id': {'required': True***REMOVED***,
        'target_resource_region': {'required': True***REMOVED***,
        'target_model_id': {'required': True, 'pattern': r'^[a-zA-Z0-9][a-zA-Z0-9._~-]{1,63***REMOVED***$'***REMOVED***,
        'target_model_location': {'required': True***REMOVED***,
        'access_token': {'required': True***REMOVED***,
        'expiration_date_time': {'required': True***REMOVED***,
    ***REMOVED***

    _attribute_map = {
        'target_resource_id': {'key': 'targetResourceId', 'type': 'str'***REMOVED***,
        'target_resource_region': {'key': 'targetResourceRegion', 'type': 'str'***REMOVED***,
        'target_model_id': {'key': 'targetModelId', 'type': 'str'***REMOVED***,
        'target_model_location': {'key': 'targetModelLocation', 'type': 'str'***REMOVED***,
        'access_token': {'key': 'accessToken', 'type': 'str'***REMOVED***,
        'expiration_date_time': {'key': 'expirationDateTime', 'type': 'iso-8601'***REMOVED***,
    ***REMOVED***
...
class CurrencyValue(msrest.serialization.Model):
    ...
    _validation = {
        'amount': {'required': True***REMOVED***,
    ***REMOVED***

    _attribute_map = {
        'amount': {'key': 'amount', 'type': 'float'***REMOVED***,
        'currency_symbol': {'key': 'currencySymbol', 'type': 'str'***REMOVED***,
        'currency_code': {'key': 'currencyCode', 'type': 'str'***REMOVED***,
    ***REMOVED***
...
class CustomDocumentModelsDetails(msrest.serialization.Model):
    ...
    _validation = {
        'count': {'required': True***REMOVED***,
        'limit': {'required': True***REMOVED***,
    ***REMOVED***

    _attribute_map = {
        'count': {'key': 'count', 'type': 'int'***REMOVED***,
        'limit': {'key': 'limit', 'type': 'int'***REMOVED***,
    ***REMOVED***
...
class Document(msrest.serialization.Model):
    ...
    _validation = {
        'doc_type': {'required': True, 'max_length': 64, 'min_length': 2***REMOVED***,
        'spans': {'required': True***REMOVED***,
        'confidence': {'required': True, 'maximum': 1, 'minimum': 0***REMOVED***,
    ***REMOVED***

    _attribute_map = {
        'doc_type': {'key': 'docType', 'type': 'str'***REMOVED***,
        'bounding_regions': {'key': 'boundingRegions', 'type': '[BoundingRegion]'***REMOVED***,
        'spans': {'key': 'spans', 'type': '[DocumentSpan]'***REMOVED***,
        'fields': {'key': 'fields', 'type': '{DocumentField***REMOVED***'***REMOVED***,
        'confidence': {'key': 'confidence', 'type': 'float'***REMOVED***,
    ***REMOVED***
...
class DocumentBarcode(msrest.serialization.Model):
    ...
    _validation = {
        'kind': {'required': True***REMOVED***,
        'value': {'required': True***REMOVED***,
        'span': {'required': True***REMOVED***,
        'confidence': {'required': True, 'maximum': 1, 'minimum': 0***REMOVED***,
    ***REMOVED***

    _attribute_map = {
        'kind': {'key': 'kind', 'type': 'str'***REMOVED***,
        'value': {'key': 'value', 'type': 'str'***REMOVED***,
        'polygon': {'key': 'polygon', 'type': '[float]'***REMOVED***,
        'span': {'key': 'span', 'type': 'DocumentSpan'***REMOVED***,
        'confidence': {'key': 'confidence', 'type': 'float'***REMOVED***,
    ***REMOVED***
...
class OperationDetails(msrest.serialization.Model):
    ...
    _validation = {
        'operation_id': {'required': True***REMOVED***,
        'status': {'required': True***REMOVED***,
        'percent_completed': {'maximum': 100, 'minimum': 0***REMOVED***,
        'created_date_time': {'required': True***REMOVED***,
        'last_updated_date_time': {'required': True***REMOVED***,
        'kind': {'required': True***REMOVED***,
        'resource_location': {'required': True***REMOVED***,
    ***REMOVED***

    _attribute_map = {
        'operation_id': {'key': 'operationId', 'type': 'str'***REMOVED***,
        'status': {'key': 'status', 'type': 'str'***REMOVED***,
        'percent_completed': {'key': 'percentCompleted', 'type': 'int'***REMOVED***,
        'created_date_time': {'key': 'createdDateTime', 'type': 'iso-8601'***REMOVED***,
        'last_updated_date_time': {'key': 'lastUpdatedDateTime', 'type': 'iso-8601'***REMOVED***,
        'kind': {'key': 'kind', 'type': 'str'***REMOVED***,
        'resource_location': {'key': 'resourceLocation', 'type': 'str'***REMOVED***,
        'api_version': {'key': 'apiVersion', 'type': 'str'***REMOVED***,
        'tags': {'key': 'tags', 'type': '{str***REMOVED***'***REMOVED***,
        'error': {'key': 'error', 'type': 'Error'***REMOVED***,
    ***REMOVED***
    ...
    _subtype_map = {
        'kind': {'documentClassifierBuild': 'DocumentClassifierBuildOperationDetails', 'documentModelBuild': 'DocumentModelBuildOperationDetails', 'documentModelCompose': 'DocumentModelComposeOperationDetails', 'documentModelCopyTo': 'DocumentModelCopyToOperationDetails'***REMOVED***
    ***REMOVED***
...
class DocumentClassifierBuildOperationDetails(OperationDetails):
    ...
    ***REMOVED***
    ...
    _attribute_map = {
        ...
        'tags': {'key': 'tags', 'type': '{str***REMOVED***'***REMOVED***,
        'error': {'key': 'error', 'type': 'Error'***REMOVED***,
        'result': {'key': 'result', 'type': 'DocumentClassifierDetails'***REMOVED***,
    ***REMOVED***
...
class DocumentField(msrest.serialization.Model):
    ...
    _validation = {
        'type': {'required': True***REMOVED***,
        'confidence': {'maximum': 1, 'minimum': 0***REMOVED***,
    ***REMOVED***

    _attribute_map = {
        'type': {'key': 'type', 'type': 'str'***REMOVED***,
        'value_string': {'key': 'valueString', 'type': 'str'***REMOVED***,
        'value_date': {'key': 'valueDate', 'type': 'date'***REMOVED***,
        'value_time': {'key': 'valueTime', 'type': 'time'***REMOVED***,
        'value_phone_number': {'key': 'valuePhoneNumber', 'type': 'str'***REMOVED***,
        'value_number': {'key': 'valueNumber', 'type': 'float'***REMOVED***,
        'value_integer': {'key': 'valueInteger', 'type': 'long'***REMOVED***,
        'value_selection_mark': {'key': 'valueSelectionMark', 'type': 'str'***REMOVED***,
        'value_signature': {'key': 'valueSignature', 'type': 'str'***REMOVED***,
        'value_country_region': {'key': 'valueCountryRegion', 'type': 'str'***REMOVED***,
        'value_array': {'key': 'valueArray', 'type': '[DocumentField]'***REMOVED***,
        'value_object': {'key': 'valueObject', 'type': '{DocumentField***REMOVED***'***REMOVED***,
        'value_currency': {'key': 'valueCurrency', 'type': 'CurrencyValue'***REMOVED***,
        'value_address': {'key': 'valueAddress', 'type': 'AddressValue'***REMOVED***,
        'value_boolean': {'key': 'valueBoolean', 'type': 'bool'***REMOVED***,
        'content': {'key': 'content', 'type': 'str'***REMOVED***,
        'bounding_regions': {'key': 'boundingRegions', 'type': '[BoundingRegion]'***REMOVED***,
        'spans': {'key': 'spans', 'type': '[DocumentSpan]'***REMOVED***,
        'confidence': {'key': 'confidence', 'type': 'float'***REMOVED***,
...
class DocumentFieldSchema(msrest.serialization.Model):
    ...
    ***REMOVED***
    ...
    _attribute_map = {
        'type': {'key': 'type', 'type': 'str'***REMOVED***,
        'description': {'key': 'description', 'type': 'str'***REMOVED***,
        'example': {'key': 'example', 'type': 'str'***REMOVED***,
        'items': {'key': 'items', 'type': 'DocumentFieldSchema'***REMOVED***,
        'properties': {'key': 'properties', 'type': '{DocumentFieldSchema***REMOVED***'***REMOVED***,
    ***REMOVED***
...
class DocumentKeyValuePair(msrest.serialization.Model):
    ...
    _validation = {
        'key': {'required': True***REMOVED***,
        'confidence': {'required': True, 'maximum': 1, 'minimum': 0***REMOVED***,
    ***REMOVED***

    _attribute_map = {
        'key': {'key': 'key', 'type': 'DocumentKeyValueElement'***REMOVED***,
        'value': {'key': 'value', 'type': 'DocumentKeyValueElement'***REMOVED***,
        'confidence': {'key': 'confidence', 'type': 'float'***REMOVED***,
    ***REMOVED***
...
class DocumentLanguage(msrest.serialization.Model):
    ...
    _validation = {
        'locale': {'required': True***REMOVED***,
        'spans': {'required': True***REMOVED***,
        'confidence': {'required': True, 'maximum': 1, 'minimum': 0***REMOVED***,
    ***REMOVED***

    _attribute_map = {
        'locale': {'key': 'locale', 'type': 'str'***REMOVED***,
        'spans': {'key': 'spans', 'type': '[DocumentSpan]'***REMOVED***,
        'confidence': {'key': 'confidence', 'type': 'float'***REMOVED***,
    ***REMOVED***
...
class DocumentModelBuildOperationDetails(OperationDetails):
    ...
    ***REMOVED***
    ...
    _attribute_map = {
        ...
        'tags': {'key': 'tags', 'type': '{str***REMOVED***'***REMOVED***,
        'error': {'key': 'error', 'type': 'Error'***REMOVED***,
        'result': {'key': 'result', 'type': 'DocumentModelDetails'***REMOVED***,
    ***REMOVED***
...
class DocumentModelDetails(msrest.serialization.Model):
    ...
    ***REMOVED***
    ...
    _attribute_map = {
        ...
        'api_version': {'key': 'apiVersion', 'type': 'str'***REMOVED***,
        'tags': {'key': 'tags', 'type': '{str***REMOVED***'***REMOVED***,
        'doc_types': {'key': 'docTypes', 'type': '{DocumentTypeDetails***REMOVED***'***REMOVED***,
    ***REMOVED***
...
class DocumentPage(msrest.serialization.Model):
    ...
    _validation = {
        'page_number': {'required': True, 'minimum': 1***REMOVED***,
        'angle': {'maximum': 180, 'minimum_ex': -180***REMOVED***,
        'width': {'minimum': 0***REMOVED***,
        'height': {'minimum': 0***REMOVED***,
        'spans': {'required': True***REMOVED***,
    ***REMOVED***

    _attribute_map = {
        'page_number': {'key': 'pageNumber', 'type': 'int'***REMOVED***,
        'angle': {'key': 'angle', 'type': 'float'***REMOVED***,
        'width': {'key': 'width', 'type': 'float'***REMOVED***,
        'height': {'key': 'height', 'type': 'float'***REMOVED***,
        'unit': {'key': 'unit', 'type': 'str'***REMOVED***,
        'spans': {'key': 'spans', 'type': '[DocumentSpan]'***REMOVED***,
        'words': {'key': 'words', 'type': '[DocumentWord]'***REMOVED***,
        'selection_marks': {'key': 'selectionMarks', 'type': '[DocumentSelectionMark]'***REMOVED***,
        'lines': {'key': 'lines', 'type': '[DocumentLine]'***REMOVED***,
        'barcodes': {'key': 'barcodes', 'type': '[DocumentBarcode]'***REMOVED***,
        'formulas': {'key': 'formulas', 'type': '[DocumentFormula]'***REMOVED***,
    ***REMOVED***
...
class DocumentParagraph(msrest.serialization.Model):
    ...
    ***REMOVED***
    ...
    _attribute_map = {
        'role': {'key': 'role', 'type': 'str'***REMOVED***,
        'content': {'key': 'content', 'type': 'str'***REMOVED***,
        'bounding_regions': {'key': 'boundingRegions', 'type': '[BoundingRegion]'***REMOVED***,
        'spans': {'key': 'spans', 'type': '[DocumentSpan]'***REMOVED***,
    ***REMOVED***
...
class DocumentSpan(msrest.serialization.Model):
    ...
    _validation = {
        'offset': {'required': True, 'minimum': 0***REMOVED***,
        'length': {'required': True, 'minimum': 0***REMOVED***,
    ***REMOVED***

    _attribute_map = {
        'offset': {'key': 'offset', 'type': 'int'***REMOVED***,
        'length': {'key': 'length', 'type': 'int'***REMOVED***,
    ***REMOVED***
...
class DocumentStyle(msrest.serialization.Model):
    ...
    _validation = {
        'color': {'pattern': r'^#[0-9a-f]{6***REMOVED***$'***REMOVED***,
        'background_color': {'pattern': r'^#[0-9a-f]{6***REMOVED***$'***REMOVED***,
        'spans': {'required': True***REMOVED***,
        'confidence': {'required': True, 'maximum': 1, 'minimum': 0***REMOVED***,
    ***REMOVED***

    _attribute_map = {
        'is_handwritten': {'key': 'isHandwritten', 'type': 'bool'***REMOVED***,
        'similar_font_family': {'key': 'similarFontFamily', 'type': 'str'***REMOVED***,
        'font_style': {'key': 'fontStyle', 'type': 'str'***REMOVED***,
        'font_weight': {'key': 'fontWeight', 'type': 'str'***REMOVED***,
        'color': {'key': 'color', 'type': 'str'***REMOVED***,
        'background_color': {'key': 'backgroundColor', 'type': 'str'***REMOVED***,
        'spans': {'key': 'spans', 'type': '[DocumentSpan]'***REMOVED***,
        'confidence': {'key': 'confidence', 'type': 'float'***REMOVED***,
    ***REMOVED***
...
class DocumentTable(msrest.serialization.Model):
    ...
    _validation = {
        'row_count': {'required': True, 'minimum': 1***REMOVED***,
        'column_count': {'required': True, 'minimum': 1***REMOVED***,
        'cells': {'required': True***REMOVED***,
        'spans': {'required': True***REMOVED***,
    ***REMOVED***

    _attribute_map = {
        'row_count': {'key': 'rowCount', 'type': 'int'***REMOVED***,
        'column_count': {'key': 'columnCount', 'type': 'int'***REMOVED***,
        'cells': {'key': 'cells', 'type': '[DocumentTableCell]'***REMOVED***,
        'bounding_regions': {'key': 'boundingRegions', 'type': '[BoundingRegion]'***REMOVED***,
        'spans': {'key': 'spans', 'type': '[DocumentSpan]'***REMOVED***,
    ***REMOVED***
...
class DocumentTableCell(msrest.serialization.Model):
    ...
    _validation = {
        'row_index': {'required': True***REMOVED***,
        'column_index': {'required': True***REMOVED***,
        'row_span': {'minimum': 1***REMOVED***,
        'column_span': {'minimum': 1***REMOVED***,
        'content': {'required': True***REMOVED***,
        'spans': {'required': True***REMOVED***,
    ***REMOVED***
    ...
    _attribute_map = {
        'kind': {'key': 'kind', 'type': 'str'***REMOVED***,
        'row_index': {'key': 'rowIndex', 'type': 'int'***REMOVED***,
        'column_index': {'key': 'columnIndex', 'type': 'int'***REMOVED***,
        'row_span': {'key': 'rowSpan', 'type': 'int'***REMOVED***,
        'column_span': {'key': 'columnSpan', 'type': 'int'***REMOVED***,
        'content': {'key': 'content', 'type': 'str'***REMOVED***,
        'bounding_regions': {'key': 'boundingRegions', 'type': '[BoundingRegion]'***REMOVED***,
        'spans': {'key': 'spans', 'type': '[DocumentSpan]'***REMOVED***,
    ***REMOVED***
...
class DocumentTypeDetails(msrest.serialization.Model):
    ...
    _validation = {
        'description': {'max_length': 4096, 'min_length': 0***REMOVED***,
        'field_schema': {'required': True***REMOVED***,
    ***REMOVED***

    _attribute_map = {
        'description': {'key': 'description', 'type': 'str'***REMOVED***,
        'build_mode': {'key': 'buildMode', 'type': 'str'***REMOVED***,
        'field_schema': {'key': 'fieldSchema', 'type': '{DocumentFieldSchema***REMOVED***'***REMOVED***,
        'field_confidence': {'key': 'fieldConfidence', 'type': '{float***REMOVED***'***REMOVED***,
    ***REMOVED***
...
class Error(msrest.serialization.Model):
    ...
    _validation = {
        'code': {'required': True***REMOVED***,
        'message': {'required': True***REMOVED***,
    ***REMOVED***

    _attribute_map = {
        'code': {'key': 'code', 'type': 'str'***REMOVED***,
        'message': {'key': 'message', 'type': 'str'***REMOVED***,
        'target': {'key': 'target', 'type': 'str'***REMOVED***,
        'details': {'key': 'details', 'type': '[Error]'***REMOVED***,
        'innererror': {'key': 'innererror', 'type': 'InnerError'***REMOVED***,
    ***REMOVED***
...
class GetDocumentClassifiersResponse(msrest.serialization.Model):
    ...
    ***REMOVED***
    ...
    _attribute_map = {
        'value': {'key': 'value', 'type': '[DocumentClassifierDetails]'***REMOVED***,
        'next_link': {'key': 'nextLink', 'type': 'str'***REMOVED***,
    ***REMOVED***
...
class GetDocumentModelsResponse(msrest.serialization.Model):
    ...
    ***REMOVED***
    ...
    _attribute_map = {
        'value': {'key': 'value', 'type': '[DocumentModelSummary]'***REMOVED***,
        'next_link': {'key': 'nextLink', 'type': 'str'***REMOVED***,
    ***REMOVED***
...
class GetOperationsResponse(msrest.serialization.Model):
    ...
    ***REMOVED***
    ...
    _attribute_map = {
        'value': {'key': 'value', 'type': '[OperationSummary]'***REMOVED***,
        'next_link': {'key': 'nextLink', 'type': 'str'***REMOVED***,
    ***REMOVED***
...
class QuotaDetails(msrest.serialization.Model):
    ...
    _validation = {
        'used': {'required': True***REMOVED***,
        'quota': {'required': True***REMOVED***,
        'quota_reset_date_time': {'required': True***REMOVED***,
    ***REMOVED***

    _attribute_map = {
        'used': {'key': 'used', 'type': 'int'***REMOVED***,
        'quota': {'key': 'quota', 'type': 'int'***REMOVED***,
        'quota_reset_date_time': {'key': 'quotaResetDateTime', 'type': 'iso-8601'***REMOVED***,
    ***REMOVED***
...
class ResourceDetails(msrest.serialization.Model):
    ...
    _validation = {
        'custom_document_models': {'required': True***REMOVED***,
        'custom_neural_document_model_builds': {'required': True***REMOVED***,
    ***REMOVED***

    _attribute_map = {
        'custom_document_models': {'key': 'customDocumentModels', 'type': 'CustomDocumentModelsDetails'***REMOVED***,
        'custom_neural_document_model_builds': {'key': 'customNeuralDocumentModelBuilds', 'type': 'QuotaDetails'***REMOVED***,
    ***REMOVED***
