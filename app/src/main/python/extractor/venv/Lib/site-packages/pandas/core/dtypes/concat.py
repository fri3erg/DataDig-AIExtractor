...
def _get_result_dtype(
    ...
    dtypes = {obj.dtype for obj in to_concat***REMOVED***
    kinds = {obj.dtype.kind for obj in to_concat***REMOVED***
    ...
    if any_ea:
        ...
        # cast this to float)
        if len(kinds) != 1:
            if not len(kinds - {"i", "u", "f"***REMOVED***) or not len(kinds - {"b", "i", "u"***REMOVED***):
                # let numpy coerce
                pass
            else:
                # coerce to object
