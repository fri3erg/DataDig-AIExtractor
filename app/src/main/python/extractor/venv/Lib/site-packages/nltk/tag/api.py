...
class TaggerI(metaclass=ABCMeta):
    ...
    def recall(self, gold) -> Dict[str, float]:
        ...
        return {tag: cm.recall(tag) for tag in cm._values***REMOVED***
    ...
    def precision(self, gold):
        ...
        cm = self.confusion(gold)
        return {tag: cm.precision(tag) for tag in cm._values***REMOVED***
    ...
    def f_measure(self, gold, alpha=0.5):
        ...
        """
        cm = self.confusion(gold)
        return {tag: cm.f_measure(tag, alpha) for tag in cm._values***REMOVED***
