...
def directed_edge_swap(G, *, nswap=1, max_tries=100, seed=None):
    ...
    while swapcount < nswap:
        ...
        if tries > max_tries:
            msg = f"Maximum number of swap attempts ({tries***REMOVED***) exceeded before desired swaps achieved ({nswap***REMOVED***)."
...
def double_edge_swap(G, nswap=1, max_tries=100, seed=None):
    ...
    while swapcount < nswap:
        ...
        if n >= max_tries:
            e = (
                f"Maximum number of swap attempts ({n***REMOVED***) exceeded "
                f"before desired swaps achieved ({nswap***REMOVED***)."
***REMOVED***
