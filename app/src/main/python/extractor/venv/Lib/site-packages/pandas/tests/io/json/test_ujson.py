...
def _clean_dict(d):
    ...
    cleaned_dict : dict
    """
    return {str(k): v for k, v in d.items()***REMOVED***
...
***REMOVED***
    ...
    def test_encode_dict_with_unicode_keys(self, unicode_key):
        unicode_dict = {unicode_key: "value1"***REMOVED***
    ...
    def test_encode_dict_conversion(self):
        dict_input = {"k1": 1, "k2": 2, "k3": 3, "k4": 4***REMOVED***
    ...
    def test_encode_time_conversion_basic(self, test):
        ...
        expected = f'"{test.isoformat()***REMOVED***"'
    ...
    def test_decode_from_unicode(self):
        unicode_input = '{"obj": 31337***REMOVED***'
...
***REMOVED***,
            ('{{"key":"***REMOVED***', "Unmatched ''\"' when when decoding 'string'"),
    ...
    @pytest.mark.parametrize(
        "invalid_dict",
        [
            "{{{{31337***REMOVED******REMOVED******REMOVED******REMOVED***",  # No key.
            '{{{{"key":***REMOVED******REMOVED******REMOVED******REMOVED***',  # No value.
            '{{{{"key"***REMOVED******REMOVED******REMOVED******REMOVED***',  # No colon or value.
        ],
    )
    ...
    def test_decode_number_with_32bit_sign_bit(self, val):
        ...
        doc = f'{{"id": {val***REMOVED******REMOVED******REMOVED***'
...
class TestPandasJSONTests:
    def test_dataframe(self, orient):
        ...
        encode_kwargs = {***REMOVED*** if orient is None else {"orient": orient***REMOVED***
    ...
    def test_dataframe_nested(self, orient):
        ...
        nested = {"df1": df, "df2": df.copy()***REMOVED***
        kwargs = {***REMOVED*** if orient is None else {"orient": orient***REMOVED***
    ...
    @pytest.mark.parametrize("too_extreme_num", [f"{2**64***REMOVED***", f"{-2**63-1***REMOVED***"])
    ...
    def test_decode_with_trailing_whitespaces(self):
        assert {***REMOVED*** == ujson.ujson_loads("{***REMOVED***\n\t ")

    def test_decode_with_trailing_non_whitespaces(self):
        with pytest.raises(ValueError, match="Trailing data"):
            ujson.ujson_loads("{***REMOVED***\n\t a")

    @pytest.mark.parametrize("value", [f"{2**64***REMOVED***", f"{-2**63-1***REMOVED***"])
    ...
    def test_encode_timedelta_iso(self, td):
        ...
        expected = f'"{td.isoformat()***REMOVED***"'
