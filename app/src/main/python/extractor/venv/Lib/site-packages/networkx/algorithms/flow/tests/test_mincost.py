...
class TestMinCostFlow:
    def test_simple_digraph(self):
        ...
        soln = {"a": {"b": 4, "c": 1***REMOVED***, "b": {"d": 4***REMOVED***, "c": {"d": 1***REMOVED***, "d": {***REMOVED******REMOVED***
        assert flowCost == 24
    ...
    def test_digraph1(self):
        ...
        G.add_edges_from(
            [
                (1, 2, {"capacity": 15, "weight": 4***REMOVED***),
                (1, 3, {"capacity": 8, "weight": 4***REMOVED***),
                (2, 3, {"weight": 2***REMOVED***),
                (2, 4, {"capacity": 4, "weight": 2***REMOVED***),
                (2, 5, {"capacity": 10, "weight": 6***REMOVED***),
                (3, 4, {"capacity": 15, "weight": 1***REMOVED***),
                (3, 5, {"capacity": 5, "weight": 3***REMOVED***),
                (4, 5, {"weight": 2***REMOVED***),
                (5, 3, {"capacity": 4, "weight": 1***REMOVED***),
            ]
        )
        flowCost, H = nx.network_simplex(G)
        soln = {
            1: {2: 12, 3: 8***REMOVED***,
            2: {3: 8, 4: 4, 5: 0***REMOVED***,
            3: {4: 11, 5: 5***REMOVED***,
            4: {5: 10***REMOVED***,
            5: {3: 0***REMOVED***,
        ***REMOVED***
    ...
    def test_digraph2(self):
        ...
        soln = {
            1: {2: 6, 4: 5, 5: 1***REMOVED***,
            2: {3: 6, 5: 4, 6: 2***REMOVED***,
            3: {6: 20***REMOVED***,
            4: {5: 2, "t": 3***REMOVED***,
            5: {6: 0, "t": 7***REMOVED***,
            6: {"t": 22***REMOVED***,
            "s": {1: 12, 2: 6, 3: 14***REMOVED***,
            "t": {***REMOVED***,
        ***REMOVED***
        assert flow == soln
    ...
    def test_digraph3(self):
        ...
        G = nx.DiGraph()
        G.add_edge("s", "a")
        G["s"]["a"].update({0: 2, 1: 4***REMOVED***)
        G.add_edge("s", "b")
        G["s"]["b"].update({0: 2, 1: 1***REMOVED***)
        G.add_edge("a", "b")
        G["a"]["b"].update({0: 5, 1: 2***REMOVED***)
        G.add_edge("a", "t")
        G["a"]["t"].update({0: 1, 1: 5***REMOVED***)
        G.add_edge("b", "a")
        G["b"]["a"].update({0: 1, 1: 3***REMOVED***)
        G.add_edge("b", "t")
        G["b"]["t"].update({0: 3, 1: 2***REMOVED***)
        ...
        assert sol["s"] == {"a": 2, "b": 2***REMOVED***
        assert sol["a"] == {"b": 1, "t": 1***REMOVED***
        assert sol["b"] == {"a": 0, "t": 3***REMOVED***
        assert sol["t"] == {***REMOVED***

        G.add_edge("t", "s")
        G["t"]["s"].update({1: -100***REMOVED***)
    ...
    def test_zero_capacity_edges(self):
        ...
        G.add_edges_from(
            [
                (1, 2, {"capacity": 1, "weight": 1***REMOVED***),
                (1, 5, {"capacity": 1, "weight": 1***REMOVED***),
                (2, 3, {"capacity": 0, "weight": 1***REMOVED***),
                (2, 5, {"capacity": 1, "weight": 1***REMOVED***),
                (5, 3, {"capacity": 2, "weight": 1***REMOVED***),
                (5, 4, {"capacity": 0, "weight": 1***REMOVED***),
                (3, 4, {"capacity": 2, "weight": 1***REMOVED***),
            ]
        )
        G.nodes[1]["demand"] = -1
        G.nodes[2]["demand"] = -1
        ...
        flowCost, H = nx.network_simplex(G)
        soln = {1: {2: 0, 5: 1***REMOVED***, 2: {3: 0, 5: 1***REMOVED***, 3: {4: 2***REMOVED***, 4: {***REMOVED***, 5: {3: 2, 4: 0***REMOVED******REMOVED***
        assert flowCost == 6
    ...
    def test_digon(self):
        ...
        #618 by arv."""
        nodes = [(1, {***REMOVED***), (2, {"demand": -4***REMOVED***), (3, {"demand": 4***REMOVED***)]
        edges = [
            (1, 2, {"capacity": 3, "weight": 600000***REMOVED***),
            (2, 1, {"capacity": 2, "weight": 0***REMOVED***),
            (2, 3, {"capacity": 5, "weight": 714285***REMOVED***),
            (3, 2, {"capacity": 2, "weight": 0***REMOVED***),
        ]
        G = nx.DiGraph(edges)
        G.add_nodes_from(nodes)
        flowCost, H = nx.network_simplex(G)
        soln = {1: {2: 0***REMOVED***, 2: {1: 0, 3: 4***REMOVED***, 3: {2: 0***REMOVED******REMOVED***
    ...
    def test_infinite_capacity_neg_digon(self):
        ...
        nodes = [(1, {***REMOVED***), (2, {"demand": -4***REMOVED***), (3, {"demand": 4***REMOVED***)]
        edges = [
            (1, 2, {"weight": -600***REMOVED***),
            (2, 1, {"weight": 0***REMOVED***),
            (2, 3, {"capacity": 5, "weight": 714285***REMOVED***),
            (3, 2, {"capacity": 2, "weight": 0***REMOVED***),
        ]
        G = nx.DiGraph(edges)
    ...
    def test_finite_capacity_neg_digon(self):
        ...
        flowCost, H = nx.capacity_scaling(G)
        assert flowCost == -2
        assert H == {"a": {"b": 1***REMOVED***, "b": {"a": 1***REMOVED******REMOVED***
    ...
    def test_multidigraph(self):
        ...
        flowCost, H = nx.network_simplex(G)
        assert flowCost == 0
        assert H == {1: {2: {0: 0***REMOVED******REMOVED***, 2: {3: {0: 0***REMOVED******REMOVED***, 3: {***REMOVED******REMOVED***
    ...
    def test_negative_selfloops(self):
        ...
        flowCost, H = nx.network_simplex(G)
        assert flowCost == -2
        assert H == {1: {1: 2***REMOVED******REMOVED***
        flowCost, H = nx.capacity_scaling(G)
        assert flowCost == -2
        assert H == {1: {1: 2***REMOVED******REMOVED***
        ...
        flowCost, H = nx.network_simplex(G)
        assert flowCost == -2
        assert H == {1: {1: {"x": 2, "y": 0***REMOVED******REMOVED******REMOVED***
        flowCost, H = nx.capacity_scaling(G)
        assert flowCost == -2
        assert H == {1: {1: {"x": 2, "y": 0***REMOVED******REMOVED******REMOVED***
    ...
    def test_bone_shaped(self):
        ...
        flowCost, H = nx.network_simplex(G)
        assert flowCost == 0
        assert H == {0: {1: 2, 2: 2, 3: 0***REMOVED***, 1: {***REMOVED***, 2: {***REMOVED***, 3: {***REMOVED***, 4: {3: 2***REMOVED***, 5: {3: 2***REMOVED******REMOVED***
        flowCost, H = nx.capacity_scaling(G)
        assert flowCost == 0
        assert H == {0: {1: 2, 2: 2, 3: 0***REMOVED***, 1: {***REMOVED***, 2: {***REMOVED***, 3: {***REMOVED***, 4: {3: 2***REMOVED***, 5: {3: 2***REMOVED******REMOVED***
