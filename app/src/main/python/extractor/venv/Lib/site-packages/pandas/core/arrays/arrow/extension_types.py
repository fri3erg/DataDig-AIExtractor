...
class ArrowPeriodType(pyarrow.ExtensionType):
    ...
    def __arrow_ext_serialize__(self) -> bytes:
        metadata = {"freq": self.freq***REMOVED***
...
class ArrowIntervalType(pyarrow.ExtensionType):
    ...
    def __arrow_ext_serialize__(self) -> bytes:
        metadata = {"subtype": str(self.subtype), "closed": self.closed***REMOVED***
        return json.dumps(metadata).encode()
...
storage_type = {storage_type***REMOVED***
serialized = {serialized***REMOVED***
pickle disassembly:\n{pickle_disassembly***REMOVED***
