...
_extension_array_shared_docs: dict[str, str] = {***REMOVED***
...
***REMOVED***
    ...
    def __setitem__(self, key, value) -> None:
        ...
        raise NotImplementedError(f"{type(self)***REMOVED*** does not implement __setitem__.")
    ...
    def interpolate(
        ...
        **kwargs,
        ...
        raise NotImplementedError(
            f"{type(self).__name__***REMOVED*** does not implement interpolate"
        )
...
***REMOVED***
            if limit_area is not None:
                raise NotImplementedError(
                    f"{type(self).__name__***REMOVED*** does not implement limit_area "
    ...
    ***REMOVED***
    ...
    def fillna(
        ...
        method : {'backfill', 'bfill', 'pad', 'ffill', None***REMOVED***, default None
            Method to use for filling holes in reindexed Series:
        ...
        if method is not None:
            warnings.warn(
                f"The 'method' keyword in {type(self).__name__***REMOVED***.fillna is "
...
***REMOVED***
    ...
    def searchsorted(
        ...
        side : {'left', 'right'***REMOVED***, optional
    ...
    def __repr__(self) -> str:
        ...
        class_name = f"<{type(self).__name__***REMOVED***>\n"
        footer = self._get_repr_footer()
        return f"{class_name***REMOVED***{data***REMOVED***\n{footer***REMOVED***"

    def _get_repr_footer(self) -> str:
        # GH#24278
        if self.ndim > 1:
            return f"Shape: {self.shape***REMOVED***, dtype: {self.dtype***REMOVED***"
        return f"Length: {len(self)***REMOVED***, dtype: {self.dtype***REMOVED***"
...
***REMOVED***
    ...
    def ravel(self, order: Literal["C", "F", "A", "K"] | None = "C") -> ExtensionArray:
        ...
        Parameters
        ----------
        order : {None, 'C', 'F', 'A', 'K'***REMOVED***, default 'C'
    ...
    def _accumulate(
        ...
        **kwargs
        ...
        Length: 3, dtype: Int64
        """
        raise NotImplementedError(f"cannot perform {name***REMOVED*** with type {self.dtype***REMOVED***")
        ...
        **kwargs
        ...
        if meth is None:
            raise TypeError(
                ...
                f"does not support reduction '{name***REMOVED***'"
***REMOVED***
    ...
    def _empty(cls, shape: Shape, dtype: ExtensionDtype):
        ...
        if not isinstance(result, cls) or dtype != result.dtype:
            raise NotImplementedError(
                f"Default 'empty' implementation is invalid for dtype='{dtype***REMOVED***'"
***REMOVED***
        return result
    ...
    def _groupby_op(
        ...
        **kwargs,
        ...
        how : {'any', 'all', 'sum', 'prod', 'min', 'max', 'mean', 'median',
               ...
               'cumprod', 'cumsum', 'cummin', 'cummax', 'rank'***REMOVED***
        has_dropped_na : bool
        min_count : int
        ngroups : int
        ...
        **kwargs : operation-specific
        ...
        if isinstance(self.dtype, StringDtype):
            ...
            raise NotImplementedError(
                f"function is not implemented for this dtype: {self.dtype***REMOVED***"
***REMOVED***
...
class ExtensionScalarOpsMixin(ExtensionOpsMixin):
    ...
    def _create_method(cls, op, coerce_to_dtype: bool = True, result_dtype=None):
        ...
        def _binop(self, other):
            ...
            if op.__name__ in {"divmod", "rdivmod"***REMOVED***:
                a, b = zip(*res)
                return _maybe_convert(a), _maybe_convert(b)

            return _maybe_convert(res)

        op_name = f"__{op.__name__***REMOVED***__"
