...
class _HeapElement:
    ...
    ***REMOVED***
    ...
    def __repr__(self):
        return f"_HeapElement({self.priority***REMOVED***, {self.element***REMOVED***)"
...
class MappedQueue:
    ...
    >>> colors_nm = {'red':665, 'blue': 470, 'green': 550***REMOVED***
    ...
    >>> q = MappedQueue({100: 0, 'a': 1 ***REMOVED***)
    ...
    def _heapify(self):
        ...
        self.position = {elt: pos for pos, elt in enumerate(self.heap)***REMOVED***
