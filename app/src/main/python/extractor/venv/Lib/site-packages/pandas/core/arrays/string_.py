...
class StringDtype(StorageExtensionDtype):
    ...
    Parameters
    ----------
    storage : {"python", "pyarrow", "pyarrow_numpy"***REMOVED***, optional
    ...
    def __init__(self, storage=None) -> None:
        ...
        if storage not in {"python", "pyarrow", "pyarrow_numpy"***REMOVED***:
            raise ValueError(
                f"Storage must be 'python', 'pyarrow' or 'pyarrow_numpy'. "
                f"Got {storage***REMOVED*** instead."
***REMOVED***
...
***REMOVED***
        if string == "string":
            ...
            raise TypeError(f"Cannot construct a '{cls.__name__***REMOVED***' from '{string***REMOVED***'")
    ...
    def _validate(self):
        ...
        if self._ndarray.dtype != "object":
            raise ValueError(
                ...
                f"'{self._ndarray.dtype***REMOVED***' dtype instead."
***REMOVED***
    ...
    def __setitem__(self, key, value) -> None:
        ...
        if scalar_value:
            if isna(value):
                ...
                raise TypeError(
                    f"Cannot set non-string value '{value***REMOVED***' into a StringArray."
    ***REMOVED***
        else:
    ...
    def _reduce(
        ...
        raise TypeError(f"Cannot perform reduction '{name***REMOVED***' with string dtype")
    ...
    def _cmp_method(self, other, op):
        ...
        if not lib.is_scalar(other):
            if len(other) != len(self):
                ...
                raise ValueError(
                    f"Lengths of operands do not match: {len(self)***REMOVED*** != {len(other)***REMOVED***"
    ***REMOVED***
