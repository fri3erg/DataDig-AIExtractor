    ...
    ***REMOVED***:
    ...
    def _decorate_clauses(clauses):
        ...
        for i in range(len(clauses)):
            ...
            out += f"[{seq***REMOVED***] {clauses[i]***REMOVED*** {parents***REMOVED*** {taut***REMOVED***\n"
        return out
...
***REMOVED***
    ...
    def __str__(self):
        return "{" + ", ".join("%s" % item for item in self) + "***REMOVED***"
...
def _iterate_first(first, second, bindings, used, skipped, finalize_method, debug):
    ...
    """
    debug.line(f"unify({first***REMOVED***,{second***REMOVED***) {bindings***REMOVED***")
...
***REMOVED*** from e
    ...
    def __str__(self):
        data_str = ", ".join(f"{v***REMOVED***: {self.d[v]***REMOVED***" for v in sorted(self.d.keys()))
        return "{" + data_str + "***REMOVED***"
...
class UnificationException(Exception):
    def __init__(self, a, b):
        Exception.__init__(self, f"'{a***REMOVED***' cannot unify with '{b***REMOVED***'")
...
def testResolutionProver():
    ...
    print(f"{p1***REMOVED***, {p2***REMOVED*** |- {c***REMOVED***: {ResolutionProver().prove(c, [p1, p2])***REMOVED***")
    ...
    print(f"{p***REMOVED*** |- {c***REMOVED***: {ResolutionProver().prove(c, [p])***REMOVED***")


def resolution_test(e):
    f = Expression.fromstring(e)
    t = ResolutionProver().prove(f)
    print(f"|- {f***REMOVED***: {t***REMOVED***")
