...
_shared_docs_kwargs: dict[str, str] = {***REMOVED***
...
class Resampler(BaseGroupBy, PandasObject):
    ...
    _internal_names_set = set({"obj", "ax", "_indexer"***REMOVED***)
    ...
    def __str__(self) -> str:
        ...
        """
        attrs = (
            f"{k***REMOVED***={getattr(self._timegrouper, k)***REMOVED***"
            for k in self._attributes
            if getattr(self._timegrouper, k, None) is not None
        )
        return f"{type(self).__name__***REMOVED*** [{', '.join(attrs)***REMOVED***]"
    ...
    @Substitution(
        klass="Resampler",
        examples="""
    >>> df = pd.DataFrame({'A': [1, 2, 3, 4]***REMOVED***,
...
***REMOVED***
    ...
    def bfill(self, limit: int | None = None):
        ...
        >>> df = pd.DataFrame({'a': [2, np.nan, 6], 'b': [1, 3, 5]***REMOVED***,
    ...
    def fillna(self, method, limit: int | None = None):
        ...
        Parameters
        ----------
        method : {'pad', 'backfill', 'ffill', 'bfill', 'nearest'***REMOVED***
        ...
        """
        warnings.warn(
            f"{type(self).__name__***REMOVED***.fillna is deprecated and will be removed "
...
class DatetimeIndexResampler(Resampler):
    ...
    def _upsample(self, method, limit: int | None = None, fill_value=None):
        ...
        method : string {'backfill', 'bfill', 'pad',
            'ffill', 'asfreq'***REMOVED*** method for upsampling
...
***REMOVED***
    ...
    def _downsample(self, how, **kwargs):
        ...
        **kwargs : kw args passed to how function
        ...
        raise IncompatibleFrequency(
            f"Frequency {ax.freq***REMOVED*** cannot be resampled to {self.freq***REMOVED***, "
    ...
    def _upsample(self, method, limit: int | None = None, fill_value=None):
        ...
        Parameters
        ----------
        method : {'backfill', 'bfill', 'pad', 'ffill'***REMOVED***
...
class TimeGrouper(Grouper):
    ...
    convention : {'start', 'end', 'e', 's'***REMOVED***
    ...
    def __init__(
        ...
        **kwargs,
        ...
        if label not in {None, "left", "right"***REMOVED***:
            raise ValueError(f"Unsupported value {label***REMOVED*** for `label`")
        if closed not in {None, "left", "right"***REMOVED***:
            raise ValueError(f"Unsupported value {closed***REMOVED*** for `closed`")
        if convention not in {None, "start", "end", "e", "s"***REMOVED***:
            raise ValueError(f"Unsupported value {convention***REMOVED*** for `convention`")
...
***REMOVED***
        ...
        end_types = {"ME", "YE", "QE", "BME", "BYE", "BQE", "W"***REMOVED***
        rule = freq.rule_code
        ...
        if origin in ("epoch", "start", "start_day", "end", "end_day"):
            ...
            try:
                ...
                raise ValueError(
                    ...
                    "'end', 'end_day' or "
                    f"should be a Timestamp convertible type. Got '{origin***REMOVED***' instead."
    ***REMOVED*** from err
...
***REMOVED***
        ...
        raise TypeError(
            ...
            f"but got an instance of '{type(ax).__name__***REMOVED***'"
        )
    ...
    def _get_time_bins(self, ax: DatetimeIndex):
        if not isinstance(ax, DatetimeIndex):
            raise TypeError(
                ...
                f"an instance of {type(ax).__name__***REMOVED***"
***REMOVED***
...
***REMOVED***
        ...
        if not isinstance(self.freq, Tick):
            ...
            raise ValueError(
                ...
                f"e.g. '24h' or '3D', not {self.freq***REMOVED***"
***REMOVED***
...
def _get_timestamp_range_edges(
    ...
    closed : {'right', 'left'***REMOVED***, default "left"
        Which side of bin interval is closed.
    origin : {'epoch', 'start', 'start_day'***REMOVED*** or Timestamp, default 'start_day'
...
def _get_period_range_edges(
    ...
    closed : {'right', 'left'***REMOVED***, default "left"
        Which side of bin interval is closed.
    origin : {'epoch', 'start', 'start_day'***REMOVED***, Timestamp, default 'start_day'
        The timestamp on which to adjust the grouping. The timezone of origin must
        match the timezone of the index.
    ...
    if isinstance(obj.index, PeriodIndex):
        ...
        if isinstance(freq, BaseOffset):
            if hasattr(freq, "_period_dtype_code"):
                ...
                raise ValueError(
                    f"Invalid offset: '{freq.base***REMOVED***' for converting time series "
                    f"with PeriodIndex."
    ***REMOVED***
...
def maybe_warn_args_and_kwargs(cls, kernel: str, args, kwargs) -> None:
    ...
    if warn_args and warn_kwargs:
        ...
        return
    warnings.warn(
        f"Passing additional {msg***REMOVED*** to {cls.__name__***REMOVED***.{kernel***REMOVED*** has "
