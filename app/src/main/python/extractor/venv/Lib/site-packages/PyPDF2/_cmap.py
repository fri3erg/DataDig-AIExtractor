    ...
    ***REMOVED***
    ...
    if isinstance(enc, str):
        try:
            ...
            warnings.warn(
                f"Advanced encoding {enc***REMOVED*** not implemented yet",
                PdfReadWarning,
***REMOVED***
            encoding = enc
        ...
        try:
            ...
            warnings.warn(
                f"Advanced encoding {encoding***REMOVED*** not implemented yet",
                PdfReadWarning,
***REMOVED***
...
***REMOVED***  # join is here as some cases where the code was split
        map_dict[
...
def compute_space_width(
    ...
    ***REMOVED***
        ...
        try:
            ...
            sp_width = (
                w1[-1] / 2.0
***REMOVED***  # if using default we consider space will be only half size
    elif "/Widths" in ft:
