...
// libdivide_64_div_32_to_32: divides a 64-bit uint {u1, u0***REMOVED*** by a 32-bit
// uint {v***REMOVED***. The result must fit in 32 bits.
...
// libdivide_128_div_64_to_64: divides a 128-bit uint {u1, u0***REMOVED*** by a 64-bit
// uint {v***REMOVED***. The result must fit in 64 bits.
// Returns the quotient directly and the remainder in *r
...
static uint64_t libdivide_128_div_128_to_64(uint64_t u_hi, uint64_t u_lo, uint64_t v_hi, uint64_t v_lo, uint64_t *r_hi, uint64_t *r_lo) {
    ...
    *r_hi = (uint64_t)(remainder >> 64);
    ...
    typedef struct { uint64_t hi; uint64_t lo; ***REMOVED*** u128_t;
    u128_t u = {u_hi, u_lo***REMOVED***;
    u128_t v = {v_hi, v_lo***REMOVED***;
...
struct libdivide_u32_branchfree_t libdivide_u32_branchfree_gen(uint32_t d) {
    ...
    ***REMOVED***
    ...
    struct libdivide_u32_branchfree_t ret = {tmp.magic, (uint8_t)(tmp.more & LIBDIVIDE_32_SHIFT_MASK)***REMOVED***;
    return ret;
***REMOVED***
...
uint32_t libdivide_u32_recover(const struct libdivide_u32_t *denom) {
    ...
    if (!denom->magic) {
        return 1U << shift;
    ***REMOVED*** else if (!(more & LIBDIVIDE_ADD_MARKER)) {
...
struct libdivide_u64_branchfree_t libdivide_u64_branchfree_gen(uint64_t d) {
    ...
    ***REMOVED***
    ...
    struct libdivide_u64_branchfree_t ret = {tmp.magic, (uint8_t)(tmp.more & LIBDIVIDE_64_SHIFT_MASK)***REMOVED***;
    return ret;
***REMOVED***
...
struct libdivide_s32_branchfree_t libdivide_s32_branchfree_gen(int32_t d) {
    ...
    struct libdivide_s32_branchfree_t result = {tmp.magic, tmp.more***REMOVED***;
    return result;
***REMOVED***
...
struct libdivide_s64_branchfree_t libdivide_s64_branchfree_gen(int64_t d) {
    ...
    struct libdivide_s64_branchfree_t ret = {tmp.magic, tmp.more***REMOVED***;
    return ret;
***REMOVED***
...
template<bool IS_INTEGRAL, bool IS_SIGNED, int SIZEOF, int ALGO> struct dispatcher { ***REMOVED***;

template<> struct dispatcher<true, true, sizeof(int32_t), BRANCHFULL> { DISPATCHER_GEN(int32_t, s32) ***REMOVED***;
template<> struct dispatcher<true, true, sizeof(int32_t), BRANCHFREE> { DISPATCHER_GEN(int32_t, s32_branchfree) ***REMOVED***;
template<> struct dispatcher<true, false, sizeof(uint32_t), BRANCHFULL> { DISPATCHER_GEN(uint32_t, u32) ***REMOVED***;
template<> struct dispatcher<true, false, sizeof(uint32_t), BRANCHFREE> { DISPATCHER_GEN(uint32_t, u32_branchfree) ***REMOVED***;
template<> struct dispatcher<true, true, sizeof(int64_t), BRANCHFULL> { DISPATCHER_GEN(int64_t, s64) ***REMOVED***;
template<> struct dispatcher<true, true, sizeof(int64_t), BRANCHFREE> { DISPATCHER_GEN(int64_t, s64_branchfree) ***REMOVED***;
template<> struct dispatcher<true, false, sizeof(uint64_t), BRANCHFULL> { DISPATCHER_GEN(uint64_t, u64) ***REMOVED***;
template<> struct dispatcher<true, false, sizeof(uint64_t), BRANCHFREE> { DISPATCHER_GEN(uint64_t, u64_branchfree) ***REMOVED***;
