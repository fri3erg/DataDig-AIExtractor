...
class TestEncoding(SoupTest):
    ...
    def test_unicode_string_can_be_encoded(self):
        html = "<b>\N{SNOWMAN***REMOVED***</b>"
        soup = self.soup(html)
        assert soup.b.string.encode("utf-8") == "\N{SNOWMAN***REMOVED***".encode("utf-8")
    ...
    def test_decode_contents(self):
        html = "<b>\N{SNOWMAN***REMOVED***</b>"
        soup = self.soup(html)
        assert "\N{SNOWMAN***REMOVED***" == soup.b.decode_contents()

    def test_encode_contents(self):
        html = "<b>\N{SNOWMAN***REMOVED***</b>"
        soup = self.soup(html)
        assert "\N{SNOWMAN***REMOVED***".encode("utf8") == soup.b.encode_contents(
            encoding="utf8"
        )
    ...
    def test_deprecated_renderContents(self):
        ...
        soup = self.soup(html)
        soup.renderContents()
        assert "\N{SNOWMAN***REMOVED***".encode("utf8") == soup.b.renderContents()
...
class TestFormatters(SoupTest):
    ...
    def test_default_formatter_is_minimal(self):
        markup = "<b>&lt;&lt;Sacr\N{LATIN SMALL LETTER E WITH ACUTE***REMOVED*** bleu!&gt;&gt;</b>"
        soup = self.soup(markup)
        decoded = soup.decode(formatter="minimal")
        # The < is converted back into &lt; but the e-with-acute is left alone.
        assert decoded == self.document_for(
                "<b>&lt;&lt;Sacr\N{LATIN SMALL LETTER E WITH ACUTE***REMOVED*** bleu!&gt;&gt;</b>"
        )

    def test_formatter_html(self):
        markup = "<br><b>&lt;&lt;Sacr\N{LATIN SMALL LETTER E WITH ACUTE***REMOVED*** bleu!&gt;&gt;</b>"
        soup = self.soup(markup)
