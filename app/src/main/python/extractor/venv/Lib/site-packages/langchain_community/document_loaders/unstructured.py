...
def validate_unstructured_version(min_unstructured_version: str) -> None:
    ...
    if not satisfies_min_unstructured_version(min_unstructured_version):
        raise ValueError(
            f"unstructured>={min_unstructured_version***REMOVED*** is required in this loader."
        )
...
***REMOVED***
        _valid_modes = {"single", "elements", "paged"***REMOVED***
        if mode not in _valid_modes:
            raise ValueError(
                f"Got {mode***REMOVED*** for `mode`, but should be one of `{_valid_modes***REMOVED***`"
***REMOVED***
        self.mode = mode
    ...
    def load(self) -> List[Document]:
        ...
        if self.mode == "elements":
            ...
            text_dict: Dict[int, str] = {***REMOVED***
            meta_dict: Dict[int, Dict] = {***REMOVED***
            ...
            raise ValueError(f"mode of {self.mode***REMOVED*** not supported.")
        return docs
...
class UnstructuredFileLoader(UnstructuredBaseLoader):
    ...
    def _get_metadata(self) -> dict:
        return {"source": self.file_path***REMOVED***
