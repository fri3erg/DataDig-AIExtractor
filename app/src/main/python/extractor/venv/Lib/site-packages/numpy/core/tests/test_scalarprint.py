...
class TestRealScalars:
    def test_str(self):
        ...
        for wants, val in zip(wanted, svals):
            for want, styp in zip(wants, styps):
                msg = 'for str({***REMOVED***({***REMOVED***))'.format(np.dtype(styp).name, repr(val))
    ...
    def test_py2_float_print(self):
        ...
        with TemporaryFile('r+t') as fo, TemporaryFile('r+t') as fe:
            ...
            code.interact(local={'np': np***REMOVED***, readfunc=input_func, banner='')
    ...
    def test_dragon4(self):
        ...
        preckwd = lambda prec: {'unique': False, 'precision': prec***REMOVED***
