...
class LabelStudioCallbackHandler(BaseCallbackHandler):
    ...
    def __init__(
        ...
        try:
            ...
            raise ImportError(
                f"You're using {self.__class__.__name__***REMOVED*** in your code,"
...
***REMOVED***
        ...
        if not url:
            if os.getenv("LABEL_STUDIO_URL"):
                ...
                warnings.warn(
                    ...
                    f"using default URL: {ls.LABEL_STUDIO_DEFAULT_URL***REMOVED***"
    ...
    ***REMOVED***
        ...
        self.payload: Dict[str, Dict] = {***REMOVED***
    ...
    ***REMOVED***
        ...
        if not self.from_name:
            error_message = (
                f'Label Studio project "{self.project_name***REMOVED***" '
                            ...
                            "result": [
                                {
                                    ...
                                    "type": "textarea",
                                    "value": {"text": [g.text for g in generation]***REMOVED***,
                                ***REMOVED***
                            ],
    ...
    def on_llm_start(
        ...
        **kwargs: Any,
        ...
        if self.input_type != "Text":
            raise ValueError(
                f'\nLabel Studio project "{self.project_name***REMOVED***" '
                f"has an input type <{self.input_type***REMOVED***>. "
                f'To make it work with the mode="chat", '
                f"the input type should be <Text>.\n"
                f"Read more here https://labelstud.io/tags/text"
***REMOVED***
        run_id = str(kwargs["run_id"])
        self.payload[run_id] = {"prompts": prompts, "kwargs": kwargs***REMOVED***
