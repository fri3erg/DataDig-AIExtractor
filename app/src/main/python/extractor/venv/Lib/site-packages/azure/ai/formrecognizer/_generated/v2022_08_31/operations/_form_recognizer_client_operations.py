...
def build_analyze_document_request_initial(
    ...
    **kwargs: Any
    ...
    path_format_arguments = {
        "modelId": _SERIALIZER.url("model_id", model_id, 'str', pattern=r'[a-zA-Z0-9][a-zA-Z0-9._~-]{1,63***REMOVED***'),
    ***REMOVED***
...
def build_get_operation_request(
    ...
    **kwargs: Any
    ...
    # Construct URL
    _url = kwargs.pop("template_url", "/operations/{operationId***REMOVED***")
    path_format_arguments = {
...
***REMOVED***
    ...
    get_analyze_document_result.metadata = {'url': "/documentModels/{modelId***REMOVED***/analyzeResults/{resultId***REMOVED***"***REMOVED***  # type: ignore
    ...
    _build_document_model_initial.metadata = {'url': "/documentModels:build"***REMOVED***  # type: ignore
...
***REMOVED***
    ...
    begin_build_document_model.metadata = {'url': "/documentModels:build"***REMOVED***  # type: ignore
    ...
    _compose_document_model_initial.metadata = {'url': "/documentModels:compose"***REMOVED***  # type: ignore
...
***REMOVED***
    ...
    begin_compose_document_model.metadata = {'url': "/documentModels:compose"***REMOVED***  # type: ignore
    ...
    authorize_copy_document_model.metadata = {'url': "/documentModels:authorizeCopy"***REMOVED***  # type: ignore
    ...
    _copy_document_model_to_initial.metadata = {'url': "/documentModels/{modelId***REMOVED***:copyTo"***REMOVED***  # type: ignore
...
***REMOVED***
    ...
    begin_copy_document_model_to.metadata = {'url': "/documentModels/{modelId***REMOVED***:copyTo"***REMOVED***  # type: ignore
...
***REMOVED***
    ...
    get_operations.metadata = {'url': "/operations"***REMOVED***  # type: ignore
    ...
    get_operation.metadata = {'url': "/operations/{operationId***REMOVED***"***REMOVED***  # type: ignore
...
***REMOVED***
    ...
    get_document_models.metadata = {'url': "/documentModels"***REMOVED***  # type: ignore
    ...
    get_document_model.metadata = {'url': "/documentModels/{modelId***REMOVED***"***REMOVED***  # type: ignore
    ...
    delete_document_model.metadata = {'url': "/documentModels/{modelId***REMOVED***"***REMOVED***  # type: ignore
    ...
    get_resource_details.metadata = {'url': "/info"***REMOVED***  # type: ignore
