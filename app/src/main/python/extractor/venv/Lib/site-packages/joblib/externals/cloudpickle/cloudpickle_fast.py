...
def _enum_getnewargs(obj):
    members = {e.name: e.value for e in obj***REMOVED***
...
class CloudPickler(Pickler):
    ...
    def _function_getnewargs(self, func):
        ...
        base_globals = self.globals_ref.setdefault(id(func.__globals__), {***REMOVED***)

        if base_globals == {***REMOVED***:
...
***REMOVED***
    ...
    ***REMOVED***
        ...
        def save_pypy_builtin_func(self, obj):
            ...
            3.6 and later.
            """
            rv = (types.FunctionType, (obj.__code__, {***REMOVED***, obj.__name__,
