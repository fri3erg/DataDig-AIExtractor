...
class Yellowbrick(VectorStore):
    ...
    def create_table_if_not_exists(self) -> None:
        ...
        cursor.execute(
            ...
            embedding FLOAT)"
***REMOVED***.format(sql.Identifier(self._table))
        )
    ...
    def drop(self, table: str) -> None:
        ...
        cursor = self._connection.cursor()
        cursor.execute(sql.SQL("DROP TABLE IF EXISTS {***REMOVED***").format(sql.Identifier(table)))
        self._connection.commit()
        cursor.close()
    ...
    def check_database_utf8(self) -> bool:
        ...
        if encoding.lower() == "utf8" or encoding.lower() == "utf-8":
            ...
            raise Exception(
                f"Database \
           '{self.connection_string.split('/')[-1]***REMOVED***' encoding is not UTF-8"
***REMOVED***
    ...
    ***REMOVED***
            ...
            insert_query = sql.SQL(
                "INSERT INTO {t***REMOVED*** \
                (id, embedding_id, text, metadata, embedding) VALUES {v***REMOVED***"
***REMOVED***.format(
...
***REMOVED***
    ...
    def similarity_search_with_score_by_vector(
        ...
        cursor.execute(
            sql.SQL(
                "CREATE TEMPORARY TABLE {***REMOVED*** ( \
            embedding_id INTEGER, embedding FLOAT)"
***REMOVED***.format(sql.Identifier(tmp_table))
        )
        self._connection.commit()
        ...
        insert_query = sql.SQL(
            "INSERT INTO {t***REMOVED*** \
            (embedding_id, embedding) VALUES {v***REMOVED***"
        ).format(
        ...
        sql_query = sql.SQL(
            ...
            FROM {v1***REMOVED*** v1 INNER JOIN {v2***REMOVED*** v2 \
        ...
        for result in results:
            metadata = json.loads(result[1]) or {***REMOVED***
