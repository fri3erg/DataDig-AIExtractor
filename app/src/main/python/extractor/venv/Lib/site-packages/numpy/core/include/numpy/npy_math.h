...
{
    const union { npy_uint32 __i; float __f;***REMOVED*** __bint = {0x7f800000UL***REMOVED***;
    return __bint.__f;
***REMOVED***

static inline float __npy_nanf(void)
{
    const union { npy_uint32 __i; float __f;***REMOVED*** __bint = {0x7fc00000UL***REMOVED***;
    return __bint.__f;
***REMOVED***

static inline float __npy_pzerof(void)
{
    const union { npy_uint32 __i; float __f;***REMOVED*** __bint = {0x00000000UL***REMOVED***;
    return __bint.__f;
***REMOVED***

static inline float __npy_nzerof(void)
{
    const union { npy_uint32 __i; float __f;***REMOVED*** __bint = {0x80000000UL***REMOVED***;
    return __bint.__f;
***REMOVED***
