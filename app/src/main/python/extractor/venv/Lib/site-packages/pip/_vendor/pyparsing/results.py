...
class ParseResults:
    ...
    Example::
        ...
        def test(s, fn=repr):
            print(f"{s***REMOVED*** -> {fn(eval(s))***REMOVED***")
        test("list(result)")
        test("result[0]")
        test("result['month']")
        test("result.day")
    ...
    class List(list):
        ...
        def __new__(cls, contained=None):
            ...
            if not isinstance(contained, list):
                raise TypeError(
                    f"{cls.__name__***REMOVED*** may only be constructed with a list, not {type(contained).__name__***REMOVED***"
    ***REMOVED***
...
***REMOVED***
    ...
    def pop(self, *args, **kwargs):
        ...
        for k, v in kwargs.items():
            if k == "default":
                ...
                raise TypeError(f"pop() got an unexpected keyword argument {k!r***REMOVED***")
    ...
    ***REMOVED***
    ...
    def __repr__(self) -> str:
        return f"{type(self).__name__***REMOVED***({self._toklist!r***REMOVED***, {self.as_dict()***REMOVED***)"
        ...
        if full:
            if self.haskeys():
                ...
                for k, v in items:
                    if out:
                        out.append(NL)
                    out.append(f"{indent***REMOVED***{('  ' * _depth)***REMOVED***- {k***REMOVED***: ")
