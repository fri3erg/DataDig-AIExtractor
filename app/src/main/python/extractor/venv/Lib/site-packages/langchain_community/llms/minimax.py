...
class _MinimaxEndpointClient(BaseModel):
    ...
    def set_api_url(cls, values: Dict[str, Any]) -> Dict[str, Any]:
        if "api_url" not in values:
            ...
            api_url = f"{host***REMOVED***/v1/text/chatcompletion?GroupId={group_id***REMOVED***"
            values["api_url"] = api_url
        return values

    def post(self, request: Any) -> Any:
        headers = {"Authorization": f"Bearer {self.api_key.get_secret_value()***REMOVED***"***REMOVED***
        ...
        if response.json()["base_resp"]["status_code"] > 0:
            raise ValueError(
                f"API {response.json()['base_resp']['status_code']***REMOVED***"
                f" error: {response.json()['base_resp']['status_msg']***REMOVED***"
***REMOVED***
...
class MinimaxCommon(BaseModel):
    ...
    def _identifying_params(self) -> Dict[str, Any]:
        ...
        return {**{"model": self.model***REMOVED***, **self._default_params***REMOVED***
...
class Minimax(MinimaxCommon, LLM):
    ...
    def _call(
        ...
        **kwargs: Any,
        ...
        request["messages"] = [{"sender_type": "USER", "text": prompt***REMOVED***]
