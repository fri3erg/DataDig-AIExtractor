...
----------
    ...
    ...     print(
    ...         '({h[0]***REMOVED***, {h[1]***REMOVED***), {r***REMOVED***, ({d[0]***REMOVED***, {d[1]***REMOVED***)'
...
Custom cell extractors can take in and return an index.
    ...
    ...     return (index, '{***REMOVED***-{***REMOVED***'.format(word, index), word,
    ...             tag, tag, '', head, rel)
    >>> dg = DependencyGraph(treebank_data, cell_extractor=custom_extractor)
    >>> dg.tree().pprint()
    (will-8
...
---------------------------------
    ...
    ...         print('{address***REMOVED*** {word***REMOVED***: {d***REMOVED***'.format(d=node['deps'][''], **node))
    1 the: []
    2 man: [1]
    3 taught: [2, 7]
    4 his: []
