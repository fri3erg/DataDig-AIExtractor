...
class DeepLakeTranslator(Visitor):
    ...
    def visit_comparison(self, comparison: Comparison) -> str:
        ...
        if not can_cast_to_float(comparison.value):
            values = f"'{values***REMOVED***'"
        return f"metadata['{comparison.attribute***REMOVED***'] {comparator***REMOVED*** {values***REMOVED***"
    ...
    def visit_structured_query(
        ...
        if structured_query.filter is None:
            ...
            tqL = f"SELECT * WHERE {structured_query.filter.accept(self)***REMOVED***"
            kwargs = {"tql": tqL***REMOVED***
