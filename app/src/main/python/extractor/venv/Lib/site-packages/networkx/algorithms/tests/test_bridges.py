...
class TestLocalBridges:
    ...
    def test_no_weight(self):
        inf = float("inf")
        expected = {(3, 4, inf), (4, 3, inf)***REMOVED***
        assert next(nx.local_bridges(self.BB)) in expected
        expected = {(u, v, 3) for u, v, in self.square.edges***REMOVED***
    ...
    def test_weight(self):
        ...
        expected = {(u, v, 5 - wt) for u, v, wt in G.edges(data="weight", default=1)***REMOVED***
        assert set(nx.local_bridges(G, weight="weight")) == expected

        expected = {(u, v, 6) for u, v in G.edges***REMOVED***
