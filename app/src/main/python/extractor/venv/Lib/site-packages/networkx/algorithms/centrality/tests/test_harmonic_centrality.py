...
class TestClosenessCentrality:
    ...
    def test_weighted_harmonic(self):
        ...
        d = {"a": 0, "b": 0.1, "c": 2.533, "d": 0, "e": 0, "f": 0.83333***REMOVED***
        for n in sorted(XG):
            assert c[n] == pytest.approx(d[n], abs=1e-3)
