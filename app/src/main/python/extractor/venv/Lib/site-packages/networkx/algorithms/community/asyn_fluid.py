...
def asyn_fluidc(G, k, max_iter=100, seed=None):
    ...
    communities = {n: i for i, n in enumerate(vertices[:k])***REMOVED***
    density = {***REMOVED***
    com_to_numvertices = {***REMOVED***
    ...
    while cont:
        ...
        for vertex in vertices:
            ...
            try:
                com_counter.update({communities[vertex]: density[communities[vertex]]***REMOVED***)
            except KeyError:
                pass
            # Gather neighbour vertex communities
            for v in G[vertex]:
                try:
                    com_counter.update({communities[v]: density[communities[v]]***REMOVED***)
                except KeyError:
                    continue
