...
def test_categorical_node_match():
    ...
    assert nm({"x": 1, "y": 2, "z": 3***REMOVED***, {"x": 1, "y": 2, "z": 3***REMOVED***)
    assert not nm({"x": 1, "y": 2, "z": 2***REMOVED***, {"x": 1, "y": 2, "z": 1***REMOVED***)
...
class TestGenericMultiEdgeMatch:
    def setup_method(self):
        ...
        attr_dict1 = {"id": "edge1", "minFlow": 0, "maxFlow": 10***REMOVED***
        attr_dict2 = {"id": "edge2", "minFlow": -3, "maxFlow": 7***REMOVED***
        attr_dict3 = {"id": "edge3", "minFlow": 13, "maxFlow": 117***REMOVED***
        attr_dict4 = {"id": "edge4", "minFlow": 13, "maxFlow": 117***REMOVED***
        attr_dict5 = {"id": "edge5", "minFlow": 8, "maxFlow": 12***REMOVED***
        attr_dict6 = {"id": "edge6", "minFlow": 8, "maxFlow": 12***REMOVED***
        for attr_dict in [
            attr_dict1,
            attr_dict2,
            attr_dict3,
