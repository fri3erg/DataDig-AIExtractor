...
_interval_shared_docs: dict[str, str] = {***REMOVED***
...
closed : {'left', 'right', 'both', 'neither'***REMOVED***, default 'right'
...
class IntervalArray(IntervalMixin, ExtensionArray):
    ...
    def __new__(
        ...
        if isinstance(data, cls):
            ...
            if is_scalar(data):
                msg = (
                    f"{cls.__name__***REMOVED***(...) must be called with a collection "
                    f"of some kind, {data***REMOVED*** was passed"
    ***REMOVED***
                raise TypeError(msg)
    ...
    def _ensure_simple_new_inputs(
        ...
        if dtype is not None:
            ...
            if isinstance(dtype, IntervalDtype):
                ...
                msg = f"dtype must be an IntervalDtype, got {dtype***REMOVED***"
                raise TypeError(msg)
        ...
        if type(left) != type(right):
            msg = (
                f"must not have differing left [{type(left).__name__***REMOVED***] and "
                f"right [{type(right).__name__***REMOVED***] types"
***REMOVED***
...
***REMOVED***
        ...
        if isinstance(left, ABCDatetimeIndex) and str(left.tz) != str(right.tz):
            msg = (
                ...
                f"'{left.tz***REMOVED***' and '{right.tz***REMOVED***'"
***REMOVED***
            raise ValueError(msg)
        ...
        for d in data:
            if not isinstance(d, tuple) and isna(d):
                ...
                try:
                    ...
                    msg = f"{name***REMOVED***.from_tuples requires tuples of length 2, got {d***REMOVED***"
                    raise ValueError(msg) from err
                except TypeError as err:
                    msg = f"{name***REMOVED***.from_tuples received an invalid item, {d***REMOVED***"
    ...
    def _validate(cls, left, right, dtype: IntervalDtype) -> None:
        ...
        * left is always below right
        ...
        if not isinstance(dtype, IntervalDtype):
            msg = f"invalid dtype: {dtype***REMOVED***"
            raise ValueError(msg)
...
***REMOVED***:
                ...
                msg = (
                    f"Cannot convert {self.dtype***REMOVED*** to {dtype***REMOVED***; subtypes are incompatible"
    ***REMOVED***
                raise TypeError(msg)
    ...
    ***REMOVED***
    ...
    def _concat_same_type(cls, to_concat: Sequence[IntervalArray]) -> Self:
        ...
        IntervalArray
        """
        closed_set = {interval.closed for interval in to_concat***REMOVED***
        if len(closed_set) != 1:
    ...
    def _validate_listlike(self, value):
        ...
        try:
            ...
            msg = f"'value' should be an interval type, got {type(value)***REMOVED*** instead."
            raise TypeError(msg) from err
        ...
        try:
            ...
            msg = (
                ...
                f"got {type(value)***REMOVED*** instead."
***REMOVED***
            raise TypeError(msg) from err
...
***REMOVED***,
    ...
    def overlaps(self, other):
        ...
        if not isinstance(other, Interval):
            msg = f"`other` must be Interval-like, got {type(other).__name__***REMOVED***"
            raise TypeError(msg)
    ...
    _interval_shared_docs["set_closed"] = textwrap.dedent(
        ...
        Parameters
        ----------
        closed : {'left', 'right', 'both', 'neither'***REMOVED***
            Whether the intervals are closed on the left-side, right-side, both
            or neither.
...
***REMOVED***,
    ...
    def set_closed(self, closed: IntervalClosedType) -> Self:
        if closed not in VALID_CLOSED:
            msg = f"invalid option for 'closed': {closed***REMOVED***"
            raise ValueError(msg)
...
***REMOVED***
    ...
    def __arrow_array__(self, type=None):
        ...
        try:
            ...
            raise TypeError(
                f"Conversion to arrow with subtype '{self.dtype.subtype***REMOVED***' "
                "is not supported"
***REMOVED*** from err
            ...
            if type.equals(interval_type.storage_type):
                ...
                if not type.equals(interval_type):
                    raise TypeError(
                        ...
                        f"different 'subtype' ({self.dtype.subtype***REMOVED*** vs {type.subtype***REMOVED***) "
                        f"and 'closed' ({self.closed***REMOVED*** vs {type.closed***REMOVED***) attributes"
        ***REMOVED***
            else:
                raise TypeError(
                    f"Not supported to convert IntervalArray to '{type***REMOVED***' type"
    ***REMOVED***
