...
def _parse_ai_message(message: BaseMessage) -> Union[List[AgentAction], AgentFinish]:
    ...
    if not isinstance(message, AIMessage):
        raise TypeError(f"Expected an AI message got {type(message)***REMOVED***")

    function_call = message.additional_kwargs.get("function_call", {***REMOVED***)
    ...
    if function_call:
        try:
            ...
            raise OutputParserException(
                f"Could not parse tool input: {function_call***REMOVED*** because "
...
***REMOVED***
        ...
        for tool_schema in tools:
            ...
            content_msg = f"responded: {message.content***REMOVED***\n" if message.content else "\n"
            log = f"\nInvoking: `{function_name***REMOVED***` with `{tool_input***REMOVED***`\n{content_msg***REMOVED***\n"
...
***REMOVED***
    ...
    return AgentFinish(
        return_values={"output": message.content***REMOVED***, log=str(message.content)
    )
    ...
    def validate_prompt(cls, values: dict) -> dict:
        ...
        if "agent_scratchpad" not in prompt.input_variables:
            raise ValueError(
                ...
                f"got {prompt.input_variables***REMOVED***"
***REMOVED***
        return values
    ...
    def create_prompt(
        ...
        messages.extend(
            [
                *_prompts,
                HumanMessagePromptTemplate.from_template("{input***REMOVED***"),
