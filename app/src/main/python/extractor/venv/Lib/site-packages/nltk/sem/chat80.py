...
sea = {"rel_name": "sea", "closures": [], "schema": ["sea"], "filename": "world1.pl"***REMOVED***
...
def label_indivs(valuation, lexicon=False):
    ...
    Given a valuation with an entry of the form ``{'rel': {'a': True***REMOVED******REMOVED***``,
    add a new entry ``{'a': 'a'***REMOVED***``.
...
def make_lex(symbols):
    ...
    Given a valuation with an entry of the form ``{'zloty': 'zloty'***REMOVED***``,
