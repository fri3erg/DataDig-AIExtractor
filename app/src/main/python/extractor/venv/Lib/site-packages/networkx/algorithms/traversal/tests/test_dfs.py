...
class TestDFS:
    ...
    def test_successor(self):
        assert nx.dfs_successors(self.G, source=0) == {0: [1], 1: [2, 3], 2: [4]***REMOVED***
        assert nx.dfs_successors(self.G, source=1) == {0: [3, 4], 1: [0], 4: [2]***REMOVED***
        assert nx.dfs_successors(self.D) == {0: [1], 2: [3]***REMOVED***
        assert nx.dfs_successors(self.D, source=1) == {1: [0]***REMOVED***

    def test_predecessor(self):
        assert nx.dfs_predecessors(self.G, source=0) == {1: 0, 2: 1, 3: 1, 4: 2***REMOVED***
        assert nx.dfs_predecessors(self.D) == {1: 0, 3: 2***REMOVED***
...
class TestDepthLimitedSearch:
    ...
    def test_dls_successor(self):
        ...
        assert {n: set(v) for n, v in result.items()***REMOVED*** == {
            2: {1, 7***REMOVED***,
            3: {2***REMOVED***,
            4: {3, 5***REMOVED***,
            5: {6***REMOVED***,
        ***REMOVED***
        ...
        assert {n: set(v) for n, v in result.items()***REMOVED*** == {8: {9***REMOVED***, 2: {3***REMOVED***, 7: {8, 2***REMOVED******REMOVED***
