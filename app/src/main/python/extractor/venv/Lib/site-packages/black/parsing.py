    ...
    for grammar in grammars:
        ...
        try:
            ...
            errors[grammar.version] = InvalidInput(
                f"Cannot parse: {lineno***REMOVED***:{column***REMOVED***: {faulty_line***REMOVED***"
***REMOVED***
            ...
            errors[grammar.version] = InvalidInput(
                f"Cannot parse: {lineno***REMOVED***:{column***REMOVED***: {te.args[0]***REMOVED***"
***REMOVED***
...
def stringify_ast(node: ast.AST, depth: int = 0) -> Iterator[str]:
    ...
    yield f"{'  ' * depth***REMOVED***{node.__class__.__name__***REMOVED***("
    ...
    for field in sorted(node._fields):  # noqa: F402
        ...
        yield f"{'  ' * (depth + 1)***REMOVED***{field***REMOVED***="
...
***REMOVED***:
                ...
                normalized = value
            yield f"{'  ' * (depth + 2)***REMOVED***{normalized!r***REMOVED***,  # {value.__class__.__name__***REMOVED***"
