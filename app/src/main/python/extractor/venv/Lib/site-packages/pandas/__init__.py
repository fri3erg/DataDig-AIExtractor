...
for _dependency in _hard_dependencies:
    try:
        ...
        _missing_dependencies.append(f"{_dependency***REMOVED***: {_e***REMOVED***")
...
try:
    ...
    _module = _err.name
    raise ImportError(
        f"C extension: {_module***REMOVED*** not built. If you want to import "
...
if pa_version_under10p1:
    ...
    if pa_not_found:
        ...
        pa_msg = (
            f"was too old on your system - pyarrow {VERSIONS['pyarrow']***REMOVED*** "
