...
***REMOVED***
            ...
            raise ValueError(f"invalid validation method '{method***REMOVED***'")


ARGMINMAX_DEFAULTS = {"out": None***REMOVED***
...
ARGSORT_DEFAULTS: dict[str, int | str | None] = {***REMOVED***
...
ARGSORT_DEFAULTS_KIND: dict[str, int | None] = {***REMOVED***
...
CLIP_DEFAULTS: dict[str, Any] = {"out": None***REMOVED***
...
CUM_FUNC_DEFAULTS: dict[str, Any] = {***REMOVED***
...
ALLANY_DEFAULTS: dict[str, bool | None] = {***REMOVED***
...
LOGICAL_FUNC_DEFAULTS = {"out": None, "keepdims": False***REMOVED***
validate_logical_func = CompatValidator(LOGICAL_FUNC_DEFAULTS, method="kwargs")

MINMAX_DEFAULTS = {"axis": None, "dtype": None, "out": None, "keepdims": False***REMOVED***
...
RESHAPE_DEFAULTS: dict[str, str] = {"order": "C"***REMOVED***
validate_reshape = CompatValidator(
    RESHAPE_DEFAULTS, fname="reshape", method="both", max_fname_arg_count=1
)

REPEAT_DEFAULTS: dict[str, Any] = {"axis": None***REMOVED***
validate_repeat = CompatValidator(
    REPEAT_DEFAULTS, fname="repeat", method="both", max_fname_arg_count=1
)

ROUND_DEFAULTS: dict[str, Any] = {"out": None***REMOVED***
validate_round = CompatValidator(
    ROUND_DEFAULTS, fname="round", method="both", max_fname_arg_count=1
)

SORT_DEFAULTS: dict[str, int | str | None] = {***REMOVED***
SORT_DEFAULTS["axis"] = -1
SORT_DEFAULTS["kind"] = "quicksort"
SORT_DEFAULTS["order"] = None
validate_sort = CompatValidator(SORT_DEFAULTS, fname="sort", method="kwargs")

STAT_FUNC_DEFAULTS: dict[str, Any | None] = {***REMOVED***
...
STAT_DDOF_FUNC_DEFAULTS: dict[str, bool | None] = {***REMOVED***
STAT_DDOF_FUNC_DEFAULTS["dtype"] = None
STAT_DDOF_FUNC_DEFAULTS["out"] = None
STAT_DDOF_FUNC_DEFAULTS["keepdims"] = False
validate_stat_ddof_func = CompatValidator(STAT_DDOF_FUNC_DEFAULTS, method="kwargs")

TAKE_DEFAULTS: dict[str, str | None] = {***REMOVED***
...
TRANSPOSE_DEFAULTS = {"axes": None***REMOVED***
...
def validate_groupby_func(name: str, args, kwargs, allowed=None) -> None:
    ...
    if len(args) + len(kwargs) > 0:
        raise UnsupportedFunctionCall(
            ...
            f"Use .groupby(...).{name***REMOVED***() instead"
        )
    ...
    if len(args) + len(kwargs) > 0:
        if method in RESAMPLER_NUMPY_OPS:
            raise UnsupportedFunctionCall(
                ...
                f"Use .resample(...).{method***REMOVED***() instead"
***REMOVED***
...
def validate_minmax_axis(axis: AxisInt | None, ndim: int = 1) -> None:
    ...
    if axis >= ndim or (axis < 0 and ndim + axis < 0):
        raise ValueError(f"`axis` must be fewer than the number of dimensions ({ndim***REMOVED***)")
