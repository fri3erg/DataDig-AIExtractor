    ...
    def _call(
        ...
        **kwargs: Any,
        ...
        response = completion_with_retry(
            ...
            prompt=prompt,
            params=params,
            url=f"{self.nebula_service_url***REMOVED***{self.nebula_service_path***REMOVED***",
        )
...
def make_request(
    self: Nebula,
    prompt: str,
    url: str = f"{DEFAULT_NEBULA_SERVICE_URL***REMOVED***{DEFAULT_NEBULA_SERVICE_PATH***REMOVED***",
    ...
    headers = {
        ...
        "ApiKey": f"{api_key***REMOVED***",
    ***REMOVED***

    body = {"prompt": prompt***REMOVED***
