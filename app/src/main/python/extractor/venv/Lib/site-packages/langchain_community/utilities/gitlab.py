...
class GitLabAPIWrapper(BaseModel):
    ...
    """The name of the GitLab repository, in the form {username***REMOVED***/{repo-name***REMOVED***."""
...
***REMOVED***
    ...
    def parse_issues(self, issues: List[Issue]) -> List[dict]:
        ...
        for issue in issues:
            title = issue.title
            number = issue.iid
            parsed.append({"title": title, "number": number***REMOVED***)
        return parsed
    ...
    def get_issue(self, issue_number: int) -> Dict[str, Any]:
        ...
        while len(comments) <= 10:
            ...
            for comment in comments_page:
                ...
                comments.append(
                    {"body": comment.body, "user": comment.author["username"]***REMOVED***
    ***REMOVED***
            page += 1
        ...
        if self.gitlab_base_branch == self.gitlab_branch:
            ...
            try:
                ...
                pr = self.gitlab_repo_instance.mergerequests.create(
                    ...
                    ***REMOVED***
    ***REMOVED***
                return f"Successfully created PR number {pr.iid***REMOVED***"
    ...
    def comment_on_issue(self, comment_query: str) -> str:
        ...
        try:
            issue = self.gitlab_repo_instance.issues.get(issue_number)
            issue.notes.create({"body": comment***REMOVED***)
    ...
    def create_file(self, file_query: str) -> str:
        ...
        try:
            ...
            return f"File already exists at {file_path***REMOVED***. Use update_file instead"
        except Exception:
            data = {
