...
def density(G):
    ...
    .. math::
       ...
       d = \frac{2m***REMOVED***{n(n-1)***REMOVED***,

    and for directed graphs is

    .. math::

       d = \frac{m***REMOVED***{n(n-1)***REMOVED***,
...
def set_node_attributes(G, values, name=None):
    ...
    dictionary of node attributes for that node::
        ...
        >>> G = nx.path_graph(3)
        >>> attrs = {0: {"attr1": 20, "attr2": "nothing"***REMOVED***, 1: {"attr2": 3***REMOVED******REMOVED***
    ...
    values are silently ignored::
        ...
        >>> G = nx.Graph()
        >>> G.add_node(0)
        >>> nx.set_node_attributes(G, {0: "red", 1: "blue"***REMOVED***, name="color")
        >>> G.nodes[0]["color"]
        'red'
        >>> 1 in G.nodes
        False
...
def get_node_attributes(G, name, default=None):
    ...
    if default is not None:
        return {n: d.get(name, default) for n, d in G.nodes.items()***REMOVED***
    return {n: d[name] for n, d in G.nodes.items() if name in d***REMOVED***
...
def set_edge_attributes(G, values, name=None):
    ...
    the entire dictionary will be used to update edge attributes::
        ...
        >>> G = nx.path_graph(3)
        >>> attrs = {(0, 1): {"attr1": 20, "attr2": "nothing"***REMOVED***, (1, 2): {"attr2": 3***REMOVED******REMOVED***
    ...
    silently ignored::
        ...
        >>> G = nx.Graph([(0, 1)])
        >>> nx.set_edge_attributes(G, {(1, 2): {"weight": 2.0***REMOVED******REMOVED***)
        >>> (1, 2) in G.edges()
        False
    ...
    including the edge key::
        ...
        [0, 1]
        >>> attributes = {(0, 1, 0): {"cost": 21***REMOVED***, (0, 1, 1): {"cost": 7***REMOVED******REMOVED***
    ...
    overwrite the previous values. Continuing from the previous case we get::
        ...
        >>> nx.set_edge_attributes(H, {(u, v): ed for u, v, ed in MG.edges.data()***REMOVED***)
    ...
    if name is not None:
        ...
        try:
            # if `values` is a dict using `.items()` => {edge: value***REMOVED***
            if G.is_multigraph():
        ...
        # `values` consists of doct-of-dict {edge: {attr: value***REMOVED******REMOVED*** shape
        if G.is_multigraph():
...
def get_edge_attributes(G, name, default=None):
    ...
    if default is not None:
        return {x[:-1]: x[-1].get(name, default) for x in edges***REMOVED***
    return {x[:-1]: x[-1][name] for x in edges if name in x[-1]***REMOVED***
...
def non_neighbors(graph, node):
    ...
    """
    nbors = set(neighbors(graph, node)) | {node***REMOVED***
...
def is_weighted(G, edge=None, weight="weight"):
    ...
    if edge is not None:
        ...
        if data is None:
            msg = f"Edge {edge!r***REMOVED*** does not exist."
