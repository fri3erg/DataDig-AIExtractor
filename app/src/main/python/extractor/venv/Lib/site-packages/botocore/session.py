...
class Session:
    ...
    def __init__(
        ...
        self._session_instance_vars = {***REMOVED***
...
***REMOVED***
    ...
    def get_scoped_config(self):
        ...
        if profile_name is None:
            return profile_map.get('default', {***REMOVED***)
        ...
        **entire** config file.
        ...
        if self._config is None:
            try:
                ...
                self._config = {'profiles': {***REMOVED******REMOVED***
            try:
...
***REMOVED***.load_credentials()
    ...
    def user_agent(self):
        ...
        """
        base = (
            f'{self.user_agent_name***REMOVED***/{self.user_agent_version***REMOVED*** '
            f'Python/{platform.python_version()***REMOVED*** '
            f'{platform.system()***REMOVED***/{platform.release()***REMOVED***'
        )
        if HAS_CRT:
    ...
    def get_service_model(self, service_name, api_version=None):
        ...
        :rtype: L{botocore.model.ServiceModel***REMOVED***
...
class ComponentLocator:
    ...
    def __init__(self):
        self._components = {***REMOVED***
        self._deferred = {***REMOVED***
