...
def local_node_connectivity(
    ...
    kwargs = {"flow_func": flow_func, "residual": residual***REMOVED***
    ...
    return nx.maximum_flow_value(H, f"{mapping[s]***REMOVED***B", f"{mapping[t]***REMOVED***A", **kwargs)
...
def average_node_connectivity(G, flow_func=None):
    ...
    The average connectivity `\bar{\kappa***REMOVED***` of a graph G is the average
    of local node connectivity over all pairs of nodes of G [1]_ .

    .. math::

        \bar{\kappa***REMOVED***(G) = \frac{\sum_{u,v***REMOVED*** \kappa_{G***REMOVED***(u,v)***REMOVED***{{n \choose 2***REMOVED******REMOVED***
...
def all_pairs_node_connectivity(G, nbunch=None, flow_func=None):
    ...
    all_pairs = {n: {***REMOVED*** for n in nbunch***REMOVED***
...
@nx._dispatch(
    graphs={"G": 0, "auxiliary?": 4, "residual?": 5***REMOVED***,
    preserve_edge_attrs={"residual": {"capacity": float("inf")***REMOVED******REMOVED***,
    preserve_graph_attrs={"residual"***REMOVED***,
)
