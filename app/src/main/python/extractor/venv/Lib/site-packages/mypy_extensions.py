...
def _typeddict_new(cls, _typename, _fields=None, **kwargs):
    ...
    ns = {'__annotations__': dict(_fields), '__total__': total***REMOVED***
    try:
...
class _TypedDictMeta(type):
    def __new__(cls, name, bases, ns, total=True):
        ...
        anns = ns.get('__annotations__', {***REMOVED***)
        msg = "TypedDict('Name', {f0: t0, f1: t1, ...***REMOVED***); each t must be a type"
        anns = {n: _type_check(tp, msg) for n, tp in anns.items()***REMOVED***
        for base in bases:
            anns.update(base.__dict__.get('__annotations__', {***REMOVED***))
...
for _int_type in i64, i32, i16, u8:
    _int_type.__doc__ = \
        ...
        * {name***REMOVED***(x[, base=n]) converts a number or string to 'int'
        * isinstance(x, {name***REMOVED***) is the same as isinstance(x, int)
