...
class AveragedPerceptron:
    ...
    def __init__(self, weights=None):
        ...
        self.weights = weights if weights else {***REMOVED***
        self.classes = set()
    ...
    def update(self, truth, guess, features):
        ...
        if truth == guess:
            return None
        for f in features:
            weights = self.weights.setdefault(f, {***REMOVED***)
...
***REMOVED***
    ...
    def train(self, sentences, save_loc=None, nr_iter=5):
        ...
        for iter_ in range(nr_iter):
            ...
            logging.info(f"Iter {iter_***REMOVED***: {c***REMOVED***/{n***REMOVED***={_pc(c, n)***REMOVED***")
    ...
    def _get_features(self, i, word, context, prev, prev2):
        ...
        {hashable: int***REMOVED*** dict. If the features change, a new model must be
        trained.
        """
