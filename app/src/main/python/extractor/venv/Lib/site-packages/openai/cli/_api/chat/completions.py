...
def register(subparser: _SubParsersAction[ArgumentParser]) -> None:
    ...
    req.add_argument(
        ...
        help="A message in `{role***REMOVED*** {content***REMOVED***` format. Use this argument multiple times to add multiple messages.",
        required=True,
    )
    req.add_argument(
        "-m",
...
class CLIChatCompletion:
    ...
    def create(args: CLIChatCompletionCreateArgs) -> None:
        params: CompletionCreateParams = {
            "model": args.model,
            "messages": [
                {"role": cast(Literal["user"], message.role), "content": message.content***REMOVED*** for message in args.message
            ],
            "n": args.n,
    ...
    def _create(params: CompletionCreateParamsNonStreaming) -> None:
        ...
        for choice in completion.choices:
            if should_print_header:
                sys.stdout.write("===== Chat Completion {***REMOVED*** =====\n".format(choice.index))
