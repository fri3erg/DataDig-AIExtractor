...
def joint_degree_graph(joint_degrees, seed=None):
    ...
    >>> joint_degrees = {
    ...     1: {4: 1***REMOVED***,
    ...     2: {2: 2, 3: 2, 4: 2***REMOVED***,
    ...     3: {2: 2, 4: 1***REMOVED***,
    ...     4: {1: 1, 2: 2, 3: 1***REMOVED***,
    ... ***REMOVED***
    ...
    degree_count = {k: sum(l.values()) // k for k, l in joint_degrees.items() if k > 0***REMOVED***
    ...
    for k in joint_degrees:
        for l in joint_degrees[k]:
            ...
            if (n_edges_add > 0) and (k >= l):
                ...
                k_unsat = {v for v in k_nodes if h_node_residual[v] > 0***REMOVED***

                if k != l:
                    l_unsat = {w for w in l_nodes if h_node_residual[w] > 0***REMOVED***
                else:
                    l_unsat = k_unsat
...
def is_valid_directed_joint_degree(in_degrees, out_degrees, nkk):
    ...
    """
    V = {***REMOVED***  # number of nodes with in/out degree.
    forbidden = {***REMOVED***
    ...
    S = {***REMOVED***  # number of edges going from in/out degree nodes.
    for k in nkk:
        for l in nkk[k]:
            val = nkk[k][l]
...
def directed_joint_degree_graph(in_degrees, out_degrees, nkk, seed=None):
    ...
    h_degree_nodelist_in = {***REMOVED***
    h_degree_nodelist_out = {***REMOVED***
    # for a given group, keep the list of all unsaturated node ids.
    h_degree_nodelist_in_unsat = {***REMOVED***
    h_degree_nodelist_out_unsat = {***REMOVED***
    # for a given node, keep track of the remaining stubs to be added.
    h_node_residual_out = {***REMOVED***
    h_node_residual_in = {***REMOVED***
    # for a given node, keep track of the partition id.
    h_partition_out = {***REMOVED***
    h_partition_in = {***REMOVED***
