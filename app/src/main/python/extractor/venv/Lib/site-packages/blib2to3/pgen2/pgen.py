...
class ParserGenerator:
    ...
    def __init__(self, filename: Path, stream: Optional[IO[str]] = None) -> None:
        ...
        if close_stream is not None:
            close_stream()
        self.first = {***REMOVED***  # map from symbol name to set of tokens
        self.addfirstsets()
    ...
    def calcfirst(self, name: str) -> None:
        ...
        state = dfa[0]
        totalset: Dict[str, int] = {***REMOVED***
        overlapcheck = {***REMOVED***
        for label in state.arcs:
            if label in self.dfas:
                ...
                totalset[label] = 1
                overlapcheck[label] = {label: 1***REMOVED***
        inverse: Dict[str, str] = {***REMOVED***
    ...
    def make_dfa(self, start: "NFAState", finish: "NFAState") -> List["DFAState"]:
        ...
        def closure(state: NFAState) -> Dict[NFAState, int]:
            base: Dict[NFAState, int] = {***REMOVED***
        ...
        for state in states:  # NB states grows while we're iterating
            arcs: Dict[str, Dict[NFAState, int]] = {***REMOVED***
            for nfastate in state.nfaset:
                for label, next in nfastate.arcs:
                    if label is not None:
                        addclosure(next, arcs.setdefault(label, {***REMOVED***))
...
class DFAState:
    ...
    def __init__(self, nfaset: Dict[NFAState, Any], final: NFAState) -> None:
        ...
        self.arcs = {***REMOVED***  # map from label to DFAState
