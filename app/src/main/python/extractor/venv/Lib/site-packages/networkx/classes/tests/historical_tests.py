...
class HistoricalTests:
    ...
    def test_nonhashable_node(self):
        ...
        G = self.G()
        assert not G.has_node(["A"])
        assert not G.has_node({"A": 1***REMOVED***)
    ...
    def test_nbunch_dict(self):
        ...
        nbunch = set("ABCDEFGHIJKL")
        G.add_nodes_from(nbunch)
        nbunch = {"I": "foo", "J": 2, "K": True, "L": "spam"***REMOVED***
    ...
    def test_edges_nbunch(self):
        ...
        # nbunch can be a set
        assert edges_equal(G.edges({"A", "B"***REMOVED***), elist)
        # nbunch can be a graph
        G1 = self.G()
        G1.add_nodes_from("AB")
        assert edges_equal(G.edges(G1), elist)
        # nbunch can be a dict with nodes as keys
        ndict = {"A": "thing1", "B": "thing2"***REMOVED***
    ...
    def test_degree_graph(self):
        ...
        assert dict(d for n, d in P3.degree(["A", "B"])) == {***REMOVED***
        # nbunch can be a graph
        ...
        assert dict(P5.degree([])) == {***REMOVED***

    def test_null(self):
        null = nx.null_graph()
        assert list(null.degree()) == []
        assert dict(null.degree()) == {***REMOVED***
