...
class ValidationErrors:
    ...
    def _format_error(self, error):
        ...
        if error_type == 'missing required field':
            return (
                f"Missing required parameter in {name***REMOVED***: "
                f"\"{additional['required_name']***REMOVED***\""
***REMOVED***
        elif error_type == 'unknown field':
            unknown_param = additional['unknown_param']
            valid_names = ', '.join(additional['valid_names'])
            return (
                f'Unknown parameter in {name***REMOVED***: "{unknown_param***REMOVED***", '
                f'must be one of: {valid_names***REMOVED***'
***REMOVED***
            ...
            return (
                f'Invalid type for parameter {name***REMOVED***, value: {param***REMOVED***, '
                f'type: {param_type***REMOVED***, valid types: {valid_types***REMOVED***'
***REMOVED***
        elif error_type == 'invalid range':
            param = additional['param']
            min_allowed = additional['min_allowed']
            return (
                f'Invalid value for parameter {name***REMOVED***, value: {param***REMOVED***, '
                f'valid min value: {min_allowed***REMOVED***'
***REMOVED***
        elif error_type == 'invalid length':
            param = additional['param']
            min_allowed = additional['min_allowed']
            return (
                f'Invalid length for parameter {name***REMOVED***, value: {param***REMOVED***, '
                f'valid min length: {min_allowed***REMOVED***'
***REMOVED***
        elif error_type == 'unable to encode to json':
            return 'Invalid parameter {***REMOVED*** must be json serializable: {***REMOVED***'.format(
                name,
...
***REMOVED***
            ...
            valid_types = ', '.join(additional['valid_types'])
            return (
                f'Invalid type for document parameter {name***REMOVED***, value: {param***REMOVED***, '
                f'type: {param_type***REMOVED***, valid types: {valid_types***REMOVED***'
***REMOVED***
            ...
            return (
                ...
                f'{name***REMOVED***. Can only set one of the following keys: '
                f'{members***REMOVED***.'
***REMOVED***
            ...
            return (
                ...
                f'structure {name***REMOVED***: {members***REMOVED***.'
***REMOVED***
...
***REMOVED***
    ...
    def _validate_list(self, param, shape, errors, name):
        ...
        for i, item in enumerate(param):
            self._validate(item, member_shape, errors, f'{name***REMOVED***[{i***REMOVED***]')
    ...
    def _validate_map(self, param, shape, errors, name):
        ...
        for key, value in param.items():
            self._validate(key, key_shape, errors, f"{name***REMOVED*** (key: {key***REMOVED***)")
            self._validate(value, value_shape, errors, f'{name***REMOVED***.{key***REMOVED***')
