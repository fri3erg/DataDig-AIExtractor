...
def floyd_warshall(G, weight="weight"):
    ...
    >>> results = {a: dict(b) for a, b in fw.items()***REMOVED***
    >>> print(results)
    {0: {0: 0, 1: 5, 2: 7, 3: 4***REMOVED***, 1: {1: 0, 2: 2, 3: -1, 0: inf***REMOVED***, 2: {2: 0, 3: -3, 0: inf, 1: inf***REMOVED***, 3: {3: 0, 2: 8, 0: inf, 1: inf***REMOVED******REMOVED***
