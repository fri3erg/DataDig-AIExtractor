...
def get_expected_stringlength(dtype):
    ...
    if dtype.kind in "iu":
        if dtype.itemsize == 1:
            ...
            raise AssertionError(f"did not find expected length for {dtype***REMOVED***")
...
class TestChanges:
    ...
    def test_float_to_string(self, floating, string):
        ...
        assert np.can_cast(floating, f"{string***REMOVED***100")
...
class TestCasting:
    ...
    def string_with_modified_length(self, dtype, change_length):
        ...
        return np.dtype(f"{dtype.byteorder***REMOVED***{dtype.char***REMOVED***{length***REMOVED***")
    ...
    def test_string_cancast(self, other_DT, string_char):
        ...
        string_dt = np.dtype(f"{string_char***REMOVED***{expected_length***REMOVED***")
    ...
    def test_unicode_byteswapped_cast(self, order1, order2):
        ...
        dtype1 = np.dtype(f"{order1***REMOVED***U30")
        dtype2 = np.dtype(f"{order2***REMOVED***U30")
