...
class DynamoDBChatMessageHistory(BaseChatMessageHistory):
    ...
    ***REMOVED*** from e
        ...
        self.key: Dict = key or {primary_key_name: session_id***REMOVED***
    ...
    ***REMOVED*** from e
            ...
            actions = AttributeActions(
                ...
                attribute_actions={"History": CryptoAction.ENCRYPT_AND_SIGN***REMOVED***,
***REMOVED***
...
***REMOVED*** from e
        ...
        try:
            self.table.put_item(Item={**self.key, "History": messages***REMOVED***)
