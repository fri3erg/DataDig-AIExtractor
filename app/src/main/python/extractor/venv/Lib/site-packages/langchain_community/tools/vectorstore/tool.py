...
class VectorStoreQATool(BaseVectorStoreTool, BaseTool):
    ...
    def get_description(name: str, description: str) -> str:
        template: str = (
            "Useful for when you need to answer questions about {name***REMOVED***. "
            "Whenever you need information about {description***REMOVED*** "
...
class VectorStoreQAWithSourcesTool(BaseVectorStoreTool, BaseTool):
    ...
    def get_description(name: str, description: str) -> str:
        template: str = (
            "Useful for when you need to answer questions about {name***REMOVED*** and the sources "
    ...
    def _run(
        ...
        return json.dumps(
            chain(
                {chain.question_key: query***REMOVED***,
