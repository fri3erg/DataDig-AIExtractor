    ...
    async def start_server(
        ...
        if self.scheme is sentinel:
            if self._ssl:
                ...
                scheme = "http"
            self.scheme = scheme
        self._root = URL(f"{self.scheme***REMOVED***://{self.host***REMOVED***:{self.port***REMOVED***")
...
def make_mocked_request(
    ...
    *,
    ...
    match_info = UrlMappingMatchInfo(
        {***REMOVED*** if match_info is sentinel else match_info, mock.Mock()
    )
