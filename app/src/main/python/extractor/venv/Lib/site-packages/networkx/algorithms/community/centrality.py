...
def girvan_newman(G, most_valuable_edge=None):
    ...
    To just choose an edge to remove based on the weight::
        ...
        >>> G = nx.path_graph(10)
        >>> edges = G.edges()
        >>> nx.set_edge_attributes(G, {(u, v): v for u, v in edges***REMOVED***, "weight")
        >>> def heaviest(G):
    ...
    `most_valuable_edge` keyword argument::
        ...
        ...     centrality = {e: c / max_cent for e, c in centrality.items()***REMOVED***
        ...     # Add some random noise.
        ...     centrality = {e: c + random() for e, c in centrality.items()***REMOVED***
        ...     return max(centrality, key=centrality.get)
        ...
        >>> G = nx.path_graph(10)
        >>> comp = nx.community.girvan_newman(G, most_valuable_edge=most_central_edge)
