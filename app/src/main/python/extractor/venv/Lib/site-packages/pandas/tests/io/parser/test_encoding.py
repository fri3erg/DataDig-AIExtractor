...
4,5,6""".replace(
    ...
    path = f"__{uuid.uuid4()***REMOVED***__.csv"
    kwargs = {"sep": sep, "skiprows": 2***REMOVED***
    utf8 = "utf-8"
...
@pytest.mark.parametrize(
    ...
    [
        # Basic test
        ("a\n1", {***REMOVED***, DataFrame({"a": [1]***REMOVED***)),
        # "Regular" quoting
        ('"a"\n1', {"quotechar": '"'***REMOVED***, DataFrame({"a": [1]***REMOVED***)),
        # Test in a data row instead of header
        ("b\n1", {"names": ["a"]***REMOVED***, DataFrame({"a": ["b", "1"]***REMOVED***)),
        # Test in empty data row with skipping
        ("\n1", {"names": ["a"], "skip_blank_lines": True***REMOVED***, DataFrame({"a": [1]***REMOVED***)),
        # Test in empty data row without skipping
        (
            "\n1",
            {"names": ["a"], "skip_blank_lines": False***REMOVED***,
            DataFrame({"a": [np.nan, 1]***REMOVED***),
        ),
    ],
)
...
def test_read_csv_utf_aliases(all_parsers, utf_value, encoding_fmt):
    # see gh-13549
    expected = DataFrame({"mb_num": [4.8], "multibyte": ["test"]***REMOVED***)
    parser = all_parsers
...
def test_encoding_temp_file(all_parsers, utf_value, encoding_fmt, pass_encoding):
    ...
    expected = DataFrame({"foo": ["bar"]***REMOVED***)
...
def test_encoding_named_temp_file(all_parsers):
    ...
    expected = DataFrame({title: [data]***REMOVED***)

    with tempfile.NamedTemporaryFile() as f:
        f.write(f"{title***REMOVED***\n{data***REMOVED***".encode(encoding))
