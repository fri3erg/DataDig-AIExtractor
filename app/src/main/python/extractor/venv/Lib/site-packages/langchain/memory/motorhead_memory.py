...
***REMOVED***
    ...
    async def init(self) -> None:
        res = requests.get(
            f"{self.url***REMOVED***/sessions/{self.session_id***REMOVED***/memory",
    ...
    def load_memory_variables(self, values: Dict[str, Any]) -> Dict[str, Any]:
        if self.return_messages:
            return {self.memory_key: self.chat_memory.messages***REMOVED***
        else:
            return {self.memory_key: get_buffer_string(self.chat_memory.messages)***REMOVED***
    ...
    def save_context(self, inputs: Dict[str, Any], outputs: Dict[str, str]) -> None:
        ...
        requests.post(
            ...
            json={
                "messages": [
                    {"role": "Human", "content": f"{input_str***REMOVED***"***REMOVED***,
                    {"role": "AI", "content": f"{output_str***REMOVED***"***REMOVED***,
                ]
            ***REMOVED***,
            headers=self.__get_headers(),
        )
    ...
    def delete_session(self) -> None:
        """Delete a session"""
        requests.delete(f"{self.url***REMOVED***/sessions/{self.session_id***REMOVED***/memory")
