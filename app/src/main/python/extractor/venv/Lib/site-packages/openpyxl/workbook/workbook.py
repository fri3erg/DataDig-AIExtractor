...
class Workbook(object):
    ...
    def _setup_styles(self):
        ...
        self._date_formats = {***REMOVED***
        self._timedelta_formats = {***REMOVED***
    ...
    def __getitem__(self, key):
        ...
        for sheet in self.worksheets + self.chartsheets:
            if sheet.title == key:
                return sheet
        raise KeyError("Worksheet {0***REMOVED*** does not exist.".format(key))
    ...
    def create_named_range(self, name, worksheet=None, value=None, scope=None):
        ...
        if worksheet is not None:
            defn.value = "{0***REMOVED***!{1***REMOVED***".format(quote_sheetname(worksheet.title), value)
        else:
            defn.value = value
    ...
    def copy_worksheet(self, from_worksheet):
        ...
        new_title = u"{0***REMOVED*** Copy".format(from_worksheet.title)
