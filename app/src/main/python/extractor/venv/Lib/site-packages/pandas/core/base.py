...
class NoNewAttributesMixin:
    ...
    def __setattr__(self, key: str, value) -> None:
        ...
        if getattr(self, "__frozen", False) and not (
            ...
            raise AttributeError(f"You cannot add any new attribute '{key***REMOVED***'")
        object.__setattr__(self, key, value)
...
class SelectionMixin(Generic[NDFrameT]):
    ...
    def __getitem__(self, key):
        if self._selection is not None:
            raise IndexError(f"Column(s) {self._selection***REMOVED*** already selected")

        if isinstance(key, (list, tuple, ABCSeries, ABCIndex, np.ndarray)):
            if len(self.obj.columns.intersection(key)) != len(set(key)):
                bad_keys = list(set(key).difference(self.obj.columns))
                raise KeyError(f"Columns not found: {str(bad_keys)[1:-1]***REMOVED***")
            return self._gotitem(list(key), ndim=2)

        else:
            if key not in self.obj:
                raise KeyError(f"Column not found: {key***REMOVED***")
    ...
    def to_numpy(
        ...
        **kwargs
        ...
        if isinstance(self.dtype, ExtensionDtype):
            ...
            raise TypeError(
                f"to_numpy() got an unexpected keyword argument '{bad_keys***REMOVED***'"
***REMOVED***
    ...
    def argmax(
        ...
        """
        Return int position of the {value***REMOVED*** value in the Series.

        If the {op***REMOVED***imum is achieved in multiple locations,
        the first row position is returned.

        Parameters
        ----------
        axis : {{None***REMOVED******REMOVED***
        ...
        *args, **kwargs
        ...
        -------
        int
            Row position of the {op***REMOVED***imum value.

        See Also
        --------
        Series.arg{op***REMOVED*** : Return position of the {op***REMOVED***imum value.
        Series.arg{oppose***REMOVED*** : Return position of the {oppose***REMOVED***imum value.
        numpy.ndarray.arg{op***REMOVED*** : Equivalent method for numpy arrays.
        ...
        ...                'Cinnamon Toast Crunch': 120.0, 'Cocoa Puff': 110.0***REMOVED******REMOVED***)
        >>> s
        Corn Flakes              100.0
...
***REMOVED***
    ...
    _shared_docs[
        ...
        Find the indices into a sorted {klass***REMOVED*** `self` such that, if the
        corresponding elements in `value` were inserted before the indices,
        the order of `self` would be preserved.

        .. note::

            The {klass***REMOVED*** *must* be monotonically sorted, otherwise
        ...
        side : {{'left', 'right'***REMOVED******REMOVED***, optional
    ...
    def searchsorted(
        ...
        if isinstance(value, ABCDataFrame):
            msg = (
                ...
                f"{type(value).__name__***REMOVED*** is not supported"
***REMOVED***
