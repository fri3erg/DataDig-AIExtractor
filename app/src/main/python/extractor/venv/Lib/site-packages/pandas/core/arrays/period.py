...
***REMOVED***
        ...
        if dtype is not None:
            ...
            if not isinstance(dtype, PeriodDtype):
                raise ValueError(f"Invalid dtype {dtype***REMOVED*** for PeriodArray")
    ...
    def _unbox_scalar(  # type: ignore[override]
        ...
        if value is NaT:
            ...
            raise ValueError(f"'value' should be a Period. Got '{value***REMOVED***' instead.")
            ...
            if pyarrow.types.is_integer(type):
                ...
                if self.freqstr != type.freq:
                    raise TypeError(
                        ...
                        f"'freq' ({self.freqstr***REMOVED*** vs {type.freq***REMOVED***)"
        ***REMOVED***
            else:
                raise TypeError(
                    f"Not supported to convert PeriodArray to '{type***REMOVED***' type"
    ***REMOVED***
    ...
    def asfreq(self, freq=None, how: str = "E") -> Self:
        """
        Convert the {klass***REMOVED*** to the specified frequency `freq`.

        Equivalent to applying :meth:`pandas.Period.asfreq` with the given arguments
        to each :class:`~pandas.Period` in this {klass***REMOVED***.

        Parameters
        ----------
        freq : str
            A frequency.
        how : str {{'E', 'S'***REMOVED******REMOVED***, default 'E'
        ...
        -------
        {klass***REMOVED***
            The transformed {klass***REMOVED*** with the new frequency.

        See Also
        --------
        {other***REMOVED***.asfreq: Convert each Period in a {other_name***REMOVED*** to the given frequency.
    ...
    def _add_timedelta_arraylike(
        ...
        if not self.dtype._is_tick_like():
            # We cannot add timedelta-like to non-tick PeriodArray
            raise TypeError(
                f"Cannot add or subtract timedelta64[ns] dtype from {self.dtype***REMOVED***"
***REMOVED***

        dtype = np.dtype(f"m8[{self.dtype._td64_unit***REMOVED***]")
...
def dt64arr_to_periodarr(
    ...
    if not isinstance(data.dtype, np.dtype) or data.dtype.kind != "M":
        raise ValueError(f"Wrong dtype: {data.dtype***REMOVED***")
    ...
    try:
        ...
        raise TypeError(f"{freq.name***REMOVED*** is not supported as period frequency")
