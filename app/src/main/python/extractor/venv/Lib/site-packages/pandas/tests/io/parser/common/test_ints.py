...
@pytest.mark.parametrize(
    ...
    [
        ...
        (
            "A,B\nYES,1\nno,2\nyes,3\nNo,3\nYes,3",
            {"true_values": ["yes", "Yes", "YES"], "false_values": ["no", "NO", "No"]***REMOVED***,
            DataFrame(
...
***REMOVED***,
        ...
        (
            "A,B\nfoo,bar\nbar,foo",
            {"true_values": ["foo"], "false_values": ["bar"]***REMOVED***,
...
def test_int64_min_issues(all_parsers):
    ...
    expected = DataFrame({"A": [0, 0], "B": [0, np.nan]***REMOVED***)
    tm.assert_frame_equal(result, expected)
...
00013007854817840018860166"""
    ...
    if conv is None:
        ...
        with pytest.raises(err, match=msg):
            parser.read_csv(StringIO(data), converters={"ID": conv***REMOVED***)
