    ...
    def parse(self, response: str) -> Any:
        try:
            ...
            raise OutputParserException(
                f"Response '{response***REMOVED***' is not one of the "
                f"expected values: {self._valid_values***REMOVED***"
***REMOVED***

    def get_format_instructions(self) -> str:
        return f"Select one of the following options: {', '.join(self._valid_values)***REMOVED***"
