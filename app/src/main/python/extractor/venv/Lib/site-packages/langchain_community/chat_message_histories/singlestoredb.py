        ...
        try:
            ...
            try:
                cur.execute(
                    ...
                    ({***REMOVED*** BIGINT PRIMARY KEY AUTO_INCREMENT,
                    {***REMOVED*** TEXT NOT NULL,
                    {***REMOVED*** JSON NOT NULL);""".format(
                        self.table_name,
                        self.id_field,
    ...
    ***REMOVED***
    ...
    def messages(self) -> List[BaseMessage]:  # type: ignore
        ...
        try:
            ...
            try:
                cur.execute(
                    """SELECT {***REMOVED*** FROM {***REMOVED*** WHERE {***REMOVED*** = %s""".format(
                        self.message_field,
                        self.table_name,
                        self.session_id_field,
        ***REMOVED***,
    ...
    ***REMOVED***
    ...
    def add_message(self, message: BaseMessage) -> None:
        ...
        try:
            ...
            try:
                cur.execute(
                    """INSERT INTO {***REMOVED*** ({***REMOVED***, {***REMOVED***) VALUES (%s, %s)""".format(
                        self.table_name,
                        self.session_id_field,
                        self.message_field,
        ***REMOVED***,
    ...
    ***REMOVED***
    ...
    def clear(self) -> None:
        ...
        try:
            ...
            try:
                cur.execute(
                    """DELETE FROM {***REMOVED*** WHERE {***REMOVED*** = %s""".format(
                        self.table_name,
                        self.session_id_field,
        ***REMOVED***,
                    (self.session_id),
