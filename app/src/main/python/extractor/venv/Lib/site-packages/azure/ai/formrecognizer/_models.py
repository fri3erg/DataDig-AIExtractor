...
class Point(namedtuple("Point", "x y")):
    ...
    def to_dict(self) -> Dict:
        ...
        :rtype: dict
        """
        return {"x": self.x, "y": self.y***REMOVED***
...
class TextAppearance:
    ...
    def __repr__(self) -> str:
        return f"TextAppearance(style_name={self.style_name***REMOVED***, style_confidence={self.style_confidence***REMOVED***)"
...
class FormWord(FormElement):
    ...
    def __repr__(self) -> str:
        return (
            f"FormWord(text={self.text***REMOVED***, bounding_box={self.bounding_box***REMOVED***, confidence={self.confidence***REMOVED***, "
            f"page_number={self.page_number***REMOVED***, kind={self.kind***REMOVED***)"
        )[:1024]
...
class FormSelectionMark(FormElement):
    ...
    def __repr__(self) -> str:
        return (
            f"FormSelectionMark(text={self.text***REMOVED***, bounding_box={self.bounding_box***REMOVED***, confidence={self.confidence***REMOVED***, "
            f"page_number={self.page_number***REMOVED***, state={self.state***REMOVED***, kind={self.kind***REMOVED***)"
        )[:1024]
...
class FormLine(FormElement):
    ...
    def __repr__(self) -> str:
        return (
            f"FormLine(text={self.text***REMOVED***, bounding_box={self.bounding_box***REMOVED***, words={repr(self.words)***REMOVED***, "
            f"page_number={self.page_number***REMOVED***, kind={self.kind***REMOVED***, appearance={self.appearance***REMOVED***)"
        )[:1024]
...
class FormTableCell:  # pylint:disable=too-many-instance-attributes
    ...
    def __repr__(self) -> str:
        return (
            f"FormTableCell(text={self.text***REMOVED***, row_index={self.row_index***REMOVED***, column_index={self.column_index***REMOVED***, "
            f"row_span={self.row_span***REMOVED***, column_span={self.column_span***REMOVED***, bounding_box={self.bounding_box***REMOVED***, "
            f"confidence={self.confidence***REMOVED***, is_header={self.is_header***REMOVED***, is_footer={self.is_footer***REMOVED***, "
            f"page_number={self.page_number***REMOVED***, field_elements={repr(self.field_elements)***REMOVED***)"
        )[:1024]
...
class FormTable:
    ...
    def __repr__(self) -> str:
        return (
            f"FormTable(page_number={self.page_number***REMOVED***, cells={repr(self.cells)***REMOVED***, row_count={self.row_count***REMOVED***, "
            f"column_count={self.column_count***REMOVED***, bounding_box={self.bounding_box***REMOVED***)"
        )[:1024]
...
class FormPage:
    ...
    def __repr__(self) -> str:
        return (
            f"FormPage(page_number={self.page_number***REMOVED***, text_angle={self.text_angle***REMOVED***, "
            f"width={self.width***REMOVED***, height={self.height***REMOVED***, unit={self.unit***REMOVED***, tables={repr(self.tables)***REMOVED***, "
            f"lines={repr(self.lines)***REMOVED***, selection_marks={repr(self.selection_marks)***REMOVED***)"
        )[:1024]
...
class FieldData:
    ...
    def __repr__(self) -> str:
        return (
            f"FieldData(page_number={self.page_number***REMOVED***, text={self.text***REMOVED***, bounding_box={self.bounding_box***REMOVED***, "
            f"field_elements={repr(self.field_elements)***REMOVED***)"
        )[:1024]
...
***REMOVED***,
    ...
    def __repr__(self) -> str:
        return (
                f"FormField(value_type={self.value_type***REMOVED***, label_data={repr(self.label_data)***REMOVED***, "
                f"value_data={repr(self.value_data)***REMOVED***, name={self.name***REMOVED***, value={repr(self.value)***REMOVED***, "
                f"confidence={self.confidence***REMOVED***)"
***REMOVED***[:1024]
    ...
    def to_dict(self) -> Dict:
        ...
        if isinstance(self.value, dict):
            value = {k: v.to_dict() for k, v in self.value.items()***REMOVED***  # type: ignore
    ...
    def from_dict(cls, data: Dict) -> "FormField":
        ...
        if isinstance(data.get("value"), dict):
            value = {k: FormField.from_dict(v) for k, v in data.get("value").items()***REMOVED***  # type: ignore
...
class RecognizedForm:
    ...
    def __repr__(self) -> str:
        return (
            f"RecognizedForm(form_type={self.form_type***REMOVED***, fields={repr(self.fields)***REMOVED***, "
            f"page_range={repr(self.page_range)***REMOVED***, pages={repr(self.pages)***REMOVED***, "
            f"form_type_confidence={self.form_type_confidence***REMOVED***, model_id={self.model_id***REMOVED***)"
***REMOVED***[:1024]
    ...
    def to_dict(self) -> Dict:
        ...
        """
        return {
            "fields": {k: v.to_dict() for k, v in self.fields.items()***REMOVED***
            if self.fields
            else {***REMOVED***,
    ...
    def from_dict(cls, data: Dict) -> "RecognizedForm":
        ...
        """
        return cls(
            fields={k: FormField.from_dict(v) for k, v in data.get("fields").items()***REMOVED***  # type: ignore
            if data.get("fields")
            else {***REMOVED***,
...
class FormRecognizerError:
    ...
    def __repr__(self) -> str:
        return f"FormRecognizerError(code={self.code***REMOVED***, message={self.message***REMOVED***)"[:1024]
    ...
    def to_dict(self) -> Dict:
        ...
        :rtype: dict
        """
        return {"code": self.code, "message": self.message***REMOVED***
...
class CustomFormModelField:
    ...
    def _from_generated_unlabeled(cls, fields):
        return {
            f"field-{idx***REMOVED***": cls(
                name=f"field-{idx***REMOVED***",
                label=field_name,
***REMOVED***
    ...
    def __repr__(self) -> str:
        return f"CustomFormModelField(label={self.label***REMOVED***, name={self.name***REMOVED***, accuracy={self.accuracy***REMOVED***)"[:1024]
    ...
    def to_dict(self) -> Dict:
        ...
        :rtype: dict
        """
        return {"label": self.label, "accuracy": self.accuracy, "name": self.name***REMOVED***
...
class TrainingDocumentInfo:
    ...
    ***REMOVED***
    ...
    def __repr__(self) -> str:
        return (
            f"TrainingDocumentInfo(name={self.name***REMOVED***, status={self.status***REMOVED***, page_count={self.page_count***REMOVED***, "
            f"errors={repr(self.errors)***REMOVED***, model_id={self.model_id***REMOVED***)"[:1024]
        )
...
class AccountProperties:
    ...
    def __repr__(self) -> str:
        return (
            f"AccountProperties(custom_model_count={self.custom_model_count***REMOVED***, "
            f"custom_model_limit={self.custom_model_limit***REMOVED***)"
        )[:1024]
...
class CustomFormModelProperties:
    ...
    def __repr__(self) -> str:
        return f"CustomFormModelProperties(is_composed_model={self.is_composed_model***REMOVED***)"
    ...
    def to_dict(self) -> Dict:
        ...
        :rtype: dict
        """
        return {"is_composed_model": self.is_composed_model***REMOVED***
...
class CustomFormModelInfo:
    ...
    def __repr__(self) -> str:
        return (
            f"CustomFormModelInfo(model_id={self.model_id***REMOVED***, status={self.status***REMOVED***, "
            f"training_started_on={self.training_started_on***REMOVED***, training_completed_on={self.training_completed_on***REMOVED***, "
            f"properties={repr(self.properties)***REMOVED***, model_name={self.model_name***REMOVED***)"
        )[:1024]
...
***REMOVED***
    ...
    def __repr__(self) -> str:
        return (
            f"CustomFormSubmodel(accuracy={self.accuracy***REMOVED***, model_id={self.model_id***REMOVED***, "
            f"fields={repr(self.fields)***REMOVED***, form_type={self.form_type***REMOVED***)"
        )[:1024]
    ...
    def from_dict(cls, data: Dict) -> "CustomFormSubmodel":
        ...
        return cls(
            model_id=data.get("model_id", None),
            accuracy=data.get("accuracy", None),
            fields={k: CustomFormModelField.from_dict(v) for k, v in data.get("fields").items()***REMOVED***  # type: ignore
            if data.get("fields")
            else {***REMOVED***,
            form_type=data.get("form_type", None),
        )
...
***REMOVED***,
    ...
    def __repr__(self) -> str:
        return (
            f"CustomFormModel(model_id={self.model_id***REMOVED***, status={self.status***REMOVED***, "
            f"training_started_on={self.training_started_on***REMOVED***, training_completed_on={self.training_completed_on***REMOVED***, "
            f"submodels={repr(self.submodels)***REMOVED***, errors={repr(self.errors)***REMOVED***, "
            f"training_documents={repr(self.training_documents)***REMOVED***, model_name={self.model_name***REMOVED***, "
            f"properties={repr(self.properties)***REMOVED***)"
        )[:1024]
...
class DocumentSpan:
    ...
    def __repr__(self) -> str:
        return f"DocumentSpan(offset={self.offset***REMOVED***, length={self.length***REMOVED***)"
...
class BoundingRegion:
    ...
    def __repr__(self) -> str:
        return f"BoundingRegion(page_number={self.page_number***REMOVED***, polygon={self.polygon***REMOVED***)"
...
class AddressValue:  # pylint: disable=too-many-instance-attributes
    ...
    def __repr__(self) -> str:
        return (
            f"AddressValue(house_number={self.house_number***REMOVED***, po_box={self.po_box***REMOVED***, road={self.road***REMOVED***, "
            f"city={self.city***REMOVED***, state={self.state***REMOVED***, postal_code={self.postal_code***REMOVED***, "
            f"country_region={self.country_region***REMOVED***, street_address={self.street_address***REMOVED***, "
            f"unit={self.unit***REMOVED***, city_district={self.city_district***REMOVED***, state_district={self.state_district***REMOVED***, "
            f"suburb={self.suburb***REMOVED***, house={self.house***REMOVED***, level={self.level***REMOVED***)"
        )
...
class CurrencyValue:
    ...
    def __str__(self):
        if self.symbol is not None:
            return f"{self.symbol***REMOVED***{self.amount***REMOVED***"
        return f"{self.amount***REMOVED***"

    def __repr__(self) -> str:
        return f"CurrencyValue(amount={self.amount***REMOVED***, symbol={self.symbol***REMOVED***, code={self.code***REMOVED***)"
...
class DocumentLanguage:
    ...
    def __repr__(self) -> str:
        return f"DocumentLanguage(locale={self.locale***REMOVED***, spans={repr(self.spans)***REMOVED***, confidence={self.confidence***REMOVED***)"
...
class DocumentField:
    ...
    ***REMOVED***
    ...
    def __repr__(self) -> str:
        return (
            f"DocumentField(value_type={self.value_type***REMOVED***, value={repr(self.value)***REMOVED***, content={self.content***REMOVED***, "
            f"bounding_regions={repr(self.bounding_regions)***REMOVED***, spans={repr(self.spans)***REMOVED***, "
            f"confidence={self.confidence***REMOVED***)"
        )
    ...
    def to_dict(self) -> Dict:
        ...
        # to call the proper to_dict() method.
            ...
            value = {k: v.to_dict() for k, v in self.value.items()***REMOVED*** if self.value else {***REMOVED***  # type: ignore
        elif isinstance(self.value, list):
    ...
    def from_dict(cls, data: Dict) -> "DocumentField":
        ...
        # to call the proper from_dict() method.
            ...
            value = {k: DocumentField.from_dict(v) for k, v in data.get("value").items()***REMOVED***  # type: ignore
        elif isinstance(data.get("value"), list):
...
class AnalyzedDocument:
    ...
    def __repr__(self) -> str:
        return (
            f"AnalyzedDocument(doc_type={self.doc_type***REMOVED***, bounding_regions={repr(self.bounding_regions)***REMOVED***, "
            f"spans={repr(self.spans)***REMOVED***, fields={repr(self.fields)***REMOVED***, confidence={self.confidence***REMOVED***)"
        )
    ...
    def from_dict(cls, data: Dict) -> "AnalyzedDocument":
        ...
        return cls(
            ...
            fields={k: DocumentField.from_dict(v) for k, v in data.get("fields").items()***REMOVED***  # type: ignore
            if data.get("fields")
            else {***REMOVED***,
            confidence=data.get("confidence", None),
        )
...
class DocumentKeyValueElement:
    ...
    def __repr__(self) -> str:
        return (
            f"DocumentKeyValueElement(content={self.content***REMOVED***, bounding_regions={repr(self.bounding_regions)***REMOVED***, "
            f"spans={repr(self.spans)***REMOVED***)"
        )
...
class DocumentKeyValuePair:
    ...
    def __repr__(self) -> str:
        return (
            f"DocumentKeyValuePair(key={repr(self.key)***REMOVED***, value={repr(self.value)***REMOVED***, "
            f"confidence={self.confidence***REMOVED***)"
        )
...
class DocumentWord:
    ...
    def __repr__(self) -> str:
        return (
            f"DocumentWord(content={self.content***REMOVED***, polygon={self.polygon***REMOVED***, "
            f"span={repr(self.span)***REMOVED***, confidence={self.confidence***REMOVED***)"
        )
...
class DocumentSelectionMark:
    ...
    def __repr__(self) -> str:
        return (
            f"DocumentSelectionMark(state={self.state***REMOVED***, span={repr(self.span)***REMOVED***, "
            f"confidence={self.confidence***REMOVED***, polygon={self.polygon***REMOVED***)"
        )
...
class DocumentLine:
    ...
    def __repr__(self) -> str:
        return f"DocumentLine(content={self.content***REMOVED***, polygon={self.polygon***REMOVED***, spans={repr(self.spans)***REMOVED***)"
...
class DocumentParagraph:
    ...
    def __repr__(self) -> str:
        return (
            f"DocumentParagraph(role={self.role***REMOVED***, content={self.content***REMOVED***, "
            f"bounding_regions={repr(self.bounding_regions)***REMOVED***, spans={repr(self.spans)***REMOVED***)"
        )
...
class DocumentBarcode:
    ...
    def __repr__(self) -> str:
        return (
            f"DocumentBarcode(kind={self.kind***REMOVED***, polygon={self.polygon***REMOVED***, confidence={self.confidence***REMOVED***, "
            f"value={self.value***REMOVED***, span={repr(self.span)***REMOVED***)"
        )
...
class DocumentFormula:
    ...
    def __repr__(self) -> str:
        return (
            f"DocumentFormula(kind={self.kind***REMOVED***, polygon={self.polygon***REMOVED***, confidence={self.confidence***REMOVED***, "
            f"value={self.value***REMOVED***, span={repr(self.span)***REMOVED***)"
        )
...
class DocumentPage:  # pylint: disable=too-many-instance-attributes
    ...
    def __repr__(self) -> str:
        return (
            f"DocumentPage(page_number={self.page_number***REMOVED***, angle={self.angle***REMOVED***, "
            f"width={self.width***REMOVED***, height={self.height***REMOVED***, unit={self.unit***REMOVED***, lines={repr(self.lines)***REMOVED***, "
            f"words={repr(self.words)***REMOVED***, selection_marks={repr(self.selection_marks)***REMOVED***, "
            f"spans={repr(self.spans)***REMOVED***, barcodes={repr(self.barcodes)***REMOVED***, formulas={repr(self.formulas)***REMOVED***)"
        )
...
class DocumentStyle:
    ...
    def __repr__(self) -> str:
        return (
            f"DocumentStyle(is_handwritten={self.is_handwritten***REMOVED***, spans={repr(self.spans)***REMOVED***, "
            f"confidence={self.confidence***REMOVED***, similar_font_family={self.similar_font_family***REMOVED***, "
            f"font_style={self.font_style***REMOVED***, font_weight={self.font_weight***REMOVED***, color={self.color***REMOVED***, "
            f"background_color={self.background_color***REMOVED***)"
        )
...
class DocumentTableCell:
    ...
    def __repr__(self) -> str:
        return (
            f"DocumentTableCell(kind={self.kind***REMOVED***, row_index={self.row_index***REMOVED***, "
            f"column_index={self.column_index***REMOVED***, row_span={self.row_span***REMOVED***, "
            f"column_span={self.column_span***REMOVED***, content={self.content***REMOVED***, "
            f"bounding_regions={repr(self.bounding_regions)***REMOVED***, spans={repr(self.spans)***REMOVED***)"
        )
...
class DocumentTable:
    ...
    def __repr__(self) -> str:
        return (
            f"DocumentTable(row_count={self.row_count***REMOVED***, column_count={self.column_count***REMOVED***, "
            f"cells={repr(self.cells)***REMOVED***, bounding_regions={repr(self.bounding_regions)***REMOVED***, "
            f"spans={repr(self.spans)***REMOVED***)"
        )
...
class DocumentTypeDetails:
    ...
    def __repr__(self) -> str:
        return (
            f"DocumentTypeDetails(description={self.description***REMOVED***, build_mode={self.build_mode***REMOVED***, "
            f"field_schema={self.field_schema***REMOVED***, field_confidence={self.field_confidence***REMOVED***)"
        )
    ...
    def _from_generated(cls, doc_type):
        return cls(
            ...
            field_schema={name: field.serialize() for name, field in doc_type.field_schema.items()***REMOVED***
            if doc_type.field_schema else {***REMOVED***,
            field_confidence=doc_type.field_confidence
            if doc_type.field_confidence else {***REMOVED***,
        )
    ...
    def from_dict(cls, data: Dict) -> "DocumentTypeDetails":
        ...
        return cls(
            ...
            field_schema=data.get("field_schema", {***REMOVED***),
            field_confidence=data.get("field_confidence", {***REMOVED***),
        )
...
class DocumentModelSummary:
    ...
    def __repr__(self) -> str:
        return (
            f"DocumentModelSummary(model_id={self.model_id***REMOVED***, description={self.description***REMOVED***, "
            f"created_on={self.created_on***REMOVED***, api_version={self.api_version***REMOVED***, tags={self.tags***REMOVED***, "
            f"expires_on={self.expires_on***REMOVED***)"
        )
    ...
    def _from_generated(cls, model):
        ...
        return cls(
            ...
            tags=model.tags if model.tags else {***REMOVED***,
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "tags": self.tags if self.tags else {***REMOVED***,
...
class BlobFileListSource:
    ...
    def __repr__(self) -> str:
        return (
            f"BlobFileListSource(container_url={self.container_url***REMOVED***, file_list={self.file_list***REMOVED***)"
        )
...
class BlobSource:
    ...
    def __repr__(self) -> str:
        return (
            f"BlobSource(container_url={self.container_url***REMOVED***, prefix={self.prefix***REMOVED***)"
        )
...
class ClassifierDocumentTypeDetails:
    ...
    def __repr__(self) -> str:
        return (
            f"ClassifierDocumentTypeDetails(source_kind={self.source_kind***REMOVED***, source={repr(self.source)***REMOVED***)"
        )
...
class DocumentClassifierDetails:
    ...
    def __repr__(self) -> str:
        return (
            f"DocumentClassifierDetails(classifier_id={self.classifier_id***REMOVED***, description={self.description***REMOVED***, "
            f"created_on={self.created_on***REMOVED***, expires_on={self.expires_on***REMOVED***, "
            f"api_version={self.api_version***REMOVED***, doc_types={repr(self.doc_types)***REMOVED***)"
        )
    ...
    def _from_generated(cls, model):
        return cls(
            ...
            api_version=model.api_version,
            doc_types={k: ClassifierDocumentTypeDetails._from_generated(v) for k, v in model.doc_types.items()***REMOVED***
            if model.doc_types else {***REMOVED***
        )
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "expires_on": self.expires_on,
            "api_version": self.api_version,
            "doc_types": {k: v.to_dict() for k, v in self.doc_types.items()***REMOVED*** if self.doc_types else {***REMOVED***  # type: ignore
        ***REMOVED***
    ...
    def from_dict(cls, data: Dict[str, Any]) -> "DocumentClassifierDetails":
        ...
        return cls(
            ...
            doc_types={k: ClassifierDocumentTypeDetails.from_dict(v)
                       for k, v in data.get("doc_types").items()***REMOVED***  # type: ignore
...
class DocumentModelDetails(DocumentModelSummary):
    ...
    def __repr__(self) -> str:
        return (
            f"DocumentModelDetails(model_id={self.model_id***REMOVED***, description={self.description***REMOVED***, "
            f"created_on={self.created_on***REMOVED***, api_version={self.api_version***REMOVED***, tags={self.tags***REMOVED***, "
            f"doc_types={repr(self.doc_types)***REMOVED***, expires_on={self.expires_on***REMOVED***)"
        )
    ...
    def _from_generated(cls, model):
        ...
        return cls(
            ...
            api_version=model.api_version,
            tags=model.tags if model.tags else {***REMOVED***,
            doc_types={k: DocumentTypeDetails._from_generated(v) for k, v in model.doc_types.items()***REMOVED***
            if model.doc_types else {***REMOVED***,
            expires_on=expires_on
        )
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "api_version": self.api_version,
            "tags": self.tags if self.tags else {***REMOVED***,
            "doc_types": {k: v.to_dict() for k, v in self.doc_types.items()***REMOVED*** if self.doc_types else {***REMOVED***,
            "expires_on": self.expires_on,
        ***REMOVED***
    ...
    def from_dict(cls, data: Dict[str, Any]) -> "DocumentModelDetails":
        ...
        return cls(
            ...
            api_version=data.get("api_version", None),
            tags=data.get("tags", {***REMOVED***),
            doc_types={k: DocumentTypeDetails.from_dict(v) for k, v in data.get("doc_types").items()***REMOVED***  # type: ignore
            if data.get("doc_types")
            else {***REMOVED***,
            expires_on=data.get("expires_on", None),
        )
...
class DocumentAnalysisInnerError:
    ...
    def __repr__(self) -> str:
        return (
            f"DocumentAnalysisInnerError(code={self.code***REMOVED***, message={self.message***REMOVED***, "
            f"innererror={repr(self.innererror)***REMOVED***)"
        )
...
class DocumentAnalysisError:
    ...
    def __repr__(self) -> str:
        return (
            f"DocumentAnalysisError(code={self.code***REMOVED***, message={self.message***REMOVED***, target={self.target***REMOVED***, "
            f"details={repr(self.details)***REMOVED***, innererror={repr(self.innererror)***REMOVED***)"
        )
...
class OperationSummary:
    ...
    def __repr__(self) -> str:
        return (
            f"OperationSummary(operation_id={self.operation_id***REMOVED***, status={self.status***REMOVED***, "
            f"percent_completed={self.percent_completed***REMOVED***, created_on={self.created_on***REMOVED***, "
            f"last_updated_on={self.last_updated_on***REMOVED***, kind={self.kind***REMOVED***, "
            f"resource_location={self.resource_location***REMOVED***, api_version={self.api_version***REMOVED***, tags={self.tags***REMOVED***)"
        )
    ...
    def _from_generated(cls, op):
        return cls(
            ...
            tags=op.tags if op.tags else {***REMOVED***,
        )
...
class OperationDetails(OperationSummary):
    ...
    def __repr__(self) -> str:
        return (
            f"OperationDetails(operation_id={self.operation_id***REMOVED***, status={self.status***REMOVED***, "
            f"percent_completed={self.percent_completed***REMOVED***, created_on={self.created_on***REMOVED***, "
            f"last_updated_on={self.last_updated_on***REMOVED***, kind={self.kind***REMOVED***, "
            f"resource_location={self.resource_location***REMOVED***, result={repr(self.result)***REMOVED***, "
            f"error={repr(self.error)***REMOVED***, api_version={self.api_version***REMOVED***, tags={self.tags***REMOVED***)"
        )
...
class AnalyzeResult:  # pylint: disable=too-many-instance-attributes
    ...
    def __repr__(self) -> str:
        return (
            f"AnalyzeResult(api_version={self.api_version***REMOVED***, model_id={self.model_id***REMOVED***, "
            f"content={self.content***REMOVED***, languages={repr(self.languages)***REMOVED***, "
            f"pages={repr(self.pages)***REMOVED***, paragraphs={repr(self.paragraphs)***REMOVED***, tables={repr(self.tables)***REMOVED***, "
            f"key_value_pairs={repr(self.key_value_pairs)***REMOVED***, "
            f"styles={repr(self.styles)***REMOVED***, documents={repr(self.documents)***REMOVED***)"
        )
...
class CustomDocumentModelsDetails:
    ...
    def __repr__(self) -> str:
        return f"CustomDocumentModelsDetails(count={self.count***REMOVED***, limit={self.limit***REMOVED***)"
...
class QuotaDetails:
    ...
    def __repr__(self) -> str:
        return f"QuotaDetails(used={self.used***REMOVED***, quota={self.quota***REMOVED***, quota_resets_on={self.quota_resets_on***REMOVED***)"
...
class ResourceDetails:
    ...
    def __repr__(self) -> str:
        return f"ResourceDetails(custom_document_models={repr(self.custom_document_models)***REMOVED***, " \
               f"neural_document_model_quota={repr(self.neural_document_model_quota)***REMOVED***)"
...
***REMOVED*** if data.get("custom_document_models") else None,
            neural_document_model_quota=QuotaDetails.from_dict(
                data.get("neural_document_model_quota")  # type: ignore
***REMOVED*** if data.get("neural_document_model_quota") else None,
        )
