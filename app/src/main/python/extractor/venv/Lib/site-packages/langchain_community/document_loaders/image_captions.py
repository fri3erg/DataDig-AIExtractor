...
***REMOVED***
        ...
        try:
            ...
            if isinstance(image_source, bytes):
                ...
                msg = f"Could not get image data for {image_source***REMOVED***"
        ...
        if isinstance(image_source, bytes):
            metadata: dict = {"image_source": "Image bytes provided"***REMOVED***
        else:
            metadata = {"image_path": image_source***REMOVED***
