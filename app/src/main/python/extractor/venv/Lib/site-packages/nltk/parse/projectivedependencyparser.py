...
***REMOVED***
    ...
    ***REMOVED***:
                    ...
                    if head_word in tags:
                        ...
                        tags[head_word] = {head_tag***REMOVED***
                    child = "STOP"
                    child_tag = "STOP"
                    prev_word = "START"
                    prev_tag = "START"
                    if child_index < 0:
                        ...
                        head_event = "(head ({***REMOVED*** {***REMOVED***) (mods ({***REMOVED***, {***REMOVED***, {***REMOVED***) left))".format(
                            child,
                            child_tag,
                            prev_tag,
                            head_word,
                            head_tag,
            ***REMOVED***
                        mod_event = "(mods ({***REMOVED***, {***REMOVED***, {***REMOVED***) left))".format(
                            prev_tag,
                            head_word,
                            head_tag,
            ***REMOVED***
                        ...
                        if child != "STOP":
                            productions.append(DependencyProduction(head_word, [child]))
                        head_event = "(head ({***REMOVED*** {***REMOVED***) (mods ({***REMOVED***, {***REMOVED***, {***REMOVED***) right))".format(
                            child,
                            child_tag,
                            prev_tag,
                            head_word,
                            head_tag,
            ***REMOVED***
                        mod_event = "(mods ({***REMOVED***, {***REMOVED***, {***REMOVED***) right))".format(
                            prev_tag,
                            head_word,
                            head_tag,
            ***REMOVED***
