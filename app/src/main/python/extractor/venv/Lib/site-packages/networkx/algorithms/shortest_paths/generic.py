...
def shortest_path(G, source=None, target=None, weight=None, method="dijkstra"):
    ...
    if method not in ("dijkstra", "bellman-ford"):
        ...
        raise ValueError(f"method not supported: {method***REMOVED***")
...
def average_shortest_path_length(G, weight=None, method=None):
    ...
    .. math::
       ...
       a =\sum_{\substack{s,t \in V \\ s\neq t***REMOVED******REMOVED*** \frac{d(s, t)***REMOVED***{n(n-1)***REMOVED***
...
def all_shortest_paths(G, source, target, weight=None, method="dijkstra"):
    ...
    return _build_paths_from_predecessors({source***REMOVED***, target, pred)
...
def single_source_all_shortest_paths(G, source, weight=None, method="dijkstra"):
    ...
    {0: [[0]], 1: [[0, 1]], 2: [[0, 1, 2], [0, 3, 2]], 3: [[0, 3]]***REMOVED***
    ...
    for n in G:
        try:
            yield n, list(_build_paths_from_predecessors({source***REMOVED***, n, pred))
        except nx.NetworkXNoPath:
            pass
...
def _build_paths_from_predecessors(sources, target, pred):
    ...
    if target not in pred:
        raise nx.NetworkXNoPath(f"Target {target***REMOVED*** cannot be reached from given sources")
