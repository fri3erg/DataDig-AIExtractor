...
def disjoint_union(G, H):
    ...
    >>> U.nodes(data=True)
    NodeDataView({0: {'key1': 5***REMOVED***, 1: {***REMOVED***, 2: {***REMOVED***, 3: {'key2': 10***REMOVED***, 4: {***REMOVED***, 5: {***REMOVED***, 6: {***REMOVED******REMOVED***)
    >>> U.edges
...
def compose(G, H):
    ...
    >>> G = nx.Graph([(0, 1, {'weight': 2.0***REMOVED***), (3, 0, {'weight': 100.0***REMOVED***)])
    >>> H = nx.Graph([(0, 1, {'weight': 10.0***REMOVED***), (1, 2, {'weight': -1.0***REMOVED***)])
    >>> nx.set_node_attributes(G, {0: 'dark', 1: 'light', 3: 'black'***REMOVED***, name='color')
    >>> nx.set_node_attributes(H, {0: 'green', 1: 'orange', 2: 'yellow'***REMOVED***, name='color')
    ...
    >>> node_data = {n: G.nodes[n]['color'] + " " + H.nodes[n]['color'] for n in G.nodes & H.nodes***REMOVED***
    ...
    >>> edge_data = {e: G.edges[e]['weight'] * H.edges[e]['weight'] for e in G.edges & H.edges***REMOVED***
...
def full_join(G, H, rename=(None, None)):
    ...
    def add_prefix(graph, prefix):
        ...
        def label(x):
            return f"{prefix***REMOVED***{x***REMOVED***"
