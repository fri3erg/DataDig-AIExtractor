...
class _FileOpeners:
    ...
    def __init__(self):
        self._loaded = False
        self._file_openers = {None: io.open***REMOVED***
...
def open(path, mode='r', destpath=os.curdir, encoding=None, newline=None):
    ...
    encoding : {None, str***REMOVED***, optional
        ...
        what `io.open` uses.
    newline : {None, str***REMOVED***, optional
...
class DataSource:
    ...
    def open(self, path, mode='r', encoding=None, newline=None):
        ...
        if found:
            ...
            raise FileNotFoundError(f"{path***REMOVED*** not found.")
