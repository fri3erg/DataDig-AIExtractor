...
def normalize_and_validate(
    ...
    for name, value in headers:
        ...
        if not _parsed:
            ...
            validate(_field_name_re, name, "Illegal header name {!r***REMOVED***", name)
            validate(_field_value_re, value, "Illegal header value {!r***REMOVED***", value)
        ...
        if name == b"content-length":
            lengths = {length.strip() for length in value.split(b",")***REMOVED***
            if len(lengths) != 1:
