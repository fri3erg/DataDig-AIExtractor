...
class TestTimedeltaConstructorUnitKeyword:
    ...
    def test_units_H_T_S_L_N_U_deprecated(self, unit, unit_depr):
        # GH#52536
        msg = f"'{unit_depr***REMOVED***' is deprecated and will be removed in a future version."
    ...
    def test_unit_parser(self, unit, np_unit, wrapper):
        ...
        msg = f"'{unit***REMOVED***' is deprecated and will be removed in a future version."
        ...
        with tm.assert_produces_warning(warn, match=msg):
            ...
            str_repr = [f"{x***REMOVED***{unit***REMOVED***" for x in np.arange(5)]
            ...
            result = to_timedelta(f"2{unit***REMOVED***")
            assert result == expected
            result = Timedelta(f"2{unit***REMOVED***")
            assert result == expected
...
def test_td_construction_with_np_dtypes(npdtype, item):
    ...
    assert Timedelta(**{pykwarg: npdtype(1)***REMOVED***)._value == expected
...
def test_iso_constructor_raises(fmt):
    msg = f"Invalid ISO 8601 Duration format - {fmt***REMOVED***"
    with pytest.raises(ValueError, match=msg):
        Timedelta(fmt)
