...
#static# #rctype# #callbackname# (#optargs##args##strarglens##noargs#) {
    #name#_t cb_local = { NULL, NULL, 0 ***REMOVED***;
    #name#_t *cb = NULL;
...
#docstrsigns#""",
    'latexdocstr': """
{{***REMOVED***\\verb@def #argname#(#latexdocsignature#): return #docreturn#@{***REMOVED******REMOVED***
#routnote#
...
cb_rout_rules = [
    ...
    ***REMOVED***, {  # Function
        ...
        'frompyobj': [
            {debugcapi: '    CFUNCSMESS("cb:Getting return_value->");'***REMOVED***,
            '''\
    if (capi_j>capi_i) {
    ...
    ***REMOVED***''',
        ...
        'need': ['#ctype#_from_pyobj', {debugcapi: 'CFUNCSMESS'***REMOVED***, 'GETSCALARFROMPYTUPLE'],
        'return': '    return return_value;',
        '_check': l_and(isfunction, l_not(isstringfunction), l_not(iscomplexfunction))
    ***REMOVED***,
    {  # String function
        'pyobjfrom': {debugcapi: '    fprintf(stderr,"debug-capi:cb:#name#:%d:\\n",return_value_len);'***REMOVED***,
...
""",
    ...
    #ctype# return_value = {0, 0***REMOVED***;
#endif
""",
        'frompyobj': [
            {debugcapi: '    CFUNCSMESS("cb:Getting return_value->");'***REMOVED***,
    ...
    ***REMOVED***,
    {'docstrout': '        #pydocsignout#',
     'latexdocstrout': ['\\item[]{{***REMOVED***\\verb@#pydocsignout#@{***REMOVED******REMOVED***',
                        {hasnote: '--- #note#'***REMOVED***],
     'docreturn': '#rname#,',
     '_check': isfunction***REMOVED***,
    {'_check': issubroutine, 'return': 'return;'***REMOVED***
]
...
cb_arg_rules = [
    {  # Doc
        ...
        'docsign': {l_and(isrequired, isintent_nothide): '#varname#,'***REMOVED***,
        'docsignopt': {l_and(isoptional, isintent_nothide): '#varname#,'***REMOVED***,
        'depend': ''
    ***REMOVED***,
    {
        'args': {
        ...
        ***REMOVED***,
        'args_td': {
            ...
            isstring: '#ctype#'
        ***REMOVED***,
        'need': {l_or(isscalar, isarray, isstring): '#ctype#'***REMOVED***,
    ...
    ***REMOVED***,
    {  # Scalars
        'decl': {l_not(isintent_c): '    #ctype# #varname_i#=(*#varname_i#_cb_capi);'***REMOVED***,
        'error': {l_and(isintent_c, isintent_out,
                        throw_error('intent(c,out) is forbidden for callback scalar arguments')):
                  ''***REMOVED***,
        'frompyobj': [{debugcapi: '    CFUNCSMESS("cb:Getting #varname#->");'***REMOVED***,
                      {isintent_out:
                      ...
                      {l_and(debugcapi, l_and(l_not(iscomplex), l_not( isintent_c))):
                          '    fprintf(stderr,"#showvalueformat#.\\n",*#varname_i#_cb_capi);'***REMOVED***,
                      {l_and(debugcapi, l_and(iscomplex, isintent_c)):
                          '    fprintf(stderr,"#showvalueformat#.\\n",(#varname_i#).r,(#varname_i#).i);'***REMOVED***,
                      {l_and(debugcapi, l_and(iscomplex, l_not( isintent_c))):
                          '    fprintf(stderr,"#showvalueformat#.\\n",(*#varname_i#_cb_capi).r,(*#varname_i#_cb_capi).i);'***REMOVED***,
                      ],
        'need': [{isintent_out: ['#ctype#_from_pyobj', 'GETSCALARFROMPYTUPLE']***REMOVED***,
                 {debugcapi: 'CFUNCSMESS'***REMOVED***],
        '_check': isscalar
    ***REMOVED***, {
        'pyobjfrom': [{isintent_in: """\
    if (cb->nofargs>capi_i)
        if (CAPI_ARGLIST_SETITEM(capi_i++,pyobj_from_#ctype#1(#varname_i#)))
            goto capi_fail;"""***REMOVED***,
                      {isintent_inout: """\
    if (cb->nofargs>capi_i)
        if (CAPI_ARGLIST_SETITEM(capi_i++,pyarr_from_p_#ctype#1(#varname_i#_cb_capi)))
            goto capi_fail;"""***REMOVED***],
        'need': [{isintent_in: 'pyobj_from_#ctype#1'***REMOVED***,
                 {isintent_inout: 'pyarr_from_p_#ctype#1'***REMOVED***,
                 {iscomplex: '#ctype#'***REMOVED***],
    ...
    ***REMOVED***, {  # String
        ...
        GETSTRFROMPYTUPLE(capi_return,capi_i++,#varname_i#,#varname_i#_cb_len);""",
                      {debugcapi:
                       '    fprintf(stderr,"#showvalueformat#\\":%d:.\\n",#varname_i#,#varname_i#_cb_len);'***REMOVED***,
                      ],
        'need': ['#ctype#', 'GETSTRFROMPYTUPLE',
                 {debugcapi: 'CFUNCSMESS'***REMOVED***, 'string.h'],
    ...
    if (cb->nofargs>capi_i)
        if (CAPI_ARGLIST_SETITEM(capi_i++,pyobj_from_#ctype#1size(#varname_i#,#varname_i#_cb_len)))
            goto capi_fail;"""***REMOVED***,
                      {isintent_inout: """\
    if (cb->nofargs>capi_i) {
        int #varname_i#_cb_dims[] = {#varname_i#_cb_len***REMOVED***;
    ...
    ***REMOVED***,
    # Array ...
    {
        'decl': '    npy_intp #varname_i#_Dims[#rank#] = {#rank*[-1]#***REMOVED***;',
        'setdims': '    #cbsetdims#;',
        '_check': isarray,
        '_depend': ''
    ***REMOVED***,
...
***REMOVED***"""],
    ...
    ***REMOVED***, {
        ...
        rv_cb_arr =  array_from_pyobj(#atype#,#varname_i#_Dims,#rank#,F2PY_INTENT_IN""",
                      {isintent_c: '|F2PY_INTENT_C'***REMOVED***,
                      """,capi_tmp);
        if (rv_cb_arr == NULL) {
    ...
    ***REMOVED***""",
        ...
        'need': ['MEMCOPY', {iscomplexarray: '#ctype#'***REMOVED***],
