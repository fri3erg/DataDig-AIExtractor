...
class TestUnicodeDammit(object):
    ...
    def test_unicode_input(self):
        markup = "I'm already Unicode! \N{SNOWMAN***REMOVED***"
    ...
    def test_smart_quotes_to(self, smart_quotes_to, expect_converted):
        ...
        assert converted == "<foo>{***REMOVED***</foo>".format(expect_converted)
        
    def test_detect_utf8(self):
        utf8 = b"Sacr\xc3\xa9 bleu! \xe2\x98\x83"
        dammit = UnicodeDammit(utf8)
        assert dammit.original_encoding.lower() == 'utf-8'
        assert dammit.unicode_markup == 'Sacr\xe9 bleu! \N{SNOWMAN***REMOVED***'
...
class TestEncodingDetector(object):
    ...
    def test_encoding_detector_replaces_junk_in_encoding_name_with_replacement_character(self):
        ...
        assert 'utf-\N{REPLACEMENT CHARACTER***REMOVED***' in encodings
...
<i>\310\322\321\220\312\321\355\344</i></html>"""
    ...
    def test_detwingle(self):
        ...
        utf8 = ("\N{SNOWMAN***REMOVED***" * 3).encode("utf8")

        # Here's a Windows-1252 document.
        windows_1252 = (
            "\N{LEFT DOUBLE QUOTATION MARK***REMOVED***Hi, I like Windows!"
            "\N{RIGHT DOUBLE QUOTATION MARK***REMOVED***").encode("windows_1252")
    ...
    def test_detwingle_ignores_multibyte_characters(self):
        ...
        for tricky_unicode_char in (
            "\N{LATIN SMALL LIGATURE OE***REMOVED***", # 2-byte char '\xc5\x93'
            "\N{LATIN SUBSCRIPT SMALL LETTER X***REMOVED***", # 3-byte char '\xe2\x82\x93'
...
class TestEntitySubstitution(object):
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            ("foo\u2200\N{SNOWMAN***REMOVED***\u00f5bar",
             "foo&forall;\N{SNOWMAN***REMOVED***&otilde;bar"),
