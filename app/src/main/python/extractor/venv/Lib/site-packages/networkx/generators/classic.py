...
def barbell_graph(m1, m2, create_using=None):
    ...
    Two identical complete graphs $K_{m1***REMOVED***$ form the left and right bells,
    and are connected by a path $P_{m2***REMOVED***$.
...
def complete_multipartite_graph(*subset_sizes):
    ...
    try:
        ...
        if any(size < 0 for size in subset_sizes):
            raise NetworkXError(f"Negative number of nodes not valid: {subset_sizes***REMOVED***")
