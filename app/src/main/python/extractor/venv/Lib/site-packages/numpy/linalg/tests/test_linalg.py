...
def get_real_dtype(dtype):
    return {single: single, double: double,
            csingle: single, cdouble: double***REMOVED***[dtype]


def get_complex_dtype(dtype):
    return {single: csingle, double: cdouble,
            csingle: csingle, cdouble: cdouble***REMOVED***[dtype]
...
class LinalgCase:
    ...
    def __repr__(self):
        return f'<LinalgCase: {self.name***REMOVED***>'
...
def apply_tag(tag, cases):
    ...
    for case in cases:
        case.tags = case.tags | {tag***REMOVED***
    return cases
...
def _make_generalized_cases():
    ...
    for case in CASES:
        ...
        new_case = LinalgCase(case.name + "_tile3", a, b,
                              tags=case.tags | {'generalized'***REMOVED***)
        ...
        for a, a_label in _stride_comb_iter(case.a):
            for b, b_label in _stride_comb_iter(case.b):
                new_case = LinalgCase(case.name + "_" + a_label + "_" + b_label, a, b,
                                      tags=case.tags | {'strided'***REMOVED***)
                new_cases.append(new_case)
    return new_cases
    ...
    def check_cases(self, require=set(), exclude=set()):
        ...
        for case in self.TEST_CASES:
            ...
            try:
                ...
                msg = f'In test case: {case!r***REMOVED***\n\n'
...
class LinalgSquareTestCase(LinalgTestCase):
    ...
    def test_sq_cases(self):
        self.check_cases(require={'square'***REMOVED***,
                         exclude={'generalized', 'size-0'***REMOVED***)

    def test_empty_sq_cases(self):
        self.check_cases(require={'square', 'size-0'***REMOVED***,
                         exclude={'generalized'***REMOVED***)


class LinalgNonsquareTestCase(LinalgTestCase):

    def test_nonsq_cases(self):
        self.check_cases(require={'nonsquare'***REMOVED***,
                         exclude={'generalized', 'size-0'***REMOVED***)

    def test_empty_nonsq_cases(self):
        self.check_cases(require={'nonsquare', 'size-0'***REMOVED***,
                         exclude={'generalized'***REMOVED***)
...
class HermitianTestCase(LinalgTestCase):
    ...
    def test_herm_cases(self):
        self.check_cases(require={'hermitian'***REMOVED***,
                         exclude={'generalized', 'size-0'***REMOVED***)

    def test_empty_herm_cases(self):
        self.check_cases(require={'hermitian', 'size-0'***REMOVED***,
                         exclude={'generalized'***REMOVED***)
...
class LinalgGeneralizedSquareTestCase(LinalgTestCase):
    ...
    def test_generalized_sq_cases(self):
        self.check_cases(require={'generalized', 'square'***REMOVED***,
                         exclude={'size-0'***REMOVED***)

    @pytest.mark.slow
    def test_generalized_empty_sq_cases(self):
        self.check_cases(require={'generalized', 'square', 'size-0'***REMOVED***)
...
class LinalgGeneralizedNonsquareTestCase(LinalgTestCase):
    ...
    def test_generalized_nonsq_cases(self):
        self.check_cases(require={'generalized', 'nonsquare'***REMOVED***,
                         exclude={'size-0'***REMOVED***)

    @pytest.mark.slow
    def test_generalized_empty_nonsq_cases(self):
        self.check_cases(require={'generalized', 'nonsquare', 'size-0'***REMOVED***)
...
class HermitianGeneralizedTestCase(LinalgTestCase):
    ...
    def test_generalized_herm_cases(self):
        self.check_cases(require={'generalized', 'hermitian'***REMOVED***,
                         exclude={'size-0'***REMOVED***)

    @pytest.mark.slow
    def test_generalized_empty_herm_cases(self):
        self.check_cases(require={'generalized', 'hermitian', 'size-0'***REMOVED***,
...
class TestCholesky:
    ...
    def test_basic_property(self, shape, dtype):
        ...
        assert_allclose(b, a, atol=atol, err_msg=f'{shape***REMOVED*** {dtype***REMOVED***\n{a***REMOVED***\n{c***REMOVED***')
