...
***REMOVED***:
            ...
            logging.error(
                f"An error occurred while deleting the table " f"{self.table_name***REMOVED***: {e***REMOVED***"
***REMOVED***
            raise
        ...
        try:
            ...
            logging.error(
                f"An error occurred while getting the table " f"{self.table_name***REMOVED***: {e***REMOVED***"
***REMOVED***
            raise
...
***REMOVED*** from e
        ...
        if host is not None and port is not None:
            if "," in host:
                hosts = host.split(",")
                given_address = ",".join([f"{h***REMOVED***:{port***REMOVED***" for h in hosts])
            else:
        ...
        try:
            logger.info(f"create HippoClient[{given_address***REMOVED***]")
    ...
    def _create_collection(
        ...
        logger.debug(f"[_create_collection] dim: {dim***REMOVED***")
        fields = []
        ...
        fields.append(
            HippoField(
                ...
                type_params={"dimension": dim***REMOVED***,
***REMOVED***
        )
                ...
                if isinstance(value, list):
                    ...
                    fields.append(
                        HippoField(
                            ...
                            False,
                            HippoType.FLOAT_VECTOR,
                            type_params={"dimension": value_dim***REMOVED***,
            ***REMOVED***
        ***REMOVED***
                else:
                    fields.append(HippoField(key, False, HippoType.STRING))

        logger.debug(f"[_create_collection] fields: {fields***REMOVED***")
        ...
        logger.info(
            ...
            f"create table {self.table_name***REMOVED*** in {self.database_name***REMOVED*** successfully"
        )
    ...
    def _extract_fields(self) -> None:
        ...
        if isinstance(self.col, HippoTable):
            ...
            logger.debug(f"[_extract_fields] schema:{schema***REMOVED***")
            for x in schema:
                self.fields.append(x.name)
            logger.debug(f"04 [_extract_fields] fields:{self.fields***REMOVED***")
...
***REMOVED***.get(self.table_name, {***REMOVED***)
            ...
            if embedding_indexes is None:
                ...
                for x in self.hc.get_table_info(self.table_name, self.database_name)[
                    ...
                    logger.debug(f"[_get_index] embedding_indexes {embedding_indexes***REMOVED***")
    ...
    def add_texts(
        ...
        **kwargs: Any,
        ...
        logger.debug(f"[add_texts] texts: {texts***REMOVED***")
        ...
        logger.debug(f"[add_texts] len_embeddings:{len(embeddings)***REMOVED***")
        ...
        ***REMOVED***
        logger.debug(f"[add_texts] metadatas:{metadatas***REMOVED***")
        logger.debug(f"[add_texts] fields:{self.fields***REMOVED***")
        ...
        logger.debug(f"[add_texts] total_count:{total_count***REMOVED***")
        for i in range(0, total_count, batch_size):
            ...
            try:
                ...
                logger.info(f"05 [add_texts] insert {res***REMOVED***")
            except Exception as e:
                logger.error(
    ...
    ***REMOVED***
    ...
    def similarity_search_with_score_by_vector(
        ...
        **kwargs: Any,
        ...
        # Perform the search.
        logger.debug(f"search_field:{self._vector_field***REMOVED***")
        logger.debug(f"vectors:{[embedding]***REMOVED***")
        logger.debug(f"output_fields:{output_fields***REMOVED***")
        logger.debug(f"topk:{k***REMOVED***")
        logger.debug(f"dsl:{expr***REMOVED***")
        ...
        # Organize results.
        logger.debug(f"[similarity_search_with_score_by_vector] res:{res***REMOVED***")
        score_col = self._text_field + "%scores"
        ret = []
        count = 0
        for items in zip(*[res[0][field] for field in output_fields]):
            meta = {field: value for field, value in zip(output_fields, items)***REMOVED***
            doc = Document(page_content=meta.pop(self._text_field), metadata=meta)
            logger.debug(
                f"[similarity_search_with_score_by_vector] "
                f"res[0][score_col]:{res[0][score_col]***REMOVED***"
***REMOVED***
    ...
    def from_texts(
        ...
        **kwargs: Any,
        ...
        logger.debug(f"[from_texts] texts:{texts***REMOVED***")
        logger.debug(f"[from_texts] metadatas:{metadatas***REMOVED***")
