    ...
    ::
        ...
        response = {
            ...
            'Contents': [{
                ...
                'Owner': {'ID': 'abc123', 'DisplayName': 'myname'***REMOVED***,
                'Size': 14814
            ***REMOVED***],
            'EncodingType': 'url',
            'ResponseMetadata': {
        ...
        ***REMOVED***
        ...
        expected_params = {'Bucket': 'test-bucket'***REMOVED***
    ...
    ::
        ...
        ***REMOVED***
        ...
        with Stubber(s3) as stubber:
            stubber.add_response('list_buckets', response, {***REMOVED***)
    ...
    **Example:**
    ::
        ...
        ***REMOVED***
        ...
        expected_params = {'Bucket': ANY***REMOVED***
        stubber.add_response('list_objects', response, expected_params)
...
***REMOVED***
        ...
        http_response = AWSResponse(None, 200, {***REMOVED***, None)
    ...
    def add_client_error(
        ...
        """
        http_response = AWSResponse(None, http_status_code, {***REMOVED***, None)
        ...
        # look like.
        parsed_response = {
            'ResponseMetadata': {'HTTPStatusCode': http_status_code***REMOVED***,
            'Error': {'Message': service_message, 'Code': service_error_code***REMOVED***,
        ***REMOVED***
    ...
    def assert_no_pending_responses(self):
        ...
        if remaining != 0:
            raise AssertionError(f"{remaining***REMOVED*** responses remaining in queue.")
...
***REMOVED***
        ...
        if name != model.name:
            raise StubResponseError(
                operation_name=model.name,
                reason=f'Operation mismatch: found response for {name***REMOVED***.',
***REMOVED***
