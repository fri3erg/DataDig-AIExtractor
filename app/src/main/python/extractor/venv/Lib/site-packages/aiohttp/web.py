...
def run_app(
    ...
    *,
    ...
    try:
        ...
        _cancel_tasks({main_task***REMOVED***, loop)
...
def main(argv: List[str]) -> None:
    ...
    try:
        ...
        arg_parser.error(f"unable to import {mod_str***REMOVED***: {ex***REMOVED***")
    try:
        func = getattr(module, func_str)
    except AttributeError:
        arg_parser.error(f"module {mod_str!r***REMOVED*** has no attribute {func_str!r***REMOVED***")
