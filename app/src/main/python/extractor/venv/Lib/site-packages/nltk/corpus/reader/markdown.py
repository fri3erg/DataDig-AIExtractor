    ...
    def wrapper(*args, **kwargs):
        ...
        for arg in args:
            if isinstance(arg, str):
                _args.append({part.strip() for part in arg.split(",")***REMOVED***)
        ...
        for name, value in kwargs.items():
            if isinstance(value, str):
                kwargs[name] = {part.strip() for part in value.split(",")***REMOVED***
...
class MarkdownBlock:
    ...
    def __repr__(self):
        return f"{self.__class__.__name__***REMOVED***(content={repr(str(self))***REMOVED***)"

    def __str__(self):
        return (
            f"{self.content[:self.truncate_at]***REMOVED***"
            f"{'...' if len(self.content) > self.truncate_at else ''***REMOVED***"
        )
