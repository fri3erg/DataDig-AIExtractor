...
class DtypeWarning(Warning):
    ...
    ...                          ['1'] * 100000),
    ...                    'b': ['b'] * 300000***REMOVED***)  # doctest: +SKIP
    ...
    >>> df2 = pd.read_csv('test.csv', sep=',', dtype={'a': str***REMOVED***)  # doctest: +SKIP
...
class MergeError(ValueError):
    ...
    ...                     "b": ["cat", "dog", "weasel", "horse"]***REMOVED***,
    ...                     index=range(4))
    >>> right = pd.DataFrame({"a": ["a", "b", "c", "d"],
    ...                      "c": ["meow", "bark", "chirp", "nay"]***REMOVED***,
...
class AbstractMethodError(NotImplementedError):
    ...
    def __init__(self, class_instance, methodtype: str = "method") -> None:
        types = {"method", "classmethod", "staticmethod", "property"***REMOVED***
        if methodtype not in types:
            raise ValueError(
                f"methodtype must be one of {methodtype***REMOVED***, got {types***REMOVED*** instead."
***REMOVED***
    ...
    def __str__(self) -> str:
        ...
        return f"This {self.methodtype***REMOVED*** must be defined in the concrete class {name***REMOVED***"
...
class NumbaUtilError(Exception):
    ...
    Examples
    --------
    >>> df = pd.DataFrame({"key": ["a", "a", "b", "b"], "data": [1, 2, 3, 4]***REMOVED***,
    ...                   columns=["key", "data"])
...
class SpecificationError(Exception):
    ...
    ...                    'B': range(5),
    ...                    'C': range(5)***REMOVED***)
    >>> df.groupby('A').B.agg({'foo': 'count'***REMOVED***) # doctest: +SKIP
    ... # SpecificationError: nested renamer is not supported

    >>> df.groupby('A').agg({'B': {'foo': ['sum', 'max']***REMOVED******REMOVED***) # doctest: +SKIP
    ... # SpecificationError: nested renamer is not supported
...
class SettingWithCopyError(ValueError):
    ...
    >>> df = pd.DataFrame({'A': [1, 1, 1, 2, 2]***REMOVED***, columns=['A'])
...
_chained_assignment_method_msg = (
    ...
    "using 'df.method({col: value***REMOVED***, inplace=True)' instead, to perform "
...
_chained_assignment_warning_method_msg = (
    ...
    "For example, when doing 'df[col].method(value, inplace=True)', try "
    "using 'df.method({col: value***REMOVED***, inplace=True)' or "
...
class NumExprClobberingError(NameError):
    ...
    Examples
    --------
    >>> df = pd.DataFrame({'abs': [1, 1, 1]***REMOVED***)
...
class UndefinedVariableError(NameError):
    ...
    Examples
    --------
    >>> df = pd.DataFrame({'A': [1, 1, 1]***REMOVED***)
    ...
    def __init__(self, name: str, is_local: bool | None = None) -> None:
        base_msg = f"{repr(name)***REMOVED*** is not defined"
        if is_local:
            msg = f"local variable {base_msg***REMOVED***"
        else:
            msg = f"name {base_msg***REMOVED***"
        super().__init__(msg)
...
class PyperclipWindowsException(PyperclipException):
    ...
    def __init__(self, message: str) -> None:
        ...
        message += f" ({ctypes.WinError()***REMOVED***)"  # type: ignore[attr-defined]
...
class PossiblePrecisionLoss(Warning):
    ...
    Examples
    --------
    >>> df = pd.DataFrame({"s": pd.Series([1, 2**53], dtype=np.int64)***REMOVED***)
...
class ValueLabelTypeMismatch(Warning):
    ...
    Examples
    --------
    >>> df = pd.DataFrame({"categories": pd.Series(["a", 2], dtype="category")***REMOVED***)
    >>> df.to_stata('test') # doctest: +SKIP
...
class InvalidColumnName(Warning):
    ...
    Examples
    --------
    >>> df = pd.DataFrame({"0categories": pd.Series([2, 2])***REMOVED***)
    >>> df.to_stata('test') # doctest: +SKIP
