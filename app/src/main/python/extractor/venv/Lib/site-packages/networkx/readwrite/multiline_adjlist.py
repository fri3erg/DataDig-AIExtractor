...
def write_multiline_adjlist(G, path, delimiter=" ", comments="#", encoding="utf-8"):
    ...
    ***REMOVED***
    ...
    header = (
        f"{pargs***REMOVED***\n"
        + comments
        + f" GMT {time.asctime(time.gmtime())***REMOVED***\n"
        + comments
        + f" {G.name***REMOVED***\n"
    )
...
def parse_multiline_adjlist(
    ...
    >>> lines = [
    ...     "1 2",
    ...     "2 {'weight':3, 'name': 'Frodo'***REMOVED***",
    ...     "3 {***REMOVED***",
    ...     "2 1",
    ...     "5 {'weight':6, 'name': 'Saruman'***REMOVED***",
    ... ]
    ...
    for line in lines:
        ...
        try:
            ...
            raise TypeError(f"Failed to read node and degree on line ({line***REMOVED***)") from err
        if nodetype is not None:
            try:
                u = nodetype(u)
            except BaseException as err:
                raise TypeError(
                    f"Failed to convert node ({u***REMOVED***) to " f"type {nodetype***REMOVED***"
    ***REMOVED*** from err
        G.add_node(u)
        for i in range(deg):
            while True:
                try:
                    ...
                    msg = f"Failed to find neighbor for node ({u***REMOVED***)"
            ...
            if nodetype is not None:
                try:
                    ...
                    raise TypeError(
                        f"Failed to convert node ({v***REMOVED***) " f"to type {nodetype***REMOVED***"
        ***REMOVED*** from err
            if edgetype is not None:
                try:
                    edgedata = {"weight": edgetype(data)***REMOVED***
                except BaseException as err:
                    raise TypeError(
                        f"Failed to convert edge data ({data***REMOVED***) " f"to type {edgetype***REMOVED***"
        ***REMOVED*** from err
            else:
                try:  # try to evaluate
