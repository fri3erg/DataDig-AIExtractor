 ...
 * intrinsincs __try{***REMOVED***/__except{***REMOVED***. It is also utilized for C++ exceptions by
 ...
 * uses __try{***REMOVED*** or most C++ functions will push a new handler onto the front
...
typedef struct _GExceptionRegistration {
    ...
    void* handler_f;
***REMOVED*** GExceptionRegistration;
