...
***REMOVED***
            ...
            chain.invoke({"context": docs***REMOVED***)
    """  # noqa: E501
    ...
    return (
        RunnablePassthrough.assign(**{DOCUMENTS_KEY: format_docs***REMOVED***).with_config(
...
***REMOVED***
    ...
    ***REMOVED***
    ...
    def combine_docs(
        ...
        return self.llm_chain.predict(callbacks=callbacks, **inputs), {***REMOVED***
    ...
    async def acombine_docs(
        ...
        inputs = self._get_inputs(docs, **kwargs)
        # Call predict on the LLM.
        return await self.llm_chain.apredict(callbacks=callbacks, **inputs), {***REMOVED***
