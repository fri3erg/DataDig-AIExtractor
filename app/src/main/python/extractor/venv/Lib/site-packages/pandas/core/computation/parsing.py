...
def create_valid_python_identifier(name: str) -> str:
    ...
    special_characters_***REMOVED***
        char: f"_{token.tok_name[tokval]***REMOVED***_"
    ...
    ***REMOVED***
    ...
    name = f"BACKTICK_QUOTED_STRING_{name***REMOVED***"

    if not name.isidentifier():
        raise SyntaxError(f"Could not convert '{name***REMOVED***' to a valid Python identifier.")
...
def clean_column_name(name: Hashable) -> Hashable:
    ...
    """
    try:
        tokenized = tokenize_string(f"`{name***REMOVED***`")
...
def tokenize_string(source: str) -> Iterator[tuple[int, str]]:
    ...
    ***REMOVED***
                ...
                raise SyntaxError(f"Failed to parse backticks in '{source***REMOVED***'.") from err
        else:
            yield toknum, tokval
