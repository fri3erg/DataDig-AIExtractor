...
class Client:
    ...
    ***REMOVED***
    ...
    def __repr__(self):
        ...
        attribute_str = ', '.join('{***REMOVED***={***REMOVED***'.format(k, v) for k, v in attrs.items())
        return '<{***REMOVED*** {***REMOVED***>'.format(self.__class__.__name__, attribute_str)
    ...
    def get_oauth_signature(self, request):
        ...
        collected_params = signature.collect_parameters(
            ...
            body=body,
            headers=headers)
        log.debug("Collected params: {***REMOVED***".format(collected_params))

        normalized_params = signature.normalize_parameters(collected_params)
        normalized_uri = signature.base_string_uri(uri, headers.get('Host', None))
        log.debug("Normalized params: {***REMOVED***".format(normalized_params))
        log.debug("Normalized URI: {***REMOVED***".format(normalized_uri))

        base_string = signature.signature_base_string(request.http_method,
                                                      normalized_uri, normalized_params)

        log.debug("Signing: signature base string: {***REMOVED***".format(base_string))
        ...
        log.debug("Signature: {***REMOVED***".format(sig))
        return sig
    ...
    def sign(self, uri, http_method='GET', body=None, headers=None, realm=None):
        ...
        #       header field set to "application/x-www-form-urlencoded".
            ...
            raise ValueError(
                "Body contains parameters but Content-Type header was {***REMOVED*** "
                "instead of {***REMOVED***".format(content_type or "not set",
