...
***REMOVED***,
            ...
            fields={key: FormField._from_generated(key, value, read_result) for key, value in page.fields.items()***REMOVED***
            if page.fields
            else None,
...
def prepare_unlabeled_result(response, model_id):
    ...
    for index, page in enumerate(page_result):
        ...
        if unlabeled_fields:
            unlabeled_fields = {field.name: field for field in unlabeled_fields***REMOVED***
        form = RecognizedForm(
...
def prepare_labeled_result(response, model_id):
    ...
    for doc in response.analyze_result.document_results:
        ...
        form = RecognizedForm(
            ...
            fields={label: FormField._from_generated(label, value, read_result) for label, value in doc.fields.items()***REMOVED***,
