...
class Together(LLM):
    ...
    def _call(
        ...
        **kwargs: Any,
        ...
        headers = {
            "Authorization": f"Bearer {self.together_api_key.get_secret_value()***REMOVED***",
        ...
        ***REMOVED***
        ...
        if response.status_code >= 500:
            raise Exception(f"Together Server: Error {response.status_code***REMOVED***")
        elif response.status_code >= 400:
            raise ValueError(f"Together received an invalid payload: {response.text***REMOVED***")
...
***REMOVED*** as response:
                if response.status >= 500:
                    raise Exception(f"Together Server: Error {response.status***REMOVED***")
                elif response.status >= 400:
                    raise ValueError(
                        f"Together received an invalid payload: {response.text***REMOVED***"
        ***REMOVED***
