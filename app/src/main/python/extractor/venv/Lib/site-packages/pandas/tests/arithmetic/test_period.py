...
class TestPeriodIndexComparisons:
    ...
    def test_parr_cmp_pi_mismatched_freq(self, freq, box_with_array):
        ...
        msg = rf"Invalid comparison between dtype=period\[{freq***REMOVED***\] and Period"
    ...
    def test_pi_cmp_nat_mismatched_freq_raises(self, freq):
        ...
        msg = rf"Invalid comparison between dtype=period\[{freq***REMOVED***\] and PeriodArray"
        with pytest.raises(TypeError, match=msg):
            idx1 > diff
...
class TestPeriodIndexArithmetic:
    ...
    def test_sub_n_gt_1_offsets(self, offset, kwd_name, n):
        # GH 23878
        kwds = {kwd_name: 3***REMOVED*** if kwd_name is not None else {***REMOVED***
        p1_d = "19910905"
        p2_d = "19920406"
