...
class AuthorizationEndpoint(BaseEndpoint):
    ...
    def create_authorization_response(self, uri, http_method='GET', body=None,
        ...
        An example of an authorization request::
            ...
            ...     ***REMOVED***)
            >>> h
            {'Location': 'https://the.client/callback?oauth_verifier=...&extra=argument'***REMOVED***
            >>> b
            None
            >>> s
            302
        ...
        verifier = self.create_verifier(request, credentials or {***REMOVED***)
        ...
        if redirect_uri == 'oob':
            ...
            return {'Location': populated_redirect***REMOVED***, None, 302
    ...
    def get_realms_and_credentials(self, uri, http_method='GET', body=None,
        ...
        realms = self.request_validator.get_realms(
            request.resource_owner_key, request)
        return realms, {'resource_owner_key': request.resource_owner_key***REMOVED***
