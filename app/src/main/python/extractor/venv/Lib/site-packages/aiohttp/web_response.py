...
class StreamResponse(BaseClass, HeadersMixin):
    ...
    def __init__(
        ...
        *,
        ...
        self._body_length = 0
        self._state: Dict[str, Any] = {***REMOVED***
...
***REMOVED***
    ...
    def etag(self, value: Optional[Union[ETag, str]]) -> None:
        if value is None:
            ...
            self._headers[hdrs.ETAG] = f'"{value***REMOVED***"'
        elif isinstance(value, ETag) and isinstance(value.value, str):
            validate_etag_value(value.value)
            hdr_value = f'W/"{value.value***REMOVED***"' if value.is_weak else f'"{value.value***REMOVED***"'
            self._headers[hdrs.ETAG] = hdr_value
        else:
            raise ValueError(
                f"Unsupported etag type: {type(value)***REMOVED***. "
...
***REMOVED***
    ...
    def _generate_content_type_header(
        ...
        params = "; ".join(f"{k***REMOVED***={v***REMOVED***" for k, v in self._content_dict.items())
        if params:
        ...
        if self._chunked:
            if version != HttpVersion11:
                raise RuntimeError(
                    ...
                    "for HTTP/{0.major***REMOVED***.{0.minor***REMOVED***".format(request.version)
    ***REMOVED***
...
***REMOVED***:
    ...
    async def _write_headers(self) -> None:
        ...
        # status line
        version = request.version
        status_line = "HTTP/{***REMOVED***.{***REMOVED*** {***REMOVED*** {***REMOVED***".format(
    ...
    def __repr__(self) -> str:
        if self._eof_sent:
            ...
            info = f"{self._req.method***REMOVED*** {self._req.path***REMOVED*** "
        else:
            info = "not prepared"
        return f"<{self.__class__.__name__***REMOVED*** {self.reason***REMOVED*** {info***REMOVED***>"
...
class Response(StreamResponse):
    ...
    async def write_eof(self, data: bytes = b"") -> None:
        ...
        assert not data, f"data arg is not supported, got {data!r***REMOVED***"
        assert self._req is not None
        assert self._payload_writer is not None
        if body is not None:
            if self._must_be_empty_body:
...
***REMOVED***
            ...
            if self._zlib_executor_size is None and len(self._body) > 1024 * 1024:
                warnings.warn(
                    ...
                    f"({len(self._body)***REMOVED*** bytes) might block the async event loop. "
