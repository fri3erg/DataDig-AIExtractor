...
class AzureCognitiveSearchRetriever(BaseRetriever):
    ...
    def _build_search_url(self, query: str) -> str:
        ...
        base_url = f"https://{self.service_name***REMOVED***.{url_suffix***REMOVED***/"
        endpoint_path = f"indexes/{self.index_name***REMOVED***/docs?api-version={self.api_version***REMOVED***"
        top_param = f"&$top={self.top_k***REMOVED***" if self.top_k else ""
        return base_url + endpoint_path + f"&search={query***REMOVED***" + top_param
    ...
    def _search(self, query: str) -> List[dict]:
        ...
        if response.status_code != 200:
            raise Exception(f"Error in search request: {response***REMOVED***")
