...
sys.path.insert(0, {joblib_root_folder!r***REMOVED***)
...
***REMOVED***
    ...
    callable_position = "{callable_position***REMOVED***"
...
# Here, we do not need the `***REMOVED***` safeguard when
...
def test_globals_update_at_each_parallel_call():
    ...
    assert set(workers_global_variable) == {"original value"***REMOVED***
    ...
    workers_global_variable = Parallel(n_jobs=2)(
        delayed(check_globals)() for i in range(2))
    assert set(workers_global_variable) == {"changed value"***REMOVED***
...
def check_child_num_threads(workers_info, parent_info, num_threads):
    ...
    for child_threadpool_info in workers_info:
        for child_module in child_threadpool_info:
            ...
            expected = {min(num_threads, parent_max_num_threads), num_threads***REMOVED***
