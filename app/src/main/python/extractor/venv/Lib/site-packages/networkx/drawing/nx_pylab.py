...
def draw_networkx(G, pos=None, arrows=None, with_labels=True, **kwds):
    ...
    ***REMOVED***
    ...
    if any(k not in valid_kwds for k in kwds):
        ...
        raise ValueError(f"Received invalid argument(s): {invalid_args***REMOVED***")

    node_kwds = {k: v for k, v in kwds.items() if k in valid_node_kwds***REMOVED***
    edge_kwds = {k: v for k, v in kwds.items() if k in valid_edge_kwds***REMOVED***
    label_kwds = {k: v for k, v in kwds.items() if k in valid_label_kwds***REMOVED***
...
def draw_networkx_nodes(
    ...
    try:
        ...
        raise nx.NetworkXError(f"Node {err***REMOVED*** has no position.") from err
...
def draw_networkx_edges(
    ...
    if use_linecollection and any(
        ...
        msg = (
            "\n\nThe {0***REMOVED*** keyword argument is not applicable when drawing edges\n"
            "with LineCollection.\n\n"
            "To make this warning go away, either specify `arrows=True` to\n"
            "force FancyArrowPatches or use the default value for {0***REMOVED***.\n"
...
***REMOVED***:
            ...
            arrow = mpl.patches.FancyArrowPatch(
                ...
                linestyle=linestyle,
                zorder=1,
***REMOVED***  # arrows go behind nodes
...
def draw_networkx_labels(
    ...
    labels : dictionary (default={n: n for n in G***REMOVED***)
        Node labels in a dictionary of text labels keyed by node.
        Node-keys in labels should appear as keys in `pos`.
        If needed use: `{n:lab for n,lab in labels.items() if n in pos***REMOVED***`
    ...
    horizontalalignment : string (default='center')
        Horizontal alignment {'center', 'right', 'left'***REMOVED***

    verticalalignment : string (default='center')
        Vertical alignment {'center', 'top', 'bottom', 'baseline', 'center_baseline'***REMOVED***
    ...
    if labels is None:
        labels = {n: n for n in G.nodes()***REMOVED***

    text_items = {***REMOVED***  # there is no text collection so we'll fake one
...
def draw_networkx_edge_labels(
    ...
    bbox : Matplotlib bbox, optional
        ...
        Default is {boxstyle='round', ec=(1.0, 1.0, 1.0), fc=(1.0, 1.0, 1.0)***REMOVED***.
    ...
    if edge_labels is None:
        labels = {(u, v): d for u, v, d in G.edges(data=True)***REMOVED***
    else:
        labels = edge_labels
...
***REMOVED***[0]
        ...
        if bbox is None:
            bbox = {"boxstyle": "round", "ec": (1.0, 1.0, 1.0), "fc": (1.0, 1.0, 1.0)***REMOVED***
        if not isinstance(label, str):
            label = str(label)  # this makes "1" and 1 labeled the same
