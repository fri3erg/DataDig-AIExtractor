...
class NLATool(Tool):
    ...
    def from_open_api_endpoint_chain(
        ...
        expanded_name = (
            f'{api_title.replace(" ", "_")***REMOVED***.{chain.api_operation.operation_id***REMOVED***'
        )
        description = (
            f"I'm an AI from {api_title***REMOVED***. Instruct what you want,"
            " and I'll assist via an API with description:"
            f" {chain.api_operation.description***REMOVED***"
        )
