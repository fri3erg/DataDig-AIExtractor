...
def clean_fill_method(
    ...
    *,
    ...
    if method not in valid_methods:
        raise ValueError(f"Invalid fill method. Expecting {expecting***REMOVED***. Got {method***REMOVED***")
    return method
...
def clean_interp_method(method: str, index: Index, **kwargs) -> str:
    ...
    if method not in valid:
        raise ValueError(f"method must be one of {valid***REMOVED***. Got '{method***REMOVED***' instead.")

    if method in ("krogh", "piecewise_polynomial", "pchip"):
        if not index.is_monotonic_increasing:
            raise ValueError(
                f"{method***REMOVED*** interpolation requires that the index be monotonic."
***REMOVED***
...
def validate_limit_direction(
    ...
    if limit_direction not in valid_limit_directions:
        raise ValueError(
            ...
            f"{valid_limit_directions***REMOVED***, got '{limit_direction***REMOVED***'."
        )
...
def validate_limit_area(limit_area: str | None) -> Literal["inside", "outside"] | None:
    if limit_area is not None:
        ...
        if limit_area not in valid_limit_areas:
            raise ValueError(
                f"Invalid limit_area: expecting one of {valid_limit_areas***REMOVED***, got "
                f"{limit_area***REMOVED***."
***REMOVED***
...
def infer_limit_direction(
    ...
    if limit_direction is None:
        ...
        if method in ("pad", "ffill") and limit_direction != "forward":
            raise ValueError(
                f"`limit_direction` must be 'forward' for method `{method***REMOVED***`"
***REMOVED***
        if method in ("backfill", "bfill") and limit_direction != "backward":
            raise ValueError(
                f"`limit_direction` must be 'backward' for method `{method***REMOVED***`"
***REMOVED***
...
def get_interp_index(method, index: Index) -> Index:
    ...
    if method == "linear":
        ...
        methods = {"index", "values", "nearest", "time"***REMOVED***
        ...
        if method not in methods and not is_numeric_or_datetime:
            raise ValueError(
                ...
                f"using {method***REMOVED*** method other than linear. "
...
def _interpolate_scipy_wrapper(
    ...
    **kwargs,
    ...
    """
    extra = f"{method***REMOVED*** interpolation requires SciPy."
    ...
    ***REMOVED***
    ...
    if method in interp1d_methods:
        ...
        if isna(order) or (order <= 0):
            raise ValueError(
                f"order needs to be specified and greater than 0; got order: {order***REMOVED***"
***REMOVED***
...
def _cubicspline_interpolate(
    ...
    extrapolate : {bool, 'periodic', None***REMOVED***, optional
...
def _interpolate_with_limit_area(
    ...
    limit_area: {'inside', 'outside'***REMOVED***
...
def _fill_limit_area_1d(
    ...
    limit_area : { "outside", "inside" ***REMOVED***
...
_fill_methods = {"pad": _pad_1d, "backfill": _backfill_1d***REMOVED***
...
def get_fill_func(method, ndim: int = 1):
    ...
    return {"pad": _pad_2d, "backfill": _backfill_2d***REMOVED***[method]
