...
class ContentFormatterBase:
    ...
    ***REMOVED*** -> bytes:
                    input_str = json.dumps(
                        {
                            "inputs": {"input_string": [prompt]***REMOVED***, 
...
class GPT2ContentFormatter(ContentFormatterBase):
    ...
    def format_request_payload(self, prompt: str, model_kwargs: Dict) -> bytes:
        ...
        request_payload = json.dumps(
            {"inputs": {"input_string": [f'"{prompt***REMOVED***"']***REMOVED***, "parameters": model_kwargs***REMOVED***
        )
...
class HFContentFormatter(ContentFormatterBase):
    ...
    def format_request_payload(self, prompt: str, model_kwargs: Dict) -> bytes:
        ...
        request_payload = json.dumps(
            {"inputs": [f'"{prompt***REMOVED***"'], "parameters": model_kwargs***REMOVED***
        )
        return str.encode(request_payload)
...
class DollyContentFormatter(ContentFormatterBase):
    ...
    def format_request_payload(self, prompt: str, model_kwargs: Dict) -> bytes:
        ...
        request_payload = json.dumps(
            {
                "input_data": {"input_string": [f'"{prompt***REMOVED***"']***REMOVED***,
                "parameters": model_kwargs,
            ***REMOVED***
        )
        return str.encode(request_payload)
