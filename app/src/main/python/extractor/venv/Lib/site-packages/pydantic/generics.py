...
# `Model[int, str]`: {A: int, B: str***REMOVED***` will be stored in `_assigned_parameters`.
...
class GenericModel(BaseModel):
    ...
    def __class_getitem__(cls: Type[GenericModelT], params: Union[Type[Any], Tuple[Type[Any], ...]]) -> Type[Any]:
        ...
        if not hasattr(cls, '__parameters__'):
            raise TypeError(f'Type {cls.__name__***REMOVED*** must inherit from typing.Generic before being parameterized')
        ...
        instance_type_hints = {k: v for k, v in type_hints if get_origin(v) is not ClassVar***REMOVED***

        fields = {k: (DeferredType(), cls.__fields__[k].field_info) for k in instance_type_hints if k in cls.__fields__***REMOVED***
...
***REMOVED***,
        ...
        # parameters.
        new_params = tuple(
            {param: None for param in iter_contained_typevars(typevars_map.values())***REMOVED***
    ...
    def __concrete_name__(cls: Type[Any], params: Tuple[Type[Any], ...]) -> str:
        ...
        return f'{cls.__name__***REMOVED***[{params_component***REMOVED***]'
    ...
    def __parameterized_bases__(cls, typevars_map: Parametrization) -> Iterator[Type[Any]]:
        ...
        :param typevars_map: Dictionary of type applications for binding subclasses.
            ...
            the value `{S: str, T: int***REMOVED***` would be passed to `typevars_map`.
        ...
        assert A[int] in B.__parameterized_bases__({V: int***REMOVED***)
        ```
        """
...
def replace_types(type_: Any, type_map: Mapping[Any, Any]) -> Any:
    ...
    >>> replace_types(Tuple[str, Union[List[str], float]], {str: int***REMOVED***)
...
def check_parameters_count(cls: Type[GenericModel], parameters: Tuple[Any, ...]) -> None:
    ...
    if actual != expected:
        ...
        raise TypeError(f'Too {description***REMOVED*** parameters for {cls.__name__***REMOVED***; actual {actual***REMOVED***, expected {expected***REMOVED***')


DictValues: Type[Any] = {***REMOVED***.values().__class__
