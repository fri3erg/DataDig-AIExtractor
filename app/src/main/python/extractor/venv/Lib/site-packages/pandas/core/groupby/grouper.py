...
class Grouper:
    ...
    closed : {'left' or 'right'***REMOVED***
        Closed end of interval. Only when `freq` parameter is passed.
    label : {'left' or 'right'***REMOVED***
        ...
        if self.key is not None:
            ...
            if getattr(gpr_index, "name", None) == key and isinstance(obj, Series):
                ...
                if key not in obj._info_axis:
                    raise KeyError(f"The grouper name {key***REMOVED*** is not found")
...
***REMOVED***
    ...
    def ax(self) -> Index:
        warnings.warn(
            f"{type(self).__name__***REMOVED***.ax is deprecated and will be removed in a "
    ...
    def indexer(self):
        warnings.warn(
            f"{type(self).__name__***REMOVED***.indexer is deprecated and will be removed "
    ...
    def obj(self):
        ...
        #  GH#25564, GH#41930
        warnings.warn(
            f"{type(self).__name__***REMOVED***.obj is deprecated and will be removed "
    ...
    def grouper(self):
        warnings.warn(
            f"{type(self).__name__***REMOVED***.grouper is deprecated and will be removed "
    ...
    def groups(self):
        warnings.warn(
            f"{type(self).__name__***REMOVED***.groups is deprecated and will be removed "
    ...
    def __repr__(self) -> str:
        attrs_list = (
            f"{attr_name***REMOVED***={repr(getattr(self, attr_name))***REMOVED***"
            for attr_name in self._attributes
            if getattr(self, attr_name) is not None
        )
        attrs = ", ".join(attrs_list)
        cls_name = type(self).__name__
        return f"{cls_name***REMOVED***({attrs***REMOVED***)"
...
class Grouping:
    ...
    -------
    indices : dict
        Mapping of {group -> index_list***REMOVED***
    codes : ndarray
        Group codes
    group_index : Index or None
        unique groups
    groups : dict
        Mapping of {group -> label_list***REMOVED***
    """
    ...
    def __init__(
        ...
        # as single grouper groupby, use the group_info to get codes
            ...
            if getattr(grouping_vector, "ndim", 1) != 1:
                ...
                raise ValueError(f"Grouper for '{t***REMOVED***' not 1-dimensional")
...
***REMOVED***
    ...
    def __repr__(self) -> str:
        return f"Grouping({self.name***REMOVED***)"
    ...
    def _ilevel(self) -> int | None:
        ...
        if not isinstance(level, int):
            ...
            if level not in index.names:
                raise AssertionError(f"Level {level***REMOVED*** not in index")
...
def get_grouper(
        ...
        if isinstance(group_axis, MultiIndex):
            ...
            if isinstance(level, str):
                if obj._get_axis(axis).name != level:
                    raise ValueError(
                        f"level name {level***REMOVED*** is not the name "
                        f"of the {obj._get_axis_name(axis)***REMOVED***"
        ***REMOVED***
    ...
    if isinstance(key, Grouper):
        ...
        if key.key is None:
            ...
            return grouper, frozenset({key.key***REMOVED***), obj
        ...
        if is_in_obj(gpr):  # df.groupby(df['name'])
            ...
            if obj.ndim != 1 and gpr in obj:
                ...
                if gpr.ndim != 1:
                    ...
                    # exception message
                    raise ValueError(f"Grouper for '{name***REMOVED***' not 1-dimensional")
                exclusions.add(name)
