...
class TestCtor:
    ...
    def test_bmat_nondefault_str(self):
        ...
        assert_(np.all(bmat("A,A;A,A", ldict={'A':B***REMOVED***) == Aresult))
        assert_raises(TypeError, bmat, "A,A;A,A", gdict={'A':B***REMOVED***)
        assert_(
            np.all(bmat("A,A;A,A", ldict={'A':A***REMOVED***, gdict={'A':B***REMOVED***) == Aresult))
        b2 = bmat("A,B;C,D", ldict={'A':A,'B':B***REMOVED***, gdict={'C':B,'D':A***REMOVED***)
