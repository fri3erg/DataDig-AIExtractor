...
class AnalyzeResult(msrest.serialization.Model):
    ...
    _validation = {
        'version': {'required': True***REMOVED***,
        'read_results': {'required': True***REMOVED***,
    ***REMOVED***

    _attribute_map = {
        'version': {'key': 'version', 'type': 'str'***REMOVED***,
        'read_results': {'key': 'readResults', 'type': '[ReadResult]'***REMOVED***,
        'page_results': {'key': 'pageResults', 'type': '[PageResult]'***REMOVED***,
        'document_results': {'key': 'documentResults', 'type': '[DocumentResult]'***REMOVED***,
        'errors': {'key': 'errors', 'type': '[ErrorInformation]'***REMOVED***,
    ***REMOVED***
...
class Appearance(msrest.serialization.Model):
    ...
    _validation = {
        'style': {'required': True***REMOVED***,
    ***REMOVED***

    _attribute_map = {
        'style': {'key': 'style', 'type': 'Style'***REMOVED***,
    ***REMOVED***
...
class Attributes(msrest.serialization.Model):
    ...
    _attribute_map = {
        'is_composed': {'key': 'isComposed', 'type': 'bool'***REMOVED***,
    ***REMOVED***
...
class ComposeRequest(msrest.serialization.Model):
    ...
    _validation = {
        'model_ids': {'required': True***REMOVED***,
    ***REMOVED***

    _attribute_map = {
        'model_ids': {'key': 'modelIds', 'type': '[str]'***REMOVED***,
        'model_name': {'key': 'modelName', 'type': 'str'***REMOVED***,
    ***REMOVED***
...
class CopyAuthorizationResult(msrest.serialization.Model):
    ...
    _validation = {
        'model_id': {'required': True***REMOVED***,
        'access_token': {'required': True***REMOVED***,
        'expiration_date_time_ticks': {'required': True***REMOVED***,
    ***REMOVED***

    _attribute_map = {
        'model_id': {'key': 'modelId', 'type': 'str'***REMOVED***,
        'access_token': {'key': 'accessToken', 'type': 'str'***REMOVED***,
        'expiration_date_time_ticks': {'key': 'expirationDateTimeTicks', 'type': 'long'***REMOVED***,
    ***REMOVED***
...
class CopyOperationResult(msrest.serialization.Model):
    ...
    ***REMOVED***
    ...
    _attribute_map = {
        ...
        'created_date_time': {'key': 'createdDateTime', 'type': 'iso-8601'***REMOVED***,
        'last_updated_date_time': {'key': 'lastUpdatedDateTime', 'type': 'iso-8601'***REMOVED***,
        'copy_result': {'key': 'copyResult', 'type': 'CopyResult'***REMOVED***,
    ***REMOVED***
...
class CopyRequest(msrest.serialization.Model):
    ...
    _validation = {
        'target_resource_id': {'required': True, 'max_length': 1024, 'min_length': 0, 'pattern': r'^/subscriptions/[^/]*/resourceGroups/[^/]*/providers/Microsoft.CognitiveServices/accounts/[^/]*$'***REMOVED***,
        'target_resource_region': {'required': True, 'max_length': 24, 'min_length': 1, 'pattern': r'^[a-z0-9]+$'***REMOVED***,
        'copy_authorization': {'required': True***REMOVED***,
    ***REMOVED***

    _attribute_map = {
        'target_resource_id': {'key': 'targetResourceId', 'type': 'str'***REMOVED***,
        'target_resource_region': {'key': 'targetResourceRegion', 'type': 'str'***REMOVED***,
        'copy_authorization': {'key': 'copyAuthorization', 'type': 'CopyAuthorizationResult'***REMOVED***,
    ***REMOVED***
...
class DataTable(msrest.serialization.Model):
    ...
    _validation = {
        'rows': {'required': True, 'minimum': 1***REMOVED***,
        'columns': {'required': True, 'minimum': 1***REMOVED***,
        'cells': {'required': True***REMOVED***,
        'bounding_box': {'required': True, 'max_items': 8, 'min_items': 8***REMOVED***,
    ***REMOVED***

    _attribute_map = {
        'rows': {'key': 'rows', 'type': 'int'***REMOVED***,
        'columns': {'key': 'columns', 'type': 'int'***REMOVED***,
        'cells': {'key': 'cells', 'type': '[DataTableCell]'***REMOVED***,
        'bounding_box': {'key': 'boundingBox', 'type': '[float]'***REMOVED***,
    ***REMOVED***
...
class DataTableCell(msrest.serialization.Model):
    ...
    _validation = {
        'row_index': {'required': True, 'minimum': 0***REMOVED***,
        'column_index': {'required': True, 'minimum': 0***REMOVED***,
        'row_span': {'minimum': 1***REMOVED***,
        'column_span': {'minimum': 1***REMOVED***,
        'text': {'required': True***REMOVED***,
        'bounding_box': {'required': True, 'max_items': 8, 'min_items': 8***REMOVED***,
    ...
    ***REMOVED***
    ...
    _attribute_map = {
        ...
        'text': {'key': 'text', 'type': 'str'***REMOVED***,
        'bounding_box': {'key': 'boundingBox', 'type': '[float]'***REMOVED***,
        'confidence': {'key': 'confidence', 'type': 'float'***REMOVED***,
        'elements': {'key': 'elements', 'type': '[str]'***REMOVED***,
        'is_header': {'key': 'isHeader', 'type': 'bool'***REMOVED***,
        'is_footer': {'key': 'isFooter', 'type': 'bool'***REMOVED***,
    ***REMOVED***
...
class DocumentResult(msrest.serialization.Model):
    ...
    _validation = {
        'doc_type': {'required': True***REMOVED***,
        'page_range': {'required': True, 'max_items': 2, 'min_items': 2***REMOVED***,
        'doc_type_confidence': {'maximum': 1, 'minimum': 0***REMOVED***,
        'fields': {'required': True***REMOVED***,
    ***REMOVED***

    _attribute_map = {
        'doc_type': {'key': 'docType', 'type': 'str'***REMOVED***,
        'model_id': {'key': 'modelId', 'type': 'str'***REMOVED***,
        'page_range': {'key': 'pageRange', 'type': '[int]'***REMOVED***,
        'doc_type_confidence': {'key': 'docTypeConfidence', 'type': 'float'***REMOVED***,
        'fields': {'key': 'fields', 'type': '{FieldValue***REMOVED***'***REMOVED***,
    ***REMOVED***
...
class ErrorResponse(msrest.serialization.Model):
    ...
    ***REMOVED***
    ...
    _attribute_map = {
        'error': {'key': 'error', 'type': 'ErrorInformation'***REMOVED***,
    ***REMOVED***
...
class FieldValue(msrest.serialization.Model):
    ...
    _validation = {
        ...
        'bounding_box': {'max_items': 8, 'min_items': 8***REMOVED***,
        'confidence': {'maximum': 1, 'minimum': 0***REMOVED***,
        'page': {'minimum': 1***REMOVED***,
    ***REMOVED***
    ...
    _attribute_map = {
        ...
        'value_integer': {'key': 'valueInteger', 'type': 'int'***REMOVED***,
        'value_array': {'key': 'valueArray', 'type': '[FieldValue]'***REMOVED***,
        'value_object': {'key': 'valueObject', 'type': '{FieldValue***REMOVED***'***REMOVED***,
        ...
        'confidence': {'key': 'confidence', 'type': 'float'***REMOVED***,
        'elements': {'key': 'elements', 'type': '[str]'***REMOVED***,
        'page': {'key': 'page', 'type': 'int'***REMOVED***,
    ***REMOVED***
    ...
    def __init__(
        ...
        *,
        ...
        value_selection_mark: Optional[Union[str, "_models.FieldValueSelectionMark"]] = None,
...
class FormFieldsReport(msrest.serialization.Model):
    ...
    _validation = {
        'field_name': {'required': True***REMOVED***,
        'accuracy': {'required': True***REMOVED***,
    ***REMOVED***

    _attribute_map = {
        'field_name': {'key': 'fieldName', 'type': 'str'***REMOVED***,
        'accuracy': {'key': 'accuracy', 'type': 'float'***REMOVED***,
    ***REMOVED***
...
class KeysResult(msrest.serialization.Model):
    ...
    _validation = {
        'clusters': {'required': True***REMOVED***,
    ***REMOVED***

    _attribute_map = {
        'clusters': {'key': 'clusters', 'type': '{[str]***REMOVED***'***REMOVED***,
    ***REMOVED***
...
class KeyValueElement(msrest.serialization.Model):
    ...
    ***REMOVED***
    ...
    def __init__(
        ...
        *,
        text: str,
        type: Optional[Union[str, "_models.KeyValueType"]] = None,
        bounding_box: Optional[List[float]] = None,
        elements: Optional[List[str]] = None,
        **kwargs
    ):
...
class KeyValuePair(msrest.serialization.Model):
    ...
    ***REMOVED***
    ...
    _attribute_map = {
        'label': {'key': 'label', 'type': 'str'***REMOVED***,
        'key': {'key': 'key', 'type': 'KeyValueElement'***REMOVED***,
        'value': {'key': 'value', 'type': 'KeyValueElement'***REMOVED***,
        'confidence': {'key': 'confidence', 'type': 'float'***REMOVED***,
    ***REMOVED***
...
class Model(msrest.serialization.Model):
    ...
    _validation = {
        'model_info': {'required': True***REMOVED***,
    ***REMOVED***

    _attribute_map = {
        'model_info': {'key': 'modelInfo', 'type': 'ModelInfo'***REMOVED***,
        'keys': {'key': 'keys', 'type': 'KeysResult'***REMOVED***,
        'train_result': {'key': 'trainResult', 'type': 'TrainResult'***REMOVED***,
        'composed_train_results': {'key': 'composedTrainResults', 'type': '[TrainResult]'***REMOVED***,
    ***REMOVED***
    ...
    def __init__(
        ...
        *,
        ...
        composed_train_results: Optional[List["_models.TrainResult"]] = None,
        **kwargs
    ):
        """
...
class ModelInfo(msrest.serialization.Model):
    ...
    ***REMOVED***
    ...
    _attribute_map = {
        ...
        'last_updated_date_time': {'key': 'lastUpdatedDateTime', 'type': 'iso-8601'***REMOVED***,
        'model_name': {'key': 'modelName', 'type': 'str'***REMOVED***,
        'attributes': {'key': 'attributes', 'type': 'Attributes'***REMOVED***,
    ***REMOVED***
    ...
    def __init__(
        ...
        *,
        ...
        last_updated_date_time: datetime.datetime,
        model_name: Optional[str] = None,
        attributes: Optional["_models.Attributes"] = None,
        **kwargs
    ):
        """
        :keyword model_id: Required. Model identifier.
...
class Models(msrest.serialization.Model):
    ...
    _attribute_map = {
        'summary': {'key': 'summary', 'type': 'ModelsSummary'***REMOVED***,
        'model_list': {'key': 'modelList', 'type': '[ModelInfo]'***REMOVED***,
...
class PageResult(msrest.serialization.Model):
    ...
    _validation = {
        'page': {'required': True, 'minimum': 1***REMOVED***,
        'cluster_id': {'minimum': 0***REMOVED***,
    ***REMOVED***

    _attribute_map = {
        'page': {'key': 'page', 'type': 'int'***REMOVED***,
        'cluster_id': {'key': 'clusterId', 'type': 'int'***REMOVED***,
        'key_value_pairs': {'key': 'keyValuePairs', 'type': '[KeyValuePair]'***REMOVED***,
        'tables': {'key': 'tables', 'type': '[DataTable]'***REMOVED***,
    ***REMOVED***
...
class ReadResult(msrest.serialization.Model):
    ...
    _validation = {
        'page': {'required': True, 'minimum': 1***REMOVED***,
        'angle': {'required': True, 'maximum': 180, 'minimum_ex': -180***REMOVED***,
        'width': {'required': True, 'minimum': 0***REMOVED***,
        'height': {'required': True, 'minimum': 0***REMOVED***,
        'unit': {'required': True***REMOVED***,
    ***REMOVED***
    ...
    _attribute_map = {
        ...
        'lines': {'key': 'lines', 'type': '[TextLine]'***REMOVED***,
        'selection_marks': {'key': 'selectionMarks', 'type': '[SelectionMark]'***REMOVED***,
    ***REMOVED***
    ...
    def __init__(
        ...
        *,
        ...
        selection_marks: Optional[List["_models.SelectionMark"]] = None,
        **kwargs
    ):
        """
...
class SourcePath(msrest.serialization.Model):
    ...
    _validation = {
        'source': {'max_length': 2048, 'min_length': 0***REMOVED***,
    ***REMOVED***

    _attribute_map = {
        'source': {'key': 'source', 'type': 'str'***REMOVED***,
    ***REMOVED***
...
class Style(msrest.serialization.Model):
    ...
    _validation = {
        'name': {'required': True***REMOVED***,
        'confidence': {'required': True***REMOVED***,
    ***REMOVED***

    _attribute_map = {
        'name': {'key': 'name', 'type': 'str'***REMOVED***,
        'confidence': {'key': 'confidence', 'type': 'float'***REMOVED***,
    ***REMOVED***
    ...
    def __init__(
        self,
        *,
        name: Union[str, "_models.TextStyle"],
        confidence: float,
        **kwargs
    ):
        """
...
class TextLine(msrest.serialization.Model):
    ...
    _validation = {
        'text': {'required': True***REMOVED***,
        'bounding_box': {'required': True, 'max_items': 8, 'min_items': 8***REMOVED***,
        'words': {'required': True***REMOVED***,
    ***REMOVED***

    _attribute_map = {
        'text': {'key': 'text', 'type': 'str'***REMOVED***,
        'bounding_box': {'key': 'boundingBox', 'type': '[float]'***REMOVED***,
        'words': {'key': 'words', 'type': '[TextWord]'***REMOVED***,
        'appearance': {'key': 'appearance', 'type': 'Appearance'***REMOVED***,
    ***REMOVED***
    ...
    def __init__(
        ...
        *,
        ...
        appearance: Optional["_models.Appearance"] = None,
        **kwargs
    ):
        """
...
class TrainingDocumentInfo(msrest.serialization.Model):
    ...
    _validation = {
        'document_name': {'required': True***REMOVED***,
        'pages': {'required': True***REMOVED***,
        'errors': {'required': True***REMOVED***,
        'status': {'required': True***REMOVED***,
    ***REMOVED***

    _attribute_map = {
        'document_name': {'key': 'documentName', 'type': 'str'***REMOVED***,
        'pages': {'key': 'pages', 'type': 'int'***REMOVED***,
        'errors': {'key': 'errors', 'type': '[ErrorInformation]'***REMOVED***,
        'status': {'key': 'status', 'type': 'str'***REMOVED***,
    ***REMOVED***
...
class TrainRequest(msrest.serialization.Model):
    ...
    _validation = {
        'source': {'required': True, 'max_length': 2048, 'min_length': 0***REMOVED***,
    ***REMOVED***

    _attribute_map = {
        'source': {'key': 'source', 'type': 'str'***REMOVED***,
        'source_filter': {'key': 'sourceFilter', 'type': 'TrainSourceFilter'***REMOVED***,
        'use_label_file': {'key': 'useLabelFile', 'type': 'bool'***REMOVED***,
        'model_name': {'key': 'modelName', 'type': 'str'***REMOVED***,
    ***REMOVED***
...
class TrainResult(msrest.serialization.Model):
    ...
    _validation = {
        'training_documents': {'required': True***REMOVED***,
    ***REMOVED***

    _attribute_map = {
        'training_documents': {'key': 'trainingDocuments', 'type': '[TrainingDocumentInfo]'***REMOVED***,
        'fields': {'key': 'fields', 'type': '[FormFieldsReport]'***REMOVED***,
        'average_model_accuracy': {'key': 'averageModelAccuracy', 'type': 'float'***REMOVED***,
        'model_id': {'key': 'modelId', 'type': 'str'***REMOVED***,
        'errors': {'key': 'errors', 'type': '[ErrorInformation]'***REMOVED***,
    ***REMOVED***
...
class TrainSourceFilter(msrest.serialization.Model):
    ...
    _validation = {
        'prefix': {'max_length': 1024, 'min_length': 0***REMOVED***,
    ***REMOVED***

    _attribute_map = {
        'prefix': {'key': 'prefix', 'type': 'str'***REMOVED***,
        'include_sub_folders': {'key': 'includeSubFolders', 'type': 'bool'***REMOVED***,
    ***REMOVED***
