...
@pytest.mark.parametrize(
    ...
    [
        [np.mean, "mean", {***REMOVED***],
        [np.nansum, "sum", {***REMOVED***],
        [
            lambda x: np.isfinite(x).astype(float).sum(),
            "count",
            {***REMOVED***,
        ],
        [np.median, "median", {***REMOVED***],
        [np.min, "min", {***REMOVED***],
        [np.max, "max", {***REMOVED***],
        [lambda x: np.std(x, ddof=1), "std", {***REMOVED***],
        [lambda x: np.std(x, ddof=0), "std", {"ddof": 0***REMOVED***],
        [lambda x: np.var(x, ddof=1), "var", {***REMOVED***],
        [lambda x: np.var(x, ddof=0), "var", {"ddof": 0***REMOVED***],
    ],
)
...
@pytest.mark.parametrize(
    ...
    [
        [np.mean, "mean", {***REMOVED***, 10],
        [np.nansum, "sum", {***REMOVED***, 10],
        [lambda x: np.isfinite(x).astype(float).sum(), "count", {***REMOVED***, 0],
        [np.median, "median", {***REMOVED***, 10],
        [np.min, "min", {***REMOVED***, 10],
        [np.max, "max", {***REMOVED***, 10],
        [lambda x: np.std(x, ddof=1), "std", {***REMOVED***, 10],
        [lambda x: np.std(x, ddof=0), "std", {"ddof": 0***REMOVED***, 10],
        [lambda x: np.var(x, ddof=1), "var", {***REMOVED***, 10],
        [lambda x: np.var(x, ddof=0), "var", {"ddof": 0***REMOVED***, 10],
    ],
)
...
@pytest.mark.parametrize(
    ...
    [
        ...
        ["max", {***REMOVED***, 15],
        ["std", {***REMOVED***, 15],
        ["std", {"ddof": 0***REMOVED***, 15],
        ["var", {***REMOVED***, 15],
        ["var", {"ddof": 0***REMOVED***, 15],
    ],
)
...
@pytest.mark.parametrize(
    ...
    [
        ["mean", {***REMOVED***, 10, None],
        ["sum", {***REMOVED***, 10, None],
        ["count", {***REMOVED***, 0, 0],
        ["median", {***REMOVED***, 10, None],
        ["min", {***REMOVED***, 10, None],
        ["max", {***REMOVED***, 10, None],
        ["std", {***REMOVED***, 10, None],
        ["std", {"ddof": 0***REMOVED***, 10, None],
        ["var", {***REMOVED***, 10, None],
        ["var", {"ddof": 0***REMOVED***, 10, None],
    ],
)
def test_center_reindex_series(series, roll_func, kwargs, minp, fill_value):
    # shifter index
    s = [f"x{x:d***REMOVED***" for x in range(12)]
...
@pytest.mark.parametrize(
    "data_type",
    [np.dtype(f"f{width***REMOVED***") for width in [4, 8]]
    + [np.dtype(f"{sign***REMOVED***{width***REMOVED***") for width in [1, 2, 4, 8] for sign in "ui"],
)
