...
def set_schema(
    ...
    *,
    ...
    v = SchemaValidator(schema)
    assert v.validate_python({1, '2', 3***REMOVED***) == {1, 2, 3***REMOVED***
    ```
...
def frozenset_schema(
    ...
    *,
    ...
    v = SchemaValidator(schema)
    assert v.validate_python(frozenset(range(3))) == frozenset({0, 1, 2***REMOVED***)
    ```
...
def dict_schema(
    ...
    *,
    ...
    v = SchemaValidator(schema)
    assert v.validate_python({'a': '1', 'b': 2***REMOVED***) == {'a': 1, 'b': 2***REMOVED***
    ```
...
def no_info_before_validator_function(
    ...
    *,
    ...
    schema = core_schema.typed_dict_schema({'a': core_schema.typed_dict_field(func_schema)***REMOVED***)

    v = SchemaValidator(schema)
    assert v.validate_python({'a': b'hello '***REMOVED***) == {'a': 'hello world'***REMOVED***
    ```
    ...
    return _dict_not_none(
        ...
        function={'type': 'no-info', 'function': function***REMOVED***,
        schema=schema,
        ref=ref,
        metadata=metadata,
        serialization=serialization,
...
def field_before_validator_function(
    ...
    *,
    ...
    return _dict_not_none(
        type='function-before',
        function={'type': 'field', 'function': function, 'field_name': field_name***REMOVED***,
        schema=schema,
        ref=ref,
        metadata=metadata,
        serialization=serialization,
...
def general_before_validator_function(
    ...
    *,
    ...
    return _dict_not_none(
        type='function-before',
        function={'type': 'general', 'function': function***REMOVED***,
        schema=schema,
        ref=ref,
        metadata=metadata,
        serialization=serialization,
...
def field_plain_validator_function(
    ...
    *,
    ...
    v = SchemaValidator(schema)
    assert v.validate_python({'a': 'hello '***REMOVED***) == {'a': 'hello world'***REMOVED***
    ```
...
def with_default_schema(
    ...
    *,
    ...
    wrapper_schema = core_schema.typed_dict_schema(
        {'a': core_schema.typed_dict_field(schema)***REMOVED***
    )
    v = SchemaValidator(wrapper_schema)
    assert v.validate_python({***REMOVED***) == v.validate_python({'a': 'hello'***REMOVED***)
    ```
...
***REMOVED***,
    ...
    v = SchemaValidator(schema)
    assert v.validate_python({'foo': 'apple', 'bar': '123'***REMOVED***) == {'foo': 'apple', 'bar': 123***REMOVED***
    assert v.validate_python({'foo': 'banana', 'spam': [1, 2, 3]***REMOVED***) == {
        'foo': 'banana',
        'spam': [1, 2, 3],
    ***REMOVED***
    ```
...
def typed_dict_schema(
    ...
    *,
    ...
    wrapper_schema = core_schema.typed_dict_schema(
        {'a': core_schema.typed_dict_field(core_schema.str_schema())***REMOVED***
    )
    v = SchemaValidator(wrapper_schema)
    assert v.validate_python({'a': 'hello'***REMOVED***) == {'a': 'hello'***REMOVED***
    ```
...
def model_fields_schema(
    ...
    *,
    ...
    wrapper_schema = core_schema.model_fields_schema(
        {'a': core_schema.model_field(core_schema.str_schema())***REMOVED***
    )
    v = SchemaValidator(wrapper_schema)
    print(v.validate_python({'a': 'hello'***REMOVED***))
    #> ({'a': 'hello'***REMOVED***, None, {'a'***REMOVED***)
    ```
    ...
    *,
    ...
    schema = core_schema.model_schema(
        ...
        schema=core_schema.model_fields_schema(
            fields={'a': core_schema.model_field(core_schema.str_schema())***REMOVED***,
        ),
    )
    v = SchemaValidator(schema)
    assert v.isinstance_python({'a': 'hello'***REMOVED***) is True
    assert v.isinstance_python({'a': 'too long'***REMOVED***) is False
    ```
...
def dataclass_field(
    ...
    *,
    ...
    v = SchemaValidator(schema)
    assert v.validate_python({'a': 'hello'***REMOVED***) == ({'a': 'hello'***REMOVED***, None)
    ```
...
def dataclass_args_schema(
    ...
    *,
    ...
    v = SchemaValidator(schema)
    assert v.validate_python({'a': 'hello', 'b': True***REMOVED***) == ({'a': 'hello', 'b': True***REMOVED***, None)
    ```
...
def arguments_parameter(
    ...
    *,
    ...
    v = SchemaValidator(schema)
    assert v.validate_python(('hello',)) == (('hello',), {***REMOVED***)
    ```
...
def arguments_schema(
    ...
    *,
    ...
    v = SchemaValidator(schema)
    assert v.validate_python(('hello', True)) == (('hello', True), {***REMOVED***)
    ```
...
def json_schema(
    ...
    *,
    ...
    v = SchemaValidator(schema)
    m = v.validate_python('{"field_a": "hello", "field_b": true***REMOVED***')
...
def _dict_not_none(**kwargs: Any) -> Any:
    return {k: v for k, v in kwargs.items() if v is not None***REMOVED***
