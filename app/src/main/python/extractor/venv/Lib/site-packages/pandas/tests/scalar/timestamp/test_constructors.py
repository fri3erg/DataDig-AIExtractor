...
class TestTimestampConstructorUnitKeyword:
    ...
    def test_construct_from_int_float_with_unit_out_of_bound_raises(self, typ):
        ...
        msg = f"cannot convert input {val***REMOVED*** with the unit 'D'"
    ...
    @pytest.mark.parametrize(
        "value, check_kwargs",
        [
            [946688461000000000, {***REMOVED***],
            [946688461000000000 / 1000, {"unit": "us"***REMOVED***],
            [946688461000000000 / 1_000_000, {"unit": "ms"***REMOVED***],
            [946688461000000000 / 1_000_000_000, {"unit": "s"***REMOVED***],
            [10957, {"unit": "D", "h": 0***REMOVED***],
            [
                (946688461000000000 + 500000) / 1000000000,
                {"unit": "s", "us": 499, "ns": 964***REMOVED***,
            ],
            [
                (946688461000000000 + 500000000) / 1000000000,
                {"unit": "s", "us": 500000***REMOVED***,
            ],
            [(946688461000000000 + 500000) / 1000000, {"unit": "ms", "us": 500***REMOVED***],
            [(946688461000000000 + 500000) / 1000, {"unit": "us", "us": 500***REMOVED***],
            [(946688461000000000 + 500000000) / 1000000, {"unit": "ms", "us": 500000***REMOVED***],
            [946688461000000000 / 1000.0 + 5, {"unit": "us", "us": 5***REMOVED***],
            [946688461000000000 / 1000.0 + 5000, {"unit": "us", "us": 5000***REMOVED***],
            [946688461000000000 / 1000000.0 + 0.5, {"unit": "ms", "us": 500***REMOVED***],
            [946688461000000000 / 1000000.0 + 0.005, {"unit": "ms", "us": 5, "ns": 5***REMOVED***],
            [946688461000000000 / 1000000000.0 + 0.5, {"unit": "s", "us": 500000***REMOVED***],
            [10957 + 0.5, {"unit": "D", "h": 12***REMOVED***],
        ],
    )
...
***REMOVED***
    ...
    @pytest.mark.parametrize("kwargs", [{***REMOVED***, {"year": 2020***REMOVED***, {"year": 2020, "month": 1***REMOVED***])
            ...
            for tz, offset in timezones:
                for result in [Timestamp(date_str, tz=tz), Timestamp(date_obj, tz=tz)]:
                    result = result.as_unit(
                        "ns"
        ***REMOVED***  # test originally written before non-nano
...
***REMOVED***,
    ...
    def test_constructor_invalid_Z0_isostring(self, z):
        # GH 8910
        msg = f"Unknown datetime string format, unable to parse: 2014-11-02 01:00{z***REMOVED***"
        with pytest.raises(ValueError, match=msg):
            Timestamp(f"2014-11-02 01:00{z***REMOVED***")
    ...
    def test_construct_timestamp_near_dst(self, offset):
        # GH 20854
        expected = Timestamp(f"2016-10-30 03:00:00{offset***REMOVED***", tz="Europe/Helsinki")
    ...
    def test_raise_tz_and_tzinfo_in_datetime_input(self, box):
        # GH 23579
        kwargs = {"year": 2018, "month": 1, "day": 1, "tzinfo": pytz.utc***REMOVED***
