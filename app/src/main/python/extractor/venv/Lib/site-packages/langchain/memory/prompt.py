...
Existing summary of {entity***REMOVED***:
{summary***REMOVED***
...
_DEFAULT_KNOWLEDGE_TRIPLE_EXTRACTION_TEMPLATE = (
    ...
    f"Output: (Nevada, is a, state){KG_TRIPLE_DELIMITER***REMOVED***(Nevada, is in, US)"
    f"{KG_TRIPLE_DELIMITER***REMOVED***(Nevada, is the number 1 producer of, gold)\n"
    "END OF EXAMPLE\n\n"
    "EXAMPLE\n"
    "Conversation history:\n"
    "Person #1: Hello.\n"
    ...
    f"Output: (Descartes, likes to drive, antique scooters){KG_TRIPLE_DELIMITER***REMOVED***(Descartes, plays, mandolin)\n"
    "END OF EXAMPLE\n\n"
    "Conversation history (for reference only):\n"
    "{history***REMOVED***"
    "\nLast line of conversation (for extraction):\n"
