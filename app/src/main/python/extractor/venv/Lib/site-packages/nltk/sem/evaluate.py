...
def _read_valuation_line(s):
    ...
    Lines are expected to be of the form::
      ...
      noosa => n
      girl => {g1, g2***REMOVED***
      chase => {(b1, g1), (b2, g1), (g1, d1), (g2, d2)***REMOVED***
...
def read_valuation(s, encoding=None):
    ...
    for linenum, line in enumerate(s.splitlines()):
        ...
        try:
            ...
            raise ValueError(f"Unable to parse line {linenum***REMOVED***: {line***REMOVED***") from e
...
class Assignment(dict):
    ...
    def __init__(self, domain, assign=None):
        ...
        if assign:
            for (var, val) in assign:
                assert val in self.domain, "'{***REMOVED***' is not in the domain: {***REMOVED***".format(
                    val,
                    self.domain,
    ***REMOVED***
    ...
    ***REMOVED***
    ...
    def __str__(self):
        """
        Pretty printing for assignments. {'x', 'u'***REMOVED*** appears as 'g[u/x]'
        """
        gstring = "g"
        # Deterministic output for unit testing.
        variant = sorted(self.variant)
        for (val, var) in variant:
            gstring += f"[{val***REMOVED***/{var***REMOVED***]"
        return gstring
    ...
    def add(self, var, val):
        ...
        """
        assert val in self.domain, f"{val***REMOVED*** is not in the domain {self.domain***REMOVED***"
...
***REMOVED***
    ...
    def __repr__(self):
        return f"({self.domain!r***REMOVED***, {self.valuation!r***REMOVED***)"

    def __str__(self):
        return f"Domain = {self.domain***REMOVED***,\nValuation = \n{self.valuation***REMOVED***"
    ...
    def evaluate(self, expr, g, trace=None):
        ...
        try:
            ...
            if trace:
                print()
                print(f"'{expr***REMOVED***' evaluates to {value***REMOVED*** under M, {g***REMOVED***")
            return value
        except Undefined:
            if trace:
                print()
                print(f"'{expr***REMOVED***' is undefined under M, {g***REMOVED***")
            return "Undefined"
    ...
    def satisfiers(self, parsed, varex, g, trace=None, nesting=0):
        ...
        if var in parsed.free():
            if trace:
                ...
                print(
                    (spacer * nesting)
                    + f"Open formula is '{parsed***REMOVED***' with assignment {g***REMOVED***"
    ***REMOVED***
            for u in self.domain:
                new_g = g.copy()
                ...
                if value == False:
                    if trace:
                        print(indent + f"value of '{parsed***REMOVED***' under {new_g***REMOVED*** is False")

                # so g[u/var] is a satisfying assignment
                else:
                    candidates.append(u)
                    if trace:
                        print(indent + f"value of '{parsed***REMOVED***' under {new_g***REMOVED*** is {value***REMOVED***")

            result = {c for c in candidates***REMOVED***
        # var isn't free in parsed
        else:
            raise Undefined(f"{var.name***REMOVED*** is not free in {parsed***REMOVED***")
...
def propdemo(trace=None):
    ...
    for sent in sentences:
        if trace:
            ...
            print(f"The value of '{sent***REMOVED***' is: {m1.evaluate(sent, g1)***REMOVED***")
...
def folmodel(quiet=False, trace=None):
    ...
    v2 = [
        ...
        ("boy", {"b1", "b2"***REMOVED***),
        ("dog", {"d1"***REMOVED***),
        ("love", {("b1", "g1"), ("b2", "g2"), ("g1", "b1"), ("g2", "b1")***REMOVED***),
    ]
    val2 = Valuation(v2)
    dom2 = val2.domain
    m2 = Model(dom2, val2)
    ...
    ***REMOVED***
        ...
        for (fun, args) in applications:
            try:
                ...
                print(f"{fun***REMOVED***({args***REMOVED***) evaluates to {argsval in funval***REMOVED***")
            except Undefined:
                print(f"{fun***REMOVED***({args***REMOVED***) evaluates to Undefined")
...
def foldemo(trace=None):
    ...
    for fmla in formulas:
        ...
        if trace:
            ...
            print(f"The value of '{fmla***REMOVED***' is: {m2.evaluate(fmla, g2)***REMOVED***")
...
def satdemo(trace=None):
    ...
    for p in parsed:
        g2.purge()
        print(
            "The satisfiers of '{***REMOVED***' are: {***REMOVED***".format(p, m2.satisfiers(p, "x", g2, trace))
        )
...
def demo(num=0, trace=None):
    ...
    """
    demos = {1: propdemo, 2: folmodel, 3: foldemo, 4: satdemo***REMOVED***
