...
def lagmulx(c):
    ...
    .. math::
        ...
        xP_i(x) = (-(i + 1)*P_{i + 1***REMOVED***(x) + (2i + 1)P_{i***REMOVED***(x) - iP_{i - 1***REMOVED***(x))
...
def lagval2d(x, y, c):
    ...
    .. math:: p(x,y) = \\sum_{i,j***REMOVED*** c_{i,j***REMOVED*** * L_i(x) * L_j(y)
...
def laggrid2d(x, y, c):
    ...
    .. math:: p(a,b) = \\sum_{i,j***REMOVED*** c_{i,j***REMOVED*** * L_i(a) * L_j(b)
...
def lagval3d(x, y, z, c):
    ...
    .. math:: p(x,y,z) = \\sum_{i,j,k***REMOVED*** c_{i,j,k***REMOVED*** * L_i(x) * L_j(y) * L_k(z)
...
def laggrid3d(x, y, z, c):
    ...
    .. math:: p(a,b,c) = \\sum_{i,j,k***REMOVED*** c_{i,j,k***REMOVED*** * L_i(a) * L_j(b) * L_k(c)
...
def laggauss(deg):
    ...
    .. math:: w_k = c / (L'_n(x_k) * L_{n-1***REMOVED***(x_k))
