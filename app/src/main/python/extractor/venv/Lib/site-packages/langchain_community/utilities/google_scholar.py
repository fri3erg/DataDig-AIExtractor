...
class GoogleScholarAPIWrapper(BaseModel):
    ...
    Attributes:
        ...
        lr: attribute defines one or multiple languages to limit the search to.
            It uses lang_{two-letter language code***REMOVED*** to specify languages
...
***REMOVED***
    ...
    def run(self, query: str) -> str:
        ...
        while page < max((self.top_k_results - 20), 1):
            ...
            ***REMOVED***,  # if top_k_result is less than 20.
                        "lr": self.lr,
                    ***REMOVED***
    ***REMOVED***
                .get_dict()
...
***REMOVED***
        ...
        docs = [
            f"Title: {result.get('title','')***REMOVED***\n"
            f"Authors: {','.join([author.get('name') for author in result.get('publication_info',{***REMOVED***).get('authors',[])])***REMOVED***\n"  # noqa: E501
            f"Summary: {result.get('publication_info',{***REMOVED***).get('summary','')***REMOVED***\n"
            f"Total-Citations: {result.get('inline_links',{***REMOVED***).get('cited_by',{***REMOVED***).get('total','')***REMOVED***"  # noqa: E501
