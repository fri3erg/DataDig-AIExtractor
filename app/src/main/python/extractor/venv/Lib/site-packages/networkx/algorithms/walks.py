...
def number_of_walks(G, walk_length):
    ...
    >>> walks
    {0: {0: 1, 1: 0, 2: 1***REMOVED***, 1: {0: 0, 1: 2, 2: 0***REMOVED***, 2: {0: 1, 1: 0, 2: 1***REMOVED******REMOVED***
    ...
    if walk_length < 0:
        raise ValueError(f"`walk_length` cannot be negative: {walk_length***REMOVED***")
    ...
    result = {
        u: {v: power[u_idx, v_idx] for v_idx, v in enumerate(G)***REMOVED***
