...
class BaseInterfaceTests:
    ...
    def test_copy(self, data):
        ...
        if data.dtype._is_immutable:
            pytest.skip(f"test_copy assumes mutability and {data.dtype***REMOVED*** is immutable")
    ...
    def test_view(self, data):
        ...
        if data.dtype._is_immutable:
            pytest.skip(f"test_view assumes mutability and {data.dtype***REMOVED*** is immutable")
