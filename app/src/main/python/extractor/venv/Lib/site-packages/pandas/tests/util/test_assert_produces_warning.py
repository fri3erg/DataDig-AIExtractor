...
@pytest.mark.parametrize(
    ...
    [
        ...
        ("Message 12-234 with numbers", r"\d{2***REMOVED***-\d{3***REMOVED***"),
        ("Message 12-234 with numbers", r"^Mes.*\d{2***REMOVED***-\d{3***REMOVED***"),
        ("Message 12-234 with numbers", r"\d{2***REMOVED***-\d{3***REMOVED***\s\S+"),
