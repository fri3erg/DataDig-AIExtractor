...
CPROPS_FMTID = "{D5CDD505-2E9C-101B-9397-08002B2CF9AE***REMOVED***"
...
EXT_TYPES = {
    '{78C0D931-6437-407D-A8EE-F0AAD7539E65***REMOVED***': 'Conditional Formatting',
    '{CCE6A557-97BC-4B89-ADB6-D9C93CAAB3DF***REMOVED***': 'Data Validation',
    '{05C60535-1F16-4FD2-B633-F4F36F0B64E0***REMOVED***': 'Sparkline Group',
    '{A8765BA9-456A-4DAB-B4F3-ACF838C121DE***REMOVED***': 'Slicer List',
    '{FC87AEE6-9EDD-4A0A-B7FB-166176984837***REMOVED***': 'Protected Range',
    '{01252117-D84E-4E92-8308-4BE1C098FCBB***REMOVED***': 'Ignored Error',
    '{F7C9EE02-42E1-4005-9D12-6889AFFD525C***REMOVED***': 'Web Extension',
    '{3A4CF648-6AED-40f4-86FF-DC5316D8AED3***REMOVED***': 'Slicer List',
    '{7E03D99C-DC04-49d9-9315-930204A7B6E9***REMOVED***': 'Timeline Ref',
***REMOVED***
