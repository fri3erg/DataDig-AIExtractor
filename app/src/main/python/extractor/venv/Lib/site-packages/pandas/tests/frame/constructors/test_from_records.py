...
class TestFromRecords:
    def test_from_records_dt64tz_frame(self):
        ...
        df = DataFrame({i: dti for i in range(4)***REMOVED***)
    ...
    def test_from_records_with_datetimes(self):
        ...
        # GH#6140
        expected = DataFrame({"EXPIRY": [datetime(2005, 3, 1, 0, 0), None]***REMOVED***)
    ...
    ***REMOVED***,
        ...
        asdict2 = {x: y.values for x, y in df.items()***REMOVED***
    ...
    def test_from_records_series_list_dict(self):
        # GH#27358
        expected = DataFrame([[{"a": 1, "b": 2***REMOVED***, {"a": 3, "b": 4***REMOVED***]]).T
        data = Series([[{"a": 1, "b": 2***REMOVED***], [{"a": 3, "b": 4***REMOVED***]])
    ...
    def test_from_records_series_categorical_index(self):
        ...
        series_of_dicts = Series([{"a": 1***REMOVED***, {"a": 2***REMOVED***, {"b": 3***REMOVED***], index=index)
        frame = DataFrame.from_records(series_of_dicts, index=index)
        expected = DataFrame(
            {"a": [1, 2, np.nan], "b": [np.nan, np.nan, 3]***REMOVED***, index=index
        )
        tm.assert_frame_equal(frame, expected)

    def test_frame_from_records_utc(self):
        rec = {"datum": 1.5, "begin_time": datetime(2006, 4, 27, tzinfo=pytz.utc)***REMOVED***
    ...
    def test_from_records_tuples_generator(self):
        ...
        data = {"Integer": columns[0], "String": columns[1], "Float": columns[2]***REMOVED***
    ...
    def test_from_records_set_index_name(self):
        ...
        # demo missing data
        documents.append({"order_id": 10, "quantity": 5***REMOVED***)
    ...
    def test_from_records_misc_brokenness2(self):
        ...
        expected = DataFrame(
            {"date": [row[0] for row in rows], "test": [row[1] for row in rows]***REMOVED***
        )
        tm.assert_frame_equal(result, expected)
    ...
    def test_from_records_empty_with_nonempty_fields_gh3682(self):
        ...
        expected = DataFrame({"value": [2]***REMOVED***, index=ex_index, columns=["value"])
    ...
    def test_from_records_empty2(self):
        ...
        expected = DataFrame({"prop": np.array([], dtype=int)***REMOVED***)
        tm.assert_frame_equal(result, expected)
