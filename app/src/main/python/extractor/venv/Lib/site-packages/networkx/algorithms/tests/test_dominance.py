...
class TestImmediateDominators:
    ...
    def test_singleton(self):
        G = nx.DiGraph()
        G.add_node(0)
        assert nx.immediate_dominators(G, 0) == {0: 0***REMOVED***
        G.add_edge(0, 0)
        assert nx.immediate_dominators(G, 0) == {0: 0***REMOVED***
    ...
    def test_path(self):
        ...
        assert nx.immediate_dominators(G, 0) == {i: max(i - 1, 0) for i in range(n)***REMOVED***
    ...
    def test_irreducible1(self):
        ...
        G = nx.DiGraph(edges)
        assert nx.immediate_dominators(G, 5) == {i: 5 for i in range(1, 6)***REMOVED***
    ...
    def test_irreducible2(self):
        ...
        assert result == {i: 6 for i in range(1, 7)***REMOVED***
    ...
    def test_domrel_png(self):
        ...
        assert result == {1: 1, 2: 1, 3: 2, 4: 2, 5: 2, 6: 2***REMOVED***
        # Test postdominance.
        result = nx.immediate_dominators(G.reverse(copy=False), 6)
        assert result == {1: 2, 2: 6, 3: 5, 4: 5, 5: 2, 6: 6***REMOVED***
    ...
    def test_boost_example(self):
        ...
        assert result == {0: 0, 1: 0, 2: 1, 3: 1, 4: 3, 5: 4, 6: 4, 7: 1***REMOVED***
        # Test postdominance.
        result = nx.immediate_dominators(G.reverse(copy=False), 7)
        assert result == {0: 1, 1: 7, 2: 7, 3: 4, 4: 5, 5: 7, 6: 4, 7: 7***REMOVED***
...
class TestDominanceFrontiers:
    ...
    def test_singleton(self):
        G = nx.DiGraph()
        G.add_node(0)
        assert nx.dominance_frontiers(G, 0) == {0: set()***REMOVED***
        G.add_edge(0, 0)
        assert nx.dominance_frontiers(G, 0) == {0: set()***REMOVED***
    ...
    def test_path(self):
        n = 5
        G = nx.path_graph(n, create_using=nx.DiGraph())
        assert nx.dominance_frontiers(G, 0) == {i: set() for i in range(n)***REMOVED***
    ...
    def test_unreachable(self):
        ...
        assert n > 1
        G = nx.path_graph(n, create_using=nx.DiGraph())
        assert nx.dominance_frontiers(G, n // 2) == {i: set() for i in range(n // 2, n)***REMOVED***
    ...
    def test_domrel_png(self):
        ...
        ***REMOVED***
        ...
        assert result == {1: set(), 2: {2***REMOVED***, 3: {2***REMOVED***, 4: {2***REMOVED***, 5: {2***REMOVED***, 6: set()***REMOVED***
    ...
    def test_loop(self):
        ...
        assert df == {"a": set(), "b": set(), "c": set()***REMOVED***
