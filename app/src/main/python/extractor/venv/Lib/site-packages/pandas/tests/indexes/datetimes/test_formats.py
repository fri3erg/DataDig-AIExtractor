...
***REMOVED***,
    ...
    def test_dti_repr_time_midnight(self, dates, freq, expected_repr, unit):
        ...
        assert actual_repr == expected_repr.replace("[ns]", f"[{unit***REMOVED***]")
...
***REMOVED***
        ...
        with pd.option_context("display.width", 300):
            for index, expected in zip(idxs, exp):
                ...
                expected = expected.replace("[ns", f"[{unit***REMOVED***")
                result = repr(index)
...
***REMOVED***:
                ...
                result = repr(ser)
                assert result == expected.replace("[ns", f"[{unit***REMOVED***")
...
class TestFormat:
    def test_format(self):
        ...
        expected = [f"{x:%Y-%m-%d***REMOVED***" for x in idx]
