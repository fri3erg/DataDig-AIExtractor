...
def _convert_dict_to_message(_dict: Mapping[str, Any]) -> AIMessage:
    ...
    if _dict.get("function_call"):
        additional_kwargs = {"function_call": dict(_dict["function_call"])***REMOVED***
    ...
    return AIMessage(
        content=content,
        additional_kwargs={**_dict.get("body", {***REMOVED***), **additional_kwargs***REMOVED***,
    )
...
***REMOVED***
        ...
        params = {
            **values.get("init_kwargs", {***REMOVED***),
            "model": values["model"],
...
***REMOVED***
    ...
    def _identifying_params(self) -> Dict[str, Any]:
        return {
            **{"endpoint": self.endpoint, "model": self.model***REMOVED***,
    ...
    def _generate(
        ...
        **kwargs: Any,
        ...
        if self.streaming:
            ...
            lc_msg = AIMessage(content=completion, additional_kwargs={***REMOVED***)
            gen = ChatGeneration(
                message=lc_msg,
...
***REMOVED***
            return ChatResult(
                generations=[gen],
                llm_output={"token_usage": {***REMOVED***, "model_name": self.model***REMOVED***,
***REMOVED***
        ...
        gen = ChatGeneration(
            ...
            generation_info={
                "finish_reason": "stop",
                **response_payload.get("body", {***REMOVED***),
            ***REMOVED***,
        )
        token_usage = response_payload.get("usage", {***REMOVED***)
        llm_output = {"token_usage": token_usage, "model_name": self.model***REMOVED***
