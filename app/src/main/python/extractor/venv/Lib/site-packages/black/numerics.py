...
def format_hex(text: str) -> str:
    ...
    return f"{before***REMOVED***{after.upper()***REMOVED***"
...
def format_scientific_notation(text: str) -> str:
    ...
    return f"{before***REMOVED***e{sign***REMOVED***{after***REMOVED***"
...
def format_complex_number(text: str) -> str:
    ...
    number = text[:-1]
    suffix = text[-1]
    return f"{format_float_or_int_string(number)***REMOVED***{suffix***REMOVED***"
...
def format_float_or_int_string(text: str) -> str:
    ...
    return f"{before or 0***REMOVED***.{after or 0***REMOVED***"
