...
class WorkbookWriter:
    ...
    def write_worksheets(self):
        for idx, sheet in enumerate(self.wb._sheets, 1):
            sheet_node = ChildSheet(name=sheet.title, sheetId=idx, id="rId{0***REMOVED***".format(idx))
    ...
    def write_names(self):
        ...
        for idx, sheet in enumerate(self.wb.worksheets):
            ...
            if sheet.auto_filter:
                ...
                name.value = f"{quoted***REMOVED***!{sheet.auto_filter***REMOVED***"
    ...
    def write_root_rels(self):
        ...
        rels.append(rel)
        rel = Relationship(Type=f"{PKG_REL_NS***REMOVED***/metadata/core-properties", Target=ARC_CORE)
        rels.append(rel)
