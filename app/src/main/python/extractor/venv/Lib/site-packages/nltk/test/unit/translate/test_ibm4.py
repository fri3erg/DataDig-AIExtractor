...
class TestIBMModel4(unittest.TestCase):
    def test_set_uniform_distortion_probabilities_of_max_displacements(self):
        # arrange
        src_classes = {"schinken": 0, "eier": 0, "spam": 1***REMOVED***
        trg_classes = {"ham": 0, "eggs": 1, "spam": 2***REMOVED***
        corpus = [
    ...
    def test_prob_t_a_given_s(self):
        ...
        src_classes = {"räucherschinken": 0, "ja": 1, "ich": 2, "esse": 3, "gern": 4***REMOVED***
        trg_classes = {"ham": 0, "smoked": 1, "i": 3, "love": 4, "to": 2, "eat": 4***REMOVED***
