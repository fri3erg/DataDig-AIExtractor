...
def build_module(source_files, options=[], skip=[], only=[], module_name=None):
    ...
    code = f"***REMOVED***; sys.path = {sys.path!r***REMOVED***; import numpy.f2py; numpy.f2py.main()"
    ...
    if sys.platform == "cygwin":
        ...
        _module_list.extend(
            glob.glob(os.path.join(d, "{:s***REMOVED****".format(module_name)))
        )
...
def _get_compiler_status():
    ...
    code = textwrap.dedent(f"""\
        import os
        ***REMOVED***
        sys.path = {repr(sys.path)***REMOVED***
        ...
        have_c = config_cmd.try_compile('void foo() {{***REMOVED******REMOVED***')
...
class F2PyTest:
    ...
    def module_name(self):
        cls = type(self)
        return f'_{cls.__module__.rsplit(".",1)[-1]***REMOVED***_{cls.__name__***REMOVED***_ext_module'
