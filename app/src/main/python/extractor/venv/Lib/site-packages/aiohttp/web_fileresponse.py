...
class FileResponse(StreamResponse):
    ...
    async def prepare(self, request: "BaseRequest") -> Optional[AbstractStreamWriter]:
        ...
        etag_value = f"{st.st_mtime_ns:x***REMOVED***-{st.st_size:x***REMOVED***"
        ...
        if ifrange is None or st.st_mtime <= ifrange.timestamp():
            ...
            try:
                ...
                self.headers[hdrs.CONTENT_RANGE] = f"bytes */{file_size***REMOVED***"
        ...
        ***REMOVED***
        ...
        if status == HTTPPartialContent.status_code:
            self.headers[hdrs.CONTENT_RANGE] = "bytes {***REMOVED***-{***REMOVED***/{***REMOVED***".format(
