...
def core_number(G):
    ...
    node_pos = {v: pos for pos, v in enumerate(nodes)***REMOVED***
    # The initial guess for the core number of a node is its degree.
    core = degrees
    nbrs = {v: list(nx.all_neighbors(G, v)) for v in G***REMOVED***
    for v in nodes:
        for u in nbrs[v]:
            if core[u] > core[v]:
                nbrs[u].remove(v)
...
def onion_layers(G):
    ...
    od_layers = {***REMOVED***
    # Adjacency list
    neighbors = {v: list(nx.all_neighbors(G, v)) for v in G***REMOVED***
