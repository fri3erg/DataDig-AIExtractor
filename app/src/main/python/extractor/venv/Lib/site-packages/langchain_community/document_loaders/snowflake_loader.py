...
***REMOVED*** from ex
        ...
        try:
            ...
            print(f"An error occurred: {e***REMOVED***")
            query_result = []
        finally:
            cur.close()
        return query_result
    ...
    def lazy_load(self) -> Iterator[Document]:
        ...
        if isinstance(query_result, Exception):
            print(f"An error occurred during the query: {query_result***REMOVED***")
            return []
        ...
        for row in query_result:
            page_content = "\n".join(
                f"{k***REMOVED***: {v***REMOVED***" for k, v in row.items() if k in page_content_columns
***REMOVED***
            metadata = {k: v for k, v in row.items() if k in metadata_columns***REMOVED***
