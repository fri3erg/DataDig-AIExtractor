...
***REMOVED***
    ...
    def _create_table(
        ...
        field_list: List[dict] = [
            {"field": "text", "type": "str"***REMOVED***,
            {"field": "metadata", "type": "str"***REMOVED***,
        ],
    ) -> int:
        """
        ...
        type_dict = {"int": vearch.dataType.INT, "str": vearch.dataType.STRING***REMOVED***
        engine_info = {
            "index_size": 10000,
            "retrieval_type": "IVFPQ",
            "retrieval_param": {"ncentroids": 2048, "nsubvector": 32***REMOVED***,
        ***REMOVED***
        fields = [
        ...
        vector_field = vearch.GammaVectorInfo(
            ...
            store_param={"cache_size": 10000***REMOVED***,
            has_source=False,
        )
...
***REMOVED***
            ...
            if embeddings is not None and metadatas is not None:
                doc_items = []
                for text, metadata, embed in zip(texts, metadatas, embeddings):
                    profiles_v: dict[str, Any] = {***REMOVED***
...
***REMOVED***
            ...
            query_data = {
                ...
                "fields": [],
                "is_brute_search": 1,
                "retrieval_param": {"metric_type": "InnerProduct", "nprobe": 20***REMOVED***,
                "topn": k,
            ***REMOVED***
...
***REMOVED***
    ...
    def get(
        ...
        **kwargs: Any,
        ...
        results: Dict[str, Document] = {***REMOVED***
        if ids is None or ids.__len__() == 0:
            return results
        if self.flag:
            query_data = {"query": {"ids": ids***REMOVED******REMOVED***
