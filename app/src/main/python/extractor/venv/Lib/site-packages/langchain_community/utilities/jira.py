    ...
    def parse_issues(self, issues: Dict) -> List[dict]:
        ...
        for issue in issues["issues"]:
            ...
            for related_issue in issue["fields"]["issuelinks"]:
                ...
                rel_issues = {"type": rel_type, "key": rel_key, "summary": rel_summary***REMOVED***
            parsed.append(
                {
                    "key": key,
                    "summary": summary,
...
***REMOVED***
    ...
    def parse_projects(self, projects: List[dict]) -> List[dict]:
        ...
        for project in projects:
            ...
            style = project["style"]
            parsed.append(
                {"id": id, "key": key, "name": name, "type": type, "style": style***REMOVED***
***REMOVED***
        return parsed
...
***REMOVED***
        ...
        return jira_function(*params.get("args", []), **params.get("kwargs", {***REMOVED***))
    ...
    def run(self, mode: str, query: str) -> str:
        if mode == "jql":
            ...
            raise ValueError(f"Got unexpected mode {mode***REMOVED***")
