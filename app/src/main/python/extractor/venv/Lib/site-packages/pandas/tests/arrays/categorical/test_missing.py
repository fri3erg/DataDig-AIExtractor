...
class TestCategoricalMissing:
    ...
    @pytest.mark.parametrize(
        ...
        [
            (
                {"value": 1, "method": "ffill"***REMOVED***,
                "Cannot specify both 'value' and 'method'.",
***REMOVED***,
            ({***REMOVED***, "Must specify a fill 'value' or 'method'."),
            ({"method": "bad"***REMOVED***, "Invalid fill method. Expecting .* bad"),
            (
                {"value": Series([1, 2, 3, 4, "a"])***REMOVED***,
