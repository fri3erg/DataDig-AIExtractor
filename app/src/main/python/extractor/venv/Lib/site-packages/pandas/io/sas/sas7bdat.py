...
def _convert_datetimes(sas_datetimes: pd.Series, unit: str) -> pd.Series:
    ...
    Parameters
    ----------
    sas_datetimes : {Series, Sequence[float]***REMOVED***
...
class SAS7BDATReader(ReaderBase, abc.Iterator):
    ...
    def _get_properties(self) -> None:
        ...
        if buf in const.encoding_names:
            ...
            self.inferred_encoding = f"unknown (code={buf***REMOVED***)"
...
***REMOVED***:
        ...
        ***REMOVED***
                    ...
                    self.close()
                    raise ValueError(
                        f"Unknown subheader signature {subheader_signature***REMOVED***"
        ***REMOVED***
            else:
    ...
    def _process_columnsize_subheader(self, offset: int, length: int) -> None:
        ...
        if self.col_count_p1 + self.col_count_p2 != self.column_count:
            print(
                f"Warning: column count mismatch ({self.col_count_p1***REMOVED*** + "
                f"{self.col_count_p2***REMOVED*** != {self.column_count***REMOVED***)\n"
***REMOVED***
    ...
    def _read_next_page(self):
        ...
        if len(self._cached_page) <= 0:
            ...
            msg = (
                ...
                f"{len(self._cached_page):d***REMOVED*** of {self._page_length:d***REMOVED*** bytes)"
***REMOVED***
    ...
    def _chunk_to_dataframe(self) -> DataFrame:
        ...
        for j in range(self.column_count):
            ...
            if self._column_types[j] == b"d":
                ...
                self.close()
                raise ValueError(f"unknown column type {repr(self._column_types[j])***REMOVED***")
