...
def test_overlapping_K5():
    ...
    assert c == {frozenset(range(5)), frozenset(range(2, 7))***REMOVED***
...
def test_isolated_K5():
    ...
    c = set(nx.community.k_clique_communities(G, 5))
    assert c == {frozenset(range(5)), frozenset(range(5, 10))***REMOVED***
...
class TestZacharyKarateClub:
    ...
    def test_k2(self):
        ...
        expected = {frozenset(self.G)***REMOVED***
    ...
    def test_k3(self):
        ...
        comm2 = [0, 4, 5, 6, 10, 16]
        comm3 = [24, 25, 31]
        expected = {frozenset(comm1), frozenset(comm2), frozenset(comm3)***REMOVED***
    ...
    def test_k5(self):
        expected = {frozenset([0, 1, 2, 3, 7, 13])***REMOVED***
