...
readme = 'README.md'
authors = [
  { name = 'The Pandas Development Team', email='pandas-dev@python.org' ***REMOVED***,
]
license = {file = 'LICENSE'***REMOVED***
requires-python = '>=3.9'
dependencies = [
...
build-verbosity = "3"
environment = {LDFLAGS="-Wl,--strip-all"***REMOVED***
...
repair-wheel-command = "delvewheel repair -w {dest_dir***REMOVED*** {wheel***REMOVED***"
