...
class SelfAskWithSearchAgent(Agent):
    ...
    def _validate_tools(cls, tools: Sequence[BaseTool]) -> None:
        ...
        if tool_names != {"Intermediate Answer"***REMOVED***:
            raise ValueError(
                f"Tool name should be Intermediate Answer, got {tool_names***REMOVED***"
***REMOVED***
...
***REMOVED***
            ...
            agent_executor.invoke({"input": "hi"***REMOVED***)
    ...
    """
    missing_vars = {"agent_scratchpad"***REMOVED***.difference(prompt.input_variables)
    if missing_vars:
        raise ValueError(f"Prompt missing required variables: {missing_vars***REMOVED***")
