...
class RunTree(RunBase):
    ...
    child_runs: List[RunTree] = Field(
        ...
        exclude={"__all__": {"parent_run_id"***REMOVED******REMOVED***,
    )
    ...
    def infer_defaults(cls, values: dict) -> dict:
        ...
        if "serialized" not in values:
            values["serialized"] = {"name": values["name"]***REMOVED***
        ...
        cast(dict, values.setdefault("extra", {***REMOVED***))
        return values
...
***REMOVED***
    ...
    def create_child(
        ...
        *,
        ...
        serialized_ = serialized or {"name": name***REMOVED***
        run = RunTree(
            name=name,
            id=run_id or uuid4(),
            serialized=serialized_,
            inputs=inputs or {***REMOVED***,
            outputs=outputs or {***REMOVED***,
            error=error,
            run_type=run_type,
    ...
    def _get_dicts_safe(self):
        try:
            return self.dict(exclude={"child_runs"***REMOVED***, exclude_none=True)
        except TypeError:
            # Things like generators cannot be copied
            self_dict = self.dict(
                exclude={"child_runs", "inputs", "outputs"***REMOVED***, exclude_none=True
***REMOVED***
            if self.inputs:
                # shallow copy
