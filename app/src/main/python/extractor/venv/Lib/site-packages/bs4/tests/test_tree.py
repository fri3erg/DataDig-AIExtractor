...
class TestFindAllBasicNamespaces(SoupTest):
    ...
    def test_find_by_namespaced_name(self):
        ...
        assert "a" == soup.find(attrs= { "svg:fill" : "red" ***REMOVED***).name
...
class TestFindAllByName(SoupTest):
    ...
    def test_find_all_by_tag_dict(self):
        self.assert_selects(
            self.tree.find_all({'a' : True, 'b' : True***REMOVED***),
            ['First tag.', 'Second tag.', 'Nested tag.'])
...
class TestFindAllByAttribute(SoupTest):
    ...
    def test_find_all_by_attribute_dict(self):
        ...
        self.assert_selects(tree.find_all(attrs={'name' : 'name1'***REMOVED***),
                           ["Name match."])

        self.assert_selects(tree.find_all(attrs={'class' : 'class2'***REMOVED***),
                           ["Class match."])
    ...
    def test_find_all_by_attribute_soupstrainer(self):
        ...
        strainer = SoupStrainer(attrs={'id' : 'first'***REMOVED***)
