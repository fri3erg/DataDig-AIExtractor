...
class TestAGraph:
    ...
    def test_from_agraph_named_edges(self):
        ...
        assert ("0", "1", {"key": "foo"***REMOVED***) in H.edges(data=True)
    ...
    def test_to_agraph_with_nodedata(self):
        ...
        A = nx.nx_agraph.to_agraph(G)
        assert dict(A.nodes()[0].attr) == {"color": "red"***REMOVED***
    ...
    def test_to_agraph_with_edgedata(self, graph_class):
        ...
        A = nx.nx_agraph.to_agraph(G)
        assert dict(A.edges()[0].attr) == {"color": "yellow"***REMOVED***
    ...
    def test_view_pygraphviz_leaves_input_graph_unmodified(self):
        ...
        G.graph["node"] = {"width": "0.80"***REMOVED***
        G.graph["edge"] = {"fontsize": "14"***REMOVED***
        path, A = nx.nx_agraph.view_pygraphviz(G, show=False)
        assert G.graph == {"node": {"width": "0.80"***REMOVED***, "edge": {"fontsize": "14"***REMOVED******REMOVED***
    ...
    def test_round_trip_empty_graph(self):
        ...
        G.graph["graph"] = {***REMOVED***
        G.graph["node"] = {***REMOVED***
        G.graph["edge"] = {***REMOVED***
    ...
    def test_pygraphviz_layout_root(self, root):
        ...
        A.layout(args=f"-Groot={root***REMOVED***", prog="circo")
        # Parse AGraph layout
