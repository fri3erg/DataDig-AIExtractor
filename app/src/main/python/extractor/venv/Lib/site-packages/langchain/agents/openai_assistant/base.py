    ...
    Example using OpenAI tools:
        .. code-block:: python
            ...
            interpreter_assistant = OpenAIAssistantRunnable.create_assistant(
                ...
                tools=[{"type": "code_interpreter"***REMOVED***],
                model="gpt-4-1106-preview"
***REMOVED***
            output = interpreter_assistant.invoke({"content": "What's 10 - 4 raised to the 2.7"***REMOVED***)
...
***REMOVED***
            ...
            agent_executor.invoke({"content": "What's 10 - 4 raised to the 2.7"***REMOVED***)
...
***REMOVED***
            ...
            def execute_agent(agent, tools, input):
                ...
                while not isinstance(response, AgentFinish):
                    ...
                    for action in response:
                        ...
                        tool_outputs.append({"output": tool_output, "tool_call_id": action.tool_call_id***REMOVED***)
        ...
        ***REMOVED***
            ...
            response = execute_agent(agent, tools, {"content": "What's 10 - 4 raised to the 2.7"***REMOVED***)
            next_response = execute_agent(agent, tools, {"content": "now add 17.241", "thread_id": response.thread_id***REMOVED***)
...
***REMOVED***
    ...
    ***REMOVED***
    ...
    def _parse_intermediate_steps(
        ...
        ***REMOVED***
        tool_outputs = [
            {"output": str(output), "tool_call_id": action.tool_call_id***REMOVED***
...
***REMOVED***
            ...
            for tool_call in run.required_action.submit_tool_outputs.tool_calls:
                ...
                try:
                    ...
                    raise ValueError(
                        ...
                        f"{function.arguments***REMOVED*** for function {function.name***REMOVED***"
        ***REMOVED*** from e
    ...
    ***REMOVED***
            ...
            raise ValueError(
                f"Unexpected run status: {run.status***REMOVED***. Full run info:\n\n{run_info***REMOVED***)"
***REMOVED***
