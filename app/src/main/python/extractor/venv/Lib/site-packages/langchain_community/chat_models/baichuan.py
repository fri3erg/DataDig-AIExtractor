...
***REMOVED***
        ...
        if response.get("code") != 0:
            raise ValueError(f"Error from Baichuan api response: {response***REMOVED***")
    ...
    def _chat(self, messages: List[BaseMessage], **kwargs: Any) -> requests.Response:
        ...
        parameters = {**self._default_params, **kwargs***REMOVED***

        model = parameters.pop("model")
        headers = parameters.pop("headers", {***REMOVED***)
        ...
        ***REMOVED***
        ...
        if self.streaming:
            url = f"{url***REMOVED***/stream"
        url = f"{url***REMOVED***/chat"
        ...
        res = requests.post(
            ...
            headers={
                ...
                "Authorization": f"Bearer {api_key***REMOVED***",
    ...
    ***REMOVED***,
    ...
    def _create_chat_result(self, response: Mapping[str, Any]) -> ChatResult:
        ...
        llm_output = {"token_usage": token_usage, "model": self.model***REMOVED***
