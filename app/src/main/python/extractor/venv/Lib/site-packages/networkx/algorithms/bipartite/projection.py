...
def projected_graph(B, nodes, multigraph=False):
    ...
    for u in nodes:
        nbrs2 = {v for nbr in B[u] for v in B[nbr] if v != u***REMOVED***
        if multigraph:
            for n in nbrs2:
                if directed:
...
def weighted_projected_graph(B, nodes, ratio=False):
    ...
    [(1, 3, {'weight': 1***REMOVED***)]
    >>> G = bipartite.weighted_projected_graph(B, [1, 3], ratio=True)
    >>> list(G.edges(data=True))
    [(1, 3, {'weight': 0.5***REMOVED***)]
    ...
    if n_top < 1:
        raise NetworkXAlgorithmError(
            f"the size of the nodes to project onto ({len(nodes)***REMOVED***) is >= the graph size ({len(B)***REMOVED***).\n"
            "They are either not a valid bipartite partition or contain duplicates"
        )

    for u in nodes:
        unbrs = set(B[u])
        nbrs2 = {n for nbr in unbrs for n in B[nbr]***REMOVED*** - {u***REMOVED***
        for v in nbrs2:
            vnbrs = set(pred[v])
            common = unbrs & vnbrs
            if not ratio:
...
def collaboration_weighted_projected_graph(B, nodes):
    ...
    .. math::
        ...
        w_{u, v***REMOVED*** = \sum_k \frac{\delta_{u***REMOVED***^{k***REMOVED*** \delta_{v***REMOVED***^{k***REMOVED******REMOVED***{d_k - 1***REMOVED***
    ...
    network and `\delta_{u***REMOVED***^{k***REMOVED***` is 1 if node `u` is
    ...
    ...     print(edge)
    ...
    (0, 2, {'weight': 0.5***REMOVED***)
    (0, 5, {'weight': 0.5***REMOVED***)
    (2, 4, {'weight': 1.0***REMOVED***)
    (2, 5, {'weight': 0.5***REMOVED***)
    ...
    for u in nodes:
        unbrs = set(B[u])
        nbrs2 = {n for nbr in unbrs for n in B[nbr] if n != u***REMOVED***
        for v in nbrs2:
            vnbrs = set(pred[v])
...
def overlap_weighted_projected_graph(B, nodes, jaccard=True):
    ...
    .. math::
        ...
        w_{v, u***REMOVED*** = \frac{|N(u) \cap N(v)|***REMOVED***{|N(u) \cup N(v)|***REMOVED***
    ...
    .. math::
        ...
        w_{v, u***REMOVED*** = \frac{|N(u) \cap N(v)|***REMOVED***{min(|N(u)|, |N(v)|)***REMOVED***
    ...
    [0, 2, 4]
    >>> list(G.edges(data=True))
    [(0, 2, {'weight': 0.5***REMOVED***), (2, 4, {'weight': 0.5***REMOVED***)]
    >>> G = bipartite.overlap_weighted_projected_graph(B, nodes, jaccard=False)
    >>> list(G.edges(data=True))
    [(0, 2, {'weight': 1.0***REMOVED***), (2, 4, {'weight': 1.0***REMOVED***)]
...
def generic_weighted_projected_graph(B, nodes, weight_function=None):
    ...
    ...     print(edge)
    ...
    (0, 2, {'weight': 1***REMOVED***)
    (0, 3, {'weight': 2***REMOVED***)
    (1, 2, {'weight': 3***REMOVED***)
    (1, 3, {'weight': 4***REMOVED***)
    >>> # By default, the weight is the number of shared neighbors
    >>> G = bipartite.generic_weighted_projected_graph(B, [0, 1])
    >>> print(list(G.edges(data=True)))
    [(0, 1, {'weight': 2***REMOVED***)]
    >>> # To specify a custom weight function use the weight_function parameter
    >>> G = bipartite.generic_weighted_projected_graph(
    ...     B, [0, 1], weight_function=jaccard
    ... )
    >>> print(list(G.edges(data=True)))
    [(0, 1, {'weight': 1.0***REMOVED***)]
    >>> G = bipartite.generic_weighted_projected_graph(
    ...     B, [0, 1], weight_function=my_weight
    ... )
    >>> print(list(G.edges(data=True)))
    [(0, 1, {'weight': 10***REMOVED***)]
    ...
    G.add_nodes_from((n, B.nodes[n]) for n in nodes)
    for u in nodes:
        nbrs2 = {n for nbr in set(B[u]) for n in B[nbr]***REMOVED*** - {u***REMOVED***
        for v in nbrs2:
