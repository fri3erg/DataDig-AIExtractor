...
def test_karate_club_partition():
    ...
    part = [
        {0, 1, 2, 3, 7, 9, 11, 12, 13, 17, 19, 21***REMOVED***,
        {16, 4, 5, 6, 10***REMOVED***,
        {23, 25, 27, 28, 24, 31***REMOVED***,
        {32, 33, 8, 14, 15, 18, 20, 22, 26, 29, 30***REMOVED***,
    ]
...
def test_directed_partition():
    ...
    G_expected_partition = [{0, 1, 2***REMOVED***, {3, 4***REMOVED***, {5***REMOVED***, {6***REMOVED***, {8, 7***REMOVED***, {9, 10***REMOVED***]
    G_partition = nx.community.louvain_communities(G, seed=123, weight=None)

    H_expected_partition = [{2, 3, 4, 5***REMOVED***, {8, 1, 6, 7***REMOVED***, {9, 10, 11***REMOVED***]
...
def test_none_weight_param():
    ...
    nx.set_edge_attributes(
        G, {edge: i * i for i, edge in enumerate(G.edges)***REMOVED***, name="foo"
    )
...
def test_empty_graph():
    ...
    expected = [{0***REMOVED***, {1***REMOVED***, {2***REMOVED***, {3***REMOVED***, {4***REMOVED***]
