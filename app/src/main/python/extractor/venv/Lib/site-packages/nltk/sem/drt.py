...
***REMOVED***:
                drs = DRS(
                    list(set(drs.refs) - {cond.second.variable***REMOVED***),
        ...
        if isinstance(other, DRS):
            if len(self.refs) == len(other.refs):
                ...
                if self.consequent == converted_other.consequent and len(
                    self.conds
    ***REMOVED*** == len(converted_other.conds):
...
***REMOVED***, "Can only replace a proposition label with a variable"
...
***REMOVED***
    ...
    def __str__(self):
        return f"prop({self.variable***REMOVED***, {self.drs***REMOVED***)"
...
***REMOVED***  # the line separating refs from conds
