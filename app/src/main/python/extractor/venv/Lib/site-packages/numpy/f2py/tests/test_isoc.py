...
def test_process_f2cmap_dict():
    ...
    f2cmap_all = {"integer": {"8": "rubbish_type"***REMOVED******REMOVED***
    new_map = {"INTEGER": {"4": "int"***REMOVED******REMOVED***
    c2py_map = {"int": "int", "rubbish_type": "long"***REMOVED***

    exp_map, exp_maptyp = ({"integer": {"8": "rubbish_type", "4": "int"***REMOVED******REMOVED***, ["int"])
