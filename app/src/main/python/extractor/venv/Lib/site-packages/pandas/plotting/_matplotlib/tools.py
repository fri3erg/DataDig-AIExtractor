...
def _get_layout(
    ...
    if layout is not None:
        ...
        if nrows * ncols < nplots:
            raise ValueError(
                f"Layout of {nrows***REMOVED***x{ncols***REMOVED*** must be larger than required size {nplots***REMOVED***"
***REMOVED***
    ...
    layouts = {1: (1, 1), 2: (1, 2), 3: (2, 2), 4: (2, 2)***REMOVED***
    try:
...
def create_subplots(
    ...
    **fig_kw,
    ...
    layout_type : {'box', 'horizontal', 'vertical'***REMOVED***, default 'box'
    ...
    ***REMOVED***
            if ax.size == naxes:
                ...
                raise ValueError(
                    f"The number of passed axes must be {naxes***REMOVED***, the "
