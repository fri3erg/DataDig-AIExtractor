...
def andrews_curves(
    ...
    **kwargs,
    ...
    .. math::
        f(t) = \\frac{x_1***REMOVED***{\\sqrt{2***REMOVED******REMOVED*** + x_2 \\sin(t) + x_3 \\cos(t) +
...
class _Options(dict):
    ...
    _ALIASES = {"x_compat": "xaxis.compat"***REMOVED***
    ...
    def __getitem__(self, key):
        ...
        if key not in self:
            raise ValueError(f"{key***REMOVED*** is not a valid pandas plotting option")
    ...
    def __delitem__(self, key) -> None:
        ...
        if key in self._DEFAULT_KEYS:
            raise ValueError(f"Cannot remove default parameter {key***REMOVED***")
