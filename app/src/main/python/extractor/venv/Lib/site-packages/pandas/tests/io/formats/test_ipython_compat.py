...
class TestTableSchemaRepr:
    def test_publishes(self, ip):
        ...
        expected_keys = [
            {"text/plain", "application/vnd.dataresource+json"***REMOVED***,
            {"text/plain", "text/html", "application/vnd.dataresource+json"***REMOVED***,
        ]
    ...
    def test_publishes_not_implemented(self, ip):
        ...
        expected = {"text/plain", "text/html"***REMOVED***
        assert set(formatted[0].keys()) == expected
