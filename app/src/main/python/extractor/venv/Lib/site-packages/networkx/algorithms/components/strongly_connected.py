...
def strongly_connected_components(G):
    ...
    neighbors = {v: iter(G[v]) for v in G***REMOVED***
    for source in G:
...
def kosaraju_strongly_connected_components(G, source=None):
    ...
    while post:
        ...
        new = {v for v in c if v not in seen***REMOVED***
        seen.update(new)
        yield new
...
def condensation(G, scc=None):
    ...
    >>> H = nx.condensation(G)
    >>> H.nodes.data()
    NodeDataView({0: {'members': {0, 1, 2, 3***REMOVED******REMOVED***, 1: {'members': {4, 5, 6, 7***REMOVED******REMOVED******REMOVED***)
    >>> H.graph['mapping']
    {0: 0, 1: 0, 2: 0, 3: 0, 4: 1, 5: 1, 6: 1, 7: 1***REMOVED***
    ...
    NodeView((0,))
    >>> H.nodes.data()
    NodeDataView({0: {'members': {0, 1, 2, 3, 4, 5, 6***REMOVED******REMOVED******REMOVED***)
