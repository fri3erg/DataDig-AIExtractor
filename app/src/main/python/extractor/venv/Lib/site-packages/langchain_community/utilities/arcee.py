...
class ArceeRoute(str, Enum):
    ...
    model_training_status = "models/status/{id_or_name***REMOVED***"
...
class ArceeWrapper:
    ...
    def __init__(
        ...
        try:
            ...
            raise ValueError(
                f"Error while validating model training status for '{model_name***REMOVED***': {e***REMOVED***"
***REMOVED*** from e

    def validate_model_training_status(self) -> None:
        if self.model_training_status != "training_complete":
            raise Exception(
                f"Model {self.model_id***REMOVED*** is not ready. "
...
***REMOVED***
    ...
    def _make_request(
        ...
        if response.status_code not in (200, 201):
            raise Exception(f"Failed to make request. Response: {response.text***REMOVED***")
    ...
    def _make_request_headers(self, headers: Optional[Dict] = None) -> Dict:
        ...
        if not isinstance(self.arcee_api_key, SecretStr):
            raise TypeError(
                f"arcee_api_key must be a SecretStr. Got {type(self.arcee_api_key)***REMOVED***"
***REMOVED***
    ...
    def _make_request_url(self, route: Union[ArceeRoute, str]) -> str:
        return f"{self.arcee_api_url***REMOVED***/{self.arcee_api_version***REMOVED***/{route***REMOVED***"
...
***REMOVED***,
    ...
    def retrieve(
        ...
        **kwargs: Any,
        ...
        """Retrieve {size***REMOVED*** contexts with your retriever for a given query
