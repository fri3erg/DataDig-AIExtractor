    ...
    def test_dti_cmp_datetimelike(self, other, tz_naive_fixture):
        ...
        if tz is not None:
            if isinstance(other, np.datetime64):
                pytest.skip(f"{type(other).__name__***REMOVED*** is not tz aware")
...
***REMOVED***
    ...
    def test_scalar_comparison_tzawareness(
        ...
        if op in [operator.eq, operator.ne]:
            ...
            msg = (
                r"Invalid comparison between dtype=datetime64\[ns, .*\] "
                f"and {type(other).__name__***REMOVED***"
***REMOVED***
            with pytest.raises(TypeError, match=msg):
                op(dtarr, other)
            with pytest.raises(TypeError, match=msg):
...
class TestDatetime64Arithmetic:
    ...
    def test_dt64arr_sub_NaT(self, box_with_array, unit):
        ...
        result = ser - NaT
        expected = Series([NaT, NaT], dtype=f"timedelta64[{unit***REMOVED***]")
        expected = tm.box_expected(expected, box_with_array)
        tm.assert_equal(result, expected)
...
***REMOVED***
    ...
    def test_dt64arr_add_sub_relativedelta_offsets(self, box_with_array, unit):
        ...
        for i, (offset_unit, value) in enumerate(relative_kwargs):
            off = DateOffset(**{offset_unit: value***REMOVED***)
    ...
    @pytest.mark.parametrize(
        ...
        [
            "YearBegin",
            ("YearBegin", {"month": 5***REMOVED***),
            "YearEnd",
            ("YearEnd", {"month": 5***REMOVED***),
            "MonthBegin",
            "MonthEnd",
            "SemiMonthEnd",
            "SemiMonthBegin",
            "Week",
            ("Week", {"weekday": 3***REMOVED***),
            "Week",
            ("Week", {"weekday": 6***REMOVED***),
            "BusinessDay",
            "BDay",
            "QuarterEnd",
            "QuarterBegin",
            ...
            "BYearEnd",
            "BQuarterBegin",
            ("LastWeekOfMonth", {"weekday": 2***REMOVED***),
            (
                "FY5253Quarter",
                {
                ...
                ***REMOVED***,
***REMOVED***,
            ("FY5253", {"weekday": 0, "startingMonth": 2, "variation": "nearest"***REMOVED***),
            ("WeekOfMonth", {"weekday": 2, "week": 2***REMOVED***),
            "Easter",
            ("DateOffset", {"day": 4***REMOVED***),
            ("DateOffset", {"month": 5***REMOVED***),
        ],
    )
...
***REMOVED***:
    ...
    def test_datetime64_ops_nat(self, unit):
        ...
        nat_series_dtype_timestamp = Series([NaT, NaT], dtype=f"datetime64[{unit***REMOVED***]")
        single_nat_dtype_datetime = Series([NaT], dtype=f"datetime64[{unit***REMOVED***]")
...
def test_shift_months(years, months, unit):
    ...
    shifted_dt64 = shifted.view(f"M8[{dti.unit***REMOVED***]")
