...
def group_betweenness_centrality(G, C, normalized=True, weight=None, endpoints=False):
    ...
    .. math::
       ...
       c_B(v) =\sum_{s,t \in V***REMOVED*** \frac{\sigma(s, t|v)***REMOVED***{\sigma(s, t)***REMOVED***
    ...
    set_v = {node for group in C for node in group***REMOVED***
    if set_v - G.nodes:  # element(s) of C not in G
        raise nx.NodeNotFound(f"The node(s) {set_v - G.nodes***REMOVED*** are in C but not in G.")
...
def prominent_group(
    ...
    if C is not None:
        ...
        if C - G.nodes:  # element(s) of C not in G
            raise nx.NodeNotFound(f"The node(s) {C - G.nodes***REMOVED*** are in C but not in G.")
...
def group_closeness_centrality(G, S, weight=None):
    ...
    .. math::
       ...
       c_{close***REMOVED***(S) = \frac{|V-S|***REMOVED***{\sum_{v \in V-S***REMOVED*** d_{S, v***REMOVED******REMOVED***

       d_{S, v***REMOVED*** = min_{u \in S***REMOVED*** (d_{u, v***REMOVED***)

    where $V$ is the set of nodes, $d_{S, v***REMOVED***$ is the distance of
