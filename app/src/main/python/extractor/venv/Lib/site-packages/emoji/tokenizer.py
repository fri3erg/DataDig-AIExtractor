...
class EmojiMatch:
    ...
    def __repr__(self) -> str:
        return f'{self.__class__.__name__***REMOVED***({self.emoji***REMOVED***, {self.start***REMOVED***:{self.end***REMOVED***)'
...
class EmojiMatchZWJ(EmojiMatch):
    ...
    def __repr__(self) -> str:
        return f'{self.__class__.__name__***REMOVED***({self.join()***REMOVED***, {self.start***REMOVED***:{self.end***REMOVED***)'
...
def get_search_tree() -> Dict[str, Any]:
    ...
    Example of a search tree::
        ...
        'b': {'en': ':Bus:'***REMOVED***,
        'ba': {'en': ':Bat:'***REMOVED***,
        'band': {'en': ':Beatles:'***REMOVED***,
        'bandit': {'en': ':Outlaw:'***REMOVED***,
        'bank': {'en': ':BankOfEngland:'***REMOVED***,
        'bb': {'en': ':BB-gun:'***REMOVED***,
        'c': {'en': ':Car:'***REMOVED******REMOVED***

        _SEARCH_TREE =
        {'a': {'data': {'en': ':Apple:'***REMOVED******REMOVED***,
        'b': {'a': {'data': {'en': ':Bat:'***REMOVED***,
                    'n': {'d': {'data': {'en': ':Beatles:'***REMOVED***,
                                'i': {'t': {'data': {'en': ':Outlaw:'***REMOVED******REMOVED******REMOVED******REMOVED***,
                        'k': {'data': {'en': ':BankOfEngland:'***REMOVED******REMOVED******REMOVED******REMOVED***,
            'b': {'data': {'en': ':BB-gun:'***REMOVED******REMOVED***,
            'data': {'en': ':Bus:'***REMOVED******REMOVED***,
        'c': {'data': {'en': ':Car:'***REMOVED******REMOVED******REMOVED***
