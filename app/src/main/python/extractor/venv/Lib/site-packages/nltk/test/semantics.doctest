...
Parse a valuation from a string.
    ...
    ... dog => {d1, d2***REMOVED***
    ... bark => {d1, d2***REMOVED***
    ... walk => {b1, g2, d1***REMOVED***
    ... chase => {(b1, g1), (b2, g1), (g1, d1), (g2, d2)***REMOVED***
    ... see => {(b1, g1), (b2, d2), (g1, b1),(d2, b1), (g2, n)***REMOVED***
    ... in => {(b1, n), (b2, n), (d2, n)***REMOVED***
    ... with => {(b1, g1), (g1, b1), (d1, b1), (b1, d1)***REMOVED***
    ... """
    ...
    {'bark': set([('d1',), ('d2',)]),
     ...
     'tess': 'd2',
     'walk': set([('d1',), ('b1',), ('g2',)]),
     'with': set([('b1', 'g1'), ('d1', 'b1'), ('b1', 'd1'), ('g1', 'b1')])***REMOVED***
...
Extension of Lambda expressions
    ...
    >>> print(m0.evaluate(r'\x. \y. love(x, y)', g0) == {'g2': {'g2': False, 'b2': False, 'b1': True, 'g1': False, 'd1': False***REMOVED***, 'b2': {'g2': True, 'b2': False, 'b1': False, 'g1': False, 'd1': False***REMOVED***, 'b1': {'g2': False, 'b2': False, 'b1': False, 'g1': True, 'd1': False***REMOVED***, 'g1': {'g2': False, 'b2': False, 'b1': True, 'g1': False, 'd1': False***REMOVED***, 'd1': {'g2': False, 'b2': False, 'b1': False, 'g1': False, 'd1': False***REMOVED******REMOVED***)
    True
    >>> print(m0.evaluate(r'\x. dog(x) (adam)', g0))
    False
    >>> print(m0.evaluate(r'\x. (dog(x) | boy(x)) (adam)', g0))
    True
    >>> print(m0.evaluate(r'\x. \y. love(x, y)(fido)', g0) == {'g2': False, 'b2': False, 'b1': False, 'g1': False, 'd1': False***REMOVED***)
    True
    >>> print(m0.evaluate(r'\x. \y. love(x, y)(adam)', g0) == {'g2': False, 'b2': False, 'b1': False, 'g1': True, 'd1': False***REMOVED***)
    True
    >>> print(m0.evaluate(r'\x. \y. love(x, y)(betty)', g0) == {'g2': False, 'b2': False, 'b1': True, 'g1': False, 'd1': False***REMOVED***)
    True
    ...
    True
    >>> print(m0.evaluate(r'\x. exists y. love(x, y)', g0) == {'g2': True, 'b2': True, 'b1': True, 'g1': True, 'd1': False***REMOVED***)
    True
    >>> print(m0.evaluate(r'\z. adam', g0) == {'g2': 'b1', 'b2': 'b1', 'b1': 'b1', 'g1': 'b1', 'd1': 'b1'***REMOVED***)
    True
    >>> print(m0.evaluate(r'\z. love(x, y)', g0) == {'g2': False, 'b2': False, 'b1': False, 'g1': False, 'd1': False***REMOVED***)
    True
...
--------------------------
    ...
    ...     ('adam = mia', 'Undefined'),
    ...     ('\\x. (boy(x) | girl(x))', {'g2': True, 'b2': True, 'b1': True, 'g1': True, 'd1': False***REMOVED***),
    ...     ('\\x. exists y. (boy(x) & love(x, y))', {'g2': False, 'b2': True, 'b1': True, 'g1': False, 'd1': False***REMOVED***),
