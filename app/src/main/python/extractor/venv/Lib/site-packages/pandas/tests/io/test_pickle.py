...
def compare_element(result, expected, typ):
    ...
    if typ.startswith("sp_"):
        ...
        comparator = getattr(tm, f"assert_{typ***REMOVED***_equal", tm.assert_almost_equal)
...
@pytest.fixture
def get_random_path():
    return f"__{uuid.uuid4()***REMOVED***__.pickle"
...
def test_pickle_generalurl_read(monkeypatch, mockurl):
    ...
    class MockReadResponse:
        def __init__(self, path) -> None:
            ...
            if "gzip" in path:
                self.headers = {"Content-Encoding": "gzip"***REMOVED***
            else:
                self.headers = {"Content-Encoding": ""***REMOVED***
