...
def _init_socks5_connection(
    ...
    *,
    ...
    if response.method != auth_method:
        ...
        raise ProxyError(
            f"Requested {requested***REMOVED*** from proxy server, but got {responded***REMOVED***."
        )
    ...
    if response.reply_code != socks5.SOCKS5ReplyCode.SUCCEEDED:
        ...
        raise ProxyError(f"Proxy Server could not connect: {reply_code***REMOVED***.")
...
***REMOVED***
    ...
    def __repr__(self) -> str:
        return f"<{self.__class__.__name__***REMOVED*** [{self.info()***REMOVED***]>"
