...
def validate_jinja2(template: str, input_variables: List[str]) -> None:
    ...
    if missing_variables:
        warning_message += f"Missing variables: {missing_variables***REMOVED*** "

    if extra_variables:
        warning_message += f"Extra variables: {extra_variables***REMOVED***"
...
def check_valid_template(
    ...
    try:
        ...
        raise ValueError(
            f"Invalid template format {template_format!r***REMOVED***, should be one of"
            f" {list(DEFAULT_FORMATTER_MAPPING)***REMOVED***."
        ) from exc
    try:
        ...
        raise ValueError(
            ...
            f" from {input_variables***REMOVED***."
        ) from exc
...
def get_template_variables(template: str, template_format: str) -> List[str]:
    ...
    if template_format == "jinja2":
        ...
        ***REMOVED***
        ...
        raise ValueError(f"Unsupported template format: {template_format***REMOVED***")
