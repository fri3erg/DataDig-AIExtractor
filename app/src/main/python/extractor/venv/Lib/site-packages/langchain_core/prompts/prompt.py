    ...
    *Security warning*: Prefer using `template_format="f-string"` instead of
    ...
    Example:
        ...
        .. code-block:: python
            ...
            prompt = PromptTemplate.from_template("Say {foo***REMOVED***")
            prompt.format(foo="bar")

            # Instantiation using initializer
            prompt = PromptTemplate(input_variables=["foo"], template="Say {foo***REMOVED***")
    """
...
***REMOVED***
            ...
            partial_variables = {k: v for k, v in self.partial_variables.items()***REMOVED***
...
***REMOVED***
    ...
    def from_template(
        ...
        *Security warning*: Prefer using `template_format="f-string"` instead of
        ...
        _partial_variables = partial_variables or {***REMOVED***
