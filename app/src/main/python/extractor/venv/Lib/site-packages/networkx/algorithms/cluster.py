...
def triangles(G, nodes=None):
    ...
    if nodes is not None:
        ...
        return {v: t // 2 for v, d, t, _ in _triangles_and_degree_iter(G, nodes)***REMOVED***
...
def _triangles_and_degree_iter(G, nodes=None):
    ...
    for v, v_nbrs in nodes_nbrs:
        vs = set(v_nbrs) - {v***REMOVED***
        gen_degree = Counter(len(vs & (set(G[w]) - {w***REMOVED***)) for w in vs)
...
def _directed_triangles_and_degree_iter(G, nodes=None):
    ...
    for i, preds, succs in nodes_nbrs:
        ipreds = set(preds) - {i***REMOVED***
        isuccs = set(succs) - {i***REMOVED***

        directed_triangles = 0
        for j in chain(ipreds, isuccs):
            jpreds = set(G._pred[j]) - {j***REMOVED***
            jsuccs = set(G._succ[j]) - {j***REMOVED***
...
def average_clustering(G, nodes=None, weight=None, count_zeros=True):
    ...
    .. math::
       ...
       C = \frac{1***REMOVED***{n***REMOVED***\sum_{v \in G***REMOVED*** c_v,
...
def clustering(G, nodes=None, weight=None):
    ...
    .. math::
      ...
      c_u = \frac{2 T(u)***REMOVED***{deg(u)(deg(u)-1)***REMOVED***,
    ...
    .. math::
       ...
       c_u = \frac{1***REMOVED***{deg(u)(deg(u)-1))***REMOVED***
             \sum_{vw***REMOVED*** (\hat{w***REMOVED***_{uv***REMOVED*** \hat{w***REMOVED***_{uw***REMOVED*** \hat{w***REMOVED***_{vw***REMOVED***)^{1/3***REMOVED***.

    The edge weights :math:`\hat{w***REMOVED***_{uv***REMOVED***` are normalized by the maximum weight
    in the network :math:`\hat{w***REMOVED***_{uv***REMOVED*** = w_{uv***REMOVED***/\max(w)`.
    ...
    .. math::
       ...
       c_u = \frac{T(u)***REMOVED***{2(deg^{tot***REMOVED***(u)(deg^{tot***REMOVED***(u)-1) - 2deg^{\leftrightarrow***REMOVED***(u))***REMOVED***,

    where :math:`T(u)` is the number of directed triangles through node
    :math:`u`, :math:`deg^{tot***REMOVED***(u)` is the sum of in degree and out degree of
    :math:`u` and :math:`deg^{\leftrightarrow***REMOVED***(u)` is the reciprocal degree of
    :math:`u`.
    ...
    {0: 1.0, 1: 1.0, 2: 1.0, 3: 1.0, 4: 1.0***REMOVED***
    ...
    if G.is_directed():
        ...
        if weight is not None:
            ...
            clusterc = {v: 0 if t == 0 else t / (d * (d - 1)) for v, d, t in td_iter***REMOVED***
        else:
            td_iter = _triangles_and_degree_iter(G, nodes)
            clusterc = {v: 0 if t == 0 else t / (d * (d - 1)) for v, d, t, _ in td_iter***REMOVED***
    if nodes in G:
...
def transitivity(G):
    ...
    .. math::
        ...
        T = 3\frac{\#triangles***REMOVED***{\#triads***REMOVED***.
...
def square_clustering(G, nodes=None):
    ...
    .. math::
       C_4(v) = \frac{ \sum_{u=1***REMOVED***^{k_v***REMOVED***
       \sum_{w=u+1***REMOVED***^{k_v***REMOVED*** q_v(u,w) ***REMOVED***{ \sum_{u=1***REMOVED***^{k_v***REMOVED***
       \sum_{w=u+1***REMOVED***^{k_v***REMOVED*** [a_v(u,w) + q_v(u,w)]***REMOVED***,
    ...
    (1+q_v(u,w)+\theta_{uv***REMOVED***)) + (k_w - (1+q_v(u,w)+\theta_{uw***REMOVED***))`, where
    :math:`\theta_{uw***REMOVED*** = 1` if :math:`u` and :math:`w` are connected and 0
    otherwise. [2]_
    ...
    for v in node_iter:
        ...
        for u, w in combinations(G[v], 2):
            squares = len((set(G[u]) & set(G[w])) - {v***REMOVED***)
...
def generalized_degree(G, nodes=None):
    ...
    :math:`\mathbf{k***REMOVED***_i=(k_i^{(0)***REMOVED***, \dotsc, k_i^{(N-2)***REMOVED***)` where
    :math:`k_i^{(j)***REMOVED***` is the number of edges attached to node :math:`i` that
    ...
    {0: Counter({3: 4***REMOVED***), 1: Counter({3: 4***REMOVED***), 2: Counter({3: 4***REMOVED***), 3: Counter({3: 4***REMOVED***), 4: Counter({3: 4***REMOVED***)***REMOVED***
    ...
    the generalized degree :math:`\mathbf{k***REMOVED***_i=(k_i^{(0)***REMOVED***, \dotsc,
    k_i^{(N-2)***REMOVED***)` by :math:`(k_i^{(1)***REMOVED***+2k_i^{(2)***REMOVED***+\dotsc +(N-2)k_i^{(N-2)***REMOVED***)/2`.
    ...
    return {v: gd for v, d, t, gd in _triangles_and_degree_iter(G, nodes)***REMOVED***
