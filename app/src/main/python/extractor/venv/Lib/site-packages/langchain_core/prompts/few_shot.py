...
***REMOVED***
    ...
    ***REMOVED***
    ...
    def format(self, **kwargs: Any) -> str:
        ...
        examples = [
            {k: e[k] for k in self.example_prompt.input_variables***REMOVED*** for e in examples
        ]
        # Format the examples.
        example_strings = [
...
***REMOVED***
            ...
            examples = [
                {"input": "2+2", "output": "4"***REMOVED***,
                {"input": "2+3", "output": "5"***REMOVED***,
            ]

            example_prompt = ChatPromptTemplate.from_messages(
                [('human', '{input***REMOVED***'), ('ai', '{output***REMOVED***')]
***REMOVED***
...
***REMOVED***
            ...
            few_shot_prompt = FewShotChatMessagePromptTemplate(
                ...
                example_prompt=(
                    ...
                    + AIMessagePromptTemplate.from_template("{output***REMOVED***")
    ***REMOVED***,
***REMOVED***
...
***REMOVED***
            ...
            chain.invoke({"input": "What's 3+3?"***REMOVED***)
    """
