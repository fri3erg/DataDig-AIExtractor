...
def analyze_text(
    ...
    ***REMOVED***
    resp.update({"text_complexity_metrics": text_complexity_metrics***REMOVED***)
...
def construct_html_from_prompt_and_generation(prompt: str, generation: str) -> Any:
    ...
    return f"""
    <p style="color:black;">{formatted_prompt***REMOVED***:</p>
    <blockquote>
      <p style="color:green;">
        {formatted_generation***REMOVED***
      </p>
    </blockquote>
    """
...
***REMOVED***
    ...
    def html(self, html: str, filename: str) -> None:
        ...
        with self.mlflow.start_run(
            ...
            self.mlflow.log_text(html, f"{filename***REMOVED***.html")
    ...
    def text(self, text: str, filename: str) -> None:
        ...
        with self.mlflow.start_run(
            ...
            self.mlflow.log_text(text, f"{filename***REMOVED***.txt")
...
class MlflowCallbackHandler(BaseMetadataCallbackHandler, BaseCallbackHandler):
    ...
    and adds the response to the list of records for both the {method***REMOVED***_records and
    ...
    def on_llm_start(
        ...
        resp: Dict[str, Any] = {***REMOVED***
        resp.update({"action": "on_llm_start"***REMOVED***)
        ...
        for idx, prompt in enumerate(prompts):
            ...
            self.mlflg.jsonf(prompt_resp, f"llm_start_{llm_starts***REMOVED***_prompt_{idx***REMOVED***")
    ...
    def on_llm_new_token(self, token: str, **kwargs: Any) -> None:
        ...
        resp: Dict[str, Any] = {***REMOVED***
        resp.update({"action": "on_llm_new_token", "token": token***REMOVED***)
        resp.update(self.metrics)
        ...
        self.mlflg.jsonf(resp, f"llm_new_tokens_{llm_streams***REMOVED***")
    ...
    def on_llm_end(self, response: LLMResult, **kwargs: Any) -> None:
        ...
        resp: Dict[str, Any] = {***REMOVED***
        resp.update({"action": "on_llm_end"***REMOVED***)
        resp.update(flatten_dict(response.llm_output or {***REMOVED***))
        resp.update(self.metrics)
    ...
    ***REMOVED***
                ...
                self.mlflg.jsonf(resp, f"llm_end_{llm_ends***REMOVED***_generation_{idx***REMOVED***")
    ...
    def on_chain_start(
        ...
        resp: Dict[str, Any] = {***REMOVED***
        resp.update({"action": "on_chain_start"***REMOVED***)
        resp.update(flatten_dict(serialized))
        resp.update(self.metrics)

        self.mlflg.metrics(self.metrics, step=self.metrics["step"])

        chain_input = ",".join([f"{k***REMOVED***={v***REMOVED***" for k, v in inputs.items()])
        input_resp = deepcopy(resp)
        input_resp["inputs"] = chain_input
        self.records["on_chain_start_records"].append(input_resp)
        self.records["action_records"].append(input_resp)
        self.mlflg.jsonf(input_resp, f"chain_start_{chain_starts***REMOVED***")
    ...
    def on_chain_end(self, outputs: Dict[str, Any], **kwargs: Any) -> None:
        ...
        resp: Dict[str, Any] = {***REMOVED***
        chain_output = ",".join([f"{k***REMOVED***={v***REMOVED***" for k, v in outputs.items()])
        resp.update({"action": "on_chain_end", "outputs": chain_output***REMOVED***)
        resp.update(self.metrics)
        ...
        self.records["action_records"].append(resp)
        self.mlflg.jsonf(resp, f"chain_end_{chain_ends***REMOVED***")
    ...
    def on_tool_start(
        ...
        resp: Dict[str, Any] = {***REMOVED***
        resp.update({"action": "on_tool_start", "input_str": input_str***REMOVED***)
        resp.update(flatten_dict(serialized))
        resp.update(self.metrics)
        ...
        self.records["action_records"].append(resp)
        self.mlflg.jsonf(resp, f"tool_start_{tool_starts***REMOVED***")
    ...
    def on_tool_end(self, output: str, **kwargs: Any) -> None:
        ...
        resp: Dict[str, Any] = {***REMOVED***
        resp.update({"action": "on_tool_end", "output": output***REMOVED***)
        resp.update(self.metrics)
        ...
        self.records["action_records"].append(resp)
        self.mlflg.jsonf(resp, f"tool_end_{tool_ends***REMOVED***")
    ...
    def on_text(self, text: str, **kwargs: Any) -> None:
        ...
        resp: Dict[str, Any] = {***REMOVED***
        resp.update({"action": "on_text", "text": text***REMOVED***)
        resp.update(self.metrics)
        ...
        self.records["action_records"].append(resp)
        self.mlflg.jsonf(resp, f"on_text_{text_ctr***REMOVED***")
    ...
    def on_agent_finish(self, finish: AgentFinish, **kwargs: Any) -> None:
        ...
        self.records["action_records"].append(resp)
        self.mlflg.jsonf(resp, f"agent_finish_{agent_ends***REMOVED***")
    ...
    def on_agent_action(self, action: AgentAction, **kwargs: Any) -> Any:
        ...
        self.records["action_records"].append(resp)
        self.mlflg.jsonf(resp, f"agent_action_{tool_starts***REMOVED***")
...
***REMOVED***
        ...
        llm_input_prompts_df = (
            ...
            .dropna(axis=1)
            .rename({"step": "prompt_step"***REMOVED***, axis=1)
        )
        ...
        llm_outputs_df = (
            ...
            .dropna(axis=1)
            .rename({"step": "output_step", "text": "output"***REMOVED***, axis=1)
        )
