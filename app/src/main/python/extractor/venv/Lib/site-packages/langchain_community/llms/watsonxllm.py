...
***REMOVED***
    ...
    def _extract_token_usage(
        ...
        if response is None:
            return {"generated_token_count": 0, "input_token_count": 0***REMOVED***
        ...
        for res in response:
            ...
            if results:
                ...
                gen = Generation(
                    ...
                    generation_info={"finish_reason": finish_reason***REMOVED***,
    ***REMOVED***
...
***REMOVED***,
    ...
    def _generate(
        ...
        **kwargs: Any,
        ...
        if stop:
            if self.params:
                self.params.update({"stop_sequences": stop***REMOVED***)
            else:
                self.params = {"stop_sequences": stop***REMOVED***
        should_stream = stream if stream is not None else self.streaming
        if should_stream:
            if len(prompts) > 1:
                raise ValueError(
                    f"WatsonxLLM currently only supports single prompt, got {prompts***REMOVED***"
    ***REMOVED***
