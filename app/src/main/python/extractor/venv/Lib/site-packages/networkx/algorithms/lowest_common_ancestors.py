...
def all_pairs_lowest_common_ancestor(G, pairs=None):
    ...
    {(0, 0): 0, (0, 1): 0, (0, 3): 0, (0, 2): 0, (1, 1): 1, (1, 3): 0, (1, 2): 1, (3, 3): 3, (3, 2): 0, (2, 2): 2***REMOVED***
...
def tree_all_pairs_lowest_common_ancestor(G, root=None, pairs=None):
    ...
    if pairs is not None:
        ...
        for u, v in pairs:
            for n in (u, v):
                if n not in G:
                    msg = f"The node {str(n)***REMOVED*** is not in the digraph."
