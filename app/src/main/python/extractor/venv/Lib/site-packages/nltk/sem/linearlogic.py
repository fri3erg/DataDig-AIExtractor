...
class LinearLogicParser(LogicParser):
    ...
    def __init__(self):
        ...
        self.operator_precedence = {APP: 1, Tokens.IMP: 2, None: 3***REMOVED***
...
class Expression:
    ...
    def __repr__(self):
        return f"<{self.__class__.__name__***REMOVED*** {self***REMOVED***>"
...
***REMOVED***
    ...
    def compile_neg(self, index_counter, glueFormulaFactory):
        ...
        new_v = glueFormulaFactory("v%s" % fresh_index, a, {fresh_index***REMOVED***)
    ...
    def __str__(self):
        return "{***REMOVED***{***REMOVED*** {***REMOVED*** {***REMOVED***{***REMOVED***".format(
            Tokens.OPEN,
            self.antecedent,
            Tokens.IMP,
            self.consequent,
    ...
    def __hash__(self):
        return hash(f"{hash(self.antecedent)***REMOVED***{Tokens.IMP***REMOVED***{hash(self.consequent)***REMOVED***")
    ...
    def __init__(self, function, argument, argument_indices=None):
        ...
        try:
            ...
            raise LinearLogicApplicationException(
                f"Cannot apply {function_simp***REMOVED*** to {argument_simp***REMOVED***. {e***REMOVED***"
***REMOVED*** from e
    ...
    ***REMOVED***
    ...
    def __hash__(self):
        return hash(f"{hash(self.antecedent)***REMOVED***{Tokens.OPEN***REMOVED***{hash(self.consequent)***REMOVED***")
...
class BindingDict:
    def __init__(self, bindings=None):
        ...
        :param bindings:
            ...
            dict {``VariableExpression``: ``AtomicExpression``***REMOVED*** to initialize the dictionary
        """
        self.d = {***REMOVED***
...
***REMOVED*** from e
    ...
    def __str__(self):
        return "{" + ", ".join(f"{v***REMOVED***: {self.d[v]***REMOVED***" for v in sorted(self.d.keys())) + "***REMOVED***"
...
class UnificationException(Exception):
    def __init__(self, a, b, bindings):
        Exception.__init__(self, f"Cannot unify {a***REMOVED*** with {b***REMOVED*** given {bindings***REMOVED***")
