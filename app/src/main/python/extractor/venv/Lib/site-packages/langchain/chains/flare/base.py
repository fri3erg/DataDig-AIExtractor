...
class _OpenAIResponseChain(_ResponseChain):
    ...
    llm: OpenAI = Field(
        default_factory=lambda: OpenAI(
            max_tokens=32, model_kwargs={"logprobs": 1***REMOVED***, temperature=0
        )
    )
...
class FlareChain(Chain):
    ...
    def _do_retrieval(
        ...
        _run_manager.on_text(
            f"Generated Questions: {questions***REMOVED***", color="yellow", end="\n"
        )
    ...
    def _call(
        ...
        for i in range(self.max_iter):
            _run_manager.on_text(
                f"Current Response: {response***REMOVED***", color="blue", end="\n"
***REMOVED***
            _input = {"user_input": user_input, "context": "", "response": response***REMOVED***
...
***REMOVED***
            ...
            if not low_confidence_spans:
                ...
                if finished:
                    return {self.output_keys[0]: final_response***REMOVED***
                continue
...
***REMOVED***
            ...
            if finished:
                break
        return {self.output_keys[0]: response***REMOVED***
    ...
    def from_llm(
        ...
        response_llm = OpenAI(
            max_tokens=max_generation_len, model_kwargs={"logprobs": 1***REMOVED***, temperature=0
        )
