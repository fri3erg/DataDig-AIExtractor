...
class Messages(SyncAPIResource):
    ...
    def create(
        ...
        *,
        ...
        return self._post(
            f"/threads/{thread_id***REMOVED***/messages",
...
***REMOVED***,
    ...
    def retrieve(
        ...
        *,
        ...
        extra_headers = {"OpenAI-Beta": "assistants=v1", **(extra_headers or {***REMOVED***)***REMOVED***
        return self._get(
            f"/threads/{thread_id***REMOVED***/messages/{message_id***REMOVED***",
            options=make_request_options(
                extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout
***REMOVED***,
            cast_to=ThreadMessage,
    ...
    def update(
        ...
        *,
        ...
        return self._post(
            f"/threads/{thread_id***REMOVED***/messages/{message_id***REMOVED***",
            body=maybe_transform({"metadata": metadata***REMOVED***, message_update_params.MessageUpdateParams),
            options=make_request_options(
                extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout
***REMOVED***,
            cast_to=ThreadMessage,
