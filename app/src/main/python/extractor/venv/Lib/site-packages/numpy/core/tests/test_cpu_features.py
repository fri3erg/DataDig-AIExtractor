...
class AbstractTest:
    features = []
    features_groups = {***REMOVED***
    features_map = {***REMOVED***
    features_flags = set()
...
***REMOVED***
    ...
    def _expect_error(
        ...
        try:
            ...
            assertion_message = f"Expected: {msg***REMOVED***\nGot: {e.stderr***REMOVED***"
            assert re.search(msg, e.stderr), assertion_message

            assertion_message = (
                f"Expected error of type: {err_type***REMOVED***; see full "
                f"error:\n{e.stderr***REMOVED***"
***REMOVED***
...
***REMOVED***
        ...
        assert set(enabled_features) == {feature***REMOVED***
    ...
    def test_variable_too_long(self, action):
        ...
        self.env[f'NPY_{action***REMOVED***_CPU_FEATURES'] = "t" * MAX_VAR_LENGTH
        msg = (
            f"Length of environment variable 'NPY_{action***REMOVED***_CPU_FEATURES' is "
            f"{MAX_VAR_LENGTH + 1***REMOVED***, only {MAX_VAR_LENGTH***REMOVED*** accepted"
        )
    ...
    def test_impossible_feature_disable(self):
        ...
        msg = (
            f"You cannot disable CPU feature '{bad_feature***REMOVED***', since it is "
    ...
    def test_impossible_feature_enable(self):
        ...
        msg = (
            f"You cannot enable CPU features \\({bad_feature***REMOVED***\\), since "
        ...
        feats = f"{bad_feature***REMOVED***, {self.BASELINE_FEAT***REMOVED***"
        self.env['NPY_ENABLE_CPU_FEATURES'] = feats
        msg = (
            f"You cannot enable CPU features \\({bad_feature***REMOVED***\\), since they "
