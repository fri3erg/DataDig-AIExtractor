...
def test_all_simple_paths():
    ...
    assert {tuple(p) for p in paths***REMOVED*** == {(0, 1, 2, 3)***REMOVED***
...
def test_all_simple_paths_with_two_targets_emits_two_paths():
    ...
    assert {tuple(p) for p in paths***REMOVED*** == {(0, 1, 2, 3), (0, 1, 2, 4)***REMOVED***
...
def test_all_simple_paths_with_two_targets_in_line_emits_two_paths():
    ...
    assert {tuple(p) for p in paths***REMOVED*** == {(0, 1, 2), (0, 1, 2, 3)***REMOVED***
...
def test_all_simple_paths_ignores_cycle():
    ...
    G.add_edge(1, 3)
    paths = nx.all_simple_paths(G, 0, 3)
    assert {tuple(p) for p in paths***REMOVED*** == {(0, 1, 3)***REMOVED***
...
def test_all_simple_paths_with_two_targets_inside_cycle_emits_two_paths():
    ...
    G.add_edge(1, 3)
    paths = nx.all_simple_paths(G, 0, [2, 3])
    assert {tuple(p) for p in paths***REMOVED*** == {(0, 1, 2), (0, 1, 3)***REMOVED***
...
def test_all_simple_paths_cutoff():
    ...
    assert {tuple(p) for p in paths***REMOVED*** == {(0, 1)***REMOVED***
    paths = nx.all_simple_paths(G, 0, 1, cutoff=2)
    assert {tuple(p) for p in paths***REMOVED*** == {(0, 1), (0, 2, 1), (0, 3, 1)***REMOVED***
...
def test_all_simple_paths_on_non_trivial_graph():
    ...
    assert {tuple(p) for p in paths***REMOVED*** == {
        (1, 2),
        (1, 3, 4, 2),
        (1, 5, 4, 2),
        (1, 3),
    ...
    ***REMOVED***
    ...
    assert {tuple(p) for p in paths***REMOVED*** == {(1, 2), (1, 3), (1, 2, 3)***REMOVED***
...
def test_all_simple_paths_multigraph():
    ...
    assert len(paths) == 3
    assert {tuple(p) for p in paths***REMOVED*** == {(1, 2), (1, 2), (1, 10, 2)***REMOVED***
...
def test_all_simple_paths_multigraph_with_cutoff():
    ...
    assert len(paths) == 2
    assert {tuple(p) for p in paths***REMOVED*** == {(1, 2), (1, 2)***REMOVED***
...
def test_all_simple_paths_directed():
    ...
    assert {tuple(p) for p in paths***REMOVED*** == {(1, 2, 3)***REMOVED***
...
def hamiltonian_path(G, source):
    ...
    neighbors = set(G[source]) - {source***REMOVED***
    n = len(G)
...
def test_all_simple_edge_paths():
    ...
    assert {tuple(p) for p in paths***REMOVED*** == {((0, 1), (1, 2), (2, 3))***REMOVED***
...
def test_all_simple_edge_paths_with_two_targets_in_line_emits_two_paths():
    ...
    assert {tuple(p) for p in paths***REMOVED*** == {((0, 1), (1, 2)), ((0, 1), (1, 2), (2, 3))***REMOVED***
...
def test_all_simple_edge_paths_ignores_cycle():
    ...
    G.add_edge(1, 3)
    paths = nx.all_simple_edge_paths(G, 0, 3)
    assert {tuple(p) for p in paths***REMOVED*** == {((0, 1), (1, 3))***REMOVED***
...
def test_all_simple_edge_paths_with_two_targets_inside_cycle_emits_two_paths():
    ...
    G.add_edge(1, 3)
    paths = nx.all_simple_edge_paths(G, 0, [2, 3])
    assert {tuple(p) for p in paths***REMOVED*** == {((0, 1), (1, 2)), ((0, 1), (1, 3))***REMOVED***
...
def test_all_simple_edge_paths_cutoff():
    ...
    assert {tuple(p) for p in paths***REMOVED*** == {((0, 1),), ((0, 2), (2, 1)), ((0, 3), (3, 1))***REMOVED***
...
def test_all_simple_edge_paths_on_non_trivial_graph():
    ...
    ***REMOVED***
    ...
    assert {tuple(p) for p in paths***REMOVED*** == {((1, 2),), ((1, 3),), ((1, 2), (2, 3))***REMOVED***
...
def test_all_simple_edge_paths_multigraph_with_cutoff():
    ...
    assert len(paths) == 2
    assert {tuple(p) for p in paths***REMOVED*** == {((1, 2, 0),), ((1, 2, 1),)***REMOVED***
...
def test_all_simple_edge_paths_directed():
    ...
    assert {tuple(p) for p in paths***REMOVED*** == {((1, 2), (2, 3))***REMOVED***
...
def test_weighted_shortest_simple_path():
    ...
    weight = {(u, v): random.randint(1, 100) for (u, v) in G.edges()***REMOVED***
