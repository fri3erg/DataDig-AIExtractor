...
def test_all_modules_are_expected():
    ...
    if modnames:
        raise AssertionError(f'Found unexpected modules: {modnames***REMOVED***')
...
def test_all_modules_are_expected_2():
    ...
    if unexpected_members:
        raise AssertionError("Found unexpected object(s) that look like "
                             "modules: {***REMOVED***".format(unexpected_members))
...
def test_api_importable():
    ...
    if module_names:
        raise AssertionError("Modules in the public API that cannot be "
                             "imported: {***REMOVED***".format(module_names))
    ...
    if module_names:
        raise AssertionError("Modules in the public API that were not "
                             "found: {***REMOVED***".format(module_names))
...
def test_array_api_entry_point():
    ...
    xp = ep.load()
    msg = (
        f"numpy entry point value '{ep.value***REMOVED***' "
