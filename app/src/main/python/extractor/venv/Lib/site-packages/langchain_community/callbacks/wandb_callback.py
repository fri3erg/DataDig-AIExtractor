...
def analyze_text(
    ...
    if visualize and nlp and output_dir is not None:
        ...
        dep_output_path = Path(output_dir, hash_string(f"dep-{text***REMOVED***") + ".html")
        dep_output_path.open("w", encoding="utf-8").write(dep_out)

        ent_out = spacy.displacy.render(  # type: ignore
            doc, style="ent", jupyter=False, page=True
        )
        ent_output_path = Path(output_dir, hash_string(f"ent-{text***REMOVED***") + ".html")
...
class WandbCallbackHandler(BaseMetadataCallbackHandler, BaseCallbackHandler):
    ...
    ***REMOVED***
    ...
    def on_chain_end(self, outputs: Dict[str, Any], **kwargs: Any) -> None:
        ...
        resp = self._init_resp()
        resp.update({"action": "on_chain_end", "outputs": outputs["output"]***REMOVED***)
        resp.update(self.get_custom_callback_meta())
