...
class BaseMultiDiGraphTester(BaseMultiGraphTester):
    ...
    def test_edges_data(self):
        G = self.K3
        edges = [(0, 1, {***REMOVED***), (0, 2, {***REMOVED***), (1, 0, {***REMOVED***), (1, 2, {***REMOVED***), (2, 0, {***REMOVED***), (2, 1, {***REMOVED***)]
        assert sorted(G.edges(data=True)) == edges
        assert sorted(G.edges(0, data=True)) == [(0, 1, {***REMOVED***), (0, 2, {***REMOVED***)]
    ...
    def test_out_edges_data(self):
        ...
        assert sorted(G.edges(0, data=True)) == [(0, 1, {"data": 1***REMOVED***), (0, 2, {***REMOVED***)]
    ...
    def test_in_edges_data(self):
        G = self.K3
        assert sorted(G.in_edges(0, data=True)) == [(1, 0, {***REMOVED***), (2, 0, {***REMOVED***)]
        G.remove_edge(1, 0)
        G.add_edge(1, 0, data=1)
        assert sorted(G.in_edges(0, data=True)) == [(1, 0, {"data": 1***REMOVED***), (2, 0, {***REMOVED***)]
...
class TestMultiDiGraph(BaseMultiDiGraphTester, _TestMultiGraph):
    def setup_method(self):
        ...
        self.k3nodes = [0, 1, 2]
        self.K3 = self.Graph()
        self.K3._succ = {0: {***REMOVED***, 1: {***REMOVED***, 2: {***REMOVED******REMOVED***
    ...
    def test_add_edge(self):
        G = self.Graph()
        G.add_edge(0, 1)
        assert G._adj == {0: {1: {0: {***REMOVED******REMOVED******REMOVED***, 1: {***REMOVED******REMOVED***
        assert G._succ == {0: {1: {0: {***REMOVED******REMOVED******REMOVED***, 1: {***REMOVED******REMOVED***
        assert G._pred == {0: {***REMOVED***, 1: {0: {0: {***REMOVED******REMOVED******REMOVED******REMOVED***
        G = self.Graph()
        G.add_edge(*(0, 1))
        assert G._adj == {0: {1: {0: {***REMOVED******REMOVED******REMOVED***, 1: {***REMOVED******REMOVED***
        assert G._succ == {0: {1: {0: {***REMOVED******REMOVED******REMOVED***, 1: {***REMOVED******REMOVED***
    ...
    def test_add_edges_from(self):
        ...
        assert G._adj == {0: {1: {0: {***REMOVED***, 1: {"weight": 3***REMOVED******REMOVED******REMOVED***, 1: {***REMOVED******REMOVED***
        assert G._succ == {0: {1: {0: {***REMOVED***, 1: {"weight": 3***REMOVED******REMOVED******REMOVED***, 1: {***REMOVED******REMOVED***
        assert G._pred == {0: {***REMOVED***, 1: {0: {0: {***REMOVED***, 1: {"weight": 3***REMOVED******REMOVED******REMOVED******REMOVED***
        ...
        ***REMOVED***
        ...
        assert G._succ == {0: {1: keydict***REMOVED***, 1: {***REMOVED******REMOVED***
        assert G._pred == {1: {0: keydict***REMOVED***, 0: {***REMOVED******REMOVED***
