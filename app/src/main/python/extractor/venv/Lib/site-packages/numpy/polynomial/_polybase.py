...
class ABCPolyBase(abc.ABC):
    ...
    ***REMOVED***
    ...
    def __repr__(self):
        ...
        return (f"{name***REMOVED***({coef***REMOVED***, domain={domain***REMOVED***, window={window***REMOVED***, "
                f"symbol='{self.symbol***REMOVED***')")
    ...
    def __format__(self, fmt_str):
        ...
        if fmt_str not in ('ascii', 'unicode'):
            raise ValueError(
                f"Unsupported format string '{fmt_str***REMOVED***' passed to "
                f"{self.__class__***REMOVED***.__format__. Valid options are "
                f"'ascii' and 'unicode'"
***REMOVED***
        if fmt_str == 'ascii':
...
***REMOVED***
        return (f"·{cls.basis_name***REMOVED***{i.translate(cls._subscript_mapping)***REMOVED***"
                f"({arg_str***REMOVED***)")
...
***REMOVED***
        return f" {cls.basis_name***REMOVED***_{i***REMOVED***({arg_str***REMOVED***)"
    ...
    def _repr_latex_term(cls, i, arg_str, needs_parens):
        ...
        return f"{{{cls.basis_name***REMOVED******REMOVED******REMOVED***_{{{i***REMOVED******REMOVED******REMOVED***({arg_str***REMOVED***)"

    @staticmethod
    def _repr_latex_scalar(x, parens=False):
        # TODO: we're stuck with disabling math formatting until we handle
        # exponents in this function
        return r'\text{{{***REMOVED******REMOVED******REMOVED***'.format(pu.format_float(x, parens=parens))
    ...
    def _repr_latex_(self):
        ...
        if off == 0 and scale == 1:
            ...
            term = f"{self._repr_latex_scalar(off)***REMOVED*** + {self.symbol***REMOVED***"
            needs_parens = True
        elif off == 0:
            term = f"{self._repr_latex_scalar(scale)***REMOVED***{self.symbol***REMOVED***"
            needs_parens = True
        else:
            term = (
                f"{self._repr_latex_scalar(off)***REMOVED*** + "
                f"{self._repr_latex_scalar(scale)***REMOVED***{self.symbol***REMOVED***"
***REMOVED***
            needs_parens = True

        mute = r"\color{{LightGray***REMOVED******REMOVED***{{{***REMOVED******REMOVED******REMOVED***".format

        parts = []
        for i, c in enumerate(self.coef):
            # prevent duplication of + and - signs
            if i == 0:
                coef_str = f"{self._repr_latex_scalar(c)***REMOVED***"
            elif not isinstance(c, numbers.Real):
                coef_str = f" + ({self._repr_latex_scalar(c)***REMOVED***)"
            elif not np.signbit(c):
                coef_str = f" + {self._repr_latex_scalar(c, parens=True)***REMOVED***"
            else:
                coef_str = f" - {self._repr_latex_scalar(-c, parens=True)***REMOVED***"
            ...
            if term_str == '1':
                ...
                part = rf"{coef_str***REMOVED***\,{term_str***REMOVED***"
        ...
        return rf"${self.symbol***REMOVED*** \mapsto {body***REMOVED***$"
    ...
    def __truediv__(self, other):
        ...
        if not isinstance(other, numbers.Number) or isinstance(other, bool):
            raise TypeError(
                ...
                f"'{type(self)***REMOVED***', '{type(other)***REMOVED***'"
***REMOVED***
    ...
    def fit(cls, x, y, deg, domain=None, rcond=None, full=False, w=None,
        ...
        domain : {None, [beg, end], []***REMOVED***, optional
        ...
        w : array_like, shape (M,), optional
            ...
            .. versionadded:: 1.5.0
        window : {[beg, end]***REMOVED***, optional
