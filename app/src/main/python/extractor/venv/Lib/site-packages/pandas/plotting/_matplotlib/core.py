...
class MPLPlot(ABC):
    ...
    def __init__(
        ...
        **kwds,
        ...
        self.errors = {"xerr": xerr, "yerr": yerr***REMOVED***
        self.data = data
    ...
    def _validate_log_kwd(
        ...
        if (
            ...
            return value
        raise ValueError(
            f"keyword '{kwd***REMOVED***' should be bool, None, or 'sym', not '{value***REMOVED***'"
        )
    ...
    def _validate_subplots_kwarg(
        ...
        if kind not in supported_kinds:
            raise ValueError(
                ...
                f"one of {', '.join(supported_kinds)***REMOVED***. Got {kind***REMOVED***."
***REMOVED***
...
***REMOVED***
    ...
    ***REMOVED***
            ...
            if (idx_locs == -1).any():
                ...
                raise ValueError(
                    f"Column label(s) {list(bad_labels)***REMOVED*** not found in the DataFrame."
    ***REMOVED***
            ...
            if duplicates:
                raise ValueError(
                    ...
                    f"Columns {duplicates***REMOVED*** were found in multiple subplots."
    ***REMOVED***
                ...
                if is_list_like(self.title):
                    if len(self.title) != self.nseries:
                        raise ValueError(
                            ...
                            "and `subplots=True`.\n"
                            f"length of title = {len(self.title)***REMOVED***\n"
                            f"number of columns = {self.nseries***REMOVED***"
            ***REMOVED***
...
***REMOVED***
            ...
            if isinstance(data, ABCSeries) and err_shape[0] == 2:
                ...
                if err_shape[2] != len(data):
                    raise ValueError(
                        ...
                        f"with the shape (2, {len(data)***REMOVED***)"
        ***REMOVED***
    ...
    ***REMOVED***:
                    raise ValueError(
                        "Asymmetrical error bars should be provided "
                        f"with the shape ({nseries***REMOVED***, 2, {len(data)***REMOVED***)"
        ***REMOVED***
...
***REMOVED***
            ...
            msg = f"No valid {label***REMOVED*** detected"
            raise ValueError(msg)
...
***REMOVED***
    ...
    def _initialize_stacker(cls, ax: Axes, stacking_id, n: int) -> None:
        ...
        if not hasattr(ax, "_stacker_pos_prior"):
            # TODO #54485
            ax._stacker_pos_prior = {***REMOVED***  # type: ignore[attr-defined]
        if not hasattr(ax, "_stacker_neg_prior"):
            # TODO #54485
            ax._stacker_neg_prior = {***REMOVED***  # type: ignore[attr-defined]
        # TODO #54485
...
***REMOVED***
        ...
        raise ValueError(
            ...
            f"Column '{label***REMOVED***' contains both positive and negative values"
        )
...
class PiePlot(MPLPlot):
    ...
    def __init__(self, data, kind=None, **kwargs) -> None:
        data = data.fillna(value=0)
        if (data < 0).any().any():
            raise ValueError(f"{self._kind***REMOVED*** plot doesn't allow negative values")
    ...
    def _validate_log_kwd(
        ...
        if value is not False:
            warnings.warn(
                f"PiePlot ignores the '{kwd***REMOVED***' keyword",
                UserWarning,
                stacklevel=find_stack_level(),
***REMOVED***
        return False
