...
def create_openai_fn_runnable(
        ...
        .. code-block:: python
                ...
                prompt = ChatPromptTemplate.from_messages(
                    [
                        ...
                        ("human", "Make calls to the relevant function to record the entities in the following input: {input***REMOVED***"),
    ...
    ***REMOVED***
    ...
    llm_kwargs: Dict[str, Any] = {"functions": openai_functions, **kwargs***REMOVED***
    if len(openai_functions) == 1 and enforce_single_function_usage:
        llm_kwargs["function_call"] = {"name": openai_functions[0]["name"]***REMOVED***
        ...
        .. code-block:: python
                ...
                prompt = ChatPromptTemplate.from_messages(
                    [
                        ...
                        ("human", "Use the given format to extract information from the following input: {input***REMOVED***"),
                        ("human", "Tip: Make sure to answer in the correct format"),
                    ]
    ***REMOVED***
