...
class TestPeriodIndex:
    ...
    def test_range_slice_outofbounds(self, make_range):
        ...
        df = DataFrame({"units": [100 + i for i in range(10)]***REMOVED***, index=idx)
    ...
    def test_maybe_cast_slice_bound(self, make_range, frame_or_series):
        ...
        obj = DataFrame({"units": [100 + i for i in range(10)]***REMOVED***, index=idx)
        obj = tm.get_obj(obj, frame_or_series)

        msg = (
            f"cannot do slice indexing on {type(idx).__name__***REMOVED*** with "
