...
LINK_NOTE_TEMPLATE = "joplin://x-callback-url/openNote?id={id***REMOVED***"
...
class JoplinLoader(BaseLoader):
    ...
    def __init__(
        ...
        base_url = f"http://{host***REMOVED***:{port***REMOVED***"
        self._get_note_url = (
            f"{base_url***REMOVED***/notes?token={access_token***REMOVED***"
            f"&fields=id,parent_id,title,body,created_time,updated_time&page={{page***REMOVED******REMOVED***"
        )
        self._get_folder_url = (
            f"{base_url***REMOVED***/folders/{{id***REMOVED******REMOVED***?token={access_token***REMOVED***&fields=title"
        )
        self._get_tag_url = (
            f"{base_url***REMOVED***/notes/{{id***REMOVED******REMOVED***/tags?token={access_token***REMOVED***&fields=title"
        )
