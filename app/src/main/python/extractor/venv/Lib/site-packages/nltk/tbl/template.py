...
class Template(BrillTemplateI):
    """
    A tbl Template that generates a list of L{Rule***REMOVED***s that apply at a given sentence
    position.  In particular, each C{Template***REMOVED*** is parameterized by a list of
    independent features (a combination of a specific
    property to extract and a list C{L***REMOVED*** of relative positions at which to extract
    ...
    def __init__(self, *features):
        ...
        Takes a list of Features. A C{Feature***REMOVED*** is a combination
        of a specific property and its relative positions and should be
        a subclass of L{nltk.tbl.feature.Feature***REMOVED***.
...
***REMOVED***
        self.id = f"{len(self.ALLTEMPLATES):03d***REMOVED***"
    ...
    def _applicable_conditions(self, tokens, index):
        ...
        that are applicable to C{tokens[index]***REMOVED***.
        """
        conditions = []
    ...
    def get_neighborhood(self, tokens, index):
        ...
        neighborhood = {index***REMOVED***  # set literal for python 2.7+
    ...
    def expand(cls, featurelists, combinations=None, skipintersecting=True):
        ...
        def nonempty_powerset(xs):  # xs is a list
            ...
            # find the correct tuple given combinations, one of {None, k, (k1,k2)***REMOVED***
...
***REMOVED***  # n over k1, n over k1+1... n over k2
