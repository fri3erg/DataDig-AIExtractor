...
class TestSetitemDT64Values:
    ...
    def test_setitem_with_tz(self, tz, indexer_sli):
        ...
        assert orig.dtype == f"datetime64[ns, {tz***REMOVED***]"
        ...
        assert vals.dtype == f"datetime64[ns, {tz***REMOVED***]"
    ...
    def test_object_series_setitem_dt64array_exact_match(self):
        ...
        ser = Series({"X": np.nan***REMOVED***, dtype=object)
...
def test_setitem_with_bool_indexer():
    ...
    expected = DataFrame({"a": [10, 2, 3]***REMOVED***)
