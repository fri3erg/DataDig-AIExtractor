...
class TestXS:
    ...
    def test_xs_keep_level(self):
        df = DataFrame(
            {
                "day": {0: "sat", 1: "sun"***REMOVED***,
                "flavour": {0: "strawberry", 1: "strawberry"***REMOVED***,
                "sales": {0: 10, 1: 12***REMOVED***,
                "year": {0: 2008, 1: 2008***REMOVED***,
            ***REMOVED***
...
***REMOVED***,
    ...
    def test_xs_droplevel_false_view(
        ...
        if using_copy_on_write:
            ...
            expected = DataFrame({"a": [2]***REMOVED***)
        tm.assert_frame_equal(result, expected)
