...
_TOKEN: Final[str] = rf"[{_TCHAR***REMOVED***]+"

_QDTEXT: Final[str] = r"[{***REMOVED***]".format(
...
_QUOTED_STRING: Final[str] = r'"(?:{quoted_pair***REMOVED***|{qdtext***REMOVED***)*"'.format(
    qdtext=_QDTEXT, quoted_pair=_QUOTED_PAIR
)

_FORWARDED_PAIR: Final[
    str
] = r"({token***REMOVED***)=({token***REMOVED***|{quoted_string***REMOVED***)(:\d{{1,4***REMOVED******REMOVED***)?".format(
...
***REMOVED***
    ...
    ***REMOVED***
    ...
    def cookies(self) -> Mapping[str, str]:
        ...
        return MappingProxyType({key: val.value for key, val in parsed.items()***REMOVED***)
    ...
    if DEBUG:
        ...
        def __setattr__(self, name: str, val: Any) -> None:
            if name not in self.ATTRS:
                warnings.warn(
                    "Setting custom {***REMOVED***.{***REMOVED*** attribute "
