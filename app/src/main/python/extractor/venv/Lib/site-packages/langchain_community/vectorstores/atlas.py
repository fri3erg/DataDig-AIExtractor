        ...
        **kwargs: Any,
        ...
        if self._embedding_function is not None:
            ...
            if metadatas is None:
                data = [
                    {AtlasDB._ATLAS_DEFAULT_ID_FIELD: ids[i], "text": texts[i]***REMOVED***
...
***REMOVED***
        ...
        # Text upload case
            ...
            if metadatas is None:
                data = [
                    {"text": text, AtlasDB._ATLAS_DEFAULT_ID_FIELD: ids[i]***REMOVED***
...
***REMOVED***
    ...
    def from_texts(
        ...
        **kwargs: Any,
        ...
        all_index_kwargs = {"name": name + "_index", "indexed_field": "text"***REMOVED***
