...
ALLOWED_CLOSE_CODES: Final[Set[int]] = {int(i) for i in WSCloseCode***REMOVED***
    ...
    def _feed_data(self, data: bytes) -> Tuple[bool, bytes]:
        for fin, opcode, payload, compressed in self.parse_frame(data):
                ...
                if len(payload) >= 2:
                    ...
                    if close_code < 3000 and close_code not in ALLOWED_CLOSE_CODES:
                        raise WebSocketError(
                            ...
                            f"Invalid close code: {close_code***REMOVED***",
            ***REMOVED***
                    try:
            ...
            ***REMOVED*** from exc
                    ...
                    raise WebSocketError(
                        WSCloseCode.PROTOCOL_ERROR,
                        f"Invalid close frame: {fin***REMOVED*** {opcode***REMOVED*** {payload!r***REMOVED***",
        ***REMOVED***
                else:
...
***REMOVED***:
                raise WebSocketError(
                    WSCloseCode.PROTOCOL_ERROR, f"Unexpected opcode={opcode!r***REMOVED***"
    ***REMOVED***
            else:
                # load text/binary
                if not fin:
                    ...
                    if self._max_msg_size and len(self._partial) >= self._max_msg_size:
                        raise WebSocketError(
                            ...
                            "Message size {***REMOVED*** exceeds limit {***REMOVED***".format(
                    ...
                    if self._partial:
                        if opcode != WSMsgType.CONTINUATION:
                            raise WebSocketError(
                                ...
                                "to be zero, got {!r***REMOVED***".format(opcode),
                ***REMOVED***
            ...
            ***REMOVED***
                        if self._decompressobj.unconsumed_tail:
                            ...
                            raise WebSocketError(
                                WSCloseCode.MESSAGE_TOO_BIG,
                                "Decompressed message size {***REMOVED*** exceeds limit {***REMOVED***".format(
