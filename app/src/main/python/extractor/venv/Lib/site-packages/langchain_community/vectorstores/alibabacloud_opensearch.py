...
class AlibabaCloudOpenSearchSettings:
    ...
    def __init__(
        ...
        self.inverse_field_name_mapping: Dict[str, str] = {***REMOVED***
...
***REMOVED***
        ...
        self.options_headers: Dict[str, str] = {***REMOVED***
    ...
    ***REMOVED***
                ...
                logger.error(
                    f"add doc to endpoint:{self.config.endpoint***REMOVED*** "
                    f"instance_id:{self.config.instance_id***REMOVED*** failed.",
                    e,
    ***REMOVED***
                raise e
...
***REMOVED***
        ...
        def create_filter(md_key: str, md_value: Any) -> str:
            ...
            if len(expr) != 2:
                logger.error(
                    f"filter {md_filter_expr***REMOVED*** express is not correct, "
    ...
    ***REMOVED***
            ...
            if isinstance(md_value, numbers.Number):
                return f"{md_filter_key***REMOVED*** {md_filter_operator***REMOVED*** {md_value***REMOVED***"
            return f'{md_filter_key***REMOVED***{md_filter_operator***REMOVED***"{md_value***REMOVED***"'
...
***REMOVED***:
                logger.error(
                    f"query {self.config.endpoint***REMOVED*** {self.config.instance_id***REMOVED*** "
                    f"failed:{json_response['errorMsg']***REMOVED***."
    ***REMOVED***
            else:
                return json_response
        except Exception as e:
            logger.error(
                f"query instance endpoint:{self.config.endpoint***REMOVED*** "
                f"instance_id:{self.config.instance_id***REMOVED*** failed.",
                e,
***REMOVED***
        return {***REMOVED***
    ...
    def delete_documents_with_document_id(self, id_list: List[str]) -> bool:
        ...
        for doc_id in id_list:
            delete_doc_list.append(
                {
                    "fields": {self.config.field_name_mapping["id"]: doc_id***REMOVED***,
                    "cmd": "delete",
                ***REMOVED***
***REMOVED***
...
***REMOVED***
            ...
            logger.error(
                f"delete doc from :{self.config.endpoint***REMOVED*** "
                f"instance_id:{self.config.instance_id***REMOVED*** failed.",
                e,
***REMOVED***
            raise e
