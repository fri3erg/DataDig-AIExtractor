...
class TestCategoricalAnalytics:
    ...
    def test_min_max_not_ordered_raises(self, aggregation):
        ...
        msg = f"Categorical is not ordered for operation {aggregation***REMOVED***"
...
***REMOVED***,
    ...
    def test_numpy_min_max_raises(self, method):
        ...
        msg = (
            f"Categorical is not ordered for operation {method***REMOVED***\n"
    ...
    def test_numpy_min_max_unsupported_kwargs_raises(self, method, kwarg):
        ...
        msg = (
            f"the '{kwarg***REMOVED***' parameter is not supported in the pandas implementation "
            f"of {method***REMOVED***"
        )
        if kwarg == "axis":
            msg = r"`axis` must be fewer than the number of dimensions \(1\)"
        kwargs = {kwarg: 42***REMOVED***
        method = getattr(np, method)
