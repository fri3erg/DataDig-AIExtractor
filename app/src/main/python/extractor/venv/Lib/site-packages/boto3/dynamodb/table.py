    ...
    def batch_writer(self, overwrite_by_pkeys=None):
        ...
        Example usage::
            ...
            with table.batch_writer() as batch:
                ...
                batch.delete_item(Key={'HashKey': 'SomeHashKey'***REMOVED***)
...
class BatchWriter:
    ...
    def put_item(self, Item):
        self._add_request_and_process({'PutRequest': {'Item': Item***REMOVED******REMOVED***)

    def delete_item(self, Key):
        self._add_request_and_process({'DeleteRequest': {'Key': Key***REMOVED******REMOVED***)
    ...
    ***REMOVED***
    ...
    def _flush(self):
        ...
        response = self._client.batch_write_item(
            RequestItems={self._table_name: items_to_send***REMOVED***
        )
        unprocessed_items = response['UnprocessedItems']
        if not unprocessed_items:
            unprocessed_items = {***REMOVED***
