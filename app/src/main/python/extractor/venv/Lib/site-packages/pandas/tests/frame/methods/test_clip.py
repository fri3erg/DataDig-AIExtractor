...
class TestDataFrameClip:
    ...
    def test_clip_mixed_numeric(self):
        ...
        df = DataFrame({"A": [1, 2, 3], "B": [1.0, np.nan, 3.0]***REMOVED***)
        result = df.clip(1, 2)
        expected = DataFrame({"A": [1, 2, 2], "B": [1.0, np.nan, 2.0]***REMOVED***)
    ...
    def test_clip_with_na_args(self, float_frame):
        ...
        df = DataFrame({"col_0": [1, 2, 3], "col_1": [4, 5, 6], "col_2": [7, 8, 9]***REMOVED***)
        ...
        expected = DataFrame(
            {"col_0": [4, 5, 3], "col_1": [4, 5, 6], "col_2": [7, 8, 9]***REMOVED***
        )
        tm.assert_frame_equal(result, expected)

        result = df.clip(lower=[4, 5, np.nan], axis=1)
        expected = DataFrame(
            {"col_0": [4, 4, 4], "col_1": [5, 5, 6], "col_2": [7, 8, 9]***REMOVED***
        )
        tm.assert_frame_equal(result, expected)
        ...
        expected = DataFrame({"col_0": [9, -3, 0, 6, 5], "col_1": [2, -4, 6, 8, 3]***REMOVED***)
        tm.assert_frame_equal(result, expected)
    ...
    def test_clip_int_data_with_float_bound(self):
        ...
        expected = DataFrame({"a": [1.5, 2.0, 3.0]***REMOVED***)
        tm.assert_frame_equal(result, expected)
