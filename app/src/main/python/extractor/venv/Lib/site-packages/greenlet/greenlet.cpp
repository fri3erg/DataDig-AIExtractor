...
static PyMethodDef green_methods[] = {
    {"switch",
     ...
     green_switch_doc***REMOVED***,
    {"throw", (PyCFunction)green_throw, METH_VARARGS, green_throw_doc***REMOVED***,
    {"__getstate__", (PyCFunction)green_getstate, METH_NOARGS, NULL***REMOVED***,
    {NULL, NULL***REMOVED*** /* sentinel */
***REMOVED***;

static PyGetSetDef green_getsets[] = {
    /* name, getter, setter, doc, context pointer */
    {"__dict__", (getter)green_getdict, (setter)green_setdict, /*XXX*/ NULL***REMOVED***,
    {"run", (getter)green_getrun, (setter)green_setrun, /*XXX*/ NULL***REMOVED***,
    {"parent", (getter)green_getparent, (setter)green_setparent, /*XXX*/ NULL***REMOVED***,
    {"gr_frame", (getter)green_getframe, NULL, /*XXX*/ NULL***REMOVED***,
    {"gr_context",
     (getter)green_getcontext,
     (setter)green_setcontext,
     /*XXX*/ NULL***REMOVED***,
    {"dead", (getter)green_getdead, NULL, /*XXX*/ NULL***REMOVED***,
    {"_stack_saved", (getter)green_get_stack_saved, NULL, /*XXX*/ NULL***REMOVED***,
    {NULL***REMOVED***
***REMOVED***;
...
static PyMethodDef GreenMethods[] = {
    {"getcurrent",
     ...
     METH_NOARGS,
     mod_getcurrent_doc***REMOVED***,
    {"settrace", (PyCFunction)mod_settrace, METH_VARARGS, mod_settrace_doc***REMOVED***,
    {"gettrace", (PyCFunction)mod_gettrace, METH_NOARGS, mod_gettrace_doc***REMOVED***,
    {"set_thread_local", (PyCFunction)mod_set_thread_local, METH_VARARGS, mod_set_thread_local_doc***REMOVED***,
    {"get_pending_cleanup_count", (PyCFunction)mod_get_pending_cleanup_count, METH_NOARGS, mod_get_pending_cleanup_count_doc***REMOVED***,
    {"get_total_main_greenlets", (PyCFunction)mod_get_total_main_greenlets, METH_NOARGS, mod_get_total_main_greenlets_doc***REMOVED***,
    {"get_clocks_used_doing_optional_cleanup", (PyCFunction)mod_get_clocks_used_doing_optional_cleanup, METH_NOARGS, mod_get_clocks_used_doing_optional_cleanup_doc***REMOVED***,
    {"enable_optional_cleanup", (PyCFunction)mod_enable_optional_cleanup, METH_O, mod_enable_optional_cleanup_doc***REMOVED***,
    {"get_tstate_trash_delete_nesting", (PyCFunction)mod_get_tstate_trash_delete_nesting, METH_NOARGS, mod_get_tstate_trash_delete_nesting_doc***REMOVED***,
    {NULL, NULL***REMOVED*** /* Sentinel */
***REMOVED***;
