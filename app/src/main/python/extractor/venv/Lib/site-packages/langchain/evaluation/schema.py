...
class _EvalArgsMixin:
    ...
    def _skip_input_warning(self) -> str:
        ...
        return f"Ignoring input in {self.__class__.__name__***REMOVED***, as it is not expected."
    ...
    def _check_evaluation_args(
        ...
        if self.requires_input and input is None:
            raise ValueError(f"{self.__class__.__name__***REMOVED*** requires an input string.")
        elif input is not None and not self.requires_input:
            warn(self._skip_input_warning)
        if self.requires_reference and reference is None:
            raise ValueError(f"{self.__class__.__name__***REMOVED*** requires a reference string.")
