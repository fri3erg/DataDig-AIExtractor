    ...
    def _get_relevant_documents(
        ...
        *,
        ...
        if self.search_type == SearchType.similarity:
            ...
            raise ValueError(
                f"Search type {self.search_type***REMOVED*** does not exist. "
...
***REMOVED***
    ...
    ***REMOVED***  # add vector similarity search
...
***REMOVED***.documents
    ...
    def _docarray_to_langchain_doc(self, doc: Union[Dict[str, Any], Any]) -> Document:
        ...
        if self.content_field not in fields:
            raise ValueError(
                f"Document does not contain the content field - {self.content_field***REMOVED***."
***REMOVED***
        lc_doc = Document(
