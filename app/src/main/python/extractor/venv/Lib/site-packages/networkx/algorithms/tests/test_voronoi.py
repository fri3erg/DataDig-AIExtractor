...
class TestVoronoiCells:
    ...
    def test_isolates(self):
        ...
        """
        G = nx.empty_graph(5)
        cells = nx.voronoi_cells(G, {0, 2, 4***REMOVED***)
        expected = {0: {0***REMOVED***, 2: {2***REMOVED***, 4: {4***REMOVED***, "unreachable": {1, 3***REMOVED******REMOVED***
        assert expected == cells

    def test_undirected_unweighted(self):
        G = nx.cycle_graph(6)
        cells = nx.voronoi_cells(G, {0, 3***REMOVED***)
        expected = {0: {0, 1, 5***REMOVED***, 3: {2, 3, 4***REMOVED******REMOVED***
        assert expected == cells
    ...
    def test_directed_unweighted(self):
        ...
        cells = nx.voronoi_cells(G, {0, 3***REMOVED***)
        expected = {0: {0, 1, 2***REMOVED***, 3: {3, 4, 5***REMOVED******REMOVED***
        assert expected == cells
    ...
    def test_directed_inward(self):
        ...
        cells = nx.voronoi_cells(G, {0, 3***REMOVED***)
        expected = {0: {0, 4, 5***REMOVED***, 3: {1, 2, 3***REMOVED******REMOVED***
        assert expected == cells
    ...
    def test_undirected_weighted(self):
        ...
        cells = nx.voronoi_cells(G, {0, 3***REMOVED***)
        expected = {0: {0***REMOVED***, 3: {1, 2, 3***REMOVED******REMOVED***
        assert expected == cells
    ...
    def test_multigraph_unweighted(self):
        ...
        H = nx.Graph(G)
        G_cells = nx.voronoi_cells(G, {0, 3***REMOVED***)
        H_cells = nx.voronoi_cells(H, {0, 3***REMOVED***)
