...
class InterpolatedLanguageModel(LanguageModel):
    ...
    def __init__(self, smoothing_cls, order, **kwargs):
        params = kwargs.pop("params", {***REMOVED***)
...
class AbsoluteDiscountingInterpolated(InterpolatedLanguageModel):
    ...
    def __init__(self, order, discount=0.75, **kwargs):
        super().__init__(
            AbsoluteDiscounting, order, params={"discount": discount***REMOVED***, **kwargs
        )
...
***REMOVED***
        super().__init__(
            KneserNey, order, params={"discount": discount, "order": order***REMOVED***, **kwargs
        )
