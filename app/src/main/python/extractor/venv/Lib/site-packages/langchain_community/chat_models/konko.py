...
class ChatKonko(BaseChatModel):
    ...
    def lc_secrets(self) -> Dict[str, str]:
        return {"konko_api_key": "KONKO_API_KEY", "openai_api_key": "OPENAI_API_KEY"***REMOVED***
...
***REMOVED***
    ...
    ***REMOVED***
        ...
        models_url = f"{konko_api_base***REMOVED***/models"

        headers = {
            "Authorization": f"Bearer {konko_api_key.get_secret_value()***REMOVED***",
        ***REMOVED***
        ...
        if models_response.status_code != 200:
            raise ValueError(
                f"Error getting models from {models_url***REMOVED***: "
                f"{models_response.status_code***REMOVED***"
***REMOVED***

        return {model["id"] for model in models_response.json()["data"]***REMOVED***
        ...
        for output in llm_outputs:
            ...
            for k, v in token_usage.items():
                if k in overall_token_usage:
                    ...
                    overall_token_usage[k] = v
        return {"token_usage": overall_token_usage, "model_name": self.model***REMOVED***
...
***REMOVED***
    ...
    def _identifying_params(self) -> Dict[str, Any]:
        ...
        return {**{"model_name": self.model***REMOVED***, **self._default_params***REMOVED***

    @property
    def _client_params(self) -> Dict[str, Any]:
        """Get the parameters used for the konko client."""
        return {**self._default_params***REMOVED***
