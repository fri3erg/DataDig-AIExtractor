...
class BlockchainDocumentLoader(BaseLoader):
    ...
    def __init__(
        ...
        if not re.match(r"^0x[a-fA-F0-9]{40***REMOVED***$", self.contract_address):
            raise ValueError(f"Invalid contract address {self.contract_address***REMOVED***")
    ...
    def load(self) -> List[Document]:
        ...
        while True:
            url = (
                f"https://{self.blockchainType***REMOVED***.g.alchemy.com/nft/v2/"
                f"{self.api_key***REMOVED***/getNFTsForCollection?withMetadata="
                f"True&contractAddress={self.contract_address***REMOVED***"
                f"&startToken={current_start_token***REMOVED***"
***REMOVED***
            ...
            if response.status_code != 200:
                raise ValueError(
                    f"Request failed with status code {response.status_code***REMOVED***"
    ***REMOVED***
...
***REMOVED***:
        ...
        if not result:
            raise ValueError(
                f"No NFTs found for contract address {self.contract_address***REMOVED***"
***REMOVED***
