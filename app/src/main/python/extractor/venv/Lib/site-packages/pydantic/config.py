...
class BaseConfig:
    ...
    fields: Dict[str, Union[str, Dict[str, str]]] = {***REMOVED***
    validate_assignment: bool = False
    error_msg_templates: Dict[str, str] = {***REMOVED***
    arbitrary_types_allowed: bool = False
    orm_mode: bool = False
    getter_dict: Type[GetterDict] = GetterDict
    alias_generator: Optional[Callable[[str], str]] = None
    keep_untouched: Tuple[type, ...] = ()
    schema_extra: Union[Dict[str, Any], 'SchemaExtraCallable'] = {***REMOVED***
    json_loads: Callable[[str], Any] = json.loads
    json_dumps: Callable[..., str] = json.dumps
    json_encoders: Dict[Union[Type[Any], str, ForwardRef], AnyCallable] = {***REMOVED***
    ...
    def get_field_info(cls, name: str) -> Dict[str, Any]:
        ...
        if isinstance(fields_value, str):
            field_info: Dict[str, Any] = {'alias': fields_value***REMOVED***
        ...
        if field_info.get('alias_priority', 0) <= 1 and cls.alias_generator:
            ...
            if not isinstance(alias, str):
                raise TypeError(f'Config.alias_generator must return str, not {alias.__class__***REMOVED***')
...
def get_config(config: Union[ConfigDict, Type[object], None]) -> Type[BaseConfig]:
    if config is None:
        ...
        config_dict = (
            ...
            else {k: getattr(config, k) for k in dir(config) if not k.startswith('__')***REMOVED***
        )
...
def inherit_config(self_config: 'ConfigType', parent_config: 'ConfigType', **namespace: Any) -> 'ConfigType':
    ...
    namespace['json_encoders'] = {
        **getattr(parent_config, 'json_encoders', {***REMOVED***),
        **getattr(self_config, 'json_encoders', {***REMOVED***),
        **namespace.get('json_encoders', {***REMOVED***),
    ***REMOVED***
...
def prepare_config(config: Type[BaseConfig], cls_name: str) -> None:
    if not isinstance(config.extra, Extra):
        try:
            ...
            raise ValueError(f'"{cls_name***REMOVED***": {config.extra***REMOVED*** is not a valid value for "extra"')
