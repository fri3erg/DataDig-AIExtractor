...
def betweenness_centrality(
    ...
    If $s = t$, $\sigma(s, t) = 1$, and if $v \in {s, t***REMOVED***$,
    $\sigma(s, t|v) = 0$ [2]_.
    ...
    differ -- for example, if sources is {0***REMOVED*** and targets is {1***REMOVED***,
...
def edge_betweenness_centrality(G, k=None, normalized=True, weight=None, seed=None):
    ...
    .. math::
       ...
       c_B(e) =\sum_{s,t \in V***REMOVED*** \frac{\sigma(s, t|e)***REMOVED***{\sigma(s, t)***REMOVED***
...
def _add_edge_keys(G, betweenness, weight=None):
    ...
    for u, v in betweenness:
        d = G[u][v]
        wt = _weight(u, v, d)
        keys = [k for k in d if _weight(u, v, {k: d[k]***REMOVED***) == wt]
