...
def test_drop_duplicates_with_misspelled_column_name(subset):
    # GH 19730
    df = DataFrame({"A": [0, 0, 1], "B": [0, 0, 1], "C": [0, 0, 1]***REMOVED***)
...
def test_drop_duplicates():
    ...
    # GH 11376
    df = DataFrame({"x": [7, 6, 3, 3, 4, 8, 0], "y": [0, 6, 5, 5, 9, 1, 2]***REMOVED***)
...
@pytest.mark.parametrize(
    ...
    [
        ({"A": [2, 2, 3]***REMOVED***, {"A": [2, 3]***REMOVED***, True, [0, 1]),
        ({"A": [2, 2, 3]***REMOVED***, {"A": [2, 3]***REMOVED***, False, [0, 2]),
        ({"A": [2, 2, 3], "B": [2, 2, 4]***REMOVED***, {"A": [2, 3], "B": [2, 4]***REMOVED***, True, [0, 1]),
        ({"A": [2, 2, 3], "B": [2, 2, 4]***REMOVED***, {"A": [2, 3], "B": [2, 4]***REMOVED***, False, [0, 2]),
    ],
)
...
def test_drop_duplicates_non_boolean_ignore_index(arg):
    # GH#38274
    df = DataFrame({"a": [1, 2, 1, 3]***REMOVED***)
