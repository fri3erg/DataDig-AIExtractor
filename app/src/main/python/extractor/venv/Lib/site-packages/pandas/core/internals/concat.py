...
def _concatenate_array_managers(
    ...
    Parameters
    ----------
    mgrs_indexers : list of (ArrayManager, {axis: indexer,...***REMOVED***) tuples
    axes : list of Index
    concat_axis : int
...
def concatenate_managers(
    ...
    Parameters
    ----------
    mgrs_indexers : list of (BlockManager, {axis: indexer,...***REMOVED***) tuples
    axes : list of Index
    concat_axis : int
    copy : bool
...
class JoinUnit:
    ...
    def __repr__(self) -> str:
        return f"{type(self).__name__***REMOVED***({repr(self.block)***REMOVED***)"
