...
***REMOVED***
        ...
        if self.object_ids is not None:
            for object_id in self.object_ids:
                ...
                yield Document(
                    page_content=page_content, metadata={"title": page_title***REMOVED***
    ***REMOVED***
        else:
    ...
    def _get_page_content(self, page_id: str) -> str:
        ...
        request_url = self.onenote_api_base_url + f"/pages/{page_id***REMOVED***/content"
        response = requests.get(request_url, headers=self._headers, timeout=10)
        response.raise_for_status()
    ...
    def _headers(self) -> Dict[str, str]:
        ...
        return {
            "Authorization": f"Bearer {self.access_token***REMOVED***",
        ***REMOVED***
...
***REMOVED***
            ...
            try:
                ...
                raise Exception(
                    f"Could not create the folder {self.token_path.parent***REMOVED*** "
    ...
    def _url(self) -> str:
        ...
        if self.notebook_name is not None:
            filter_list.append(
                ...
                + f"'{self.notebook_name.replace(' ', '%20')***REMOVED***'"
***REMOVED***
            expand_list.append("parentNotebook")
        if self.section_name is not None:
            filter_list.append(
                "parentSection/displayName%20eq%20"
                + f"'{self.section_name.replace(' ', '%20')***REMOVED***'"
***REMOVED***
            expand_list.append("parentSection")
        if self.page_title is not None:
            filter_list.append(
                "title%20eq%20" + f"'{self.page_title.replace(' ', '%20')***REMOVED***'"
***REMOVED***
        ...
        return f"{self.onenote_api_base_url***REMOVED***/pages{query_params***REMOVED***"
