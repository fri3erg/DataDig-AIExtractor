...
***REMOVED***
    ...
    def __validate_distance_strategy(distance_strategy: DistanceStrategy) -> None:
        if distance_strategy not in [
            ...
            raise ValueError(f"Distance strategy {distance_strategy***REMOVED*** not implemented.")
    ...
    def _create_index_if_not_exists(self, num_dimensions: int) -> bool:
        ...
        if self.distance_strategy == DistanceStrategy.COSINE:
            ...
            logger.error(f"Distance strategy {self.distance_strategy***REMOVED*** not implemented.")
            raise ValueError(
                f"Distance strategy {self.distance_strategy***REMOVED*** not implemented."
***REMOVED***
        ...
        if isinstance(response, CreateIndex.Success):
            ...
            logger.error(f"Error creating index: {response.inner_exception***REMOVED***")
            raise response.inner_exception
        else:
            logger.error(f"Unexpected response: {response***REMOVED***")
            raise Exception(f"Unexpected response: {response***REMOVED***")
    ...
    def add_texts(
        ...
        **kwargs: Any,
        ...
        if metadatas is not None:
            ...
            metadatas = [{self.text_field: text***REMOVED*** for text in texts]
    ...
    def max_marginal_relevance_search_by_vector(
        ...
        **kwargs: Any,
        ...
        if isinstance(response, SearchAndFetchVectors.Success):
            ...
            logger.error(f"Error searching and fetching vectors: {response***REMOVED***")
            return []
        else:
            logger.error(f"Unexpected response: {response***REMOVED***")
            raise Exception(f"Unexpected response: {response***REMOVED***")
