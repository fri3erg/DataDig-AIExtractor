...
***REMOVED***:
    ...
    def test_copy_name2(self, index_flat):
        ...
        msg = f"{type(index).__name__***REMOVED***.name must be a hashable type"
    ...
    def test_unique_level(self, index_flat):
        ...
        msg = (
            ...
            rf"\({re.escape(index.name.__repr__())***REMOVED***\)"
        )
...
def test_sort_values_invalid_na_position(index_with_missing, na_position):
    with pytest.raises(ValueError, match=f"invalid na_position: {na_position***REMOVED***"):
