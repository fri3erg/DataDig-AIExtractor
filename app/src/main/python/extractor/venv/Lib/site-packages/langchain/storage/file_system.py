...
class LocalFileStore(ByteStore):
    ...
    def _get_full_path(self, key: str) -> Path:
        ...
        if not re.match(r"^[a-zA-Z0-9_.\-/]+$", key):
            raise InvalidKeyException(f"Invalid characters in key: {key***REMOVED***")
        ...
        if common_path != str(self.root_path):
            raise InvalidKeyException(
                f"Invalid key: {key***REMOVED***. Key should be relative to the full path."
                f"{self.root_path***REMOVED*** vs. {common_path***REMOVED*** and full path of {full_path***REMOVED***"
***REMOVED***
