...
We can automatically generate random text based on a given text, e.g.:
    ...
    No princípio , criou Deus os abençoou , dizendo : Onde { estão ***REMOVED*** e até
    à ave dos céus , { que ***REMOVED*** será . Disse mais Abrão : Dá - me a mulher
    que tomaste ; porque daquele poço Eseque , { tinha .***REMOVED*** E disse : Não
    poderemos descer ; mas , do campo ainda não estava na casa do teu
    pescoço . E viveu Serugue , depois Simeão e Levi { são ***REMOVED*** estes ? E o
...
List the 20 most frequent tags, in order of decreasing frequency:
    ...
    ['n', 'prp', 'art', 'v-fin', ',', 'prop', 'adj', 'adv', '.',
     ...
     'pron-pers', '\xab', '\xbb', 'conj-s', '***REMOVED***']
...
in characters), and generates a concordance for that word.
    ...
    mpre ter jovens simp?ticos a ? vender ? chega ! ***REMOVED***
