    ...
    def __init__(
        ...
        try:
            if client is not None:
                ...
                client_params["endpoint_url"] = f"{protocol***REMOVED***://{host***REMOVED***:{port***REMOVED***"
...
***REMOVED***
    ...
    def query(self, query: str, params: dict = {***REMOVED***) -> Dict[str, Any]:
...
***REMOVED***
    ...
    def _get_triples(self, e_labels: List[str]) -> List[str]:
        triple_query = """
        MATCH (a)-[e:`{e_label***REMOVED***`]->(b)
        WITH a,e,b LIMIT 3000
        RETURN DISTINCT labels(a) AS from, type(e) AS edge, labels(b) AS to
        LIMIT 10
        """

        triple_template = "(:`{a***REMOVED***`)-[:`{e***REMOVED***`]->(:`{b***REMOVED***`)"
        triple_schema = []
    ...
    ***REMOVED***
    ...
    def _get_node_properties(self, n_labels: List[str], types: Dict) -> List:
        ...
        for label in n_labels:
            ...
            data = {"label": label, "properties": self.query(q)["results"]***REMOVED***
            s = set({***REMOVED***)
            ...
            np = {
                "properties": [{"property": k, "type": v***REMOVED*** for k, v in s],
                "labels": label,
            ***REMOVED***
    ...
    def _refresh_schema(self) -> None:
        ...
        ***REMOVED***
        ...
        {node_properties***REMOVED***
        Relationship properties are the following:
        {edge_properties***REMOVED***
        The relationships are the following:
        {triple_schema***REMOVED***
        """
