...
class MutableExpander:
    ...
    def markdown(
        ...
        *,
        ...
        kwargs = {"body": body, "unsafe_allow_html": unsafe_allow_html, "help": help***REMOVED***
    ...
    def exception(
        ...
        kwargs = {"exception": exception***REMOVED***
    ...
    def _create_child(self, type: ChildType, kwargs: Dict[str, Any]) -> None:
        ...
        if type == ChildType.MARKDOWN:
            ...
            raise RuntimeError(f"Unexpected child type {type***REMOVED***")
    ...
    def _get_dg(self, index: Optional[int]) -> DeltaGenerator:
        if index is not None:
            ...
            assert 0 <= index < len(self._child_records), f"Bad index: {index***REMOVED***"
