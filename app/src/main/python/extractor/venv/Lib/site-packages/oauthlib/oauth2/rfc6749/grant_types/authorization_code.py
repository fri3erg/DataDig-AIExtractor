...
class AuthorizationCodeGrant(GrantTypeBase):
    ...
    ***REMOVED***
    ...
    def create_authorization_code(self, request):
        ...
        """
        grant = {'code': common.generate_token()***REMOVED***
    ...
    def create_authorization_response(self, request, token_handler):
        ...
        # https://tools.ietf.org/html/rfc6749#appendix-B
            ...
            return {'Location': redirect_uri***REMOVED***, None, 302
        ...
        return self.prepare_authorization_response(
            request, grant, {***REMOVED***, None, 302)
        ...
        if challenge is not None:
            ...
            if challenge_method not in self._code_challenge_methods:
                raise errors.ServerError(
                    description="code_challenge_method {***REMOVED*** is not supported.".format(challenge_method),
                    request=request
    ***REMOVED***
