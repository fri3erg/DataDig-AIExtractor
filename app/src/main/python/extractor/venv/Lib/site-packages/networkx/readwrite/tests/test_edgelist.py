...
edges_with_multiple_attrs = textwrap.dedent(
    """
    # comment line
    1 2 {'weight':2.0, 'color':'green'***REMOVED***
    # comment line
    2 3 {'weight':3.0, 'color':'red'***REMOVED***
    """
)
...
_expected_edges_weights = [(1, 2, {"weight": 2.0***REMOVED***), (2, 3, {"weight": 3.0***REMOVED***)]
...
@pytest.mark.parametrize(
    ("data", "extra_kwargs"),
    (
        (edges_no_data, {***REMOVED***),
        (edges_with_values, {***REMOVED***),
        (edges_with_weight, {***REMOVED***),
        (edges_with_multiple_attrs, {***REMOVED***),
        (edges_with_multiple_attrs_csv, {"delimiter": ","***REMOVED***),
    ),
)
...
@pytest.mark.parametrize(
    ...
    (
        (edges_with_weight, {***REMOVED***, _expected_edges_weights),
        (edges_with_multiple_attrs, {***REMOVED***, _expected_edges_multiattr),
        (edges_with_multiple_attrs_csv, {"delimiter": ","***REMOVED***, _expected_edges_multiattr),
    ),
)
...
def test_parse_edgelist_with_data_dict(example_graph):
    G = example_graph
    H = nx.parse_edgelist(
        ["1 2 {'weight': 3***REMOVED***", "2 3 {'weight': 27***REMOVED***", "3 4 {'weight': 3.0***REMOVED***"], nodetype=int
    )
    assert nodes_equal(G.nodes, H.nodes)
...
class TestEdgelist:
    ...
    def test_write_edgelist_3(self):
        ...
        nx.write_edgelist(G, fh, data=True)
        fh.seek(0)
        assert fh.read() == b"1 2 {'weight': 2.0***REMOVED***\n2 3 {'weight': 3.0***REMOVED***\n"
    ...
    def test_unicode(self):
        ...
        G.add_edge(name1, "Radiohead", **{name2: 3***REMOVED***)
