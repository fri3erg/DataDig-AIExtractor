...
class NotAPartition(NetworkXError):
    ...
    def __init__(self, G, collection):
        msg = f"{collection***REMOVED*** is not a valid partition of the graph {G***REMOVED***"
        super().__init__(msg)
...
def _require_partition(G, partition):
    ...
    order)::
        ...
        >>> partition = [{0, 1***REMOVED***, {2, 3***REMOVED***, {4***REMOVED***]
        >>> foo(G, partition)
        partition is valid!
        >>> partition = [{0***REMOVED***, {2, 3***REMOVED***, {4***REMOVED***]
        >>> foo(G, partition)
        Traceback (most recent call last):
          ...
        networkx.exception.NetworkXError: `partition` is not a valid partition of the nodes of G
        >>> partition = [{0, 1***REMOVED***, {1, 2, 3***REMOVED***, {4***REMOVED***]
        >>> foo(G, partition)
        Traceback (most recent call last):
          ...
        networkx.exception.NetworkXError: `partition` is not a valid partition of the nodes of G
...
def modularity(G, communities, weight="weight", resolution=1):
    ...
    .. math::
        Q = \frac{1***REMOVED***{2m***REMOVED*** \sum_{ij***REMOVED*** \left( A_{ij***REMOVED*** - \gamma\frac{k_ik_j***REMOVED***{2m***REMOVED***\right)
            \delta(c_i,c_j)
    ...
    .. math::
       Q = \sum_{c=1***REMOVED***^{n***REMOVED***
       \left[ \frac{L_c***REMOVED***{m***REMOVED*** - \gamma\left( \frac{k_c***REMOVED***{2m***REMOVED*** \right) ^2 \right]
    ...
    For directed graphs the second formula replaces $k_c$ with $k^{in***REMOVED***_c k^{out***REMOVED***_c$.
    ...
    >>> nx.community.modularity(G, [{0, 1, 2***REMOVED***, {3, 4, 5***REMOVED***])
    0.35714285714285715
