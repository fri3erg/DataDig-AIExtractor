...
class WrappedCythonOp:
    ...
    ***REMOVED***
    ...
    _cython_arity = {"ohlc": 4***REMOVED***  # OHLC
        ...
        if is_numeric:
            ...
            if how in ["median", "cumprod"]:
                ...
                raise NotImplementedError(
                    ...
                    f"[how->{how***REMOVED***,dtype->{dtype_str***REMOVED***]"
    ***REMOVED***
    ...
    def _get_out_dtype(self, dtype: np.dtype) -> np.dtype:
        ...
        if how == "rank":
            ...
            if dtype.kind in "iufcb":
                out_dtype = f"{dtype.kind***REMOVED***{dtype.itemsize***REMOVED***"
            else:
                out_dtype = "object"
...
***REMOVED***
    ...
    ***REMOVED***
                ...
                raise NotImplementedError(f"{self.how***REMOVED*** is not implemented")
        else:
            # TODO: min_count
            if self.how != "rank":
