...
def lookup_by_userid_demo():
    ...
    for info in user_info:
        ...
        print(f"{name***REMOVED***, followers: {followers***REMOVED***, following: {following***REMOVED***")
...
def limit_by_time_demo(keywords="nltk"):
    ...
    print(f"Cutoff date: {dt_date***REMOVED***\n")

    for tweet in client.search_tweets(keywords=keywords):
        print("{***REMOVED*** ".format(tweet["created_at"]), end="")
