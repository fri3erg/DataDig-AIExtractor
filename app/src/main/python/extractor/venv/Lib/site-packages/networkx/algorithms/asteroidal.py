...
def find_asteroidal_triple(G):
    ...
    :math:`O(|V||\overline{E***REMOVED*** + |V||E|)`, where the second term is the
...
def create_component_structure(G):
    ...
    .. math::
        c_{uv***REMOVED*** = \begin{cases***REMOVED*** 0, if v \in N[u] \\
            k, if v \in component k of G \setminus N[u] \end{cases***REMOVED***
    ...
    """
    V = set(G.nodes)
    component_structure = {***REMOVED***
    for v in V:
        label = 0
        closed_neighborhood = set(G[v]).union({v***REMOVED***)
        row_dict = {***REMOVED***
