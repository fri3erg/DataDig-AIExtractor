...
***REMOVED***
    ...
    def _identifying_params(self) -> Mapping[str, Any]:
        ...
        return {
            **{"gradient_api_url": self.gradient_api_url***REMOVED***,
    ...
    def _kwargs_post_fine_tune_request(
        ...
        """
        _model_kwargs = self.model_kwargs or {***REMOVED***
        _params = {**_model_kwargs, **kwargs***REMOVED***

        multipliers = _params.get("multipliers", None)

        return dict(
            url=f"{self.gradient_api_url***REMOVED***/models/{self.model_id***REMOVED***/fine-tune",
            headers={
                "authorization": f"Bearer {self.gradient_access_token***REMOVED***",
                "x-gradient-workspace-id": f"{self.gradient_workspace_id***REMOVED***",
...
***REMOVED***,
    ...
    def _kwargs_post_request(
        ...
        return dict(
            url=f"{self.gradient_api_url***REMOVED***/models/{self.model_id***REMOVED***/complete",
            headers={
                "authorization": f"Bearer {self.gradient_access_token***REMOVED***",
                "x-gradient-workspace-id": f"{self.gradient_workspace_id***REMOVED***",
                "accept": "application/json",
...
***REMOVED***,
    ...
    def _call(
        ...
        **kwargs: Any,
        ...
        """Call to Gradients API `model/{id***REMOVED***/complete`.
    ...
    ***REMOVED***
            ...
            raise Exception(f"RequestException while calling Gradient Endpoint: {e***REMOVED***")
    ...
    async def _acall(
        ...
        **kwargs: Any,
        ...
        """Async Call to Gradients API `model/{id***REMOVED***/complete`.
