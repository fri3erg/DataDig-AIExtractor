...
class HoleSemantics:
    ...
    def __init__(self, usr):
        ...
        self.holes = set()
        self.labels = set()
        self.fragments = {***REMOVED***  # mapping of label -> formula fragment
    ...
    def pluggings(self):
        ...
        """
        record = []
        self._plug_nodes([(self.top_hole, [])], self.top_most_labels, {***REMOVED***, record)
        return record
...
class Constraint:
    ...
    def __repr__(self):
        return f"({self.lhs***REMOVED*** < {self.rhs***REMOVED***)"
