...
class TLSinTLSStream(NetworkStream):  # pragma: no cover
    ...
    def read(self, max_bytes: int, timeout: typing.Optional[float] = None) -> bytes:
        exc_map: ExceptionMapping = {socket.timeout: ReadTimeout, OSError: ReadError***REMOVED***
...
***REMOVED***
    ...
    def write(self, buffer: bytes, timeout: typing.Optional[float] = None) -> None:
        exc_map: ExceptionMapping = {socket.timeout: WriteTimeout, OSError: WriteError***REMOVED***
        with map_exceptions(exc_map):
            self._sock.settimeout(timeout)
            while buffer:
