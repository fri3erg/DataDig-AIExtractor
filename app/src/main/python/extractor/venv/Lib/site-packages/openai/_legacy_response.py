...
***REMOVED***
        ...
        if (
            ...
            raise RuntimeError(
                f"Invalid state, expected {cast_to***REMOVED*** to be a subclass type of {BaseModel***REMOVED***, {dict***REMOVED***, {list***REMOVED*** or {Union***REMOVED***."
***REMOVED***
        ...
        ***REMOVED***
            ...
            if self._client._strict_response_validation:
                raise APIResponseValidationError(
                    response=response,
                    message=f"Expected Content-Type response header to be `application/json` but received `{content_type***REMOVED***` instead.",
                    body=response.text,
    ***REMOVED***
    ...
    def __repr__(self) -> str:
        return f"<APIResponse [{self.status_code***REMOVED*** {self.http_response.reason_phrase***REMOVED***] type={self._cast_to***REMOVED***>"
...
def _extract_stream_chunk_type(stream_cls: type) -> type:
    ...
    if not args:
        raise TypeError(
            f"Expected stream_cls to have been given a generic type argument, e.g. Stream[Foo] but received {stream_cls***REMOVED***",
        )
...
def to_raw_response_wrapper(func: Callable[P, R]) -> Callable[P, LegacyAPIResponse[R]]:
    ...
    def wrapped(*args: P.args, **kwargs: P.kwargs) -> LegacyAPIResponse[R]:
        extra_headers = {**(cast(Any, kwargs.get("extra_headers")) or {***REMOVED***)***REMOVED***
