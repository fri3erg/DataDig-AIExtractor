...
def add(x1, x2):
    ...
    if type(arr1.dtype) != type(arr2.dtype):
        ...
        raise TypeError(
            ...
            f"got dtypes: '{arr1.dtype***REMOVED***' and '{arr2.dtype***REMOVED***' (the few cases "
