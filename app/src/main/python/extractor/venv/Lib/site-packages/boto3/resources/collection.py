...
***REMOVED***,
    ...
    def _clone(self, **kwargs):
        ...
        rather than the original. This allows things like:
            ...
            >>> query1.params
            {'Param1': 1, 'Param2': 2***REMOVED***
            >>> query2.params
            {'Param1': 1, 'Param3': 3***REMOVED***
...
***REMOVED***
            ...
            pages = paginator.paginate(
                PaginationConfig={'MaxItems': limit, 'PageSize': page_size***REMOVED***,
                **params
***REMOVED***
        else:
            logger.debug(
...
class CollectionFactory:
    ...
    def load_from_definition(
        ...
        if service_context.service_name == resource_name:
            cls_name = '{***REMOVED***.{***REMOVED***Collection'.format(
                service_context.service_name, collection_name
***REMOVED***
        else:
            cls_name = '{***REMOVED***.{***REMOVED***.{***REMOVED***Collection'.format(
