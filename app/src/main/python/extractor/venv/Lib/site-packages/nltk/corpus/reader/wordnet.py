...
class Synset(_WordNetObject):
 ...
 Synset('physical_entity.n.01'), Synset('entity.n.01')]
    ...
    def hypernym_distances(self, distance=0, simulate_root=False):
        ...
        """
        distances = {(self, distance)***REMOVED***
...
***REMOVED***
    ...
    def __repr__(self):
        return f"{type(self).__name__***REMOVED***('{self._name***REMOVED***')"
...
class WordNetCorpusReader(CorpusReader):
    ...
    # { Filename constants
    _FILEMAP = {ADJ: "adj", ADV: "adv", NOUN: "noun", VERB: "verb"***REMOVED***
    # ***REMOVED***

    # { Part of speech constants
    _pos_numbers = {NOUN: 1, VERB: 2, ADJ: 3, ADV: 4, ADJ_SAT: 5***REMOVED***
...
***REMOVED***
        ...
        self._data_file_map = {***REMOVED***
        self._exception_map = {***REMOVED***
        self._lexnames = []
        ...
        for source in synset_to_many:
            ...
            if candidates_bag:
                ...
                if source[-1] == "s":
                    ...
                    synset_to_one[f"{source[:-1]***REMOVED***a"] = target
            else:
    ...
    def ss2of(self, ss):
        ...
        if ss:
            return f"{ss.offset():08d***REMOVED***-{ss.pos()***REMOVED***"
    ...
    def _load_lang_data(self, lang):
        ...
        with reader.open(f"{prov***REMOVED***/wn-{prov2***REMOVED***-{lang.split('_')[0]***REMOVED***.tab") as fp:
        ...
        for fileid in fileids:
            ...
            if file_extension == ".tab":
                ...
                if lang in self.provenances or prov in ["cldr", "wikt"]:
                    ...
                    lang = f"{lang***REMOVED***_{prov***REMOVED***"
    ...
    def _load_exception_map(self):
        ...
        for pos, suffix in self._FILEMAP.items():
            self._exception_map[pos] = {***REMOVED***
    ...
    def lemma(self, name, lang="eng"):
        ...
        for lemma in synset.lemmas(lang):
            if lemma._name == lemma_name:
                return lemma
        raise WordNetError(f"No lemma {lemma_name!r***REMOVED*** in {synset_name!r***REMOVED***")
    ...
    def synset(self, name):
        ...
        try:
            ...
            raise WordNetError(f"No lemma {lemma!r***REMOVED*** with part of speech {pos!r***REMOVED***") from e
        except IndexError as e:
            n_senses = len(self._lemma_pos_offset_map[lemma][pos])
            raise WordNetError(
                f"Lemma {lemma!r***REMOVED*** with part of speech {pos!r***REMOVED*** only "
                f"has {n_senses***REMOVED*** {'sense' if n_senses == 1 else 'senses'***REMOVED***"
***REMOVED*** from e
...
***REMOVED***
    ...
    def synset_from_pos_and_offset(self, pos, offset):
        ...
        if (
            line_offset.isalnum()
            and line_offset == f"{'0'*(8-len(str(offset)))***REMOVED***{str(offset)***REMOVED***"
        ):
            ...
            synset = None
            warnings.warn(f"No WordNet synset found for pos={pos***REMOVED*** at offset={offset***REMOVED***.")
        data_file.seek(0)
        return synset
    ...
    def _synset_from_pos_and_line(self, pos, data_file_line):
        ...
        # raise a more informative error with line text
            ...
            raise WordNetError(f"line {data_file_line!r***REMOVED***: {e***REMOVED***") from e
...
***REMOVED***
    ...
    ***REMOVED***
    ...
    #                warnings.warn(f"Language {lang***REMOVED***: no synset found for {of***REMOVED***")
    ...
    def synonyms(self, word, lang="eng"):
        ...
        return [
            sorted(list(set(ss.lemma_names(lang=lang)) - {word***REMOVED***))
    ...
    def doc(self, file="README", lang="eng"):
        ...
        if lang == "eng":
            ...
            if lang in self.langs():
                file = f"{os.path.join(self.provenances[lang],file)***REMOVED***"
        try:
            with reader.open(file) as fp:
                return fp.read()
        except:
            if lang in self._lang_data:
                return f"Cannot determine {file***REMOVED*** for {lang***REMOVED***"
            else:
                return f"Language {lang***REMOVED*** is not supported."
    ...
    ***REMOVED***
    ...
    def custom_lemmas(self, tab_file, lang):
        ...
        for line in tab_file.readlines():
            ...
            ***REMOVED***:
                            warnings.warn(
                                f"{lang***REMOVED***: invalid offset {offset_pos***REMOVED*** in '{line***REMOVED***'"
                ***REMOVED***
                        continue
                elif offset_pos[-1] == "a":
