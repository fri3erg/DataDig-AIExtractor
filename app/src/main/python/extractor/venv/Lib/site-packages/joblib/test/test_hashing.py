...
input_list = [1, 2, 1., 2., 1 + 1j, 2. + 1j,
              'a', 'b',
              (1,), (1, 1,), [1, ], [1, 1, ],
              {1: 1***REMOVED***, {1: 2***REMOVED***, {2: 1***REMOVED***,
              None,
              gc.collect,
              [1, ].append,
...
def test_hash_numpy_dict_of_arrays(three_np_arrays):
    ...
    d1 = {1: arr1, 2: arr2***REMOVED***
    d2 = {1: arr2, 2: arr1***REMOVED***
    d3 = {1: arr2, 2: arr3***REMOVED***
...
def test_dict_hash(tmpdir):
    ...
    d = {'#s12069__c_maps.nii.gz': [33],
         ...
         '#s13983__c_maps.nii.gz': [33]***REMOVED***
...
def test_string():
    ...
    string = 'foo'
    a = {string: 'bar'***REMOVED***
    b = {string: 'bar'***REMOVED***
...
@parametrize('to_hash,expected',
             [('This is a string to hash',
              ...
              ({'abcde': 123, 'sadfas': [-9999, 2, 3]***REMOVED***,
