...
def strip_markdown_code(md_string: str) -> str:
    ...
    stripped_string = re.sub(r"^`{1,3***REMOVED***.*?\n", "", md_string, flags=re.DOTALL)
    stripped_string = re.sub(r"`{1,3***REMOVED***$", "", stripped_string)
...
class BearlyInterpreterTool:
    ...
    files: Dict[str, FileInfo] = {***REMOVED***
    ...
    def file_description(self) -> str:
        ...
        for target_path, file_info in self.files.items():
            ...
            lines.append(
                f"- path: `{target_path***REMOVED***` \n first four lines: {peek_content***REMOVED***"
                f" \n description: `{file_info.description***REMOVED***`"
***REMOVED***
        return "\n".join(lines)
    ...
    def _run(self, python_code: str) -> dict:
        ...
        resp = requests.post(
            ...
            data=json.dumps(
                ...
                ***REMOVED***
***REMOVED***,
            headers={"Authorization": self.api_key***REMOVED***,
        ).json()
        return {
