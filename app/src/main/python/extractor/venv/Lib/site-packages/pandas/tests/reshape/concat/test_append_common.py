...
class TestConcatAppendCommon:
    ...
    def test_concatlike_dtypes_coercion(self, item, item2, request):
        ...
        if typ1 == "bool" and typ2 in ("int64", "float64"):
            ...
            mark = pytest.mark.xfail(reason="GH#39187 casting to object")
            request.applymarker(mark)
        elif typ1 in {"datetime64[ns, US/Eastern]", "timedelta64[ns]"***REMOVED*** or typ2 in {
            "datetime64[ns, US/Eastern]",
            "timedelta64[ns]",
        ***REMOVED***:
    ...
    def test_categorical_concat_append(self):
        ...
        vals2 = [1, 2, 1, 2]
        exp = DataFrame({"cats": cat2, "vals": vals2***REMOVED***, index=Index([0, 1, 0, 1]))
        ...
        vals3 = [1, 2]
        df_different_categories = DataFrame({"cats": cat3, "vals": vals3***REMOVED***)

        res = pd.concat([df, df_different_categories], ignore_index=True)
        exp = DataFrame({"cats": list("abab"), "vals": [1, 2, 1, 2]***REMOVED***)
