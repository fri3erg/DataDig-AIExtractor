...
class TestMultiLevel:
    ...
    def test_empty_frame_groupby_dtypes_consistency(self, d):
        # GH 20888
        group_keys = ["a", "b", "c"]
        df = DataFrame({"a": [1], "b": [2], "c": [3], "d": [d]***REMOVED***)
    ...
    def test_datetime_object_multiindex(self):
        data_dic = {
            (0, datetime.date(2018, 3, 3)): {"A": 1, "B": 10***REMOVED***,
            (0, datetime.date(2018, 3, 4)): {"A": 2, "B": 11***REMOVED***,
            (1, datetime.date(2018, 3, 3)): {"A": 3, "B": 12***REMOVED***,
            (1, datetime.date(2018, 3, 4)): {"A": 4, "B": 13***REMOVED***,
        ***REMOVED***
        result = DataFrame.from_dict(data_dic, orient="index")
        data = {"A": [1, 2, 3, 4], "B": [10, 11, 12, 13]***REMOVED***
        index = [
            [0, 0, 1, 1],
            [
...
class TestSorted:
    ...
    def test_sort_non_lexsorted(self):
        ...
        df = DataFrame({"col": range(len(idx))***REMOVED***, index=idx, dtype="int64")
