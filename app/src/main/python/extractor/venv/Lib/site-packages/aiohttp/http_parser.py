...
class HeadersParser:
    ...
    def parse_headers(
        ...
        while line:
            ...
            if {bname[0], bname[-1]***REMOVED*** & {32, 9***REMOVED***:  # {" ", "\t"***REMOVED***
            ...
            if len(bname) > self.max_field_size:
                raise LineTooLong(
                    "request header name {***REMOVED***".format(
            ...
            if continuation:
                ...
                while continuation:
                    ...
                    if header_length > self.max_field_size:
                        raise LineTooLong(
                            "request header field {***REMOVED***".format(
                                bname.decode("utf8", "backslashreplace")
                ***REMOVED***,
                            str(self.max_field_size),
                            str(header_length),
...
class HttpParser(abc.ABC, Generic[_MsgT]):
    ...
    def parse_headers(
        ...
        if bad_hdr is not None:
            raise BadHttpMessage(f"Duplicate '{bad_hdr***REMOVED***' header found.")
