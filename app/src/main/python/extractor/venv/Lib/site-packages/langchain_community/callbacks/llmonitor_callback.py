...
def _serialize(obj: Any) -> Union[Dict[str, Any], List[Any], Any]:
    ...
    if isinstance(obj, dict):
        return {key: _serialize(value) for key, value in obj.items()***REMOVED***
...
def _parse_lc_message(message: BaseMessage) -> Dict[str, Any]:
    ...
    parsed = {"text": message.content, "role": _parse_lc_role(message.type)***REMOVED***
    parsed.update(
        {
...
class LLMonitorCallbackHandler(BaseCallbackHandler):
    ...
    llm = OpenAI(callbacks=[llmonitor_callback],
                 metadata={"userId": "user-123"***REMOVED***)
...
***REMOVED***
        ...
        if parse(self.__llmonitor_version) < parse("0.0.32"):
            logger.warning(
                ...
                {self.__llmonitor_version***REMOVED*** 
...
***REMOVED***
        ...
        try:
            res = requests.get(f"{self.__api_url***REMOVED***/api/app/{self.__app_id***REMOVED***")
            if not res.ok:
                raise ConnectionError()
        except Exception:
            logger.warning(
                f"""[LLMonitor] Could not connect to the LLMonitor API at 
                {self.__api_url***REMOVED***"""
***REMOVED***
    ...
    def on_llm_start(
        ...
        **kwargs: Any,
        ...
        try:
            ...
            params = kwargs.get("invocation_params", {***REMOVED***)
            params.update(
                serialized.get("kwargs", {***REMOVED***)
***REMOVED***  # Sometimes, for example with ChatAnthropic, `invocation_params` is empty
...
***REMOVED***
            ...
            warnings.warn(f"[LLMonitor] An error occurred in on_llm_start: {e***REMOVED***")
...
***REMOVED***
            ...
            logger.error(f"[LLMonitor] An error occurred in on_chat_model_start: {e***REMOVED***")
    ...
    def on_llm_end(
        ...
        **kwargs: Any,
        ...
        try:
            token_usage = (response.llm_output or {***REMOVED***).get("token_usage", {***REMOVED***)
...
***REMOVED***
            ...
            logger.error(f"[LLMonitor] An error occurred in on_llm_end: {e***REMOVED***")
...
***REMOVED***
            ...
            logger.error(f"[LLMonitor] An error occurred in on_tool_start: {e***REMOVED***")
...
***REMOVED***
            ...
            logger.error(f"[LLMonitor] An error occurred in on_tool_end: {e***REMOVED***")
...
***REMOVED***
            ...
            logger.error(f"[LLMonitor] An error occurred in on_chain_start: {e***REMOVED***")
...
***REMOVED***
            ...
            logger.error(f"[LLMonitor] An error occurred in on_chain_end: {e***REMOVED***")
...
***REMOVED***
            ...
            logger.error(f"[LLMonitor] An error occurred in on_agent_action: {e***REMOVED***")
...
***REMOVED***
            ...
            logger.error(f"[LLMonitor] An error occurred in on_agent_finish: {e***REMOVED***")
        ...
        **kwargs: Any,
        ...
        try:
            self.__track_event(
                ...
                run_id=str(run_id),
                parent_run_id=str(parent_run_id) if parent_run_id else None,
                error={"message": str(error), "stack": traceback.format_exc()***REMOVED***,
                app_id=self.__app_id,
***REMOVED***
        except Exception as e:
            logger.error(f"[LLMonitor] An error occurred in on_chain_error: {e***REMOVED***")
...
***REMOVED***
            ...
            logger.error(f"[LLMonitor] An error occurred in on_tool_error: {e***REMOVED***")
...
***REMOVED***
            ...
            logger.error(f"[LLMonitor] An error occurred in on_llm_error: {e***REMOVED***")
