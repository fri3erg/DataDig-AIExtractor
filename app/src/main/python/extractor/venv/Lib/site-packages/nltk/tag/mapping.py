...
def _load_universal_map(fileid):
    ...
    for line in contents.splitlines():
        ...
        assert coarse in _UNIVERSAL_TAGS, f"Unexpected coarse tag: {coarse***REMOVED***"
        assert (
            fine not in _MAPPINGS[fileid]["universal"]
        ), f"Multiple entries for original tag: {fine***REMOVED***"
...
def tagset_mapping(source, target):
    ...
    >>> tagset_mapping('ru-rnc', 'universal') == {'!': '.', 'A': 'ADJ', 'C': 'CONJ', 'AD': 'ADV',\
            ...
            'IJ': 'X', 'V': 'VERB', 'Z': 'X', 'VI': 'VERB', 'YES_NO_SENT': 'X', 'PTCL': 'PRT'***REMOVED***
    True
    """
