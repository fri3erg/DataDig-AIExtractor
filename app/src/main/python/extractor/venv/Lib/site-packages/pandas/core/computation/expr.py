...
_msg = f"cannot both support and not support {intersection***REMOVED***"
...
def _node_not_implemented(node_name: str) -> Callable[..., None]:
    ...
    def f(self, *args, **kwargs):
        raise NotImplementedError(f"'{node_name***REMOVED***' nodes are not implemented")
...
_op_classes = {"binary": BinOp, "unary": UnaryOp***REMOVED***
...
def add_ops(op_classes):
    ...
    def f(cls):
        for op_attr_name, op_class in op_classes.items():
            ops = getattr(cls, f"{op_attr_name***REMOVED***_ops")
            ops_map = getattr(cls, f"{op_attr_name***REMOVED***_op_nodes_map")
            for op in ops:
                op_node = ops_map[op]
                if op_node is not None:
                    made_op = _op_maker(op_class, op)
                    setattr(cls, f"visit_{op_node***REMOVED***", made_op)
        return cls
...
class BaseExprVisitor(ast.NodeVisitor):
    ...
    ***REMOVED***
    ...
    def visit(self, node, **kwargs):
        ...
        method = f"visit_{type(node).__name__***REMOVED***"
    ...
    def _maybe_evaluate_binop(
        ...
        if res.has_invalid_return_type:
            raise TypeError(
                f"unsupported operand type(s) for {res.op***REMOVED***: "
                f"'{lhs.type***REMOVED***' and '{rhs.type***REMOVED***'"
***REMOVED***
...
***REMOVED***
    ...
    def visit_Attribute(self, node, **kwargs):
        ...
        raise ValueError(f"Invalid Attribute context {type(ctx).__name__***REMOVED***")
    ...
    def visit_Call(self, node, side=None, **kwargs):
        ...
        if res is None:
            ...
            raise ValueError(
                f"Invalid function call {node.func.id***REMOVED***"  # type: ignore[attr-defined]
***REMOVED***
        ...
        if isinstance(res, FuncNode):
            ...
            if node.keywords:
                raise TypeError(
                    f'Function "{res.name***REMOVED***" does not support keyword arguments'
    ***REMOVED***
            ...
            for key in node.keywords:
                if not isinstance(key, ast.keyword):
                    ...
                    raise ValueError(
                        ...
                        f"'{node.func.id***REMOVED***'"  # type: ignore[attr-defined]
        ***REMOVED***
...
PARSERS = {"python": PythonExprVisitor, "pandas": PandasExprVisitor***REMOVED***
