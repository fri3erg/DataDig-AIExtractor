...
DEFAULT_URI_TEMPLATE = '{service***REMOVED***.{region***REMOVED***.{dnsSuffix***REMOVED***'  # noqa
DEFAULT_SERVICE_DATA = {'endpoints': {***REMOVED******REMOVED***
...
***REMOVED***
    ...
    def _resolve(
        ...
        endpoint_data = service_data.get('endpoints', {***REMOVED***).get(
...
***REMOVED***
        ...
        service_defaults = service_data.get('defaults', {***REMOVED***)
        partition_defaults = partition.get('defaults', {***REMOVED***)
...
***REMOVED***
            if result == {***REMOVED***:
                error_msg = (
                    f"Endpoint does not exist for {service_name***REMOVED*** "
                    f"in region {endpoint_name***REMOVED***"
    ***REMOVED***
...
***REMOVED***
        ...
        if not self._use_ssl and provider_result.url.startswith('https://'):
            provider_result = provider_result._replace(
                url=f'http://{provider_result.url[8:]***REMOVED***'
***REMOVED***
    ...
    ***REMOVED***
    ...
    def auth_schemes_to_signing_ctx(self, auth_schemes):
        ...
        LOG.debug(
            ...
            ', '.join([f'"{s.get("name")***REMOVED***"' for s in auth_schemes]),
        ...
        auth_schemes = [
            {**scheme, 'name': self._strip_sig_prefix(scheme['name'])***REMOVED***
