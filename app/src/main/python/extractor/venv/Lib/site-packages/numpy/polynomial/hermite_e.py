...
def hermemulx(c):
    ...
    .. math::
        ...
        xP_i(x) = (P_{i + 1***REMOVED***(x) + iP_{i - 1***REMOVED***(x)))
...
def hermeval2d(x, y, c):
    ...
    .. math:: p(x,y) = \\sum_{i,j***REMOVED*** c_{i,j***REMOVED*** * He_i(x) * He_j(y)
...
def hermegrid2d(x, y, c):
    ...
    .. math:: p(a,b) = \\sum_{i,j***REMOVED*** c_{i,j***REMOVED*** * H_i(a) * H_j(b)
...
def hermeval3d(x, y, z, c):
    ...
    .. math:: p(x,y,z) = \\sum_{i,j,k***REMOVED*** c_{i,j,k***REMOVED*** * He_i(x) * He_j(y) * He_k(z)
...
def hermegrid3d(x, y, z, c):
    ...
    .. math:: p(a,b,c) = \\sum_{i,j,k***REMOVED*** c_{i,j,k***REMOVED*** * He_i(a) * He_j(b) * He_k(c)
...
def hermegauss(deg):
    ...
    .. math:: w_k = c / (He'_n(x_k) * He_{n-1***REMOVED***(x_k))
