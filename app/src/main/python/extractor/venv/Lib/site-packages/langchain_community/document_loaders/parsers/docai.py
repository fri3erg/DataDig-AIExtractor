...
***REMOVED***
        ...
        if processor_name and not re.fullmatch(pattern, processor_name):
            raise ValueError(
                f"Processor name {processor_name***REMOVED*** has the wrong format. If your "
...
***REMOVED***
    ...
    ***REMOVED*** from exc
            options = ClientOptions(
                api_endpoint=f"{location***REMOVED***-documentai.googleapis.com"
***REMOVED***
...
***REMOVED***
        ...
        while self.is_running(operations):
            ...
            if time_elapsed > timeout_sec:
                raise TimeoutError(
                    "Timeout exceeded! Check operations " f"{operation_names***REMOVED*** later!"
    ***REMOVED***
            logger.debug(".")
        ...
        for result in results:
            ...
            yield from (
                Document(
                    ...
                    metadata={"page": page.page_number, "source": result.source_path***REMOVED***,
    ***REMOVED***
                for shard in shards
...
***REMOVED***
            ...
            for status in (
                ...
                if isinstance(op.metadata, BatchProcessMetadata)
                    ...
                    op.metadata.value
    ***REMOVED***.individual_process_statuses
***REMOVED***
        ]
