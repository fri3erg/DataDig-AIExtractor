...
def _itemsview_repr(view):
    lst = []
    for k, v in view:
        lst.append("{!r***REMOVED***: {!r***REMOVED***".format(k, v))
    body = ", ".join(lst)
    return "{***REMOVED***({***REMOVED***)".format(view.__class__.__name__, body)
...
def _mdrepr(md):
    lst = []
    for k, v in md.items():
        lst.append("'{***REMOVED***': {!r***REMOVED***".format(k, v))
    body = ", ".join(lst)
    return "<{***REMOVED***({***REMOVED***)>".format(md.__class__.__name__, body)
