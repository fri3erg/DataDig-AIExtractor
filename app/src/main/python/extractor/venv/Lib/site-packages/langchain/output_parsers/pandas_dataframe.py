...
class PandasDataFrameOutputParser(BaseOutputParser):
        ...
        # Check if the format is [1..5]
            ...
            if match:
                ...
                raise OutputParserException(
                    f"Unable to parse the array provided in {array***REMOVED***. \
    ...
    ***REMOVED***
        ...
        if not parsed_array:
            raise OutputParserException(
                f"Invalid array format in '{original_request_params***REMOVED***'. \
                    Please check the format instructions."
***REMOVED***
        elif (
            ...
            raise OutputParserException(
                f"The maximum index {parsed_array[-1]***REMOVED*** exceeds the maximum index of \
                    the Pandas DataFrame {self.dataframe.index.max()***REMOVED***."
***REMOVED***
    ...
    def parse(self, request: str) -> Dict[str, Any]:
        ...
        if len(splitted_request) != 2:
            raise OutputParserException(
                f"Request '{request***REMOVED***' is not correctly formatted. \
                    Please refer to the format instructions."
***REMOVED***
        result = {***REMOVED***
        try:
            request_type, request_params = splitted_request
            if request_type in {"Invalid column", "Invalid operation"***REMOVED***:
                raise OutputParserException(
                    f"{request***REMOVED***. Please check the format instructions."
    ***REMOVED***
    ...
    ***REMOVED***
        ...
        ***REMOVED***()
            ...
            if request_type not in {"column", "row"***REMOVED***:
                raise OutputParserException(
                    f"Unsupported request type '{request_type***REMOVED***'. \
                        Please check the format instructions."
    ***REMOVED***
            raise OutputParserException(
                f"""Requested index {
