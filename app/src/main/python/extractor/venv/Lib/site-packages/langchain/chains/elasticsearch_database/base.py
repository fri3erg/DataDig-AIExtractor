...
***REMOVED***
        ...
        if self.sample_documents_in_index_info > 0:
            for k, v in mappings.items():
                hits = self.database.search(
                    index=k,
                    query={"match_all": {***REMOVED******REMOVED***,
    ...
    ***REMOVED***["hits"]["hits"]
        ...
        return "\n\n".join(
            [
                "Mapping for index {***REMOVED***:\n{***REMOVED***".format(index, mappings[index]["mappings"])
    ...
    def _call(
        ...
        input_text = f"{inputs[self.input_key]***REMOVED***\nESQuery:"
...
***REMOVED***
            ...
            intermediate_steps.append(
                es_cmd
***REMOVED***  # output: elasticsearch dsl generation (no checker)
            intermediate_steps.append({"es_cmd": es_cmd***REMOVED***)  # input: ES search
            ...
            answer_inputs: dict = {"data": result, "input": input_text***REMOVED***
