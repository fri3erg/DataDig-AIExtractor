...
***REMOVED***
    ...
    def lc_secrets(self) -> Dict[str, str]:
        return {"gpt_router_api_key": "GPT_ROUTER_API_KEY"***REMOVED***
    ...
    def _identifying_params(self) -> Dict[str, Any]:
        ...
        return {
            **{"models_priority_list": self.models_priority_list***REMOVED***,
...
***REMOVED***
        ...
        params = {**params, **kwargs, "stream": False***REMOVED***
...
***REMOVED***
    ...
    def _create_chat_generation_chunk(
        ...
        chunk = _convert_delta_to_message_chunk(
            {"content": data.get("text", "")***REMOVED***, default_chunk_class
        )
...
***REMOVED***
        ...
        llm_output = {"token_usage": response.meta, "model": response.model***REMOVED***
