...
@nx._dispatch(graphs={"t1": 0, "t2": 2***REMOVED***)
def root_trees(t1, root1, t2, root2):
    ...
    namemap1 = {root1: newroot1***REMOVED***
    namemap2 = {root2: newroot2***REMOVED***
...
def rooted_tree_isomorphism(t1, root1, t2, root2):
    ...
    label = {v: 0 for v in dT***REMOVED***
    # and also ordered_labels and ordered_children
    # which will store ordered tuples
    ordered_labels = {v: () for v in dT***REMOVED***
    ordered_children = {v: () for v in dT***REMOVED***
...
@nx._dispatch(graphs={"t1": 0, "t2": 1***REMOVED***)
