...
ALLOWED_SCHEMAS = {"http", "https"***REMOVED***
ALLOWED_NETLOCK = {
    "youtu.be",
    "m.youtube.com",
    "youtube.com",
...
class YoutubeLoader(BaseLoader):
    ...
    def extract_video_id(youtube_url: str) -> str:
        ...
        if not video_id:
            raise ValueError(
                f"Could not determine the video ID for the URL {youtube_url***REMOVED***"
***REMOVED***
        return video_id
...
***REMOVED***
        ...
        metadata = {"source": self.video_id***REMOVED***
...
***REMOVED***
        yt = YouTube(f"https://www.youtube.com/watch?v={self.video_id***REMOVED***")
        video_info = {
        ...
        while request is not None:
            ...
            for item in response["items"]:
                if not item["id"].get("videoId"):
                    continue
                meta_data = {"videoId": item["id"]["videoId"]***REMOVED***
                if self.add_video_info:
        ...
        ***REMOVED***
                    ...
                    if self.continue_on_failure:
                        logger.error(
                            ...
                            + f" {item['id']['videoId']***REMOVED***, exception: {e***REMOVED***"
            ***REMOVED***
                    else:
                        raise e
                    pass
