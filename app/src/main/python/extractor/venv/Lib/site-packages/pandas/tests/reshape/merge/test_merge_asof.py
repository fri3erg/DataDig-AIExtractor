...
***REMOVED***
    ...
    def test_examples1(self):
        """doc-string examples"""
        left = pd.DataFrame({"a": [1, 5, 10], "left_val": ["a", "b", "c"]***REMOVED***)
        right = pd.DataFrame({"a": [1, 2, 3, 6, 7], "right_val": [1, 2, 3, 6, 7]***REMOVED***)

        expected = pd.DataFrame(
            {"a": [1, 5, 10], "left_val": ["a", "b", "c"], "right_val": [1, 3, 7]***REMOVED***
        )
...
***REMOVED***
    ...
    ***REMOVED***.astype(f"M8[{unit***REMOVED***]"),
    ...
    ***REMOVED***.astype(f"M8[{unit***REMOVED***]"),
    ...
    def test_examples3(self):
        ...
        expected = pd.DataFrame(
            {"a": [1, 5, 10], "left_val": ["a", "b", "c"], "right_val": [1, 6, np.nan]***REMOVED***
        )
    ...
    def test_examples4(self):
        ...
        expected = pd.DataFrame(
            {"a": [1, 5, 10], "left_val": ["a", "b", "c"], "right_val": [1, 6, 7]***REMOVED***
        )
...
***REMOVED***
    ...
    ***REMOVED***,
        ...
        trades = trades.astype({"ticker": dtype, "exch": dtype***REMOVED***)
    ...
    ***REMOVED***,
        ...
        quotes = quotes.astype({"ticker": dtype, "exch": dtype***REMOVED***)
    ...
    ***REMOVED***,
        ...
        expected = expected.astype({"ticker": dtype, "exch": dtype***REMOVED***)
...
***REMOVED***
    ...
    def test_with_duplicates_no_on(self):
        df1 = pd.DataFrame({"key": [1, 1, 3], "left_val": [1, 2, 3]***REMOVED***)
        df2 = pd.DataFrame({"key": [1, 2, 2], "right_val": [1, 2, 3]***REMOVED***)
        result = merge_asof(df1, df2, on="key")
        expected = pd.DataFrame(
            {"key": [1, 1, 3], "left_val": [1, 2, 3], "right_val": [1, 1, 3]***REMOVED***
        )
        tm.assert_frame_equal(result, expected)
...
***REMOVED***
    ...
    def test_tolerance_forward(self):
        ...
        left = pd.DataFrame({"a": [1, 5, 10], "left_val": ["a", "b", "c"]***REMOVED***)
        right = pd.DataFrame({"a": [1, 2, 3, 7, 11], "right_val": [1, 2, 3, 7, 11]***REMOVED***)

        expected = pd.DataFrame(
            {"a": [1, 5, 10], "left_val": ["a", "b", "c"], "right_val": [1, np.nan, 11]***REMOVED***
        )
    ...
    ***REMOVED***,
    ...
    def test_tolerance_float(self):
        # GH22981
        left = pd.DataFrame({"a": [1.1, 3.5, 10.9], "left_val": ["a", "b", "c"]***REMOVED***)
        right = pd.DataFrame(
            {"a": [1.0, 2.5, 3.3, 7.5, 11.5], "right_val": [1.0, 2.5, 3.3, 7.5, 11.5]***REMOVED***
        )
    ...
    def test_allow_exact_matches_forward(self):
        ...
        expected = pd.DataFrame(
            {"a": [1, 5, 10], "left_val": ["a", "b", "c"], "right_val": [2, 7, 11]***REMOVED***
        )
    ...
    def test_allow_exact_matches_nearest(self):
        ...
        expected = pd.DataFrame(
            {"a": [1, 5, 10], "left_val": ["a", "b", "c"], "right_val": [2, 3, 11]***REMOVED***
        )
    ...
    def test_allow_exact_matches_and_tolerance2(self):
        # GH 13695
        df1 = pd.DataFrame(
            {"time": to_datetime(["2016-07-15 13:30:00.030"]), "username": ["bob"]***REMOVED***
        )
        df2 = pd.DataFrame(
            {
                "time": to_datetime(
    ...
    ***REMOVED***,
    ...
    def test_allow_exact_matches_and_tolerance_forward(self):
        ...
        left = pd.DataFrame({"a": [1, 5, 10], "left_val": ["a", "b", "c"]***REMOVED***)
        right = pd.DataFrame({"a": [1, 3, 4, 6, 11], "right_val": [1, 3, 4, 6, 11]***REMOVED***)

        expected = pd.DataFrame(
            {"a": [1, 5, 10], "left_val": ["a", "b", "c"], "right_val": [np.nan, 6, 11]***REMOVED***
        )
    ...
    def test_allow_exact_matches_and_tolerance_nearest(self):
        ...
        left = pd.DataFrame({"a": [1, 5, 10], "left_val": ["a", "b", "c"]***REMOVED***)
        right = pd.DataFrame({"a": [1, 3, 4, 6, 11], "right_val": [1, 3, 4, 7, 11]***REMOVED***)

        expected = pd.DataFrame(
            {"a": [1, 5, 10], "left_val": ["a", "b", "c"], "right_val": [np.nan, 4, 11]***REMOVED***
        )
    ...
    ***REMOVED***,
    ...
    def test_on_float(self):
        ...
        df2 = pd.DataFrame(
            {"price": [0.0, 1.0, 100.0], "mpv": [0.0001, 0.01, 0.05]***REMOVED***,
            columns=["price", "mpv"],
        )
    ...
    def test_on_specialized_type(self, any_real_numpy_dtype):
        ...
        df1 = pd.DataFrame(
            {"value": [5, 2, 25, 100, 78, 120, 79], "symbol": list("ABCDEFG")***REMOVED***,
            columns=["symbol", "value"],
        )
        df1.value = dtype(df1.value)

        df2 = pd.DataFrame(
            {"value": [0, 80, 120, 125], "result": list("xyzw")***REMOVED***,
    ...
    def test_on_specialized_type_by_int(self, any_real_numpy_dtype):
        ...
        df2 = pd.DataFrame(
            {"value": [0, 80, 120, 125], "key": [1, 2, 2, 3], "result": list("xyzw")***REMOVED***,
    ...
    def test_merge_datatype_error_raises(self, using_infer_string):
        ...
        left = pd.DataFrame({"left_val": [1, 5, 10], "a": ["a", "b", "c"]***REMOVED***)
        right = pd.DataFrame({"right_val": [1, 2, 3, 6, 7], "a": [1, 2, 3, 6, 7]***REMOVED***)
    ...
    def test_merge_datatype_categorical_error_raises(self):
        ...
        left = pd.DataFrame(
            {"left_val": [1, 5, 10], "a": pd.Categorical(["a", "b", "c"])***REMOVED***
        )
        right = pd.DataFrame(
            {
                "right_val": [1, 2, 3, 6, 7],
    ...
    def test_merge_groupby_multiple_column_with_categorical_column(self):
        # GH 16454
        df = pd.DataFrame({"x": [0], "y": [0], "z": pd.Categorical([0])***REMOVED***)
        result = merge_asof(df, df, on="x", by=["y", "z"])
        expected = pd.DataFrame({"x": [0], "y": [0], "z": pd.Categorical([0])***REMOVED***)
        tm.assert_frame_equal(result, expected)
    ...
    def test_merge_on_nans(self, func, side):
        # GH 23189
        msg = f"Merge keys contain null values on {side***REMOVED*** side"
        nulls = func([1.0, 5.0, np.nan])
        non_nulls = func([1.0, 5.0, 10.0])
        df_null = pd.DataFrame({"a": nulls, "left_val": ["a", "b", "c"]***REMOVED***)
        df = pd.DataFrame({"a": non_nulls, "right_val": [1, 6, 11]***REMOVED***)
...
***REMOVED***
        ...
        left["time"] = pd.to_timedelta(left["time"], "ms").astype(f"m8[{unit***REMOVED***]")
        ...
        right["time"] = pd.to_timedelta(right["time"], "ms").astype(f"m8[{unit***REMOVED***]")
...
***REMOVED***,
        ...
        expected["time"] = pd.to_timedelta(expected["time"], "ms").astype(f"m8[{unit***REMOVED***]")
    ...
    def test_int_type_tolerance(self, any_int_dtype):
        ...
        left = pd.DataFrame({"a": [0, 10, 20], "left_val": [1, 2, 3]***REMOVED***)
        right = pd.DataFrame({"a": [5, 15, 25], "right_val": [1, 2, 3]***REMOVED***)
        left["a"] = left["a"].astype(any_int_dtype)
        right["a"] = right["a"].astype(any_int_dtype)

        expected = pd.DataFrame(
            {"a": [0, 10, 20], "left_val": [1, 2, 3], "right_val": [np.nan, 1.0, 2.0]***REMOVED***
        )
    ...
    def test_merge_index_column_tz(self):
        ...
        right = pd.DataFrame({"from_date": index, "abc": [2.46] * 4 + [2.19]***REMOVED***)
        result = merge_asof(
...
***REMOVED***
        ...
        df1 = pd.DataFrame({"val1": "foo"***REMOVED***, index=pd.DatetimeIndex(dr1))
        df2 = pd.DataFrame({"val2": "bar"***REMOVED***, index=pd.DatetimeIndex(dr2))

        expected = pd.DataFrame(
            {"val1": "foo", "val2": "bar"***REMOVED***, index=pd.DatetimeIndex(dr1)
        )
        result = merge_asof(
            df1,
            df2,
...
@pytest.mark.parametrize(
    "kwargs", [{"on": "x"***REMOVED***, {"left_index": True, "right_index": True***REMOVED***]
)
@pytest.mark.parametrize(
    "data",
...
def test_merge_asof_non_numerical_dtype(kwargs, data, infer_string):
    ...
    with option_context("future.infer_string", infer_string):
        left = pd.DataFrame({"x": data***REMOVED***, index=data)
        right = pd.DataFrame({"x": data***REMOVED***, index=data)
        with pytest.raises(
            MergeError,
...
def test_merge_asof_non_numerical_dtype_object():
    # GH#29130
    left = pd.DataFrame({"a": ["12", "13", "15"], "left_val1": ["a", "b", "c"]***REMOVED***)
    right = pd.DataFrame({"a": ["a", "b", "c"], "left_val": ["d", "e", "f"]***REMOVED***)
    with pytest.raises(
        MergeError,
        match=r"Incompatible merge dtype, .*, both sides must have numeric dtype",
    ):
...
@pytest.mark.parametrize(
    "kwargs",
    [
        {"right_index": True, "left_index": True***REMOVED***,
        {"left_on": "left_time", "right_index": True***REMOVED***,
        {"left_index": True, "right_on": "right"***REMOVED***,
    ],
)
def test_merge_asof_index_behavior(kwargs):
    # GH 33463
    index = Index([1, 5, 10], name="test")
    left = pd.DataFrame({"left": ["a", "b", "c"], "left_time": [1, 4, 10]***REMOVED***, index=index)
    right = pd.DataFrame({"right": [1, 2, 3, 6, 7]***REMOVED***, index=[1, 2, 3, 6, 7])
    result = merge_asof(left, right, **kwargs)

    expected = pd.DataFrame(
        {"left": ["a", "b", "c"], "left_time": [1, 4, 10], "right": [1, 3, 7]***REMOVED***,
        index=index,
    )
    tm.assert_frame_equal(result, expected)
...
def test_merge_asof_numeric_column_in_index():
    # GH#34488
    left = pd.DataFrame({"b": [10, 11, 12]***REMOVED***, index=Index([1, 2, 3], name="a"))
    right = pd.DataFrame({"c": [20, 21, 22]***REMOVED***, index=Index([0, 2, 3], name="a"))

    result = merge_asof(left, right, left_on="a", right_on="a")
    expected = pd.DataFrame({"a": [1, 2, 3], "b": [10, 11, 12], "c": [20, 21, 22]***REMOVED***)
    tm.assert_frame_equal(result, expected)
...
def test_merge_asof_numeri_column_in_index_object_dtype():
    # GH#34488
    left = pd.DataFrame({"b": [10, 11, 12]***REMOVED***, index=Index(["1", "2", "3"], name="a"))
    right = pd.DataFrame({"c": [20, 21, 22]***REMOVED***, index=Index(["m", "n", "o"], name="a"))
...
def test_merge_asof_array_as_on(unit):
    ...
    dti = pd.DatetimeIndex(
        ["2021/01/01 00:37", "2021/01/01 01:40"], dtype=f"M8[{unit***REMOVED***]"
    )
    right = pd.DataFrame(
        {
            "a": [2, 6],
    ...
    left = pd.DataFrame({"b": [4, 8, 7]***REMOVED***)
    result = merge_asof(
        left,
        right,
        left_on=ts_merge,
    ...
    expected = pd.DataFrame({"b": [4, 8, 7], "a": [np.nan, 2, 6], "ts": ts_merge***REMOVED***)
    tm.assert_frame_equal(result, expected)
...
def test_merge_asof_extension_dtype(dtype):
    ...
    left = left.astype({"join_col": dtype***REMOVED***)
    right = right.astype({"join_col": dtype***REMOVED***)
    ...
    expected = expected.astype({"join_col": dtype***REMOVED***)
    tm.assert_frame_equal(result, expected)
...
def test_merge_asof_read_only_ndarray():
    ...
    expected = pd.DataFrame({"left": [2], "right": [1]***REMOVED***, index=[2])
    tm.assert_frame_equal(result, expected)
