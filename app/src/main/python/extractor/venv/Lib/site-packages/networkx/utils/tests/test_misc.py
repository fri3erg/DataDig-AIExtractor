...
nested_mixed = [
    1,
    (2, 3, {4, (5, 6), 7***REMOVED***, [8, 9]),
    {10: "foo", 11: "bar", (12, 13): "baz"***REMOVED***,
    {(14, 15): "qwe", 16: "asd"***REMOVED***,
    (17, (18, "19"), 20),
]
...
class TestNumpyArray:
    ...
    def test__dict_to_numpy_array1(self):
        d = {"a": 1, "b": 2***REMOVED***
        a = _dict_to_numpy_array1(d, mapping={"a": 0, "b": 1***REMOVED***)
        np.testing.assert_allclose(a, np.array([1, 2]))
        a = _dict_to_numpy_array1(d, mapping={"b": 0, "a": 1***REMOVED***)
    ...
    def test__dict_to_numpy_array2(self):
        d = {"a": {"a": 1, "b": 2***REMOVED***, "b": {"a": 10, "b": 20***REMOVED******REMOVED***

        mapping = {"a": 1, "b": 0***REMOVED***
...
def test_groups():
    ...
    expected = {0: {"a", "b"***REMOVED***, 1: {"c", "d"***REMOVED***, 2: {"e"***REMOVED******REMOVED***
    assert actual == expected
    assert {***REMOVED*** == groups({***REMOVED***)
