...
CLIENT_ID_CHARACTER_SET = (r' !"#$%&\'()*+,-./0123456789:;<=>?@ABCDEFGHIJKLMN'
                           'OPQRSTUVWXYZ[\\]^_`abcdefghijklmnopqrstuvwxyz{|***REMOVED***')
    ...
    if hasattr(data, '__iter__'):
        try:
            ...
            if hasattr(data, 'items'):
                data = data.items()
            return {to_unicode(k, encoding): to_unicode(v, encoding) for k, v in data***REMOVED***
...
class CaseInsensitiveDict(dict):
    ...
    def __init__(self, data):
        self.proxy = {k.lower(): k for k in data***REMOVED***
        for k in data:
            self[k] = data[k]
...
class Request:
    ...
    * list of 2-tuples
    ...
    def __init__(self, uri, http_method='GET', body=None, headers=None,
        ...
        self.headers = CaseInsensitiveDict(encode(headers or {***REMOVED***))
        self.body = encode(body)
        self.decoded_body = extract_params(self.body)
        self.oauth_params = []
        self.validator_log = {***REMOVED***
    ...
    def __repr__(self):
        ...
        return '<oauthlib.Request url="{***REMOVED***", http_method="{***REMOVED***", headers="{***REMOVED***", body="{***REMOVED***">'.format(
