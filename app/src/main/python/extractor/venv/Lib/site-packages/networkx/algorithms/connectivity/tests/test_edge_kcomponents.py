...
***REMOVED***, "Subgraphs and components should be the same when k == 1 or (k == 2 and not G.directed())"
...
def test_bridge_cc():
    ...
    target_ccs = fset(
        [{1, 2, 3, 4***REMOVED***, {5***REMOVED***, {8, 9, 10***REMOVED***, {11, 12, 13***REMOVED***, {20***REMOVED***, {21***REMOVED***, {22***REMOVED***, {23***REMOVED***, {24***REMOVED***]
    )
...
def test_undirected_aux_graph():
    ...
    target_1 = fset([{a, b, c, d, e, f, g***REMOVED***, {h, i***REMOVED***])
    ...
    target_2 = fset([{a, b, c, d, e, f, g***REMOVED***, {h***REMOVED***, {i***REMOVED***])
    ...
    target_3 = fset([{a***REMOVED***, {b, c, f, g***REMOVED***, {d***REMOVED***, {e***REMOVED***, {h***REMOVED***, {i***REMOVED***])
    assert target_3 == components_3

    components_4 = fset(aux_graph.k_edge_subgraphs(k=4))
    target_4 = fset([{a***REMOVED***, {b***REMOVED***, {c***REMOVED***, {d***REMOVED***, {e***REMOVED***, {f***REMOVED***, {g***REMOVED***, {h***REMOVED***, {i***REMOVED***])
...
def test_local_subgraph_difference():
    ...
    subgraph_target = fset(
        [{101***REMOVED***, {102***REMOVED***, {103***REMOVED***, {104***REMOVED***, {21, 22, 23, 24***REMOVED***, {11, 12, 13, 14***REMOVED***]
    )
    ...
    local_target = fset([{101***REMOVED***, {102***REMOVED***, {103***REMOVED***, {104***REMOVED***, {11, 12, 13, 14, 21, 22, 23, 24***REMOVED***])
...
def test_four_clique():
    ...
    assert clique1.union(clique2).union({100***REMOVED***) in local_ccs
...
def test_directed_aux_graph():
    ...
    components_1 = fset(aux_graph.k_edge_subgraphs(k=1))
    target_1 = fset([{a, b, c, d, e, f, g***REMOVED***, {h***REMOVED***, {i***REMOVED***])
    assert target_1 == components_1
    ...
    components_2 = fset(aux_graph.k_edge_subgraphs(k=2))
    target_2 = fset([{i***REMOVED***, {e***REMOVED***, {d***REMOVED***, {b, c, f, g***REMOVED***, {h***REMOVED***, {a***REMOVED***])
    assert target_2 == components_2

    components_3 = fset(aux_graph.k_edge_subgraphs(k=3))
    target_3 = fset([{a***REMOVED***, {b***REMOVED***, {c***REMOVED***, {d***REMOVED***, {e***REMOVED***, {f***REMOVED***, {g***REMOVED***, {h***REMOVED***, {i***REMOVED***])
    assert target_3 == components_3
