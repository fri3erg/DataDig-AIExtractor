...
class FactWithEvidence(BaseModel):
    ...
    def _get_span(self, quote: str, context: str, errs: int = 100) -> Iterator[str]:
        ...
        errs_ = 0
        s = regex.search(f"({minor***REMOVED***){{e<={errs_***REMOVED******REMOVED******REMOVED***", major)
...
***REMOVED***
        ...
        HumanMessagePromptTemplate.from_template("{context***REMOVED***"),
        HumanMessagePromptTemplate.from_template("Question: {question***REMOVED***"),
        HumanMessage(
            content=(
