...
class TestBFS:
    ...
    def test_successor(self):
        assert dict(nx.bfs_successors(self.G, source=0)) == {0: [1], 1: [2, 3], 2: [4]***REMOVED***

    def test_predecessor(self):
        assert dict(nx.bfs_predecessors(self.G, source=0)) == {1: 0, 2: 1, 3: 1, 4: 2***REMOVED***
    ...
    def test_descendants_at_distance(self):
        for distance, descendants in enumerate([{0***REMOVED***, {1***REMOVED***, {2, 3***REMOVED***, {4***REMOVED***]):
...
class TestBreadthLimitedSearch:
    ...
    def test_limited_bfs_successor(self):
        ...
        ***REMOVED***
        assert result == {8: [9], 2: [3], 7: [2, 8]***REMOVED***
    ...
    def test_limited_descendants_at_distance(self):
        for distance, descendants in enumerate(
            [{0***REMOVED***, {1***REMOVED***, {2***REMOVED***, {3, 7***REMOVED***, {4, 8***REMOVED***, {5, 9***REMOVED***, {6, 10***REMOVED***]
        ):
            assert nx.descendants_at_distance(self.G, 0, distance) == descendants
        for distance, descendants in enumerate([{2***REMOVED***, {3, 7***REMOVED***, {8***REMOVED***, {9***REMOVED***, {10***REMOVED***]):
