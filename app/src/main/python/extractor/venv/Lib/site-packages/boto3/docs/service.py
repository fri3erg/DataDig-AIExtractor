...
class ServiceDocumenter(BaseServiceDocumenter):
    ...
    def _document_service_resource(self, section):
        ...
        breadcrumb_section.style.ref(
            self._client.__class__.__name__, f'../../{self._service_name***REMOVED***'
        )
        ...
        service_resource_dir_path = os.path.join(
            ...
            f'{resource_name.lower()***REMOVED***',
        )
        service_resource_doc.write_to_file(service_resource_dir_path, 'index')
        section.style.tocitem(f'{self._service_name***REMOVED***/{resource_name***REMOVED***/index')
...
***REMOVED***
            breadcrumb_section.write(
                f' / Resource / {resource.meta.resource_model.name***REMOVED***'
***REMOVED***
            ResourceDocumenter(
                resource, self._session, self._root_docs_path
***REMOVED***.document_resource(
...
***REMOVED***
            ...
            service_resource_dir_path = os.path.join(
                self._root_docs_path,
                f'{self._service_name***REMOVED***',
                f'{resource_name***REMOVED***',
***REMOVED***
            resource_doc.write_to_file(service_resource_dir_path, 'index')
            section.style.tocitem(
                f'{self._service_name***REMOVED***/{resource_name***REMOVED***/index'
***REMOVED***
