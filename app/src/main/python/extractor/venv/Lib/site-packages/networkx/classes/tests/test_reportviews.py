...
class TestNodeDataView:
    ...
    def test_str(self):
        msg = str([(n, {***REMOVED***) for n in range(9)])
    ...
    def test_repr(self):
        ...
        expected = (
            "NodeDataView({0: {***REMOVED***, 1: {***REMOVED***, 2: {***REMOVED***, 3: {***REMOVED***, "
            + "4: {***REMOVED***, 5: {***REMOVED***, 6: {***REMOVED***, 7: {***REMOVED***, 8: {***REMOVED******REMOVED***)"
        )
        assert repr(self.ndv) == expected
        expected = (
            "NodeDataView({0: None, 1: None, 2: None, 3: None, 4: None, "
            + "5: None, 6: None, 7: None, 8: None***REMOVED***, data='foo')"
        )
    ...
    def test_contains(self):
        ...
        G.nodes[3]["foo"] = "bar"
        assert (7, {***REMOVED***) in nv
        assert (3, {"foo": "bar"***REMOVED***) in nv
        assert (3, "bar") in nwv
    ...
    def test_iter(self):
        ...
        for i, (n, d) in enumerate(nv):
            ...
            assert d == {***REMOVED***
        inv = iter(nv)
        assert next(inv) == (0, {***REMOVED***)
        G.nodes[3]["foo"] = "bar"
        # default
        for n, d in nv:
            if n == 3:
                assert d == {"foo": "bar"***REMOVED***
            else:
                assert d == {***REMOVED***
        # data=True
        for n, d in ndv:
...
class TestNodeViewSetOps:
    ...
    def test_xor(self):
        ...
        nv = self.nv
        some_nodes = self.n_its(range(5, 12))
        nodes = {0, 1, 2, 3, 4, 9, 10, 11***REMOVED***
...
class TestNodeDataViewSetOps(TestNodeViewSetOps):
    ...
    def n_its(self, nodes):
        return {(node, "bar" if node == 3 else None) for node in nodes***REMOVED***
...
class TestNodeDataViewDefaultSetOps(TestNodeDataViewSetOps):
    ...
    def n_its(self, nodes):
        return {(node, "bar" if node == 3 else 1) for node in nodes***REMOVED***
...
class TestEdgeDataView:
    ...
    def test_str(self):
        ev = self.eview(self.G)(data=True)
        rep = str([(n, n + 1, {***REMOVED***) for n in range(8)])
        assert str(ev) == rep

    def test_repr(self):
        ev = self.eview(self.G)(data=True)
        rep = (
            "EdgeDataView([(0, 1, {***REMOVED***), (1, 2, {***REMOVED***), "
            + "(2, 3, {***REMOVED***), (3, 4, {***REMOVED***), "
            + "(4, 5, {***REMOVED***), (5, 6, {***REMOVED***), "
            + "(6, 7, {***REMOVED***), (7, 8, {***REMOVED***)])"
        )
        assert repr(ev) == rep
    ...
    def test_iterdata(self):
        ...
        for e in ev:
            assert len(e) == 3
            if set(e[:2]) == {2, 3***REMOVED***:
                assert e[2] == {"foo": "bar"***REMOVED***
                checked = True
            else:
                assert e[2] == {***REMOVED***
        assert checked
...
class TestOutEdgeDataView(TestEdgeDataView):
    ...
    def test_repr(self):
        ev = self.eview(self.G)(data=True)
        rep = (
            "OutEdgeDataView([(0, 1, {***REMOVED***), (1, 2, {***REMOVED***), "
            + "(2, 3, {***REMOVED***), (3, 4, {***REMOVED***), "
            + "(4, 5, {***REMOVED***), (5, 6, {***REMOVED***), "
            + "(6, 7, {***REMOVED***), (7, 8, {***REMOVED***)])"
        )
...
class TestInEdgeDataView(TestOutEdgeDataView):
    ...
    def test_repr(self):
        ev = self.eview(self.G)(data=True)
        rep = (
            "InEdgeDataView([(0, 1, {***REMOVED***), (1, 2, {***REMOVED***), "
            + "(2, 3, {***REMOVED***), (3, 4, {***REMOVED***), "
            + "(4, 5, {***REMOVED***), (5, 6, {***REMOVED***), "
            + "(6, 7, {***REMOVED***), (7, 8, {***REMOVED***)])"
        )
...
class TestMultiEdgeDataView(TestEdgeDataView):
    ...
    def test_repr(self):
        ev = self.eview(self.G)(data=True)
        rep = (
            "MultiEdgeDataView([(0, 1, {***REMOVED***), (1, 2, {***REMOVED***), "
            + "(2, 3, {***REMOVED***), (3, 4, {***REMOVED***), "
            + "(4, 5, {***REMOVED***), (5, 6, {***REMOVED***), "
            + "(6, 7, {***REMOVED***), (7, 8, {***REMOVED***)])"
        )
...
class TestOutMultiEdgeDataView(TestOutEdgeDataView):
    ...
    def test_repr(self):
        ev = self.eview(self.G)(data=True)
        rep = (
            "OutMultiEdgeDataView([(0, 1, {***REMOVED***), (1, 2, {***REMOVED***), "
            + "(2, 3, {***REMOVED***), (3, 4, {***REMOVED***), "
            + "(4, 5, {***REMOVED***), (5, 6, {***REMOVED***), "
            + "(6, 7, {***REMOVED***), (7, 8, {***REMOVED***)])"
        )
...
class TestInMultiEdgeDataView(TestOutMultiEdgeDataView):
    ...
    def test_repr(self):
        ev = self.eview(self.G)(data=True)
        rep = (
            "InMultiEdgeDataView([(0, 1, {***REMOVED***), (1, 2, {***REMOVED***), "
            + "(2, 3, {***REMOVED***), (3, 4, {***REMOVED***), "
            + "(4, 5, {***REMOVED***), (5, 6, {***REMOVED***), "
            + "(6, 7, {***REMOVED***), (7, 8, {***REMOVED***)])"
        )
...
class TestEdgeView:
    ...
    def test_and(self):
        ...
        ev = self.eview(self.G)
        some_edges = {(0, 1), (1, 0), (0, 2)***REMOVED***
        if self.G.is_directed():
            assert some_edges & ev, {(0, 1)***REMOVED***
            assert ev & some_edges, {(0, 1)***REMOVED***
        else:
            assert ev & some_edges == {(0, 1), (1, 0)***REMOVED***
            assert some_edges & ev == {(0, 1), (1, 0)***REMOVED***
        return
    ...
    def test_or(self):
        ...
        ev = self.eview(self.G)
        some_edges = {(0, 1), (1, 0), (0, 2)***REMOVED***
        result1 = {(n, n + 1) for n in range(8)***REMOVED***
        result1.update(some_edges)
        result2 = {(n + 1, n) for n in range(8)***REMOVED***
    ...
    def test_xor(self):
        ...
        some_edges = {(0, 1), (1, 0), (0, 2)***REMOVED***
        if self.G.is_directed():
            result = {(n, n + 1) for n in range(1, 8)***REMOVED***
            result.update({(1, 0), (0, 2)***REMOVED***)
            assert ev ^ some_edges == result
        else:
            result = {(n, n + 1) for n in range(1, 8)***REMOVED***
            result.update({(0, 2)***REMOVED***)
            assert ev ^ some_edges == result
        return
    ...
    def test_sub(self):
        ...
        ev = self.eview(self.G)
        some_edges = {(0, 1), (1, 0), (0, 2)***REMOVED***
        result = {(n, n + 1) for n in range(8)***REMOVED***
        result.remove((0, 1))
        assert ev - some_edges, result
...
class TestMultiEdgeView(TestEdgeView):
    ...
    def test_getitem(self):
        ...
        assert ev[0, 1, 0] == {"foo": "bar"***REMOVED***
    ...
    def test_iterkeys(self):
        ...
        for e in ev:
            ...
            if set(e[:2]) == {2, 3***REMOVED***:
                ...
                assert e[2] == 0
                assert e[3] == {"foo": "bar"***REMOVED***
                checked = True
            elif set(e[:3]) == {1, 2, 3***REMOVED***:
                assert e[2] == 3
                assert e[3] == {"foo": "bar"***REMOVED***
                checked_multi = True
            else:
        ...
        ev = evr(keys=True, data="foo", default=1)
        for e in ev:
            if set(e[:2]) == {1, 2***REMOVED*** and e[2] == 3:
                assert e[3] == "bar"
            if set(e[:2]) == {1, 2***REMOVED*** and e[2] == 0:
                assert e[3] == 1
            if set(e[:2]) == {2, 3***REMOVED***:
                assert e[2] == 0
                assert e[3] == "bar"
        ...
        for e in ev:
            if set(e[:2]) == {1, 2***REMOVED***:
                assert e[2] in {0, 3***REMOVED***
                if e[2] == 3:
                    assert e[3] == "bar"
                else:  # e[2] == 0
                    assert e[3] == 1
    ...
    def test_or(self):
        # print("G | H edges:", gnv | hnv)
        ev = self.eview(self.G)
        some_edges = {(0, 1, 0), (1, 0, 0), (0, 2, 0)***REMOVED***
        result = {(n, n + 1, 0) for n in range(8)***REMOVED***
        result.update(some_edges)
        result.update({(1, 2, 3)***REMOVED***)
        assert ev | some_edges == result
    ...
    def test_xor(self):
        ...
        some_edges = {(0, 1, 0), (1, 0, 0), (0, 2, 0)***REMOVED***
        if self.G.is_directed():
            result = {(n, n + 1, 0) for n in range(1, 8)***REMOVED***
            result.update({(1, 0, 0), (0, 2, 0), (1, 2, 3)***REMOVED***)
            assert ev ^ some_edges == result
            assert some_edges ^ ev == result
        else:
            result = {(n, n + 1, 0) for n in range(1, 8)***REMOVED***
            result.update({(0, 2, 0), (1, 2, 3)***REMOVED***)
            assert ev ^ some_edges == result
            assert some_edges ^ ev == result
    ...
    def test_and(self):
        ...
        some_edges = {(0, 1, 0), (1, 0, 0), (0, 2, 0)***REMOVED***
        if self.G.is_directed():
            assert ev & some_edges == {(0, 1, 0)***REMOVED***
            assert some_edges & ev == {(0, 1, 0)***REMOVED***
        else:
            assert ev & some_edges == {(0, 1, 0), (1, 0, 0)***REMOVED***
            assert some_edges & ev == {(0, 1, 0), (1, 0, 0)***REMOVED***
...
class TestDegreeView:
    ...
    def test_repr(self):
        dv = self.dview(self.G)
        rep = "DegreeView({0: 1, 1: 3, 2: 2, 3: 3, 4: 2, 5: 1***REMOVED***)"
        assert repr(dv) == rep
...
class TestDiDegreeView(TestDegreeView):
    ...
    def test_repr(self):
        dv = self.G.degree()
        rep = "DiDegreeView({0: 1, 1: 3, 2: 2, 3: 3, 4: 2, 5: 1***REMOVED***)"
        assert repr(dv) == rep
...
class TestOutDegreeView(TestDegreeView):
    ...
    def test_repr(self):
        dv = self.G.out_degree()
        rep = "OutDegreeView({0: 1, 1: 2, 2: 1, 3: 1, 4: 1, 5: 0***REMOVED***)"
        assert repr(dv) == rep
...
class TestInDegreeView(TestDegreeView):
    ...
    def test_repr(self):
        dv = self.G.in_degree()
        rep = "InDegreeView({0: 0, 1: 1, 2: 1, 3: 2, 4: 1, 5: 1***REMOVED***)"
        assert repr(dv) == rep
...
class TestMultiDegreeView(TestDegreeView):
    ...
    def test_repr(self):
        dv = self.G.degree()
        rep = "MultiDegreeView({0: 1, 1: 4, 2: 2, 3: 4, 4: 2, 5: 1***REMOVED***)"
        assert repr(dv) == rep
...
class TestDiMultiDegreeView(TestMultiDegreeView):
    ...
    def test_repr(self):
        dv = self.G.degree()
        rep = "DiMultiDegreeView({0: 1, 1: 4, 2: 2, 3: 4, 4: 2, 5: 1***REMOVED***)"
        assert repr(dv) == rep
...
class TestOutMultiDegreeView(TestDegreeView):
    ...
    def test_repr(self):
        dv = self.G.out_degree()
        rep = "OutMultiDegreeView({0: 1, 1: 3, 2: 1, 3: 1, 4: 1, 5: 0***REMOVED***)"
        assert repr(dv) == rep
...
class TestInMultiDegreeView(TestDegreeView):
    ...
    def test_repr(self):
        dv = self.G.in_degree()
        rep = "InMultiDegreeView({0: 0, 1: 1, 2: 1, 3: 3, 4: 1, 5: 1***REMOVED***)"
        assert repr(dv) == rep
