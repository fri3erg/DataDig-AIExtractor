...
<div><script>if (i < 2) { alert("<b>Markup within script tags should be treated as literal.</b>"); ***REMOVED***</script></div>
...
<div><a style={height:21px;***REMOVED***>That attribute value was bogus</a></div>
...
class TreeBuilderSmokeTest(object):
    ...
    @pytest.mark.parametrize(
        ...
        [None, {***REMOVED***, dict(b=['class']), {'*': ['notclass']***REMOVED***]
    )
    ...
    @pytest.mark.parametrize(
        "multi_valued_attributes", [dict(a=['class']), {'*': ['class']***REMOVED***]
    )
...
'''
    ...
    def test_entities_in_attributes_converted_to_unicode(self):
        expect = '<p id="pi\N{LATIN SMALL LETTER N WITH TILDE***REMOVED***ata"></p>'
    ...
    def test_entities_in_text_converted_to_unicode(self):
        expect = '<p>pi\N{LATIN SMALL LETTER N WITH TILDE***REMOVED***ata</p>'
    ...
    def test_out_of_range_entity(self):
        expect = "\N{REPLACEMENT CHARACTER***REMOVED***"
...
"""
    ...
    def test_can_parse_unicode_document(self):
        ...
        markup = '<html><head><meta encoding="euc-jp"></head><body>Sacr\N{LATIN SMALL LETTER E WITH ACUTE***REMOVED*** bleu!</body>'
        soup = self.soup(markup)
    ...
    def test_entities_in_strings_converted_during_parsing(self):
        ...
        expected = "<p>&lt;&lt;sacr\N{LATIN SMALL LETTER E WITH ACUTE***REMOVED*** bleu!&gt;&gt;</p>"
    ...
    def test_smart_quotes_converted_on_the_way_in(self):
        ...
        assert soup.p.string == "\N{LEFT SINGLE QUOTATION MARK***REMOVED***Foo\N{RIGHT SINGLE QUOTATION MARK***REMOVED***"

    def test_non_breaking_spaces_converted_on_the_way_in(self):
        soup = self.soup("<a>&nbsp;&nbsp;</a>")
        assert soup.a.string == "\N{NO-BREAK SPACE***REMOVED***" * 2

    def test_entities_converted_on_the_way_out(self):
        text = "<p>&lt;&lt;sacr&eacute;&#32;bleu!&gt;&gt;</p>"
        expected = "<p>&lt;&lt;sacr\N{LATIN SMALL LETTER E WITH ACUTE***REMOVED*** bleu!&gt;&gt;</p>".encode("utf-8")
        soup = self.soup(text)
    ...
    def test_real_iso_8859_document(self):
        ...
        unicode_html = '<html><head><meta content="text/html; charset=ISO-8859-1" http-equiv="Content-type"/></head><body><p>Sacr\N{LATIN SMALL LETTER E WITH ACUTE***REMOVED*** bleu!</p></body></html>'
    ...
    def test_meta_tag_reflects_current_encoding(self):
        ...
        parsed_meta = soup.find('meta', {'http-equiv': 'Content-type'***REMOVED***)
...
"""
    ...
    def test_can_parse_unicode_document(self):
        markup = '<?xml version="1.0" encoding="euc-jp"><root>Sacr\N{LATIN SMALL LETTER E WITH ACUTE***REMOVED*** bleu!</root>'
        soup = self.soup(markup)
        assert 'Sacr\xe9 bleu!' == soup.root.string

    def test_can_parse_unicode_document_begining_with_bom(self):
        markup = '\N{BYTE ORDER MARK***REMOVED***<?xml version="1.0" encoding="euc-jp"><root>Sacr\N{LATIN SMALL LETTER E WITH ACUTE***REMOVED*** bleu!</root>'
        soup = self.soup(markup)
        assert 'Sacr\xe9 bleu!' == soup.root.string
