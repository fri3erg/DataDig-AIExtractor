...
should have a question mark at the end: {question***REMOVED***""",
)
...
***REMOVED***
    ...
    def _get_relevant_documents(
        ...
        *,
        ...
        result = self.llm_chain({"question": query***REMOVED***)
        logger.info(f"Questions for Google Search (raw): {result***REMOVED***")
        questions = getattr(result["text"], "lines", [])
        logger.info(f"Questions for Google Search: {questions***REMOVED***")
        ...
        for query in questions:
            ...
            logger.info("Searching for relevant urls...")
            logger.info(f"Search results: {search_results***REMOVED***")
        ...
        logger.info(f"New URLs to load: {new_urls***REMOVED***")
