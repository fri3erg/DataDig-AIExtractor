...
@pytest.mark.parametrize(
    "args,kwds",
    [
        pytest.param([], {***REMOVED***, id="no_args_or_kwds"),
        pytest.param([1], {***REMOVED***, id="axis_from_args"),
        pytest.param([], {"axis": 1***REMOVED***, id="axis_from_kwds"),
        pytest.param([], {"numeric_only": True***REMOVED***, id="optional_kwds"),
        pytest.param([1, True], {"numeric_only": True***REMOVED***, id="args_and_kwds"),
    ],
)
...
def test_apply_np_reducer(op, how):
    # GH 39116
    float_frame = DataFrame({"a": [1, 2], "b": [3, 4]***REMOVED***)
    result = getattr(float_frame, how)(op)
    # pandas ddof defaults to 1, numpy to 0
    kwargs = {"ddof": 1***REMOVED*** if op in ("std", "var") else {***REMOVED***
    expected = Series(
