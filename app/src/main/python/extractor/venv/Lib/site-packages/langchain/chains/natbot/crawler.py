...
***REMOVED***
        ...
        self.page.set_viewport_size({"width": 1280, "height": 1080***REMOVED***)
    ...
    def go_to_page(self, url: str) -> None:
        ...
        self.page_element_buffer = {***REMOVED***
...
***REMOVED***
        ...
        page_state_as_text.append(
            {
                "x": 0,
                "y": 0,
                "text": "[scrollbar {:0.2f***REMOVED***-{:0.2f***REMOVED***%]".format(
    ...
    ***REMOVED***,
        ...
        tree = self.client.send(
            ...
            {"computedStyles": [], "includeDOMRects": True, "includePaintOrder": True***REMOVED***,
        )
        ...
        child_nodes: Dict[str, List[Dict[str, Any]]] = {***REMOVED***
        elements_in_view_port: List[ElementInViewPort] = []

        anchor_ancestry: Dict[str, Tuple[bool, Optional[int]]] = {"-1": (False, None)***REMOVED***
        button_ancestry: Dict[str, Tuple[bool, Optional[int]]] = {"-1": (False, None)***REMOVED***
...
***REMOVED***:  # found pages that needed this quirk
                return "button"
            else:
                return "text"
...
***REMOVED***:  # reuse the parent's anchor_id (which could be much higher in the tree)
                value = (True, anchor_id)
            else:
                value = (
                    False,
                    None,
    ***REMOVED***  # not a descendant of an anchor, most likely it will become text, an interactive element or discarded
...
***REMOVED***
            ...
            try:
                cursor = layout_node_index.index(
                    index
    ***REMOVED***  # todo replace this with proper cursoring, ignoring the fact this is O(n^2) for the moment
            except:
                continue
...
***REMOVED***
            ...
            if node_name == "#text" and ancestor_exception and ancestor_node:
                ...
                if text == "|" or text == "•":
                    continue
                ancestor_node.append({"type": "type", "value": text***REMOVED***)
            else:
                if (
                    node_name == "input" and element_attributes.get("type") == "submit"
    ***REMOVED*** or node_name == "button":
                    node_name = "button"
                    element_attributes.pop(
                        "type", None
        ***REMOVED***  # prevent [button ... (button)..]
            ...
            ***REMOVED***
            ...
            if node_value[index] >= 0:
                ...
                if (
                    element_node_value == "|"
    ***REMOVED***:  # commonly used as a separator, does not add much context - lets save ourselves some token space
                    continue
            elif (
                node_name == "input"
...
***REMOVED***
        ...
        for element in elements_in_view_port:
            ...
            inner_text = f"{element_node_value***REMOVED*** " if element_node_value else ""
            meta = ""
            ...
            if node_index in child_nodes:
                for child in child_nodes[node_index]:
                    ...
                    if entry_type == "attribute" and node_meta_data:
                        ...
                        node_meta_data.append(f'{entry_key***REMOVED***="{entry_value***REMOVED***"')
                    else:
                        inner_text += f"{entry_value***REMOVED*** "

            if node_meta_data:
                meta_string = " ".join(node_meta_data)
                meta = f" {meta_string***REMOVED***"

            if inner_text != "":
                inner_text = f"{inner_text.strip()***REMOVED***"
...
***REMOVED*** and inner_text.strip() == "":
            ...
            if inner_text != "":
                elements_of_interest.append(
                    f"""<{converted_node_name***REMOVED*** id={id_counter***REMOVED***{meta***REMOVED***>{inner_text***REMOVED***</{converted_node_name***REMOVED***>"""
    ***REMOVED***
            else:
                elements_of_interest.append(
                    f"""<{converted_node_name***REMOVED*** id={id_counter***REMOVED***{meta***REMOVED***/>"""
    ***REMOVED***
            id_counter += 1

        print("Parsing time: {:0.2f***REMOVED*** seconds".format(time.time() - start))
