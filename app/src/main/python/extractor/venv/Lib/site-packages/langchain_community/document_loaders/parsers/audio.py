...
***REMOVED***
        ...
        for split_number, i in enumerate(range(0, len(audio), chunk_duration_ms)):
            ...
            if blob.source is not None:
                file_obj.name = blob.source + f"_part_{split_number***REMOVED***.mp3"
            else:
                file_obj.name = f"part_{split_number***REMOVED***.mp3"

            # Transcribe
            print(f"Transcribing part {split_number+1***REMOVED***!")
            attempts = 0
            while attempts < 3:
                try:
                    if is_openai_v1():
            ...
            ***REMOVED***
                    ...
                    attempts += 1
                    print(f"Attempt {attempts***REMOVED*** failed. Exception: {str(e)***REMOVED***")
                    time.sleep(5)
            else:
            ...
            yield Document(
                ...
                metadata={"source": blob.source, "chunk": split_number***REMOVED***,
***REMOVED***
        ...
        if forced_decoder_ids is not None:
            try:
                ...
                logger.info(
                    ...
                    f"Text of exception: {exception_text***REMOVED***"
...
***REMOVED***
        ...
        # Transcribe
        print(f"Transcribing part {blob.path***REMOVED***!")
        ...
        yield Document(
            ...
            metadata={"source": blob.source***REMOVED***,
        )
