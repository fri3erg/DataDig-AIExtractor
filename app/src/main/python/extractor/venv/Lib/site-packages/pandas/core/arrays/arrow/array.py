...
class ArrowExtensionArray(
    ...
    def __init__(self, values: pa.Array | pa.ChunkedArray) -> None:
        ...
        if isinstance(values, pa.Array):
            ...
            raise ValueError(
                f"Unsupported type '{type(values)***REMOVED***' for ArrowExtensionArray"
***REMOVED***
    ...
    def _from_sequence_of_strings(
        ...
        if (
            ...
            raise NotImplementedError(
                f"Converting strings to {pa_type***REMOVED*** is not implemented."
***REMOVED***
...
***REMOVED***:
    ...
    def _cmp_method(self, other, op):
        ...
        if isinstance(
            ...
            raise NotImplementedError(
                f"{op.__name__***REMOVED*** not implemented for {type(other)***REMOVED***"
***REMOVED***
    ...
    def _evaluate_op_method(self, other, op, arrow_funcs):
        ...
        if pc_func is NotImplemented:
            raise NotImplementedError(f"{op.__name__***REMOVED*** not implemented.")
    ...
    def argsort(
        ...
        **kwargs,
        ...
        null_placement = {"last": "at_end", "first": "at_start"***REMOVED***.get(na_position, None)
    ...
    def _argmin_max(self, skipna: bool, method: str) -> int:
        if self._pa_array.length() in (0, self._pa_array.null_count) or (
            ...
            # let ExtensionArray.arg{max|min***REMOVED*** raise
            return getattr(super(), f"arg{method***REMOVED***")(skipna=skipna)
    ...
    def fillna(
        ...
        if isinstance(value, (np.ndarray, ExtensionArray)):
            ...
            if len(value) != len(self):
                raise ValueError(
                    f"Length of 'value' does not match. Got ({len(value)***REMOVED***) "
                    f" expected {len(self)***REMOVED***"
    ***REMOVED***

        try:
            fill_value = self._box_pa(value, pa_type=self._pa_array.type)
        except pa.ArrowTypeError as err:
            msg = f"Invalid value '{str(value)***REMOVED***' for dtype {self.dtype***REMOVED***"
...
***REMOVED***
    ...
    def reshape(self, *args, **kwargs):
        raise NotImplementedError(
            f"{type(self)***REMOVED*** does not support reshape "
...
***REMOVED*** and pa_dtype.unit == "ns":
    ...
    def _to_datetimearray(self) -> DatetimeArray:
        ...
        np_dtype = np.dtype(f"M8[{pa_type.unit***REMOVED***]")
...
***REMOVED***
    ...
    def _reduce_pyarrow(self, name: str, *, skipna: bool = True, **kwargs) -> pa.Scalar:
        ...
        **kwargs
        ...
        cast_kwargs = {***REMOVED*** if pa_version_under13p0 else {"safe": False***REMOVED***
        ...
        try:
            ...
            msg = (
                f"'{type(self).__name__***REMOVED***' with dtype {self.dtype***REMOVED*** "
                f"does not support reduction '{name***REMOVED***' with pyarrow "
                f"version {pa.__version__***REMOVED***. '{name***REMOVED***' may be supported by "
                f"upgrading pyarrow."
***REMOVED***
            raise TypeError(msg) from err
        if name == "median":
    ...
    ***REMOVED***
    ...
    def __setitem__(self, key, value) -> None:
        ...
        if com.is_null_slice(key):
            ...
            if not 0 <= key < n:
                raise IndexError(
                    f"index {key***REMOVED*** is out of bounds for axis 0 with size {n***REMOVED***"
    ***REMOVED***
            if isinstance(value, pa.Scalar):
                value = value.as_py()
    ...
    def interpolate(
        ...
        **kwargs,
        ...
        if self.dtype.kind == "f":
            ...
            raise NotImplementedError(
                f"interpolate is not implemented for dtype={self.dtype***REMOVED***"
***REMOVED***
...
***REMOVED***
    ...
    def _str_count(self, pat: str, flags: int = 0):
        if flags:
            raise NotImplementedError(f"count not implemented with {flags=***REMOVED***")
    ...
    def _str_contains(
        ...
        if flags:
            raise NotImplementedError(f"contains not implemented with {flags=***REMOVED***")
...
***REMOVED***
    ...
    def _str_repeat(self, repeats: int | Sequence[int]):
        if not isinstance(repeats, int):
            raise NotImplementedError(
                f"repeat is not implemented when repeats is {type(repeats).__name__***REMOVED***"
***REMOVED***
        else:
    ...
    def _str_find(self, sub: str, start: int = 0, end: int | None = None):
        if start != 0 and end is not None:
            ...
            raise NotImplementedError(
                f"find not implemented with {sub=***REMOVED***, {start=***REMOVED***, {end=***REMOVED***"
***REMOVED***
        return type(self)(result)
    ...
    def _str_extract(self, pat: str, flags: int = 0, expand: bool = True):
        ...
        if len(groups) == 0:
            raise ValueError(f"{pat=***REMOVED*** must contain a symbolic group name.")
...
***REMOVED***,
    ...
    def _dt_time(self):
        unit = (
            ...
            if self.dtype.pyarrow_dtype.unit in {"us", "ns"***REMOVED***
            else "ns"
        )
    ...
    def _round_temporally(
        ...
        if offset is None:
            raise ValueError(f"Must specify a valid frequency: {freq***REMOVED***")
        pa_supported_unit = {
            "Y": "year",
            "YS": "year",
            "Q": "quarter",
        ...
        ***REMOVED***
        ...
        if unit is None:
            raise ValueError(f"{freq=***REMOVED*** is not supported")
        multiple = offset.n
        rounding_method = getattr(pc, f"{method***REMOVED***_temporal")
    ...
    def _dt_to_pydatetime(self):
        if pa.types.is_date(self.dtype.pyarrow_dtype):
            raise ValueError(
                f"to_pydatetime cannot be called with {self.dtype.pyarrow_dtype***REMOVED*** type. "
...
***REMOVED***
    ...
    def _dt_tz_localize(
        ...
        if ambiguous != "raise":
            raise NotImplementedError(f"{ambiguous=***REMOVED*** is not supported")
        nonexistent_pa = {
            "raise": "raise",
        ...
        ***REMOVED***.get(
        ...
        if nonexistent_pa is None:
            raise NotImplementedError(f"{nonexistent=***REMOVED*** is not supported")
        if tz is None:
