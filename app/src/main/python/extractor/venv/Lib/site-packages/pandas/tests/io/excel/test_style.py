...
shared_style_params = [
    (
        ...
        ["fill", "fgColor", "rgb"],
        {"xlsxwriter": "FF111222", "openpyxl": "00111222"***REMOVED***,
    ),
    (
        "color: #111222",
        ["font", "color", "value"],
    ...
    (
        ...
        ["alignment", "vertical"],
        {"xlsxwriter": None, "openpyxl": "bottom"***REMOVED***,  # xlsxwriter Fails
    ),
...
def test_styler_to_excel_border_style(engine, border_style):
    css = f"border-left: {border_style***REMOVED*** black thin"
...
def test_styler_custom_converter():
    ...
    def custom_converter(css):
        return {"font": {"color": {"rgb": "111222"***REMOVED******REMOVED******REMOVED***
...
def test_styler_to_s3(s3_public_bucket, s3so):
    ...
    styler.to_excel(f"s3://{mock_bucket_name***REMOVED***/{target_file***REMOVED***", storage_options=s3so)
    timeout = 5
    while True:
        ...
        result = read_excel(
            f"s3://{mock_bucket_name***REMOVED***/{target_file***REMOVED***", index_col=0, storage_options=s3so
        )
