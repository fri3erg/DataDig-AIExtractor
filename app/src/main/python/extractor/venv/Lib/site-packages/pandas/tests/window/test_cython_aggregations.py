...
def _get_rolling_aggregations():
    ...
    named_roll_aggs = (
        ...
        + [
            (f"roll_var({ddof***REMOVED***)", partial(window_aggregations.roll_var, ddof=ddof))
            for ddof in [0, 1]
        ]
        + [
        ...
        + [
            (
                f"roll_quantile({quantile***REMOVED***,{interpolation***REMOVED***)",
                partial(
...
***REMOVED***
        ...
        + [
            (
                f"roll_rank({percentile***REMOVED***,{method***REMOVED***,{ascending***REMOVED***)",
                partial(
...
***REMOVED***
    ...
    return {"ids": unzipped[0], "params": unzipped[1]***REMOVED***
