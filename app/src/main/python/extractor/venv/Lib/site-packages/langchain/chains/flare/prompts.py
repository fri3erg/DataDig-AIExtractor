...
>>> USER INPUT: {user_input***REMOVED***
>>> EXISTING PARTIAL RESPONSE: {current_response***REMOVED***

The question to which the answer is the term/entity/phrase "{uncertain_span***REMOVED***" is:"""
