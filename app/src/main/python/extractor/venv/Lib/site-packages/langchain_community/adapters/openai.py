...
def _convert_message_chunk(chunk: BaseMessageChunk, i: int) -> dict:
    ...
    if isinstance(chunk, AIMessageChunk):
        ...
        raise ValueError(f"Got unexpected streaming chunk type: {type(chunk)***REMOVED***")
    # This only happens at the end of streams, and OpenAI returns as empty dict
    if _dict == {"content": ""***REMOVED***:
        _dict = {***REMOVED***
    return _dict
...
def _convert_message_chunk_to_delta(chunk: BaseMessageChunk, i: int) -> Dict[str, Any]:
    ...
    return {"choices": [{"delta": _dict***REMOVED***]***REMOVED***
    ...
    def create(
        ...
        **kwargs: Any,
        ...
        if not stream:
            ...
            return {"choices": [{"message": convert_message_to_dict(result)***REMOVED***]***REMOVED***
        else:
            return (
