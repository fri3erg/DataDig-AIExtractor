...
_ROLE_MAP = {"human": "Human: ", "ai": "Assistant: "***REMOVED***
...
def _get_chat_history(chat_history: List[CHAT_TURN_TYPE]) -> str:
    ...
    for dialogue_turn in chat_history:
        if isinstance(dialogue_turn, BaseMessage):
            role_prefix = _ROLE_MAP.get(dialogue_turn.type, f"{dialogue_turn.type***REMOVED***: ")
            buffer += f"\n{role_prefix***REMOVED***{dialogue_turn.content***REMOVED***"
            ...
            raise ValueError(
                f"Unsupported chat history format: {type(dialogue_turn)***REMOVED***."
                f" Full chat history: {chat_history***REMOVED*** "
***REMOVED***
    return buffer
...
***REMOVED***
            ...
            template = (
                ...
                "a standalone question. Chat History: {chat_history***REMOVED***"
                "Follow up question: {question***REMOVED***"
***REMOVED***
...
***REMOVED***
    ...
    def from_llm(
        ...
        **kwargs: Any,
        ...
        """
        combine_docs_chain_kwargs = combine_docs_chain_kwargs or {***REMOVED***
...
class ChatVectorDBChain(BaseConversationalRetrievalChain):
    ...
    def _get_docs(
        ...
        *,
        ...
        """Get docs."""
        vectordbkwargs = inputs.get("vectordbkwargs", {***REMOVED***)
        full_kwargs = {**self.search_kwargs, **vectordbkwargs***REMOVED***
