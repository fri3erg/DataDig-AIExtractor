...
============
    ...
    `(n, {'color': 'red'***REMOVED***) in VD`. DataViews allow set operations when
...
class NodeView(Mapping, Set):
    ...
    1
    2
    >>> assert NV & {1, 2, 3***REMOVED*** == {1, 2***REMOVED***
    ...
    def __getstate__(self):
        return {"_nodes": self._nodes***REMOVED***
    ...
    def __getitem__(self, n):
        if isinstance(n, slice):
            raise nx.NetworkXError(
                f"{type(self).__name__***REMOVED*** does not support slicing, "
                f"try list(G.nodes)[{n.start***REMOVED***:{n.stop***REMOVED***:{n.step***REMOVED***]"
***REMOVED***
    ...
    def data(self, data=True, default=None):
        ...
        >>> G = nx.Graph()
        >>> G.add_nodes_from([
        ...     (0, {"color": "red", "weight": 10***REMOVED***),
        ...     (1, {"color": "blue"***REMOVED***),
        ...     (2, {"color": "yellow", "weight": 2***REMOVED***)
        ... ])
        ...
        >>> G.nodes.data()
        NodeDataView({0: {'color': 'red', 'weight': 10***REMOVED***, 1: {'color': 'blue'***REMOVED***, 2: {'color': 'yellow', 'weight': 2***REMOVED******REMOVED***)
    ...
    def __repr__(self):
        return f"{self.__class__.__name__***REMOVED***({tuple(self)***REMOVED***)"
...
class NodeDataView(Set):
    ...
    def __getstate__(self):
        return {"_nodes": self._nodes, "_data": self._data, "_default": self._default***REMOVED***
    ...
    def __getitem__(self, n):
        if isinstance(n, slice):
            raise nx.NetworkXError(
                f"{type(self).__name__***REMOVED*** does not support slicing, "
                f"try list(G.nodes.data())[{n.start***REMOVED***:{n.stop***REMOVED***:{n.step***REMOVED***]"
***REMOVED***
        ddict = self._nodes[n]
        data = self._data
    ...
    def __repr__(self):
        ...
        if self._data is False:
            return f"{name***REMOVED***({tuple(self)***REMOVED***)"
        if self._data is True:
            return f"{name***REMOVED***({dict(self)***REMOVED***)"
        return f"{name***REMOVED***({dict(self)***REMOVED***, data={self._data!r***REMOVED***)"
...
class DiDegreeView:
    ...
    ***REMOVED***
    ...
    def __repr__(self):
        return f"{self.__class__.__name__***REMOVED***({dict(self)***REMOVED***)"
...
***REMOVED***
    ...
    def __repr__(self):
        return f"{self.__class__.__name__***REMOVED***({list(self)***REMOVED***)"
...
class OutEdgeView(Set, Mapping):
    ...
    def __getstate__(self):
        return {"_graph": self._graph, "_adjdict": self._adjdict***REMOVED***
    ...
    def __getitem__(self, e):
        if isinstance(e, slice):
            raise nx.NetworkXError(
                f"{type(self).__name__***REMOVED*** does not support slicing, "
                f"try list(G.edges)[{e.start***REMOVED***:{e.stop***REMOVED***:{e.step***REMOVED***]"
***REMOVED***
        u, v = e
    ...
    def data(self, data=True, default=None, nbunch=None):
        ...
        >>> G = nx.Graph()
        >>> G.add_edges_from([
        ...     (0, 1, {"dist": 3, "capacity": 20***REMOVED***),
        ...     (1, 2, {"dist": 4***REMOVED***),
        ...     (2, 0, {"dist": 5***REMOVED***)
        ... ])
        ...
        >>> G.edges.data()
        EdgeDataView([(0, 1, {'dist': 3, 'capacity': 20***REMOVED***), (0, 2, {'dist': 5***REMOVED***), (1, 2, {'dist': 4***REMOVED***)])
...
class EdgeView(OutEdgeView):
    ...
    (1, 2)
    (2, 3)
    >>> assert EV & {(1, 2), (3, 4)***REMOVED*** == {(1, 2)***REMOVED***

    >>> EVdata = G.edges(data="color", default="aqua")
    >>> G.add_edge(2, 3, color="blue")
    >>> assert (2, 3, "blue") in EVdata
    >>> for u, v, c in EVdata:
    ...     print(f"({u***REMOVED***, {v***REMOVED***) has color: {c***REMOVED***")
    (0, 1) has color: aqua
    (1, 2) has color: aqua
    (2, 3) has color: blue
...
class InEdgeView(OutEdgeView):
    ...
    def __getitem__(self, e):
        if isinstance(e, slice):
            raise nx.NetworkXError(
                f"{type(self).__name__***REMOVED*** does not support slicing, "
                f"try list(G.in_edges)[{e.start***REMOVED***:{e.stop***REMOVED***:{e.step***REMOVED***]"
***REMOVED***
        u, v = e
