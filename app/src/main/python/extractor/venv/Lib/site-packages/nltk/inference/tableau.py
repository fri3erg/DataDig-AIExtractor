    ...
    def _attempt_proof_n_atom(
        ...
        if context:
            ...
            return self._attempt_proof(
                ...
                atoms | {(current.term, True)***REMOVED***,
                debug + 1,
***REMOVED***
    ...
    def _attempt_proof_prop(
        ...
        agenda.mark_alls_fresh()
        return self._attempt_proof(
            agenda, accessible_vars, atoms | {(current, False)***REMOVED***, debug + 1
        )
    ...
    def _attempt_proof_n_prop(
        ...
        agenda.mark_alls_fresh()
        return self._attempt_proof(
            agenda, accessible_vars, atoms | {(current.term, True)***REMOVED***, debug + 1
        )
    ...
    def _attempt_proof_n_eq(
        ...
        return self._attempt_proof(
            agenda,
            accessible_vars | {current.term.first, current.term.second***REMOVED***,
            atoms,
            debug + 1,
        )
    ...
    def _attempt_proof_some(
        ...
        agenda.mark_alls_fresh()
        return self._attempt_proof(
            agenda, accessible_vars | {new_unique_variable***REMOVED***, atoms, debug + 1
        )
    ...
    def _attempt_proof_all(
        ...
        if accessible_vars:
            ...
            if bv_available:
                ...
                current._used_vars |= {variable_to_use***REMOVED***
                agenda.put(
    ...
    ***REMOVED***
            ...
            current._used_vars |= {new_unique_variable***REMOVED***
            agenda.put(
...
class Agenda:
    ...
    def clone(self):
        ...
        for allEx, _ in set_list[Categories.ALL]:
            ...
            try:
                new_allEx._used_vars = {used for used in allEx._used_vars***REMOVED***
            except AttributeError:
    ...
    def put(self, expression, context=None):
        if isinstance(expression, AllExpression):
            ...
            try:
                ex_to_add._used_vars = {used for used in expression._used_vars***REMOVED***
            except AttributeError:
...
class Debug:
    ...
    def line(self, data, indent=0):
        ...
        ***REMOVED***
        ...
        newline = "{***REMOVED***{***REMOVED***".format("   " * (self.indent + indent), data)
