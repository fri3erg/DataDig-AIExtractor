...
def _make_install_req_from_dist(
    ...
    if template.req:
        ...
        line = f"{dist.canonical_name***REMOVED*** @ {template.link.url***REMOVED***"
    else:
        line = f"{dist.canonical_name***REMOVED***=={dist.version***REMOVED***"
    ireq = install_req_from_line(
        line,
        user_supplied=template.user_supplied,
        comes_from=template.comes_from,
...
class _InstallRequirementBackedCandidate(Candidate):
    ...
    def __str__(self) -> str:
        return f"{self.name***REMOVED*** {self.version***REMOVED***"

    def __repr__(self) -> str:
        return f"{self.__class__.__name__***REMOVED***({str(self._link)!r***REMOVED***)"
    ...
    def format_for_error(self) -> str:
        return "{***REMOVED*** {***REMOVED*** (from {***REMOVED***)".format(
            self.name,
            self.version,
...
class LinkCandidate(_InstallRequirementBackedCandidate):
    ...
    def __init__(
        ...
        if ireq.link.is_wheel and not ireq.link.is_file:
            ...
            assert name == wheel_name, f"{name!r***REMOVED*** != {wheel_name!r***REMOVED*** for wheel"
            # Version may not be present for PEP 508 direct URLs
            if version is not None:
                wheel_version = Version(wheel.version)
                assert version == wheel_version, "{!r***REMOVED*** != {!r***REMOVED*** for wheel {***REMOVED***".format(
...
class AlreadyInstalledCandidate(Candidate):
    ...
    def __repr__(self) -> str:
        return f"{self.__class__.__name__***REMOVED***({self.dist!r***REMOVED***)"
    ...
    def format_for_error(self) -> str:
        return f"{self.name***REMOVED*** {self.version***REMOVED*** (Installed)"
...
class ExtrasCandidate(Candidate):
    ...
    def __str__(self) -> str:
        ...
        return "{***REMOVED***[{***REMOVED***] {***REMOVED***".format(name, ",".join(self.extras), rest)

    def __repr__(self) -> str:
        return f"{self.__class__.__name__***REMOVED***(base={self.base!r***REMOVED***, extras={self.extras!r***REMOVED***)"
...
class RequiresPythonCandidate(Candidate):
    ...
    def __str__(self) -> str:
        return f"Python {self._version***REMOVED***"
    ...
    def format_for_error(self) -> str:
        return f"Python {self.version***REMOVED***"
