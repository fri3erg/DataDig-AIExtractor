...
class InvalidHeadersLength(ParserError):
    ...
    def __init__(self, length):
        message = 'Header length of {***REMOVED*** exceeded the maximum of {***REMOVED***'.format(
            length,
            _MAX_HEADERS_LENGTH,
        )
        super().__init__(message)
...
class InvalidPayloadLength(ParserError):
    ...
    def __init__(self, length):
        message = 'Payload length of {***REMOVED*** exceeded the maximum of {***REMOVED***'.format(
            length,
            _MAX_PAYLOAD_LENGTH,
        )
        super().__init__(message)
...
class ChecksumMismatch(ParserError):
    ...
    def __init__(self, expected, calculated):
        message = (
            'Checksum mismatch: expected 0x{:08x***REMOVED***, calculated 0x{:08x***REMOVED***'.format(
                expected,
                calculated,
***REMOVED***
        )
    ...
    **Example:**
    ::
        ...
        response = s3.select_object_content(
            ...
            Key='keyname',
            ExpressionType='SQL',
            RequestProgress={'Enabled': True***REMOVED***,
            Expression="SELECT * FROM S3Object s",
            InputSerialization={'CSV': {***REMOVED******REMOVED***,
            OutputSerialization={'CSV': {***REMOVED******REMOVED***,
        )
