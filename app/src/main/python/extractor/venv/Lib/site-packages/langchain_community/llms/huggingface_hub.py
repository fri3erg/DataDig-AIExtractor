...
***REMOVED***
            if client.task not in VALID_TASKS:
                raise ValueError(
                    f"Got invalid task {client.task***REMOVED***, "
...
***REMOVED***
    ...
    def _identifying_params(self) -> Mapping[str, Any]:
        ...
        return {
            **{"repo_id": self.repo_id, "task": self.task***REMOVED***,
    ...
    def _call(
        ...
        **kwargs: Any,
        ...
        if "error" in response:
            raise ValueError(f"Error raised by inference API: {response['error']***REMOVED***")
        if self.client.task == "text-generation":
            ...
            raise ValueError(
                f"Got invalid task {self.client.task***REMOVED***, "
                f"currently only {VALID_TASKS***REMOVED*** are supported"
***REMOVED***
        if stop is not None:
