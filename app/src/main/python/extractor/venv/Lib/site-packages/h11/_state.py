...
# 3) The keep-alive state, with possible states {True, False***REMOVED***
# 4) The SWITCH_CONNECT state, with possible states {False, True***REMOVED***
# 5) The SWITCH_UPGRADE state, with possible states {False, True***REMOVED***
#
...
# doesn't matter how we arrived at the {client: DONE, keep-alive: False***REMOVED*** state
...
EVENT_TRIGGERED_TRANSITIONS: EventTransitionType = {
    CLIENT: {
        IDLE: {Request: SEND_BODY, ConnectionClosed: CLOSED***REMOVED***,
        SEND_BODY: {Data: SEND_BODY, EndOfMessage: DONE***REMOVED***,
        DONE: {ConnectionClosed: CLOSED***REMOVED***,
        MUST_CLOSE: {ConnectionClosed: CLOSED***REMOVED***,
        CLOSED: {ConnectionClosed: CLOSED***REMOVED***,
        MIGHT_SWITCH_PROTOCOL: {***REMOVED***,
        SWITCHED_PROTOCOL: {***REMOVED***,
        ERROR: {***REMOVED***,
    ***REMOVED***,
    SERVER: {
        IDLE: {
...
STATE_TRIGGERED_TRANSITIONS: StateTransitionType = {
    ...
    (MIGHT_SWITCH_PROTOCOL, SWITCHED_PROTOCOL): {CLIENT: SWITCHED_PROTOCOL***REMOVED***,
    # Socket shutdown
    (CLOSED, DONE): {SERVER: MUST_CLOSE***REMOVED***,
    (CLOSED, IDLE): {SERVER: MUST_CLOSE***REMOVED***,
    (ERROR, DONE): {SERVER: MUST_CLOSE***REMOVED***,
    (DONE, CLOSED): {CLIENT: MUST_CLOSE***REMOVED***,
    (IDLE, CLOSED): {CLIENT: MUST_CLOSE***REMOVED***,
    (DONE, ERROR): {CLIENT: MUST_CLOSE***REMOVED***,
***REMOVED***
...
class ConnectionState:
    def __init__(self) -> None:
        ...
        # This is a subset of {UPGRADE, CONNECT***REMOVED***, containing the proposals
        # made by the client for switching protocols.
        self.pending_switch_proposals: Set[Type[Sentinel]] = set()

        self.states: Dict[Type[Sentinel], Type[Sentinel]] = {CLIENT: IDLE, SERVER: IDLE***REMOVED***
        ...
        if server_switch_event is not None:
            ...
            if server_switch_event not in self.pending_switch_proposals:
                raise LocalProtocolError(
                    "Received server {***REMOVED*** event without a pending proposal".format(
                        server_switch_event
        ***REMOVED***
    ***REMOVED***
    ...
    def _fire_event_triggered_transitions(
        ...
        try:
            ...
            raise LocalProtocolError(
                "can't handle event type {***REMOVED*** when role={***REMOVED*** and state={***REMOVED***".format(
...
***REMOVED*** from None
    ...
    def _fire_state_triggered_transitions(self) -> None:
        ...
        while True:
            ...
            changes = STATE_TRIGGERED_TRANSITIONS.get(joint_state, {***REMOVED***)
    ...
    def start_next_cycle(self) -> None:
        if self.states != {CLIENT: DONE, SERVER: DONE***REMOVED***:
            raise LocalProtocolError(
                "not in a reusable state. self.states={***REMOVED***".format(self.states)
***REMOVED***
        # Can't reach DONE/DONE with any of these active, but still, let's be
        # sure.
        assert self.keep_alive
        assert not self.pending_switch_proposals
        self.states = {CLIENT: IDLE, SERVER: IDLE***REMOVED***
