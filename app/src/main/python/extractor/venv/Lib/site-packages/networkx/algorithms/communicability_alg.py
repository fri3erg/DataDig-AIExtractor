...
def communicability(G):
    ...
    .. math::
        C(u,v)=\sum_{j=1***REMOVED***^{n***REMOVED***\phi_{j***REMOVED***(u)\phi_{j***REMOVED***(v)e^{\lambda_{j***REMOVED******REMOVED***,

    where `\phi_{j***REMOVED***(u)` is the `u\rm{th***REMOVED***` element of the `j\rm{th***REMOVED***` orthonormal
