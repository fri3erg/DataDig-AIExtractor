...
class NpzFile(Mapping):
    ...
    def __getitem__(self, key):
        ...
        if member:
            ...
            raise KeyError(f"{key***REMOVED*** is not a file in the archive")
    ...
    def __repr__(self):
        ...
        if len(self.files) > self._MAX_REPR_ARRAY_COUNT:
            array_names += "..."
        return f"NpzFile {filename!r***REMOVED*** with keys: {array_names***REMOVED***"
        ...
        if magic.startswith(_ZIP_PREFIX) or magic.startswith(_ZIP_SUFFIX):
            ...
            try:
                ...
                raise pickle.UnpicklingError(
                    f"Failed to interpret file {file!r***REMOVED*** as a pickle") from e
...
def _ensure_ndmin_ndarray_check_param(ndmin):
    ...
    if ndmin not in [0, 1, 2]:
        raise ValueError(f"Illegal value of ndmin keyword: {ndmin***REMOVED***")
...
def _check_nonneg_int(value, name="argument"):
    try:
        ...
        raise TypeError(f"{name***REMOVED*** must be an integer") from None
    if value < 0:
        raise ValueError(f"{name***REMOVED*** must be nonnegative")
...
def _read(fname, *, delimiter=',', comment='#', quote='"',
    ...
    converters : dict or callable, optional
        ...
        E.g. if column 0 is a date string: ``converters = {0: datestr2num***REMOVED***``.
...
***REMOVED***
        ...
        if len(comments) == 0:
            ...
            if delimiter in comments:
                raise TypeError(
                    f"Comment characters '{comments***REMOVED***' cannot include the "
                    f"delimiter '{delimiter***REMOVED***'"
    ***REMOVED***
    ...
    try:
        ...
        raise ValueError(
            ...
            f"or generator. Got {type(fname)***REMOVED*** instead.") from e
    ...
    if arr.shape:
        if arr.shape[0] == 0:
            warnings.warn(
                f'loadtxt: input contained no data: "{fname***REMOVED***"',
...
def savetxt(fname, X, fmt='%.18e', delimiter=' ', newline='\n', header='',
    ...
    comments : str, optional
        ...
        .. versionadded:: 1.7.0
    encoding : {None, str***REMOVED***, optional
...
def genfromtxt(fname, dtype=float, comments='#', delimiter=None,
    ...
    converters : variable, optional
        ...
        for missing data: ``converters = {3: lambda s: float(s or 0)***REMOVED***``.
    ...
    * Individual values are not stripped of spaces by default.
    ...
    try:
        ...
        raise TypeError(
            ...
            f"or an iterator of strings. Got {type(fname)***REMOVED*** instead."
        ) from e
    with fid_ctx:
