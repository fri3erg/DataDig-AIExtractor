...
def generate_regular_range(
    ...
    try:
        ...
        raise ValueError(
            f"freq={freq***REMOVED*** is incompatible with unit={unit***REMOVED***. "
...
def _generate_range_overflow_safe(
    ...
    msg = f"Cannot generate range with {side***REMOVED***={endpoint***REMOVED*** and periods={periods***REMOVED***"
...
def _generate_range_overflow_safe_signed(
    ...
    raise OutOfBoundsDatetime(
        f"Cannot generate range with {side***REMOVED***={endpoint***REMOVED*** and periods={periods***REMOVED***"
    )
