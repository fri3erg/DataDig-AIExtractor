...
class BaseGroupbyTests:
    ...
    ***REMOVED***,
    ...
    def test_groupby_extension_agg(self, as_index, data_for_grouping):
        df = pd.DataFrame({"A": [1, 1, 2, 2, 3, 3, 1, 4], "B": data_for_grouping***REMOVED***)
        ...
        if as_index:
            ...
            expected = pd.DataFrame({"B": uniques, "A": exp_vals***REMOVED***)
    ...
    def test_groupby_agg_extension(self, data_for_grouping):
        ...
        result = df.groupby("A").agg({"B": "first"***REMOVED***)
        tm.assert_frame_equal(result, expected)
    ...
    def test_groupby_extension_transform(self, data_for_grouping):
        ...
        df = pd.DataFrame({"A": [1, 1, 3, 3, 1, 4], "B": valid***REMOVED***)
        is_bool = data_for_grouping.dtype._is_boolean
        if is_bool:
            # only 2 unique values, and the final entry has c==b
            #  (see data_for_grouping docstring)
        ...
        if (
            ...
            msg = "|".join(
                [
                    ...
                    # all others
                    re.escape(f"agg function failed [how->sum,dtype->{dtype***REMOVED***"),
                ]
***REMOVED***
