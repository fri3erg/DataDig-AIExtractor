...
class DirNamesMixin:
    ...
    def _dir_additions(self) -> set[str]:
        ...
        """
        return {accessor for accessor in self._accessors if hasattr(self, accessor)***REMOVED***
...
class PandasDelegate:
    ...
    def _delegate_property_get(self, name: str, *args, **kwargs):
        raise TypeError(f"You cannot access the property {name***REMOVED***")

    def _delegate_property_set(self, name: str, value, *args, **kwargs):
        raise TypeError(f"The property {name***REMOVED*** cannot be set")

    def _delegate_method(self, name: str, *args, **kwargs):
        raise TypeError(f"You cannot call method {name***REMOVED***")
...
def _register_accessor(name: str, cls):
    """
    Register a custom accessor on {klass***REMOVED*** objects.
    ...
    Back in an interactive IPython session:
        ...
        .. code-block:: ipython
            ...
            In [1]: ds = pd.DataFrame({{"longitude": np.linspace(0, 10),
               ...:                    "latitude": np.linspace(0, 20)***REMOVED******REMOVED***)
            In [2]: ds.geo.center
            Out[2]: (5.0, 10.0)
    ...
    def decorator(accessor):
        if hasattr(cls, name):
            warnings.warn(
                f"registration of accessor {repr(accessor)***REMOVED*** under name "
                f"{repr(name)***REMOVED*** for type {repr(cls)***REMOVED*** is overriding a preexisting "
