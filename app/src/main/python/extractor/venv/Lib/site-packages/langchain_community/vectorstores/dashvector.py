...
***REMOVED***
        ...
        if not isinstance(collection, dashvector.Collection):
            raise ValueError(
                ...
                f"bug got {type(collection)***REMOVED***"
***REMOVED***
    ...
    def _similarity_search_with_score_by_vector(
        ...
        if not ret:
            raise ValueError(
                f"Fail to query docs by vector, error {self._collection.message***REMOVED***"
***REMOVED***
        ...
        **kwargs: Any,
        ...
        for i in range(0, len(text_list), batch_size):
            ...
            if metadatas:
                ...
                batch_metadatas = [{***REMOVED*** for _ in range(i, end)]
        ...
        **kwargs: Any,
        ...
        Example:
            ...
            dashvector = DashVector.from_documents(
                docs,
                embeddings,
                dashvector_api_key="{DASHVECTOR_API_KEY***REMOVED***"
***REMOVED***
        """
        try:
            import dashvector
...
***REMOVED***
        ...
        if not collection:
            ...
            if resp:
                ...
                raise ValueError(
                    "Fail to create collection. " f"Error: {resp.message***REMOVED***."
    ***REMOVED***
