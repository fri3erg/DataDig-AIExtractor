...
***REMOVED***
    ...
    def is_arxiv_identifier(self, query: str) -> bool:
        ...
        arxiv_identifier_pattern = r"\d{2***REMOVED***(0[1-9]|1[0-2])\.\d{4,5***REMOVED***(v\d+|)|\d{7***REMOVED***.*"
...
***REMOVED***
    ...
    ***REMOVED***.results()
            ...
            return [Document(page_content=f"Arxiv exception: {ex***REMOVED***")]
        docs = [
            Document(
...
***REMOVED***
    ...
    ***REMOVED***.results()
            ...
            return f"Arxiv exception: {ex***REMOVED***"
        docs = [
            f"Published: {result.updated.date()***REMOVED***\n"
            f"Title: {result.title***REMOVED***\n"
            f"Authors: {', '.join(a.name for a in result.authors)***REMOVED***\n"
            f"Summary: {result.summary***REMOVED***"
            for result in results
        ]
        if docs:
