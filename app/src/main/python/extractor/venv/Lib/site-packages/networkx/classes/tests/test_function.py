...
class TestFunction:
    def setup_method(self):
        self.G = nx.Graph({0: [1, 2, 3], 1: [1, 2, 0], 4: []***REMOVED***, name="Test")
        self.Gdegree = {0: 3, 1: 2, 2: 2, 3: 1, 4: 0***REMOVED***
        self.Gnodes = list(range(5))
        self.Gedges = [(0, 1), (0, 2), (0, 3), (1, 0), (1, 1), (1, 2)]
        self.DG = nx.DiGraph({0: [1, 2, 3], 1: [1, 2, 0], 4: []***REMOVED***)
        self.DGin_degree = {0: 1, 1: 2, 2: 2, 3: 1, 4: 0***REMOVED***
        self.DGout_degree = {0: 3, 1: 3, 2: 0, 3: 0, 4: 0***REMOVED***
    ...
    def test_add_star(self):
        ...
        assert edges_equal(
            ...
            [
                (12, 13, {"weight": 2.0***REMOVED***),
                (12, 14, {"weight": 2.0***REMOVED***),
                (12, 15, {"weight": 2.0***REMOVED***),
            ],
        )
    ...
    def test_add_path(self):
        ...
        assert edges_equal(
            ...
            [
                (12, 13, {"weight": 2.0***REMOVED***),
                (13, 14, {"weight": 2.0***REMOVED***),
                (14, 15, {"weight": 2.0***REMOVED***),
            ],
        )
    ...
    def test_add_cycle(self):
        ...
        oklists = [
            [
                (12, 13, {"weight": 1.0***REMOVED***),
                (12, 15, {"weight": 1.0***REMOVED***),
                (13, 14, {"weight": 1.0***REMOVED***),
                (14, 15, {"weight": 1.0***REMOVED***),
            ],
            [
                (12, 13, {"weight": 1.0***REMOVED***),
                (13, 14, {"weight": 1.0***REMOVED***),
                (14, 15, {"weight": 1.0***REMOVED***),
                (15, 12, {"weight": 1.0***REMOVED***),
            ],
        ]
    ...
    def test_create_empty_copy(self):
        ...
        assert G._node == {***REMOVED***.fromkeys(self.G.nodes(), {***REMOVED***)
        assert G._adj == {***REMOVED***.fromkeys(self.G.nodes(), {***REMOVED***)
...
@pytest.mark.parametrize(
    ("values", "name"),
    (
        ({0: "red", 1: "blue"***REMOVED***, "color"),  # values dictionary
        ({0: {"color": "red"***REMOVED***, 1: {"color": "blue"***REMOVED******REMOVED***, None),  # dict-of-dict
    ),
)
...
def test_set_edge_attributes(graph_type):
    ...
    assert G[1][2] == {***REMOVED***


@pytest.mark.parametrize(
    ("values", "name"),
    (
        ({(0, 1): 1.0, (0, 2): 2.0***REMOVED***, "weight"),  # values dict
        ({(0, 1): {"weight": 1.0***REMOVED***, (0, 2): {"weight": 2.0***REMOVED******REMOVED***, None),  # values dod
    ),
)
...
def test_set_edge_attributes_multi(graph_type):
    ...
    assert G[1][2][0] == {***REMOVED***


@pytest.mark.parametrize(
    ("values", "name"),
    (
        ({(0, 1, 0): 1.0, (0, 2, 0): 2.0***REMOVED***, "weight"),  # values dict
        ({(0, 1, 0): {"weight": 1.0***REMOVED***, (0, 2, 0): {"weight": 2.0***REMOVED******REMOVED***, None),  # values dod
    ),
)
...
def test_selfloops(graph_type):
    ...
    assert edges_equal(nx.selfloop_edges(G, data=True), [(0, 0, {***REMOVED***)])
...
def test_pathweight():
    ...
    graphs = [nx.Graph(), nx.DiGraph(), nx.MultiGraph(), nx.MultiDiGraph()]
    edges = [
        (1, 2, {"cost": 5, "dist": 6***REMOVED***),
        (2, 3, {"cost": 3, "dist": 4***REMOVED***),
        (1, 2, {"cost": 1, "dist": 2***REMOVED***),
    ]
    for graph in graphs:
...
def test_restricted_view(G):
    ...
    assert set(H.nodes()) == {1, 3, 4***REMOVED***
    assert set(H.edges()) == {(1, 1)***REMOVED***
