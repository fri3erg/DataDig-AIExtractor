...
def convert_pandas_type_to_json_field(arr) -> dict[str, JSONSerializable]:
    ...
    ***REMOVED***
    ...
    if isinstance(dtype, CategoricalDtype):
        ...
        field["constraints"] = {"enum": list(cats)***REMOVED***
...
def convert_json_field_to_pandas_type(field) -> str | CategoricalDtype:
    ...
    Examples
    --------
    >>> convert_json_field_to_pandas_type({"name": "an_int", "type": "integer"***REMOVED***)
    'int64'
    ...
    >>> convert_json_field_to_pandas_type({"name": "a_datetime", "type": "datetime"***REMOVED***)
    'datetime64[ns]'

    >>> convert_json_field_to_pandas_type(
    ...     {"name": "a_datetime_with_tz", "type": "datetime", "tz": "US/Central"***REMOVED***
    ... )
    ...
    if typ == "string":
        ...
        if field.get("tz"):
            return f"datetime64[ns, {field['tz']***REMOVED***]"
        elif field.get("freq"):
...
***REMOVED***
    ...
    raise ValueError(f"Unsupported or invalid field type: {typ***REMOVED***")
...
def build_table_schema(
    ...
    ...     ***REMOVED***, index=pd.Index(range(3), name='idx'))
