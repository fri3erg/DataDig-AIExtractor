...
class _TypedProperty(Strict):
    ...
    def __repr__(self):
        return f"{self.__class__.__name__***REMOVED***, name={self.name***REMOVED***, value={self.value***REMOVED***"
...
XML_MAPPING = {v:k for k,v in CLASS_MAPPING.items()***REMOVED***
...
class CustomPropertyList(Strict):
    ...
    def from_tree(cls, tree):
        ...
        for prop in prop_list.property:
            ...
            if not typ:
                warn(f"Unknown type for {prop.name***REMOVED***")
                continue
    ...
    def append(self, prop):
        if prop.name in self.names:
            raise ValueError(f"Property with name {prop.name***REMOVED*** already exists")
        props = self.props
        props.append(prop)
        self.props = props
    ...
    def to_tree(self):
        ...
        for p in self.props:
            ...
            if not attr:
                raise TypeError("Unknown adapter for {p***REMOVED***")
            np = _CustomDocumentProperty(name=p.name, **{attr:p.value***REMOVED***)
    ...
    def __getitem__(self, name):
        ...
        for p in self.props:
            if p.name == name:
                return p
        raise KeyError(f"Property with name {name***REMOVED*** not found")
    ...
    def __repr__(self):
        return f"{self.__class__.__name__***REMOVED*** containing {self.props***REMOVED***"
