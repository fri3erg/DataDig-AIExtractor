...
***REMOVED***
        ...
        options = {***REMOVED*** if options is None else options
        self._options_cmd = ",".join(
            f"{key***REMOVED***={json.dumps(val)***REMOVED***" for key, val in options.items()
        )
    ...
    def default_config(self, lang):
        ...
        if os.environ.get("STANFORD_SEGMENTER"):
            search_path = {os.path.join(os.environ.get("STANFORD_SEGMENTER"), "data")***REMOVED***
...
***REMOVED***
    ...
    ***REMOVED*** from e
            ...
            raise LookupError(f"Unsupported language {lang***REMOVED***")
