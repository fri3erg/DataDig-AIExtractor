...
class TestRangeIndex:
    ...
    def test_cache(self):
        ...
        df = pd.DataFrame({"a": range(10)***REMOVED***, index=idx)
    ...
    def test_cant_or_shouldnt_cast(self, start, stop, step):
        msg = f"Wrong type {type(start)***REMOVED*** for value {start***REMOVED***"
    ...
    @pytest.mark.parametrize("step", set(range(-5, 6)) - {0***REMOVED***)
...
***REMOVED***,
    ...
    def test_sort_values_key(self):
        # GH#43666, GH#52764
        sort_order = {8: 2, 6: 0, 4: 8, 2: 10, 0: 12***REMOVED***
