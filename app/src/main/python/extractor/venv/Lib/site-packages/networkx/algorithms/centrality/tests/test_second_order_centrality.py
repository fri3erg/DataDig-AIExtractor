...
def test_weight_attribute():
    ...
    expected = {0: 3.431, 1: 3.082, 2: 5.612***REMOVED***
...
def test_P3():
    ...
    G = nx.path_graph(3)
    b_answer = {0: 3.741, 1: 1.414, 2: 3.741***REMOVED***
...
def test_K3():
    ...
    b_answer = {0: 1.414, 1: 1.414, 2: 1.414***REMOVED***
...
def test_ring_graph():
    ...
    G = nx.cycle_graph(5)
    b_answer = {0: 4.472, 1: 4.472, 2: 4.472, 3: 4.472, 4: 4.472***REMOVED***
