...
class ContextCallbackHandler(BaseCallbackHandler):
    ...
    Chain Example:
        ...
        ...         template="What is a good name for a company that makes {product***REMOVED***?",
    ...
    def __init__(self, token: str = "", verbose: bool = False, **kwargs: Any) -> None:
        ...
        self.metadata: Dict[str, str] = {***REMOVED***
    ...
    def on_chat_model_start(
        ...
        **kwargs: Any,
        ...
        llm_model = kwargs.get("invocation_params", {***REMOVED***).get("model", None)
