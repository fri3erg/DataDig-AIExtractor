...
***REMOVED***
        ...
        for url in self._get_urls:
            try:
                ...
                if getattr(feed, "bozo", False):
                    raise ValueError(
                        f"Error fetching {url***REMOVED***, exception: {feed.bozo_exception***REMOVED***"
        ***REMOVED***
            except Exception as e:
                if self.continue_on_failure:
                    logger.error(f"Error fetching {url***REMOVED***, exception: {e***REMOVED***")
                    continue
                else:
                    raise e
            try:
        ...
        ***REMOVED***
                ...
                if self.continue_on_failure:
                    logger.error(f"Error processing entry {entry.link***REMOVED***, exception: {e***REMOVED***")
                    continue
                else:
                    raise e
