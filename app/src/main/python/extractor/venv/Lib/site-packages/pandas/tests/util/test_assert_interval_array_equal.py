...
@pytest.mark.parametrize(
    "kwargs",
    [
        {"start": 0, "periods": 4***REMOVED***,
        {"start": 1, "periods": 5***REMOVED***,
        {"start": 5, "end": 10, "closed": "left"***REMOVED***,
    ],
)
...
def test_interval_array_equal_closed_mismatch():
    kwargs = {"start": 0, "periods": 5***REMOVED***
