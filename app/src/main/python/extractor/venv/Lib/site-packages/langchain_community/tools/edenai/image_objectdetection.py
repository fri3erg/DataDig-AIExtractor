...
class EdenAiObjectDetectionTool(EdenaiTool):
    ...
    def _parse_json(self, json_data: dict) -> str:
        ...
        for found_obj in json_data["items"]:
            label_str = f"{found_obj['label']***REMOVED*** - Confidence {found_obj['confidence']***REMOVED***"
...
***REMOVED***:  # some providers don't return positions
                label_str += f""",at the position x_min: {x_min***REMOVED***, x_max: {x_max***REMOVED***, 
                y_min: {y_min***REMOVED***, y_max: {y_max***REMOVED***"""
    ...
    def _run(
        ...
        """Use the tool."""
        query_params = {"file_url": query, "attributes_as_list": False***REMOVED***
