...
class TestTimestampTZLocalize:
    ...
    def test_tz_localize_pushes_out_of_bounds(self):
        ...
        msg = (
            f"Converting {Timestamp.min.strftime('%Y-%m-%d %H:%M:%S')***REMOVED*** "
            f"underflows past {Timestamp.min***REMOVED***"
        )
        ...
        # tz_localize that pushes away from the boundary is OK
        msg = (
            f"Converting {Timestamp.max.strftime('%Y-%m-%d %H:%M:%S')***REMOVED*** "
            f"overflows past {Timestamp.max***REMOVED***"
        )
