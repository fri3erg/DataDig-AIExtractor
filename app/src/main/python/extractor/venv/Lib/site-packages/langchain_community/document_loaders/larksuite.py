...
class LarkSuiteDocLoader(BaseLoader):
    ...
    def lazy_load(self) -> Iterator[Document]:
        ...
        api_url_prefix = f"{self.domain***REMOVED***/open-apis/docx/v1/documents"
        metadata_json = self._get_larksuite_api_json_data(
            f"{api_url_prefix***REMOVED***/{self.document_id***REMOVED***"
        )
        raw_content_json = self._get_larksuite_api_json_data(
            f"{api_url_prefix***REMOVED***/{self.document_id***REMOVED***/raw_content"
        )
