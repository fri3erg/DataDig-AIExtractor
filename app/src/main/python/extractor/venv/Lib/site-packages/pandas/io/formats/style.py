...
def _mpl(func: Callable) -> Generator[tuple[Any, Any], None, None]:
    if has_mpl:
        ...
        raise ImportError(f"{func.__name__***REMOVED*** requires matplotlib.")
...
coloring_args = """color : str, default '{default***REMOVED***'
...
class Styler(StylerRenderer):
    ...
    table_styles : list-like, default None
        List of {selector: (attr, value)***REMOVED*** dicts; see Notes.
    ...
    escape : str, optional
        ...
        ``{``, ``***REMOVED***``, ``~``, ``^``, and ``\`` in the cell display string with
    ...
    *{"row": "MY_ROW_CLASS", "col_trim": "", "row_trim": ""***REMOVED****.
    ...
    def concat(self, other: Styler) -> Styler:
        ...
        The following should be noted:
          ...
          - ``css`` will be inherited from the original Styler, and the value of
            ...
            ``foot{parent***REMOVED***_foot{child***REMOVED***_``.
        ...
        ...                                 "props": "border-top: 1px solid black;"***REMOVED***]))
    ...
    def to_latex(
        ...
        *,
        ...
        column_format : str, optional
            ...
            \\begin{tabular***REMOVED***{<column_format>***REMOVED***
        ...
        position : str, optional
            ...
            ``\\begin{table***REMOVED***[<position>]``.
        position_float : {"centering", "raggedleft", "raggedright"***REMOVED***, optional
        ...
        hrules : bool
            ...
            {booktabs***REMOVED*** LaTeX package.
        ...
        clines : str, optional
            ...
            .. versionadded:: 1.4.0
        label : str, optional
            The LaTeX label included as: \\label{<label>***REMOVED***.
            This is used with \\ref{<label>***REMOVED*** in the main .tex file.
        caption : str, tuple, optional
            If string, the LaTeX table caption included as: \\caption{<caption>***REMOVED***.
            If tuple, i.e ("full caption", "short caption"), the caption included
            as: \\caption[<caption[1]>]{<caption[0]>***REMOVED***.
        ...
        sparse_columns : bool, optional
            ...
            is `True`.
        multirow_align : {"c", "t", "b", "naive"***REMOVED***, optional
            ...
            .. versionchanged:: 1.4.0
        multicol_align : {"r", "c", "l", "naive-l", "naive-r"***REMOVED***, optional
        ...
        siunitx : bool, default False
            Set to ``True`` to structure LaTeX compatible with the {siunitx***REMOVED*** package.
        environment : str, optional
            If given, the environment that will replace 'table' in ``\\begin{table***REMOVED***``.
        ...
        **Latex Packages**
        ...
        Feature               Inclusion
        ===================== ==========================================================
        sparse columns        none: included within default {tabular***REMOVED*** environment
        sparse rows           \\usepackage{multirow***REMOVED***
        hrules                \\usepackage{booktabs***REMOVED***
        colors                \\usepackage[table]{xcolor***REMOVED***
        siunitx               \\usepackage{siunitx***REMOVED***
        bold (with siunitx)   | \\usepackage{etoolbox***REMOVED***
                              | \\robustify\\bfseries
                              | \\sisetup{detect-all = true***REMOVED***  *(within {document***REMOVED***)*
        italic (with siunitx) | \\usepackage{etoolbox***REMOVED***
                              | \\robustify\\itshape
                              | \\sisetup{detect-all = true***REMOVED***  *(within {document***REMOVED***)*
        environment           \\usepackage{longtable***REMOVED*** if arg is "longtable"
                              | or any other relevant environment package
        hyperlinks            \\usepackage{hyperref***REMOVED***
        ===================== ==========================================================
        ...
        **Cell Styles**
        ...
        >>> s = df.style.highlight_max(axis=None,
        ...                            props='cellcolor:{red***REMOVED***; bfseries: ;')
        ...
        ``\cellcolor{red***REMOVED*** \bfseries 4``.
        ...
        (<command>,<options> ``--rwrap``)   \\<command><options>{<display_value>***REMOVED***
        (<command>,<options> ``--wrap``)    {\\<command><options> <display_value>***REMOVED***
        (<command>,<options> ``--lwrap``)   {\\<command><options>***REMOVED*** <display_value>
        (<command>,<options> ``--dwrap``)   {\\<command><options>***REMOVED***{<display_value>***REMOVED***
        =================================== ============================================

        For example the `textbf` command for font-weight
        should always be used with `--rwrap` so ``('textbf', '--rwrap')`` will render a
        working cell, wrapped with braces, as ``\textbf{<display_value>***REMOVED***``.
        ...
        ...     props='cellcolor:[HTML]{FFFF00***REMOVED***; color:{red***REMOVED***;'
        ...
        **Table Styles**
        ...
        .. code-block:: python
            ...
            set_table_styles([
                {"selector": "column_format", "props": f":{column_format***REMOVED***;"***REMOVED***,
                {"selector": "position", "props": f":{position***REMOVED***;"***REMOVED***,
                {"selector": "position_float", "props": f":{position_float***REMOVED***;"***REMOVED***,
                {"selector": "label", "props": f":{{{label.replace(':','§')***REMOVED******REMOVED******REMOVED***;"***REMOVED***
            ], overwrite=False)
        ...
        .. code-block:: python
            ...
            set_table_styles([
                {'selector': 'toprule', 'props': ':toprule;'***REMOVED***,
                {'selector': 'bottomrule', 'props': ':hline;'***REMOVED***,
            ], overwrite=False)

        If other ``commands`` are added to table styles they will be detected, and
        positioned immediately above the '\\begin{tabular***REMOVED***' command. For example to
        add odd and even row coloring, from the {colortbl***REMOVED*** package, in format
        ``\rowcolors{1***REMOVED***{pink***REMOVED***{red***REMOVED***``, use:

        .. code-block:: python

            set_table_styles([
                {'selector': 'rowcolors', 'props': ':{1***REMOVED***{pink***REMOVED***{red***REMOVED***;'***REMOVED***
            ], overwrite=False)
        ...
        ... ])
        >>> s = df.style.highlight_max(
        ...     props='cellcolor:[HTML]{FFFF00***REMOVED***; color:{red***REMOVED***; itshape:; bfseries:;'
        ... )
        >>> s.to_latex(
        ...
        **Formatting**
        ...
        >>> s.caption = None
        >>> s.format({
        ...    ("Numeric", "Integers"): '\${***REMOVED***',
        ...    ("Numeric", "Floats"): '{:.3f***REMOVED***',
        ...
        >>> s.to_latex()  # doctest: +SKIP
        \begin{tabular***REMOVED***{llrrl***REMOVED***
        {***REMOVED*** & {***REMOVED*** & \multicolumn{2***REMOVED***{r***REMOVED***{Numeric***REMOVED*** & {Non-Numeric***REMOVED*** \\
        {***REMOVED*** & {***REMOVED*** & {Integers***REMOVED*** & {Floats***REMOVED*** & {Strings***REMOVED*** \\
        \multirow[c]{2***REMOVED***{****REMOVED***{L0***REMOVED*** & ix1 & \\$1 & 2.200 & DOGS \\
         & ix2 & \$3 & 4.400 & CATS \\
        L1 & ix3 & \$2 & 6.600 & COWS \\
        \end{tabular***REMOVED***
        ...
        **CSS Conversion**
        ...
        font-style         | italic             | itshape
                           | oblique            | slshape
        background-color   | red                cellcolor     | {red***REMOVED***--lwrap
                           | #fe01ea                          | [HTML]{FE01EA***REMOVED***--lwrap
                           | #f0e                             | [HTML]{FF00EE***REMOVED***--lwrap
                           | rgb(128,255,0)                   | [rgb]{0.5,1,0***REMOVED***--lwrap
                           | rgba(128,0,0,0.5)                | [rgb]{0.5,0,0***REMOVED***--lwrap
                           | rgb(25%,255,50%)                 | [rgb]{0.25,1,0.5***REMOVED***--lwrap
        color              | red                color         | {red***REMOVED***
                           | #fe01ea                          | [HTML]{FE01EA***REMOVED***
                           | #f0e                             | [HTML]{FF00EE***REMOVED***
                           | rgb(128,255,0)                   | [rgb]{0.5,1,0***REMOVED***
                           | rgba(128,0,0,0.5)                | [rgb]{0.5,0,0***REMOVED***
                           | rgb(25%,255,50%)                 | [rgb]{0.25,1,0.5***REMOVED***
        ================== ==================== ============= ==========================
        ...
        ...     **{"font-weight": "bold /* --dwrap */", "Huge": "--latex--rwrap"***REMOVED***
        ... ).to_latex(convert_css=True)  # doctest: +SKIP
        \begin{tabular***REMOVED***{lr***REMOVED***
        {***REMOVED*** & {0***REMOVED*** \\
        0 & {\bfseries***REMOVED***{\Huge{1***REMOVED******REMOVED*** \\
        \end{tabular***REMOVED***
        ...
        ...     else: color = "#ffdd33"
        ...     return f"color: {color***REMOVED***; font-weight: bold;"
        ...
        (from the {graphicx***REMOVED*** package), that is not easy to convert from CSS and
        ...
        >>> styler.map_index(
        ...     lambda v: "rotatebox:{45***REMOVED***--rwrap--latex;", level=2, axis=1
        ... )  # doctest: +SKIP
        ...
        \begin{table***REMOVED***
        \centering
        \caption{Selected stock correlation and simple statistics.***REMOVED***
        \begin{tabular***REMOVED***{llrrrrrrrrl***REMOVED***
        \toprule
         &  & \multicolumn{4***REMOVED***{|c|***REMOVED***{Equity***REMOVED*** & \multicolumn{4***REMOVED***{|c|***REMOVED***{Stats***REMOVED*** & Rating \\
         &  & \multicolumn{2***REMOVED***{|c|***REMOVED***{Energy***REMOVED*** & \multicolumn{2***REMOVED***{|c|***REMOVED***{Consumer***REMOVED*** &
        \multicolumn{4***REMOVED***{|c|***REMOVED***{***REMOVED*** &  \\
         &  & \rotatebox{45***REMOVED***{BP***REMOVED*** & \rotatebox{45***REMOVED***{Shell***REMOVED*** & \rotatebox{45***REMOVED***{H\&M***REMOVED*** &
        \rotatebox{45***REMOVED***{Unilever***REMOVED*** & \rotatebox{45***REMOVED***{Std Dev***REMOVED*** & \rotatebox{45***REMOVED***{Variance***REMOVED*** &
        \rotatebox{45***REMOVED***{52w High***REMOVED*** & \rotatebox{45***REMOVED***{52w Low***REMOVED*** & \rotatebox{45***REMOVED***{***REMOVED*** \\
        \midrule
        \multirow[c]{2***REMOVED***{****REMOVED***{Energy***REMOVED*** & BP & {\cellcolor[HTML]{FCFFA4***REMOVED******REMOVED***
        \color[HTML]{000000***REMOVED*** 1.00 & {\cellcolor[HTML]{FCA50A***REMOVED******REMOVED*** \color[HTML]{000000***REMOVED***
        0.80 & {\cellcolor[HTML]{EB6628***REMOVED******REMOVED*** \color[HTML]{F1F1F1***REMOVED*** 0.66 &
        {\cellcolor[HTML]{F68013***REMOVED******REMOVED*** \color[HTML]{F1F1F1***REMOVED*** 0.72 & 32.2 & 1,034.8 & 335.1
        & 240.9 & \color[HTML]{33FF85***REMOVED*** \bfseries BUY \\
         & Shell & {\cellcolor[HTML]{FCA50A***REMOVED******REMOVED*** \color[HTML]{000000***REMOVED*** 0.80 &
        {\cellcolor[HTML]{FCFFA4***REMOVED******REMOVED*** \color[HTML]{000000***REMOVED*** 1.00 &
        {\cellcolor[HTML]{F1731D***REMOVED******REMOVED*** \color[HTML]{F1F1F1***REMOVED*** 0.69 &
        {\cellcolor[HTML]{FCA108***REMOVED******REMOVED*** \color[HTML]{000000***REMOVED*** 0.79 & 1.9 & 3.5 & 14.1 &
        19.8 & \color[HTML]{FFDD33***REMOVED*** \bfseries HOLD \\
        \cline{1-11***REMOVED***
        \multirow[c]{2***REMOVED***{****REMOVED***{Consumer***REMOVED*** & H\&M & {\cellcolor[HTML]{EB6628***REMOVED******REMOVED***
        \color[HTML]{F1F1F1***REMOVED*** 0.66 & {\cellcolor[HTML]{F1731D***REMOVED******REMOVED*** \color[HTML]{F1F1F1***REMOVED***
        0.69 & {\cellcolor[HTML]{FCFFA4***REMOVED******REMOVED*** \color[HTML]{000000***REMOVED*** 1.00 &
        {\cellcolor[HTML]{FAC42A***REMOVED******REMOVED*** \color[HTML]{000000***REMOVED*** 0.86 & 7.0 & 49.0 & 210.9 &
        140.6 & \color[HTML]{33FF85***REMOVED*** \bfseries BUY \\
         & Unilever & {\cellcolor[HTML]{F68013***REMOVED******REMOVED*** \color[HTML]{F1F1F1***REMOVED*** 0.72 &
        {\cellcolor[HTML]{FCA108***REMOVED******REMOVED*** \color[HTML]{000000***REMOVED*** 0.79 &
        {\cellcolor[HTML]{FAC42A***REMOVED******REMOVED*** \color[HTML]{000000***REMOVED*** 0.86 &
        {\cellcolor[HTML]{FCFFA4***REMOVED******REMOVED*** \color[HTML]{000000***REMOVED*** 1.00 & 213.8 & 45,693.3 &
        2,807.0 & 3,678.0 & \color[HTML]{FF5933***REMOVED*** \bfseries SELL \\
        \cline{1-11***REMOVED***
        \bottomrule
        \end{tabular***REMOVED***
        \end{table***REMOVED***
...
***REMOVED***
        ...
        if hrules:
            obj.set_table_styles(
                [
                    {"selector": "toprule", "props": ":toprule"***REMOVED***,
                    {"selector": "midrule", "props": ":midrule"***REMOVED***,
                    {"selector": "bottomrule", "props": ":bottomrule"***REMOVED***,
                ],
                overwrite=False,
***REMOVED***
...
***REMOVED***
    ...
    def to_html(
        ...
        **kwargs
        ...
        if bold_headers:
            obj.set_table_styles(
                [{"selector": "th", "props": "font-weight: bold;"***REMOVED***], overwrite=False
***REMOVED***
...
***REMOVED***
    ...
    def _update_ctx(self, attrs: DataFrame) -> None:
        ...
        Collects a mapping of {index_label: [('<property>', '<value>'), ..]***REMOVED***.
...
***REMOVED***
    ...
    def clear(self) -> None:
        ...
        Examples
        --------
        >>> df = pd.DataFrame({'A': [1, 2], 'B': [3, np.nan]***REMOVED***)
        ...
        if data.empty:
            ...
            if not isinstance(result, DataFrame):
                if not isinstance(result, np.ndarray):
                    raise TypeError(
                        f"Function {repr(func)***REMOVED*** must return a DataFrame or ndarray "
                        f"when passed to `Styler.apply` with axis=None"
        ***REMOVED***
                if data.shape != result.shape:
                    raise ValueError(
                        f"Function {repr(func)***REMOVED*** returned ndarray with wrong shape.\n"
                        f"Result has shape: {result.shape***REMOVED***\n"
                        f"Expected shape: {data.shape***REMOVED***"
        ***REMOVED***
        ...
        if isinstance(result, Series):
            raise ValueError(
                f"Function {repr(func)***REMOVED*** resulted in the apply method collapsing to a "
                f"Series.\nUsually, this is the result of the function returning a "
                f"single value, instead of list-like."
***REMOVED***
        msg = (
            f"Function {repr(func)***REMOVED*** created invalid {{0***REMOVED******REMOVED*** labels.\nUsually, this is "
            f"the result of the function returning a "
            f"{'Series' if axis is not None else 'DataFrame'***REMOVED*** which contains invalid "
            ...
            f"the wrong axis.\n"
            f"Result {{0***REMOVED******REMOVED*** has shape: {{1***REMOVED******REMOVED***\n"
            f"Expected {{0***REMOVED******REMOVED*** shape:   {{2***REMOVED******REMOVED***"
        )
...
***REMOVED***
    ...
    def apply(
        ...
        **kwargs : dict
        ...
        ...     return np.where(x == np.nanmax(x.to_numpy()), f"color: {color***REMOVED***;", None)
    ...
    def apply_index(
        ...
        **kwargs,
        ...
        """
        Apply a CSS-styling function to the index or column headers, {wise***REMOVED***.
        ...
        ----------
        func : function
            ``func`` should {func***REMOVED***.
        axis : {{0, 1, "index", "columns"***REMOVED******REMOVED***
        ...
        **kwargs : dict
        ...
        See Also
        --------
        Styler.{alt***REMOVED***_index: Apply a CSS-styling function to headers {altwise***REMOVED***.
        Styler.apply: Apply a CSS-styling function column-wise, row-wise, or table-wise.
        Styler.map: Apply a CSS-styling function elementwise.

        Notes
        -----
        Each input to ``func`` will be {input_note***REMOVED***. The output of ``func`` should be
        {output_note***REMOVED***, in the format 'attribute: value; attribute2: value2; ...'
        ...
        >>> def color_b(s):
        ...     return {ret***REMOVED***
        >>> df.style.{this***REMOVED***_index(color_b)  # doctest: +SKIP
        ...
        >>> def highlight_x({var***REMOVED***):
        ...     return {ret2***REMOVED***
        >>> df.style.{this***REMOVED***_index(highlight_x, axis="columns", level=[0, 2])
        ...  # doctest: +SKIP
...
***REMOVED***
    ...
    def map(self, func: Callable, subset: Subset | None = None, **kwargs) -> Styler:
        ...
        **kwargs : dict
        ...
        ...     return f"color: {color***REMOVED***;" if v < 0 else None
        >>> df = pd.DataFrame(np.random.randn(5, 2), columns=["A", "B"])
...
***REMOVED***:
        ...
        if not isinstance(obj, pd.MultiIndex):
            ...
            if axis == 1:
                ...
                if self.index.names[0] is not None:
                    styles[0]["props"] = (
                        props + f"top:0px; z-index:2; height:{pixel_size***REMOVED***px;"
        ***REMOVED***
                    styles.append(
                        {
                            "selector": "thead tr:nth-child(2) th",
                            "props": props
                            + f"top:{pixel_size***REMOVED***px; z-index:2; height:{pixel_size***REMOVED***px; ",
                        ***REMOVED***
        ***REMOVED***
            else:
            ...
            if axis == 1:
                ...
                for i, level in enumerate(levels_):
                    styles.append(
                        {
                            "selector": f"thead tr:nth-child({level+1***REMOVED***) th",
                            "props": props
                            + (
                                f"top:{i * pixel_size***REMOVED***px; height:{pixel_size***REMOVED***px; "
                                "z-index:2;"
                ***REMOVED***,
                        ***REMOVED***
        ***REMOVED***
                if not all(name is None for name in self.index.names):
                    styles.append(
                        {
                            "selector": f"thead tr:nth-child({obj.nlevels+1***REMOVED***) th",
                            "props": props
                            + (
                                f"top:{(len(levels_)) * pixel_size***REMOVED***px; "
                                f"height:{pixel_size***REMOVED***px; z-index:2;"
                ***REMOVED***,
                        ***REMOVED***
        ***REMOVED***
                ...
                for i, level in enumerate(levels_):
                    props_ = props + (
                        f"left:{i * pixel_size***REMOVED***px; "
                        f"min-width:{pixel_size***REMOVED***px; "
                        f"max-width:{pixel_size***REMOVED***px; "
        ***REMOVED***
                    styles.extend(
                        [
                            {
                                "selector": f"thead tr th:nth-child({level+1***REMOVED***)",
                                "props": props_ + "z-index:3 !important;",
                            ***REMOVED***,
                            {
                                "selector": f"tbody tr th.level{level***REMOVED***",
    ...
    def set_table_styles(
        ...
        ...     [{'selector': 'tr:hover',
        ...       'props': [('background-color', 'yellow')]***REMOVED***]
        ... )  # doctest: +SKIP
        ...
        >>> df.style.set_table_styles(
        ...     [{'selector': 'tr:hover',
        ...       'props': 'background-color: yellow; font-size: 1em;'***REMOVED***]
        ... )  # doctest: +SKIP
        ...
        >>> df.style.set_table_styles({
        ...     'A': [{'selector': '',
        ...            'props': [('color', 'red')]***REMOVED***],
        ...     'B': [{'selector': 'td',
        ...            'props': 'color: blue;'***REMOVED***]
        ... ***REMOVED***, overwrite=False)  # doctest: +SKIP

        Adding row styling

        >>> df.style.set_table_styles({
        ...     0: [{'selector': 'td:hover',
        ...          'props': [('font-size', '25px')]***REMOVED***]
        ... ***REMOVED***, axis=1, overwrite=False)  # doctest: +SKIP

        See `Table Visualization <../../user_guide/style.ipynb>`_ user guide for
        more details.
        """
        if css_class_names is not None:
            self.css = {**self.css, **css_class_names***REMOVED***
        ...
        if table_styles is None:
            ...
            idf = f".{self.css['row']***REMOVED***" if axis == 1 else f".{self.css['col']***REMOVED***"
    ...
    def hide(
        ...
        axis : {"index", 0, "columns", 1***REMOVED***
        ...
        >>> df.style.format("{:.1f***REMOVED***").hide()  # doctest: +SKIP
                         x                    y
           a      b      c      a      b      c
        ...
        >>> df.style.format("{:.1f***REMOVED***").hide(subset=(slice(None), ["a", "c"]))
        ...   # doctest: +SKIP
                                 x                    y
                   a      b      c      a      b      c
        ...
        >>> df.style.format("{:.1f***REMOVED***").hide(subset=(slice(None), ["a", "c"])).hide()
        ...   # doctest: +SKIP
                         x                    y
           a      b      c      a      b      c
         0.7    1.0    1.3    1.5   -0.0   -0.2
        ...
        >>> df.style.format("{:,.1f***REMOVED***").hide(level=1)  # doctest: +SKIP
                             x                    y
               a      b      c      a      b      c
        ...
        >>> df.style.format("{:,.1f***REMOVED***").hide(names=True)  # doctest: +SKIP
                                 x                    y
                   a      b      c      a      b      c
        ...
        if subset is None:
            if level is None and names:
                ...
                setattr(self, f"hide_{obj***REMOVED***_names", True)
                return self

            levels_ = refactor_levels(level, getattr(self, objs))
            setattr(
                self,
                f"hide_{objs***REMOVED***_",
...
***REMOVED***
            ...
            setattr(self, f"hidden_{alt***REMOVED***", h_els)
    ...
    def background_gradient(
        ...
        """
        Color the {name***REMOVED*** in a gradient style.

        The {name***REMOVED*** color is determined according
        ...
        high : float
            ...
            defaults to 0.
        axis : {{0, 1, "index", "columns", None***REMOVED******REMOVED***, default 0
            Apply to each column (``axis=0`` or ``'index'``), to each row
            (``axis=1`` or ``'columns'``), or to the entire DataFrame at once
            with ``axis=None``.
        %(subset)s
        {text_threshold***REMOVED***
        vmin : float, optional
        ...
        gmap : array-like, optional
            Gradient map for determining the {name***REMOVED*** colors. If not supplied
        ...
        See Also
        --------
        Styler.{alt***REMOVED***_gradient: Color the {alt***REMOVED*** in a gradient style.
        ...
        >>> df.style.{name***REMOVED***_gradient(axis=0)  # doctest: +SKIP

        .. figure:: ../../_static/style/{image_prefix***REMOVED***_ax0.png

        Shading all values collectively using ``axis=None``

        >>> df.style.{name***REMOVED***_gradient(axis=None)  # doctest: +SKIP

        .. figure:: ../../_static/style/{image_prefix***REMOVED***_axNone.png

        Compress the color map from the both ``low`` and ``high`` ends

        >>> df.style.{name***REMOVED***_gradient(axis=None, low=0.75, high=1.0)  # doctest: +SKIP

        .. figure:: ../../_static/style/{image_prefix***REMOVED***_axNone_lowhigh.png

        Manually setting ``vmin`` and ``vmax`` gradient thresholds

        >>> df.style.{name***REMOVED***_gradient(axis=None, vmin=6.7, vmax=21.6)  # doctest: +SKIP

        .. figure:: ../../_static/style/{image_prefix***REMOVED***_axNone_vminvmax.png

        Setting a ``gmap`` and applying to all columns with another ``cmap``

        >>> df.style.{name***REMOVED***_gradient(axis=0, gmap=df['Temp (c)'], cmap='YlOrRd')
        ...  # doctest: +SKIP

        .. figure:: ../../_static/style/{image_prefix***REMOVED***_gmap.png

        Setting the gradient map for a dataframe (i.e. ``axis=None``), we need to
        explicitly state ``subset`` to match the ``gmap`` shape

        >>> gmap = np.array([[1,2,3], [2,3,4], [3,4,5]])
        >>> df.style.{name***REMOVED***_gradient(axis=None, gmap=gmap,
        ...     cmap='YlOrRd', subset=['Temp (c)', 'Rain (mm)', 'Wind (m/s)']
        ... )  # doctest: +SKIP

        .. figure:: ../../_static/style/{image_prefix***REMOVED***_axNone_gmap.png
        """
    ...
    def set_properties(self, subset: Subset | None = None, **kwargs) -> Styler:
        ...
        **kwargs : dict
        ...
        >>> df.style.set_properties(**{'background-color': 'yellow'***REMOVED***)  # doctest: +SKIP

        See `Table Visualization <../../user_guide/style.ipynb>`_ user guide for
        more details.
        """
        values = "".join([f"{p***REMOVED***: {v***REMOVED***;" for p, v in kwargs.items()])
...
***REMOVED***:
    ...
    ***REMOVED***
        ...
        if not 0 <= width <= 100:
            raise ValueError(f"`width` must be a value in [0, 100], got {width***REMOVED***")
        if not 0 <= height <= 100:
            raise ValueError(f"`height` must be a value in [0, 100], got {height***REMOVED***")
    ...
    def highlight_null(
        ...
        if props is None:
            props = f"background-color: {color***REMOVED***;"
    ...
    def highlight_max(
        ...
        Examples
        --------
        >>> df = pd.DataFrame({'A': [2, 1], 'B': [3, 4]***REMOVED***)
    ...
    def highlight_between(
        ...
        inclusive : {'both', 'neither', 'left', 'right'***REMOVED***
...
def _validate_apply_axis_arg(
    ...
    if isinstance(arg, (Series, DataFrame)):  # align indx / cols to data
        ...
        if arg.shape != data.shape:  # check valid input
            raise ValueError(
                f"supplied '{arg_name***REMOVED***' is not correct shape for data over "
                f"selected 'axis': got {arg.shape***REMOVED***, "
                f"expected {data.shape***REMOVED***"
***REMOVED***
    return arg
...
***REMOVED***
        ...
        def css(rgba, text_only) -> str:
            if not text_only:
                ...
                return (
                    f"background-color: {_matplotlib.colors.rgb2hex(rgba)***REMOVED***;"
                    f"color: {text_color***REMOVED***;"
    ***REMOVED***
            else:
                return f"color: {_matplotlib.colors.rgb2hex(rgba)***REMOVED***;"
...
def _bar(
    ...
    data : Series or DataFrame
        Underling subset of Styler data on which operations are performed.
    align : str in {"left", "right", "mid", "zero", "mean"***REMOVED***, int, float, callable
    ...
    def css_bar(start: float, end: float, color: str) -> str:
        ...
        if end > start:
            ...
            if start > 0:
                cell_css += f" transparent {start*100:.1f***REMOVED***%, {color***REMOVED*** {start*100:.1f***REMOVED***%,"
            cell_css += f" {color***REMOVED*** {end*100:.1f***REMOVED***%, transparent {end*100:.1f***REMOVED***%)"
        return cell_css
    ...
    def css_calc(x, left: float, right: float, align: str, color: str | list | tuple):
        ...
        right : float
            ...
            (left < right).
        align : {"left", "right", "zero", "mid"***REMOVED***
    ...
    ***REMOVED***
        ...
        if height < 1 and "background: linear-gradient(" in ret:
            return (
                ret + f" no-repeat center; background-size: 100% {height * 100:.1f***REMOVED***%;"
***REMOVED***
        else:
            return ret
    ...
    if align == "mid":
        ...
        raise ValueError(
            "`align` should be in {'left', 'right', 'mid', 'mean', 'zero'***REMOVED*** or be a "
