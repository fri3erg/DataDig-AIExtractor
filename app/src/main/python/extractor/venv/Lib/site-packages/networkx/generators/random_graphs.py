...
def fast_gnp_random_graph(n, p, seed=None, directed=False):
    """Returns a $G_{n,p***REMOVED***$ random graph, also known as an Erdős-Rényi graph or
    a binomial graph.
    ...
    Notes
    -----
    The $G_{n,p***REMOVED***$ graph algorithm chooses each of the $[n (n - 1)] / 2$
...
def gnp_random_graph(n, p, seed=None, directed=False):
    """Returns a $G_{n,p***REMOVED***$ random graph, also known as an Erdős-Rényi graph
    or a binomial graph.

    The $G_{n,p***REMOVED***$ model chooses each of the possible edges with probability $p$.
...
def dense_gnm_random_graph(n, m, seed=None):
    """Returns a $G_{n,m***REMOVED***$ random graph.

    In the $G_{n,m***REMOVED***$ model, a graph is chosen uniformly at random from the set
...
def barabasi_albert_graph(n, m, seed=None, initial_graph=None):
    ...
    if m < 1 or m >= n:
        raise nx.NetworkXError(
            f"Barabási–Albert network must have m >= 1 and m < n, m = {m***REMOVED***, n = {n***REMOVED***"
        )
    ...
    if initial_graph is None:
        ...
        if len(initial_graph) < m or len(initial_graph) > n:
            raise nx.NetworkXError(
                f"Barabási–Albert initial graph needs between m={m***REMOVED*** and n={n***REMOVED*** nodes"
***REMOVED***
...
def dual_barabasi_albert_graph(n, m1, m2, p, seed=None, initial_graph=None):
    ...
    if m1 < 1 or m1 >= n:
        raise nx.NetworkXError(
            f"Dual Barabási–Albert must have m1 >= 1 and m1 < n, m1 = {m1***REMOVED***, n = {n***REMOVED***"
        )
    if m2 < 1 or m2 >= n:
        raise nx.NetworkXError(
            f"Dual Barabási–Albert must have m2 >= 1 and m2 < n, m2 = {m2***REMOVED***, n = {n***REMOVED***"
        )
    if p < 0 or p > 1:
        raise nx.NetworkXError(
            f"Dual Barabási–Albert network must have 0 <= p <= 1, p = {p***REMOVED***"
        )
    ...
    if initial_graph is None:
        ...
        if len(initial_graph) < max(m1, m2) or len(initial_graph) > n:
            raise nx.NetworkXError(
                ...
                f"max(m1, m2) = {max(m1, m2)***REMOVED*** and n = {n***REMOVED*** nodes"
***REMOVED***
        G = initial_graph.copy()
...
def extended_barabasi_albert_graph(n, m, p, q, seed=None):
    ...
    """
    if m < 1 or m >= n:
        msg = f"Extended Barabasi-Albert network needs m>=1 and m<n, m={m***REMOVED***, n={n***REMOVED***"
        raise nx.NetworkXError(msg)
    if p + q >= 1:
        msg = f"Extended Barabasi-Albert network needs p + q <= 1, p={p***REMOVED***, q={q***REMOVED***"
        raise nx.NetworkXError(msg)
...
def powerlaw_cluster_graph(n, m, p, seed=None):
    ...
    if m < 1 or n < m:
        raise nx.NetworkXError(f"NetworkXError must have m>1 and m<n, m={m***REMOVED***,n={n***REMOVED***")

    if p > 1 or p < 0:
        raise nx.NetworkXError(f"NetworkXError p must be in [0,1], p={p***REMOVED***")
...
def random_powerlaw_tree_sequence(n, gamma=3, seed=None, tries=100):
    ...
    raise nx.NetworkXError(
        f"Exceeded max ({tries***REMOVED***) attempts for a valid tree sequence."
    )
