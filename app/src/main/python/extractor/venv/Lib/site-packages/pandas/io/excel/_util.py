...
_writers: MutableMapping[str, ExcelWriter_t] = {***REMOVED***
...
def get_default_engine(ext: str, mode: Literal["reader", "writer"] = "reader") -> str:
    ...
    mode : str {'reader', 'writer'***REMOVED***
...
def get_writer(engine_name: str) -> ExcelWriter_t:
    try:
        ...
        raise ValueError(f"No Excel writer '{engine_name***REMOVED***'") from err
...
def _excel2num(x: str) -> int:
    ...
    for c in x.upper().strip():
        ...
        if cp < ord("A") or cp > ord("Z"):
            raise ValueError(f"Invalid column name: {x***REMOVED***")
