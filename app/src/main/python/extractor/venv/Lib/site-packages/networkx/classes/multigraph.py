...
class MultiGraph(Graph):
    ...
    **Edges:**
    ...
    >>> keys = G.add_edges_from([(4, 5, {"route": 28***REMOVED***), (4, 5, {"route": 37***REMOVED***)])
    >>> G[4]
    AdjacencyView({3: {0: {***REMOVED******REMOVED***, 5: {0: {***REMOVED***, 1: {'route': 28***REMOVED***, 2: {'route': 37***REMOVED******REMOVED******REMOVED***)
    ...
    **Attributes:**
    ...
    >>> keys = G.add_edges_from([(1, 2, {"color": "blue"***REMOVED***), (2, 3, {"weight": 8***REMOVED***)])
    >>> G[1][2][0]["weight"] = 4.7
    ...
    **Shortcuts:**
    ...
    AdjacencyView({2: {0: {'weight': 4***REMOVED***, 1: {'color': 'blue'***REMOVED******REMOVED******REMOVED***)
    ...
    ***REMOVED***
    ...
    def add_edge(self, u_for_edge, v_for_edge, key=None, **attr):
        ...
        >>> ekey = G.add_edge(1, 2)
        >>> G[1][2][0].update({0: 5***REMOVED***)
        >>> G.edges[1, 2, 0].update({0: 5***REMOVED***)
        """
    ...
    def add_edges_from(self, ebunch_to_add, **attr):
        ...
        for e in ebunch_to_add:
            ...
            if ne == 4:
                ...
                msg = f"Edge tuple {e***REMOVED*** must be a 2-tuple, 3-tuple or 4-tuple."
    ...
    def remove_edge(self, u, v, key=None):
        ...
        if key is None:
            ...
            try:
                ...
                msg = f"The edge {u***REMOVED***-{v***REMOVED*** with key {key***REMOVED*** is not in the graph."
    ...
    def edges(self):
        ...
        MultiEdgeDataView([(0, 1, {***REMOVED***), (1, 2, {***REMOVED***), (1, 2, {'weight': 2***REMOVED***), (2, 3, {'weight': 5***REMOVED***)])
        >>> G.edges.data("weight", default=1)
        MultiEdgeDataView([(0, 1, 1), (1, 2, 1), (1, 2, 2), (2, 3, 5)])
        >>> G.edges(keys=True)  # default keys are integers
        MultiEdgeView([(0, 1, 0), (1, 2, 0), (1, 2, 1), (2, 3, 0)])
        >>> G.edges.data(keys=True)
        MultiEdgeDataView([(0, 1, 0, {***REMOVED***), (1, 2, 0, {***REMOVED***), (1, 2, 1, {'weight': 2***REMOVED***), (2, 3, 0, {'weight': 5***REMOVED***)])
