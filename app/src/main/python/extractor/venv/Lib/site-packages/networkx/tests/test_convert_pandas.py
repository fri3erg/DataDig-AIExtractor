...
class TestConvertPandas:
    ...
    def test_from_edgelist_all_attr(self):
        Gtrue = nx.Graph(
            [
                ("E", "C", {"cost": 9, "weight": 10***REMOVED***),
                ("B", "A", {"cost": 1, "weight": 7***REMOVED***),
                ("A", "D", {"cost": 7, "weight": 4***REMOVED***),
            ]
        )
    ...
    def test_from_edgelist_multi_attr_incl_target(self):
        Gtrue = nx.Graph(
            [
                ("E", "C", {0: "C", "b": "E", "weight": 10***REMOVED***),
                ("B", "A", {0: "B", "b": "A", "weight": 7***REMOVED***),
                ("A", "D", {0: "A", "b": "D", "weight": 4***REMOVED***),
            ]
        )
    ...
    def test_from_edgelist_multidigraph_and_edge_attr(self):
        ...
        edges = [
            ("X1", "X4", {"Co": "zA", "Mi": 0, "St": "X1"***REMOVED***),
            ("X1", "X4", {"Co": "zB", "Mi": 54, "St": "X2"***REMOVED***),
            ("X1", "X4", {"Co": "zB", "Mi": 49, "St": "X3"***REMOVED***),
            ("X1", "X4", {"Co": "zB", "Mi": 44, "St": "X4"***REMOVED***),
            ("Y1", "Y3", {"Co": "zC", "Mi": 0, "St": "Y1"***REMOVED***),
            ("Y1", "Y3", {"Co": "zC", "Mi": 34, "St": "Y2"***REMOVED***),
            ("Y1", "Y3", {"Co": "zC", "Mi": 29, "St": "X2"***REMOVED***),
            ("Y1", "Y3", {"Co": "zC", "Mi": 24, "St": "Y3"***REMOVED***),
            ("Z1", "Z3", {"Co": "zD", "Mi": 0, "St": "Z1"***REMOVED***),
            ("Z1", "Z3", {"Co": "zD", "Mi": 14, "St": "X3"***REMOVED***),
        ]
    ...
    def test_from_edgelist_one_attr(self):
        Gtrue = nx.Graph(
            [
                ("E", "C", {"weight": 10***REMOVED***),
                ("B", "A", {"weight": 7***REMOVED***),
                ("A", "D", {"weight": 4***REMOVED***),
            ]
        )
    ...
    def test_from_edgelist_int_attr_name(self):
        ...
        Gtrue = nx.Graph(
            [("E", "C", {0: "C"***REMOVED***), ("B", "A", {0: "B"***REMOVED***), ("A", "D", {0: "A"***REMOVED***)]
        )
    ...
    def test_from_edgelist_no_attr(self):
        Gtrue = nx.Graph([("E", "C", {***REMOVED***), ("B", "A", {***REMOVED***), ("A", "D", {***REMOVED***)])
    ...
    def test_from_edgelist(self):
        ...
        edges = pd.DataFrame({"source": source, "target": target, "weight": weight***REMOVED***)
    ...
    def test_roundtrip(self, graph):
        ...
        # adjacency
        adj = {1: {1: {"weight": 1***REMOVED***, 2: {"weight": 1***REMOVED******REMOVED***, 2: {1: {"weight": 1***REMOVED******REMOVED******REMOVED***
        Gtrue = graph(adj)
    ...
    def test_from_adjacency_named(self):
        ...
        data = {
            "A": {"A": 0, "B": 0, "C": 0***REMOVED***,
            "B": {"A": 1, "B": 0, "C": 0***REMOVED***,
            "C": {"A": 0, "B": 1, "C": 0***REMOVED***,
        ***REMOVED***
    ...
    def test_edgekey_with_multigraph(self):
        df = pd.DataFrame(
            {
                "source": {"A": "N1", "B": "N2", "C": "N1", "D": "N1"***REMOVED***,
                "target": {"A": "N2", "B": "N3", "C": "N1", "D": "N2"***REMOVED***,
                "attr1": {"A": "F1", "B": "F2", "C": "F3", "D": "F4"***REMOVED***,
                "attr2": {"A": 1, "B": 0, "C": 0, "D": 0***REMOVED***,
                "attr3": {"A": 0, "B": 1, "C": 0, "D": 1***REMOVED***,
            ***REMOVED***
        )
        Gtrue = nx.MultiGraph(
            [
                ("N1", "N2", "F1", {"attr2": 1, "attr3": 0***REMOVED***),
                ("N2", "N3", "F2", {"attr2": 0, "attr3": 1***REMOVED***),
                ("N1", "N1", "F3", {"attr2": 0, "attr3": 0***REMOVED***),
                ("N1", "N2", "F4", {"attr2": 0, "attr3": 1***REMOVED***),
            ]
        )
