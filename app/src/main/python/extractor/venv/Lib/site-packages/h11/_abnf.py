...
field_content = r"{field_vchar***REMOVED***+(?:[ \t]+{field_vchar***REMOVED***+)*".format(**globals())
...
field_value = r"({field_content***REMOVED***)?".format(**globals())

#  header-field   = field-name ":" OWS field-value OWS
header_field = (
    r"(?P<field_name>{field_name***REMOVED***)"
    r":"
    r"{OWS***REMOVED***"
    r"(?P<field_value>{field_value***REMOVED***)"
    r"{OWS***REMOVED***".format(**globals())
)
...
method = token
request_target = r"{vchar***REMOVED***+".format(**globals())
http_version = r"HTTP/(?P<http_version>[0-9]\.[0-9])"
request_line = (
    r"(?P<method>{method***REMOVED***)"
    r" "
    r"(?P<target>{request_target***REMOVED***)"
    r" "
    r"{http_version***REMOVED***".format(**globals())
)
...
status_code = r"[0-9]{3***REMOVED***"
reason_phrase = r"([ \t]|{vchar_or_obs_text***REMOVED***)*".format(**globals())
status_line = (
    r"{http_version***REMOVED***"
    r" "
    r"(?P<status_code>{status_code***REMOVED***)"
    ...
    r"(?: (?P<reason>{reason_phrase***REMOVED***))?".format(**globals())
)
...
chunk_size = r"({HEXDIG***REMOVED***){{1,20***REMOVED******REMOVED***".format(**globals())
# Actually
#
...
chunk_ext = r";.*"
chunk_header = (
    r"(?P<chunk_size>{chunk_size***REMOVED***)"
    r"(?P<chunk_ext>{chunk_ext***REMOVED***)?"
    r"{OWS***REMOVED***\r\n".format(
        **globals()
