...
reader_engine_doc = """
: string
    The default Excel reader engine for '{ext***REMOVED***' files. Available options:
    auto, {others***REMOVED***.
"""
...
writer_engine_doc = """
: string
    The default Excel writer engine for '{ext***REMOVED***' files. Available options:
    auto, {others***REMOVED***.
"""
...
styler_render_repr = """
: str
    Determine which output to use in Jupyter Notebook in {"html", "latex"***REMOVED***.
"""
...
styler_environment = """
: str
    The environment to replace ``\\begin{table***REMOVED***``. If "longtable" is used results
