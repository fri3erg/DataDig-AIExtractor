...
def get_runtime_and_metrics() -> dict:
    ...
    return {**get_runtime_environment(), **get_system_metrics()***REMOVED***
...
def get_system_metrics() -> Dict[str, Union[float, dict]]:
    ...
    try:
        ...
        metrics: Dict[str, Union[float, dict]] = {***REMOVED***
...
def _get_compose_command() -> Optional[List[str]]:
    try:
        ...
        compose_command = [f"NOT INSTALLED: {e***REMOVED***"]
    except:  # noqa
        return None
...
def get_langchain_env_vars() -> dict:
    ...
    env_vars = {k: v for k, v in os.environ.items() if k.startswith("LANGCHAIN_")***REMOVED***
