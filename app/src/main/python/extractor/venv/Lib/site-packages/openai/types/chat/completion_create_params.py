...
class CompletionCreateParamsBase(TypedDict, total=False):
    ...
    particular function via `{"name": "my_function"***REMOVED***` forces the model to call that
    function.
    ...
    Setting to `{ "type": "json_object" ***REMOVED***` enables JSON mode, which guarantees the
    ...
    **Important:** when using JSON mode, you **must** also instruct the model to
    ...
    `{"type": "function", "function": {"name": "my_function"***REMOVED******REMOVED***` forces the model to
    call that function.
