...
class TestDataFramePlotsGroupby:
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            ({***REMOVED***, [True, False, True, False]),
            # set sharey=True should be identical
            ({"sharey": True***REMOVED***, [True, False, True, False]),
            # sharey=False, all yticklabels should be visible
            ({"sharey": False***REMOVED***, [True, True, True, True]),
        ],
    )
    ...
    @pytest.mark.parametrize(
        ...
        [
            # behavior without keyword
            ({***REMOVED***, [True, True, True, True]),
            # set sharex=False should be identical
            ({"sharex": False***REMOVED***, [True, True, True, True]),
            # sharex=True, xticklabels should be visible
            # only for bottom plots
            ({"sharex": True***REMOVED***, [False, False, True, True]),
        ],
    )
