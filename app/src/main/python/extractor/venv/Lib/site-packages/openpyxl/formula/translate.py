...
class Translator(object):
    ...
    ROW_RANGE_RE = re.compile(r"(\$?[1-9][0-9]{0,6***REMOVED***):(\$?[1-9][0-9]{0,6***REMOVED***)$")
    COL_RANGE_RE = re.compile(r"(\$?[A-Za-z]{1,3***REMOVED***):(\$?[A-Za-z]{1,3***REMOVED***)$")
    CELL_REF_RE = re.compile(r"(\$?[A-Za-z]{1,3***REMOVED***)(\$?[1-9][0-9]{0,6***REMOVED***)$")
