...
***REMOVED***
            ...
            runnable.invoke(1) # {'origin': 1, 'modified': 2***REMOVED***
            ...
            ***REMOVED***
            ...
            chain.invoke('hello') # {'original': 'completion', 'parsed': 'noitelpmoc'***REMOVED***
  ...
  ***REMOVED***
            ...
            # {'llm1': 'completion', 'llm2': 'completion', 'total_chars': 20***REMOVED***
    """
...
class RunnableAssign(RunnableSerializable[Dict[str, Any], Dict[str, Any]]):
    ...
    def get_name(
        ...
        name = (
            name or self.name or f"RunnableAssign<{','.join(self.mapper.steps.keys())***REMOVED***>"
        )
...
***REMOVED***
            ...
            for chunk in for_passthrough:
                assert isinstance(
                    chunk, dict
    ***REMOVED***, "The input to RunnablePassthrough.assign() must be a dict."
                # remove mapper keys from passthrough chunk, to be overwritten by map
                filtered = AddableDict(
                    {k: v for k, v in chunk.items() if k not in mapper_keys***REMOVED***
    ***REMOVED***
                if filtered:
                    yield filtered
            # yield map output
...
class RunnablePick(RunnableSerializable[Dict[str, Any], Dict[str, Any]]):
    ...
    def get_name(
        ...
        name = (
            name
            or self.name
            or f"RunnablePick<{','.join([self.keys] if isinstance(self.keys, str) else self.keys)***REMOVED***>"  # noqa: E501
        )
        return super().get_name(suffix, name=name)
    ...
    def _pick(self, input: Dict[str, Any]) -> Any:
        ...
        if isinstance(self.keys, str):
            ...
            picked = {k: input.get(k) for k in self.keys if k in input***REMOVED***
            if picked:
