...
***REMOVED***
    ...
    def fromstring(
        ...
        if node_pattern is None:
            node_pattern = rf"[^\s{open_pattern***REMOVED***{close_pattern***REMOVED***]+"
        if leaf_pattern is None:
            leaf_pattern = rf"[^\s{open_pattern***REMOVED***{close_pattern***REMOVED***]+"
        token_re = re.compile(
            r"%s\s*(%s)?|%s|(%s)"
    ...
    def pformat(self, margin=70, indent=0, nodesep="", parens="()", quotes=False):
        ...
        if isinstance(self._label, str):
            s = f"{parens[0]***REMOVED***{self._label***REMOVED***{nodesep***REMOVED***"
        else:
            s = f"{parens[0]***REMOVED***{repr(self._label)***REMOVED***{nodesep***REMOVED***"
        for child in self:
            if isinstance(child, Tree):
                s += (
                    "\n"
    ...
    ***REMOVED***
    ...
    def pformat_latex_qtree(self):
        ...
        :rtype: str
        """
        reserved_chars = re.compile(r"([#\$%&~_\{\***REMOVED***])")
