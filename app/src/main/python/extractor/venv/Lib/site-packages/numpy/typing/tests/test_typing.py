...
def run_mypy() -> None:
    ...
    for directory in (PASS_DIR, REVEAL_DIR, FAIL_DIR, MISC_DIR):
        ...
        elif exit_code not in {0, 1***REMOVED***:
            pytest.fail(f"Unexpected mypy exit code: {exit_code***REMOVED***\n\n{stdout***REMOVED***")
...
def test_fail(path: str) -> None:
    ...
    for error_line in output_mypy[path]:
        ...
        errors[lineno] += f'{error_line***REMOVED***\n'
    ...
    for i, line in enumerate(lines):
        ...
        if "# E:" in target_line:
            ...
            pytest.fail(
                f"Unexpected mypy output at line {lineno***REMOVED***\n\n{errors[lineno]***REMOVED***"
***REMOVED***


_FAIL_MSG1 = """Extra error at line {***REMOVED***

Expression: {***REMOVED***
Extra error: {!r***REMOVED***
"""

_FAIL_MSG2 = """Error mismatch at line {***REMOVED***

Expression: {***REMOVED***
Expected error: {***REMOVED***
Observed error: {!r***REMOVED***
"""
...
_REVEAL_MSG = """Reveal mismatch at line {***REMOVED***
...
def test_code_runs(path: str) -> None:
    ...
    spec = importlib.util.spec_from_file_location(
        f"{dirname***REMOVED***.{filename***REMOVED***", path
    )
