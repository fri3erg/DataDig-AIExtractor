...
***REMOVED***
    ...
    def load(self) -> List[Document]:
        ...
        if transcript.error:
            raise ValueError(f"Could not transcribe file: {transcript.error***REMOVED***")
    ...
    ***REMOVED***
            ...
            return [
                Document(page_content=s.text, metadata=s.dict(exclude={"text"***REMOVED***))
                for s in sentences
            ]
        elif self.transcript_format == TranscriptFormat.PARAGRAPHS:
            paragraphs = transcript.get_paragraphs()
            return [
                Document(page_content=p.text, metadata=p.dict(exclude={"text"***REMOVED***))
                for p in paragraphs
            ]
