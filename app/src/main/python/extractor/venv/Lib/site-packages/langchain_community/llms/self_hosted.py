...
***REMOVED***
    ...
    ***REMOVED***.save().to(gpu, path="models")
            llm = SelfHostedPipeline.from_pipeline(
...
***REMOVED***
        ...
        _load_fn_kwargs = self.load_fn_kwargs or {***REMOVED***
...
***REMOVED***
        ...
        load_fn_kwargs = {"pipeline": pipeline, "device": device***REMOVED***
        return cls(
    ...
    def _identifying_params(self) -> Mapping[str, Any]:
        ...
        return {
            **{"hardware": self.hardware***REMOVED***,
        ***REMOVED***
