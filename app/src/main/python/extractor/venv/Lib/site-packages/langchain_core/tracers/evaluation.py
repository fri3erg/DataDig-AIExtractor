...
***REMOVED***
        ...
        self.logged_eval_results: Dict[Tuple[str, str], List[EvaluationResult]] = {***REMOVED***
...
***REMOVED*** as cb:
    ...
    ***REMOVED***
            ...
            logger.error(
                f"Error evaluating run {run.id***REMOVED*** with "
                f"{evaluator.__class__.__name__***REMOVED***: {repr(e)***REMOVED***",
                exc_info=True,
***REMOVED***
            raise e
...
***REMOVED***
    ...
    def _log_evaluation_feedback(
        ...
        for res in results:
            source_info_: Dict[str, Any] = {***REMOVED***
...
***REMOVED***
    ...
    def _persist_run(self, run: Run) -> None:
        ...
        if self.skip_unfinished and not run.outputs:
            logger.debug(f"Skipping unfinished run {run.id***REMOVED***")
            return
        run_ = run.copy()
