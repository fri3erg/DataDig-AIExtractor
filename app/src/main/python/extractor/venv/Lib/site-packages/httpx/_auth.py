...
***REMOVED***
    ...
    def _parse_challenge(
        ...
        header_dict: typing.Dict[str, str] = {***REMOVED***
...
***REMOVED***
    ...
    def _get_header_value(self, header_fields: typing.Dict[str, bytes]) -> str:
        ...
        QUOTED_TEMPLATE = '{***REMOVED***="{***REMOVED***"'
        NON_QUOTED_TEMPLATE = "{***REMOVED***={***REMOVED***"
...
***REMOVED***
    ...
    def _resolve_qop(
        ...
        message = f'Unexpected qop value "{qop!r***REMOVED***" in digest auth'
