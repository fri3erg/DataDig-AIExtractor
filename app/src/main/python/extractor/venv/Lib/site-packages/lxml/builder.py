...
***REMOVED***
    ...
    and/or a specific target ``namespace`` to the ElementMaker class::
        ...
        >>> E = ElementMaker(namespace="http://my.ns/", nsmap={'p':'http://my.ns/'***REMOVED***)
        >>> print(ET.tostring( E.test ))
    ...
    def __init__(self, typemap=None,
        ...
        self._namespace = '{' + namespace + '***REMOVED***' if namespace is not None else None
        ...
        typemap = dict(typemap) if typemap else {***REMOVED***
