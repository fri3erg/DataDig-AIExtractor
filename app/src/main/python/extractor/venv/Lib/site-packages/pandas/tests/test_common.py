...
def test_standardize_mapping():
    ...
    fill = {"bad": "data"***REMOVED***
    assert com.standardize_mapping(fill) == dict

    # Convert instance to type
    assert com.standardize_mapping({***REMOVED***) == dict
...
class TestIsBoolIndexer:
    ...
    def test_frozenlist(self):
        # GH#42461
        data = {"col1": [1, 2], "col2": [3, 4]***REMOVED***
...
def test_str_size():
    ...
    call = [
        pyexe,
        "-c",
        "a='a';***REMOVED***;sys.getsizeof(a);import pandas;print(sys.getsizeof(a));",
    ]
...
def test_pyarrow_missing_warn(module):
    ...
    response = subprocess.run(
        [sys.executable, "-c", f"import {module***REMOVED***"],
        capture_output=True,
        check=True,
    )
    msg = """
