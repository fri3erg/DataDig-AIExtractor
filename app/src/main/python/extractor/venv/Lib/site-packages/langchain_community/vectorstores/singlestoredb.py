...
***REMOVED***
        ...
        try:
            ...
            try:
                cur.execute(
                    ...
                    ({***REMOVED*** TEXT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci,
                    {***REMOVED*** BLOB, {***REMOVED*** JSON);""".format(
                        self.table_name,
                        self.content_field,
                        self.vector_field,
                        self.metadata_field,
    ...
    ***REMOVED***
    ...
    def add_texts(
        ...
        ***REMOVED***
                    cur.execute(
                        "INSERT INTO {***REMOVED*** VALUES (%s, JSON_ARRAY_PACK(%s), %s)".format(
                            self.table_name
            ***REMOVED***,
                        (
                            text,
                            "[{***REMOVED***]".format(",".join(map(str, embedding))),
                            json.dumps(metadata),
            ***REMOVED***,
        ***REMOVED***
            finally:
    ...
    ***REMOVED***
                s2.similarity_search("query text", 1,
                    {"metadata_field": "metadata_value"***REMOVED***)
        """
...
***REMOVED*** -> None:
            ...
            ***REMOVED***
                        ...
                        arguments.append(
                            "JSON_EXTRACT_JSON({***REMOVED***, {***REMOVED***) = %s".format(
                                self.metadata_field,
        ...
        try:
            ...
            try:
                cur.execute(
                    """SELECT {***REMOVED***, {***REMOVED***, {***REMOVED***({***REMOVED***, JSON_ARRAY_PACK(%s)) as __score
                    FROM {***REMOVED*** {***REMOVED*** ORDER BY __score {***REMOVED*** LIMIT %s""".format(
                        self.content_field,
                        self.metadata_field,
