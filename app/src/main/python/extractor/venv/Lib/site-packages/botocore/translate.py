...
def build_retry_config(
    ...
    service_config = retry_model.get(endpoint_prefix, {***REMOVED***)
    ...
    final_retry_config = {
        '__default__': copy.deepcopy(retry_model.get('__default__', {***REMOVED***))
    ***REMOVED***
...
def resolve_references(config, definitions):
    ...
    references as {"$ref": "name"***REMOVED***, when this happens the reference
