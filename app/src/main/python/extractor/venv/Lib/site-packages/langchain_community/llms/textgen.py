...
class TextGen(LLM):
    ...
    def _identifying_params(self) -> Dict[str, Any]:
        ...
        return {**{"model_url": self.model_url***REMOVED***, **self._default_params***REMOVED***
    ...
    def _get_parameters(self, stop: Optional[List[str]] = None) -> Dict[str, Any]:
        ...
        if self.preset is None:
            ...
            params = {"preset": self.preset***REMOVED***
...
***REMOVED***:
            ...
            url = f"{self.model_url***REMOVED***/api/v1/generate"
            ...
            if response.status_code == 200:
                ...
                print(f"ERROR: response: {response***REMOVED***")
                result = ""
...
***REMOVED***
        ...
        url = f"{self.model_url***REMOVED***/api/v1/stream"
