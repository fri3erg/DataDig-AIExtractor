...
def node_redundancy(G, nodes=None):
    ...
    .. math::
        ...
        rc(v) = \frac{|\{\{u, w\***REMOVED*** \subseteq N(v),
        \: \exists v' \neq  v,\: (v',u) \in E\:
        \mathrm{and***REMOVED***\: (v',w) \in E\***REMOVED***|***REMOVED***{ \frac{|N(v)|(|N(v)|-1)***REMOVED***{2***REMOVED******REMOVED***,
    ...
    return {v: _node_redundancy(G, v) for v in nodes***REMOVED***
...
def _node_redundancy(G, v):
    ...
    n = len(G[v])
    overlap = sum(
        1 for (u, w) in combinations(G[v], 2) if (set(G[u]) & set(G[w])) - {v***REMOVED***
    )
