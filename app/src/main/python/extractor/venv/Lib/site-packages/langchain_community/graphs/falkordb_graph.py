...
RETURN {label:label, keys:keys***REMOVED*** AS output
"""
...
RETURN {types:type, keys:keys***REMOVED*** AS output
"""
...
RETURN DISTINCT {start: src_label, type: rel_type, end: dst_label***REMOVED*** AS output
"""
...
***REMOVED***
        ...
        try:
            ...
            raise ValueError(f"Could not refresh schema. Error: {e***REMOVED***")
    ...
    def refresh_schema(self) -> None:
        ...
        self.structured_schema = {
            "node_props": {el[0]["label"]: el[0]["keys"] for el in node_properties***REMOVED***,
            "rel_props": {el[0]["types"]: el[0]["keys"] for el in rel_properties***REMOVED***,
            "relationships": [el[0] for el in relationships],
        ***REMOVED***

        self.schema = (
            f"Node properties: {node_properties***REMOVED***\n"
            f"Relationships properties: {rel_properties***REMOVED***\n"
            f"Relationships: {relationships***REMOVED***\n"
        )
    ...
    def add_graph_documents(
        ...
        for document in graph_documents:
            ...
            for node in document.nodes:
                self.query(
                    (
                        f"MERGE (n:{node.type***REMOVED*** {{id:'{node.id***REMOVED***'***REMOVED******REMOVED***) "
                        "SET n += $properties "
                        "RETURN distinct 'done' AS result"
        ***REMOVED***,
                    {"properties": node.properties***REMOVED***,
    ***REMOVED***
            ...
            for rel in document.relationships:
                self.query(
                    (
                        f"MATCH (a:{rel.source.type***REMOVED*** {{id:'{rel.source.id***REMOVED***'***REMOVED******REMOVED***), "
                        f"(b:{rel.target.type***REMOVED*** {{id:'{rel.target.id***REMOVED***'***REMOVED******REMOVED***) "
                        f"MERGE (a)-[r:{(rel.type.replace(' ', '_').upper())***REMOVED***]->(b) "
                        "SET r += $properties "
                        "RETURN distinct 'done' AS result"
        ***REMOVED***,
                    {"properties": rel.properties***REMOVED***,
    ***REMOVED***
