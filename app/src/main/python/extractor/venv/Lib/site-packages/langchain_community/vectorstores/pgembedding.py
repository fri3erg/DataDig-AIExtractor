...
***REMOVED***
    ...
    def create_hnsw_index(
        ...
        try:
            ...
            print(f"Failed to create HNSW extension or index: {e***REMOVED***")
            ...
            results: List[QueryResult] = (
                session.query(
                    ...
                    func.abs(EmbeddingStore.embedding.op("<->")(embedding)).label(
                        "distance"
        ***REMOVED***,
    ***REMOVED***  # Specify the columns you need here, e.g., EmbeddingStore.embedding
                .filter(filter_by)
                .order_by(
                    func.abs(EmbeddingStore.embedding.op("<->")(embedding)).asc()
    ***REMOVED***  # Using PostgreSQL specific operator with the correct column name
                .limit(k)
                .all()
***REMOVED***
