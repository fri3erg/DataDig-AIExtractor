...
class TestDateOffset:
    ...
    ***REMOVED***
***REMOVED***
        offset = DateOffset(**{kwd: 2***REMOVED***)
        assert offset.kwds == {kwd: 2***REMOVED***
    ...
    def test_add(self, arithmatic_offset_type, expected, dt):
        assert DateOffset(**{arithmatic_offset_type: 1***REMOVED***) + dt == Timestamp(expected)
        assert dt + DateOffset(**{arithmatic_offset_type: 1***REMOVED***) == Timestamp(expected)
    ...
    def test_sub(self, arithmatic_offset_type, expected, dt):
        ...
        with pytest.raises(TypeError, match="Cannot subtract datetime from offset"):
            DateOffset(**{arithmatic_offset_type: 1***REMOVED***) - dt
    ...
    def test_mul_add(self, arithmatic_offset_type, n, expected, dt):
        assert DateOffset(**{arithmatic_offset_type: 1***REMOVED***) * n + dt == Timestamp(expected)
        assert n * DateOffset(**{arithmatic_offset_type: 1***REMOVED***) + dt == Timestamp(expected)
        assert dt + DateOffset(**{arithmatic_offset_type: 1***REMOVED***) * n == Timestamp(expected)
        assert dt + n * DateOffset(**{arithmatic_offset_type: 1***REMOVED***) == Timestamp(expected)
    ...
    @pytest.mark.parametrize(
        ...
        [
            ({"microseconds": 1, "milliseconds": 1***REMOVED***, "2022-01-01 00:00:00.001001"),
            ({"seconds": 1, "milliseconds": 1***REMOVED***, "2022-01-01 00:00:01.001"),
            ({"minutes": 1, "milliseconds": 1***REMOVED***, "2022-01-01 00:01:00.001"),
            ({"hours": 1, "milliseconds": 1***REMOVED***, "2022-01-01 01:00:00.001"),
            ({"days": 1, "milliseconds": 1***REMOVED***, "2022-01-02 00:00:00.001"),
            ({"weeks": 1, "milliseconds": 1***REMOVED***, "2022-01-08 00:00:00.001"),
            ({"months": 1, "milliseconds": 1***REMOVED***, "2022-02-01 00:00:00.001"),
            ({"years": 1, "milliseconds": 1***REMOVED***, "2023-01-01 00:00:00.001"),
        ],
    )
...
def test_get_offset():
    ...
    for name, expected in pairs:
        ...
        assert offset == expected, (
            f"Expected {repr(name)***REMOVED*** to yield {repr(expected)***REMOVED*** "
            f"(actual: {repr(offset)***REMOVED***)"
        )
...
def test_valid_month_attributes(kwd, month_classes):
    ...
    msg = rf"__init__\(\) got an unexpected keyword argument '{kwd***REMOVED***'"
...
@pytest.mark.parametrize(
    "offset_kwargs, expected_arg",
    [
        ({"nanoseconds": 1***REMOVED***, "1970-01-01 00:00:00.000000001"),
        ({"nanoseconds": 5***REMOVED***, "1970-01-01 00:00:00.000000005"),
        ({"nanoseconds": -1***REMOVED***, "1969-12-31 23:59:59.999999999"),
        ({"microseconds": 1***REMOVED***, "1970-01-01 00:00:00.000001"),
        ({"microseconds": -1***REMOVED***, "1969-12-31 23:59:59.999999"),
        ({"seconds": 1***REMOVED***, "1970-01-01 00:00:01"),
        ({"seconds": -1***REMOVED***, "1969-12-31 23:59:59"),
        ({"minutes": 1***REMOVED***, "1970-01-01 00:01:00"),
        ({"minutes": -1***REMOVED***, "1969-12-31 23:59:00"),
        ({"hours": 1***REMOVED***, "1970-01-01 01:00:00"),
        ({"hours": -1***REMOVED***, "1969-12-31 23:00:00"),
        ({"days": 1***REMOVED***, "1970-01-02 00:00:00"),
        ({"days": -1***REMOVED***, "1969-12-31 00:00:00"),
        ({"weeks": 1***REMOVED***, "1970-01-08 00:00:00"),
        ({"weeks": -1***REMOVED***, "1969-12-25 00:00:00"),
        ({"months": 1***REMOVED***, "1970-02-01 00:00:00"),
        ({"months": -1***REMOVED***, "1969-12-01 00:00:00"),
        ({"years": 1***REMOVED***, "1971-01-01 00:00:00"),
        ({"years": -1***REMOVED***, "1969-01-01 00:00:00"),
    ],
)
...
def test_dateoffset_immutable(attribute):
    offset = DateOffset(**{attribute: 0***REMOVED***)
...
def test_dateoffset_operations_on_dataframes():
    # GH 47953
    df = DataFrame({"T": [Timestamp("2019-04-30")], "D": [DateOffset(months=1)]***REMOVED***)
