...
<!-- Select the import statement and adjust the path as 
   ...
   If not XSLT2 then also remove svrl:active-pattern/@document="{document-uri()***REMOVED***" from process-pattern()
-->
<!--
...
<xsl:template name="process-root">
	...
	<svrl:schematron-output title="{$title***REMOVED***" schemaVersion="{$schemaVersion***REMOVED***" >
...
<xsl:template name="process-assert">
	...
	<xsl:param name="see" />
	<xsl:param name="space" />
	<svrl:failed-assert test="{$test***REMOVED***" >
...
<xsl:template name="process-report">
	...
	<xsl:param name="see" />
	<xsl:param name="space" />
	<svrl:successful-report test="{$test***REMOVED***" >
		<xsl:if test=" string-length( $id ) &gt; 0">
			<axsl:attribute name="id">
				<xsl:value-of select=" $id " />
			</axsl:attribute>
...
<xsl:template name="process-diagnostic">
	...
	<xsl:param name="see" />
	<xsl:param name="space" />
	<svrl:diagnostic-reference diagnostic="{$id***REMOVED***" >
...
<xsl:template name="process-rule">
	...
	<svrl:fired-rule context="{$context***REMOVED***" >
		<!-- Process rich attributes.  -->
		<xsl:call-template name="richParms">
			<xsl:with-param name="fpi" select="$fpi"/>
			<xsl:with-param name="icon" select="$icon"/>
...
<xsl:template name="process-ns">
	...
	<xsl:param name="uri"/>
	<svrl:ns-prefix-in-attribute-values uri="{$uri***REMOVED***" prefix="{$prefix***REMOVED***" />
</xsl:template>
