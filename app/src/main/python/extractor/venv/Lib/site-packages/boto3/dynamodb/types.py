...
class Binary:
    ...
    def __init__(self, value):
        if not isinstance(value, BINARY_TYPES):
            ...
            raise TypeError(f'Value must be of the following types: {types***REMOVED***')
        self.value = value
    ...
    def __repr__(self):
        return f'Binary({self.value!r***REMOVED***)'
...
class TypeSerializer:
    ...
    def serialize(self, value):
        ...
        :param value: A python value to be serialized to DynamoDB. Here are
            ...
            Python                                  DynamoDB
            ------                                  --------
            None                                    {'NULL': True***REMOVED***
            True/False                              {'BOOL': True/False***REMOVED***
            int/Decimal                             {'N': str(value)***REMOVED***
            string                                  {'S': string***REMOVED***
            Binary/bytearray/bytes (py3 only)       {'B': bytes***REMOVED***
            set([int/Decimal])                      {'NS': [str(value)]***REMOVED***
            set([string])                           {'SS': [string])
            set([Binary/bytearray/bytes])           {'BS': [bytes]***REMOVED***
            list                                    {'L': list***REMOVED***
            dict                                    {'M': dict***REMOVED***
        ...
        serializer = getattr(self, f'_serialize_{dynamodb_type***REMOVED***'.lower())
        return {dynamodb_type: serializer(value)***REMOVED***
    ...
    def _get_dynamodb_type(self, value):
        ...
        if self._is_null(value):
            ...
            msg = f'Unsupported type "{type(value)***REMOVED***" for value "{value***REMOVED***"'
            raise TypeError(msg)
...
***REMOVED***
    ...
    def _serialize_m(self, value):
        return {k: self.serialize(v) for k, v in value.items()***REMOVED***
...
class TypeDeserializer:
    ...
    def deserialize(self, value):
        ...
        :param value: A DynamoDB value to be deserialized to a pythonic value.
            ...
            DynamoDB                                Python
            --------                                ------
            {'NULL': True***REMOVED***                          None
            {'BOOL': True/False***REMOVED***                    True/False
            {'N': str(value)***REMOVED***                       Decimal(str(value))
            {'S': string***REMOVED***                           string
            {'B': bytes***REMOVED***                            Binary(bytes)
            {'NS': [str(value)]***REMOVED***                    set([Decimal(str(value))])
            {'SS': [string]***REMOVED***                        set([string])
            {'BS': [bytes]***REMOVED***                         set([bytes])
            {'L': list***REMOVED***                             list
            {'M': dict***REMOVED***                             dict
...
***REMOVED***
        ...
        try:
            deserializer = getattr(
                self, f'_deserialize_{dynamodb_type***REMOVED***'.lower()
***REMOVED***
        except AttributeError:
            raise TypeError(f'Dynamodb type {dynamodb_type***REMOVED*** is not supported')
    ...
    def _deserialize_m(self, value):
        return {k: self.deserialize(v) for k, v in value.items()***REMOVED***
