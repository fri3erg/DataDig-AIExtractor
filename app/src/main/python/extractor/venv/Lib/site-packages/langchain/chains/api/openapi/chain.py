...
class OpenAPIEndpointChain(Chain, BaseModel):
    ...
    def _construct_path(self, args: Dict[str, str]) -> str:
        ...
        for param in self.param_mapping.path_params:
            path = path.replace(f"{{{param***REMOVED******REMOVED******REMOVED***", str(args.pop(param, "")))
        return path
    ...
    def _get_output(self, output: str, intermediate_steps: dict) -> dict:
        ...
        if self.return_intermediate_steps:
            ...
            ***REMOVED***
            ...
            return {self.output_key: output***REMOVED***
        ...
        try:
            ...
            if api_response.status_code != 200:
                ...
                response_text = (
                    ...
                    + f"\nFor {method_str.upper()***REMOVED***  {request_args['url']***REMOVED***\n"
                    + f"Called with args: {request_args['params']***REMOVED***"
    ***REMOVED***
            else:
                response_text = api_response.text
        except Exception as e:
            response_text = f"Error with message {str(e)***REMOVED***"
