...
***REMOVED*** from e
        ...
        if metadatas is not None:
            assert length == len(
                metadatas
***REMOVED***, "Number of texts and metadatas should be the same."

        if ids is not None:
            assert len(ltexts) == len(
                ids
***REMOVED***, "Number of text inputs and input ids should be the same."
    ...
    ***REMOVED***
        ...
        ***REMOVED***
                ...
                logger.warning(f"Post inputs failed: {error***REMOVED***")
                traceback.print_exc()
...
***REMOVED*** from e
        ...
        rank = [{"text_raw": query***REMOVED***]
        # Add filter by metadata if provided.
        if filters is not None:
            search_metadata = {"metadata": filters***REMOVED***
        ...
        def hit_to_document(hit: resources_pb2.Hit) -> Tuple[Document, float]:
            ...
            h = {"Authorization": f"Key {self._pat***REMOVED***"***REMOVED***
            ...
            logger.debug(
                f"\tScore {hit.score:.2f***REMOVED*** for annotation: {hit.annotation.id***REMOVED***\
                off input: {hit.input.id***REMOVED***, text: {requested_text[:125]***REMOVED***"
***REMOVED***
