...
class TestPeriodIndexDisallowedFreqs:
    ...
    def test_period_index_from_datetime_index_invalid_freq(self, freq):
        # GH#56899
        msg = f"Invalid frequency: {freq[1:]***REMOVED***"
...
***REMOVED***
    ...
    def test_constructor_year_and_quarter(self):
        ...
        strs = [f"{t[0]:d***REMOVED***Q{t[1]:d***REMOVED***" for t in zip(quarter, year)]
    ...
    def test_constructor_freq_mult_dti_compat_month(self, mult):
        pidx = period_range(start="2014-04-01", freq=f"{mult***REMOVED***M", periods=10)
        expected = date_range(
            start="2014-04-01", freq=f"{mult***REMOVED***ME", periods=10
        ).to_period(f"{mult***REMOVED***M")
        tm.assert_index_equal(pidx, expected)
