...
class ResourceMeta:
    ...
    def __repr__(self):
        return 'ResourceMeta(\'{***REMOVED***\', identifiers={***REMOVED***)'.format(
    ...
    def __init__(self, *args, **kwargs):
        ...
        for name, value in kwargs.items():
            ...
            if name not in self.meta.identifiers:
                raise ValueError(f'Unknown keyword argument: {name***REMOVED***')
        ...
        for identifier in self.meta.identifiers:
            if getattr(self, identifier) is None:
                raise ValueError(f'Required parameter {identifier***REMOVED*** not set')

    def __repr__(self):
        identifiers = []
        for identifier in self.meta.identifiers:
            identifiers.append(
                f'{identifier***REMOVED***={repr(getattr(self, identifier))***REMOVED***'
***REMOVED***
