...
RHS_RE = re.compile(r"""([^{***REMOVED***]*[^ {***REMOVED***])\s*(\{[^***REMOVED***]+\***REMOVED***)?""", re.UNICODE)

# Parses the semantic predicate
SEMANTICS_RE = re.compile(r"""\{([^***REMOVED***]+)\***REMOVED***""", re.UNICODE)
...
class Token:
    ...
    token => category {semantics***REMOVED***
    e.g. eat => S\\var[pl]/var {\\x y.eat(x,y)***REMOVED***
    ...
    * `semantics` (Expression)
    ...
    def __str__(self):
        ...
        if self._semantics is not None:
            semantics_str = " {" + str(self._semantics) + "***REMOVED***"
