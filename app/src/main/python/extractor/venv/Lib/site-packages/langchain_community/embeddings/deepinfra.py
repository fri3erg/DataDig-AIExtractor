...
***REMOVED***
    ...
    def _identifying_params(self) -> Mapping[str, Any]:
        ...
        return {"model_id": self.model_id***REMOVED***
    ...
    def _embed(self, input: List[str]) -> List[List[float]]:
        ...
        ***REMOVED***
        ...
        try:
            res = requests.post(
                f"https://api.deepinfra.com/v1/inference/{self.model_id***REMOVED***",
                headers=headers,
                json={"inputs": input, "normalize": self.normalize, **_model_kwargs***REMOVED***,
***REMOVED***
...
***REMOVED***
    ...
    def embed_documents(self, texts: List[str]) -> List[List[float]]:
        ...
        """
        instruction_pairs = [f"{self.embed_instruction***REMOVED***{text***REMOVED***" for text in texts]
    ...
    def embed_query(self, text: str) -> List[float]:
        ...
        """
        instruction_pair = f"{self.query_instruction***REMOVED***{text***REMOVED***"
