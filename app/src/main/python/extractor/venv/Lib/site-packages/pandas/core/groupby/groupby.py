...
_apply_docs = {
    ...
    The function passed to ``apply`` must take a {input***REMOVED*** as its first
    ...
    ----------
    func : callable
        A callable that takes a {input***REMOVED*** as its first argument, and
...
Compute {fname***REMOVED*** of group values.

Parameters
----------
numeric_only : bool, default {no***REMOVED***
...
min_count : int, default {mc***REMOVED***
...
-------
Series or DataFrame
    Computed {fname***REMOVED*** of values within each group.
...
engine : str, default None {e***REMOVED***
    * ``'cython'`` : Runs rolling apply through C-extensions from cython.
    * ``'numba'`` : Runs rolling apply through JIT compiled code from numba.
        Only available when ``raw`` is set to ``True``.
    * ``None`` : Defaults to ``'cython'`` or globally setting ``compute.use_numba``

engine_kwargs : dict, default None {ek***REMOVED***
    * For ``'cython'`` engine, there are no accepted ``engine_kwargs``
    * For ``'numba'`` engine, the engine can accept ``nopython``, ``nogil``
        and ``parallel`` dictionary keys. The values must either be ``True`` or
        ``False``. The default ``engine_kwargs`` for the ``'numba'`` engine is
        ``{{'nopython': True, 'nogil': False, 'parallel': False***REMOVED******REMOVED***`` and will be
...
engine_kwargs : dict, default None
    ...
    * For ``'numba'`` engine, the engine can accept ``nopython``, ``nogil``
      and ``parallel`` dictionary keys. The values must either be ``True`` or
      ``False``. The default ``engine_kwargs`` for the ``'numba'`` engine is
      ``{'nopython': True, 'nogil': False, 'parallel': False***REMOVED***`` and will be
...
func : function, str, list, dict or None
    ...
    work when passed a {klass***REMOVED*** or when passed to {klass***REMOVED***.apply.
...
See Also
--------
{klass***REMOVED***.groupby.apply : Apply function func group-wise
    and combine the results together.
{klass***REMOVED***.groupby.transform : Transforms the Series on each group
    based on the given function.
{klass***REMOVED***.aggregate : Aggregate using one or more
    operations over the specified axis.
...
class BaseGroupBy(PandasObject, SelectionMixin[NDFrameT], GroupByIndexingMixin):
    ...
    ***REMOVED***
    ...
    def grouper(self) -> ops.BaseGrouper:
        warnings.warn(
            f"{type(self).__name__***REMOVED***.grouper is deprecated and will be removed in a "
    ...
    def groups(self) -> dict[Hashable, np.ndarray]:
        """
        Dict {group name -> group labels***REMOVED***.
        ...
        {Timestamp('2023-01-01 00:00:00'): 2, Timestamp('2023-02-01 00:00:00'): 4***REMOVED***
        """
    ...
    def indices(self) -> dict[Hashable, npt.NDArray[np.intp]]:
        """
        Dict {group name -> group indices***REMOVED***.
        ...
        Timestamp('2023-02-01 00:00:00'): [2, 3]***REMOVED***)
        """
    ...
    @Substitution(
        ...
        examples=dedent(
            """\
        >>> df = pd.DataFrame({'A': 'a b a b'.split(), 'B': [1, 2, 3, 4]***REMOVED***)
        >>> df
           A  B
        0  a  1
        1  b  2
    ...
    ***REMOVED***
    ...
    def __getattr__(self, attr: str):
        ...
        raise AttributeError(
            f"'{type(self).__name__***REMOVED***' object has no attribute '{attr***REMOVED***'"
        )
    ...
    def _deprecate_axis(self, axis: int, name: str) -> None:
        if axis == 1:
            warnings.warn(
                f"{type(self).__name__***REMOVED***.{name***REMOVED*** with axis=1 is deprecated and "
...
***REMOVED***
            ...
            warnings.warn(
                f"The 'axis' keyword in {type(self).__name__***REMOVED***.{name***REMOVED*** is deprecated "
...
***REMOVED***
    ...
    def _transform_with_numba(self, func, *args, engine_kwargs=None, **kwargs):
        ...
        index = data.index
        if data.ndim == 1:
            result_kwargs = {"name": data.name***REMOVED***
            result = result.ravel()
        else:
            result_kwargs = {"columns": data.columns***REMOVED***
        ...
        if isinstance(func, str):
            if hasattr(self, func):
                ...
                if callable(res):
                    ...
                    raise ValueError(f"Cannot pass arguments to property {func***REMOVED***")
                return res

            else:
                raise TypeError(f"apply func should be callable, not '{func***REMOVED***'")
    ...
    ***REMOVED***:
    ...
    def _agg_py_fallback(
        ...
        try:
            ...
            msg = f"agg function failed [how->{how***REMOVED***,dtype->{ser.dtype***REMOVED***]"
    ...
    ***REMOVED***
    ...
    def _transform(self, func, *args, engine=None, engine_kwargs=None, **kwargs):
        ...
        if not isinstance(func, str):
            ...
            msg = f"'{func***REMOVED***' is not a valid function name for transform(name)"
            raise ValueError(msg)
    ...
    def _wrap_transform_fast_result(self, result: NDFrameT) -> NDFrameT:
        ...
        if self.obj.ndim == 1:
            ...
            output = result._reindex_with_indexers(
                {axis: (new_ax, ids)***REMOVED***, allow_dups=True, copy=False
***REMOVED***
    ...
    def mean(
        ...
        engine_kwargs : dict, default None
            ...
            * For ``'numba'`` engine, the engine can accept ``nopython``, ``nogil``
              and ``parallel`` dictionary keys. The values must either be ``True`` or
              ``False``. The default ``engine_kwargs`` for the ``'numba'`` engine is
              ``{{'nopython': True, 'nogil': False, 'parallel': False***REMOVED******REMOVED***``
        ...
        ...                    'B': [np.nan, 2, 3, 4, 5],
        ...                    'C': [1, 2, 1, 1, 2]***REMOVED***, columns=['A', 'B', 'C'])
...
***REMOVED***
    ...
    def median(self, numeric_only: bool = False) -> NDFrameT:
        ...
        >>> data = {'a': [1, 3, 5, 7, 7, 8, 3], 'b': [1, 4, 8, 4, 4, 2, 1]***REMOVED***
        ...
        ***REMOVED***
        if isinstance(obj, Series):
            ...
            if subset is not None:
                ...
                if clashing:
                    raise ValueError(
                        f"Keys {clashing***REMOVED*** in subset cannot be in "
                        "the groupby column keys."
        ***REMOVED***
                doesnt_exist = subsetted - unique_cols
                if doesnt_exist:
                    raise ValueError(
                        f"Keys {doesnt_exist***REMOVED*** in subset do not "
...
***REMOVED***.transform("sum")
        ...
        if self.as_index:
            ...
            if name in columns:
                raise ValueError(f"Column label '{name***REMOVED***' is duplicate of result column")
            result_series.name = name
    ...
    def sem(self, ddof: int = 1, numeric_only: bool = False) -> NDFrameT:
        ...
        if numeric_only and self.obj.ndim == 1 and not is_numeric_dtype(self.obj.dtype):
            raise TypeError(
                f"{type(self).__name__***REMOVED***.sem called with "
                f"numeric_only={numeric_only***REMOVED*** and dtype {self.obj.dtype***REMOVED***"
***REMOVED***
        return self._cython_agg_general(
            "sem",
...
***REMOVED***
    ...
    def ohlc(self) -> DataFrame:
        ...
        ...         2023: [3.4, 9.0, 7.2, 5.2, 8.8, 9.4, 8.2, 1.0]***REMOVED***
...
***REMOVED***
    ...
    def rolling(self, *args, **kwargs) -> RollingGroupby:
        ...
        method : str {'single', 'table'***REMOVED***, default 'single'
        ...
        ...                    'B': [1, 2, 3, 4],
        ...                    'C': [0.362, 0.227, 1.267, -0.562]***REMOVED***)
        >>> df
              A  B      C
        0     1  1  0.362
        1     1  2  0.227
    ...
    def bfill(self, limit: int | None = None):
        ...
        ...                    'B': [None, None, 5, None, 7]***REMOVED***, index=index)
        >>> df
                  A	    B
        Falcon	1.0	  NaN
        Falcon	NaN	  NaN
    ...
    def nth(self) -> GroupByNthSelector:
        ...
        dropna : {'any', 'all', None***REMOVED***, default None
        ...
        >>> df = pd.DataFrame({'A': [1, 1, 2, 1, 2],
        ...                    'B': [np.nan, 2, 3, 4, 5]***REMOVED***, columns=['A', 'B'])
        >>> g = df.groupby('A')
        >>> g.nth(0)
           A   B
        0  1 NaN
...
***REMOVED***
    ...
    ***REMOVED***
            ...
            if isinstance(vals, BaseMaskedArray) and is_numeric_dtype(vals.dtype):
                ...
                warnings.warn(
                    f"Allowing bool dtype in {type(self).__name__***REMOVED***.quantile is "
        ...
        def post_processor(
            ...
            if inference:
                ...
                if isinstance(orig_vals, BaseMaskedArray):
                    ...
                    if interpolation in {"linear", "midpoint"***REMOVED*** and not is_float_dtype(
                        orig_vals
        ***REMOVED***:
                ...
                ***REMOVED***
                    ...
                    and interpolation in {"linear", "midpoint"***REMOVED***
    ***REMOVED***:
    ...
    ***REMOVED***
    ...
    def ngroup(self, ascending: bool = True):
        ...
        Examples
        --------
        >>> df = pd.DataFrame({"color": ["red", None, "red", "blue", "blue", "red"]***REMOVED***)
        >>> df
           color
        0    red
        1   None
    ...
    def rank(
        ...
        ...     df[f'{method***REMOVED***_rank'] = df.groupby('group')['value'].rank(method)
        >>> df
...
***REMOVED***
    ...
    def cummin(
        ...
        **kwargs,
        ...
        turtle  6   6   9
        >>> df.groupby("a").groups
        {1: ['snake', 'rabbit'], 6: ['turtle']***REMOVED***
        >>> df.groupby("a").cummin()
                b   c
        snake   0   2
        rabbit  0   2
    ...
    ***REMOVED***
            ...
            if not is_integer(periods):
                raise TypeError(
                    f"Periods must be integer, but {periods***REMOVED*** is {type(periods)***REMOVED***."
    ***REMOVED***
            if suffix:
    ...
    ***REMOVED***
                ...
                shifted = obj._reindex_with_indexers(
                    {self.axis: (obj.axes[self.axis], res_indexer)***REMOVED***,
    ...
    ***REMOVED***
            ...
            if add_suffix:
                ...
                shifted = shifted.add_suffix(
                    f"{suffix***REMOVED***_{period***REMOVED***" if suffix else f"_{period***REMOVED***"
    ***REMOVED***
    ...
    def diff(
        ...
        if obj.ndim == 1:
            ...
            if len(to_coerce):
                shifted = shifted.astype({c: "float32" for c in to_coerce***REMOVED***)
...
***REMOVED***
    ...
    def sample(
        ...
        --------
        >>> df = pd.DataFrame(
        ...     {"a": ["red"] * 2 + ["blue"] * 2 + ["black"] * 2, "b": range(6)***REMOVED***
        ... )
        >>> df
               a  b
        0    red  0
...
***REMOVED***
    ...
    def _idxmax_idxmin(
        ...
        Parameters
        ----------
        how : {'idxmin', 'idxmax'***REMOVED***
            Whether to compute idxmin or idxmax.
        axis : {{0 or 'index', 1 or 'columns'***REMOVED******REMOVED***, default None
...
***REMOVED***
            ...
            if raise_err:
                raise ValueError(
                    f"Can't get {how***REMOVED*** of an empty group due to unobserved categories. "
                    "Specify observed=True in groupby instead."
    ***REMOVED***
        elif not skipna:
            if self._obj_with_exclusions.isna().any(axis=None):
                warnings.warn(
                    f"The behavior of {type(self).__name__***REMOVED***.{how***REMOVED*** with all-NA "
    ...
    ***REMOVED***
                ...
                if f"attempt to get {name***REMOVED*** of an empty sequence" in str(err):
                    raise ValueError(
                        f"Can't get {how***REMOVED*** of an empty group due to unobserved "
...
def get_groupby(
    ...
    if isinstance(obj, Series):
        ...
        raise TypeError(f"invalid type: {obj***REMOVED***")
...
_apply_groupings_depr = (
    "{***REMOVED***.{***REMOVED*** operated on the grouping columns. This behavior is deprecated, "
