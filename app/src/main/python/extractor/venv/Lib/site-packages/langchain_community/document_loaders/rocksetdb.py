...
class ColumnNotFoundError(Exception):
    ...
    def __init__(self, missing_key: str, query: str):
        super().__init__(f'Column "{missing_key***REMOVED***" not selected in query:\n{query***REMOVED***')
...
***REMOVED***
    ...
    def lazy_load(self) -> Iterator[Document]:
        ...
        ***REMOVED***,
                    metadata={col: doc[col] for col in self.metadata_keys***REMOVED***
                    if self.metadata_keys is not None
                    else doc,
    ***REMOVED***  # try to yield the Document
            except (
                KeyError
***REMOVED*** as e:  # either content_columns or metadata_columns is invalid
                raise ColumnNotFoundError(
                    e.args[0], self.query
    ***REMOVED***  # raise that the column isn't in the db schema
