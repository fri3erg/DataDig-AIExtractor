...
class TestFloyd:
    ...
    def test_floyd_warshall_predecessor_and_distance(self):
        ...
        assert path["s"]["v"] == "u"
        assert dist == {
            "y": {"y": 0, "x": 12, "s": 7, "u": 15, "v": 6***REMOVED***,
            "x": {"y": 2, "x": 0, "s": 9, "u": 3, "v": 4***REMOVED***,
            "s": {"y": 7, "x": 5, "s": 0, "u": 8, "v": 9***REMOVED***,
            "u": {"y": 2, "x": 2, "s": 9, "u": 0, "v": 1***REMOVED***,
            "v": {"y": 1, "x": 13, "s": 8, "u": 16, "v": 0***REMOVED***,
        ***REMOVED***
        ...
        inf = float("inf")
        assert dist == {
            "v": {"v": 0, "x": 5.0, "y": 6.0, "u": 7.0***REMOVED***,
            "x": {"x": 0, "u": 2.0, "v": inf, "y": inf***REMOVED***,
            "y": {"y": 0, "x": 5.0, "v": inf, "u": 7.0***REMOVED***,
            "u": {"u": 0, "v": inf, "x": inf, "y": inf***REMOVED***,
        ***REMOVED***
        assert path == {
            "v": {"x": "v", "y": "v", "u": "x"***REMOVED***,
            "x": {"u": "x"***REMOVED***,
            "y": {"x": "y", "u": "x"***REMOVED***,
        ***REMOVED***
