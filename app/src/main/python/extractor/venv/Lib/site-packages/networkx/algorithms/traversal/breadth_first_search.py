...
def bfs_predecessors(G, source, depth_limit=None, sort_neighbors=None):
    ...
    {1: 0, 2: 0, 3: 1, 4: 1, 5: 2, 6: 2***REMOVED***
    >>> M = nx.Graph()
...
def bfs_layers(G, sources):
    ...
    {0: [0, 4], 1: [1, 3], 2: [2]***REMOVED***
    >>> H = nx.Graph()
    >>> H.add_edges_from([(0, 1), (0, 2), (1, 3), (1, 4), (2, 5), (2, 6)])
    >>> dict(enumerate(nx.bfs_layers(H, [1])))
    {0: [1], 1: [0, 3, 4], 2: [2], 3: [5, 6]***REMOVED***
    >>> dict(enumerate(nx.bfs_layers(H, [1, 6])))
    {0: [1, 6], 1: [0, 3, 4, 2], 2: [5]***REMOVED***
    """
    if sources in G:
        sources = [sources]
    ...
    for source in current_layer:
        if source not in G:
            raise nx.NetworkXError(f"The node {source***REMOVED*** is not in the graph.")
...
def bfs_labeled_edges(G, sources):
    ...
    depth = {s: 0 for s in sources***REMOVED***
