...
***REMOVED***
    ...
    def run(self, query: str) -> str:
        ...
        try:
            ...
            docs = [
                f"Published: {result['Published']***REMOVED***\n"
                f"Title: {result['Title']***REMOVED***\n"
                f"Copyright Information: {result['Copyright Information']***REMOVED***\n"
...
***REMOVED***
            ...
            return f"PubMed exception: {ex***REMOVED***"
    ...
    def lazy_load(self, query: str) -> Iterator[dict]:
        ...
        url = (
            ...
            + "db=pubmed&term="
            + str({urllib.parse.quote(query)***REMOVED***)
            + f"&retmode=json&retmax={self.top_k_results***REMOVED***&usehistory=y"
        )
        ...
        while True:
            try:
                ...
                if e.code == 429 and retry < self.max_retry:
                    ...
                    print(
                        f"Too Many Requests, "
                        f"waiting for {self.sleep_time:.2f***REMOVED*** seconds..."
        ***REMOVED***
    ...
    def _parse_article(self, uid: str, text_dict: dict) -> dict:
        ...
        abstract_text = ar.get("Abstract", {***REMOVED***).get("AbstractText", [])
        summaries = [
            f"{txt['@Label']***REMOVED***: {txt['#text']***REMOVED***"
...
***REMOVED***
        ...
        a_d = ar.get("ArticleDate", {***REMOVED***)
        pub_date = "-".join(
        ...
        return {
            ...
            "Published": pub_date,
            "Copyright Information": ar.get("Abstract", {***REMOVED***).get(
