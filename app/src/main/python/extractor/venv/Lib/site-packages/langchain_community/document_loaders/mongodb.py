...
***REMOVED*** from e
        ...
        self.filter_criteria = filter_criteria or {***REMOVED***
    ...
    async def aload(self) -> List[Document]:
        ...
        if len(result) != total_docs:
            logger.warning(
                f"Only partial collection of documents returned. Loaded {len(result)***REMOVED*** "
                f"docs, expected {total_docs***REMOVED***."
***REMOVED***
