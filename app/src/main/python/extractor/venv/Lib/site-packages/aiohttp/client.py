...
***REMOVED***, "Only absolute URLs without path part are supported"
    ...
    ***REMOVED***
    ...
    def __init_subclass__(cls: Type["ClientSession"]) -> None:
        warnings.warn(
            "Inheritance class {***REMOVED*** from ClientSession "
    ...
    if DEBUG:
        ...
        def __setattr__(self, name: str, val: Any) -> None:
            if name not in self.ATTRS:
                warnings.warn(
                    "Setting custom ClientSession.{***REMOVED*** attribute "
    ...
    ***REMOVED***
    ...
    def __del__(self, _warnings: Any = warnings) -> None:
        if not self.closed:
            ...
            _warnings.warn(
                f"Unclosed client session {self!r***REMOVED***", ResourceWarning, **kwargs
***REMOVED***
            context = {"client_session": self, "message": "Unclosed client session"***REMOVED***
            ...
            ***REMOVED***:
                ...
                ***REMOVED***
                        ...
                        raise ServerTimeoutError(
                            "Connection timeout " "to host {***REMOVED***".format(url)
            ***REMOVED*** from exc
