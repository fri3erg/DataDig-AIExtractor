...
@nx._dispatch(edge_attrs={"weight": 0***REMOVED***)
...
@nx._dispatch(edge_attrs={"capacity": float("inf"), "weight": 0***REMOVED***)
def max_flow_min_cost(G, s, t, capacity="capacity", weight="weight"):
    ...
    >>> G.add_edges_from(
    ...     [
    ...         (1, 2, {"capacity": 12, "weight": 4***REMOVED***),
    ...         (1, 3, {"capacity": 20, "weight": 6***REMOVED***),
    ...         (2, 3, {"capacity": 6, "weight": -3***REMOVED***),
    ...         (2, 6, {"capacity": 14, "weight": 1***REMOVED***),
    ...         (3, 4, {"weight": 9***REMOVED***),
    ...         (3, 5, {"capacity": 10, "weight": 5***REMOVED***),
    ...         (4, 2, {"capacity": 19, "weight": 13***REMOVED***),
    ...         (4, 5, {"capacity": 4, "weight": 0***REMOVED***),
    ...         (5, 7, {"capacity": 28, "weight": 2***REMOVED***),
    ...         (6, 5, {"capacity": 11, "weight": 1***REMOVED***),
    ...         (6, 7, {"weight": 8***REMOVED***),
    ...         (7, 4, {"capacity": 6, "weight": 6***REMOVED***),
    ...     ]
    ... )
