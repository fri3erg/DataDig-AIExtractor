...
class Recorder:
    def __init__(self, parser: "Parser", ilabels: List[int], context: Context) -> None:
        ...
        self._points = {ilabel: stack_copy(self._start_point) for ilabel in ilabels***REMOVED***
...
class ParseError(Exception):
    ...
    def __init__(
        ...
        Exception.__init__(
            self, f"{msg***REMOVED***: type={type!r***REMOVED***, value={value!r***REMOVED***, context={context!r***REMOVED***"
        )
        self.msg = msg
        self.type = type
        self.value = value
