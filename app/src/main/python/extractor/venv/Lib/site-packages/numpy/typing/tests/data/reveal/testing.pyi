...
assert_type(np.testing.assert_equal({1***REMOVED***, {1***REMOVED***), None)
...
assert_type(np.testing.runstring("1 + 1", {***REMOVED***), Any)
assert_type(np.testing.runstring("int64() + 1", {"int64": np.int64***REMOVED***), Any)
