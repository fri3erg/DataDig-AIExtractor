...
class DataNode(Node):
    ...
    def data(self):
        return (
            f'{self._leading_whitespace***REMOVED***{self._stripped_data***REMOVED***'
            f'{self._trailing_whitespace***REMOVED***'
        )
    ...
    def write(self, doc):
        ...
        str_data = (
            f'{self._leading_whitespace***REMOVED***{" ".join(words)***REMOVED***'
            f'{self._trailing_whitespace***REMOVED***'
        )
        if str_data != '':
