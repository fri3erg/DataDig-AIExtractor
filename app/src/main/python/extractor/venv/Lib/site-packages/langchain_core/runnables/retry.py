    ...
    Here's an example that uses a RunnableLambda to raise an exception
        ...
        .. code-block:: python
            ...
            def foo(input) -> None:
                ...
                raise ValueError("Invoking foo failed. At time {time.time()***REMOVED***")
...
***REMOVED***
    ...
    Example:
        ...
        .. code-block:: python
            ...
            template = PromptTemplate.from_template("tell me a joke about {topic***REMOVED***.")
    ...
    def _patch_config(
        ...
        tag = "retry:attempt:{***REMOVED***".format(attempt) if attempt > 1 else None
    ...
    ***REMOVED***
    ...
    def _batch(
        ...
        **kwargs: Any,
        ...
        results_map: Dict[int, Output] = {***REMOVED***
