...
def _default_text_mapping(dim: int) -> Dict:
    return {
        "properties": {
            "text": {"type": "text"***REMOVED***,
            "vector": {"type": "dense_vector", "dims": dim***REMOVED***,
        ***REMOVED***
    ***REMOVED***
...
def _default_script_query(query_vector: List[float], filter: Optional[dict]) -> Dict:
    if filter:
        ...
        filter = {"match": {f"metadata.{key***REMOVED***.keyword": f"{value***REMOVED***"***REMOVED******REMOVED***
    else:
        filter = {"match_all": {***REMOVED******REMOVED***
    return {
        "script_score": {
            "query": filter,
            "script": {
...
***REMOVED***
    ...
    Example:
        .. code-block:: python
            ...
            elasticsearch_url = f"https://username:password@{elastic_host***REMOVED***:9243"
            elastic_vector_search = ElasticVectorSearch(
...
***REMOVED***
        ...
        _ssl_verify = ssl_verify or {***REMOVED***
        try:
...
***REMOVED***
            ...
            raise ValueError(
                f"Your elasticsearch client string is mis-formatted. Got error: {e***REMOVED*** "
***REMOVED***
    ...
    def get_user_agent() -> str:
        ...
        return f"langchain-py-dvs/{__version__***REMOVED***"
    ...
    ***REMOVED***
    ...
    def create_index(self, client: Any, index_name: str, mapping: Dict) -> None:
        ...
        if version_num >= 8:
            ...
            client.indices.create(index=index_name, body={"mappings": mapping***REMOVED***)
    ...
    def client_search(
        ...
        if version_num >= 8:
            ...
            response = client.search(
                index=index_name, body={"query": script_query, "size": size***REMOVED***
***REMOVED***
        return response
...
class ElasticKnnSearch(VectorStore):
    ...
    Usage:
        ...
        [(Document(page_content='Hello world!', metadata={***REMOVED***), 0.9)]
    """
        ...
        docs_and_scores = [
            (
                Document(
                    ...
                    metadata=hit["fields"] if fields else {***REMOVED***,
    ***REMOVED***,
                hit["_score"],
***REMOVED***
            for hit in hits
    ...
    def knn_hybrid_search(
        ...
        match_query_body = {
            "match": {self.query_field: {"query": query, "boost": query_boost***REMOVED******REMOVED***
        ***REMOVED***
    ...
    def add_texts(
        ...
        **kwargs: Any,
        ...
        for text, vector in zip(texts, embeddings):
            body.extend(
                [
                    {"index": {"_index": self.index_name***REMOVED******REMOVED***,
                    {"text": text, "vector": vector***REMOVED***,
                ]
***REMOVED***
