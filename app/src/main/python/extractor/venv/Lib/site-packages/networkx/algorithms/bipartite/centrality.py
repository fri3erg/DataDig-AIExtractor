...
def degree_centrality(G, nodes):
    ...
    --------
    >>> G = nx.wheel_graph(5)
    >>> top_nodes = {0, 1, 2***REMOVED***
    >>> nx.bipartite.degree_centrality(G, nodes=top_nodes)
    {0: 2.0, 1: 1.5, 2: 1.5, 3: 1.0, 4: 1.0***REMOVED***
    ...
    .. math::
        ...
        d_{v***REMOVED*** = \frac{deg(v)***REMOVED***{m***REMOVED***, \mbox{for***REMOVED*** v \in U ,

        d_{v***REMOVED*** = \frac{deg(v)***REMOVED***{n***REMOVED***, \mbox{for***REMOVED*** v \in V ,
    ...
    bottom = set(G) - top
    s = 1.0 / len(bottom)
    centrality = {n: d * s for n, d in G.degree(top)***REMOVED***
    s = 1.0 / len(top)
    centrality.update({n: d * s for n, d in G.degree(bottom)***REMOVED***)
    return centrality
...
def betweenness_centrality(G, nodes):
    ...
    .. math::
       ...
       \frac{1***REMOVED***{2***REMOVED*** [m^2 (s + 1)^2 + m (s + 1)(2t - s - 1) - t (2s - t + 3)] ,
    ...
    .. math::
        ...
        \frac{1***REMOVED***{2***REMOVED*** [n^2 (p + 1)^2 + n (p + 1)(2r - p - 1) - r (2p - r + 3)] ,
    ...
    --------
    >>> G = nx.cycle_graph(4)
    >>> top_nodes = {1, 2***REMOVED***
    >>> nx.bipartite.betweenness_centrality(G, nodes=top_nodes)
    {0: 0.25, 1: 0.25, 2: 0.25, 3: 0.25***REMOVED***
...
def closeness_centrality(G, nodes, normalized=True):
    ...
    {0: 1.5, 1: 1.2, 2: 1.2, 3: 1.0, 4: 1.0***REMOVED***
    ...
    .. math::
        ...
        c_{v***REMOVED*** = \frac{m + 2(n - 1)***REMOVED***{d***REMOVED***, \mbox{for***REMOVED*** v \in U,

        c_{v***REMOVED*** = \frac{n + 2(m - 1)***REMOVED***{d***REMOVED***, \mbox{for***REMOVED*** v \in V,
