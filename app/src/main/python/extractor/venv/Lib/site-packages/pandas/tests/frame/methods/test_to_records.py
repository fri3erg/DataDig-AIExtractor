...
class TestDataFrameToRecords:
    ...
    def test_to_records_dt64tz_column(self):
        ...
        df = DataFrame({"A": date_range("2012-01-01", "2012-01-02", tz="US/Eastern")***REMOVED***)
    ...
    def test_to_records_with_unicode_index(self):
        ...
        result = DataFrame([{"a": "x", "b": "y"***REMOVED***]).set_index("a").to_records()
    ...
    def test_to_records_index_dtype(self):
        ...
        expected = np.rec.array(
            ...
            dtype=[
                ("1", f"{tm.ENDIAN***REMOVED***M8[ns]"),
                ("2", f"{tm.ENDIAN***REMOVED***M8[ns]"),
                ("3", f"{tm.ENDIAN***REMOVED***M8[ns]"),
            ],
        )
    ...
    def test_to_records_with_unicode_column_names(self):
        ...
        result = DataFrame(data={"accented_name_é": [1.0]***REMOVED***).to_records()

        # Note that numpy allows for unicode field names but dtypes need
        # to be specified using dictionary instead of list of tuples.
        expected = np.rec.array(
            [(0, 1.0)],
            dtype={"names": ["index", "accented_name_é"], "formats": ["=i8", "=f8"]***REMOVED***,
        )
        tm.assert_almost_equal(result, expected)
        ...
        [
            ...
            (
                ...
                np.rec.array(
                    ...
                    dtype=[
                        ("index", f"{tm.ENDIAN***REMOVED***i8"),
                        ("A", f"{tm.ENDIAN***REMOVED***i8"),
                        ("B", f"{tm.ENDIAN***REMOVED***f8"),
                        ("C", "O"),
                    ],
    ***REMOVED***,
***REMOVED***,
...
***REMOVED***,
            ...
            (
                {"column_dtypes": f"{tm.ENDIAN***REMOVED***U4"***REMOVED***,
                np.rec.array(
                    [("0", "1", "0.2", "a"), ("1", "2", "1.5", "bc")],
                    dtype=[
                        ("index", f"{tm.ENDIAN***REMOVED***i8"),
                        ("A", f"{tm.ENDIAN***REMOVED***U4"),
                        ("B", f"{tm.ENDIAN***REMOVED***U4"),
                        ("C", f"{tm.ENDIAN***REMOVED***U4"),
                    ],
    ***REMOVED***,
***REMOVED***,
            # Index dtype applied across the board. Columns unaffected.
            (
                {"index_dtypes": f"{tm.ENDIAN***REMOVED***U1"***REMOVED***,
                np.rec.array(
                    [("0", 1, 0.2, "a"), ("1", 2, 1.5, "bc")],
                    dtype=[
                        ("index", f"{tm.ENDIAN***REMOVED***U1"),
                        ("A", f"{tm.ENDIAN***REMOVED***i8"),
                        ("B", f"{tm.ENDIAN***REMOVED***f8"),
                        ("C", "O"),
                    ],
...
***REMOVED***,
            ...
            (
                {"column_dtypes": str***REMOVED***,
                np.rec.array(
                    [("0", "1", "0.2", "a"), ("1", "2", "1.5", "bc")],
                    dtype=[
                        ("index", f"{tm.ENDIAN***REMOVED***i8"),
                        ("A", f"{tm.ENDIAN***REMOVED***U"),
                        ("B", f"{tm.ENDIAN***REMOVED***U"),
                        ("C", f"{tm.ENDIAN***REMOVED***U"),
                    ],
    ***REMOVED***,
***REMOVED***,
            # Pass in a dtype instance.
            (
                {"column_dtypes": np.dtype(np.str_)***REMOVED***,
                np.rec.array(
                    [("0", "1", "0.2", "a"), ("1", "2", "1.5", "bc")],
                    dtype=[
                        ("index", f"{tm.ENDIAN***REMOVED***i8"),
...
***REMOVED***,
            ...
            (
                {"index_dtypes": {0: "int16"***REMOVED******REMOVED***,
                np.rec.array(
                    [(0, 1, 0.2, "a"), (1, 2, 1.5, "bc")],
                    dtype=[
                        ("index", "i2"),
...
***REMOVED***,
            ...
            (
                {"index": False, "index_dtypes": f"{tm.ENDIAN***REMOVED***U2"***REMOVED***,
                np.rec.array(
                    [(1, 0.2, "a"), (2, 1.5, "bc")],
                    dtype=[
                        ("A", f"{tm.ENDIAN***REMOVED***i8"),
...
***REMOVED***,
            ...
            (
                {"index_dtypes": {0: "int16", "not-there": "float32"***REMOVED******REMOVED***,
                np.rec.array(
                    [(0, 1, 0.2, "a"), (1, 2, 1.5, "bc")],
                    dtype=[
                        ("index", "i2"),
...
***REMOVED***,
            ...
            (
                {"column_dtypes": {"A": np.int8, "B": np.float32***REMOVED******REMOVED***,
                np.rec.array(
                    [("0", "1", "0.2", "a"), ("1", "2", "1.5", "bc")],
                    dtype=[
                        ("index", f"{tm.ENDIAN***REMOVED***i8"),
...
***REMOVED***,
            ...
            (
                {"column_dtypes": {"A": np.dtype("int8"), "B": np.dtype("float32")***REMOVED******REMOVED***,
                np.rec.array(
                    [("0", "1", "0.2", "a"), ("1", "2", "1.5", "bc")],
                    dtype=[
                        ("index", f"{tm.ENDIAN***REMOVED***i8"),
...
***REMOVED***,
            ...
            (
                {
                    "column_dtypes": {"A": np.int8, "B": np.float32***REMOVED***,
                    "index_dtypes": f"{tm.ENDIAN***REMOVED***U2",
                ***REMOVED***,
                np.rec.array(
                    [("0", "1", "0.2", "a"), ("1", "2", "1.5", "bc")],
                    dtype=[
                        ("index", f"{tm.ENDIAN***REMOVED***U2"),
                        ("A", "i1"),
                        ("B", f"{tm.ENDIAN***REMOVED***f4"),
                        ("C", "O"),
                    ],
...
***REMOVED***,
            # Invalid dype values.
            (
                {"index": False, "column_dtypes": []***REMOVED***,
                (ValueError, "Invalid dtype \\[\\] specified for column A"),
***REMOVED***,
            (
                {"index": False, "column_dtypes": {"A": "int32", "B": 5***REMOVED******REMOVED***,
...
***REMOVED***,
            ...
            (
                {
                    "index": False,
                    "column_dtypes": {"A": "int32", "B": CategoricalDtype(["a", "b"])***REMOVED***,
                ***REMOVED***,
                (ValueError, "Invalid dtype category specified for column B"),
***REMOVED***,
            # Check that bad types raise
            (
                {"index": False, "column_dtypes": {"A": "int32", "B": "foo"***REMOVED******REMOVED***,
...
***REMOVED***,
    ...
    def test_to_records_dtype(self, kwargs, expected):
        # see GH#18146
        df = DataFrame({"A": [1, 2], "B": [0.2, 1.5], "C": ["a", "bc"]***REMOVED***)
    ...
    ***REMOVED***.set_index(["a", "b"]),
                {"column_dtypes": "float64", "index_dtypes": {0: "int32", 1: "int8"***REMOVED******REMOVED***,
                np.rec.array(
                    [(1, 2, 3.0), (4, 5, 6.0), (7, 8, 9.0)],
                    dtype=[
                        ("a", f"{tm.ENDIAN***REMOVED***i4"),
                        ("b", "i1"),
                        ("c", f"{tm.ENDIAN***REMOVED***f8"),
                    ],
    ***REMOVED***,
***REMOVED***,
    ...
    ***REMOVED***,
                {
                    "column_dtypes": {0: f"{tm.ENDIAN***REMOVED***U1", 2: "float32"***REMOVED***,
                    "index_dtypes": "float32",
                ***REMOVED***,
                np.rec.array(
                    [(0.0, "1", 2, 3.0), (1.0, "4", 5, 6.0), (2.0, "7", 8, 9.0)],
                    dtype=[
                        ("index", f"{tm.ENDIAN***REMOVED***f4"),
                        ("('a', 'd')", f"{tm.ENDIAN***REMOVED***U1"),
                        ("('b', 'e')", f"{tm.ENDIAN***REMOVED***i8"),
                        ("('c', 'f')", f"{tm.ENDIAN***REMOVED***f4"),
                    ],
    ***REMOVED***,
***REMOVED***,
    ...
    ***REMOVED***,
                {
                    ...
                    "index_dtypes": {0: f"{tm.ENDIAN***REMOVED***U2", 1: "int8"***REMOVED***,
                ***REMOVED***,
                np.rec.array(
                    [
                        ("d", -4, 1.0, 2.0, 3.0),
                    ...
                    dtype=[
                        ("c", f"{tm.ENDIAN***REMOVED***U2"),
                        ("d", "i1"),
                        ("('a', 'd')", f"{tm.ENDIAN***REMOVED***f8"),
                        ("('b', 'e')", f"{tm.ENDIAN***REMOVED***f8"),
                        ("('c', 'f')", f"{tm.ENDIAN***REMOVED***f8"),
                    ],
    ***REMOVED***,
***REMOVED***,
        ],
    ...
    def test_to_records_datetimeindex_with_tz(self, tz):
        ...
        df = DataFrame({"datetime": dr***REMOVED***, index=dr)
