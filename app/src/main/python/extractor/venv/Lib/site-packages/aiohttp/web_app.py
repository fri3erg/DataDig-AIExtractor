...
***REMOVED***
        ...
        self._state: Dict[Union[AppKey[Any], str], object] = {***REMOVED***
        self._frozen = False
    ...
    def __init_subclass__(cls: Type["Application"]) -> None:
        warnings.warn(
            "Inheritance class {***REMOVED*** from web.Application "
    ...
    if DEBUG:  # pragma: no cover
        ...
        def __setattr__(self, name: str, val: Any) -> None:
            if name not in self.ATTRS:
                warnings.warn(
                    "Setting custom web.Application.{***REMOVED*** attribute "
        ...
        **kwargs: Any,
        ...
        if not issubclass(access_log_class, AbstractAccessLogger):
            raise TypeError(
                ...
                "aiohttp.abc.AbstractAccessLogger, got {***REMOVED***".format(access_log_class)
***REMOVED***
    ...
    def _prepare_middleware(self) -> Iterator[Tuple[Middleware, bool]]:
        for m in reversed(self._middlewares):
            if getattr(m, "__middleware_version__", None) == 1:
                ...
                warnings.warn(
                    'old-style middleware "{!r***REMOVED***" deprecated, ' "see #2252".format(m),
                    DeprecationWarning,
                    stacklevel=2,
    ***REMOVED***
                yield m, False
        ...
        if debug:  # pragma: no cover
            if not isinstance(match_info, AbstractMatchInfo):
                raise TypeError(
                    ...
                    "instance, not {!r***REMOVED***".format(match_info)
    ***REMOVED***
    ...
    def __repr__(self) -> str:
        return f"<Application 0x{id(self):x***REMOVED***>"
    ...
    async def _on_cleanup(self, app: Application) -> None:
        ...
        for it in reversed(self._exits):
            try:
                ...
                errors.append(RuntimeError(f"{it!r***REMOVED*** has more than one 'yield'"))
        if errors:
            if len(errors) == 1:
                raise errors[0]
            else:
