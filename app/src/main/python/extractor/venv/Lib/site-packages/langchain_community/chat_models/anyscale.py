...
class ChatAnyscale(ChatOpenAI):
    ...
    def lc_secrets(self) -> Dict[str, str]:
        return {"anyscale_api_key": "ANYSCALE_API_KEY"***REMOVED***
...
***REMOVED*** from e
        ...
        models_url = f"{anyscale_api_base***REMOVED***/models"
        models_response = requests.get(
            models_url,
            headers={
                "Authorization": f"Bearer {anyscale_api_key***REMOVED***",
            ***REMOVED***,
        )
...
***REMOVED*** from exc
        ...
        if model_name not in available_models:
            raise ValueError(
                f"Model name {model_name***REMOVED*** not found in available models: "
                f"{available_models***REMOVED***.",
***REMOVED***
