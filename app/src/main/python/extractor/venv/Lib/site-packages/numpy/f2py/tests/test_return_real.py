...
class TestReturnReal(util.F2PyTest):
    def check_function(self, t, tname):
        ...
        pytest.raises(Exception, t, {***REMOVED***)
...
usercode \'\'\'
float t4(float value) { return value; ***REMOVED***
void s4(float *t4, float value) { *t4 = value; ***REMOVED***
double t8(double value) { return value; ***REMOVED***
void s8(double *t8, double value) { *t8 = value; ***REMOVED***
\'\'\'
interface
  function t4(value)
