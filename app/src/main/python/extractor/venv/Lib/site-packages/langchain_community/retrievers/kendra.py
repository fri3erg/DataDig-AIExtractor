...
def combined_text(item: "ResultItem") -> str:
    ...
    if title:
        text += f"Document Title: {title***REMOVED***\n"
...
class ResultItem(BaseModel, ABC, extra=Extra.allow):  # type: ignore[call-arg]
    ...
    def get_document_attributes_dict(self) -> Dict[str, DocumentAttributeValueType]:
        ...
        return {attr.Key: attr.Value.value for attr in (self.DocumentAttributes or [])***REMOVED***
...
class QueryResultItem(ResultItem):
    ...
    def get_additional_metadata(self) -> dict:
        additional_metadata = {"type": self.Type***REMOVED***
...
***REMOVED***
    ...
    def validate_top_k(cls, value: int) -> int:
        if value < 0:
            raise ValueError(f"top_k ({value***REMOVED***) cannot be negative.")
        return value
