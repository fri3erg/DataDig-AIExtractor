...
class Graph:
    ...
    def add_edge(self, source: Node, target: Node) -> Edge:
        ...
        if source.id not in self.nodes:
            raise ValueError(f"Source node {source.id***REMOVED*** not in graph")
        if target.id not in self.nodes:
            raise ValueError(f"Target node {target.id***REMOVED*** not in graph")
    ...
    def first_node(self) -> Optional[Node]:
        ...
        targets = {edge.target for edge in self.edges***REMOVED***
        found: List[Node] = []
    ...
    def last_node(self) -> Optional[Node]:
        ...
        """
        sources = {edge.source for edge in self.edges***REMOVED***
        found: List[Node] = []
        for node in self.nodes.values():
...
***REMOVED***:
    ...
    def draw_ascii(self) -> str:
        ...
        ***REMOVED***:
        ...
        return draw(
            {node.id: node_data(node) for node in self.nodes.values()***REMOVED***,
