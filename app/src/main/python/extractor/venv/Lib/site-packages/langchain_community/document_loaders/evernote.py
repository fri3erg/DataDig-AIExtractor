...
***REMOVED***
        ...
        return [
            Document(
                ...
                metadata={"source": self.file_path***REMOVED***,
***REMOVED***
        ]
...
***REMOVED*** from e
    ...
    def _parse_note(note: List, prefix: Optional[str] = None) -> dict:
        note_dict: Dict[str, Any] = {***REMOVED***
        resources = []

        def add_prefix(element_tag: str) -> str:
            if prefix is None:
                return element_tag
            return f"{prefix***REMOVED***.{element_tag***REMOVED***"
        ...
        for elem in note:
            if elem.tag == "content":
                ...
                additional_attributes = EverNoteLoader._parse_note(
                    elem, elem.tag
    ***REMOVED***  # Recursively enter the note-attributes tag
        ...
        return {add_prefix(key): value for key, value in note_dict.items()***REMOVED***
