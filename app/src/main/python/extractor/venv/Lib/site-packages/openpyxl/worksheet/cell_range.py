...
class CellRange(Serialisable):
    ...
    def __init__(self, range_string=None, min_col=None, min_row=None,
        ...
        if min_col > max_col:
            fmt = "{max_col***REMOVED*** must be greater than {min_col***REMOVED***"
            raise ValueError(fmt.format(min_col=min_col, max_col=max_col))
        if min_row > max_row:
            fmt = "{max_row***REMOVED*** must be greater than {min_row***REMOVED***"
    ...
    def __repr__(self):
        fmt = u"<{cls***REMOVED*** {coord***REMOVED***>"
        if self.title:
            fmt = u"<{cls***REMOVED*** {title!r***REMOVED***!{coord***REMOVED***>"
    ...
    def __str__(self):
        ...
        title = self.title
        if title:
            fmt = u"{title***REMOVED***!{coord***REMOVED***"
    ...
    def shift(self, col_shift=0, row_shift=0):
        ...
        if (self.min_col + col_shift <= 0
            ...
            raise ValueError("Invalid shift value: col_shift={0***REMOVED***, row_shift={1***REMOVED***".format(col_shift, row_shift))
    ...
    def intersection(self, other):
        ...
        if self.isdisjoint(other):
            raise ValueError("Range {0***REMOVED*** doesn't intersect {0***REMOVED***".format(self, other))
    ...
    def size(self):
        ...
        return {'columns':cols, 'rows':rows***REMOVED***
...
class MultiCellRange(Strict):
    ...
    def __repr__(self):
        ...
        return f"<{self.__class__.__name__***REMOVED*** [{ranges***REMOVED***]>"
    ...
    def __copy__(self):
        ranges = {copy(r) for r in self.ranges***REMOVED***
