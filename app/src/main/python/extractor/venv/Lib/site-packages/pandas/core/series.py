...
_shared_doc_kwargs = {
    "axes": "index",
    "klass": "Series",
    "axes_single_arg": "{0 or 'index'***REMOVED***",
    "axis": """axis : {0 or 'index'***REMOVED***
...
def _coerce_method(converter):
    ...
    def wrapper(self):
        if len(self) == 1:
            warnings.warn(
                f"Calling {converter.__name__***REMOVED*** on a single element Series is "
                "deprecated and will raise a TypeError in the future. "
                f"Use {converter.__name__***REMOVED***(ser.iloc[0]) instead",
                FutureWarning,
                stacklevel=find_stack_level(),
***REMOVED***
            return converter(self.iloc[0])
        raise TypeError(f"cannot convert the series to {converter***REMOVED***")

    wrapper.__name__ = f"__{converter.__name__***REMOVED***__"
    return wrapper
...
class Series(base.IndexOpsMixin, NDFrame):  # type: ignore[misc]
    ...
    _internal_names_set = {"index", "name"***REMOVED*** | NDFrame._internal_names_set
    _accessors = {"dt", "cat", "str", "sparse"***REMOVED***
    _hidden_attrs = (
...
***REMOVED***
    ...
    ***REMOVED***
    ...
    def _init_dict(
        ...
        # Looking for NaN in dict doesn't work ({np.nan : 1***REMOVED***[float('nan')]
    ...
    def name(self, value: Hashable) -> None:
        validate_all_hashable(value, error_name=f"{type(self).__name__***REMOVED***.name")
...
***REMOVED***:
    ...
    ***REMOVED***
    ...
    def _set_labels(self, key, value, warn: bool = True) -> None:
        ...
        mask = indexer == -1
        if mask.any():
            raise KeyError(f"{key[mask]***REMOVED*** not in index")
    ...
    ***REMOVED***.__finalize__(self, method="reset_index")
        elif inplace:
            raise TypeError(
    ...
    def to_string(
        ...
        if not isinstance(result, str):
            raise AssertionError(
                ...
                f"of result is {repr(type(result).__name__)***REMOVED***"
***REMOVED***
    ...
    def to_markdown(
        ...
        **kwargs,
        ...
        """
        Print {klass***REMOVED*** in Markdown-friendly format.
        ...
        **kwargs
        ...
        -------
        str
            {klass***REMOVED*** in Markdown-friendly format.
    ...
    def items(self) -> Iterable[tuple[Hashable, Any]]:
        ...
        ...     print(f"Index : {index***REMOVED***, Value : {value***REMOVED***")
        Index : 0, Value : A
        Index : 1, Value : B
        Index : 2, Value : C
        """
    ...
    def to_dict(
        ...
        """
        Convert Series to {label -> value***REMOVED*** dict or dict-like object.
        ...
        >>> s = pd.Series([1, 2, 3, 4])
        >>> s.to_dict()
        {0: 1, 1: 2, 2: 3, 3: 4***REMOVED***
        >>> from collections import OrderedDict, defaultdict
        >>> s.to_dict(into=OrderedDict)
        OrderedDict([(0, 1), (1, 2), (2, 3), (3, 4)])
        >>> dd = defaultdict(list)
        >>> s.to_dict(into=dd)
        defaultdict(<class 'list'>, {0: 1, 1: 2, 2: 3, 3: 4***REMOVED***)
        """
        # GH16122
...
***REMOVED***
    ...
    def diff(self, periods: int = 1) -> Series:
        ...
        Calculates the difference of a {klass***REMOVED*** element compared with another
        element in the {klass***REMOVED*** (default is element in previous row).
        ...
        See Also
        --------
        {klass***REMOVED***.pct_change: Percent change over given number of periods.
        {klass***REMOVED***.shift: Shift index by desired number of periods with an
            optional time freq.
        {other_klass***REMOVED***.diff: First discrete difference of object.

        Notes
        -----
        For boolean dtypes, this uses :meth:`operator.xor` rather than
        :meth:`operator.sub`.
        The result is calculated according to current dtype in {klass***REMOVED***,
...
***REMOVED***.__finalize__(self, method="dot")
    ...
    def combine(
        ...
        >>> s1 = pd.Series({'falcon': 330.0, 'eagle': 160.0***REMOVED***)
        >>> s1
        falcon    330.0
        eagle     160.0
        dtype: float64
        >>> s2 = pd.Series({'falcon': 345.0, 'eagle': 200.0, 'duck': 30.0***REMOVED***)
        >>> s2
        falcon    345.0
        eagle     200.0
        duck       30.0
    ...
    def combine_first(self, other) -> Series:
        ...
        >>> s1 = pd.Series({'falcon': np.nan, 'eagle': 160.0***REMOVED***)
        >>> s2 = pd.Series({'eagle': 200.0, 'duck': 30.0***REMOVED***)
        >>> s1.combine_first(s2)
        duck       30.0
        eagle     160.0
        falcon      NaN
...
***REMOVED***
        ...
        if is_list_like(ascending):
            ...
            if len(ascending) != 1:
                raise ValueError(
                    f"Length of ascending ({len(ascending)***REMOVED***) must be 1 for Series"
    ***REMOVED***
        ...
        if na_position not in ["first", "last"]:
            raise ValueError(f"invalid na_position: {na_position***REMOVED***")
    ...
    def argsort(
        ...
        axis : {0 or 'index'***REMOVED***
            Unused. Parameter needed for compatibility with DataFrame.
        kind : {'mergesort', 'quicksort', 'heapsort', 'stable'***REMOVED***, default 'quicksort'
...
***REMOVED***
    ...
    def nlargest(
        ...
        ...                         "Anguilla": 11300, "Montserrat": 5200***REMOVED***
    ...
    def swaplevel(
        ...
        -------
        {klass***REMOVED***
            {klass***REMOVED*** with levels swapped in MultiIndex.
    ...
    def map(
        ...
        >>> s.map({'cat': 'kitten', 'dog': 'puppy'***REMOVED***)
        0   kitten
        1    puppy
        2      NaN
        3      NaN
        ...
        >>> s.map('I am a {***REMOVED***'.format, na_action='ignore')
        0     I am a cat
        1     I am a dog
        2            NaN
        3  I am a rabbit
    ...
    def rename(
        ...
        *,
        ...
        4    3
        dtype: int64
        >>> s.rename({1: 3, 2: 5***REMOVED***)  # mapping, changes labels
        0    1
        3    2
        5    3
        dtype: int64
...
***REMOVED***
    ...
    def case_when(
        ...
        if not isinstance(caselist, list):
            raise TypeError(
                f"The caselist argument should be a list; instead got {type(caselist)***REMOVED***"
***REMOVED***
...
***REMOVED***
        ...
        for num, entry in enumerate(caselist):
            if not isinstance(entry, tuple):
                raise TypeError(
                    f"Argument {num***REMOVED*** must be a tuple; instead got {type(entry)***REMOVED***."
    ***REMOVED***
            if len(entry) != 2:
                raise ValueError(
                    f"Argument {num***REMOVED*** must have length 2; "
                    "a condition and replacement; "
                    f"instead got length {len(entry)***REMOVED***."
    ***REMOVED***
        caselist = [
            (
...
***REMOVED***
    ...
    ***REMOVED***
                ...
                raise ValueError(
                    f"Failed to apply condition{position***REMOVED*** and replacement{position***REMOVED***."
    ***REMOVED*** from error
        return default
    ...
    def to_timestamp(
        ...
        if not isinstance(self.index, PeriodIndex):
            raise TypeError(f"unsupported Type {type(self.index).__name__***REMOVED***")
        ...
        **kwds,
        ...
        if isinstance(delegate, ExtensionArray):
            ...
            if numeric_only and self.dtype.kind not in "iufcb":
                ...
                raise TypeError(
                    f"Series.{name***REMOVED*** does not allow {kwd_name***REMOVED***={numeric_only***REMOVED*** "
