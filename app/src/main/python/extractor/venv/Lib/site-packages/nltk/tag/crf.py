...
class CRFTagger(TaggerI):
    ...
    def __init__(self, feature_func=None, verbose=False, training_opt={***REMOVED***):
        """
        ...
        Set of possible training options (using LBFGS training algorithm).
            ...
            :'delta': The threshold for the stopping criterion; an L-BFGS iteration stops when the
                improvement of the log likelihood over the last ${period***REMOVED*** iterations is no greater than this threshold.
    ...
    def _get_features(self, tokens, idx):
        ...
        # Punctuation
        punc_cat = {"Pc", "Pd", "Ps", "Pe", "Pi", "Pf", "Po"***REMOVED***
