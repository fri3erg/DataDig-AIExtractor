...
class ChartMatrixView:
        ...
        for i in range(N):
            for j in range(i, N):
                if cell_edges[i][j] == 0:
                    ...
                    color = "#00{:02x***REMOVED***{:02x***REMOVED***".format(
    ...
    def add_callback(self, event, func):
        self._callbacks.setdefault(event, {***REMOVED***)[func] = 1
...
***REMOVED***
    ...
    def print_selection(self, *e):
        ...
        if self._selection is None:
            ...
            c["scrollregion"] = f"0 0 {x2 - x1 + 20***REMOVED*** {y2 - y1 + 20***REMOVED***"
            self._cframe.print_to_file()
...
class ChartComparer:
    ...
    ***REMOVED***
    ...
    def __init__(self, *chart_filenames):
        ...
        self._charts = {"None": self._emptychart***REMOVED***
    ...
    def save_chart_dialog(self, *args):
        ...
        try:
            ...
            showerror("Error Saving Chart", f"Unable to open file: {filename!r***REMOVED***\n{e***REMOVED***")
    ...
    def load_chart_dialog(self, *args):
        ...
        try:
            ...
            showerror("Error Loading Chart", f"Unable to open file: {filename!r***REMOVED***\n{e***REMOVED***")
    ...
    def _update(self, operator, out_chart):
        ...
        self._out_label["text"] = "{***REMOVED*** {***REMOVED*** {***REMOVED***".format(
            self._left_name,
            self._operator,
            self._right_name,
        )
