...
def one(iterable, too_short=None, too_long=None):
    ...
    try:
        ...
        msg = (
            'Expected exactly one item in iterable, but got {!r***REMOVED***, {!r***REMOVED***, '
    ...
    *too_long* will be called with `n + 1`.
    ...
    if too_short is None:
        too_short = lambda item_count: raise_(
            ValueError,
            'Too few items in iterable (got {***REMOVED***)'.format(item_count),
        )

    if too_long is None:
        too_long = lambda item_count: raise_(
            ValueError,
            'Too many items in iterable (got at least {***REMOVED***)'.format(item_count),
        )
...
def unique_to_each(*iterables):
    ...
    dependencies::
        ...
        {'pkg_1': {'A', 'B'***REMOVED***, 'pkg_2': {'B', 'C'***REMOVED***, 'pkg_3': {'B', 'D'***REMOVED******REMOVED***
    ...
    ``pkg_2``, and ``D`` is only needed for ``pkg_3``::
        ...
        >>> unique_to_each({'A', 'B'***REMOVED***, {'B', 'C'***REMOVED***, {'B', 'D'***REMOVED***)
        [['A'], ['C'], ['D']]
    ...
    uniques = {element for element in counts if counts[element] == 1***REMOVED***
...
class bucket:
    ...
    checked against it.
        ...
        >>> validator = lambda x: x in {1, 3, 5, 7, 9***REMOVED***  # Odd digits only
...
def side_effect(func, iterable, chunk_size=None, before=None, after=None):
    ...
    *before* and *after* are optional functions that take no arguments. They
    ...
    Emitting a status message:
        ...
        >>> func = lambda item: print('Received {***REMOVED***'.format(item))
...
class UnequalIterablesError(ValueError):
    def __init__(self, details=None):
        ...
        if details is not None:
            msg += (': index 0 has length {***REMOVED***; index {***REMOVED*** has length {***REMOVED***').format(
                *details
***REMOVED***
    ...
    def __init__(self, *args):
        ...
        if argc == 1:
            ...
            raise TypeError(
                ...
                '1 argument, got {***REMOVED***'.format(argc)
***REMOVED***
        else:
            raise TypeError(
                'numeric_range expected at most '
                '3 arguments, got {***REMOVED***'.format(argc)
***REMOVED***
    ...
    def __getitem__(self, key):
        if isinstance(key, int):
            ...
            raise TypeError(
                ...
                'integers or slices, not {***REMOVED***'.format(type(key).__name__)
***REMOVED***
    ...
    def __repr__(self):
        if self._step == 1:
            return "numeric_range({***REMOVED***, {***REMOVED***)".format(
                repr(self._start), repr(self._stop)
***REMOVED***
        else:
            return "numeric_range({***REMOVED***, {***REMOVED***, {***REMOVED***)".format(
...
***REMOVED***
    ...
    def index(self, value):
        ...
        raise ValueError("{***REMOVED*** is not in numeric range".format(value))
...
def lstrip(iterable, pred):
    ...
    For example, to remove a set of items from the start of an iterable:
        ...
        >>> pred = lambda x: x in {None, False, ''***REMOVED***
...
class SequenceView(Sequence):
    ...
    def __repr__(self):
        return '{***REMOVED***({***REMOVED***)'.format(self.__class__.__name__, repr(self._target))
...
def map_if(iterable, pred, func, func_else=lambda x: x):
    ...
    *pred*, *func*, and *func_else* should each be functions that accept
    ...
    ... lambda x: f'{sqrt(x):.2f***REMOVED***', lambda x: None))
    ...
    * Provide *wait_seconds* to adjust how frequently the it is polled for
    ...
    def _reader(self):
        ...
        self._future = self._executor.submit(
            self._func, **{self._callback_kwd: callback***REMOVED***
        )
