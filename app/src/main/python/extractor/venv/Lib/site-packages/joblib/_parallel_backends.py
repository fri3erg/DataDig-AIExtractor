        ...
        if (batch_duration > 0 and
            ...
            if self.parallel.verbose >= 10:
                self.parallel._print(
                    f"Batch computation too fast ({batch_duration***REMOVED***s.) "
                    f"Setting batch_size={batch_size***REMOVED***."
    ***REMOVED***
...
***REMOVED***
            ...
            if self.parallel.verbose >= 10:
                self.parallel._print(
                    f"Batch computation too slow ({batch_duration***REMOVED***s.) "
                    f"Setting batch_size={batch_size***REMOVED***."
    ***REMOVED***
        else:
            ...
            if n_jobs != 1:
                if inside_dask_worker():
                    msg = (
                        ...
                        "- dask.config.set("
                        "{'distributed.worker.daemon': False***REMOVED***)"
