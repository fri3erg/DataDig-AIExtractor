...
class TestSNAPNoEdgeTypes(AbstractSNAP):
    ...
    def build_original_graph(self):
        nodes = {
            ...
            "C": {"color": "Red"***REMOVED***,
            "D": {"color": "Red"***REMOVED***,
            "E": {"color": "Blue"***REMOVED***,
            "F": {"color": "Blue"***REMOVED***,
            "G": {"color": "Blue"***REMOVED***,
            "H": {"color": "Blue"***REMOVED***,
            "I": {"color": "Yellow"***REMOVED***,
            "J": {"color": "Yellow"***REMOVED***,
            "K": {"color": "Yellow"***REMOVED***,
            "L": {"color": "Yellow"***REMOVED***,
        ***REMOVED***
        edges = [
            ("A", "B"),
            ("A", "C"),
    ...
    def build_summary_graph(self):
        nodes = {
            "Supernode-0": {"color": "Red"***REMOVED***,
            "Supernode-1": {"color": "Red"***REMOVED***,
            "Supernode-2": {"color": "Blue"***REMOVED***,
            "Supernode-3": {"color": "Blue"***REMOVED***,
            "Supernode-4": {"color": "Yellow"***REMOVED***,
            "Supernode-5": {"color": "Yellow"***REMOVED***,
        ***REMOVED***
        edges = [
        ...
        supernodes = {
            "Supernode-0": {"A", "B"***REMOVED***,
            "Supernode-1": {"C", "D"***REMOVED***,
            "Supernode-2": {"E", "F"***REMOVED***,
            "Supernode-3": {"G", "H"***REMOVED***,
            "Supernode-4": {"I", "J"***REMOVED***,
            "Supernode-5": {"K", "L"***REMOVED***,
        ***REMOVED***
...
class TestSNAPUndirected(AbstractSNAP):
    ...
    def build_summary_graph(self):
        ...
        ***REMOVED***
        ...
        for source, target, type in edges:
            G.add_edge(source, target, types=[{"type": type***REMOVED***])
...
class TestSNAPDirected(AbstractSNAP):
    def build_original_graph(self):
        nodes = {
            "A": {"color": "Red"***REMOVED***,
            "B": {"color": "Red"***REMOVED***,
            "C": {"color": "Green"***REMOVED***,
            "D": {"color": "Green"***REMOVED***,
            "E": {"color": "Blue"***REMOVED***,
            "F": {"color": "Blue"***REMOVED***,
            "G": {"color": "Yellow"***REMOVED***,
            "H": {"color": "Yellow"***REMOVED***,
        ***REMOVED***
        edges = [
            ("A", "C", "Strong"),
            ("A", "E", "Strong"),
    ...
    def build_summary_graph(self):
        nodes = {
            "Supernode-0": {"color": "Red"***REMOVED***,
            "Supernode-1": {"color": "Green"***REMOVED***,
            "Supernode-2": {"color": "Blue"***REMOVED***,
            "Supernode-3": {"color": "Yellow"***REMOVED***,
        ***REMOVED***
        edges = [
            ("Supernode-0", "Supernode-1", [{"type": "Strong"***REMOVED***]),
            ("Supernode-0", "Supernode-2", [{"type": "Weak"***REMOVED***, {"type": "Strong"***REMOVED***]),
            ("Supernode-1", "Supernode-2", [{"type": "Strong"***REMOVED***]),
            ("Supernode-1", "Supernode-3", [{"type": "Strong"***REMOVED***]),
            ("Supernode-3", "Supernode-2", [{"type": "Strong"***REMOVED***]),
        ]
        G = nx.DiGraph()
        for node in nodes:
            attributes = nodes[node]
...
class TestSNAPUndirectedMulti(AbstractSNAP):
    ...
    def build_summary_graph(self):
        nodes = {
            "Supernode-0": {"color": "Red"***REMOVED***,
            "Supernode-1": {"color": "Blue"***REMOVED***,
            "Supernode-2": {"color": "Yellow"***REMOVED***,
            "Supernode-3": {"color": "Blue"***REMOVED***,
            "Supernode-4": {"color": "Yellow"***REMOVED***,
            "Supernode-5": {"color": "Red"***REMOVED***,
        ***REMOVED***
        edges = [
            ("Supernode-1", "Supernode-2", [{"type": "Weak"***REMOVED***]),
            ("Supernode-2", "Supernode-4", [{"type": "Weak"***REMOVED***, {"type": "Strong"***REMOVED***]),
            ("Supernode-3", "Supernode-4", [{"type": "Strong"***REMOVED***]),
            ("Supernode-3", "Supernode-5", [{"type": "Weak"***REMOVED***, {"type": "Strong"***REMOVED***]),
            ("Supernode-4", "Supernode-4", [{"type": "Weak"***REMOVED***, {"type": "Strong"***REMOVED***]),
        ]
        G = nx.MultiGraph()
        for node in nodes:
            attributes = nodes[node]
