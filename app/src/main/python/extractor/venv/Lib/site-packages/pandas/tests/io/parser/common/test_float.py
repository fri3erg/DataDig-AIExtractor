...
def test_scientific_no_exponent(all_parsers_all_precisions):
    # see gh-12215
    df = DataFrame.from_dict({"w": ["2e"], "x": ["3E"], "y": ["42e"], "z": ["632E"]***REMOVED***)
...
def test_very_negative_exponent(all_parsers_all_precisions, neg_exp):
    ...
    expected = DataFrame({"data": [0.0]***REMOVED***)
    tm.assert_frame_equal(result, expected)
...
def test_too_many_exponent_digits(all_parsers_all_precisions, exp, request):
    ...
    if precision == "round_trip":
        ...
        expected = DataFrame({"data": [value]***REMOVED***)
    else:
        expected = DataFrame({"data": [f"10E{exp***REMOVED***"]***REMOVED***)
