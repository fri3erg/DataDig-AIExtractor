...
class BooleanDtype(BaseMaskedDtype):
    ...
    def __from_arrow__(
        ...
        if array.type != pyarrow.bool_() and not pyarrow.types.is_null(array.type):
            raise TypeError(f"Expected array of boolean type, got {array.type***REMOVED*** instead")
...
***REMOVED***.to_numpy(zero_copy_only=False)
            if arr.null_count != 0:
...
class BooleanArray(BaseMaskedArray):
    ...
    _TRUE_VALUES = {"True", "TRUE", "true", "1", "1.0"***REMOVED***
    _FALSE_VALUES = {"False", "FALSE", "false", "0", "0.0"***REMOVED***
...
***REMOVED***
        ...
        *,
        ...
        def map_string(s) -> bool:
            if s in true_values_union:
                ...
                raise ValueError(f"{s***REMOVED*** cannot be cast to bool")
    ...
    def _logical_method(self, other, op):
        assert op.__name__ in {"or_", "ror_", "and_", "rand_", "xor", "rxor"***REMOVED***
        ...
        if other_is_scalar and other is not libmissing.NA and not lib.is_bool(other):
            raise TypeError(
                ...
                f"Got {type(other).__name__***REMOVED*** instead."
***REMOVED***

        if not other_is_scalar and len(self) != len(other):
            raise ValueError("Lengths must match")

        if op.__name__ in {"or_", "ror_"***REMOVED***:
            result, mask = ops.kleene_or(self._data, other, self._mask, mask)
        elif op.__name__ in {"and_", "rand_"***REMOVED***:
