...
class _DatabricksClientBase(BaseModel, ABC):
    ...
    def request(self, method: str, url: str, request: Any) -> Any:
        headers = {"Authorization": f"Bearer {self.api_token***REMOVED***"***REMOVED***
        response = requests.request(
            method=method, url=url, headers=headers, json=request
        )
        # TODO: error handling and automatic retries
        if not response.ok:
            raise ValueError(f"HTTP {response.status_code***REMOVED*** error: {response.text***REMOVED***")
...
***REMOVED*** from e
    ...
    def set_api_url(cls, values: Dict[str, Any]) -> Dict[str, Any]:
        if "api_url" not in values:
            ...
            api_url = f"https://{host***REMOVED***/serving-endpoints/{endpoint_name***REMOVED***/invocations"
    ...
    def post(
        ...
        if self.external_or_foundation:
            ...
            wrapped_request = {"dataframe_records": [request]***REMOVED***
...
class _DatabricksClusterDriverProxyClient(_DatabricksClientBase):
    ...
    def set_api_url(cls, values: Dict[str, Any]) -> Dict[str, Any]:
        if "api_url" not in values:
            ...
            api_url = f"https://{host***REMOVED***/driver-proxy-api/o/0/{cluster_id***REMOVED***/{port***REMOVED***"
            values["api_url"] = api_url
        return values
    ...
    if not host:
        try:
            ...
            raise ValueError(
                ...
                f"environment variable 'DATABRICKS_HOST'. Received error: {e***REMOVED***"
***REMOVED***
...
def get_default_api_token() -> str:
    ...
    try:
        ...
        raise ValueError(
            ...
            f"environment variable 'DATABRICKS_TOKEN'. Received error: {e***REMOVED***"
        )
    # TODO: support Databricks CLI profile
    return api_token
...
class Databricks(LLM):
    ...
    * **Serving endpoint** (recommended for both production and development).
      ...
      * inputs::
          ...
          [{"name": "prompt", "type": "string"***REMOVED***,
           {"name": "stop", "type": "list[string]"***REMOVED***]

      * outputs: ``[{"type": "string"***REMOVED***]``
    ...
    * **Cluster driver proxy app** (recommended for interactive development).
      ...
      * inputs::
          ...
          {"type": "object",
           "properties": {
              "prompt": {"type": "string"***REMOVED***,
              "stop": {"type": "array", "items": {"type": "string"***REMOVED******REMOVED******REMOVED***,
           "required": ["prompt"]***REMOVED***`
    ...
    * an automatically generated temporary token if running inside a Databricks
    ...
    """A function that transforms ``{prompt, stop, **kwargs***REMOVED***`` into a JSON-compatible
...
***REMOVED***
            ...
            raise ValueError(f"Invalid cluster_driver_port: {v***REMOVED***")
        else:
            return v
...
***REMOVED***
    ...
    def _call(
        ...
        **kwargs: Any,
        ...
        request: Dict[str, Any] = {"prompt": prompt***REMOVED***
        if self._client.llm:
