...
... nx.d_separated(g, {"S1", "S2", "O1", "O2"***REMOVED***, {"S4", "S5", "O4", "O5"***REMOVED***, {"S3"***REMOVED***)
True
...
def minimal_d_separator(G, u, v):
    ...
    is :math:`O(|E_{An***REMOVED***^m|)`, where :math:`|E_{An***REMOVED***^m|` stands for the
...
def is_minimal_d_separator(G, u, v, z):
    ...
    >>> G.add_node(4)
    >>> nx.is_minimal_d_separator(G, 0, 2, {1***REMOVED***)
    True
    >>> # since {1***REMOVED*** is the minimal d-separator, {1, 3, 4***REMOVED*** is not minimal
    >>> nx.is_minimal_d_separator(G, 0, 2, {1, 3, 4***REMOVED***)
    False
    >>> # alternatively, if we only want to check that {1, 3, 4***REMOVED*** is a d-separator
    >>> nx.d_separated(G, {0***REMOVED***, {4***REMOVED***, {1, 3, 4***REMOVED***)
    True
    ...
    https://en.wikipedia.org/wiki/Bayesian_network#d-separation
    """
    if not nx.d_separated(G, {u***REMOVED***, {v***REMOVED***, z):
        return False
