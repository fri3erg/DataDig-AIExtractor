...
def paper_1_case(float_edge_wt=False, explicit_node_wt=True, directed=False):
    ...
    # graph creation
    example_1.add_edge(1, 2, **{EWL: 3 + shift***REMOVED***)
    example_1.add_edge(1, 4, **{EWL: 2 + shift***REMOVED***)
    example_1.add_edge(2, 3, **{EWL: 4 + shift***REMOVED***)
    example_1.add_edge(2, 5, **{EWL: 6 + shift***REMOVED***)
...
def test_paper_1_case():
    ground_truth = {frozenset([1, 4]), frozenset([2, 3, 5])***REMOVED***
...
def test_mandatory_integrality():
    ...
    ex_1_broken.add_edge(1, 2, **{EWL: 3.2***REMOVED***)
    ex_1_broken.add_edge(1, 4, **{EWL: 2.4***REMOVED***)
    ex_1_broken.add_edge(2, 3, **{EWL: 4.0***REMOVED***)
    ex_1_broken.add_edge(2, 5, **{EWL: 6.3***REMOVED***)
