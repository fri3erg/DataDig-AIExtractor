...
def create_waiter_with_client(waiter_name, waiter_model, client):
    ...
    documented_waiter_cls = type(waiter_class_name, (Waiter,), {'wait': wait***REMOVED***)
...
class AcceptorConfig:
    ...
    def explanation(self):
        if self.matcher == 'path':
            return 'For expression "{***REMOVED***" we matched expected path: "{***REMOVED***"'.format(
                self.argument,
                self.expected,
***REMOVED***
...
***REMOVED***
    ...
    def _create_status_matcher(self):
        ...
        def acceptor_matches(response):
            ...
            status_code = response.get('ResponseMetadata', {***REMOVED***).get(
                'HTTPStatusCode'
***REMOVED***
    ...
    def _create_error_matcher(self):
        ...
        def acceptor_matches(response):
            ...
            return response.get("Error", {***REMOVED***).get("Code", "") == expected
...
class Waiter:
    ...
    def wait(self, **kwargs):
        ...
        config = kwargs.pop('WaiterConfig', {***REMOVED***)
