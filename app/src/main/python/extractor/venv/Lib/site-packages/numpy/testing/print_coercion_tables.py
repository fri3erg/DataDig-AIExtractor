...
def print_new_cast_table(*, can_cast=True, legacy=False, flags=False):
    ...
    ***REMOVED***
    ...
    if flags:
        print()
        print(f"{flags_table[0]***REMOVED***: no flags, {flags_table[1]***REMOVED***: PyAPI, "
              f"{flags_table[2]***REMOVED***: supports unaligned, {flags_table[4]***REMOVED***: no-float-errors")
        print()
        print_table("flags")
