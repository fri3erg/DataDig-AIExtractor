...
***REMOVED***.responses[0]
            ...
            (
                ...
                generate_kwargs,
                postprocess_kwargs,
***REMOVED*** = self._runner.llm.sanitize_parameters(prompt, **kwargs)
