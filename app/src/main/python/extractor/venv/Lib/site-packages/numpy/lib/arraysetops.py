...
def unique(ar, return_index=False, return_inverse=False,
    ...
    * the number of times each unique value comes up in the input array
    ...
    dtype = [('f{i***REMOVED***'.format(i=i), ar.dtype) for i in range(ar.shape[1])]
    ...
    try:
        ...
        msg = 'The axis argument to unique is not supported for dtype {dt***REMOVED***'
...
def in1d(ar1, ar2, assume_unique=False, invert=False, *, kind=None):
    ...
    kind : {None, 'sort', 'table'***REMOVED***, optional
    ...
    if kind not in {None, 'sort', 'table'***REMOVED***:
        raise ValueError(
            f"Invalid kind: '{kind***REMOVED***'. Please use None, 'sort' or 'table'.")

    # Can use the table method if all arrays are integers or boolean:
    is_int_arrays = all(ar.dtype.kind in ("u", "i", "b") for ar in (ar1, ar2))
    use_table_method = is_int_arrays and kind in {None, 'table'***REMOVED***
