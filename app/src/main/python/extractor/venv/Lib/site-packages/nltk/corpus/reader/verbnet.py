...
class VerbnetCorpusReader(XMLCorpusReader):
    ...
    def __init__(self, root, fileids, wrap_etree=False):
        ...
        self._shortid_to_longid = {***REMOVED***
...
***REMOVED***
    ...
    def vnclass(self, fileid_or_classid):
        ...
        if classid in self._class_to_fileid:
            ...
            raise ValueError(f"Unknown identifier {fileid_or_classid***REMOVED***")
            ...
            themroles.append(
                {
                    "type": trole.get("type"),
                    "modifiers": [
                        {"value": restr.get("Value"), "type": restr.get("type")***REMOVED***
...
***REMOVED***
    ...
    def _get_semantics_within_frame(self, vnframe):
        ...
        for pred in vnframe.findall("SEMANTICS/PRED"):
            arguments = [
                {"type": arg.get("type"), "value": arg.get("value")***REMOVED***
    ...
    def _get_syntactic_list_within_frame(self, vnframe):
        ...
        for elt in vnframe.find("SYNTAX"):
            ...
            syntax_within_single_frame.append(
                {"pos_tag": pos_tag, "modifiers": modifiers***REMOVED***
***REMOVED***
        return syntax_within_single_frame
    ...
    def pprint_themroles(self, vnclass, indent=""):
        ...
        for themrole in self.themroles(vnclass):
            ...
            if modifiers:
                piece += "[{***REMOVED***]".format(" ".join(modifiers))
            pieces.append(piece)
        return "\n".join(pieces)
    ...
    def _pprint_description_within_frame(self, vnframe, indent=""):
        ...
        if vnframe["description"]["secondary"]:
            description += " ({***REMOVED***)".format(vnframe["description"]["secondary"])
        return description
    ...
    def _pprint_syntax_within_frame(self, vnframe, indent=""):
        ...
        for element in vnframe["syntax"]:
            ...
            modifier_list += [
                "{***REMOVED***{***REMOVED***".format(restr["value"], restr["type"])
                for restr in (
    ...
    ***REMOVED***
            ...
            if modifier_list:
                piece += "[{***REMOVED***]".format(" ".join(modifier_list))
            pieces.append(piece)
    ...
    def _pprint_semantics_within_frame(self, vnframe, indent=""):
        ...
        for predicate in vnframe["semantics"]:
            ...
            pieces.append(
                f"{'¬' if predicate['negated'] else ''***REMOVED***{predicate['predicate_value']***REMOVED***({', '.join(arguments)***REMOVED***)"
***REMOVED***
        return "\n".join(f"{indent***REMOVED**** {piece***REMOVED***" for piece in pieces)
