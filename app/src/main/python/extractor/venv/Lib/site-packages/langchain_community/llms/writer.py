...
class Writer(LLM):
    ...
    def _identifying_params(self) -> Mapping[str, Any]:
        ...
        return {
            **{"model_id": self.model_id, "writer_org_id": self.writer_org_id***REMOVED***,
        ...
        **kwargs: Any,
        ...
        if self.base_url is not None:
            ...
            base_url = (
                ...
                f"/organization/{self.writer_org_id***REMOVED***"
                f"/model/{self.model_id***REMOVED***/completions"
***REMOVED***
        params = {**self._default_params, **kwargs***REMOVED***
        response = requests.post(
            url=base_url,
            headers={
                "Authorization": f"{self.writer_api_key***REMOVED***",
