...
class DatetimeIndex(DatetimeTimedeltaMixin):
    ...
    closed : {'left', 'right'***REMOVED***, optional
    ...
    def __new__(
        ...
        if closed is not lib.no_default:
            # GH#52628
            warnings.warn(
                f"The 'closed' keyword in {cls.__name__***REMOVED*** construction is "
...
***REMOVED***
        if normalize is not lib.no_default:
            # GH#52628
            warnings.warn(
                f"The 'normalize' keyword in {cls.__name__***REMOVED*** construction is "
                "deprecated and will be removed in a future version.",
                FutureWarning,
                stacklevel=find_stack_level(),
***REMOVED***
    ...
    def _formatter_func(self):
        ...
        return lambda x: f"'{formatter(x)***REMOVED***'"
    ...
    ***REMOVED***
    ...
    def get_loc(self, key):
        ...
        if isinstance(key, self._data._recognized_scalars):
            ...
            # GH#20464
            raise TypeError(
                f"Cannot index {type(self).__name__***REMOVED*** with {type(key).__name__***REMOVED***"
***REMOVED***
    ...
    **kwargs
    ...
    if isinstance(freq, str) and freq.startswith("C"):
        try:
            ...
            msg = f"invalid custom frequency string: {freq***REMOVED***"
            raise ValueError(msg) from err
    elif holidays or weekmask:
        msg = (
            "a custom frequency string is required when holidays or "
            f"weekmask are passed, got frequency {freq***REMOVED***"
        )
