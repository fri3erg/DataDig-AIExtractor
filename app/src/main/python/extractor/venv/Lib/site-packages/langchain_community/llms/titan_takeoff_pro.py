...
class TitanTakeoffPro(LLM):
    ...
    def _default_params(self) -> Mapping[str, Any]:
        ...
        return {
            **(
                {"regex_string": self.regex_string***REMOVED***
                if self.regex_string is not None
                else {***REMOVED***
***REMOVED***,
            **(
                {"sampling_temperature": self.sampling_temperature***REMOVED***
                if self.sampling_temperature is not None
                else {***REMOVED***
***REMOVED***,
            **(
                {"sampling_topp": self.sampling_topp***REMOVED***
                if self.sampling_topp is not None
                else {***REMOVED***
***REMOVED***,
            **(
                {"repetition_penalty": self.repetition_penalty***REMOVED***
                if self.repetition_penalty is not None
                else {***REMOVED***
***REMOVED***,
            **(
                {"max_new_tokens": self.max_new_tokens***REMOVED***
                if self.max_new_tokens is not None
                else {***REMOVED***
***REMOVED***,
            **(
                {"min_new_tokens": self.min_new_tokens***REMOVED***
                if self.min_new_tokens is not None
                else {***REMOVED***
***REMOVED***,
            **(
                {"sampling_topk": self.sampling_topk***REMOVED***
                if self.sampling_topk is not None
                else {***REMOVED***
***REMOVED***,
            **(
                {"no_repeat_ngram_size": self.no_repeat_ngram_size***REMOVED***
...
***REMOVED***,
    ...
    ***REMOVED***:
                ...
                return text_output
            url = f"{self.base_url***REMOVED***/generate"
            params = {"text": prompt, **self._default_params***REMOVED***
...
***REMOVED***
    ...
    def _stream(
        ...
        **kwargs: Any,
        ...
        """
        url = f"{self.base_url***REMOVED***/generate_stream"
        params = {"text": prompt, **self._default_params***REMOVED***
    ...
    def _identifying_params(self) -> Mapping[str, Any]:
        ...
        return {"base_url": self.base_url, **{***REMOVED***, **self._default_params***REMOVED***
