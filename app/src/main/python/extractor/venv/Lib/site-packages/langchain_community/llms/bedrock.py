    ...
    for i in range(len(input_text)):
        if input_text[i : i + len(HUMAN_PROMPT)] == HUMAN_PROMPT:
            if count % 2 == 0:
                ...
                warnings.warn(ALTERNATION_ERROR + f" Received {input_text***REMOVED***")
...
class LLMInputOutputAdapter:
    ...
    ***REMOVED***
    ...
    def prepare_input(
        ...
        input_body = {**model_kwargs***REMOVED***
        if provider == "anthropic":
            ...
            input_body["textGenerationConfig"] = {**model_kwargs***REMOVED***
        else:
            input_body["inputText"] = prompt
    ...
    def prepare_output_stream(
        ...
        if provider not in cls.provider_to_output_key_map:
            raise ValueError(
                f"Unknown streaming response output key for provider: {provider***REMOVED***"
***REMOVED***
...
***REMOVED***
            ...
            raise ValueError(f"Error raised by bedrock service: {e***REMOVED***").with_traceback(
                e.__traceback__
***REMOVED***
        ...
        **kwargs: Any,
        ...
        if stop:
            if provider not in self.provider_stop_sequence_key_name_map:
                raise ValueError(
                    f"Stop sequence key name for {provider***REMOVED*** is not supported."
    ***REMOVED***
...
***REMOVED***
            ...
            raise ValueError(f"Error raised by bedrock service: {e***REMOVED***")
