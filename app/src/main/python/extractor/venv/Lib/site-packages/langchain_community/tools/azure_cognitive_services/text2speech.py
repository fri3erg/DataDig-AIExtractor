...
***REMOVED*** as f:
            ...
            logger.debug(f"Speech synthesis canceled: {cancellation_details.reason***REMOVED***")
            if cancellation_details.reason == speechsdk.CancellationReason.Error:
                raise RuntimeError(
                    f"Speech synthesis error: {cancellation_details.error_details***REMOVED***"
    ***REMOVED***

            return "Speech synthesis canceled."

        else:
            return f"Speech synthesis failed: {result.reason***REMOVED***"
    ...
    def _run(
        ...
        try:
            ...
            raise RuntimeError(f"Error while running AzureCogsText2SpeechTool: {e***REMOVED***")
