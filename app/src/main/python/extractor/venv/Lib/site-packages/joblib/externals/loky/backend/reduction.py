...
def _reduce_partial(p):
    return _rebuild_partial, (p.func, p.args, p.keywords or {***REMOVED***)
    ...
    if loky_pickler == "cloudpickle":
        ...
        try:
            ...
            extra_info = (
                ...
                f" '{loky_pickler***REMOVED***', as required by the env variable "
...
***REMOVED***
    ...
    util.debug(
        f"Using '{loky_pickler if loky_pickler else 'cloudpickle'***REMOVED***' for "
        "serialization."
    )
