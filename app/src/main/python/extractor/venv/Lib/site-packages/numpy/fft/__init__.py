...
.. math::
   A_k =  \\sum_{m=0***REMOVED***^{n-1***REMOVED*** a_m \\exp\\left\\{-2\\pi i{mk \\over n***REMOVED***\\right\\***REMOVED***
   \\qquad k = 0,\\ldots,n-1.

The DFT is in general defined for complex inputs and outputs, and a
single-frequency component at linear frequency :math:`f` is
represented by a complex exponential
:math:`a_m = \\exp\\{2\\pi i\\,f m\\Delta t\\***REMOVED***`, where :math:`\\Delta t`
...
.. math::
   a_m = \\frac{1***REMOVED***{n***REMOVED***\\sum_{k=0***REMOVED***^{n-1***REMOVED***A_k\\exp\\left\\{2\\pi i{mk\\over n***REMOVED***\\right\\***REMOVED***
   \\qquad m = 0,\\ldots,n-1.
...
:math:`1/\\sqrt{n***REMOVED***`. Finally, setting the keyword argument ``norm`` to
...
.. math::
   A_{kl***REMOVED*** =  \\sum_{m=0***REMOVED***^{M-1***REMOVED*** \\sum_{n=0***REMOVED***^{N-1***REMOVED***
   a_{mn***REMOVED***\\exp\\left\\{-2\\pi i \\left({mk\\over M***REMOVED***+{nl\\over N***REMOVED***\\right)\\right\\***REMOVED***
