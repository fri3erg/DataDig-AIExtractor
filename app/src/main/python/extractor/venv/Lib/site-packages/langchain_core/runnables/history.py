...
class RunnableWithMessageHistory(RunnableBindingBase):
    ...
    RunnableWithMessageHistory must always be called with a config that contains session_id, e.g. ``{"configurable": {"session_id": "<SESSION_ID>"***REMOVED******REMOVED***`.
    ...
    Example (dict input):
        .. code-block:: python
            ...
            prompt = ChatPromptTemplate.from_messages([
                ("system", "You're an assistant who's good at {ability***REMOVED***"),
                MessagesPlaceholder(variable_name="history"),
                ("human", "{question***REMOVED***"),
            ])
...
***REMOVED***
            ...
            chain_with_history.invoke(
                {"ability": "math", "question": "What does cosine mean?"***REMOVED***,
                config={"configurable": {"session_id": "foo"***REMOVED******REMOVED***
***REMOVED***
            # -> "Cosine is ..."
            chain_with_history.invoke(
                {"ability": "math", "question": "What's its inverse"***REMOVED***,
                config={"configurable": {"session_id": "foo"***REMOVED******REMOVED***
***REMOVED***
...
***REMOVED***
            ...
            chain_with_history.invoke(
                {"ability": "math", "question": "What does cosine mean?"***REMOVED***,
                config={"configurable": {"user_id": "123", "conversation_id": "1"***REMOVED******REMOVED***
***REMOVED***
    ...
    def __init__(
        ...
        ***REMOVED*** -> BaseChatMessageHistory:
                      ...
        ...
        ***REMOVED*** -> BaseChatMessageHistory:
        ...
        if messages_key:
            history_chain = RunnablePassthrough.assign(
                **{messages_key: history_chain***REMOVED***
***REMOVED***.with_config(run_name="insert_history")
        bound = (
...
***REMOVED***
    ...
    def _merge_configs(self, *configs: Optional[RunnableConfig]) -> RunnableConfig:
        ...
        configurable = config.get("configurable", {***REMOVED***)

        missing_keys = set(expected_keys) - set(configurable.keys())

        if missing_keys:
            example_input = {self.input_messages_key: "foo"***REMOVED***
            example_configurable = {
                missing_key: "[your-value-here]" for missing_key in missing_keys
            ***REMOVED***
            example_config = {"configurable": example_configurable***REMOVED***
            raise ValueError(
                f"Missing keys {sorted(missing_keys)***REMOVED*** in config['configurable'] "
                f"Expected keys are {sorted(expected_keys)***REMOVED***."
                f"When using via .invoke() or .stream(), pass in a config; "
                f"e.g., chain.invoke({example_input***REMOVED***, {example_config***REMOVED***)"
***REMOVED***
        ...
        if len(expected_keys) == 1:
            ...
            if set(expected_keys) != set(parameter_names):
                raise ValueError(
                    f"Expected keys {sorted(expected_keys)***REMOVED*** do not match parameter "
                    f"names {sorted(parameter_names)***REMOVED*** of get_session_history."
    ***REMOVED***

            message_history = self.get_session_history(
                **{key: configurable[key] for key in expected_keys***REMOVED***
***REMOVED***
