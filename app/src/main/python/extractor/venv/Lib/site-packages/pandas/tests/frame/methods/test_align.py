...
***REMOVED***
    ...
    def test_align_frame_with_series(self, float_frame):
        ...
        tm.assert_index_equal(left.index, float_frame.index)
        expected = {c: s for c in float_frame.columns***REMOVED***
        expected = DataFrame(
    ...
    def test_align_series_condition(self):
        ...
        expected = DataFrame({"a": [0, 2, 0], "b": [0, 5, 0]***REMOVED***)
        tm.assert_frame_equal(result, expected)
...
***REMOVED***
    ...
    ***REMOVED***,
    ...
    def test_align_series_combinations(self):
        df = DataFrame({"a": [1, 3, 5], "b": [1, 3, 5]***REMOVED***, index=list("ACE"))
