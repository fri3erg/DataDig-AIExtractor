...
class Hologres(VectorStore):
    ...
    def __post_init__(
        ...
        self.storage = HologresVector(
            ...
            table_schema={"document": "text"***REMOVED***,
    ...
    def add_embeddings(
        ...
        **kwargs: Any,
        ...
        """
        try:
            schema_datas = [{"document": t***REMOVED*** for t in texts]
...
***REMOVED***
    ...
    def connection_string_from_db_params(
        ...
        return (
            f"dbname={database***REMOVED*** user={user***REMOVED*** password={password***REMOVED*** host={host***REMOVED*** port={port***REMOVED***"
        )
