...
def build_analyze_document_request_initial(
    ...
    **kwargs: Any
    ...
    # Construct URL
    _url = kwargs.pop("template_url", "/documentModels/{modelId***REMOVED***:analyze")
    path_format_arguments = {
        "modelId": _SERIALIZER.url("model_id", model_id, 'str', max_length=64, min_length=0, pattern=r'^[a-zA-Z0-9][a-zA-Z0-9._~-]{1,63***REMOVED***$'),
    ***REMOVED***
...
def build_get_analyze_result_request(
    model_id: str,
    result_id: str,
    **kwargs: Any
) -> HttpRequest:
    ...
    # Construct URL
    _url = kwargs.pop("template_url", "/documentModels/{modelId***REMOVED***/analyzeResults/{resultId***REMOVED***")
    path_format_arguments = {
        "modelId": _SERIALIZER.url("model_id", model_id, 'str', max_length=64, min_length=0, pattern=r'^[a-zA-Z0-9][a-zA-Z0-9._~-]{1,63***REMOVED***$'),
...
def build_build_model_request_initial(
    *,
...
def build_compose_model_request_initial(
    *,
...
def build_authorize_model_copy_request(
    *,
...
def build_copy_model_to_request_initial(
    model_id: str,
    *,
    ...
    **kwargs: Any
    ...
    # Construct URL
    _url = kwargs.pop("template_url", "/documentModels/{modelId***REMOVED***:copyTo")
    path_format_arguments = {
        "modelId": _SERIALIZER.url("model_id", model_id, 'str', max_length=64, min_length=0, pattern=r'^[a-zA-Z0-9][a-zA-Z0-9._~-]{1,63***REMOVED***$'),
    ***REMOVED***
...
def build_get_model_request(
    ...
    **kwargs: Any
    ...
    # Construct URL
    _url = kwargs.pop("template_url", "/documentModels/{modelId***REMOVED***")
    path_format_arguments = {
        "modelId": _SERIALIZER.url("model_id", model_id, 'str', max_length=64, min_length=0, pattern=r'^[a-zA-Z0-9][a-zA-Z0-9._~-]{1,63***REMOVED***$'),
    ***REMOVED***
...
class DocumentModelsOperations:
    ...
    .. warning::
        **DO NOT** instantiate this class directly.
        ...
        :attr:`document_models` attribute.
    """
...
***REMOVED***
    ...
    _analyze_document_initial.metadata = {'url': "/documentModels/{modelId***REMOVED***:analyze"***REMOVED***  # type: ignore
    ...
    def begin_analyze_document(  # pylint: disable=inconsistent-return-statements
        ...
        **kwargs: Any
        ...
        :param features: List of optional analysis features. Default value is None.
        :type features: list[str or
         ~azure.ai.formrecognizer.v2023_07_31.models.DocumentAnalysisFeature]
        :param analyze_request: Analyze request parameters. Default value is None.
        :type analyze_request: IO or str or
         ~azure.ai.formrecognizer.v2023_07_31.models.AnalyzeDocumentRequest
...
***REMOVED***
    ...
    begin_analyze_document.metadata = {'url': "/documentModels/{modelId***REMOVED***:analyze"***REMOVED***  # type: ignore
    ...
    get_analyze_result.metadata = {'url': "/documentModels/{modelId***REMOVED***/analyzeResults/{resultId***REMOVED***"***REMOVED***  # type: ignore
    ...
    _build_model_initial.metadata = {'url': "/documentModels:build"***REMOVED***  # type: ignore


    @distributed_trace
    def begin_build_model(  # pylint: disable=inconsistent-return-statements
        self,
        build_request: _models.BuildDocumentModelRequest,
        **kwargs: Any
...
***REMOVED***
    ...
    begin_build_model.metadata = {'url': "/documentModels:build"***REMOVED***  # type: ignore
    ...
    _compose_model_initial.metadata = {'url': "/documentModels:compose"***REMOVED***  # type: ignore


    @distributed_trace
    def begin_compose_model(  # pylint: disable=inconsistent-return-statements
        self,
        compose_request: _models.ComposeDocumentModelRequest,
        **kwargs: Any
    ) -> DocumentModelAdministrationClientLROPoller[None]:
...
***REMOVED***
    ...
    begin_compose_model.metadata = {'url': "/documentModels:compose"***REMOVED***  # type: ignore
    ...
    def authorize_model_copy(
        ...
        **kwargs: Any
        ...
        :type authorize_copy_request: ~azure.ai.formrecognizer.v2023_07_31.models.AuthorizeCopyRequest
        :keyword callable cls: A custom type or function that will be passed the direct response
    ...
    authorize_model_copy.metadata = {'url': "/documentModels:authorizeCopy"***REMOVED***  # type: ignore
    ...
    _copy_model_to_initial.metadata = {'url': "/documentModels/{modelId***REMOVED***:copyTo"***REMOVED***  # type: ignore


    @distributed_trace
    def begin_copy_model_to(  # pylint: disable=inconsistent-return-statements
        self,
        model_id: str,
        copy_to_request: _models.CopyAuthorization,
        **kwargs: Any
        ...
        :type copy_to_request: ~azure.ai.formrecognizer.v2023_07_31.models.CopyAuthorization
        :keyword callable cls: A custom type or function that will be passed the direct response
        :keyword str continuation_token: A continuation token to restart a poller from a saved state.
        :keyword polling: By default, your polling method will be LROBasePolling. Pass in False for
         this operation to not poll, or pass in your own initialized polling object for a personal
...
***REMOVED***
    ...
    begin_copy_model_to.metadata = {'url': "/documentModels/{modelId***REMOVED***:copyTo"***REMOVED***  # type: ignore
    ...
    def list_models(
        ...
        **kwargs: Any
        ...
        :return: An iterator like instance of either GetDocumentModelsResponse or the result of
         cls(response)
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.ai.formrecognizer.v2023_07_31.models.GetDocumentModelsResponse]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        _headers = kwargs.pop("headers", {***REMOVED***) or {***REMOVED***
        _params = case_insensitive_dict(kwargs.pop("params", {***REMOVED***) or {***REMOVED***)
...
***REMOVED***
    ...
    list_models.metadata = {'url': "/documentModels"***REMOVED***  # type: ignore
    ...
    get_model.metadata = {'url': "/documentModels/{modelId***REMOVED***"***REMOVED***  # type: ignore
    ...
    delete_model.metadata = {'url': "/documentModels/{modelId***REMOVED***"***REMOVED***  # type: ignore
