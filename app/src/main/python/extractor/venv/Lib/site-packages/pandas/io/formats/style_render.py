...
class StylerRenderer:
    ...
    def _render(
        ...
        for i, concatenated in enumerate(self.concatenated):
            ...
            foot = f"{self.css['foot']***REMOVED***{i***REMOVED***"
            concatenated.css = {
                **self.css,
                "data": f"{foot***REMOVED***_data",
                "row_heading": f"{foot***REMOVED***_row_heading",
                "row": f"{foot***REMOVED***_row",
                "foot": f"{foot***REMOVED***_foot",
            ***REMOVED***
...
***REMOVED***
    ...
    def _translate(
        ...
        d : dict
            ...
            cellstyle, table_attributes***REMOVED***
        """
        if dxs is None:
            dxs = []
        ...
        ***REMOVED***
        ...
        d.update({"index_lengths": idx_lengths***REMOVED***)
...
***REMOVED***
        ...
        d.update({"table_attributes": table_attr***REMOVED***)
    ...
    def _generate_col_header_row(
        ...
        column_name = [
            _element(
                "th",
                (
                    f"{self.css['blank']***REMOVED*** {self.css['level']***REMOVED***{r***REMOVED***"
                    if name is None
                    else f"{self.css['index_name']***REMOVED*** {self.css['level']***REMOVED***{r***REMOVED***"
    ***REMOVED***,
                name
...
***REMOVED***
        ...
        for c, value in enumerate(clabels[r]):
            ...
            if self._check_trim(
                ...
                column_headers,
                "th",
                f"{self.css['col_heading']***REMOVED*** {self.css['level']***REMOVED***{r***REMOVED*** "
                f"{self.css['col_trim']***REMOVED***",
***REMOVED***:
                break
...
***REMOVED***
            ...
            if self.cell_ids:
                header_element["id"] = f"{self.css['level']***REMOVED***{r***REMOVED***_{self.css['col']***REMOVED***{c***REMOVED***"
            if (
                header_element_visible
...
***REMOVED***:
                ...
                self.cellstyle_map_columns[tuple(self.ctx_columns[r, c])].append(
                    f"{self.css['level']***REMOVED***{r***REMOVED***_{self.css['col']***REMOVED***{c***REMOVED***"
    ***REMOVED***
    ...
    def _generate_index_names_row(
        ...
        index_names = [
            _element(
                "th",
                f"{self.css['index_name']***REMOVED*** {self.css['level']***REMOVED***{c***REMOVED***",
...
***REMOVED***
        ...
        if clabels:
            ...
            for c, value in enumerate(clabels[last_level]):
                ...
                if self._check_trim(
                    ...
                    column_blanks,
                    "th",
                    f"{self.css['blank']***REMOVED*** {self.css['col']***REMOVED***{c***REMOVED*** {self.css['col_trim']***REMOVED***",
    ...
    ***REMOVED***:
                ...
                column_blanks.append(
                    _element(
                        "th",
                        f"{self.css['blank']***REMOVED*** {self.css['col']***REMOVED***{c***REMOVED***",
                        self.css["blank_value"],
    ...
    def _generate_trimmed_row(self, max_cols: int) -> list:
        ...
        index_headers = [
            _element(
                "th",
                (
                    f"{self.css['row_heading']***REMOVED*** {self.css['level']***REMOVED***{c***REMOVED*** "
                    f"{self.css['row_trim']***REMOVED***"
    ***REMOVED***,
                "...",
                not self.hide_index_[c],
                attributes="",
***REMOVED***
        ...
        for c, _ in enumerate(self.columns):
            ...
            if self._check_trim(
                ...
                data,
                "td",
                f"{self.css['data']***REMOVED*** {self.css['row_trim']***REMOVED*** {self.css['col_trim']***REMOVED***",
***REMOVED***:
                break
            ...
            data.append(
                _element(
                    "td",
                    f"{self.css['data']***REMOVED*** {self.css['col']***REMOVED***{c***REMOVED*** {self.css['row_trim']***REMOVED***",
                    "...",
...
***REMOVED***
            header_element = _element(
                ...
                (
                    f"{self.css['row_heading']***REMOVED*** {self.css['level']***REMOVED***{c***REMOVED*** "
                    f"{self.css['row']***REMOVED***{r***REMOVED***"
    ***REMOVED***,
                value,
                header_element_visible,
                display_value=self._display_funcs_index[(r, c)](value),
                attributes=(
                    f'rowspan="{idx_lengths.get((c, r), 0)***REMOVED***"'
...
***REMOVED***
            ...
            if self.cell_ids:
                header_element[
                    "id"
                ] = f"{self.css['level']***REMOVED***{c***REMOVED***_{self.css['row']***REMOVED***{r***REMOVED***"  # id is given
            if (
                header_element_visible
...
***REMOVED***:
                ...
                header_element["id"] = f"{self.css['level']***REMOVED***{c***REMOVED***_{self.css['row']***REMOVED***{r***REMOVED***"
                self.cellstyle_map_index[tuple(self.ctx_index[r, c])].append(
                    f"{self.css['level']***REMOVED***{c***REMOVED***_{self.css['row']***REMOVED***{r***REMOVED***"
    ***REMOVED***
...
***REMOVED***
            ...
            if self._check_trim(
                ...
                data,
                "td",
                f"{self.css['data']***REMOVED*** {self.css['row']***REMOVED***{r***REMOVED*** {self.css['col_trim']***REMOVED***",
***REMOVED***:
                break
            ...
            data_element = _element(
                "td",
                (
                    f"{self.css['data']***REMOVED*** {self.css['row']***REMOVED***{r***REMOVED*** "
                    f"{self.css['col']***REMOVED***{c***REMOVED***{cls***REMOVED***"
    ***REMOVED***,
                value,
                data_element_visible,
                attributes="",
...
***REMOVED***
            ...
            if self.cell_ids:
                data_element["id"] = f"{self.css['row']***REMOVED***{r***REMOVED***_{self.css['col']***REMOVED***{c***REMOVED***"
            if data_element_visible and (r, c) in self.ctx and self.ctx[r, c]:
                ...
                self.cellstyle_map[tuple(self.ctx[r, c])].append(
                    f"{self.css['row']***REMOVED***{r***REMOVED***_{self.css['col']***REMOVED***{c***REMOVED***"
    ***REMOVED***
    ...
    def _translate_latex(self, d: dict, clines: str | None) -> None:
        ...
        d["head"] = [
            [
                {**col, "cellstyle": self.ctx_columns[r, c - visible_index_level_n]***REMOVED***
...
***REMOVED***
        ...
        for r, row in zip(concatenated_visible_rows(self), d["body"]):
            ...
            row_body_cells = [
                {**col, "cellstyle": self.ctx[r, c]***REMOVED***
                for c, col in enumerate(row[index_levels:])
        ...
        if clines not in [
            ...
            raise ValueError(
                f"`clines` value of {clines***REMOVED*** is invalid. Should either be None or one "
...
***REMOVED***
                ...
                for lvln, lvl in enumerate(visible_index_levels):
                    ...
                    if idx_len is not None:  # i.e. not a sparsified entry
                        d["clines"][rn + idx_len].append(
                            f"\\cline{{{lvln+1***REMOVED***-{len(visible_index_levels)+data_len***REMOVED******REMOVED******REMOVED***"
            ***REMOVED***
    ...
    def format(
        ...
        hyperlinks : {"html", "latex"***REMOVED***, optional
        ...
        >>> df.style.format('{:.2f***REMOVED***', na_rep='MISS', subset=[0,1])  # doctest: +SKIP
                0      1          2
        0    MISS   1.00          A
        ...
        >>> df.style.format({0: '{:.2f***REMOVED***', 1: '£ {:.1f***REMOVED***'***REMOVED***, na_rep='MISS', precision=1)
        ...  # doctest: +SKIP
                 0      1     2
        0    MISS   £ 1.0     A
        1    2.00    MISS   3.0
        ...
        >>> df.style.format({0: '{:.1f***REMOVED***', 2: func***REMOVED***, precision=4, na_rep='MISS')
        ...  # doctest: +SKIP
                0        1        2
        ...
        >>> s = df.style.format(
        ...     '<a href="a.com/{0***REMOVED***">{0***REMOVED***</a>', escape="html", na_rep="NA"
        ...     )
        ...
        >>> df = pd.DataFrame([["123"], ["~ ^"], ["$%#"]])
        >>> df.style.format("\\textbf{{{***REMOVED******REMOVED******REMOVED***", escape="latex").to_latex()
        ...  # doctest: +SKIP
        \begin{tabular***REMOVED***{ll***REMOVED***
         & 0 \\
        0 & \textbf{123***REMOVED*** \\
        1 & \textbf{\textasciitilde \space \textasciicircum ***REMOVED*** \\
        2 & \textbf{\$\%\#***REMOVED*** \\
        \end{tabular***REMOVED***
        ...
        >>> df = pd.DataFrame([[r"$\sum_{i=1***REMOVED***^{10***REMOVED*** a_i$ a~b $\alpha \
        ...     = \frac{\beta***REMOVED***{\zeta^2***REMOVED***$"], ["%#^ $ \$x^2 $"]])
        >>> df.style.format(escape="latex-math").to_latex()
        ...  # doctest: +SKIP
        \begin{tabular***REMOVED***{ll***REMOVED***
         & 0 \\
        0 & $\sum_{i=1***REMOVED***^{10***REMOVED*** a_i$ a\textasciitilde b $\alpha = \frac{\beta***REMOVED***{\zeta^2***REMOVED***$ \\
        ...
        \begin{tabular***REMOVED***{ll***REMOVED***
         & 0 \\
        0 & \(\sum_{i=1***REMOVED***^{10***REMOVED*** a_i\) a\textasciitilde b \(\alpha
        = \frac{\beta***REMOVED***{\zeta^2***REMOVED***\) \\
        1 & \%\#\textasciicircum \space \( \$x^2 \) \\
        \end{tabular***REMOVED***
        ...
        ...     [r"$\frac{\beta***REMOVED***{\zeta***REMOVED***$ \(\frac{\beta***REMOVED***{\zeta***REMOVED***\)"]])
        >>> df.style.format(escape="latex-math").to_latex()
        ...  # doctest: +SKIP
        \begin{tabular***REMOVED***{ll***REMOVED***
         & 0 \\
        0 & \textbackslash ( x\textasciicircum 2 \textbackslash )  $x^2$ \\
        1 & $\frac{\beta***REMOVED***{\zeta***REMOVED***$ \textbackslash (\textbackslash
        frac\{\textbackslash beta\***REMOVED***\{\textbackslash zeta\***REMOVED***\textbackslash ) \\
        \end{tabular***REMOVED***
        ...
        >>> df = pd.DataFrame({"A": [1, 0, -1]***REMOVED***)
...
***REMOVED***
        ...
        if not isinstance(formatter, dict):
            formatter = {col: formatter for col in data.columns***REMOVED***
...
***REMOVED***
    ...
    def format_index(
        ...
        formatter : str, callable, dict or None
            Object to define how values are displayed. See notes.
        axis : {0, "index", 1, "columns"***REMOVED***
        ...
        >>> df.style.format_index('{:.2f***REMOVED***', axis=1, na_rep='MISS')  # doctest: +SKIP
             2.00   MISS    4.00
        0       1      2       3
        ...
        >>> df.style.format_index({0: lambda v: v.upper()***REMOVED***, axis=1, precision=1)
        ...  # doctest: +SKIP
                       A       B
              2.0    nan     4.0
        0       1      2       3
        ...
        >>> s = df.style.format_index('$ {0***REMOVED***', axis=1, escape="html", na_rep="NA")
        ...  # doctest: +SKIP
        <th .. >$ &#34;A&#34;</th>
        <th .. >$ A&amp;B</th>
        <th .. >NA</td>
        ...
        >>> df.style.format_index("\\textbf{{{***REMOVED******REMOVED******REMOVED***", escape="latex", axis=1).to_latex()
        ...  # doctest: +SKIP
        \begin{tabular***REMOVED***{lrrr***REMOVED***
        {***REMOVED*** & {\textbf{123***REMOVED******REMOVED*** & {\textbf{\textasciitilde ***REMOVED******REMOVED*** & {\textbf{\$\%\#***REMOVED******REMOVED*** \\
        0 & 1 & 2 & 3 \\
        \end{tabular***REMOVED***
        """
...
***REMOVED***
        ...
        if not isinstance(formatter, dict):
            formatter = {level: formatter for level in levels_***REMOVED***
        else:
            formatter = {
...
***REMOVED***
    ...
    def relabel_index(
        ...
        .. code-block:: python
            ...
            df = pd.DataFrame({"col": ["a", "b", "c"]***REMOVED***)
        ...
        >>> df = pd.DataFrame({"col": list(range(8))***REMOVED***, index=midx)
        ...
        >>> df = pd.DataFrame({"samples": np.random.rand(10)***REMOVED***)
        >>> styler = df.loc[np.random.randint(0,10,3)].style
        >>> styler.relabel_index([f"sample{i+1***REMOVED*** ({{***REMOVED******REMOVED***)" for i in range(3)])
        ...  # doctest: +SKIP
                         samples
        sample1 (5)     0.315811
        sample2 (0)     0.495941
        ...
        if len(labels) != visible_len:
            raise ValueError(
                ...
                f"visible labels along ``axis`` ({visible_len***REMOVED***)."
***REMOVED***
...
def _is_visible(idx_row, idx_col, lengths) -> bool:
    """
    Index -> {(idx_row, idx_col): bool***REMOVED***).
    """
...
def format_table_styles(styles: CSSStyles) -> CSSStyles:
    ...
    [{'selector': 'td, th', 'props': 'a:v;'***REMOVED***]
        ---> [{'selector': 'td', 'props': 'a:v;'***REMOVED***,
              {'selector': 'th', 'props': 'a:v;'***REMOVED***]
    """
    return [
        {"selector": selector, "props": css_dict["props"]***REMOVED***
...
def _default_formatter(x: Any, precision: int, thousands: bool = False) -> Any:
    ...
    if is_float(x) or is_complex(x):
        return f"{x:,.{precision***REMOVED***f***REMOVED***" if thousands else f"{x:.{precision***REMOVED***f***REMOVED***"
    elif is_integer(x):
        return f"{x:,***REMOVED***" if thousands else str(x)
    return x
...
def _str_escape(x, escape):
    ...
    if isinstance(x, str):
        if escape == "html":
            ...
            raise ValueError(
                f"`escape` only permitted in {{'html', 'latex', 'latex-math'***REMOVED******REMOVED***, \
got {escape***REMOVED***"
***REMOVED***
    return x
...
def _render_href(x, format):
    ...
    if isinstance(x, str):
        if format == "html":
            href = '<a href="{0***REMOVED***" target="_blank">{0***REMOVED***</a>'
        elif format == "latex":
            href = r"\href{{{0***REMOVED******REMOVED******REMOVED***{{{0***REMOVED******REMOVED******REMOVED***"
        else:
...
def _maybe_wrap_formatter(
    ...
    if isinstance(formatter, str):
        ...
        raise TypeError(f"'formatter' expected str or callable, got {type(formatter)***REMOVED***")
    ...
    if isinstance(style, str):
        ...
        try:
            ...
            raise ValueError(
                ...
                f"for example 'attr: val;'. '{style***REMOVED***' was given."
***REMOVED***
    return style
...
class Tooltips:
    ...
    def _class_styles(self):
        ...
        return [
            {
                "selector": f".{self.class_name***REMOVED***",
    ...
    def _pseudo_css(self, uuid: str, name: str, row: int, col: int, text: str):
        ...
        For example:
            [{"selector": "T__row1_col1:hover .pd-t",
             "props": [("visibility", "visible")]***REMOVED***,
            {"selector": "T__row1_col1 .pd-t::after",
             "props": [("content", "Some Valid Text String")]***REMOVED***]
        ...
        return [
            {
                "selector": selector_id + f":hover .{name***REMOVED***",
                "props": [("visibility", "visible")],
            ***REMOVED***,
            {
                "selector": selector_id + f" .{name***REMOVED***::after",
                "props": [("content", f'"{text***REMOVED***"')],
            ***REMOVED***,
        ]
                ...
                for item in row:
                    if item["type"] == "td":
                        item["display_value"] = (
                            ...
                            + f'<span class="{self.class_name***REMOVED***"></span>'
            ***REMOVED***
...
def _parse_latex_table_wrapping(table_styles: CSSStyles, caption: str | None) -> bool:
    """
    Indicate whether LaTeX {tabular***REMOVED*** should be wrapped with a {table***REMOVED*** environment.

    Parses the `table_styles` and detects any selectors which must be included outside
    of {tabular***REMOVED***, i.e. indicating that wrapping must occur, and therefore return True,
    or if a caption exists and requires similar.
    """
    IGNORED_WRAPPERS = ["toprule", "midrule", "bottomrule", "column_format"]
    # ignored selectors are included with {tabular***REMOVED*** so do not need wrapping
    return (
...
def _parse_latex_table_styles(table_styles: CSSStyles, selector: str) -> str | None:
    ...
    Examples
    --------
    >>> table_styles = [{'selector': 'foo', 'props': [('attr','value')]***REMOVED***,
    ...                 {'selector': 'bar', 'props': [('attr', 'overwritten')]***REMOVED***,
    ...                 {'selector': 'bar', 'props': [('a1', 'baz'), ('a2', 'ignore')]***REMOVED***]
...
def _parse_latex_cell_styles(
    ...
    '\<command><options>{display_value***REMOVED***', and this value is treated as the
    display value for the next iteration.

    The most recent style forms the inner component, for example for styles:
    `[('c1', 'o1'), ('c2', 'o2')]` this returns: `\c1o1{\c2o2{display_value***REMOVED******REMOVED***`
    ...
    We create some parsing flags to identify the different behaviours:
     ...
     - `--rwrap`        : `\<command><options>{<display_value>***REMOVED***`
     - `--wrap`         : `{\<command><options> <display_value>***REMOVED***`
     - `--nowrap`       : `\<command><options> <display_value>`
     - `--lwrap`        : `{\<command><options>***REMOVED*** <display_value>`
     - `--dwrap`        : `{\<command><options>***REMOVED***{<display_value>***REMOVED***`

    For example for styles:
    `[('c1', 'o1--wrap'), ('c2', 'o2')]` this returns: `{\c1o1 \c2o2{display_value***REMOVED******REMOVED***
    """
    if convert_css:
    ...
    for command, options in latex_styles[::-1]:  # in reverse for most recent style
        formatter = {
            "--wrap": f"{{\\{command***REMOVED***--to_parse {display_value***REMOVED******REMOVED******REMOVED***",
            "--nowrap": f"\\{command***REMOVED***--to_parse {display_value***REMOVED***",
            "--lwrap": f"{{\\{command***REMOVED***--to_parse***REMOVED******REMOVED*** {display_value***REMOVED***",
            "--rwrap": f"\\{command***REMOVED***--to_parse{{{display_value***REMOVED******REMOVED******REMOVED***",
            "--dwrap": f"{{\\{command***REMOVED***--to_parse***REMOVED******REMOVED***{{{display_value***REMOVED******REMOVED******REMOVED***",
        ***REMOVED***
        display_value = f"\\{command***REMOVED***{options***REMOVED*** {display_value***REMOVED***"
...
def _parse_latex_header_span(
    ...
    Requires the package {multirow***REMOVED***, whereas multicol support is usually built in
    to the {tabular***REMOVED*** environment.

    Examples
    --------
    >>> cell = {'cellstyle': '', 'display_value':'text', 'attributes': 'colspan="3"'***REMOVED***
    >>> _parse_latex_header_span(cell, 't', 'c')
    '\\multicolumn{3***REMOVED***{c***REMOVED***{text***REMOVED***'
    """
    ...
    if "attributes" in cell:
        ...
        if 'colspan="' in attrs:
            ...
            if "naive-l" == multicol_align:
                out = f"{{{display_val***REMOVED******REMOVED******REMOVED***" if wrap else f"{display_val***REMOVED***"
                blanks = " & {***REMOVED***" if wrap else " &"
                return out + blanks * (colspan - 1)
            elif "naive-r" == multicol_align:
                out = f"{{{display_val***REMOVED******REMOVED******REMOVED***" if wrap else f"{display_val***REMOVED***"
                blanks = "{***REMOVED*** & " if wrap else "& "
                return blanks * (colspan - 1) + out
            return f"\\multicolumn{{{colspan***REMOVED******REMOVED******REMOVED***{{{multicol_align***REMOVED******REMOVED******REMOVED***{{{display_val***REMOVED******REMOVED******REMOVED***"
        elif 'rowspan="' in attrs:
            if multirow_align == "naive":
                return display_val
            rowspan = attrs[attrs.find('rowspan="') + 9 :]
            rowspan = int(rowspan[: rowspan.find('"')])
            return f"\\multirow[{multirow_align***REMOVED***]{{{rowspan***REMOVED******REMOVED******REMOVED***{{****REMOVED******REMOVED***{{{display_val***REMOVED******REMOVED******REMOVED***"
    if wrap:
        return f"{{{display_val***REMOVED******REMOVED******REMOVED***"
    else:
        return display_val
...
def _parse_latex_css_conversion(styles: CSSList) -> CSSList:
    ...
    def font_weight(value, arg):
        if value in ("bold", "bolder"):
            return "bfseries", f"{arg***REMOVED***"
        return None

    def font_style(value, arg):
        if value == "italic":
            return "itshape", f"{arg***REMOVED***"
        if value == "oblique":
            return "slshape", f"{arg***REMOVED***"
        return None
    ...
    def color(value, user_arg, command, comm_arg):
        ...
        CSS colors have 5 formats to process:
         ...
         - 6 digit hex code: "#ff23ee"     --> [HTML]{FF23EE***REMOVED***
         - 3 digit hex code: "#f0e"        --> [HTML]{FF00EE***REMOVED***
         - rgba: rgba(128, 255, 0, 0.5)    --> [rgb]{0.502, 1.000, 0.000***REMOVED***
         - rgb: rgb(128, 255, 0,)          --> [rbg]{0.502, 1.000, 0.000***REMOVED***
         - string: red                     --> {red***REMOVED***
        ...
        if value[0] == "#" and len(value) == 7:  # color is hex code
            return command, f"[HTML]{{{value[1:].upper()***REMOVED******REMOVED******REMOVED***{arg***REMOVED***"
        if value[0] == "#" and len(value) == 4:  # color is short hex code
            val = f"{value[1].upper()*2***REMOVED***{value[2].upper()*2***REMOVED***{value[3].upper()*2***REMOVED***"
            return command, f"[HTML]{{{val***REMOVED******REMOVED******REMOVED***{arg***REMOVED***"
            ...
            return command, f"[rgb]{{{r:.3f***REMOVED***, {g:.3f***REMOVED***, {b:.3f***REMOVED******REMOVED******REMOVED***{arg***REMOVED***"
        else:
            return command, f"{{{value***REMOVED******REMOVED******REMOVED***{arg***REMOVED***"  # color is likely string-named
...
def _escape_latex(s: str) -> str:
    r"""
    Replace the characters ``&``, ``%``, ``$``, ``#``, ``_``, ``{``, ``***REMOVED***``,
