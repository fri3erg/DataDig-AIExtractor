...
class OpenpyxlWriter(ExcelWriter):
    ...
    def sheets(self) -> dict[str, Any]:
        ...
        result = {name: self.book[name] for name in self.book.sheetnames***REMOVED***
        return result
    ...
    def _convert_to_style_kwargs(cls, style_dict: dict) -> dict[str, Serialisable]:
        ...
        style_kwargs : dict
            ...
            appropriate class.
        """
        _style_key_map = {"borders": "border"***REMOVED***

        style_kwargs: dict[str, Serialisable] = {***REMOVED***
        for k, v in style_dict.items():
            k = _style_key_map.get(k, k)
            _conv_to_x = getattr(cls, f"_convert_to_{k***REMOVED***", lambda x: None)
            new_v = _conv_to_x(v)
            if new_v:
    ...
    def _convert_to_fill(cls, fill_dict: dict[str, Any]):
        ...
        ***REMOVED***
        ...
        _gradient_fill_key_map = {"fill_type": "type"***REMOVED***

        pfill_kwargs = {***REMOVED***
        gfill_kwargs = {***REMOVED***
    ...
    def _convert_to_side(cls, side_spec):
        ...
        _side_key_map = {"border_style": "style"***REMOVED***
    ...
    def _convert_to_border(cls, border_dict):
        ...
        _border_key_map = {"diagonalup": "diagonalUp", "diagonaldown": "diagonalDown"***REMOVED***

        border_kwargs = {***REMOVED***
    ...
    def _write_cells(
        ...
        _style_cache: dict[str, dict[str, Serialisable]] = {***REMOVED***
        ...
        if sheet_name in self.sheets and self._if_sheet_exists != "new":
            if "r+" in self._mode:
                if self._if_sheet_exists == "replace":
                    ...
                    raise ValueError(
                        f"Sheet '{sheet_name***REMOVED***' already exists and "
        ...
        ***REMOVED***
                    ...
                    raise ValueError(
                        f"'{self._if_sheet_exists***REMOVED***' is not valid for if_sheet_exists. "
...
***REMOVED***
            ...
            style_kwargs: dict[str, Serialisable] | None = {***REMOVED***
            if cell.style:
                key = str(cell.style)
...
class OpenpyxlReader(BaseExcelReader["Workbook"]):
    ...
    def load_workbook(
        ...
        default_kwargs = {"read_only": True, "data_only": True, "keep_links": False***REMOVED***
