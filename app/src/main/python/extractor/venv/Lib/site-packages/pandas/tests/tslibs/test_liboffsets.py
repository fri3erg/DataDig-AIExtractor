...
@pytest.mark.parametrize(
    ...
    [
        # Before March 1.
        (datetime(2017, 2, 10), {2: 1, -7: -7, 0: 0***REMOVED***),
        # After March 1.
        (Timestamp("2014-03-15", tz="US/Eastern"), {2: 2, -7: -6, 0: 1***REMOVED***),
    ],
)
...
@pytest.mark.parametrize(
    ...
    [
        # Before June 30.
        (datetime(1999, 6, 29), {5: 4, -7: -7, 0: 0***REMOVED***),
        # After June 30.
        (Timestamp(2072, 8, 24, 6, 17, 18), {5: 5, -7: -6, 0: 1***REMOVED***),
    ],
)
...
def test_roll_qtr_day_not_mod_unequal(day_opt, month, n):
    expected = {3: {-3: -2, 4: 4***REMOVED***, 5: {-3: -3, 4: 3***REMOVED******REMOVED***
...
@pytest.mark.parametrize(
    ...
    [
        # Monday.
        (datetime(1999, 5, 31), 2, {-1: {"start": 0, "business_start": 0***REMOVED******REMOVED***),
        # Saturday.
        (
            Timestamp(2072, 10, 1, 6, 17, 18),
            4,
            {2: {"end": 1, "business_end": 1, "business_start": 1***REMOVED******REMOVED***,
        ),
        # First business day.
        (
            Timestamp(2072, 10, 3, 6, 17, 18),
            4,
            {2: {"end": 1, "business_end": 1***REMOVED***, -1: {"start": 0***REMOVED******REMOVED***,
        ),
    ],
)
...
def test_roll_qtr_day_mod_equal(other, month, exp_dict, n, day_opt):
    ...
    expected = exp_dict.get(n, {***REMOVED***).get(day_opt, n)
    assert roll_qtrday(other, n, month, day_opt, modby=3) == expected


@pytest.mark.parametrize(
    "n,expected", [(42, {29: 42, 1: 42, 31: 41***REMOVED***), (-4, {29: -4, 1: -3, 31: -4***REMOVED***)]
)
