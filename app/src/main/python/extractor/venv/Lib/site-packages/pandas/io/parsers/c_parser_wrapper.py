    ...
    def __init__(self, src: ReadCsvBuffer[str], **kwds) -> None:
        ...
        if self._reader.header is None:
            ...
            (
                ...
                self.col_names,
                passed_names,
***REMOVED*** = self._extract_multi_indexer_columns(
                self._reader.header,
...
***REMOVED***:
                ...
                (
                    ...
                    self.names,  # type: ignore[has-type]
                    self.index_col,
    ***REMOVED*** = self._clean_index_names(
                    # error: Cannot determine type of 'names'
                    self.names,  # type: ignore[has-type]
                    # error: Cannot determine type of 'index_col'
                    self.index_col,  # type: ignore[has-type]
    ***REMOVED***
    ...
    def _set_noconvert_columns(self) -> None:
        ...
        names_dict = {x: i for i, x in enumerate(self.orig_names)***REMOVED***
    ...
    ***REMOVED***
                ...
                col_dict = {k: v for k, v in col_dict.items() if k in columns***REMOVED***
        ...
        if self._reader.leading_cols:
            ...
            if self.index_col and self._reader.leading_cols != len(self.index_col):
                raise ParserError(
                    ...
                    f"{len(self.index_col)***REMOVED*** number of columns, but "
                    f"{self._reader.leading_cols***REMOVED*** left to parse."
    ***REMOVED***
            ...
            data = {k: v for k, (i, v) in zip(names, data_tups)***REMOVED***
...
def _concatenate_chunks(chunks: list[dict[int, ArrayLike]]) -> dict:
    ...
    for name in names:
        ...
        dtypes = {a.dtype for a in arrs***REMOVED***
        non_cat_dtypes = {x for x in dtypes if not isinstance(x, CategoricalDtype)***REMOVED***
    ...
    if warning_columns:
        ...
        warning_message = " ".join(
            [
                f"Columns ({warning_names***REMOVED***) have mixed types. "
...
def ensure_dtype_objs(
    ...
    if isinstance(dtype, defaultdict):
        ...
        return {k: pandas_dtype(dtype[k]) for k in dtype***REMOVED***
