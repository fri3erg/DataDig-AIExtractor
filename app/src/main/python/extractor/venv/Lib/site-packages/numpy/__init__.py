...
if __NUMPY_SETUP__:
    ...
    # mapping of {name: (value, deprecation_msg)***REMOVED***
    __deprecated_attrs__ = {***REMOVED***
    ...
    _msg = (
        "module 'numpy' has no attribute '{n***REMOVED***'.\n"
        "`np.{n***REMOVED***` was a deprecated alias for the builtin `{n***REMOVED***`. "
        "To avoid this error in existing code, use `{n***REMOVED***` by itself. "
        "Doing this will not modify any behavior and is safe. {extended_msg***REMOVED***\n"
        "The aliases was originally deprecated in NumPy 1.20; for more "
        "details and guidance see the original release note at:\n"
        "    https://numpy.org/devdocs/release/1.20.0-notes.html#deprecations")

    _specific_msg = (
        "If you specifically wanted the numpy scalar type, use `np.{***REMOVED***` here.")

    _int_extended_msg = (
        "When replacing `np.{***REMOVED***`, you may wish to use e.g. `np.int64` "
    ...
    _msg = (
        "`np.{n***REMOVED***` is a deprecated alias for `{an***REMOVED***`.  (Deprecated NumPy 1.24)")
    ...
    __future_scalars__ = {"bool", "long", "ulong", "str", "bytes", "object"***REMOVED***

    __deprecated_attrs__.update({
        n: (alias, _msg.format(n=n, an=an)) for n, alias, an in _type_info***REMOVED***)
    ...
    __expired_functions__ = {
        name: (f'In accordance with NEP 32, the function {name***REMOVED*** was removed '
               'from NumPy version 1.20.  A replacement for this function '
               'is available in the numpy_financial library: '
               'https://pypi.org/project/numpy-financial')
        for name in _financial_names***REMOVED***
    ...
    def __getattr__(attr):
        ...
        if attr in __future_scalars__:
            ...
            # the AttributeError
            warnings.warn(
                f"In the future `np.{attr***REMOVED***` will be defined as the "
        ...
        raise AttributeError("module {!r***REMOVED*** has no attribute "
                             "{!r***REMOVED***".format(__name__, attr))

    def __dir__():
        public_symbols = globals().keys() | {'testing'***REMOVED***
        public_symbols -= {
            "core", "matrixlib",
    ...
    def _sanity_check():
        ...
        try:
            ...
            msg = ("The current Numpy installation ({!r***REMOVED***) fails to "
            ...
            if len(w) > 0:
                for _wn in w:
                    if _wn.category is exceptions.RankWarning:
                        ...
                        error_message = f"{_wn.category.__name__***REMOVED***: {str(_wn.message)***REMOVED***"
                        msg = (
