...
***REMOVED***
    ...
    if not isinstance(ssl, SSL_ALLOWED_TYPES):
        raise TypeError(
            ...
            "got {!r***REMOVED*** instead.".format(ssl)
        )
    return ssl
...
class ClientRequest:
    GET_METHODS = {
        ...
        hdrs.METH_TRACE,
    ***REMOVED***
    POST_METHODS = {hdrs.METH_PATCH, hdrs.METH_POST, hdrs.METH_PUT***REMOVED***
    ALL_METHODS = GET_METHODS.union(POST_METHODS).union({hdrs.METH_DELETE***REMOVED***)
    ...
    ***REMOVED***
    ...
    def __init__(
        ...
        *,
        ...
        if match:
            raise ValueError(
                f"Method cannot contain non-token characters {method!r***REMOVED*** "
                "(found at least {match.group()!r***REMOVED***)"
***REMOVED***
    ...
    def update_version(self, version: Union[http.HttpVersion, str]) -> None:
        ...
        if isinstance(version, str):
            ...
            try:
                ...
                raise ValueError(
                    f"Can not parse http version number: {version***REMOVED***"
    ***REMOVED*** from None
    ...
    async def send(self, conn: "Connection") -> "ClientResponse":
        ...
        if self.method == hdrs.METH_CONNECT:
            ...
            if helpers.is_ipv6_address(connect_host):
                connect_host = f"[{connect_host***REMOVED***]"
            path = f"{connect_host***REMOVED***:{self.url.port***REMOVED***"
...
***REMOVED***,
        ...
        # status + headers
        status_line = "{0***REMOVED*** {1***REMOVED*** HTTP/{v.major***REMOVED***.{v.minor***REMOVED***".format(
...
class ClientResponse(HeadersMixin):
    ...
    def __init__(
        ...
        *,
        ...
        self._timer = timer if timer is not None else TimerNoop()
        self._cache: Dict[str, Any] = {***REMOVED***
        self._traces = traces
        self._loop = loop
    ...
    def __del__(self, _warnings: Any = warnings) -> None:
        ...
        if self._connection is not None:
            ...
            if self._loop.get_debug():
                ...
                _warnings.warn(f"Unclosed response {self!r***REMOVED***", ResourceWarning, **kwargs)
                context = {"client_response": self, "message": "Unclosed response"***REMOVED***
...
***REMOVED***.decode("ascii")
        ...
        print(
            "<ClientResponse({***REMOVED***) [{***REMOVED*** {***REMOVED***]>".format(
