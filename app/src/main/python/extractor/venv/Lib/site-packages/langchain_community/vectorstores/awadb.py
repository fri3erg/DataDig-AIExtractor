...
***REMOVED***
        ...
        self.table2embeddings: dict[str, Embeddings] = {***REMOVED***
...
***REMOVED***
    ...
    def similarity_search(
        ...
        **kwargs: Any,
        ...
        Args:
            ...
            E.g. `{"color" : "red", "price": 4.20***REMOVED***`. Optional.
            E.g. `{"max_price" : 15.66, "min_price": 4.20***REMOVED***`
            `price` is the metadata field, means range filter(4.20<'price'<15.66).
            E.g. `{"maxe_price" : 15.66, "mine_price": 4.20***REMOVED***`
            `price` is the metadata field, means range filter(4.20<='price'<=15.66).
            kwargs: Any possible extend parameters in the future.
        ...
        not_include_fields: Set[str] = {"text_embedding", "_id", "score"***REMOVED***
    ...
    def similarity_search_with_score(
        ...
        **kwargs: Any,
        ...
        not_include_fields: Set[str] = {"text_embedding", "_id"***REMOVED***
    ...
    def max_marginal_relevance_search_by_vector(
        ...
        **kwargs: Any,
        ...
        not_include_fields: set = {"_id", "score"***REMOVED***
