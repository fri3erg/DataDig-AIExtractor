...
class ODSWriter(ExcelWriter):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        self._style_dict: dict[str, str] = {***REMOVED***
    ...
    def _make_table_cell_attributes(self, cell) -> dict[str, int | str]:
        ...
        """
        attributes: dict[str, int | str] = {***REMOVED***
...
***REMOVED***
            ...
            # Fast formatting
            value = f"{val.year***REMOVED***-{val.month:02d***REMOVED***-{val.day:02d***REMOVED***"
            # Slow but locale-dependent
...
***REMOVED***
    ...
    def _process_style(self, style: dict[str, Any] | None) -> str | None:
        ...
        name = f"pd{len(self._style_dict)+1***REMOVED***"
        ...
        if "borders" in style:
            ...
            for side, thickness in borders.items():
                thickness_translation = {"thin": "0.75pt solid #000000"***REMOVED***
                odf_style.addElement(
                    TableCellProperties(
                        attributes={f"border{side***REMOVED***": thickness_translation[thickness]***REMOVED***
        ***REMOVED***
    ***REMOVED***
