...
***REMOVED***
    ...
    def _send_request_headers(self, request: Request) -> None:
        ...
        with map_exceptions({h11.LocalProtocolError: LocalProtocolError***REMOVED***):
            event = h11.Request(
...
***REMOVED***:
    ...
    def _receive_event(
        ...
        while True:
            with map_exceptions({h11.RemoteProtocolError: RemoteProtocolError***REMOVED***):
...
***REMOVED***:
    ...
    def info(self) -> str:
        ...
        return (
            f"{origin!r***REMOVED***, HTTP/1.1, {self._state.name***REMOVED***, "
...
class HTTP11ConnectionByteStream:
    ...
    def __iter__(self) -> Iterator[bytes]:
        kwargs = {"request": self._request***REMOVED***
        try:
