...
1,2,3,4,"""
        ...
        for default in py_unsupported:
            msg = (
                f"The {repr(default)***REMOVED*** option is not "
                f"supported with the {repr(python_engine)***REMOVED*** engine"
***REMOVED***

            kwargs = {default: object()***REMOVED***
            with pytest.raises(ValueError, match=msg):
...
***REMOVED***
            kwargs = {default: object()***REMOVED***
            default_needs_bool = {"warn_bad_lines", "error_bad_lines"***REMOVED***
            if default == "dialect":
...
def test_invalid_file_inputs(request, all_parsers):
    ...
    if parser.engine == "python":
        request.applymarker(
            pytest.mark.xfail(reason=f"{parser.engine***REMOVED*** engine supports lists.")
        )
