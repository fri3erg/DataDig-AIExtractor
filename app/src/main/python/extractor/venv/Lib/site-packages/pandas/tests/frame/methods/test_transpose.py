...
class TestTranspose:
    def test_transpose_td64_intervals(self):
        ...
        result = df.T
        expected = DataFrame({i: ii[i : i + 1] for i in range(len(ii))***REMOVED***)
    ...
    def test_transpose_tzaware_2col_single_tz(self):
        ...
        df3 = DataFrame({"A": dti, "B": dti***REMOVED***)
    ...
    def test_transpose_tzaware_2col_mixed_tz(self):
        ...
        df4 = DataFrame({"A": dti, "B": dti2***REMOVED***)
    ...
    def test_transpose_preserves_dtindex_equality_with_dst(self, tz):
        ...
        df = DataFrame({"a": range(len(idx)), "b": range(len(idx))***REMOVED***, index=idx)
        result = df.T == df.T
