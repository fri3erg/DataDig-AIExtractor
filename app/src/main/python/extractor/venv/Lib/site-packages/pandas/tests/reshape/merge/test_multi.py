...
def left():
    ...
    return DataFrame({"key1": key1, "key2": key2, "data": data***REMOVED***)
...
***REMOVED***
    ...
    def test_merge_multiple_cols_with_mixed_cols_index(self):
        ...
        df = DataFrame({"lev1": list("AAABBB"), "lev2": [1, 2, 3, 1, 2, 3], "col": 0***REMOVED***)
    ...
    def test_left_join_index_preserve_order(self):
        ...
        right = DataFrame({"v2": [5, 7]***REMOVED***, index=index)
    ...
    def test_merge_datetime_index(self, klass):
        ...
        expected = DataFrame({"a": [1, 2, 3], "key_1": exp_years***REMOVED***)

        result = df.merge(df, on=["a", on_vector], how="inner")
        tm.assert_frame_equal(result, expected)

        expected = DataFrame({"key_0": exp_years, "a_x": [1, 2, 3], "a_y": [1, 2, 3]***REMOVED***)
...
***REMOVED***
    ...
    def test_single_common_level(self):
        ...
        left = DataFrame(
            {"A": ["A0", "A1", "A2"], "B": ["B0", "B1", "B2"]***REMOVED***, index=index_left
        )
        ...
        right = DataFrame(
            {"C": ["C0", "C1", "C2", "C3"], "D": ["D0", "D1", "D2", "D3"]***REMOVED***,
            index=index_right,
        )
    ...
    def test_join_multi_wrong_order(self):
        ...
        left = DataFrame(index=midx1, data={"x": [10, 20, 30, 40]***REMOVED***)
        right = DataFrame(index=midx3, data={"y": ["foo", "bar", "fing"]***REMOVED***)

        result = left.join(right)

        expected = DataFrame(
            index=midx1,
            data={"x": [10, 20, 30, 40], "y": ["fing", "foo", "bar", np.nan]***REMOVED***,
        )
