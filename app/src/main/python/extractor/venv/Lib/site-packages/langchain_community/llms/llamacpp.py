...
***REMOVED***
        ...
        model_params = {k: values[k] for k in model_param_names***REMOVED***
        ...
        try:
            ...
            raise ValueError(
                f"Could not load Llama model from path: {model_path***REMOVED***. "
                f"Received error {e***REMOVED***"
***REMOVED***
        ...
        if values["grammar"] and values["grammar_path"]:
            ...
            raise ValueError(
                ...
                f"{grammar=***REMOVED*** and {grammar_path=***REMOVED***."
***REMOVED***
    ...
    def _identifying_params(self) -> Dict[str, Any]:
        ...
        return {**{"model_path": self.model_path***REMOVED***, **self._default_params***REMOVED***
...
***REMOVED***:
    ...
    ***REMOVED***
        ...
        """
        params = {**self._get_parameters(stop), **kwargs***REMOVED***
        result = self.client(prompt=prompt, stream=True, **params)
        for part in result:
            logprobs = part["choices"][0].get("logprobs", None)
            chunk = GenerationChunk(
                text=part["choices"][0]["text"],
                generation_info={"logprobs": logprobs***REMOVED***,
***REMOVED***
            yield chunk
            if run_manager:
