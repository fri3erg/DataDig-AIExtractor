...
def betweenness_centrality_subset(G, sources, targets, normalized=False, weight=None):
    ...
    .. math::
       ...
       c_B(v) =\sum_{s\in S, t \in T***REMOVED*** \frac{\sigma(s, t|v)***REMOVED***{\sigma(s, t)***REMOVED***
    ...
    If $s = t$, $\sigma(s, t) = 1$,
    and if $v \in {s, t***REMOVED***$, $\sigma(s, t|v) = 0$ [2]_.
...
def edge_betweenness_centrality_subset(
    ...
    .. math::
       ...
       c_B(v) =\sum_{s\in S,t \in T***REMOVED*** \frac{\sigma(s, t|e)***REMOVED***{\sigma(s, t)***REMOVED***
...
def _accumulate_subset(betweenness, S, P, sigma, s, targets):
    ...
    target_set = set(targets) - {s***REMOVED***
    while S:
        w = S.pop()
        if w in target_set:
