    ...
    def create(
        ...
        *,
        ...
        if files:
            ...
            extra_headers = {"Content-Type": "multipart/form-data", **(extra_headers or {***REMOVED***)***REMOVED***
        return self._post(
            "/files",
...
***REMOVED***,
    ...
    def retrieve(
        ...
        *,
        ...
        """
        if not file_id:
            raise ValueError(f"Expected a non-empty value for `file_id` but received {file_id!r***REMOVED***")
        return self._get(
            f"/files/{file_id***REMOVED***",
            options=make_request_options(
                extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout
***REMOVED***,
            cast_to=FileObject,
        ...
        *,
        ...
        return self._get_api_list(
            ...
            options=make_request_options(
                ...
                timeout=timeout,
                query=maybe_transform({"purpose": purpose***REMOVED***, file_list_params.FileListParams),
***REMOVED***,
            model=FileObject,
        )
    ...
    def content(
        ...
        *,
        ...
        if not file_id:
            raise ValueError(f"Expected a non-empty value for `file_id` but received {file_id!r***REMOVED***")
        return self._get(
            f"/files/{file_id***REMOVED***/content",
            options=make_request_options(
                extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout
***REMOVED***,
    ...
    def retrieve_content(
        ...
        *,
        ...
        if not file_id:
            raise ValueError(f"Expected a non-empty value for `file_id` but received {file_id!r***REMOVED***")
        extra_headers = {"Accept": "application/json", **(extra_headers or {***REMOVED***)***REMOVED***
        return self._get(
            f"/files/{file_id***REMOVED***/content",
            options=make_request_options(
                extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout
***REMOVED***,
    ...
    def wait_for_processing(
        ...
        *,
        ...
        TERMINAL_STATES = {"processed", "error", "deleted"***REMOVED***
        ...
        while file.status not in TERMINAL_STATES:
            ...
            if time.time() - start > max_wait_seconds:
                raise RuntimeError(
                    f"Giving up on waiting for file {id***REMOVED*** to finish processing after {max_wait_seconds***REMOVED*** seconds."
    ***REMOVED***
