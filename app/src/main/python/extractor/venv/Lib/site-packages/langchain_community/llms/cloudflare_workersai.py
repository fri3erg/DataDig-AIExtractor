...
***REMOVED***
    ...
    def __init__(self, **kwargs: Any) -> None:
        ...
        self.endpoint_url = f"{self.base_url***REMOVED***/{self.account_id***REMOVED***/ai/run/{self.model***REMOVED***"
    ...
    def _call_api(self, prompt: str, params: Dict[str, Any]) -> requests.Response:
        ...
        data = {"prompt": prompt, "stream": self.streaming, **params***REMOVED***
    ...
    def _process_response(self, response: requests.Response) -> str:
        ...
        if response.ok:
            ...
            raise ValueError(f"Request failed with status {response.status_code***REMOVED***")
