...
PyMODINIT_FUNC PyInit_#modulename#(void) {
    ...
    import_array();
    if (PyErr_Occurred())
        {PyErr_SetString(PyExc_ImportError, \"can't initialize module #modulename# (failed to import numpy)\"); return m;***REMOVED***
...
defmod_rules = [
    {'body': '/*eof body*/',
     ...
     'latexdoc': '',
     'restdoc': '',
     'modnote': {hasnote: '#note#', l_not(hasnote): ''***REMOVED***,
     ***REMOVED***
]
...
#decl#
    static char *capi_kwlist[] = {#kwlist##kwlistopt##kwlistxa#NULL***REMOVED***;
#usercode#
#routdebugenter#
#ifdef F2PY_REPORT_ATEXIT
f2py_start_clock();
...
/*closepyobjfrom*/
#closepyobjfrom#
        ***REMOVED*** /*if (f2py_success) after callfortranroutine*/
/*cleanupfrompyobj*/
#cleanupfrompyobj#
...
""",
    ...
    'latexdoc': ['\\subsection{Wrapper function \\texttt{#texname#***REMOVED******REMOVED***\n',
                 """
\\noindent{{***REMOVED***\\verb@#docreturn##name#@{***REMOVED******REMOVED***\\texttt{(#latexdocsignatureshort#)***REMOVED***
#routnote#
...
rout_rules = [
    {  # Init
        ...
        'initf2pywraphook': '',
        'routnote': {hasnote: '--- #note#', l_not(hasnote): ''***REMOVED***,
    ***REMOVED***, {
    ...
    ***REMOVED***, {  # Subroutine
        ...
        'routine_def': {
            ...
            '    {\"#name#\",-1,{{-1***REMOVED******REMOVED***,0,0,(char *)'
            '  #F_FUNC#(#fortranname#,#FORTRANNAME#),'
            '  (f2py_init_func)#apiname#,doc_#apiname#***REMOVED***,',
            l_and(l_not(ismoduleroutine), isintent_c, l_not(isdummyroutine)):
            '    {\"#name#\",-1,{{-1***REMOVED******REMOVED***,0,0,(char *)#fortranname#,'
            '  (f2py_init_func)#apiname#,doc_#apiname#***REMOVED***,',
            l_and(l_not(ismoduleroutine), isdummyroutine):
            '    {\"#name#\",-1,{{-1***REMOVED******REMOVED***,0,0,NULL,'
            '  (f2py_init_func)#apiname#,doc_#apiname#***REMOVED***,',
        ***REMOVED***,
        'need': {l_and(l_not(l_or(ismoduleroutine, isintent_c)), l_not(isdummyroutine)): 'F_FUNC'***REMOVED***,
        'callfortranroutine': [
            {debugcapi: [
        ...
        ***REMOVED*** else {"""***REMOVED***,
            {isthreadsafe: '            Py_BEGIN_ALLOW_THREADS'***REMOVED***,
            {hascallstatement: '''                #callstatement#;
                /*(*f2py_func)(#callfortran#);*/'''***REMOVED***,
            {l_not(l_or(hascallstatement, isdummyroutine))
                   : '                (*f2py_func)(#callfortran#);'***REMOVED***,
            {isthreadsafe: '            Py_END_ALLOW_THREADS'***REMOVED***,
            {hasexternals: """        ***REMOVED***"""***REMOVED***
        ],
    ...
    ***REMOVED***
    '''***REMOVED***,
        'need': {l_not(l_or(ismoduleroutine, isdummyroutine)): ['F_WRAPPEDFUNC', 'F_FUNC']***REMOVED***,
        'callfortranroutine': [
            {debugcapi: [
    ...
    ***REMOVED***, {  # Function
        'functype': '#ctype#',
        'docreturn': {l_not(isintent_hide): '#rname#,'***REMOVED***,
        'docstrout': '#pydocsignout#',
        'latexdocstrout': ['\\item[]{{***REMOVED***\\verb@#pydocsignout#@{***REMOVED******REMOVED***',
                           {hasresultnote: '--- #resultnote#'***REMOVED***],
    ...
    ***REMOVED***, {  # Scalar function
        ...
        ***REMOVED***,
        'decl': [{iscomplexfunction_warn: '    #ctype# #name#_return_value={0,0***REMOVED***;',
                  l_not(iscomplexfunction): '    #ctype# #name#_return_value=0;'***REMOVED***,
                 {iscomplexfunction:
...
'''***REMOVED***,
            {l_not(l_or(hascallstatement, isdummyroutine))
                   : '    #name#_return_value = (*f2py_func)(#callfortran#);'***REMOVED***,
            {isthreadsafe: '    Py_END_ALLOW_THREADS'***REMOVED***,
            {hasexternals: '    ***REMOVED***'***REMOVED***,
            {l_and(debugcapi, iscomplexfunction)
                   : '    fprintf(stderr,"#routdebugshowvalue#\\n",#name#_return_value.r,#name#_return_value.i);'***REMOVED***,
            {l_and(debugcapi, l_not(iscomplexfunction)): '    fprintf(stderr,"#routdebugshowvalue#\\n",#name#_return_value);'***REMOVED***],
        'pyobjfrom': {iscomplexfunction: '    #name#_return_value_capi = pyobj_from_#ctype#1(#name#_return_value);'***REMOVED***,
        'need': [{l_not(isdummyroutine): 'F_FUNC'***REMOVED***,
                 {iscomplexfunction: 'pyobj_from_#ctype#1'***REMOVED***,
                 {islong_longfunction: 'long_long'***REMOVED***,
                 {islong_doublefunction: 'long_double'***REMOVED***],
        'returnformat': {l_not(isintent_hide): '#rformat#'***REMOVED***,
        'return': {iscomplexfunction: ',#name#_return_value_capi',
                   l_not(l_or(iscomplexfunction, isintent_hide)): ',#name#_return_value'***REMOVED***,
        '_check': l_and(isfunction, l_not(isstringfunction), l_not(isfunction_wrap))
    ***REMOVED***, {  # String function # in use for --no-wrap
        'declfortranroutine': 'extern void #F_FUNC#(#fortranname#,#FORTRANNAME#)(#callprotoargument#);',
        'routine_def': {l_not(l_or(ismoduleroutine, isintent_c)):
                        '    {\"#name#\",-1,{{-1***REMOVED******REMOVED***,0,0,(char *)#F_FUNC#(#fortranname#,#FORTRANNAME#),(f2py_init_func)#apiname#,doc_#apiname#***REMOVED***,',
                        l_and(l_not(ismoduleroutine), isintent_c):
                        '    {\"#name#\",-1,{{-1***REMOVED******REMOVED***,0,0,(char *)#fortranname#,(f2py_init_func)#apiname#,doc_#apiname#***REMOVED***,'
                        ***REMOVED***,
...
""",
                              ...
                              {hasexternals: '        ***REMOVED***'***REMOVED***,
                              {debugcapi:
                                  '        fprintf(stderr,"#routdebugshowvalue#\\n",#name#_return_value_len,#name#_return_value);'***REMOVED***,
                              '    ***REMOVED*** /* if (f2py_success) after (string)malloc */',
                              ],
...
aux_rules = [
    ...
    ***REMOVED***,
    ...
    {  # Common
        'decl': ['    #ctype# *#varname# = NULL;',
                 '    npy_intp #varname#_Dims[#rank#] = {#rank*[-1]#***REMOVED***;',
                 '    const int #varname#_Rank = #rank#;',
                 ],
        'need':['len..', {hasinitvalue: 'forcomb'***REMOVED***, {hasinitvalue: 'CFUNCSMESS'***REMOVED***],
        '_check': isarray
    ***REMOVED***,
    # Scalararray
    {  # Common
    ...
    ***REMOVED***,
    ...
    # Stringarray
    {
        'callfortranappend': {isarrayofstrings: 'flen(#varname#),'***REMOVED***,
        'need': 'string',
...
arg_rules = [
    ...
    ***REMOVED***,
    # Doc signatures
    {
        'docstropt': {l_and(isoptional, isintent_nothide): '#pydocsign#'***REMOVED***,
        'docstrreq': {l_and(isrequired, isintent_nothide): '#pydocsign#'***REMOVED***,
        'docstrout': {isintent_out: '#pydocsignout#'***REMOVED***,
        'latexdocstropt': {l_and(isoptional, isintent_nothide): ['\\item[]{{***REMOVED***\\verb@#pydocsign#@{***REMOVED******REMOVED***',
                                                                 {hasnote: '--- #note#'***REMOVED***]***REMOVED***,
        'latexdocstrreq': {l_and(isrequired, isintent_nothide): ['\\item[]{{***REMOVED***\\verb@#pydocsign#@{***REMOVED******REMOVED***',
                                                                 {hasnote: '--- #note#'***REMOVED***]***REMOVED***,
        'latexdocstrout': {isintent_out: ['\\item[]{{***REMOVED***\\verb@#pydocsignout#@{***REMOVED******REMOVED***',
                                          {l_and(hasnote, isintent_hide): '--- #note#',
                                           l_and(hasnote, isintent_nothide): '--- See above.'***REMOVED***]***REMOVED***,
        'depend': ''
    ***REMOVED***,
    ...
    ***REMOVED***,
    ...
    {  # Common
        'docsignxa': {isintent_nothide: '#varname#_extra_args=(),'***REMOVED***,
        ...
        'latexdocstropt': {isintent_nothide: '\\item[]{{***REMOVED***\\verb@#varname#_extra_args := () input tuple@{***REMOVED******REMOVED*** --- Extra arguments for call-back function {{***REMOVED***\\verb@#varname#@{***REMOVED******REMOVED***.'***REMOVED***,
        'decl': ['    #cbname#_t #varname#_cb = { Py_None, NULL, 0 ***REMOVED***;',
        ...
        'args_capi': {isrequired: ',&#varname#_cb.capi'***REMOVED***,
        'keys_capi': {isoptional: ',&#varname#_cb.capi'***REMOVED***,
        'keys_xa': ',&PyTuple_Type,&#varname#_xa_capi',
        'setjmpbuf': '(setjmp(#varname#_cb.jmpbuf))',
        'callfortran': {l_not(isintent_callback): '#varname#_cptr,'***REMOVED***,
...
""",
    ...
    ***REMOVED***,
    ...
    {  # Common
        ...
        'callfortran': {l_or(isintent_c, isattr_value): '#varname#,', l_not(l_or(isintent_c, isattr_value)): '&#varname#,'***REMOVED***,
    ...
    ***REMOVED***, {  # Not hidden
    ...
    if (f2py_success) {"""***REMOVED***,
        'closepyobjfrom': {isintent_inout: "    ***REMOVED*** /*if (f2py_success) of #varname# pyobjfrom*/"***REMOVED***,
    ...
    ***REMOVED***, {
    ...
    if (f2py_success) {'''***REMOVED***,
        ...
        'cleanupfrompyobj': '    ***REMOVED*** /*if (f2py_success) of #varname#*/',
        'need': {l_not(islogical): '#ctype#_from_pyobj'***REMOVED***,
    ...
    ***REMOVED***,
    ...
    {  # Common
        'decl': '    #ctype# #varname#;',
        'callfortran': {isintent_c: '#varname#,', l_not(isintent_c): '&#varname#,'***REMOVED***,
        'pyobjfrom': {debugcapi: '    fprintf(stderr,"#vardebugshowvalue#\\n",#varname#.r,#varname#.i);'***REMOVED***,
    ...
    ***REMOVED***, {
        'frompyobj': [{hasinitvalue: '    if (#varname#_capi==Py_None) {#varname#.r = #init.r#, #varname#.i = #init.i#;***REMOVED*** else'***REMOVED***,
                      {l_and(isoptional, l_not(hasinitvalue))
                             : '    if (#varname#_capi != Py_None)'***REMOVED***,
                      '        f2py_success = #ctype#_from_pyobj(&#varname#,#varname#_capi,"#pyname#() #nth# (#varname#) can\'t be converted to #ctype#");'
                      '\n    if (f2py_success) {'],
        'cleanupfrompyobj': '    ***REMOVED***  /*if (f2py_success) of #varname# frompyobj*/',
    ...
    ***REMOVED***, {
        ...
        '_depend': ''
    ***REMOVED***, {  # Common
        'pyobjfrom': {isintent_out: '    #varname#_capi = pyobj_from_#ctype#1(#varname#);'***REMOVED***,
    ...
    ***REMOVED***,
    ...
    {  # Common
        ...
        'pyobjfrom':[
            {debugcapi:
             '    fprintf(stderr,'
             '"#vardebugshowvalue#\\n",slen(#varname#),#varname#);'***REMOVED***,
            # The trailing null value for Fortran is blank.
            {l_and(isintent_out, l_not(isintent_c)):
             "        STRINGPADN(#varname#, slen(#varname#), ' ', '\\0');"***REMOVED***,
        ],
        'return': {isintent_out: ',#varname#'***REMOVED***,
        'need': ['len..',
                 {l_and(isintent_out, l_not(isintent_c)): 'STRINGPADN'***REMOVED***],
        '_check': isstring
    ***REMOVED***, {  # Common
        'frompyobj': [
            """\
...
"""`#varname#\' of #pyname# to C #ctype#\");
    if (f2py_success) {""",
        ...
        'cleanupfrompyobj': """\
        STRINGFREE(#varname#);
    ***REMOVED***  /*if (f2py_success) of #varname#*/""",
        'need': ['#ctype#_from_pyobj', 'len..', 'STRINGFREE',
                 {l_not(isintent_c): 'STRINGPADN'***REMOVED***],
        '_check':isstring,
        '_depend':''
    ***REMOVED***, {  # Not hidden
        'argformat': {isrequired: 'O'***REMOVED***,
    ...
    if (f2py_success) {'''***REMOVED***],
        ...
        'need': {isintent_inout: 'try_pyarr_from_#ctype#',
                 l_and(isintent_inout, l_not(isintent_c)): 'STRINGPADN'***REMOVED***,
    ...
    ***REMOVED***,
    ...
    {  # Common
        'decl': ['    #ctype# *#varname# = NULL;',
                 ...
                 {isstringarray: '    int slen(#varname#) = 0;'***REMOVED***,
                 ],
        'callfortran':'#varname#,',
        'callfortranappend': {isstringarray: 'slen(#varname#),'***REMOVED***,
        'return': {isintent_out: ',capi_#varname#_as_array'***REMOVED***,
        'need': 'len..',
        '_check': isarray
    ***REMOVED***, {  # intent(overwrite) array
    ...
    ***REMOVED***, {
        ...
        '_depend': '',
    ***REMOVED***, {
        'need': [{hasinitvalue: 'forcomb'***REMOVED***, {hasinitvalue: 'CFUNCSMESS'***REMOVED***],
        '_check': isarray,
        '_depend': ''
    ***REMOVED***, {  # Not hidden
        'decl': '    PyObject *#varname#_capi = Py_None;',
    ...
    ***REMOVED***, {
        'frompyobj': [
            ...
            {isintent_hide:
             ...
             '  capi_#varname#_intent,Py_None,capi_errmess);'***REMOVED***,
            {isintent_nothide:
             '    capi_#varname#_as_array = ndarray_from_pyobj('
             '  #atype#,#elsize#,#varname#_Dims,#varname#_Rank,'
             '  capi_#varname#_intent,#varname#_capi,capi_errmess);'***REMOVED***,
            """\
...
""",
            {isstringarray:
             '    slen(#varname#) = f2py_itemsize(#varname#);'***REMOVED***,
            {hasinitvalue: [
                {isintent_nothide:
                 '    if (#varname#_capi == Py_None) {'***REMOVED***,
                {isintent_hide: '    {'***REMOVED***,
                {iscomplexarray: '        #ctype# capi_c;'***REMOVED***,
                """\
        int *_i,capi_i=0;
    ...
    ***REMOVED***
    ...
    if((PyObject *)capi_#varname#_as_array!=#varname#_capi) {
        Py_XDECREF(capi_#varname#_as_array); ***REMOVED***"""***REMOVED***,
            {l_and(isintent_hide, l_not(isintent_out))
                   : """        Py_XDECREF(capi_#varname#_as_array);"""***REMOVED***,
            {hasinitvalue: '    ***REMOVED***  /*if (f2py_success) of #varname# init*/'***REMOVED***,
        ],
        '_check': isarray,
        '_depend': ''
    ***REMOVED***,
...
check_rules = [
    ...
    ***REMOVED***, {
        ...
        'cleanupfrompyobj': '    ***REMOVED*** /*CHECKSCALAR(#check#)*/',
        'need': 'CHECKSCALAR',
        '_check': l_and(isscalar, l_not(iscomplex)),
        '_break': ''
    ***REMOVED***, {
        'frompyobj': '    CHECKSTRING(#check#,\"#check#\",\"#nth# #varname#\",\"#varshowvalue#\",#varname#) {',
        'cleanupfrompyobj': '    ***REMOVED*** /*CHECKSTRING(#check#)*/',
        'need': 'CHECKSTRING',
        '_check': isstring,
        '_break': ''
    ***REMOVED***, {
        ...
        'cleanupfrompyobj': '    ***REMOVED*** /*CHECKARRAY(#check#)*/',
        '_check': isarray,
        '_break': ''
    ***REMOVED***, {
        'need': 'CHECKGENERIC',
        'frompyobj': '    CHECKGENERIC(#check#,\"#check#\",\"#nth# #varname#\") {',
        'cleanupfrompyobj': '    ***REMOVED*** /*CHECKGENERIC(#check#)*/',
    ***REMOVED***
]
...
def buildmodule(m, um):
    ...
    rd = dictappend({'f2py_version': f2py_version***REMOVED***, vrd)
    funcwrappers = []
    ...
    for n in m['interfaced']:
        ...
        for nb in nb_list:
            ...
            if options['emptygen']:
                ...
                Path(f"{b_path***REMOVED***/{vrd['coutput']***REMOVED***").touch()
                if isf90:
                    # f77 + f90 wrappers
                    outmess(f'    Maybe empty "{m_name***REMOVED***-f2pywrappers2.f90"\n')
                    Path(f'{b_path***REMOVED***/{m_name***REMOVED***-f2pywrappers2.f90').touch()
                    outmess(f'    Maybe empty "{m_name***REMOVED***-f2pywrappers.f"\n')
                    Path(f'{b_path***REMOVED***/{m_name***REMOVED***-f2pywrappers.f').touch()
                else:
                    # only f77 wrappers
                    outmess(f'    Maybe empty "{m_name***REMOVED***-f2pywrappers.f"\n')
                    Path(f'{b_path***REMOVED***/{m_name***REMOVED***-f2pywrappers.f').touch()
...
def buildapi(rout):
    ...
    rd['docsignature'] = stripcomma(replace('#docsign##docsignopt##docsignxa#',
                                            {'docsign': rd['docsign'],
                                             ...
                                             'docsignxa': rd['docsignxa']***REMOVED***))
    optargs = stripcomma(replace('#docsignopt##docsignxa#',
                                 {'docsignxa': rd['docsignxashort'],
                                  'docsignopt': rd['docsignoptshort']***REMOVED***
                     ***REMOVED***)
    if optargs == '':
        rd['docsignatureshort'] = stripcomma(
            replace('#docsign#', {'docsign': rd['docsign']***REMOVED***))
    else:
    ...
    cfs = stripcomma(replace('#callfortran##callfortranappend#', {
                     'callfortran': rd['callfortran'], 'callfortranappend': rd['callfortranappend']***REMOVED***))
    ...
    if isinstance(rd['docreturn'], list):
        rd['docreturn'] = stripcomma(
            replace('#docreturn#', {'docreturn': rd['docreturn']***REMOVED***)) + ' = '
    rd['docstrsigns'] = []
    rd['latexdocstrsigns'] = []
    for k in ['docstrreq', 'docstropt', 'docstrout', 'docstrcbs']:
        ...
        if k in rd and isinstance(rd[k], list):
            rd['latexdocstrsigns'] = rd['latexdocstrsigns'] + rd[k][0:1] +\
                ['\\begin{description***REMOVED***'] + rd[k][1:] +\
                ['\\end{description***REMOVED***']
