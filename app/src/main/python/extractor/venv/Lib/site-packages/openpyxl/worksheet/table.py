...
TABLESTYLES = tuple(
    ["TableStyleMedium{0***REMOVED***".format(i) for i in range(1, 29)]
    + ["TableStyleLight{0***REMOVED***".format(i) for i in range(1, 22)]
    + ["TableStyleDark{0***REMOVED***".format(i) for i in range(1, 12)]
)

PIVOTSTYLES = tuple(
    ["PivotStyleMedium{0***REMOVED***".format(i) for i in range(1, 29)]
    + ["PivotStyleLight{0***REMOVED***".format(i) for i in range(1, 29)]
    + ["PivotStyleDark{0***REMOVED***".format(i) for i in range(1, 29)]
)
...
class Table(Serialisable):
    ...
    _path = "/tables/table{0***REMOVED***.xml"
    ...
    ***REMOVED***:
    ...
    def _initialise_columns(self):
        ...
        for idx in range(min_col, max_col+1):
            col = TableColumn(id=idx, name="Column{0***REMOVED***".format(idx))
