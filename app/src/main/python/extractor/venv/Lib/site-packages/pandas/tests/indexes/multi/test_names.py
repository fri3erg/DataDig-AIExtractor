...
def test_index_name_retained():
    # GH9857
    result = pd.DataFrame({"x": [1, 2, 6], "y": [2, 2, 8], "z": [-5, 0, 5]***REMOVED***)
    result = result.set_index("z")
    result.loc[10] = [9, 10]
    df_expected = pd.DataFrame(
        {"x": [1, 2, 6, 9], "y": [2, 2, 8, 10], "z": [-5, 0, 5, 10]***REMOVED***
    )
...
@pytest.mark.parametrize(
    ...
    [
        ({"x": "z"***REMOVED***, ["z", "y", "z"]),
        ({"x": "z", "y": "x"***REMOVED***, ["z", "x", "z"]),
        ({"y": "z"***REMOVED***, ["x", "z", "x"]),
        ({***REMOVED***, ["x", "y", "x"]),
        ({"z": "a"***REMOVED***, ["x", "y", "x"]),
        ({"y": "z", "a": "b"***REMOVED***, ["x", "z", "x"]),
    ],
)
...
def test_multiindex_name_and_level_raising():
    ...
    with pytest.raises(TypeError, match="Can not pass level for dictlike `names`."):
        mi.set_names(names={"x": "z"***REMOVED***, level={"x": "z"***REMOVED***)
