...
def concatenate_cells(
    ...
    if include_outputs and cell_type == "code" and output:
        if "ename" in output[0].keys():
            ...
            if traceback:
                ...
                return (
                    f"'{cell_type***REMOVED***' cell: '{source***REMOVED***'\n, gives error '{error_name***REMOVED***',"
                    f" with description '{error_value***REMOVED***'\n"
                    f"and traceback '{traceback***REMOVED***'\n\n"
    ***REMOVED***
            else:
                return (
                    f"'{cell_type***REMOVED***' cell: '{source***REMOVED***'\n, gives error '{error_name***REMOVED***',"
    ...
    ***REMOVED***
            ...
            return (
                f"'{cell_type***REMOVED***' cell: '{source***REMOVED***'\n with "
                f"output: '{output[:min_output]***REMOVED***'\n\n"
***REMOVED***
    else:
        return f"'{cell_type***REMOVED***' cell: '{source***REMOVED***'\n\n"
