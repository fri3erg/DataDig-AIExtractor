...
def _last_left_t_init(sigma):
    return {c: 0 for c in sigma***REMOVED***
...
def demo():
    ...
    for s1, s2 in string_distance_examples:
        print(f"Edit distance btwn '{s1***REMOVED***' and '{s2***REMOVED***':", edit_distance(s1, s2))
        print(
            f"Edit dist with transpositions btwn '{s1***REMOVED***' and '{s2***REMOVED***':",
            edit_distance(s1, s2, transpositions=True),
        )
        print(f"Jaro similarity btwn '{s1***REMOVED***' and '{s2***REMOVED***':", jaro_similarity(s1, s2))
        print(
            f"Jaro-Winkler similarity btwn '{s1***REMOVED***' and '{s2***REMOVED***':",
            jaro_winkler_similarity(s1, s2),
        )
        print(
            f"Jaro-Winkler distance btwn '{s1***REMOVED***' and '{s2***REMOVED***':",
