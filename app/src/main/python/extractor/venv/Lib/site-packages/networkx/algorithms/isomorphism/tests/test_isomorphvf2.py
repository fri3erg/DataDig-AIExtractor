...
def test_isomorphism_iter1():
    ...
    assert {"A": "Y", "B": "Z"***REMOVED*** in x
    assert {"B": "Y", "C": "Z"***REMOVED*** in x
    assert {"A": "Z", "B": "Y"***REMOVED*** in y
    assert {"B": "Z", "C": "Y"***REMOVED*** in y
    assert len(x) == len(y)
    assert len(x) == 2
...
def test_monomorphism_iter1():
    ...
    assert {"A": "X", "B": "Y", "C": "Z"***REMOVED*** in x
    assert {"A": "Y", "B": "Z", "C": "X"***REMOVED*** in x
    assert {"A": "Z", "B": "X", "C": "Y"***REMOVED*** in x
    assert len(x) == 3
...
def test_isomorphvf2pp_multidigraphs():
    g = nx.MultiDiGraph({0: [1, 1, 2, 2, 3], 1: [2, 3, 3], 2: [3]***REMOVED***)
    h = nx.MultiDiGraph({0: [1, 1, 2, 2, 3], 1: [2, 3, 3], 3: [2]***REMOVED***)
