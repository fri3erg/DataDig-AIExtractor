...
>>> d = {0: {1: 1***REMOVED******REMOVED***  # dict-of-dicts single edge (0,1)
>>> G = nx.Graph(d)
...
def to_networkx_graph(data, create_using=None, multigraph_input=False):
    ...
    >>> d = {0: {1: {"weight": 1***REMOVED******REMOVED******REMOVED***  # dict-of-dicts single edge (0,1)
    >>> G = nx.Graph(d)
...
***REMOVED***
            ...
            if multigraph_input is True:
                raise nx.NetworkXError(
                    f"converting multigraph_input raised:\n{type(err1)***REMOVED***: {err1***REMOVED***"
    ***REMOVED***
            try:
...
def from_dict_of_lists(d, create_using=None):
    ...
    Examples
    --------
    >>> dol = {0: [1]***REMOVED***  # single edge (0,1)
...
def to_dict_of_dicts(G, nodelist=None, edge_data=None):
    ...
    {0: {1: {***REMOVED******REMOVED***, 1: {0: {***REMOVED***, 2: {***REMOVED******REMOVED***, 2: {1: {***REMOVED******REMOVED******REMOVED***
    ...
    ...         (1, 2, {'weight': 2.0***REMOVED***),
    ...         (2, 0, {'weight': 1.0***REMOVED***),
    ...     ]
    ... )
    >>> d = nx.to_dict_of_dicts(G)
    >>> d  # doctest: +SKIP
    {0: {1: {'weight': 1.0***REMOVED***, 2: {'weight': 1.0***REMOVED******REMOVED***,
     1: {0: {'weight': 1.0***REMOVED***, 2: {'weight': 2.0***REMOVED******REMOVED***,
     2: {1: {'weight': 2.0***REMOVED***, 0: {'weight': 1.0***REMOVED******REMOVED******REMOVED***
    >>> d[1][2]['weight']
    2.0
    ...
    >>> d
    {0: {1: 1, 2: 1***REMOVED***, 1: {0: 1, 2: 1***REMOVED***, 2: {1: 1, 0: 1***REMOVED******REMOVED***
    >>> d[1][2]
    1
    ...
    >>> d = nx.to_dict_of_dicts(G)
    >>> d  # doctest: +SKIP
    {0: {1: {'a': {'weight': 1.0***REMOVED***, 'b': {'weight': 5.0***REMOVED******REMOVED******REMOVED***,
     1: {0: {'a': {'weight': 1.0***REMOVED***, 'b': {'weight': 5.0***REMOVED******REMOVED******REMOVED******REMOVED***
    >>> d[0][1]['b']['weight']
    5.0
    ...
    >>> d
    {0: {1: 10***REMOVED***, 1: {0: 10***REMOVED******REMOVED***
    """
    dod = {***REMOVED***
    if nodelist is None:
...
def from_dict_of_dicts(d, create_using=None, multigraph_input=False):
    ...
    Examples
    --------
    >>> dod = {0: {1: {"weight": 1***REMOVED******REMOVED******REMOVED***  # single edge (0,1)
