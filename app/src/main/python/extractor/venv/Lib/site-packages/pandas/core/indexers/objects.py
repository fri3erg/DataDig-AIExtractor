...
class BaseIndexer:
    ...
    ...         return start, end
    >>> df = pd.DataFrame({"values": range(5)***REMOVED***)
    ...
    def __init__(
        ...
        **kwargs,
        ...
        groupby_indices : dict or None
            dict of {group label: [positional index of rows belonging to the group]***REMOVED***
        ...
        **kwargs :
        ...
        """
        self.groupby_indices = groupby_indices or {***REMOVED***
        self.window_indexer = window_indexer
        self.indexer_kwargs = indexer_kwargs.copy() if indexer_kwargs else {***REMOVED***
        super().__init__(
...
***REMOVED***, "these should be equal in length from get_window_bounds"
