...
***REMOVED***
    ...
    def _format_weather_info(self, location: str, w: Any) -> str:
        ...
        return (
            f"In {location***REMOVED***, the current weather is as follows:\n"
            f"Detailed status: {detailed_status***REMOVED***\n"
            f"Wind speed: {wind['speed']***REMOVED*** m/s, direction: {wind['deg']***REMOVED***°\n"
            f"Humidity: {humidity***REMOVED***%\n"
            f"Temperature: \n"
            f"  - Current: {temperature['temp']***REMOVED***°C\n"
            f"  - High: {temperature['temp_max']***REMOVED***°C\n"
            f"  - Low: {temperature['temp_min']***REMOVED***°C\n"
            f"  - Feels like: {temperature['feels_like']***REMOVED***°C\n"
            f"Rain: {rain***REMOVED***\n"
            f"Heat index: {heat_index***REMOVED***\n"
            f"Cloud cover: {clouds***REMOVED***%"
        )
