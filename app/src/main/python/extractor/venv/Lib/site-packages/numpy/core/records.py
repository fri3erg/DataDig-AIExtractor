...
class format_parser:
    ...
    def _parseFormats(self, formats, aligned=False):
        ...
        if isinstance(formats, list):
            dtype = sb.dtype(
                [('f{***REMOVED***'.format(i), format_) for i, format_ in enumerate(formats)],
                aligned,
***REMOVED***
        else:
...
def fromarrays(arrayList, dtype=None, shape=None, formats=None,
    ...
    for k, obj in enumerate(arrayList):
        ...
        name = _names[k]
        if testshape != shape:
            raise ValueError(f'array-shape mismatch in array {k***REMOVED*** ("{name***REMOVED***")')
