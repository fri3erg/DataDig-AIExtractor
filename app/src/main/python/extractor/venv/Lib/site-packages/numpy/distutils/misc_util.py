...
def msvc_runtime_major():
    ...
    ***REMOVED***.get(msvc_runtime_version(), None)
    return major
...
class Configuration:
    ...
    def __init__(self,
        ...
        for n in self.dict_keys:
            v = copy.copy(attrs.get(n, {***REMOVED***))
            setattr(self, n, v)
...
***REMOVED***
    ...
    def get_subpackage(self,subpackage_name,
        ...
        if not os.path.isfile(setup_py):
            if not self.options['assume_default_configuration']:
                self.warn('Assuming default configuration '\
                          '(%s/{setup_%s,setup***REMOVED***.py was not found)' \
    ...
    def add_npy_pkg_config(self, template, install_dir, subst_dict=None):
        ...
        ::
            ...
            config.add_npy_pkg_config('foo.ini.in', 'lib', {'foo': bar***REMOVED***)
        ...
        Example npymath.ini modified for cross-compilation::
            ...
            prefix=${pkgdir***REMOVED***
            libdir=${prefix***REMOVED***/lib
            includedir=${prefix***REMOVED***/include

            [default]
            Libs=-L${libdir***REMOVED*** -lnpymath
            Cflags=-I${includedir***REMOVED***
            Requires=mlib

            [msvc]
            Libs=/LIBPATH:${libdir***REMOVED*** npymath.lib
            Cflags=/INCLUDE:${includedir***REMOVED***
            Requires=mlib
...
def get_cmd(cmdname, _cache={***REMOVED***):
...
def get_info(pkgname, dirs=None):
    ...
    ['.../numpy/core/lib'], 'include_dirs': ['.../numpy/core/include']***REMOVED***
...
def generate_config_py(target):
    ...
    """
    from numpy.distutils.system_info ***REMOVED***tem_info
    ...
    with open(target, 'w') as f:
        ...
        f.write(textwrap.dedent(r'''
            def get_info(name):
                g = globals()
                return g.get(name, g.get(name + "_info", {***REMOVED***))
    ...
    ***REMOVED***
                for name,info_dict in globals().items():
                    if name[0] == "_" or type(info_dict) is not type({***REMOVED***): continue
                    print(name + ":")
                    if not info_dict:
                        print("  NOT AVAILABLE")
...
_cxx_ignore_flags = {'-Werror=implicit-function-declaration', '-std=c99'***REMOVED***
