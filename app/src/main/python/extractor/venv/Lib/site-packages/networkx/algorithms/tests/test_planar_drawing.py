...
def test_graph1():
    embedding_data = {0: [1, 2, 3], 1: [2, 0], 2: [3, 0, 1], 3: [2, 0]***REMOVED***
...
def test_one_node_graph():
    embedding_data = {0: []***REMOVED***
    check_embedding_data(embedding_data)


def test_two_node_graph():
    embedding_data = {0: [1], 1: [0]***REMOVED***
    check_embedding_data(embedding_data)


def test_three_node_graph():
    embedding_data = {0: [1, 2], 1: [0, 2], 2: [0, 1]***REMOVED***
    check_embedding_data(embedding_data)


def test_multiple_component_graph1():
    embedding_data = {0: [], 1: []***REMOVED***
    check_embedding_data(embedding_data)


def test_multiple_component_graph2():
    embedding_data = {0: [1, 2], 1: [0, 2], 2: [0, 1], 3: [4, 5], 4: [3, 5], 5: [3, 4]***REMOVED***
    check_embedding_data(embedding_data)


def test_invalid_half_edge():
    with pytest.raises(nx.NetworkXException):
        embedding_data = {1: [2, 3, 4], 2: [1, 3, 4], 3: [1, 2, 4], 4: [1, 2, 3]***REMOVED***
...
def test_triangulate_embedding2():
    ...
    expected_embedding = {1: [2], 2: [1]***REMOVED***
    check_triangulation(embedding, expected_embedding)
    ...
    for a, b in G.edges():
        ...
        ***REMOVED*** / determinant
                    ...
                    if point_in_between(pos[a], pos[b], (px, py)) and point_in_between(
                        pos[c], pos[d], (px, py)
        ***REMOVED***:
                        msg = f"There is an intersection at {px***REMOVED***,{py***REMOVED***"
