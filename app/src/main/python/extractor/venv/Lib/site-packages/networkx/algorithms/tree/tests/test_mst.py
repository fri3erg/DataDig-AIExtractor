...
class MinimumSpanningTreeTestBase:
    ...
    def setup_method(self, method):
        ...
        self.minimum_spanning_edgelist = [
            (0, 1, {"weight": 7***REMOVED***),
            (0, 3, {"weight": 5***REMOVED***),
            (1, 4, {"weight": 7***REMOVED***),
            (2, 4, {"weight": 5***REMOVED***),
            (3, 5, {"weight": 6***REMOVED***),
            (4, 6, {"weight": 9***REMOVED***),
        ]
        self.maximum_spanning_edgelist = [
            (0, 1, {"weight": 7***REMOVED***),
            (1, 2, {"weight": 8***REMOVED***),
            (1, 3, {"weight": 9***REMOVED***),
            (3, 4, {"weight": 15***REMOVED***),
            (4, 6, {"weight": 9***REMOVED***),
            (5, 6, {"weight": 11***REMOVED***),
        ]
    ...
    def test_disconnected(self):
        G = nx.Graph([(0, 1, {"weight": 1***REMOVED***), (2, 3, {"weight": 2***REMOVED***)])
...
class TestKruskal(MultigraphMSTTestBase):
    ...
    def test_key_data_bool(self):
        ...
        assert edges_equal(
            [(1, 2, {"weight": 2***REMOVED***), (2, 3, {"weight": 2***REMOVED***)], list(mst_edges)
        )
        ...
        assert edges_equal(
            [(1, 2, 1, {"weight": 2***REMOVED***), (2, 3, 1, {"weight": 2***REMOVED***)], list(mst_edges)
        )
...
class TestPrim(MultigraphMSTTestBase):
    ...
    def test_prim_mst_edges_simple_graph(self):
        ...
        assert edges_equal(
            [(1, 2, {"key": 2, "weight": 3***REMOVED***), (2, 3, {"key": 1, "weight": 2***REMOVED***)],
            list(mst_edges),
        )
    ...
    def test_ignore_nan(self):
        ...
        mst_edges = nx.minimum_spanning_edges(H, algorithm=self.algo, ignore_nan=True)
        assert edges_equal(
            [(1, 2, 2, {"weight": 3***REMOVED***), (2, 3, 1, {"weight": 2***REMOVED***)], list(mst_edges)
        )
...
class TestSpanningTreeIterator:
    ...
    def setup_method(self):
        ...
        self.spanning_trees = [
            # 1, MST, cost = 17
            [
                (0, 1, {"weight": 5***REMOVED***),
                (1, 2, {"weight": 4***REMOVED***),
                (2, 3, {"weight": 5***REMOVED***),
                (3, 4, {"weight": 3***REMOVED***),
            ],
            # 2, cost = 18
            [
                (0, 1, {"weight": 5***REMOVED***),
                (1, 2, {"weight": 4***REMOVED***),
                (1, 4, {"weight": 6***REMOVED***),
                (3, 4, {"weight": 3***REMOVED***),
            ],
            # 3, cost = 19
            [
