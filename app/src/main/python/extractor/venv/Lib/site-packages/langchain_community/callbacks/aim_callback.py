...
class AimCallbackHandler(BaseMetadataCallbackHandler, BaseCallbackHandler):
    ...
    ***REMOVED***
    ...
    def on_llm_start(
        ...
        resp = {"action": "on_llm_start"***REMOVED***
    ...
    def on_llm_end(self, response: LLMResult, **kwargs: Any) -> None:
        ...
        resp = {"action": "on_llm_end"***REMOVED***
        resp.update(self.get_custom_callback_meta())
    ...
    def on_chain_start(
        ...
        resp = {"action": "on_chain_start"***REMOVED***
        resp.update(self.get_custom_callback_meta())
    ...
    def on_chain_end(self, outputs: Dict[str, Any], **kwargs: Any) -> None:
        ...
        resp = {"action": "on_chain_end"***REMOVED***
        resp.update(self.get_custom_callback_meta())
    ...
    def on_tool_start(
        ...
        resp = {"action": "on_tool_start"***REMOVED***
        resp.update(self.get_custom_callback_meta())
    ...
    def on_tool_end(self, output: str, **kwargs: Any) -> None:
        ...
        resp = {"action": "on_tool_end"***REMOVED***
        resp.update(self.get_custom_callback_meta())
    ...
    def on_agent_finish(self, finish: AgentFinish, **kwargs: Any) -> None:
        ...
        resp = {"action": "on_agent_finish"***REMOVED***
        resp.update(self.get_custom_callback_meta())
