...
class TestFlowBetweennessCentrality:
    def test_K4_normalized(self):
        ...
        b_answer = {0: 0.25, 1: 0.25, 2: 0.25, 3: 0.25***REMOVED***
        for n in sorted(G):
        ...
        for n in sorted(G):
            assert b[n] == pytest.approx(b_answer[n], abs=1e-7)
        wb_answer = {0: 0.2222222, 1: 0.2222222, 2: 0.30555555, 3: 0.30555555***REMOVED***
        b = nx.current_flow_betweenness_centrality(G, normalized=True, weight="weight")
        for n in sorted(G):
            assert b[n] == pytest.approx(wb_answer[n], abs=1e-7)
        wb_answer = {0: 0.2051282, 1: 0.2051282, 2: 0.33974358, 3: 0.33974358***REMOVED***
...
***REMOVED***
            b_answer = {0: 0.75, 1: 0.75, 2: 0.75, 3: 0.75***REMOVED***
            for n in sorted(G):
                assert b[n] == pytest.approx(b_answer[n], abs=1e-7)
    ...
    def test_P4_normalized(self):
        ...
        G = nx.path_graph(4)
        b = nx.current_flow_betweenness_centrality(G, normalized=True)
        b_answer = {0: 0, 1: 2.0 / 3, 2: 2.0 / 3, 3: 0***REMOVED***
        for n in sorted(G):
            assert b[n] == pytest.approx(b_answer[n], abs=1e-7)
    ...
    def test_P4(self):
        ...
        b_answer = {0: 0, 1: 2, 2: 2, 3: 0***REMOVED***
        for n in sorted(G):
            assert b[n] == pytest.approx(b_answer[n], abs=1e-7)
    ...
    def test_star(self):
        ...
        b = nx.current_flow_betweenness_centrality(G, normalized=True)
        b_answer = {"a": 1.0, "b": 0.0, "c": 0.0, "d": 0.0***REMOVED***
        for n in sorted(G):
            assert b[n] == pytest.approx(b_answer[n], abs=1e-7)
...
class TestEdgeFlowBetweennessCentrality:
    ...
    def test_C4(self):
        ...
        G = nx.cycle_graph(4)
        b = edge_current_flow(G, normalized=False)
        b_answer = {(0, 1): 1.25, (0, 3): 1.25, (1, 2): 1.25, (2, 3): 1.25***REMOVED***
        for (s, t), v1 in b_answer.items():
            v2 = b.get((s, t), b.get((t, s)))
            assert v1 == pytest.approx(v2, abs=1e-7)
    ...
    def test_P4(self):
        ...
        G = nx.path_graph(4)
        b = edge_current_flow(G, normalized=False)
        b_answer = {(0, 1): 1.5, (1, 2): 2.0, (2, 3): 1.5***REMOVED***
        for (s, t), v1 in b_answer.items():
            v2 = b.get((s, t), b.get((t, s)))
            assert v1 == pytest.approx(v2, abs=1e-7)
