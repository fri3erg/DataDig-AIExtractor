...
def resource_allocation_index(G, ebunch=None):
    ...
    .. math::
        ...
        \sum_{w \in \Gamma(u) \cap \Gamma(v)***REMOVED*** \frac{1***REMOVED***{|\Gamma(w)|***REMOVED***
    ...
    >>> for u, v, p in preds:
    ...     print(f"({u***REMOVED***, {v***REMOVED***) -> {p:.8f***REMOVED***")
    (0, 1) -> 0.75000000
    (2, 3) -> 0.75000000
...
def jaccard_coefficient(G, ebunch=None):
    ...
    .. math::
        ...
        \frac{|\Gamma(u) \cap \Gamma(v)|***REMOVED***{|\Gamma(u) \cup \Gamma(v)|***REMOVED***
...
def adamic_adar_index(G, ebunch=None):
    ...
    .. math::
        ...
        \sum_{w \in \Gamma(u) \cap \Gamma(v)***REMOVED*** \frac{1***REMOVED***{\log |\Gamma(w)|***REMOVED***
...
def common_neighbor_centrality(G, ebunch=None, alpha=0.8):
    ...
    .. math::
        ...
        \alpha \cdot (|\Gamma (u){\cap ***REMOVED***^{***REMOVED***\Gamma (v)|)+(1-\alpha )\cdot \frac{N***REMOVED***{{d***REMOVED***_{uv***REMOVED******REMOVED***
    ...
    total number of nodes in the Graph and ${d***REMOVED***_{uv***REMOVED***$ denotes shortest distance
    between $u$ and $v$.
    ...
    >>> for u, v, p in preds:
    ...     print(f"({u***REMOVED***, {v***REMOVED***) -> {p***REMOVED***")
    ...
    if alpha == 1:
        ...
        def predict(u, v):
            ...
            return alpha * sum(1 for _ in nx.common_neighbors(G, u, v)) + (
                1 - alpha
***REMOVED*** * (G.number_of_nodes() / path_len)
...
def cn_soundarajan_hopcroft(G, ebunch=None, community="community"):
    ...
    .. math::
        ...
        |\Gamma(u) \cap \Gamma(v)| + \sum_{w \in \Gamma(u) \cap \Gamma(v)***REMOVED*** f(w)
...
def ra_index_soundarajan_hopcroft(G, ebunch=None, community="community"):
    ...
    .. math::
        ...
        \sum_{w \in \Gamma(u) \cap \Gamma(v)***REMOVED*** \frac{f(w)***REMOVED***{|\Gamma(w)|***REMOVED***
...
def within_inter_cluster(G, ebunch=None, delta=0.001, community="community"):
    ...
    def predict(u, v):
        ...
        within = {w for w in cnbors if _community(G, w, community) == Cu***REMOVED***
        inter = cnbors - within
