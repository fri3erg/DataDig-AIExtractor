...
def _flop_count(idx_contraction, inner, num_terms, size_dictionary):
    ...
    >>> _flop_count('abc', False, 1, {'a': 2, 'b':3, 'c':5***REMOVED***)
    30

    >>> _flop_count('abc', True, 2, {'a': 2, 'b':3, 'c':5***REMOVED***)
    60
...
def _compute_size_by_dict(indices, idx_dict):
    ...
    Examples
    --------
    >>> _compute_size_by_dict('abbc', {'a': 2, 'b':3, 'c':5***REMOVED***)
    90
...
def _find_contraction(positions, input_sets, output_set):
    ...
    ({'a', 'c'***REMOVED***, [{'a', 'c'***REMOVED***], {'b'***REMOVED***, {'a', 'b', 'c'***REMOVED***)
    ...
    >>> oset = set('ac')
    >>> _find_contraction(pos, isets, oset)
    ({'a', 'c'***REMOVED***, [{'a', 'c'***REMOVED***, {'a', 'c'***REMOVED***], {'b', 'd'***REMOVED***, {'a', 'b', 'c', 'd'***REMOVED***)
    """
...
def _optimal_path(input_sets, output_set, idx_dict, memory_limit):
    ...
    >>> isets = [set('abd'), set('ac'), set('bdc')]
    >>> oset = set()
    >>> idx_sizes = {'a': 1, 'b':2, 'c':3, 'd':4***REMOVED***
...
def einsum_path(*operands, optimize='greedy', einsum_call=False):
    ...
    *operands : list of array_like
    ...
    optimize : {bool, list, tuple, 'greedy', 'optimal'***REMOVED***
    ...
    if len(input_list) != 1:
        ...
        raise RuntimeError(
            "Invalid einsum_path is specified: {***REMOVED*** more operands has to be "
