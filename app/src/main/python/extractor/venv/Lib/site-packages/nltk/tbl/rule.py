...
class Rule(TagRule):
    ...
    More formally, the Rule is then applicable to the M{n***REMOVED***th token iff:

      - The M{n***REMOVED***th token is tagged with the Rule's original tag; and
      - For each (Feature(positions), M{value***REMOVED***) tuple:

        - The value of Feature of at least one token in {n+p for p in positions***REMOVED***
          is M{value***REMOVED***.
    """
    ...
    def __init__(self, templateid, original_tag, replacement_tag, conditions):
        ...
        C{original_tag***REMOVED*** to C{replacement_tag***REMOVED*** if all of the properties
        specified in C{conditions***REMOVED*** hold.
        ...
        :param conditions: A list of Feature(positions),
            ...
            token in M{n***REMOVED*** + p in positions is C{value***REMOVED***.
        :type conditions: C{iterable***REMOVED*** of C{Feature***REMOVED***
    ...
    def __repr__(self):
        ...
        try:
            ...
            self.__repr = "{***REMOVED***('{***REMOVED***', {***REMOVED***, {***REMOVED***, [{***REMOVED***])".format(
                ...
                ", ".join(f"({f***REMOVED***,{repr(v)***REMOVED***)" for (f, v) in self._conditions),
***REMOVED***
    ...
    def __str__(self):
        def _condition_to_logic(feature, value):
            ...
            """
            return "{***REMOVED***:{***REMOVED***@[{***REMOVED***]".format(
...
***REMOVED***
        ...
        s = f"{self.original_tag***REMOVED***->{self.replacement_tag***REMOVED*** if {conditions***REMOVED***"
    ...
    def format(self, fmt):
        ...
        Traceback (most recent call last):
          ...
          File "nltk/tbl/rule.py", line 256, in format
            raise ValueError("unknown rule format spec: {0***REMOVED***".format(fmt))
        ...
        if fmt == "str":
            ...
            raise ValueError(f"unknown rule format spec: {fmt***REMOVED***")
    ...
    def _verbose_format(self):
        ...
        def condition_to_str(feature, value):
            return 'the {***REMOVED*** of {***REMOVED*** is "{***REMOVED***"'.format(
                feature.PROPERTY_NAME,
        ...
        def range_to_str(positions):
            if len(positions) == 1:
                ...
                if mx - mn == len(positions) - 1:
                    ...
                    return "words {{{***REMOVED******REMOVED******REMOVED***".format(
                        ",".join("i%+d" % d for d in positions)
        ***REMOVED***

        replacement = f"{self.original_tag***REMOVED*** -> {self.replacement_tag***REMOVED***"
