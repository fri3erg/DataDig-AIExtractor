...
class SurrealDBStore(VectorStore):
    ...
    async def initialize(self) -> None:
        ...
        if "db_user" in self.kwargs and "db_pass" in self.kwargs:
            ...
            await self.sdb.signin({"user": user, "pass": password***REMOVED***)
    ...
    async def aadd_texts(
        ...
        **kwargs: Any,
        ...
        for idx, text in enumerate(texts):
            data = {"text": text, "embedding": embeddings[idx]***REMOVED***
...
***REMOVED***
    ...
    async def _asimilarity_search_by_vector_with_score(
        ...
        ***REMOVED***
        ...
        vector::similarity::cosine(embedding,{embedding***REMOVED***) as similarity
        from {collection***REMOVED***
        where vector::similarity::cosine(embedding,{embedding***REMOVED***) >= {score_threshold***REMOVED***
        order by similarity desc LIMIT {k***REMOVED***
        """.format(**args)
        ...
        return [
            (
                Document(
                    ...
                    metadata={"id": result["id"], **result["metadata"]***REMOVED***,
    ***REMOVED***,
                result["similarity"],
***REMOVED***
