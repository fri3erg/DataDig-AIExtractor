...
class Serializable(BaseModel, ABC):
    ...
    def to_json(self) -> Union[SerializedConstructor, SerializedNotImplemented]:
        ...
        lc_kwargs = {
            ...
            if not (self.__exclude_fields__ or {***REMOVED***).get(k, False)  # type: ignore
        ***REMOVED***
        ...
        for cls in [None, *self.__class__.mro()]:
            ...
            if cls:
                ...
                for attr in deprecated_attributes:
                    if hasattr(cls, attr):
                        raise ValueError(
                            f"Class {self.__class__***REMOVED*** has a deprecated "
                            f"attribute {attr***REMOVED***. Please use the corresponding "
        ...
        for key in secrets.keys():
            ...
            if secret_value is not None:
                lc_kwargs.update({key: secret_value***REMOVED***)
