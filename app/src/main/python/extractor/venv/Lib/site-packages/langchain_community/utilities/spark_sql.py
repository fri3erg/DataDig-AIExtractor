...
***REMOVED***
    ...
    def _get_create_table_stmt(self, table: str) -> str:
        statement = (
            self._spark.sql(f"SHOW CREATE TABLE {table***REMOVED***").collect()[0].createtab_stmt
        )
    ...
    def get_table_info(self, table_names: Optional[List[str]] = None) -> str:
        ...
        for table_name in all_table_names:
            ...
            if self._sample_rows_in_table_info:
                table_info += "\n\n/*"
                table_info += f"\n{self._get_sample_spark_rows(table_name)***REMOVED***\n"
                table_info += "*/"
    ...
    def _get_sample_spark_rows(self, table: str) -> str:
        query = f"SELECT * FROM {table***REMOVED*** LIMIT {self._sample_rows_in_table_info***REMOVED***"
        ...
        return (
            f"{self._sample_rows_in_table_info***REMOVED*** rows from {table***REMOVED*** table:\n"
