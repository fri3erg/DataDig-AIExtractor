    ...
    class Runner:
        ...
        def run(self, coro: Coroutine[T_Retval], *, context=None) -> T_Retval:
            ...
            if not coroutines.iscoroutine(coro):
                raise ValueError(f"a coroutine was expected, got {coro!r***REMOVED***")
...
def _task_started(task: asyncio.Task) -> bool:
    ...
    try:
        ...
        raise Exception(f"Cannot determine if task {task***REMOVED*** has started or not") from None
...
***REMOVED***
    ...
    def _uncancel(self, cancelled_exc: CancelledError) -> bool:
        ...
        self._cancel_calls = 0
        return f"Cancelled by cancel scope {id(self):x***REMOVED***" in cancelled_exc.args
            ...
            if task is not current and (task is self._host_task or _task_started(task)):
                ...
                if not isinstance(waiter, asyncio.Future) or not waiter.done():
                    ...
                    if sys.version_info >= (3, 9):
                        task.cancel(f"Cancelled by cancel scope {id(origin):x***REMOVED***")
                    else:
                        task.cancel()
...
***REMOVED***
        ...
        if not iscoroutine(coro):
            prefix = f"{func.__module__***REMOVED***." if hasattr(func, "__module__") else ""
            raise TypeError(
                f"Expected {prefix***REMOVED***{func.__qualname__***REMOVED***() to return a coroutine, but "
                f"the return value ({coro!r***REMOVED***) is not a coroutine object"
***REMOVED***
        ...
        ***REMOVED***
        ...
        for cmsg_level, cmsg_type, cmsg_data in ancdata:
            if cmsg_level != socket.SOL_SOCKET or cmsg_type != socket.SCM_RIGHTS:
                raise RuntimeError(
                    f"Received unexpected ancillary data; message = {message!r***REMOVED***, "
                    f"cmsg_level = {cmsg_level***REMOVED***, cmsg_type = {cmsg_type***REMOVED***"
    ***REMOVED***
    ...
    def check_cancelled(cls) -> None:
        ...
        while scope is not None:
            if scope.cancel_called:
                raise CancelledError(f"Cancelled by cancel scope {id(scope):x***REMOVED***")
