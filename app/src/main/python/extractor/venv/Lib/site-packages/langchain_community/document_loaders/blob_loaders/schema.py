...
class Blob(BaseModel):
    ...
    def as_string(self) -> str:
        ...
        if self.data is None and self.path:
            ...
            raise ValueError(f"Unable to get string for blob {self***REMOVED***")
    ...
    def as_bytes(self) -> bytes:
        ...
        if isinstance(self.data, bytes):
            ...
            raise ValueError(f"Unable to get bytes for blob {self***REMOVED***")
    ...
    def as_bytes_io(self) -> Generator[Union[BytesIO, BufferedReader], None, None]:
        ...
        if isinstance(self.data, bytes):
            ...
            raise NotImplementedError(f"Unable to convert blob {self***REMOVED***")
    ...
    def from_path(
        ...
        *,
        ...
        return cls(
            ...
            encoding=encoding,
            path=path,
            metadata=metadata if metadata is not None else {***REMOVED***,
        )
    ...
    def __repr__(self) -> str:
        ...
        str_repr = f"Blob {id(self)***REMOVED***"
        if self.source:
            str_repr += f" {self.source***REMOVED***"
        return str_repr
