...
SECTION_LINE_LIMIT_CONFIG = {
    'response-example': {'name': 'Response Syntax', 'line_limit': 1500***REMOVED***,
    'description': {'name': 'Response Structure', 'line_limit': 5000***REMOVED***,
    'request-example': {'name': 'Request Syntax', 'line_limit': 1500***REMOVED***,
    'request-params': {'name': 'Parameters', 'line_limit': 5000***REMOVED***,
***REMOVED***
...
class ReSTDocument:
    ...
    def writeln(self, content):
        ...
        """
        self._write(f'{self.style.spaces()***REMOVED***{content***REMOVED***\n')
...
***REMOVED***.encode()
    ...
    def write_to_file(self, full_path, file_name):
        ...
        sub_resource_file_path = os.path.join(full_path, f'{file_name***REMOVED***.rst')
