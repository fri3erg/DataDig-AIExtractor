...
def _split_text_with_regex(
    ...
    if separator:
        if keep_separator:
            ...
            _splits = re.split(f"({separator***REMOVED***)", text)
...
class TextSplitter(BaseDocumentTransformer, ABC):
    ...
    def __init__(
        ...
        if chunk_overlap > chunk_size:
            raise ValueError(
                f"Got a larger chunk overlap ({chunk_overlap***REMOVED***) than chunk size "
                f"({chunk_size***REMOVED***), should be smaller."
***REMOVED***
    ...
    def create_documents(
        ...
        _metadatas = metadatas or [{***REMOVED***] * len(texts)
        documents = []
...
***REMOVED***:
                if total > self._chunk_size:
                    logger.warning(
                        f"Created a chunk of size {total***REMOVED***, "
                        f"which is longer than the specified {self._chunk_size***REMOVED***"
        ***REMOVED***
...
***REMOVED***
        ...
        if issubclass(cls, TokenTextSplitter):
            extra_kwargs = {
                ...
                "disallowed_special": disallowed_special,
            ***REMOVED***
            kwargs = {**kwargs, **extra_kwargs***REMOVED***
...
***REMOVED***:
    ...
    def split_text(self, text: str) -> List[Document]:
        ...
        current_metadata: Dict[str, str] = {***REMOVED***
        # Keep track of the nested header structure
        # header_stack: List[Dict[str, Union[int, str]]] = []
        header_stack: List[HeaderType] = []
        initial_metadata: Dict[str, str] = {***REMOVED***
    ...
    ***REMOVED***:
        ...
        ***REMOVED***
        ...
        if current_content:
            lines_with_metadata.append(
                {"content": "\n".join(current_content), "metadata": current_metadata***REMOVED***
***REMOVED***
...
***REMOVED*** from e
        ...
        ns_map = {"h": "http://www.w3.org/1999/xhtml"***REMOVED***
...
***REMOVED***
    ...
    def _initialize_chunk_configuration(
        ...
        if self.tokens_per_chunk > self.maximum_tokens_per_chunk:
            raise ValueError(
                f"The token limit of the models '{self.model_name***REMOVED***'"
                f" is: {self.maximum_tokens_per_chunk***REMOVED***."
                f" Argument tokens_per_chunk={self.tokens_per_chunk***REMOVED***"
    ...
    def get_separators_for_language(language: Language) -> List[str]:
        if language == Language.CPP:
            ...
            return [
                ...
                "\n\\\\begin{enumerate***REMOVED***",
                "\n\\\\begin{itemize***REMOVED***",
                "\n\\\\begin{description***REMOVED***",
                "\n\\\\begin{list***REMOVED***",
                "\n\\\\begin{quote***REMOVED***",
                "\n\\\\begin{quotation***REMOVED***",
                "\n\\\\begin{verse***REMOVED***",
                "\n\\\\begin{verbatim***REMOVED***",
            ...
            raise ValueError(
                f"Language {language***REMOVED*** is not supported! "
                f"Please choose from {list(Language)***REMOVED***"
***REMOVED***
