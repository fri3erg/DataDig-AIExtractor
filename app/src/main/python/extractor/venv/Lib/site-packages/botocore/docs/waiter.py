...
class WaiterDocumenter:
    ...
    def document_waiters(self, section):
        ...
        for waiter_name in self._service_waiter_model.waiter_names:
            section.style.tocitem(f'{self._service_name***REMOVED***/waiter/{waiter_name***REMOVED***')
...
***REMOVED***
    ...
    def _add_single_waiter(self, section, waiter_name):
        ...
        breadcrumb_section.write(f' / Waiter / {waiter_name***REMOVED***')
        ...
        waiter_section.style.start_sphinx_py_class(
            class_name=f"{self._client_class_name***REMOVED***.Waiter.{waiter_name***REMOVED***"
        )
...
def document_wait_method(
    ...
    waiter_config_members['Delay'] = DocumentedShape(
        ...
        documentation=(
            ...
            'attempts. Default: {***REMOVED***</p>'.format(waiter_model.delay)
        ),
    )
    ...
    waiter_config_members['MaxAttempts'] = DocumentedShape(
        ...
        documentation=(
            ...
            'Default: {***REMOVED***</p>'.format(waiter_model.max_attempts)
        ),
    )
...
***REMOVED***,
    ...
    wait_description = (
        'Polls :py:meth:`{***REMOVED***.Client.{***REMOVED***` every {***REMOVED*** '
        'seconds until a successful state is reached. An error is '
        'returned after {***REMOVED*** failed checks.'.format(
