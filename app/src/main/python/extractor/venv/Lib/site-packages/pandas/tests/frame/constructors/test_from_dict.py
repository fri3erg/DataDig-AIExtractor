...
class TestFromDict:
    ...
    def test_constructor_orient(self, float_string_frame):
        ...
        # dict of sequence
        a = {"hi": [32, 3, 3], "there": [3, 5, 3]***REMOVED***
...
***REMOVED***
        with pytest.raises(ValueError, match=msg):
            DataFrame.from_dict({"A": [1, 2], "B": [4, 5]***REMOVED***, columns=["one", "two"])

    @pytest.mark.parametrize(
        "data_dict, orient, expected",
        [
            ({***REMOVED***, "index", RangeIndex(0)),
            (
                [{("a",): 1***REMOVED***, {("a",): 2***REMOVED***],
                "columns",
...
***REMOVED***,
            ([{("a", "b"): 1***REMOVED***], "columns", Index([("a", "b")], tupleize_cols=False)),
        ],
    )
    ...
    def test_frame_dict_constructor_empty_series(self):
        ...
        # it works!
        DataFrame({"foo": s1, "bar": s2, "baz": s3***REMOVED***)
        DataFrame.from_dict({"foo": s1, "baz": s3, "bar": s2***REMOVED***)
    ...
    def test_from_dict_orient_invalid(self):
        ...
        with pytest.raises(ValueError, match=msg):
            DataFrame.from_dict({"foo": 1, "baz": 3, "bar": 2***REMOVED***, orient="abc")
