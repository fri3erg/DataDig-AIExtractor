...
BOTOCORE_DEFAUT_SESSION_VARIABLES = {
    ...
    'api_versions': ('api_versions', None, {***REMOVED***, None),
...
class DefaultConfigResolver:
    def __init__(self, default_config_data):
        ...
        self._resolved_default_configurations = {***REMOVED***
...
class SmartDefaultsConfigStoreFactory:
    ...
    def merge_smart_defaults(self, config_store, mode, region_name):
        ...
        for config_var in default_configs:
            ...
            method = getattr(self, f'_set_{config_var***REMOVED***', None)
            if method:
...
class InstanceVarProvider(BaseProvider):
    ...
    def __repr__(self):
        return 'InstanceVarProvider(instance_var={***REMOVED***, session={***REMOVED***)'.format(
            self._instance_var,
            self._session,
        )
...
class ScopedConfigProvider(BaseProvider):
    ...
    def __repr__(self):
        return 'ScopedConfigProvider(config_var_name={***REMOVED***, session={***REMOVED***)'.format(
...
class EnvironmentProvider(BaseProvider):
    ...
    def __repr__(self):
        return f'EnvironmentProvider(name={self._name***REMOVED***, env={self._env***REMOVED***)'
...
class SectionConfigProvider(BaseProvider):
    ...
    def __init__(self, section_name, session, override_providers=None):
        ...
        if self._override_providers is None:
            self._override_providers = {***REMOVED***
...
***REMOVED***
    ...
    def __repr__(self):
        return (
            f'SectionConfigProvider(section_name={self._section_name***REMOVED***, '
            f'session={self._session***REMOVED***, '
            f'override_providers={self._override_providers***REMOVED***)'
        )
...
***REMOVED***
            ...
            endpoint_url = getattr(self, f'_get_endpoint_url_{location***REMOVED***')()
...
***REMOVED***
    ...
    def _get_service_env_var_name(self):
        ...
        return f'AWS_ENDPOINT_URL_{transformed_service_id_env***REMOVED***'
    ...
    def _get_services_config(self):
        ...
        services_section = self._full_config.get('services', {***REMOVED***).get(
            section_name
        )
        ...
        if not services_section:
            error_msg = (
                ...
                f'section but the "{section_name***REMOVED***" services '
...
***REMOVED***
    ...
    def _get_endpoint_url_config_service(self):
        ...
        return (
            ...
            .get(snakecase_service_id, {***REMOVED***)
            .get('endpoint_url')
        )
