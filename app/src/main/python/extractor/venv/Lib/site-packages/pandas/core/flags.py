...
class Flags:
    ...
    _keys: set[str] = {"allows_duplicate_labels"***REMOVED***
    ...
    def allows_duplicate_labels(self) -> bool:
        ...
        Examples
        --------
        >>> df = pd.DataFrame({"A": [1, 2]***REMOVED***, index=['a', 'a'])
    ...
    def __setitem__(self, key: str, value) -> None:
        if key not in self._keys:
            raise ValueError(f"Unknown flag {key***REMOVED***. Must be one of {self._keys***REMOVED***")
        setattr(self, key, value)

    def __repr__(self) -> str:
        return f"<Flags(allows_duplicate_labels={self.allows_duplicate_labels***REMOVED***)>"
