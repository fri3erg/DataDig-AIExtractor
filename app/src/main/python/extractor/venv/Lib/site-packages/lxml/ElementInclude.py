...
XINCLUDE = "{http://www.w3.org/2001/XInclude***REMOVED***"
...
#     to {@link default_loader***REMOVED***.  If given, it should be a callable
...
# @throws LimitedRecursiveIncludeError If the {@link max_depth***REMOVED*** was exceeded.
...
def _include(elem, loader=None, base_url=None,
    ...
    for e in include_elements:
        if e.tag == XINCLUDE_INCLUDE:
            ...
            ***REMOVED***
                node = _include(node, loader, href, max_depth - 1, {href***REMOVED*** | _parent_hrefs)
                if e.tail:
