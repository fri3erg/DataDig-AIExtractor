...
Test SklearnClassifier, which requires the scikit-learn package.
    ...
    >>> train_data = [({"a": 4, "b": 1, "c": 0***REMOVED***, "ham"),
    ...               ({"a": 5, "b": 2, "c": 1***REMOVED***, "ham"),
    ...               ({"a": 0, "b": 3, "c": 4***REMOVED***, "spam"),
    ...               ({"a": 5, "b": 1, "c": 1***REMOVED***, "ham"),
    ...               ({"a": 1, "b": 4, "c": 3***REMOVED***, "spam")]
    >>> classif = SklearnClassifier(BernoulliNB()).train(train_data)
    >>> test_data = [{"a": 3, "b": 2, "c": 1***REMOVED***,
    ...              {"a": 0, "b": 3, "c": 7***REMOVED***]
...
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
    ...
    >>> train = [
    ...     ({'a': 1, 'b': 1, 'c': 1***REMOVED***, 'y'),
    ...     ({'a': 5, 'b': 5, 'c': 5***REMOVED***, 'x'),
    ...     ({'a': 0.9, 'b': 0.9, 'c': 0.9***REMOVED***, 'y'),
    ...     ({'a': 5.5, 'b': 5.4, 'c': 5.3***REMOVED***, 'x'),
    ...     ({'a': 0.8, 'b': 1.2, 'c': 1***REMOVED***, 'y'),
    ...     ({'a': 5.1, 'b': 4.9, 'c': 5.2***REMOVED***, 'x')
    ... ]

    >>> test = [
    ...     {'a': 1, 'b': 0.8, 'c': 1.2***REMOVED***,
    ...     {'a': 5.2, 'b': 5.1, 'c': 5***REMOVED***
    ... ]
