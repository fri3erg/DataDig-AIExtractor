...
from numpy.distutils.system_info ***REMOVED***tem_info, ConfigParser, mkl_info
...
def get_class(name, notfound_action=1):
    ...
    cl = {'temp1': Temp1Info,
          ...
          ***REMOVED***.get(name.lower(), _system_info)
    return cl()
...
extra_link_args = -Wl,-rpath={lib2_escaped:s***REMOVED***
rpath = {dir2:s***REMOVED***

[duplicate_options]
mylib_libs = {lib1:s***REMOVED***
libraries = {lib2:s***REMOVED***
"""
...
def test_distutils_parse_env_order(monkeypatch):
    ...
    for prefix in '^!':
        monkeypatch.setenv(env, f'{prefix***REMOVED***b,i,e')
        order, unknown = _parse_env_order(base_order, env)
        assert len(order) == 4
