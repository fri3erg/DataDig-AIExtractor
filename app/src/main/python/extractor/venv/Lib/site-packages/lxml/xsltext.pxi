    ...
    cdef _collectXSLTResultContent(self, _XSLTContext context, xmlNode* c_parent,
        ...
        while c_node is not NULL:
            ...
            if c_node.type == tree.XML_TEXT_NODE:
                ...
                raise TypeError, \
                    f"unsupported XSLT result type: {c_node.type***REMOVED***"
            c_node = c_next
        return results
    ...
    try:
        try:
            ...
            if dict_result is NULL:
                raise KeyError, f"extension element {funicode(c_inst_node.name)***REMOVED*** not found"
            ...
            try:
                ...
                if c_context_node.type in (tree.XML_DOCUMENT_NODE,
                    ...
                    raise TypeError(f"Unsupported element type: {c_context_node.type***REMOVED***")
                else:
