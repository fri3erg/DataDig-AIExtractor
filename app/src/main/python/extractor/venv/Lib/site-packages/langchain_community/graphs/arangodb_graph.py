    ...
    *Security note*: Make sure that the database connection uses credentials
    ...
    def generate_schema(
        ...
        graph_schema: List[Dict[str, Any]] = [
            {"graph_name": g["name"], "edge_definitions": g["edge_definitions"]***REMOVED***
        ...
        for collection in self.db.collections():
            ...
            aql = f"""
                FOR doc in {col_name***REMOVED***
                    LIMIT {limit_amount***REMOVED***
                    RETURN doc
            """
            ...
            for doc in self.__db.aql.execute(aql):
                for key, value in doc.items():
                    properties.append({"name": key, "type": type(value).__name__***REMOVED***)

            collection_schema.append(
                {
                    "collection_name": col_name,
                    "collection_type": col_type,
                    f"{col_type***REMOVED***_properties": properties,
                    f"example_{col_type***REMOVED***": doc,
                ***REMOVED***
***REMOVED***

        return {"Graph Schema": graph_schema, "Collection Schema": collection_schema***REMOVED***
