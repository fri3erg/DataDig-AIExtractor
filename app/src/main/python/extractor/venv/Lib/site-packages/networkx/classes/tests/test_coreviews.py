...
class TestAtlasView:
    ...
    def setup_method(self):
        self.d = {0: {"color": "blue", "weight": 1.2***REMOVED***, 1: {***REMOVED***, 2: {"color": 1***REMOVED******REMOVED***
...
class TestAdjacencyView:
    # node->nbr->data
    def setup_method(self):
        dd = {"color": "blue", "weight": 1.2***REMOVED***
        self.nd = {0: dd, 1: {***REMOVED***, 2: {"color": 1***REMOVED******REMOVED***
        self.adj = {3: self.nd, 0: {3: dd***REMOVED***, 1: {***REMOVED***, 2: {3: {"color": 1***REMOVED******REMOVED******REMOVED***
...
class TestMultiAdjacencyView(TestAdjacencyView):
    ...
    def setup_method(self):
        dd = {"color": "blue", "weight": 1.2***REMOVED***
        self.kd = {0: dd, 1: {***REMOVED***, 2: {"color": 1***REMOVED******REMOVED***
        self.nd = {3: self.kd, 0: {3: dd***REMOVED***, 1: {0: {***REMOVED******REMOVED***, 2: {3: {"color": 1***REMOVED******REMOVED******REMOVED***
        self.adj = {3: self.nd, 0: {3: {3: dd***REMOVED******REMOVED***, 1: {***REMOVED***, 2: {3: {8: {***REMOVED******REMOVED******REMOVED******REMOVED***
...
class TestUnionAtlas:
    # node->data
    def setup_method(self):
        self.s = {0: {"color": "blue", "weight": 1.2***REMOVED***, 1: {***REMOVED***, 2: {"color": 1***REMOVED******REMOVED***
        self.p = {3: {"color": "blue", "weight": 1.2***REMOVED***, 4: {***REMOVED***, 2: {"watch": 2***REMOVED******REMOVED***
    ...
    def test_repr(self):
        out = f"{self.av.__class__.__name__***REMOVED***({self.s***REMOVED***, {self.p***REMOVED***)"
        assert repr(self.av) == out
...
class TestUnionAdjacency:
    ...
    def setup_method(self):
        dd = {"color": "blue", "weight": 1.2***REMOVED***
        self.nd = {0: dd, 1: {***REMOVED***, 2: {"color": 1***REMOVED******REMOVED***
        self.s = {3: self.nd, 0: {***REMOVED***, 1: {***REMOVED***, 2: {3: {"color": 1***REMOVED******REMOVED******REMOVED***
        self.p = {3: {***REMOVED***, 0: {3: dd***REMOVED***, 1: {0: {***REMOVED******REMOVED***, 2: {1: {"color": 1***REMOVED******REMOVED******REMOVED***
    ...
    def test_repr(self):
        ...
        out = f"{clsname***REMOVED***({self.s***REMOVED***, {self.p***REMOVED***)"
        assert repr(self.adjview) == out
...
class TestUnionMultiInner(TestUnionAdjacency):
    ...
    def setup_method(self):
        dd = {"color": "blue", "weight": 1.2***REMOVED***
        self.kd = {7: {***REMOVED***, "ekey": {***REMOVED***, 9: {"color": 1***REMOVED******REMOVED***
        self.s = {3: self.kd, 0: {7: dd***REMOVED***, 1: {***REMOVED***, 2: {"key": {"color": 1***REMOVED******REMOVED******REMOVED***
        self.p = {3: {***REMOVED***, 0: {3: dd***REMOVED***, 1: {***REMOVED***, 2: {1: {"span": 2***REMOVED******REMOVED******REMOVED***
...
class TestUnionMultiAdjacency(TestUnionAdjacency):
    ...
    def setup_method(self):
        dd = {"color": "blue", "weight": 1.2***REMOVED***
        self.kd = {7: {***REMOVED***, 8: {***REMOVED***, 9: {"color": 1***REMOVED******REMOVED***
        self.nd = {3: self.kd, 0: {9: dd***REMOVED***, 1: {8: {***REMOVED******REMOVED***, 2: {9: {"color": 1***REMOVED******REMOVED******REMOVED***
        self.s = {3: self.nd, 0: {3: {7: dd***REMOVED******REMOVED***, 1: {***REMOVED***, 2: {3: {8: {***REMOVED******REMOVED******REMOVED******REMOVED***
        self.p = {3: {***REMOVED***, 0: {3: {9: dd***REMOVED******REMOVED***, 1: {***REMOVED***, 2: {1: {8: {***REMOVED******REMOVED******REMOVED******REMOVED***
