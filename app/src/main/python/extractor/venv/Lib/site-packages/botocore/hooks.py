    ...
    def _verify_accept_kwargs(self, func):
        ...
        try:
            if not accepts_kwargs(func):
                raise ValueError(
                    f"Event handler {func***REMOVED*** must accept keyword "
                    f"arguments (**kwargs)"
    ***REMOVED***
        except TypeError:
            return False
...
class HierarchicalEmitter(BaseEventHooks):
    ...
    ***REMOVED***
                unique_id_handler_item = {'handler': handler***REMOVED***
                if unique_id_uses_count:
...
class EventAliaser(BaseEventHooks):
    def __init__(self, event_emitter, event_aliases=None):
        ...
        if event_aliases is None:
            self._event_aliases = EVENT_ALIASES
        self._alias_name_cache = {***REMOVED***
    ...
    def _alias_event_name(self, event_name):
        ...
        for old_part, new_part in self._event_aliases.items():
            ...
            logger.debug(
                f"Changing event name from {event_name***REMOVED*** to {new_name***REMOVED***"
***REMOVED***
...
class _PrefixTrie:
    ...
    def __init__(self):
        ...
        # {'foo': {'children': {'bar': {...***REMOVED******REMOVED******REMOVED******REMOVED***.
        self._root = {'chunk': None, 'children': {***REMOVED***, 'values': None***REMOVED***
    ...
    def append_item(self, key, value, section=_MIDDLE):
        ...
        for part in key_parts:
            if part not in current['children']:
                new_child = {'chunk': part, 'values': None, 'children': {***REMOVED******REMOVED***
    ...
    def _remove_item(self, current_node, key_parts, value, index):
        if current_node is None:
            ...
            if next_node is not None:
                ...
                raise ValueError(f"key is not in trie: {'.'.join(key_parts)***REMOVED***")
