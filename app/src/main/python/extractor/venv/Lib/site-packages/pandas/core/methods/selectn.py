...
class SelectNSeries(SelectN):
    ...
    obj : Series
    n : int
    keep : {'first', 'last'***REMOVED***, default 'first'
    ...
    def compute(self, method: str) -> Series:
        ...
        if not self.is_valid_dtype_n_method(dtype):
            raise TypeError(f"Cannot use method '{method***REMOVED***' with dtype {dtype***REMOVED***")
...
class SelectNFrame(SelectN):
    ...
    def compute(self, method: str) -> DataFrame:
        ...
        for column in columns:
            ...
            if not self.is_valid_dtype_n_method(dtype):
                raise TypeError(
                    f"Column {repr(column)***REMOVED*** has dtype {dtype***REMOVED***, "
                    f"cannot use method {repr(method)***REMOVED*** with this dtype"
    ***REMOVED***
