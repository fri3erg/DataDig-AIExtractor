...
def _runtime_warning_context():  # type: ignore[no-untyped-def]
    ...
    with warnings.catch_warnings(record=True) as _warnings:
        yield
        rw = [
            "{w.filename***REMOVED***:{w.lineno***REMOVED***:{w.message***REMOVED***".format(w=w)
            for w in _warnings
            if w.category == RuntimeWarning
        ]
        if rw:
            raise RuntimeError(
                "{***REMOVED*** Runtime Warning{***REMOVED***,\n{***REMOVED***".format(
...
def pytest_generate_tests(metafunc):  # type: ignore[no-untyped-def]
    ...
    avail_factories = {"pyloop": asyncio.DefaultEventLoopPolicy***REMOVED***
    ...
    factories = {***REMOVED***  # type: ignore[var-annotated]
    ...
    async def go(
        ...
        **kwargs: Any
        ...
        if isinstance(__param, Application):
            server_kwargs = server_kwargs or {***REMOVED***
