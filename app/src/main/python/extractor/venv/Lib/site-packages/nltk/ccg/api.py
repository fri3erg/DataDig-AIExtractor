...
class Direction:
    ...
    def __str__(self):
        ...
        for r in self._restrs:
            r_str = r_str + "%s" % r
        return f"{self._dir***REMOVED***{r_str***REMOVED***"
...
class PrimitiveCategory(AbstractCCGCategory):
    ...
    def __str__(self):
        ...
        return f"{self._categ***REMOVED***{restrictions***REMOVED***"
...
class FunctionalCategory(AbstractCCGCategory):
    ...
    def __str__(self):
        return f"({self._res***REMOVED***{self._dir***REMOVED***{self._arg***REMOVED***)"
