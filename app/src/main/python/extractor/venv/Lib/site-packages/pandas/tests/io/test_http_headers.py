...
def test_to_parquet_to_disk_with_storage_options(engine):
    ...
    ***REMOVED***
    ...
    true_df = pd.DataFrame({"column_name": ["column_value"]***REMOVED***)
    msg = (
