...
class BaseClientExceptions:
    ...
    def __getattr__(self, name):
        ...
        raise AttributeError(
            fr"{self***REMOVED*** object has no attribute {name***REMOVED***. "
            fr"Valid exceptions are: {', '.join(exception_cls_names)***REMOVED***"
        )


class ClientExceptionsFactory:
    def __init__(self):
        self._client_exceptions_cache = {***REMOVED***
