...
class JsonValidityEvaluator(StringEvaluator):
    ...
    Examples:
        ...
        >>> prediction = '{"name": "John", "age": 30, "city": "New York"***REMOVED***'
        >>> evaluator.evaluate(prediction)
        {'score': 1***REMOVED***

        >>> prediction = '{"name": "John", "age": 30, "city": "New York",***REMOVED***'
        >>> evaluator.evaluate(prediction)
        {'score': 0, 'reasoning': 'Expecting property name enclosed in double quotes'***REMOVED***
    """
    ...
    def _evaluate_strings(
        ...
        **kwargs: Any,
        ...
        try:
            ...
            return {"score": 1***REMOVED***
        except Exception as e:
            return {"score": 0, "reasoning": str(e)***REMOVED***
...
class JsonEqualityEvaluator(StringEvaluator):
    ...
    Examples:
        ...
        >>> evaluator.evaluate_strings('{"a": 1***REMOVED***', reference='{"a": 1***REMOVED***')
        {'score': True***REMOVED***
        >>> evaluator.evaluate_strings('{"a": 1***REMOVED***', reference='{"a": 2***REMOVED***')
        {'score': False***REMOVED***
