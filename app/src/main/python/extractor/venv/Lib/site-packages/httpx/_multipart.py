...
class DataField:
    ...
    def __init__(
        ...
        if not isinstance(name, str):
            raise TypeError(
                f"Invalid type for name. Expected str, got {type(name)***REMOVED***: {name!r***REMOVED***"
***REMOVED***
        if value is not None and not isinstance(value, (str, bytes, int, float)):
            raise TypeError(
                "Invalid type for value. Expected primitive type,"
                f" got {type(value)***REMOVED***: {value!r***REMOVED***"
***REMOVED***
        self.name = name
...
class FileField:
    ...
    def __init__(self, name: str, value: FileTypes) -> None:
        ...
        headers: typing.Dict[str, str] = {***REMOVED***
    ...
    def render_headers(self) -> bytes:
        if not hasattr(self, "_headers"):
            ...
            for header_name, header_value in self.headers.items():
                key, val = f"\r\n{header_name***REMOVED***: ".encode(), header_value.encode()
...
class MultipartStream(SyncByteStream, AsyncByteStream):
    ...
    def get_content_length(self) -> typing.Optional[int]:
        ...
        for field in self.fields:
            ...
            length += 2 + boundary_length + 2  # b"--{boundary***REMOVED***\r\n"
            length += field_length
            length += 2  # b"\r\n"

        length += 2 + boundary_length + 4  # b"--{boundary***REMOVED***--\r\n"
        return length
    ...
    def get_headers(self) -> typing.Dict[str, str]:
        ...
        if content_length is None:
            return {"Transfer-Encoding": "chunked", "Content-Type": content_type***REMOVED***
        return {"Content-Length": str(content_length), "Content-Type": content_type***REMOVED***
