...
***REMOVED***,
    ...
    def test_flex_method_equivalence(self, opname, ts):
        # check that Series.{opname***REMOVED*** behaves like Series.__{opname***REMOVED***__,
        tser = Series(
    ...
    def test_comp_ops_df_compat(self, left, right, frame_or_series):
        ...
        if frame_or_series is not Series:
            msg = (
                ...
                f"{frame_or_series.__name__***REMOVED*** objects"
***REMOVED***
            left = left.to_frame()
            right = right.to_frame()
        else:
            msg = (
                f"Can only compare identically-labeled {frame_or_series.__name__***REMOVED*** "
                f"objects"
***REMOVED***
