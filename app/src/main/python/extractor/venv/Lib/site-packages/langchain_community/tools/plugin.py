...
class AIPluginTool(BaseTool):
    ...
    def from_plugin_url(cls, url: str) -> AIPluginTool:
        ...
        description = (
            ...
            f"for interacting with the {plugin.name_for_human***REMOVED*** API. "
            f"You should only call this ONCE! What is the "
            f"{plugin.name_for_human***REMOVED*** API useful for? "
        ...
        api_spec = (
            f"Usage Guide: {plugin.description_for_model***REMOVED***\n\n"
            f"OpenAPI Spec: {open_api_spec***REMOVED***"
        )
