...
dtype : Type name or dict of column -> type, default None
    Data type for data or columns. E.g. {{'a': np.float64, 'b': np.int32***REMOVED******REMOVED***
    Use ``object`` to preserve data as stored in Excel and not interpret dtype,
    which will necessarily result in ``object`` dtype.
    If converters are specified, they will be applied INSTEAD
    of dtype conversion.
    If you use ``None``, it will infer the dtype of each column based on the data.
engine : {{'openpyxl', 'calamine', 'odf', 'pyxlsb', 'xlrd'***REMOVED******REMOVED***, default None
...
...               dtype={{'Name': str, 'Value': float***REMOVED******REMOVED***)  # doctest: +SKIP
       Name  Value
0   string1    1.0
1   string2    2.0
2  #Comment    3.0
...
class BaseExcelReader(Generic[_WorkbookT]):
    ...
    def __init__(
        ...
        self.handles = IOHandles(
            handle=filepath_or_buffer, compression={"method": None***REMOVED***
        )
...
***REMOVED***
    ...
    def raise_if_bad_sheet_by_index(self, index: int) -> None:
        ...
        if index >= n_sheets:
            raise ValueError(
                f"Worksheet index {index***REMOVED*** is invalid, {n_sheets***REMOVED*** worksheets found"
***REMOVED***

    def raise_if_bad_sheet_by_name(self, name: str) -> None:
        if name not in self.sheet_names:
            raise ValueError(f"Worksheet named '{name***REMOVED***' not found")
...
***REMOVED***
    ...
    def parse(
        ...
        **kwds,
        ...
        for asheetname in sheets:
            ...
            if verbose:
                print(f"Reading sheet {asheetname***REMOVED***")
            ...
            if header is not None and is_list_like(header):
                ...
                for row in header:
                    ...
                    if row > len(data) - 1:
                        raise ValueError(
                            f"header index {row***REMOVED*** exceeds maximum index "
                            f"{len(data) - 1***REMOVED*** of data.",
            ***REMOVED***
    ...
    ***REMOVED***
        ...
        ***REMOVED***
                ...
                err.args = (f"{err.args[0]***REMOVED*** (sheet: {asheetname***REMOVED***)", *err.args[1:])
                raise err
...
class ExcelWriter(Generic[_WorkbookT]):
    ...
    * `odswriter <https://pypi.org/project/odswriter/>`__ for ods files
    ...
    mode : {{'w', 'a'***REMOVED******REMOVED***, default 'w'
        File mode to use (write or append). Append does not work with fsspec URLs.
    {storage_options***REMOVED***

    if_sheet_exists : {{'error', 'new', 'replace', 'overlay'***REMOVED******REMOVED***, default 'error'
    ...
    ...     "path_to_file.xlsx",
    ...     engine="xlsxwriter",
    ...     engine_kwargs={{"options": {{"nan_inf_to_errors": True***REMOVED******REMOVED******REMOVED******REMOVED***
    ... ) as writer:
    ...     df.to_excel(writer)  # doctest: +SKIP
    ...
    ...     engine="openpyxl",
    ...     mode="a",
    ...     engine_kwargs={{"keep_vba": True***REMOVED******REMOVED***
    ... ) as writer:
    ...
    def __new__(
        ...
        if cls is ExcelWriter:
            if engine is None or (isinstance(engine, str) and engine == "auto"):
                ...
                try:
                    engine = config.get_option(f"io.excel.{ext***REMOVED***.writer", silent=True)
                    if engine == "auto":
                        engine = get_default_engine(ext, mode="writer")
                except KeyError as err:
                    raise ValueError(f"No engine for filetype: '{ext***REMOVED***'") from err
    ...
    def __init__(
        ...
        if if_sheet_exists not in (None, "error", "new", "replace", "overlay"):
            raise ValueError(
                f"'{if_sheet_exists***REMOVED***' is not valid for if_sheet_exists. "
...
***REMOVED***
        ...
        self._handles = IOHandles(
            cast(IO[bytes], path), compression={"compression": None***REMOVED***
        )
...
***REMOVED***
    ...
    def check_extension(cls, ext: str) -> Literal[True]:
        ...
        if not any(ext in extension for extension in cls._supported_extensions):
            raise ValueError(f"Invalid extension for engine '{cls.engine***REMOVED***': '{ext***REMOVED***'")
        return True
    ...
    ***REMOVED***
    ...
    def __init__(
        ...
        if engine is not None and engine not in self._engines:
            raise ValueError(f"Unknown engine: {engine***REMOVED***")
...
***REMOVED***
    ...
    ***REMOVED***
        ...
        ***REMOVED***
            ...
            engine = config.get_option(f"io.excel.{ext***REMOVED***.reader", silent=True)
            if engine == "auto":
