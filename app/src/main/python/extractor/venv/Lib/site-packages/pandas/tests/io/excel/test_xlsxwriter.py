...
def test_column_format(ext):
    ...
    with tm.ensure_clean(ext) as path:
        frame = DataFrame({"A": [123456, 123456], "B": [123456, 123456]***REMOVED***)
        ...
        with ExcelWriter(path) as writer:
            ...
            col_format = write_workbook.add_format({"num_format": num_format***REMOVED***)
...
def test_engine_kwargs(ext, nan_inf_to_errors):
    # GH 42286
    engine_kwargs = {"options": {"nan_inf_to_errors": nan_inf_to_errors***REMOVED******REMOVED***
    with tm.ensure_clean(ext) as f:
