...
class ConfusionMatrix:
    ...
    *r* corresponds to the test value *t*.  E.g.:
    ...
    def __init__(self, reference, test, sort_by_count=False):
        ...
        indices = {val: i for (i, val) in enumerate(values)***REMOVED***
    ...
    def __repr__(self):
        return f"<ConfusionMatrix: {self._correct***REMOVED***/{self._total***REMOVED*** correct>"
...
***REMOVED***
    ...
    def evaluate(self, alpha=0.5, truncate=None, sort_by_count=False):
        ...
        s = (
            f"{' ' * (tag_column_len - 3)***REMOVED***Tag | Prec.  | Recall | F-measure\n"
            f"{'-' * tag_column_len***REMOVED***-+--------+--------+-----------\n"
        )

        # Construct the body
        for tag in tags:
            s += (
                f"{tag:>{tag_column_len***REMOVED******REMOVED*** | "
                f"{self.precision(tag):<6.4f***REMOVED*** | "
                f"{self.recall(tag):<6.4f***REMOVED*** | "
                f"{self.f_measure(tag, alpha=alpha):.4f***REMOVED***\n"
***REMOVED***
