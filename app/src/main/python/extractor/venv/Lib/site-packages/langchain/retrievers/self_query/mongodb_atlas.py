...
class MongoDBAtlasTranslator(Visitor):
    ...
    def visit_operation(self, operation: Operation) -> Dict:
        ...
        return {self._format_func(operation.operator): args***REMOVED***
    ...
    def visit_comparison(self, comparison: Comparison) -> Dict:
        ...
        return {attribute: {comparator: comparison.value***REMOVED******REMOVED***
    ...
    def visit_structured_query(
        ...
        if structured_query.filter is None:
            ...
            kwargs = {"pre_filter": structured_query.filter.accept(self)***REMOVED***
