    ...
    def test_build_table_schema(self):
        ...
        expected = {
            "fields": [
                ...
                {"name": "A", "type": "any", "extDtype": "DateDtype"***REMOVED***,
                {"name": "B", "type": "number", "extDtype": "decimal"***REMOVED***,
                {"name": "C", "type": "any", "extDtype": "string"***REMOVED***,
                {"name": "D", "type": "integer", "extDtype": "Int64"***REMOVED***,
            ],
            "primaryKey": ["index"],
        ***REMOVED***
...
class TestTableOrient:
    ...
    def test_build_decimal_series(self, dc):
        ...
        fields = [
            {"name": "id", "type": "integer"***REMOVED***,
            {"name": "a", "type": "number", "extDtype": "decimal"***REMOVED***,
        ]
    ...
    def test_build_string_series(self, sa):
        ...
        fields = [
            {"name": "id", "type": "integer"***REMOVED***,
            {"name": "a", "type": "any", "extDtype": "string"***REMOVED***,
        ]
    ...
    def test_build_int64_series(self, ia):
        ...
        fields = [
            {"name": "id", "type": "integer"***REMOVED***,
            {"name": "a", "type": "integer", "extDtype": "Int64"***REMOVED***,
        ]
    ...
    def test_to_json(self, df):
        ...
        fields = [
            OrderedDict({"name": "idx", "type": "integer"***REMOVED***),
            OrderedDict({"name": "A", "type": "any", "extDtype": "DateDtype"***REMOVED***),
            OrderedDict({"name": "B", "type": "number", "extDtype": "decimal"***REMOVED***),
            OrderedDict({"name": "C", "type": "any", "extDtype": "string"***REMOVED***),
            OrderedDict({"name": "D", "type": "integer", "extDtype": "Int64"***REMOVED***),
        ]

        schema = OrderedDict({"fields": fields, "primaryKey": ["idx"]***REMOVED***)
        data = [
            OrderedDict(
                [
                    ("idx", 0),
...
***REMOVED***
    ...
    def test_json_ext_dtype_reading(self):
        ...
        ***REMOVED***"""
        result = read_json(StringIO(data_json), orient="table")
        expected = DataFrame({"a": Series([2, NA], dtype="Int64")***REMOVED***)
        tm.assert_frame_equal(result, expected)
