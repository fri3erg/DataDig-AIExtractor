...
"""
        ...
        cls.attribute_graph.graph["node_default"] = {"frog": True***REMOVED***
...
"""
    ...
    def test_default_attribute(self):
        ...
        G.graph["edge_default"] = {"foo": 7***REMOVED***
        fh = io.BytesIO()
        nx.write_gexf(G, fh)
        fh.seek(0)
...
gexf.xsd" version="1.2">
  <meta lastmodifieddate="{time.strftime('%Y-%m-%d')***REMOVED***">
    <creator>NetworkX {nx.__version__***REMOVED***</creator>
  </meta>
  <graph defaultedgetype="undirected" mode="dynamic" name="" timeformat="long">
    ...
    def test_edge_id_construct(self):
        G = nx.Graph()
        G.add_edges_from([(0, 1, {"id": 0***REMOVED***), (1, 2, {"id": 2***REMOVED***), (2, 3)])
...
gexf.net/1.2draft http://www.gexf.net/1.2draft/gexf.xsd" version="1.2">
  ...
  <graph defaultedgetype="undirected" mode="static" name="">
    ...
    def test_numpy_type(self):
        ...
        G = nx.path_graph(4)
        nx.set_node_attributes(G, {n: n for n in np.arange(4)***REMOVED***, "number")
 ...
 version="1.2">
  ...
  <graph defaultedgetype="undirected" mode="static" name="">
    ...
    def test_missing_viz_attributes(self):
        ...
        G.nodes[0]["viz"]["position"] = {"x": 0, "y": 1, "z": 0***REMOVED***
        ...
        G.nodes[0]["viz"] = {"size": 54***REMOVED***
        G.nodes[0]["viz"]["position"] = {"x": 0, "y": 1, "z": 0***REMOVED***
        G.nodes[0]["viz"]["color"] = {"r": 0, "g": 0, "b": 256, "a": 0.5***REMOVED***
