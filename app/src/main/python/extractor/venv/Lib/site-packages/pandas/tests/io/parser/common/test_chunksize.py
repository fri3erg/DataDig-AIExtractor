...
"""
    parser = all_parsers
    kwargs = {"index_col": 0, "nrows": 5***REMOVED***
...
@pytest.mark.parametrize("kwargs", [{***REMOVED***, {"index_col": 0***REMOVED***])
...
***REMOVED***
    ...
    expected_frames = [
        DataFrame({"a": [1, 5], "b": [2, 6]***REMOVED***),
        DataFrame({"a": [9], "b": [10]***REMOVED***, index=[2]),
    ]
...
"""
    ...
    expected_frames = [
        ...
        DataFrame({"a": [9], "b": [10], "c": [11], "d": [np.nan]***REMOVED***, index=[2]),
    ]
