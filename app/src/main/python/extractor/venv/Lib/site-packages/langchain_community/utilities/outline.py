...
class OutlineAPIWrapper(BaseModel):
    ...
    def _outline_api_query(self, query: str) -> List:
        raw_result = requests.post(
            f"{self.outline_instance_url***REMOVED***{self.outline_search_endpoint***REMOVED***",
            data={"query": query, "limit": self.top_k_results***REMOVED***,
            headers={"Authorization": f"Bearer {self.outline_api_key***REMOVED***"***REMOVED***,
        )
