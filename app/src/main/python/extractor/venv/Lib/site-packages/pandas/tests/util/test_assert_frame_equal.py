...
def test_frame_equal_row_order_mismatch(check_like, obj_fixture):
    df1 = DataFrame({"A": [1, 2, 3], "B": [4, 5, 6]***REMOVED***, index=["a", "b", "c"])
    df2 = DataFrame({"A": [3, 2, 1], "B": [6, 5, 4]***REMOVED***, index=["c", "b", "a"])

    if not check_like:  # Do not ignore row-column orderings.
        msg = f"{obj_fixture***REMOVED***.index are different"
...
@pytest.mark.parametrize(
    "df1,df2",
    [
        (DataFrame({"A": [1, 2, 3]***REMOVED***), DataFrame({"A": [1, 2, 3, 4]***REMOVED***)),
        (DataFrame({"A": [1, 2, 3], "B": [4, 5, 6]***REMOVED***), DataFrame({"A": [1, 2, 3]***REMOVED***)),
    ],
)
def test_frame_equal_shape_mismatch(df1, df2, obj_fixture):
    msg = f"{obj_fixture***REMOVED*** are different"
...
@pytest.mark.parametrize(
    ...
    [
        # Index
        (
            DataFrame.from_records({"a": [1, 2], "c": ["l1", "l2"]***REMOVED***, index=["a"]),
            DataFrame.from_records({"a": [1.0, 2.0], "c": ["l1", "l2"]***REMOVED***, index=["a"]),
            "DataFrame\\.index are different",
        ),
        # MultiIndex
        (
            DataFrame.from_records(
                {"a": [1, 2], "b": [2.1, 1.5], "c": ["l1", "l2"]***REMOVED***, index=["a", "b"]
***REMOVED***,
            DataFrame.from_records(
                {"a": [1.0, 2.0], "b": [2.1, 1.5], "c": ["l1", "l2"]***REMOVED***, index=["a", "b"]
***REMOVED***,
...
def test_frame_equal_index_dtype_mismatch(df1, df2, msg, check_index_type):
    kwargs = {"check_index_type": check_index_type***REMOVED***
...
def test_empty_dtypes(check_dtype):
    ...
    kwargs = {"check_dtype": check_dtype***REMOVED***
...
{obj_fixture***REMOVED***\\.index values are different \\(33\\.33333 %\\)
\\[left\\]:  Index\\(\\['a', 'b', 'c'\\], dtype='{dtype***REMOVED***'\\)
\\[right\\]: Index\\(\\['a', 'b', 'd'\\], dtype='{dtype***REMOVED***'\\)
At positional index 2, first diff: c != d"""

    df1 = DataFrame({"A": [1, 2, 3], "B": [4, 5, 6]***REMOVED***, index=["a", "b", "c"])
    df2 = DataFrame({"A": [1, 2, 3], "B": [4, 5, 6]***REMOVED***, index=["a", "b", "d"])
...
def test_frame_equal_columns_mismatch(check_like, obj_fixture, using_infer_string):
    if using_infer_string:
        ...
        dtype = "object"
    msg = f"""{obj_fixture***REMOVED***\\.columns are different

{obj_fixture***REMOVED***\\.columns values are different \\(50\\.0 %\\)
\\[left\\]:  Index\\(\\['A', 'B'\\], dtype='{dtype***REMOVED***'\\)
\\[right\\]: Index\\(\\['A', 'b'\\], dtype='{dtype***REMOVED***'\\)"""

    df1 = DataFrame({"A": [1, 2, 3], "B": [4, 5, 6]***REMOVED***, index=["a", "b", "c"])
    df2 = DataFrame({"A": [1, 2, 3], "b": [4, 5, 6]***REMOVED***, index=["a", "b", "c"])
...
def test_frame_equal_block_mismatch(by_blocks_fixture, obj_fixture):
    obj = obj_fixture
    msg = f"""{obj***REMOVED***\\.iloc\\[:, 1\\] \\(column name="B"\\) are different

{obj***REMOVED***\\.iloc\\[:, 1\\] \\(column name="B"\\) values are different \\(33\\.33333 %\\)
\\[index\\]: \\[0, 1, 2\\]
\\[left\\]:  \\[4, 5, 6\\]
\\[right\\]: \\[4, 5, 7\\]"""

    df1 = DataFrame({"A": [1, 2, 3], "B": [4, 5, 6]***REMOVED***)
    df2 = DataFrame({"A": [1, 2, 3], "B": [4, 5, 7]***REMOVED***)
...
@pytest.mark.parametrize(
    ...
    [
        (
            DataFrame({"A": ["á", "à", "ä"], "E": ["é", "è", "ë"]***REMOVED***),
            DataFrame({"A": ["á", "à", "ä"], "E": ["é", "è", "e̊"]***REMOVED***),
            """{obj***REMOVED***\\.iloc\\[:, 1\\] \\(column name="E"\\) are different

{obj***REMOVED***\\.iloc\\[:, 1\\] \\(column name="E"\\) values are different \\(33\\.33333 %\\)
\\[index\\]: \\[0, 1, 2\\]
\\[left\\]:  \\[é, è, ë\\]
\\[right\\]: \\[é, è, e̊\\]""",
        ),
        (
            DataFrame({"A": ["á", "à", "ä"], "E": ["é", "è", "ë"]***REMOVED***),
            DataFrame({"A": ["a", "a", "a"], "E": ["e", "e", "e"]***REMOVED***),
            """{obj***REMOVED***\\.iloc\\[:, 0\\] \\(column name="A"\\) are different

{obj***REMOVED***\\.iloc\\[:, 0\\] \\(column name="A"\\) values are different \\(100\\.0 %\\)
\\[index\\]: \\[0, 1, 2\\]
\\[left\\]:  \\[á, à, ä\\]
\\[right\\]: \\[a, a, a\\]""",
        ),
...
def test_assert_frame_equal_extension_dtype_mismatch():
    ...
    left = DataFrame({"a": [1, 2, 3]***REMOVED***, dtype="Int64")
...
def test_assert_frame_equal_interval_dtype_mismatch():
    # https://github.com/pandas-dev/pandas/issues/32747
    left = DataFrame({"a": [pd.Interval(0, 1)]***REMOVED***, dtype="interval")
...
def test_assert_frame_equal_ignore_extension_dtype_mismatch():
    ...
    left = DataFrame({"a": [1, 2, 3]***REMOVED***, dtype="Int64")
    right = DataFrame({"a": [1, 2, 3]***REMOVED***, dtype="Int32")
    tm.assert_frame_equal(left, right, check_dtype=False)
...
def test_assert_frame_equal_ignore_extension_dtype_mismatch_cross_class():
    # https://github.com/pandas-dev/pandas/issues/35715
    left = DataFrame({"a": [1, 2, 3]***REMOVED***, dtype="Int64")
    right = DataFrame({"a": [1, 2, 3]***REMOVED***, dtype="int64")
    tm.assert_frame_equal(left, right, check_dtype=False)
...
def test_assert_frame_equal_datetime_like_dtype_mismatch(dtype):
    df1 = DataFrame({"a": []***REMOVED***, dtype=dtype)
    df2 = DataFrame({"a": []***REMOVED***)
...
def test_assert_frame_equal_ea_column_definition_in_exception_mask():
    # GH#50323
    df1 = DataFrame({"a": pd.Series([pd.NA, 1], dtype="Int64")***REMOVED***)
    df2 = DataFrame({"a": pd.Series([1, 1], dtype="Int64")***REMOVED***)
...
def test_assert_frame_equal_ea_column_definition_in_exception():
    # GH#50323
    df1 = DataFrame({"a": pd.Series([pd.NA, 1], dtype="Int64")***REMOVED***)
    df2 = DataFrame({"a": pd.Series([pd.NA, 2], dtype="Int64")***REMOVED***)
...
def test_assert_frame_equal_ts_column():
    # GH#50323
    df1 = DataFrame({"a": [pd.Timestamp("2019-12-31"), pd.Timestamp("2020-12-31")]***REMOVED***)
    df2 = DataFrame({"a": [pd.Timestamp("2020-12-31"), pd.Timestamp("2020-12-31")]***REMOVED***)
...
def test_assert_frame_equal_set():
    # GH#51727
    df1 = DataFrame({"set_column": [{1, 2, 3***REMOVED***, {4, 5, 6***REMOVED***]***REMOVED***)
    df2 = DataFrame({"set_column": [{1, 2, 3***REMOVED***, {4, 5, 6***REMOVED***]***REMOVED***)
    tm.assert_frame_equal(df1, df2)
...
def test_assert_frame_equal_set_mismatch():
    # GH#51727
    df1 = DataFrame({"set_column": [{1, 2, 3***REMOVED***, {4, 5, 6***REMOVED***]***REMOVED***)
    df2 = DataFrame({"set_column": [{1, 2, 3***REMOVED***, {4, 5, 7***REMOVED***]***REMOVED***)
