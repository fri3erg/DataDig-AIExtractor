...
def _zip_descr(seqarrays, flatten=False):
    ...
    seqarrays : sequence of arrays
        Sequence of arrays
    flatten : {boolean***REMOVED***, optional
...
def get_fieldstructure(adtype, lastname=None, parents=None,):
    ...
    {'A': [], 'B': [], 'BA': ['B'], 'BB': ['B'], 'BBA': ['B', 'BB'], 'BBB': ['B', 'BB']***REMOVED***
...
def _izip_records(seqarrays, fill_value=None, flatten=True):
    ...
    seqarrays : sequence of arrays
        Sequence of arrays.
    fill_value : {None, integer***REMOVED***
        Value used to pad shorter iterables.
    flatten : {True, False***REMOVED***,
        Whether to
    """
...
def _fix_defaults(output, defaults=None):
    ...
    for (k, v) in (defaults or {***REMOVED***).items():
        if k in names:
            fill_value[k] = v
            data[k][mask[k]] = v
    return output
...
def merge_arrays(seqarrays, fill_value=-1, flatten=False,
    ...
    seqarrays : sequence of ndarrays
        Sequence of arrays
    fill_value : {float***REMOVED***, optional
        Filling value used to pad missing data on the shorter arrays.
    flatten : {False, True***REMOVED***, optional
        Whether to collapse nested fields.
    usemask : {False, True***REMOVED***, optional
        Whether to return a masked array or not.
    asrecarray : {False, True***REMOVED***, optional
...
def rename_fields(base, namemapper):
    ...
    >>> rfn.rename_fields(a, {'a':'A', 'bb':'BB'***REMOVED***)
...
'offsets': [0, 8, 16], 'itemsize': 24***REMOVED***, align=True)
    >>> print_offsets(dt)
    offsets: [0, 8, 16]
    itemsize: 24
...
def structured_to_unstructured(arr, dtype=None, copy=False, casting='unsafe'):
    ...
    names = ['f{***REMOVED***'.format(n) for n in range(n_fields)]
    ...
    flattened_fields = np.dtype({'names': names,
                                 'formats': dts,
                                 'offsets': offsets,
                                 'itemsize': arr.dtype.itemsize***REMOVED***)
    ...
    packed_fields = np.dtype({'names': names,
                              'formats': [(out_dtype, dt.shape) for dt in dts]***REMOVED***)
...
def unstructured_to_structured(arr, dtype=None, names=None, align=False,
    ...
    if dtype is None:
        if names is None:
            names = ['f{***REMOVED***'.format(n) for n in range(n_elem)]
    ...
    names = ['f{***REMOVED***'.format(n) for n in range(len(fields))]

    # Use a series of views and casts to convert to a structured array:

    # first view as a packed structured array of one dtype
    packed_fields = np.dtype({'names': names,
                              'formats': [(arr.dtype, dt.shape) for dt in dts]***REMOVED***)
    ...
    flattened_fields = np.dtype({'names': names,
                                 'formats': dts,
                                 'offsets': offsets,
                                 'itemsize': out_dtype.itemsize***REMOVED***)
...
def stack_arrays(arrays, defaults=None, usemask=True, asrecarray=False,
    ...
    usemask : {True, False***REMOVED***, optional
        Whether to return a MaskedArray (or MaskedRecords is
        `asrecarray==True`) or a ndarray.
    asrecarray : {False, True***REMOVED***, optional
        Whether to return a recarray (or MaskedRecords if `usemask==True`)
        or just a flexible-type ndarray.
    autoconvert : {False, True***REMOVED***, optional
...
def find_duplicates(a, key=None, ignoremask=True, return_index=False):
    ...
    a : array-like
        Input array
    key : {string, None***REMOVED***, optional
        Name of the fields along which to check the duplicates.
        If None, the search is performed by records
    ignoremask : {True, False***REMOVED***, optional
        Whether masked data should be discarded or considered as duplicates.
    return_index : {False, True***REMOVED***, optional
...
def join_by(key, r1, r2, jointype='inner', r1postfix='1', r2postfix='2',
    ...
    Parameters
    ----------
    key : {string, sequence***REMOVED***
        A string or a sequence of strings corresponding to the fields used
        for comparison.
    r1, r2 : arrays
        Structured arrays.
    jointype : {'inner', 'outer', 'leftouter'***REMOVED***, optional
    ...
    defaults : {dictionary***REMOVED***, optional
        Dictionary mapping field names to the corresponding default values.
    usemask : {True, False***REMOVED***, optional
        Whether to return a MaskedArray (or MaskedRecords is
        `asrecarray==True`) or a ndarray.
