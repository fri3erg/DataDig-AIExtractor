...
***REMOVED***
    ...
    def _identifying_params(self) -> Mapping[str, Any]:
        ...
        return {"model": self.model, "instruction": self.instruction***REMOVED***
    ...
    def _handle_request(self, payload: EmbaasEmbeddingsPayload) -> List[List[float]]:
        ...
        headers = {
            "Authorization": f"Bearer {self.embaas_api_key.get_secret_value()***REMOVED***",
    ...
    def _generate_embeddings(self, texts: List[str]) -> List[List[float]]:
        ...
        try:
            ...
            if e.response is None or not e.response.text:
                raise ValueError(f"Error raised by embaas embeddings API: {e***REMOVED***")

            parsed_response = e.response.json()
            if "message" in parsed_response:
                raise ValueError(
                    "Validation Error raised by embaas embeddings API:"
                    f"{parsed_response['message']***REMOVED***"
    ***REMOVED***
            raise
