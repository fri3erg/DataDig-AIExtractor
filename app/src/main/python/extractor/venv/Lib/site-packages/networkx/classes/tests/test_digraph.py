...
class BaseDiGraphTester(BaseGraphTester):
    ...
    def test_out_edges_data(self):
        G = nx.DiGraph([(0, 1, {"data": 0***REMOVED***), (1, 0, {***REMOVED***)])
        assert sorted(G.out_edges(data=True)) == [(0, 1, {"data": 0***REMOVED***), (1, 0, {***REMOVED***)]
        assert sorted(G.out_edges(0, data=True)) == [(0, 1, {"data": 0***REMOVED***)]
    ...
    def test_in_edges_data(self):
        G = nx.DiGraph([(0, 1, {"data": 0***REMOVED***), (1, 0, {***REMOVED***)])
        assert sorted(G.in_edges(data=True)) == [(0, 1, {"data": 0***REMOVED***), (1, 0, {***REMOVED***)]
        assert sorted(G.in_edges(1, data=True)) == [(0, 1, {"data": 0***REMOVED***)]
    ...
    def test_degree(self):
        ...
        assert dict(G.degree()) == {0: 4, 1: 4, 2: 4***REMOVED***
        assert G.degree(0) == 4
    ...
    def test_in_degree(self):
        ...
        assert dict(G.in_degree()) == {0: 2, 1: 2, 2: 2***REMOVED***
    ...
    def test_out_degree(self):
        ...
        assert dict(G.out_degree()) == {0: 2, 1: 2, 2: 2***REMOVED***
...
class BaseAttrDiGraphTester(BaseDiGraphTester, BaseAttrGraphTester):
    ...
    def test_in_degree_weighted(self):
        ...
        assert dict(G.in_degree(weight="weight")) == {0: 2, 1: 1.3, 2: 2***REMOVED***
        assert G.in_degree(1, weight="weight") == 1.3
        assert sorted(G.in_degree(weight="other")) == [(0, 2), (1, 2.2), (2, 2)]
        assert dict(G.in_degree(weight="other")) == {0: 2, 1: 2.2, 2: 2***REMOVED***
    ...
    def test_out_degree_weighted(self):
        ...
        assert dict(G.out_degree(weight="weight")) == {0: 1.3, 1: 2, 2: 2***REMOVED***
        assert G.out_degree(0, weight="weight") == 1.3
        assert sorted(G.out_degree(weight="other")) == [(0, 2.2), (1, 2), (2, 2)]
        assert dict(G.out_degree(weight="other")) == {0: 2.2, 1: 2, 2: 2***REMOVED***
...
class TestDiGraph(BaseAttrDiGraphTester, _TestGraph):
    ...
    def setup_method(self):
        ...
        ed1, ed2, ed3, ed4, ed5, ed6 = ({***REMOVED***, {***REMOVED***, {***REMOVED***, {***REMOVED***, {***REMOVED***, {***REMOVED***)
        self.k3adj = {0: {1: ed1, 2: ed2***REMOVED***, 1: {0: ed3, 2: ed4***REMOVED***, 2: {0: ed5, 1: ed6***REMOVED******REMOVED***
        self.k3edges = [(0, 1), (0, 2), (1, 2)]
        self.k3nodes = [0, 1, 2]
        self.K3 = self.Graph()
        self.K3._succ = self.k3adj  # K3._adj is synced with K3._succ
        self.K3._pred = {0: {1: ed3, 2: ed5***REMOVED***, 1: {0: ed1, 2: ed6***REMOVED***, 2: {0: ed2, 1: ed4***REMOVED******REMOVED***
        self.K3._node = {***REMOVED***
        self.K3._node[0] = {***REMOVED***
        self.K3._node[1] = {***REMOVED***
        self.K3._node[2] = {***REMOVED***

        ed1, ed2 = ({***REMOVED***, {***REMOVED***)
        self.P3 = self.Graph()
        self.P3._succ = {0: {1: ed1***REMOVED***, 1: {2: ed2***REMOVED***, 2: {***REMOVED******REMOVED***
        self.P3._pred = {0: {***REMOVED***, 1: {0: ed1***REMOVED***, 2: {1: ed2***REMOVED******REMOVED***
        # P3._adj is synced with P3._succ
        self.P3._node = {***REMOVED***
        self.P3._node[0] = {***REMOVED***
        self.P3._node[1] = {***REMOVED***
        self.P3._node[2] = {***REMOVED***

    def test_data_input(self):
        G = self.Graph({1: [2], 2: [1]***REMOVED***, name="test")
        assert G.name == "test"
        assert sorted(G.adj.items()) == [(1, {2: {***REMOVED******REMOVED***), (2, {1: {***REMOVED******REMOVED***)]
        assert sorted(G.succ.items()) == [(1, {2: {***REMOVED******REMOVED***), (2, {1: {***REMOVED******REMOVED***)]
        assert sorted(G.pred.items()) == [(1, {2: {***REMOVED******REMOVED***), (2, {1: {***REMOVED******REMOVED***)]

    def test_add_edge(self):
        G = self.Graph()
        G.add_edge(0, 1)
        assert G.adj == {0: {1: {***REMOVED******REMOVED***, 1: {***REMOVED******REMOVED***
        assert G.succ == {0: {1: {***REMOVED******REMOVED***, 1: {***REMOVED******REMOVED***
        assert G.pred == {0: {***REMOVED***, 1: {0: {***REMOVED******REMOVED******REMOVED***
        G = self.Graph()
        G.add_edge(*(0, 1))
        assert G.adj == {0: {1: {***REMOVED******REMOVED***, 1: {***REMOVED******REMOVED***
        assert G.succ == {0: {1: {***REMOVED******REMOVED***, 1: {***REMOVED******REMOVED***
    ...
    def test_add_edges_from(self):
        G = self.Graph()
        G.add_edges_from([(0, 1), (0, 2, {"data": 3***REMOVED***)], data=2)
        assert G.adj == {0: {1: {"data": 2***REMOVED***, 2: {"data": 3***REMOVED******REMOVED***, 1: {***REMOVED***, 2: {***REMOVED******REMOVED***
        assert G.succ == {0: {1: {"data": 2***REMOVED***, 2: {"data": 3***REMOVED******REMOVED***, 1: {***REMOVED***, 2: {***REMOVED******REMOVED***
        assert G.pred == {0: {***REMOVED***, 1: {0: {"data": 2***REMOVED******REMOVED***, 2: {0: {"data": 3***REMOVED******REMOVED******REMOVED***
    ...
    def test_remove_edge(self):
        G = self.K3.copy()
        G.remove_edge(0, 1)
        assert G.succ == {0: {2: {***REMOVED******REMOVED***, 1: {0: {***REMOVED***, 2: {***REMOVED******REMOVED***, 2: {0: {***REMOVED***, 1: {***REMOVED******REMOVED******REMOVED***
        assert G.pred == {0: {1: {***REMOVED***, 2: {***REMOVED******REMOVED***, 1: {2: {***REMOVED******REMOVED***, 2: {0: {***REMOVED***, 1: {***REMOVED******REMOVED******REMOVED***
        with pytest.raises(nx.NetworkXError):
            G.remove_edge(-1, 0)
    ...
    def test_clear(self):
        ...
        G.clear()
        assert list(G.nodes) == []
        assert G.succ == {***REMOVED***
        assert G.pred == {***REMOVED***
    ...
    def test_clear_edges(self):
        ...
        expected = {0: {***REMOVED***, 1: {***REMOVED***, 2: {***REMOVED******REMOVED***
