...
class CategorizedBracketParseCorpusReader(
    ...
    def __init__(self, *args, **kwargs):
        ...
        (C{cat_pattern***REMOVED***, C{cat_map***REMOVED***, and C{cat_file***REMOVED***) are passed to
        the L{CategorizedCorpusReader constructor
        <CategorizedCorpusReader.__init__>***REMOVED***.  The remaining arguments
        are passed to the L{BracketParseCorpusReader constructor
        <BracketParseCorpusReader.__init__>***REMOVED***.
        """
