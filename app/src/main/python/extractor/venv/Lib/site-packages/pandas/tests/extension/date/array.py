...
***REMOVED***:
            ...
            if not ly == lm == ld:
                raise ValueError(
                    f"tuple members must have the same length: {(ly, lm, ld)***REMOVED***"
    ***REMOVED***
            ...
            raise TypeError(f"{type(dates)***REMOVED*** is not supported")
    ...
    def __repr__(self) -> str:
        return f"DateArray{list(zip(self._year, self._month, self._day))***REMOVED***"
