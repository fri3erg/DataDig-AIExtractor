...
class UnknownAPIVersionError(
    ...
    def __init__(self, service_name, bad_api_version, available_api_versions):
        msg = (
            f"The '{service_name***REMOVED***' resource does not support an API version of: {bad_api_version***REMOVED***\n"
            f"Valid API versions are: {available_api_versions***REMOVED***"
        )
...
class ResourceNotExistsError(
    ...
    def __init__(self, service_name, available_services, has_low_level_client):
        msg = (
            "The '{***REMOVED***' resource does not exist.\n"
...
***REMOVED***
        ...
        if has_low_level_client:
            msg = (
                f"{msg***REMOVED***\nConsider using a boto3.client('{service_name***REMOVED***') "
                f"instead of a resource for '{service_name***REMOVED***'"
***REMOVED***
        # Not using super because we don't want the DataNotFoundError
        # to be called, it has a different __init__ signature.
        Boto3Error.__init__(self, msg)
...
class DynamoDBOperationNotSupportedError(Boto3Error):
    ...
    def __init__(self, operation, value):
        msg = (
            f'{operation***REMOVED*** operation cannot be applied to value {value***REMOVED*** of type '
            f'{type(value)***REMOVED*** directly. Must use AttributeBase object methods '
...
class DynamoDBNeedsConditionError(Boto3Error):
    ...
    def __init__(self, value):
        msg = (
            f'Expecting a ConditionBase object. Got {value***REMOVED*** of type {type(value)***REMOVED***. '
