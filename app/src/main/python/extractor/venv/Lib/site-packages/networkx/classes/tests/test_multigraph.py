...
class BaseMultiGraphTester(BaseAttrGraphTester):
    ...
    def test_get_edge_data(self):
        G = self.K3
        assert G.get_edge_data(0, 1) == {0: {***REMOVED******REMOVED***
        assert G[0][1] == {0: {***REMOVED******REMOVED***
        assert G[0][1][0] == {***REMOVED***
        assert G.get_edge_data(10, 20) is None
        assert G.get_edge_data(0, 1, 0) == {***REMOVED***

    def test_adjacency(self):
        G = self.K3
        assert dict(G.adjacency()) == {
            0: {1: {0: {***REMOVED******REMOVED***, 2: {0: {***REMOVED******REMOVED******REMOVED***,
            1: {0: {0: {***REMOVED******REMOVED***, 2: {0: {***REMOVED******REMOVED******REMOVED***,
            2: {0: {0: {***REMOVED******REMOVED***, 1: {0: {***REMOVED******REMOVED******REMOVED***,
        ***REMOVED***
    ...
    def test_edge_lookup(self):
        ...
        assert edges_equal(G.edges[1, 2, 0], {"foo": "bar"***REMOVED***)
        assert edges_equal(G.edges[1, 2, "key"], {"foo": "biz"***REMOVED***)
    ...
    def test_edge_attr(self):
        ...
        assert edges_equal(
            ...
            [(1, 2, "k1", {"foo": "bar"***REMOVED***), (1, 2, "k2", {"foo": "baz"***REMOVED***)],
        )
        assert edges_equal(
...
class TestMultiGraph(BaseMultiGraphTester, _TestGraph):
    def setup_method(self):
        ...
        # build K3
        ed1, ed2, ed3 = ({0: {***REMOVED******REMOVED***, {0: {***REMOVED******REMOVED***, {0: {***REMOVED******REMOVED***)
    ...
    def test_data_input(self):
        ...
        assert G.name == "test"
        expected = [(1, {2: {0: {***REMOVED******REMOVED******REMOVED***), (2, {1: {0: {***REMOVED******REMOVED******REMOVED***)]
        assert sorted(G.adj.items()) == expected

    def test_data_multigraph_input(self):
        # standard case with edge keys and edge data
        edata0 = {"w": 200, "s": "foo"***REMOVED***
        edata1 = {"w": 201, "s": "bar"***REMOVED***
        keydict = {0: edata0, 1: edata1***REMOVED***
        dododod = {"a": {"b": keydict***REMOVED******REMOVED***
    ...
    etraits = {"w": 200, "s": "foo"***REMOVED***
    egraphics = {"color": "blue", "shape": "box"***REMOVED***
    edata = {"traits": etraits, "graphics": egraphics***REMOVED***
    dodod1 = {"a": {"b": edata***REMOVED******REMOVED***
    dodod2 = {"a": {"b": etraits***REMOVED******REMOVED***
    dodod3 = {"a": {"b": {"traits": etraits, "s": "foo"***REMOVED******REMOVED******REMOVED***
    dol = {"a": ["b"]***REMOVED***

    multiple_edge = [("a", "b", "traits", etraits), ("a", "b", "graphics", egraphics)]
    single_edge = [("a", "b", 0, {***REMOVED***)]  # type: ignore[var-annotated]
    single_edge1 = [("a", "b", 0, edata)]
    single_edge2 = [("a", "b", 0, etraits)]
    single_edge3 = [("a", "b", 0, {"traits": etraits, "s": "foo"***REMOVED***)]
    ...
    def test_getitem(self):
        G = self.K3
        assert G[0] == {1: {0: {***REMOVED******REMOVED***, 2: {0: {***REMOVED******REMOVED******REMOVED***
    ...
    def test_remove_node(self):
        G = self.K3
        G.remove_node(0)
        assert G.adj == {1: {2: {0: {***REMOVED******REMOVED******REMOVED***, 2: {1: {0: {***REMOVED******REMOVED******REMOVED******REMOVED***
    ...
    def test_add_edge(self):
        G = self.Graph()
        G.add_edge(0, 1)
        assert G.adj == {0: {1: {0: {***REMOVED******REMOVED******REMOVED***, 1: {0: {0: {***REMOVED******REMOVED******REMOVED******REMOVED***
        G = self.Graph()
        G.add_edge(*(0, 1))
        assert G.adj == {0: {1: {0: {***REMOVED******REMOVED******REMOVED***, 1: {0: {0: {***REMOVED******REMOVED******REMOVED******REMOVED***
        G = self.Graph()
    ...
    def test_add_edge_conflicting_key(self):
        ...
        G = self.Graph()
        G.add_edges_from([(0, 1, 1, {***REMOVED***)])
        G.add_edges_from([(0, 1)])
        assert G.number_of_edges() == 2

    def test_add_edges_from(self):
        G = self.Graph()
        G.add_edges_from([(0, 1), (0, 1, {"weight": 3***REMOVED***)])
        assert G.adj == {
            0: {1: {0: {***REMOVED***, 1: {"weight": 3***REMOVED******REMOVED******REMOVED***,
            1: {0: {0: {***REMOVED***, 1: {"weight": 3***REMOVED******REMOVED******REMOVED***,
        ***REMOVED***
        G.add_edges_from([(0, 1), (0, 1, {"weight": 3***REMOVED***)], weight=2)
        assert G.adj == {
            0: {1: {0: {***REMOVED***, 1: {"weight": 3***REMOVED***, 2: {"weight": 2***REMOVED***, 3: {"weight": 3***REMOVED******REMOVED******REMOVED***,
            1: {0: {0: {***REMOVED***, 1: {"weight": 3***REMOVED***, 2: {"weight": 2***REMOVED***, 3: {"weight": 3***REMOVED******REMOVED******REMOVED***,
        ***REMOVED***
        G = self.Graph()
        edges = [
            (0, 1, {"weight": 3***REMOVED***),
            (0, 1, (("weight", 2),)),
            (0, 1, 5),
            (0, 1, "s"),
        ]
        G.add_edges_from(edges)
        keydict = {0: {"weight": 3***REMOVED***, 1: {"weight": 2***REMOVED***, 5: {***REMOVED***, "s": {***REMOVED******REMOVED***
        assert G._adj == {0: {1: keydict***REMOVED***, 1: {0: keydict***REMOVED******REMOVED***
    ...
    def test_multigraph_add_edges_from_four_tuple_misordered(self):
        ...
        with pytest.raises(TypeError):
            ...
            G.add_edges_from([(0, 1, {"color": "red"***REMOVED***, 0)])

    def test_remove_edge(self):
        G = self.K3
        G.remove_edge(0, 1)
        assert G.adj == {0: {2: {0: {***REMOVED******REMOVED******REMOVED***, 1: {2: {0: {***REMOVED******REMOVED******REMOVED***, 2: {0: {0: {***REMOVED******REMOVED***, 1: {0: {***REMOVED******REMOVED******REMOVED******REMOVED***
    ...
    def test_remove_edges_from(self):
        ...
        kd = {0: {***REMOVED******REMOVED***
        assert G.adj == {0: {2: kd***REMOVED***, 1: {2: kd***REMOVED***, 2: {0: kd, 1: kd***REMOVED******REMOVED***
        ...
        assert G.adj == {0: {***REMOVED***, 1: {***REMOVED***, 2: {***REMOVED******REMOVED***
        G = self.K3.copy()
        G.remove_edges_from([(0, 1, 0), (0, 2, 0, {***REMOVED***), (1, 2)])
        assert G.adj == {0: {1: {1: {***REMOVED******REMOVED******REMOVED***, 1: {0: {1: {***REMOVED******REMOVED******REMOVED***, 2: {***REMOVED******REMOVED***
...
class TestMultiGraphSubclass(TestMultiGraph):
    def setup_method(self):
        ...
        self.K3._pred = {0: {***REMOVED***, 1: {***REMOVED***, 2: {***REMOVED******REMOVED***
