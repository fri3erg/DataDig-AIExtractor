...
class TestClosenessCentrality:
    ...
    def test_wf_improved(self):
        ...
        res = {0: 0.25, 1: 0.375, 2: 0.375, 3: 0.25, 4: 0.222, 5: 0.333, 6: 0.222***REMOVED***
        wf_res = {0: 0.5, 1: 0.75, 2: 0.75, 3: 0.5, 4: 0.667, 5: 1.0, 6: 0.667***REMOVED***
        for n in G:
    ...
    def test_digraph(self):
        ...
        d = {0: 0.0, 1: 0.500, 2: 0.667***REMOVED***
        dr = {0: 0.667, 1: 0.500, 2: 0.0***REMOVED***
    ...
    def test_k5_closeness(self):
        ...
        d = {0: 1.000, 1: 1.000, 2: 1.000, 3: 1.000, 4: 1.000***REMOVED***
        for n in sorted(self.K5):
            assert c[n] == pytest.approx(d[n], abs=1e-3)

    def test_p3_closeness(self):
        c = nx.closeness_centrality(self.P3)
        d = {0: 0.667, 1: 1.000, 2: 0.667***REMOVED***
        for n in sorted(self.P3):
            assert c[n] == pytest.approx(d[n], abs=1e-3)
    ...
    def test_weighted_closeness(self):
        ...
        d = {"y": 0.200, "x": 0.286, "s": 0.138, "u": 0.235, "v": 0.200***REMOVED***
        for n in sorted(XG):
            assert c[n] == pytest.approx(d[n], abs=1e-3)
    ...
    def test_incremental(self):
        ...
        for i in range(5):
            ...
            # print(f"incremental time: {inc_elapsed***REMOVED***")
            ...
            # print(f"regular time: {reg_elapsed***REMOVED***")
            # Example output:
