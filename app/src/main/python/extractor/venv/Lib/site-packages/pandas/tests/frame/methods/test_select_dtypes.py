...
class TestSelectDtypes:
    ...
    def test_select_dtypes_duplicate_columns(self):
        ...
        expected = DataFrame(
            {"a": list(range(1, 4)), "b": np.arange(3, 6).astype("u1")***REMOVED***
        )
    ...
    def test_select_dtypes_empty(self):
        df = DataFrame({"a": list("abc"), "b": list(range(1, 4))***REMOVED***)
    ...
    @pytest.mark.parametrize(
        ...
        [
            [
                DataFrame(
                    {"A": range(3), "B": range(5, 8), "C": range(10, 7, -1)***REMOVED***
    ***REMOVED***.astype(dtype={"A": float, "B": np.float64, "C": np.float32***REMOVED***),
                float,
            ],
            [
                DataFrame(
    ...
    ***REMOVED***.astype(dtype={"A": float, "B": np.float64, "C": np.float32***REMOVED***),
            ...
            [DataFrame({"C": range(10, 7, -1)***REMOVED***, dtype=np.float32), np.float32],
            [
                DataFrame({"A": range(3), "B": range(5, 8)***REMOVED***).astype(
                    dtype={"A": float, "B": np.float64***REMOVED***
    ***REMOVED***,
                np.float64,
            ],
        ],
    ...
    def test_select_dtypes_float_dtype(self, expected, float_dtypes):
        # GH#42452
        dtype_dict = {"A": float, "B": np.float64, "C": np.float32***REMOVED***
        df = DataFrame(
            {"A": range(3), "B": range(5, 8), "C": range(10, 7, -1)***REMOVED***,
        )
