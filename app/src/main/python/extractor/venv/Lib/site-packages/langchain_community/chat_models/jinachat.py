...
class JinaChat(BaseChatModel):
    ...
    def lc_secrets(self) -> Dict[str, str]:
        return {"jinachat_api_key": "JINACHAT_API_KEY"***REMOVED***
        ...
        for output in llm_outputs:
            ...
            for k, v in token_usage.items():
                if k in overall_token_usage:
                    ...
                    overall_token_usage[k] = v
        return {"token_usage": overall_token_usage***REMOVED***
...
***REMOVED***
    ...
    def _create_chat_result(self, response: Mapping[str, Any]) -> ChatResult:
        ...
        llm_output = {"token_usage": response["usage"]***REMOVED***
...
***REMOVED***
    ...
    def _invocation_params(self) -> Mapping[str, Any]:
        ...
        jinachat_creds: Dict[str, Any] = {
            ...
            "model": "jinachat",
        ***REMOVED***
        return {**jinachat_creds, **self._default_params***REMOVED***
