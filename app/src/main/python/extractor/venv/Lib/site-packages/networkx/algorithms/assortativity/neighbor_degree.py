...
def average_neighbor_degree(G, source="out", target="out", nodes=None, weight=None):
    ...
    .. math::
        ...
        k_{nn,i***REMOVED*** = \frac{1***REMOVED***{|N(i)|***REMOVED*** \sum_{j \in N(i)***REMOVED*** k_j
    ...
    .. math::
        ...
        k_{nn,i***REMOVED***^{w***REMOVED*** = \frac{1***REMOVED***{s_i***REMOVED*** \sum_{j \in N(i)***REMOVED*** w_{ij***REMOVED*** k_j

    where `s_i` is the weighted degree of node `i`, `w_{ij***REMOVED***`
    ...
    {0: 2.0, 1: 1.5, 2: 1.5, 3: 2.0***REMOVED***
    >>> nx.average_neighbor_degree(G, weight="weight")
    {0: 2.0, 1: 1.1666666666666667, 2: 1.25, 3: 2.0***REMOVED***

    >>> G = nx.DiGraph()
    >>> nx.add_path(G, [0, 1, 2, 3])
    >>> nx.average_neighbor_degree(G, source="in", target="in")
    {0: 0.0, 1: 0.0, 2: 1.0, 3: 1.0***REMOVED***

    >>> nx.average_neighbor_degree(G, source="out", target="out")
    {0: 1.0, 1: 1.0, 2: 0.0, 3: 0.0***REMOVED***
    ...
    if G.is_directed():
        if source == "in":
            ...
            raise nx.NetworkXError(
                f"source argument {source***REMOVED*** must be 'in', 'out' or 'in+out'"
***REMOVED***
        ...
        if target == "in":
            ...
            raise nx.NetworkXError(
                f"target argument {target***REMOVED*** must be 'in', 'out' or 'in+out'"
***REMOVED***
    else:
...
***REMOVED***
    ...
    G_P = G_S = {n: {***REMOVED*** for n in G***REMOVED***
    if G.is_directed():
