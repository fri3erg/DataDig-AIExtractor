 ...
 * <xsl:element
 *  name = { qname ***REMOVED***
 *  namespace = { uri-reference ***REMOVED***
 ...
 *  lang = { nmtoken ***REMOVED***
 *  letter-value = { "alphabetic" | "traditional" ***REMOVED***
 *  grouping-separator = { char ***REMOVED***
 *  grouping-size = { number ***REMOVED*** />
 */
 ...
 *   select = string-expression
 *   lang = { nmtoken ***REMOVED***
 *   data-type = { "text" | "number" | qname-but-not-ncname ***REMOVED***
 *   order = { "ascending" | "descending" ***REMOVED***
 *   case-order = { "upper-first" | "lower-first" ***REMOVED*** />
 */
...
typedef enum {
    ...
    XSLT_OUTPUT_HTML,
    XSLT_OUTPUT_TEXT
***REMOVED*** xsltOutputType;

typedef enum {
    XSLT_STATE_OK = 0,
    XSLT_STATE_ERROR,
    XSLT_STATE_STOPPED
***REMOVED*** xsltTransformState;
