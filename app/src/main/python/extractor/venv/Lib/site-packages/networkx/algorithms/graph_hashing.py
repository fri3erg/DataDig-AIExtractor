...
def _init_node_labels(G, edge_attr, node_attr):
    if node_attr:
        return {u: str(dd[node_attr]) for u, dd in G.nodes(data=True)***REMOVED***
    elif edge_attr:
        return {u: "" for u in G***REMOVED***
    else:
        return {u: str(deg) for u, deg in G.degree()***REMOVED***
...
@nx._dispatch(edge_attrs={"edge_attr": None***REMOVED***, node_attrs="node_attr")
