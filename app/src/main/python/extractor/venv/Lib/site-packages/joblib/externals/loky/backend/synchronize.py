...
class SemLock:
    ...
    def __init__(self, kind, value, maxvalue, name=None):
        ...
        ***REMOVED***
        ...
        self.name = name
        util.debug(
            f"created semlock with handle {self._semlock.handle***REMOVED*** and name "
            f'"{self.name***REMOVED***"'
        )
    ...
    def __setstate__(self, state):
        ...
        util.debug(
            f'recreated blocker with handle {state[0]!r***REMOVED*** and name "{state[3]***REMOVED***"'
        )
        self._make_methods()
    ...
    def _make_name():
        ...
        return f"/loky-{os.getpid()***REMOVED***-{next(SemLock._rand)***REMOVED***"
...
class Semaphore(SemLock):
    ...
    def __repr__(self):
        try:
            ...
            value = "unknown"
        return f"<{self.__class__.__name__***REMOVED***(value={value***REMOVED***)>"
...
class BoundedSemaphore(Semaphore):
    ...
    def __repr__(self):
        try:
            ...
            value = "unknown"
        return (
            f"<{self.__class__.__name__***REMOVED***(value={value***REMOVED***, "
            f"maxvalue={self._semlock.maxvalue***REMOVED***)>"
        )
        ...
        try:
            if self._semlock._is_mine():
                ...
                if threading.current_thread().name != "MainThread":
                    name = f"{name***REMOVED***|{threading.current_thread().name***REMOVED***"
            ...
            name = "unknown"
        return f"<{self.__class__.__name__***REMOVED***(owner={name***REMOVED***)>"
...
class RLock(SemLock):
    ...
    def __repr__(self):
        ...
        return f"<{self.__class__.__name__***REMOVED***({name***REMOVED***, {count***REMOVED***)>"
...
***REMOVED***
            ...
            num_waiters = "unknown"
        return f"<{self.__class__.__name__***REMOVED***({self._lock***REMOVED***, {num_waiters***REMOVED***)>"
