...
***REMOVED***
    ...
    def create(
        ...
        q = "create store "
        q += podstore
        q += f" ({self._vector_index***REMOVED*** vector({self._vector_dimension***REMOVED***,"
        q += f" '{self._vector_type***REMOVED***'),"
        q += f" source char(256), v:text char({text_size***REMOVED***),"
        q += metadata_str + ")"
        self.run(q)
    ...
    def run(self, query: str, withFile: bool = False) -> dict:
        ...
        """
        if self._token == "":
            logger.error(f"E0005 error run({query***REMOVED***)")
            return {***REMOVED***
        ...
        **kwargs: Any,
        ...
        Args:
          ...
          metadatas: Optional list of metadatas associated with the texts.
            [{"m1": "v11", "m2": "v12", "m3": "v13", "filecol": "path_file1.jpg" ***REMOVED***,
             {"m1": "v21", "m2": "v22", "m3": "v23", "filecol": "path_file2.jpg" ***REMOVED***,
             {"m1": "v31", "m2": "v32", "m3": "v33", "filecol": "path_file3.jpg" ***REMOVED***,
             {"m1": "v41", "m2": "v42", "m3": "v43", "filecol": "path_file4.jpg" ***REMOVED***]
    ...
    def prt(self, msg: str) -> None:
        with open("/tmp/debugjaguar.log", "a") as file:
            print(f"msg={msg***REMOVED***", file=file, flush=True)
