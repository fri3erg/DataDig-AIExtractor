...
_type_reprs: Dict[int, Union[str, int]] = {***REMOVED***
...
class Node(Base):
    ...
    def __repr__(self) -> str:
        ...
        return "{***REMOVED***({***REMOVED***, {!r***REMOVED***)".format(
    ...
    def update_sibling_maps(self) -> None:
        _prev: Dict[int, Optional[NL]] = {***REMOVED***
        _next: Dict[int, Optional[NL]] = {***REMOVED***
...
class BasePattern:
    ...
    def __repr__(self) -> str:
        ...
        while args and args[-1] is None:
            del args[-1]
        return "{***REMOVED***({***REMOVED***)".format(self.__class__.__name__, ", ".join(map(repr, args)))
    ...
    def __init__(
        ...
        if content is not None:
            ...
            assert len(wrapped_content), repr(
                wrapped_content
***REMOVED***  # Can't have zero alternatives
