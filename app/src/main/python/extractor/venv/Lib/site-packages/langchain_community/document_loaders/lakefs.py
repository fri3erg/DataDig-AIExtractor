...
***REMOVED***
    ...
    def ls_objects(
        ...
        qp = {"prefix": path, "presign": presign***REMOVED***
        eqp = urllib.parse.urlencode(qp)
        objects_ls_endpoint = urljoin(
            self.__endpoint, f"repositories/{repo***REMOVED***/refs/{ref***REMOVED***/objects/ls?{eqp***REMOVED***"
        )
...
class UnstructuredLakeFSLoader(UnstructuredBaseLoader):
    ...
    def _get_metadata(self) -> dict:
        return {"repo": self.repo, "ref": self.ref, "path": self.path***REMOVED***
    ...
    def _get_elements(self) -> List:
        ...
        if self.presign:
            with tempfile.TemporaryDirectory() as temp_dir:
                file_path = f"{temp_dir***REMOVED***/{self.path.split('/')[-1]***REMOVED***"
