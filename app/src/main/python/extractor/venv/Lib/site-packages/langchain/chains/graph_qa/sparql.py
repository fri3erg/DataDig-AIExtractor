...
class GraphSparqlQAChain(Chain):
    ...
    *Security note*: Make sure that the database connection uses credentials
    ...
    def _call(
        ...
        _intent = self.sparql_intent_chain.run({"prompt": prompt***REMOVED***, callbacks=callbacks)
...
***REMOVED***
        ...
        generated_sparql = sparql_generation_chain.run(
            {"prompt": prompt, "schema": self.graph.get_schema***REMOVED***, callbacks=callbacks
        )
...
***REMOVED***
            result = self.qa_chain(
                {"prompt": prompt, "context": context***REMOVED***,
                callbacks=callbacks,
***REMOVED***
        ...
        return {self.output_key: res***REMOVED***
