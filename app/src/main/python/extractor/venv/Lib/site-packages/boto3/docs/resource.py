...
class ResourceDocumenter(BaseDocumenter):
    ...
    def _add_intro(self, section):
        ...
        start_class.style.start_sphinx_py_class(
            class_name=f'{self.class_name***REMOVED***({class_args***REMOVED***)'
        )
    ...
    def _add_description(self, section):
        ...
        section.write(
            'A resource representing an {***REMOVED*** {***REMOVED***'.format(
...
***REMOVED***
    ...
    def _add_example(self, section, identifier_names):
        ...
        section.style.new_line()
        section.write(
            '{***REMOVED*** = boto3.resource(\'{***REMOVED***\')'.format(
...
***REMOVED***
            section.write(f':type {identifier_name***REMOVED***: string')
            section.style.new_line()
            section.write(f':param {identifier_name***REMOVED***: {description***REMOVED***')
            section.style.new_line()

    def _add_overview_of_member_type(self, section, resource_member_type):
        section.style.new_line()
        section.write(
            f'These are the resource\'s available {resource_member_type***REMOVED***:'
        )
        section.style.new_line()
        section.style.toctree()
        for member in self.member_map[resource_member_type]:
            section.style.tocitem(f'{member***REMOVED***')
...
***REMOVED***
        for identifier in identifiers:
            ...
            breadcrumb_section.write(f' / Identifier / {identifier.name***REMOVED***')
...
***REMOVED***
        ...
        for attr_name in sorted(attributes):
            ...
            breadcrumb_section.style.ref(self._resource_class_name, 'index')
            breadcrumb_section.write(f' / Attribute / {attr_name***REMOVED***')
...
***REMOVED***
        ...
        for reference in references:
            ...
            breadcrumb_section.style.ref(self._resource_class_name, 'index')
            breadcrumb_section.write(f' / Reference / {reference.name***REMOVED***')
...
class ServiceResourceDocumenter(ResourceDocumenter):
    @property
    def class_name(self):
        return f'{self._service_docs_name***REMOVED***.ServiceResource'
    ...
    def _add_description(self, section):
        official_service_name = get_official_service_name(self._service_model)
        section.write(f'A resource representing {official_service_name***REMOVED***')
    ...
    def _add_example(self, section, identifier_names):
        ...
        section.style.new_line()
        section.write(
            f'{self._service_name***REMOVED*** = boto3.resource(\'{self._service_name***REMOVED***\')'
        )
        section.style.end_codeblock()
