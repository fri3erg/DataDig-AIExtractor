...
***REMOVED***
        ...
        headers = unstructured_kwargs.pop("headers", {***REMOVED***)
    ...
    ***REMOVED***
    ...
    def _validate_mode(self, mode: str) -> None:
        _valid_modes = {"single", "elements"***REMOVED***
        ...
        for url in urls:
            ...
            ***REMOVED***
                ...
                if self.continue_on_failure:
                    logger.error(f"Error fetching or processing {url***REMOVED***, exception: {e***REMOVED***")
                    continue
                else:
                    raise e
