...
class TestCore:
    ...
    def setup_class(cls):
        ...
        mapping = {6: 0, 0: 1, 4: 3, 5: 6, 3: 4, 1: 2, 2: 5***REMOVED***
        cls.H = nx.relabel_nodes(H, mapping)

    def test_trivial(self):
        """Empty graph"""
        G = nx.Graph()
        assert nx.core_number(G) == {***REMOVED***
    ...
    def test_directed_core_number(self):
        ...
        assert nx.core_number(G) == {1: 2, 2: 2, 3: 2, 4: 2***REMOVED***
        ...
        assert nx.core_number(G) == {1: 3, 2: 3, 3: 3, 4: 3, 5: 3, 6: 3***REMOVED***
