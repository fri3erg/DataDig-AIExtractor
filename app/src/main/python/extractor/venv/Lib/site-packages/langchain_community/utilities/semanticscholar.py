...
***REMOVED***
            documents.append(
                f"Published year: {getattr(item, 'year', None)***REMOVED***\n"
                f"Title: {getattr(item, 'title', None)***REMOVED***\n"
                f"Authors: {authors***REMOVED***\n"
                f"Astract: {getattr(item, 'abstract', None)***REMOVED***\n"
***REMOVED***
