...
***REMOVED***
            ...
            breadcrumb_section.write(f' / Sub-Resource / {sub_resource.name***REMOVED***')
...
def document_sub_resource(
    ...
    if include_signature:
        ...
        full_sub_resource_name = (
            f"{section.context.get('qualifier', '')***REMOVED***{sub_resource_model.name***REMOVED***"
        )
    ...
    description = f'Creates a {sub_resource_model.resource.type***REMOVED*** resource.'
    ...
    example = '{***REMOVED*** = {***REMOVED***.{***REMOVED***({***REMOVED***)'.format(
    ...
    for identifier in identifiers_needed:
        ...
        param_section.write(f':type {identifier***REMOVED***: string')
        param_section.style.new_line()
        param_section.write(f':param {identifier***REMOVED***: {description***REMOVED***')
        param_section.style.new_line()

    return_section = section.add_new_section('return')
    return_section.style.new_line()
    return_section.write(
        ':rtype: :py:class:`{***REMOVED***.{***REMOVED***`'.format(
    ...
    return_section.style.new_line()
    return_section.write(
        f':returns: A {sub_resource_model.resource.type***REMOVED*** resource'
    )
    return_section.style.new_line()
