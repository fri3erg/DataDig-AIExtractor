...
the schema name ``default`` is used if no schema is present::
    ...
    def module_name_for_table(cls, tablename, table):
        if table.schema is not None:
            return f"mymodule.{table.schema***REMOVED***"
        else:
...
***REMOVED***:
                ...
                if lcl_m2m is not None:
                    ...
                    clsdict: Dict[str, Any] = {"__table__": table***REMOVED***
        ...
        ***REMOVED***
                    ...
                    for token in map_config.cls.__module__.split("."):
                        if token not in by_module_properties:
                            by_module_properties[token] = util.Properties({***REMOVED***)
...
def automap_base(
    ...
    return type(
        ...
        {
            "__abstract__": True,
            "classes": util.Properties({***REMOVED***),
            "by_module": util.Properties({***REMOVED***),
...
***REMOVED***
            ...
            o2m_kws: Dict[str, Union[str, bool]] = {***REMOVED***
            nullable = False not in {fk.parent.nullable for fk in fks***REMOVED***
            if not nullable:
