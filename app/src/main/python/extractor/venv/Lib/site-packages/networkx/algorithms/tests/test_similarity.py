...
***REMOVED***,
        ...
        assert {canonical(*p) for p in paths***REMOVED*** == {canonical(*p) for p in expected_paths***REMOVED***
...
***REMOVED***
    ...
    def test_simrank_no_source_no_target(self, simrank_similarity):
        ...
        ***REMOVED***
        ...
        expected = {
            0: {0: 1, 1: 0.0, 2: 0.1323363991265798, 3: 0.0, 4: 0.03387811817640443***REMOVED***,
            1: {0: 0.0, 1: 1, 2: 0.4135512472705618, 3: 0.0, 4: 0.10586911930126384***REMOVED***,
            2: {
            ...
            ***REMOVED***,
            3: {0: 0.0, 1: 0.0, 2: 0.04234764772050554, 3: 1, 4: 0.3308409978164495***REMOVED***,
            4: {
    ...
    def test_simrank_source_no_target(self, simrank_similarity):
        ...
        ***REMOVED***
        ...
        expected = {0: 1, 1: 0.0, 2: 0.1323363991265798, 3: 0.0, 4: 0.03387811817640443***REMOVED***
        # Use the importance_factor from the paper to get the same numbers.
    ...
    def test_panther_similarity_unweighted(self):
        ...
        G.add_edge(1, 2)
        G.add_edge(2, 4)
        expected = {3: 0.5, 2: 0.5, 1: 0.5, 4: 0.125***REMOVED***
    ...
    def test_panther_similarity_weighted(self):
        ...
        expected = {"v3": 0.75, "v4": 0.5, "v2": 0.5, "v5": 0.25***REMOVED***
    ...
    def test_generate_random_paths_unweighted(self):
        ...
        expected_map = {
            0: {0, 2, 3, 4, 5, 6, 7, 8***REMOVED***,
            1: {1, 2, 4, 5, 7, 9***REMOVED***,
            2: {1, 2, 3, 6, 7, 8, 9***REMOVED***,
            3: {0, 3, 4, 5, 8***REMOVED***,
            4: {1, 6***REMOVED***,
        ***REMOVED***
    ...
    def test_generate_random_paths_weighted(self):
        ...
        expected_map = {
            "d": {0, 2, 3, 4, 5, 6, 8, 9***REMOVED***,
            "c": {0, 1, 2, 5, 7, 9***REMOVED***,
            "f": {0, 1, 9, 7***REMOVED***,
            "a": {0, 2, 3, 4, 5, 6, 8***REMOVED***,
            "b": {0, 2, 3, 4, 5, 6, 8***REMOVED***,
            "e": {1, 9, 7***REMOVED***,
        ***REMOVED***
