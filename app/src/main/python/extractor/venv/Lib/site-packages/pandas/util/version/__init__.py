...
class LegacyVersion(_BaseVersion):
    ...
    def __repr__(self) -> str:
        return f"<LegacyVersion('{self***REMOVED***')>"
...
class Version(_BaseVersion):
    ...
    def __init__(self, version: str) -> None:
        ...
        if not match:
            raise InvalidVersion(f"Invalid version: '{version***REMOVED***'")
...
***REMOVED***,
    ...
    def __str__(self) -> str:
        ...
        # Epoch
        if self.epoch != 0:
            parts.append(f"{self.epoch***REMOVED***!")
        ...
        if self.post is not None:
            parts.append(f".post{self.post***REMOVED***")

        # Development release
        if self.dev is not None:
            parts.append(f".dev{self.dev***REMOVED***")

        # Local version segment
        if self.local is not None:
            parts.append(f"+{self.local***REMOVED***")
