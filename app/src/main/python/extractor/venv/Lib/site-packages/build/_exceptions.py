...
class BuildBackendException(Exception):
    ...
    def __str__(self) -> str:
        ...
        return f'Backend operation failed: {self.exception!r***REMOVED***'
...
class BuildSystemTableValidationError(BuildException):
    ...
    def __str__(self) -> str:
        return f'Failed to validate `build-system` in pyproject.toml: {self.args[0]***REMOVED***'
...
class FailedProcessError(Exception):
    ...
    def __str__(self) -> str:
        ...
        description = f"{self._description***REMOVED***\n  Command '{cmd***REMOVED***' failed with return code {self.exception.returncode***REMOVED***"
