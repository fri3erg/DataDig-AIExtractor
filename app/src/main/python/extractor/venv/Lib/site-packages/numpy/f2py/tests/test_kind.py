    ...
    def test_int(self):
        ...
        for i in range(40):
            assert selectedintkind(i) == selected_int_kind(
                i
***REMOVED***, f"selectedintkind({i***REMOVED***): expected {selected_int_kind(i)!r***REMOVED*** but got {selectedintkind(i)!r***REMOVED***"
    ...
    def test_real(self):
        ...
        for i in range(32):
            assert selectedrealkind(i) == selected_real_kind(
                i
***REMOVED***, f"selectedrealkind({i***REMOVED***): expected {selected_real_kind(i)!r***REMOVED*** but got {selectedrealkind(i)!r***REMOVED***"
