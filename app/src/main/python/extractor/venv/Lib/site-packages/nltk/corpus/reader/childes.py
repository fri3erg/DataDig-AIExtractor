    ...
    ***REMOVED***
    ...
    def _get_participants(self, fileid):
        ...
        for participant in xmldoc.findall(
            f".//{{{NS***REMOVED******REMOVED******REMOVED***Participants/{{{NS***REMOVED******REMOVED******REMOVED***participant"
        ):
    ...
    def _get_age(self, fileid, speaker, month):
        xmldoc = ElementTree.parse(fileid).getroot()
        for pat in xmldoc.findall(f".//{{{NS***REMOVED******REMOVED******REMOVED***Participants/{{{NS***REMOVED******REMOVED******REMOVED***participant"):
            try:
    ...
    def _getMLU(self, fileid, speaker):
        ...
        for sent in sents:
            ...
            # if the sentence is the same as the last sent
                ...
                if len({"co", None***REMOVED***.intersection(posList)) > 0:
...
***REMOVED***
            ...
            mlu = 0
        # return {'mlu':mlu,'wordNum':numWords,'sentNum':numSents***REMOVED***
        return mlu
    ...
    def _get_words(
        ...
        results = []
        for xmlsent in xmldoc.findall(".//{%s***REMOVED***u" % NS):
            sents = []
            # select speakers
            if speaker == "ALL" or xmlsent.get("who") in speaker:
                for xmlword in xmlsent.findall(".//{%s***REMOVED***w" % NS):
                    infl = None
                    suffixStem = None
                    suffixTag = None
                    # getting replaced words
                    if replace and xmlsent.find(f".//{{{NS***REMOVED******REMOVED******REMOVED***w/{{{NS***REMOVED******REMOVED******REMOVED***replacement"):
                        xmlword = xmlsent.find(
                            f".//{{{NS***REMOVED******REMOVED******REMOVED***w/{{{NS***REMOVED******REMOVED******REMOVED***replacement/{{{NS***REMOVED******REMOVED******REMOVED***w"
            ***REMOVED***
                    elif replace and xmlsent.find(f".//{{{NS***REMOVED******REMOVED******REMOVED***w/{{{NS***REMOVED******REMOVED******REMOVED***wk"):
                        xmlword = xmlsent.find(f".//{{{NS***REMOVED******REMOVED******REMOVED***w/{{{NS***REMOVED******REMOVED******REMOVED***wk")
                    # get text
                    if xmlword.text:
                        word = xmlword.text
                    else:
                    ...
                    if relation or stem:
                        try:
                            xmlstem = xmlword.find(".//{%s***REMOVED***stem" % NS)
                            word = xmlstem.text
                        ...
                        try:
                            xmlinfl = xmlword.find(
                                f".//{{{NS***REMOVED******REMOVED******REMOVED***mor/{{{NS***REMOVED******REMOVED******REMOVED***mw/{{{NS***REMOVED******REMOVED******REMOVED***mk"
                ***REMOVED***
                            word += "-" + xmlinfl.text
                        except:
                            pass
                        ...
                        try:
                            xmlsuffix = xmlword.find(
                                ".//{%s***REMOVED***mor/{%s***REMOVED***mor-post/{%s***REMOVED***mw/{%s***REMOVED***stem"
                                % (NS, NS, NS, NS)
                ***REMOVED***
                    ...
                    if relation or pos:
                        try:
                            xmlpos = xmlword.findall(".//{%s***REMOVED***c" % NS)
                            xmlpos2 = xmlword.findall(".//{%s***REMOVED***s" % NS)
                            if xmlpos2 != []:
                        ...
                        try:
                            xmlsuffixpos = xmlword.findall(
                                ".//{%s***REMOVED***mor/{%s***REMOVED***mor-post/{%s***REMOVED***mw/{%s***REMOVED***pos/{%s***REMOVED***c"
                                % (NS, NS, NS, NS, NS)
                ***REMOVED***
                            xmlsuffixpos2 = xmlword.findall(
                                ".//{%s***REMOVED***mor/{%s***REMOVED***mor-post/{%s***REMOVED***mw/{%s***REMOVED***pos/{%s***REMOVED***s"
                                % (NS, NS, NS, NS, NS)
                ***REMOVED***
                            if xmlsuffixpos2:
                                suffixTag = (
                    ...
                    ***REMOVED***
                    ...
                    if relation == True:
                        for xmlstem_rel in xmlword.findall(
                            f".//{{{NS***REMOVED******REMOVED******REMOVED***mor/{{{NS***REMOVED******REMOVED******REMOVED***gra"
            ***REMOVED***:
                    ...
                    ***REMOVED***
                        try:
                            for xmlpost_rel in xmlword.findall(
                                f".//{{{NS***REMOVED******REMOVED******REMOVED***mor/{{{NS***REMOVED******REMOVED******REMOVED***mor-post/{{{NS***REMOVED******REMOVED******REMOVED***gra"
                ***REMOVED***:
