...
def get_reusable_executor(
    ...
    the main process. One can provide a dict ``{ENV: VAL***REMOVED***`` where ``ENV`` and
    ...
    def get_reusable_executor(
        ...
        with _executor_lock:
            ...
            if max_workers is None:
                ...
                raise ValueError(
                    f"max_workers must be greater than 0, got {max_workers***REMOVED***."
    ***REMOVED***
...
***REMOVED***
            if executor is None:
                is_reused = False
                mp.util.debug(
                    f"Create a executor with max_workers={max_workers***REMOVED***."
    ***REMOVED***
    ...
    ***REMOVED***:
                    ...
                    mp.util.debug(
                        ...
                        f"{max_workers***REMOVED*** as the previous instance cannot be "
                        f"reused ({reason***REMOVED***)."
        ***REMOVED***
        ...
        ***REMOVED***
                    ...
                    mp.util.debug(
                        ...
                        f"max_workers={executor._max_workers***REMOVED***."
        ***REMOVED***
                    is_reused = True
...
***REMOVED***
            mp.util.debug(
                f"Executor {self.executor_id***REMOVED*** waiting for jobs completion "
                "before resizing"
***REMOVED***
