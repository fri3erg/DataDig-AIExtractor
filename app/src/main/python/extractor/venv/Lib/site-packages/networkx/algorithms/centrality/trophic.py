...
def trophic_levels(G, weight="weight"):
    ...
    .. math::
        ...
        s_i = 1 + \frac{1***REMOVED***{k^{in***REMOVED***_i***REMOVED*** \sum_{j***REMOVED*** a_{ij***REMOVED*** s_j

    where $k^{in***REMOVED***_i$ is the in-degree of i

    .. math::

        k^{in***REMOVED***_i = \sum_{j***REMOVED*** a_{ij***REMOVED***

    and nodes with $k^{in***REMOVED***_i = 0$ have $s_i = 1$ by convention.
