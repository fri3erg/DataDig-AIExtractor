...
class TestRTEClassifier:
    ...
    def test_rte_feature_extraction(self):
        ...
        test_output = [
            f"{key:<15***REMOVED*** => {rte_features(pair)[key]***REMOVED***"
            for pair in pairs
    ...
    def test_feature_extractor_object(self):
        ...
        assert extractor.hyp_words == {"member", "China", "SCO."***REMOVED***
        assert extractor.overlap("word") == set()
        assert extractor.overlap("ne") == {"China"***REMOVED***
        assert extractor.hyp_extra("word") == {"member"***REMOVED***
