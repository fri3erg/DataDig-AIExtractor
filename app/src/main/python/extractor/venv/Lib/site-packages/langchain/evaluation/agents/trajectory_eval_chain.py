    ...
    def parse(self, text: str) -> TrajectoryEval:
        ...
        if "Score:" not in text:
            raise OutputParserException(
                f"Could not find score in model eval output: {text***REMOVED***"
***REMOVED***
        ...
        if _score is None or "." in _score.group(1):
            raise OutputParserException(
                f"Score is not an integer digit in the range 1-5: {text***REMOVED***"
***REMOVED***
        score = int(_score.group(1))
        # If the score is not in the range 1-5, raise an exception.
        if not 1 <= score <= 5:
            raise OutputParserException(
                f"Score is not a digit in the range 1-5: {text***REMOVED***"
***REMOVED***
...
class TrajectoryEvalChain(AgentTrajectoryEvaluator, LLMEvalChain):
    ...
    .. code-block:: python
        ...
        def geography_answers(country: str, question: str) -> str:
            ...
            return f"{country***REMOVED***? IDK - We may never know {question***REMOVED***."
    ...
    def _tools_description(self) -> str:
        ...
        return "\n\n".join(
            [
                f"""Tool {i***REMOVED***: {tool.name***REMOVED***
Description: {tool.description***REMOVED***"""
    ...
    def get_agent_trajectory(
        ...
        return "\n\n".join(
            [
                f"""Step {i***REMOVED***:
Tool used: {action.tool***REMOVED***
Tool input: {action.tool_input***REMOVED***
Tool output: {output***REMOVED***"""
