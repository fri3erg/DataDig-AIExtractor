...
***REMOVED*** from ex
    ...
    def parse_log(self, log: dict) -> Document:
        ...
        """
        attributes = log.get("attributes", {***REMOVED***)
        metadata = {
            "id": log.get("id", ""),
        ...
        ***REMOVED***
        ...
        inside_attributes = attributes.get("attributes", {***REMOVED***)
        content_dict = {**inside_attributes, "message": message***REMOVED***
        content = ", ".join(f"{k***REMOVED***: {v***REMOVED***" for k, v in content_dict.items())
...
***REMOVED*** from ex
        ...
        body = LogsListRequest(
            filter=LogsQueryFilter(
                query=self.query,
                _from=_from,
                to=f"{self.to_time if self.to_time is not None else now_timestamp***REMOVED***",
***REMOVED***,
