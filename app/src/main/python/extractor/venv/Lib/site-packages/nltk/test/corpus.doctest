...
for a given verbnet class.
    ...
    >>> frame == [{'example': "It's raining.", 'description': {'primary': 'Intransitive', 'secondary': 'Expletive Subject'***REMOVED***, 'syntax': [{'pos_tag': 'LEX', 'modifiers': {'value': 'it', 'selrestrs': [], 'synrestrs': []***REMOVED******REMOVED***, {'pos_tag': 'LEX', 'modifiers': {'value': '[+be]', 'selrestrs': [], 'synrestrs': []***REMOVED******REMOVED***, {'pos_tag': 'VERB', 'modifiers': {'value': '', 'selrestrs': [], 'synrestrs': []***REMOVED******REMOVED***], 'semantics': [{'predicate_value': 'weather', 'arguments': [{'type': 'Event', 'value': 'during(E)'***REMOVED***, {'type': 'VerbSpecific', 'value': 'Weather_type'***REMOVED***, {'type': 'ThemRole', 'value': '?Theme'***REMOVED***], 'negated': False***REMOVED***]***REMOVED***, {'example': "It's raining cats and dogs.", 'description': {'primary': 'NP', 'secondary': 'Expletive Subject, Theme Object'***REMOVED***, 'syntax': [{'pos_tag': 'LEX', 'modifiers': {'value': 'it', 'selrestrs': [], 'synrestrs': []***REMOVED******REMOVED***, {'pos_tag': 'LEX', 'modifiers': {'value': '[+be]', 'selrestrs': [], 'synrestrs': []***REMOVED******REMOVED***, {'pos_tag': 'VERB', 'modifiers': {'value': '', 'selrestrs': [], 'synrestrs': []***REMOVED******REMOVED***, {'pos_tag': 'NP', 'modifiers': {'value': 'Theme', 'selrestrs': [], 'synrestrs': []***REMOVED******REMOVED***], 'semantics': [{'predicate_value': 'weather', 'arguments': [{'type': 'Event', 'value': 'during(E)'***REMOVED***, {'type': 'VerbSpecific', 'value': 'Weather_type'***REMOVED***, {'type': 'ThemRole', 'value': 'Theme'***REMOVED***], 'negated': False***REMOVED***]***REMOVED***, {'example': 'It was pelting with rain.', 'description': {'primary': 'PP', 'secondary': 'Expletive Subject, Theme-PP'***REMOVED***, 'syntax': [{'pos_tag': 'LEX', 'modifiers': {'value': 'it[+be]', 'selrestrs': [], 'synrestrs': []***REMOVED******REMOVED***, {'pos_tag': 'VERB', 'modifiers': {'value': '', 'selrestrs': [], 'synrestrs': []***REMOVED******REMOVED***, {'pos_tag': 'PREP', 'modifiers': {'value': 'with', 'selrestrs': [], 'synrestrs': []***REMOVED******REMOVED***, {'pos_tag': 'NP', 'modifiers': {'value': 'Theme', 'selrestrs': [], 'synrestrs': []***REMOVED******REMOVED***], 'semantics': [{'predicate_value': 'weather', 'arguments': [{'type': 'Event', 'value': 'during(E)'***REMOVED***, {'type': 'VerbSpecific', 'value': 'Weather_type'***REMOVED***, {'type': 'ThemRole', 'value': 'Theme'***REMOVED***], 'negated': False***REMOVED***]***REMOVED***]
    True

Verbnet corpus lets us access thematic roles individually using `themroles()`.

    >>> themroles = verbnet.themroles('57')
    >>> themroles == [{'modifiers': [{'type': 'concrete', 'value': '+'***REMOVED***, {'type': 'force', 'value': '+'***REMOVED***], 'type': 'Theme'***REMOVED***]
    True
...
types, are:
  ...
  - I{corpus***REMOVED***.words(): list of str
  - I{corpus***REMOVED***.sents(): list of (list of str)
  - I{corpus***REMOVED***.paras(): list of (list of (list of str))
  - I{corpus***REMOVED***.tagged_words(): list of (str,str) tuple
  - I{corpus***REMOVED***.tagged_sents(): list of (list of (str,str))
  - I{corpus***REMOVED***.tagged_paras(): list of (list of (list of (str,str)))
  - I{corpus***REMOVED***.chunked_sents(): list of (Tree w/ (str,str) leaves)
  - I{corpus***REMOVED***.parsed_sents(): list of (Tree with str leaves)
  - I{corpus***REMOVED***.parsed_paras(): list of (list of (Tree with str leaves))
  - I{corpus***REMOVED***.xml(): A single xml ElementTree
  - I{corpus***REMOVED***.raw(): str (unprocessed corpus contents)
