...
def multi_file_load_config(*filenames):
    ...
    would be::
        ...
        {"foo": {"a": 1***REMOVED***, "bar": {"a": 2***REMOVED***, "baz": {"a": 3***REMOVED***,
        "profiles": {"a": {"region": "c"***REMOVED******REMOVED***, {"b": {"region": d"***REMOVED******REMOVED***,
                    {"c": {"region": "f"***REMOVED******REMOVED******REMOVED***
    ...
    :param parse_subsections: If True, parse indented blocks as
       ...
       For example, if the config file had the contents::
        ...
        The resulting ``raw_config_parse`` would be::
            ...
            {'s3': {'signature_version': 's3v4', 'addressing_style': 'path'***REMOVED******REMOVED***

       If False, do not try to parse subsections and return the indented
       block as its literal value::

            {'s3': '\nsignature_version = s3v4\naddressing_style = path'***REMOVED***
...
def build_profile_map(parsed_ini_config):
    ...
    would be converted from::
        ...
        {"profile test": {"aws_...": "foo", "aws...": "bar"***REMOVED***,
         "profile bar": {"aws...": "foo", "aws...": "bar"***REMOVED***,
         "preview": {"otherstuff": ...***REMOVED***,
         "foobar": {"morestuff": ...***REMOVED***,
         ***REMOVED***

    into::

        {"profiles": {"test": {"aws_...": "foo", "aws...": "bar"***REMOVED***,
                      "bar": {"aws...": "foo", "aws...": "bar"***REMOVED***,
         "preview": {"otherstuff": ...***REMOVED***,
         "foobar": {"morestuff": ...***REMOVED***,
        ***REMOVED***
    ...
    profiles = {***REMOVED***
    sso_sessions = {***REMOVED***
    services = {***REMOVED***
    final_config = {***REMOVED***
