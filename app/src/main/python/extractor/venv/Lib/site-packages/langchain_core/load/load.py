...
ALL_SERIALIZABLE_MAPPINGS = {**SERIALIZABLE_MAPPING, **OLD_PROMPT_TEMPLATE_FORMATS***REMOVED***
    ...
    def __call__(self, value: Dict[str, Any]) -> Any:
        if (
            ...
            if key in self.secrets_map:
                ...
                raise KeyError(f'Missing key "{key***REMOVED***" in load(secrets_map)')
...
***REMOVED***
        ...
        if (
            ...
            if namespace[0] not in self.valid_namespaces:
                raise ValueError(f"Invalid namespace: {value***REMOVED***")
    ...
    *,
    ...
    def _load(obj: Any) -> Any:
        if isinstance(obj, dict):
            ...
            loaded_obj = {k: _load(v) for k, v in obj.items()***REMOVED***
