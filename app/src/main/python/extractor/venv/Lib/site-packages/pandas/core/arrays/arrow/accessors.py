...
class ListAccessor(ArrowAccessor):
    ...
    def __init__(self, data=None) -> None:
        super().__init__(
            ...
            "'list[pyarrow]' dtype, not {dtype***REMOVED***.",
        )
        ...
        if isinstance(key, int):
            ...
            if pa_version_under11p0:
                raise NotImplementedError(
                    f"List slice not supported by pyarrow {pa.__version__***REMOVED***."
    ***REMOVED***
            ...
            raise ValueError(f"key must be an int or slice, got {type(key).__name__***REMOVED***")
...
***REMOVED***,
    ...
    def dtypes(self) -> Series:
        ...
        >>> s = pd.Series(
        ...     [
        ...         {"version": 1, "project": "pandas"***REMOVED***,
        ...         {"version": 2, "project": "pandas"***REMOVED***,
        ...         {"version": 1, "project": "numpy"***REMOVED***,
        ...     ],
    ...
    def field(
        ...
        >>> s = pd.Series(
        ...     [
        ...         {"version": {"major": 1, "minor": 5***REMOVED***, "project": "pandas"***REMOVED***,
        ...         {"version": {"major": 2, "minor": 1***REMOVED***, "project": "pandas"***REMOVED***,
        ...         {"version": {"major": 1, "minor": 26***REMOVED***, "project": "numpy"***REMOVED***,
        ...     ],
        ...     dtype=pd.ArrowDtype(pa.struct(
