        ...
        try:
            try:
                response = multion.update_session(
                    sessionId, {"input": query, "url": url***REMOVED***
    ***REMOVED***
                content = {"sessionId": sessionId, "Response": response["message"]***REMOVED***
                self.sessionId = sessionId
                return content
            except Exception as e:
                print(f"{e***REMOVED***, retrying...")
                return {"error": f"{e***REMOVED***", "Response": "retrying..."***REMOVED***
        except Exception as e:
            raise Exception(f"An error occurred: {e***REMOVED***")
