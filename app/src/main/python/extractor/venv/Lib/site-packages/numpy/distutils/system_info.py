...
def _parse_env_order(base_order, env):
    ...
    if neg:
        if sum_neg > 1:
            raise ValueError(f"Environment variable '{env***REMOVED***' may only contain a single (prefixed) negation: {order_str***REMOVED***")
        # remove prefix
        order_str = order_str[1:]
    elif sum_neg > 0:
        raise ValueError(f"Environment variable '{env***REMOVED***' may not mix negated an non-negated items: {order_str***REMOVED***")
...
def get_info(name, notfound_action=0):
    ...
    cl = {'armpl': armpl_info,
          ...
          'amd': amd_info,
          ***REMOVED***.get(name.lower(), system_info)
...
class AliasedOptionError(DistutilsError):
    ...
    In section '{section***REMOVED***' we found multiple appearances of options {options***REMOVED***."""
    ...
    def get_option_single(self, *options):
        ...
        *options : list of str
        ...
        raise AliasedOptionError(AliasedOptionError.__doc__.format(
            section=self.section, options='[{***REMOVED***]'.format(', '.join(options))))
...
class fftw_info(system_info):
    ...
    ver_info = [{'name':'fftw3',
                    'libs':['fftw3'],
                    'includes':['fftw3.h'],
                    'macros':[('SCIPY_FFTW3_H', None)]***REMOVED***,
                  {'name':'fftw2',
                    'libs':['rfftw', 'fftw'],
                    'includes':['fftw.h', 'rfftw.h'],
                    'macros':[('SCIPY_FFTW_H', None)]***REMOVED***]
...
class dfftw_info(fftw_info):
    ...
    ver_info = [{'name':'dfftw',
                    ...
                    'macros':[('SCIPY_DFFTW_H', None)]***REMOVED***]
...
class sfftw_info(fftw_info):
    ...
    ver_info = [{'name':'sfftw',
                    ...
                    'macros':[('SCIPY_SFFTW_H', None)]***REMOVED***]
...
class fftw_threads_info(fftw_info):
    ...
    ver_info = [{'name':'fftw threads',
                    ...
                    'macros':[('SCIPY_FFTW_THREADS_H', None)]***REMOVED***]
...
class dfftw_threads_info(fftw_info):
    ...
    ver_info = [{'name':'dfftw threads',
                    ...
                    'macros':[('SCIPY_DFFTW_THREADS_H', None)]***REMOVED***]
...
class sfftw_threads_info(fftw_info):
    ...
    ver_info = [{'name':'sfftw threads',
                    ...
                    'macros':[('SCIPY_SFFTW_THREADS_H', None)]***REMOVED***]
...
class djbfft_info(system_info):
    ...
    def calc_info(self):
        ...
        for d in lib_dirs:
            ...
            if p:
                info = {'libraries': ['djbfft'], 'library_dirs': [d]***REMOVED***
                break
        if info is None:
            return
        for d in incl_dirs:
...
class lapack_opt_info(system_info):
    ...
    def _calc_info(self, name):
        return getattr(self, '_calc_info_{***REMOVED***'.format(name))()
    ...
    def calc_info(self):
        ...
        if len(unknown_order) > 0:
            raise ValueError("lapack_opt_info user defined "
                             ...
                             "values: {***REMOVED***".format(unknown_order))
...
class blas_opt_info(system_info):
    ...
    def calc_info(self):
        ...
        if len(unknown_order) > 0:
            raise ValueError("blas_opt_info user defined BLAS order has unacceptable values: {***REMOVED***".format(unknown_order))
...
class blas_info(system_info):
    ...
    def get_cblas_libs(self, info):
        ...
        s = textwrap.dedent("""\
            ...
            {
                double a[4] = {1,2,3,4***REMOVED***;
                double b[4] = {5,6,7,8***REMOVED***;
    ...
    def check_symbols(self, info):
        ...
        s = textwrap.dedent("""\
            ...
            int main(int argc, const char *argv[])
            {
                %(calls)s
                return 0;
            ***REMOVED***""") % dict(prototypes=prototypes, calls=calls)
        src = os.path.join(tmpdir, 'source.c')
