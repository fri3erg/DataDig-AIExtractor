...
class TestBase:
    ...
    def setup_class(cls):
        ...
        cls.incompleteUG.add_weighted_edges_from({(0, 1, 1), (1, 2, 3)***REMOVED***)
        cls.incompleteDG = nx.DiGraph()
        cls.incompleteDG.add_weighted_edges_from({(0, 1, 1), (1, 2, 3)***REMOVED***)
...
class TestGreedyTSP(TestBase):
    ...
    def test_two_nodes(self):
        G = nx.Graph()
        G.add_weighted_edges_from({(1, 2, 1)***REMOVED***)
...
def test_ascent_fractional_solution():
    ...
    ***REMOVED***
    ...
    # Check that the z_stars are the same
    assert {key: round(z_star[key], 4) for key in z_star***REMOVED*** == {
...
def test_spanning_tree_distribution():
    ...
    ***REMOVED***
    ...
    assert {key: round(gamma[key], 4) for key in gamma***REMOVED*** == solution_gamma
...
def test_asadpour_real_world():
    ...
    node_map = {0: "JFK", 1: "LAX", 2: "ORD", 3: "IAH", 4: "PHX", 5: "PHL"***REMOVED***
