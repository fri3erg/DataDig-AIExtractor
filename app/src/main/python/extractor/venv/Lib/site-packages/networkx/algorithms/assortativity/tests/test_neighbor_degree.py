...
class TestAverageNeighbor:
    def test_degree_p4(self):
        G = nx.path_graph(4)
        answer = {0: 2, 1: 1.5, 2: 1.5, 3: 2***REMOVED***
        ...
        nd = nx.average_neighbor_degree(D)
        assert nd == {0: 1, 1: 1, 2: 0, 3: 0***REMOVED***
        nd = nx.average_neighbor_degree(D, "in", "out")
        assert nd == {0: 0, 1: 1, 2: 1, 3: 1***REMOVED***
        nd = nx.average_neighbor_degree(D, "out", "in")
        assert nd == {0: 1, 1: 1, 2: 1, 3: 0***REMOVED***
        nd = nx.average_neighbor_degree(D, "in", "in")
        assert nd == {0: 0, 1: 0, 2: 1, 3: 1***REMOVED***

    def test_degree_p4_weighted(self):
        G = nx.path_graph(4)
        G[1][2]["weight"] = 4
        answer = {0: 2, 1: 1.8, 2: 1.8, 3: 2***REMOVED***
        ...
        assert nd == {0: 1.0, 1: 1.0, 2: 0.8, 3: 1.0***REMOVED***
        nd = nx.average_neighbor_degree(D, target="in+out", weight="weight")
        assert nd == {0: 2.0, 1: 2.0, 2: 1.0, 3: 0.0***REMOVED***
    ...
    def test_degree_k4(self):
        ...
        answer = {0: 3, 1: 3, 2: 3, 3: 3***REMOVED***
        nd = nx.average_neighbor_degree(G)
        assert nd == answer
