...
def _warn_deprecated_python():
    ...
    ***REMOVED***
    ...
    if py_version in deprecated_versions:
        ...
        warning = (
            "Boto3 will no longer support Python {***REMOVED***.{***REMOVED*** "
            "starting {***REMOVED***. To continue receiving service updates, "
            "bug fixes, and security updates please upgrade to Python 3.8 or "
            "later. More information can be found here: {***REMOVED***"
