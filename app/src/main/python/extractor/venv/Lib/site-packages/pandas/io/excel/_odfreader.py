...
class ODFReader(BaseExcelReader["OpenDocument"]):
    ...
    def get_sheet_by_name(self, name: str):
        ...
        self.close()
        raise ValueError(f"sheet {name***REMOVED*** not found")
    ...
    def get_sheet_data(
        ...
        cell_names = {covered_cell_name, table_cell_name***REMOVED***
    ...
    def _get_cell_value(self, cell) -> Scalar | NaTType:
        ...
        if cell_type is None:
            ...
            self.close()
            raise ValueError(f"Unrecognized type {cell_type***REMOVED***")
