...
class TabellaScenariPerformance(BaseModel):
    ...
    scenario_morte_1: str = Field(
        NF, description="scenario morte o decesso, Valore in euro(€) o '-'  a 1 anno scenario moderato"
    )
    scenario_morte_rhp: str = Field(
        NF, description="scenario morte o decesso, Valore in euro(€) a RHP anni scenario moderato"
    )
