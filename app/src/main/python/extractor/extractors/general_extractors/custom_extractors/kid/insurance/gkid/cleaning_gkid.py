...
regex_search = {
    "it": {
        "costi_ingresso_gkid": ".{0,3***REMOVED***cost.{0,6***REMOVED***ingress.{0,5***REMOVED***",
        "costi_uscita_gkid": ".{0,3***REMOVED***cost.{0,6***REMOVED***uscit.{0,5***REMOVED***",
        "commissione_gestione_gkid": ".{0,3***REMOVED***co.{0,14***REMOVED***gestion.{0,5***REMOVED***",
        "commissione_transazione_gkid": ".{0,3***REMOVED***co.{0,14***REMOVED***transazion.{0,5***REMOVED***",
        "commissione_performance_gkid": ".{0,3***REMOVED***co.{0,14***REMOVED***performance.{0,5***REMOVED***",
        "costi_totali-gkid": ".{0,4***REMOVED***cost.{0,4***REMOVED***total.{0,5***REMOVED***",
        "incidenza-gkid": ".{0,7***REMOVED***ncidenz.{0,30***REMOVED***|.*RIY.*",
    ***REMOVED***,
    "en": {***REMOVED***,
***REMOVED***
strips_cleaning = {
